...
class tepuy_srh_c_tipopersonal
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_srh_c_tipopersonal($path)
	...
	function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_d_tipopersonal)
		//      Argumento: 
	...
	function  uf_srh_insert_tipopersonal($as_codtipper,$as_dentipper,$aa_seguridad)
	{
		...
		//         areaess: public (tepuy_siv_d_tipoarticulo)
		//      Argumento: $as_codtipper   // codigo de profesion
...
}// end   class tepuy_srh_c_tipopersonal
?>