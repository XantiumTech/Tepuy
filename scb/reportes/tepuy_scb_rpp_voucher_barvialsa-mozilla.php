<?PHP
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_nomproben,$ls_fecmov,$ls_conmov,$as_chevau,&$io_pdf)
	{
		...
		$io_pdf->add_texto(12,84,11,"<b>$ls_conmov</b>");//108
		...
		$io_pdf->add_texto(8,239,10,'<b>'.substr($as_chevau,-8).'</b>');//108
	...
	function uf_print_totales($ad_montotdeb,$ad_montothab,$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $io_pdf->add_texto(137,76,12,'<b>'.number_format($ad_montotdeb,2,',','.').'</b>');
		 $io_pdf->add_texto(170,77,12,'<b>'.number_format($ad_montothab,2,',','.').'</b>');
	}
	...
	function uf_print_firmas($ad_usuario,$ad_contabilidad,$ad_gerente,$ad_presidente,$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $io_pdf->add_texto(3,80,10,'<b>'.$ad_usuario.'</b>');
		 $io_pdf->add_texto(26,89,10,'<b>'.$ad_gerente.'</b>');
		$io_pdf->add_texto(65,80,10,'<b>'.$ad_presidente.'</b>');
		 $io_pdf->add_texto(29,102,10,'<b>'.$ad_contabilidad.'</b>');
	}
