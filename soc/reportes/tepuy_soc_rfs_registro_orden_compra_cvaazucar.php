...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,&$io_pdf)
	{
		...
		// Fecha Creación: 21/06/2007                   Fecha de Modificación: 10/03/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);
		$io_pdf->line(15,40,585,40);
		$io_pdf->line(500,650,500,760);  //linea vertical del cuadro de la derecha
		$io_pdf->line(500,705,585,705);
        $io_pdf->Rectangle(15,650,570,110);
		$io_pdf->addJpegFromFile('../../shared/imagebank/LOGO CVA1.jpg',20,715,80,40); // Agregar Logo cvazucar
		if($as_estcondat=="B") 
        {
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,655,12,$ls_titulo); // Agregar el título
		$io_pdf->addText(245,740,12," <b>CVA Azúcar, S.A.</b>");
		$io_pdf->addText(20,700,9,"<b>Domicilio Fiscal:</b> Av Fuerzas Armadas, Esquina Socarra urb. La Candelaria, Edif. Corporación Vzlana Agraria, P 7,");
		$io_pdf->addText(20,690,9,"Zona Postal 1010.Caracas. <b>Oficinas</b>: Av Ricaurte, c/c Democracia, Edificio el Kontar, piso 1, Diagonal a Vialco, Antigua");
		$io_pdf->addText(20,680,9,"Sede de Pepeganga, San Carlos Estado Cojedes.");
		$io_pdf->addText(20,670,9,"<b>Teléfonos</b>: (0416) 6449601,<b>Fax</b>: (0258) 4338722 . E-mail:compras.cvaa@gmail.com / R.I.F.: G-20006348-3");
		$io_pdf->addText(505,740,9," <b>No. </b>");
		$io_pdf->addText(505,730,9,$as_numordcom); // Agregar el título
		$io_pdf->addText(505,695,9,"<b>Fecha </b>");
		$io_pdf->addText(505,680,9,$ad_fecordcom); // Agregar el título
		$io_pdf->addText(540,770,7,date("d/m/Y")); // Agregar la Fecha
		$io_pdf->addText(546,764,6,date("h:i a")); // Agregar la Hora
		// cuadro inferior
        $io_pdf->Rectangle(15,60,570,90); 
		$io_pdf->line(15,135,585,135);	//HORIZONTAL
		$io_pdf->line(15,85,585,85);	// SEGUNAD LINEA HORIZONTAL	
		$io_pdf->addText(25,140,7,"UNIDAD SOLICITANTE"); // Agregar el título
		$io_pdf->addText(150,140,7,"COMPRAS"); // Agregar el título
		$io_pdf->line(110,60,110,150);	//VERTICAL	
		$io_pdf->addText(120,75,7,"LIC. DALIANNY HERNÁNDEZ"); // Agregar el título
		$io_pdf->addText(130,63,7,"COORDINADORA"); // Agregar el título
		$io_pdf->line(225,60,225,150);	//VERTICAL		
		$io_pdf->addText(230,140,7,"PLANIFICACIÓN Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(240,75,7,"T.S.U YASMIN CEBALLOS"); // Agregar el título
		$io_pdf->addText(250,63,7,"COORDINADORA"); // Agregar el título
		$io_pdf->line(350,60,350,150);	//VERTICAL		
		$io_pdf->addText(360,140,7,"ADMINISTRACIÓN Y FINANZAS");
		$io_pdf->addText(365,75,7,"LIC. VIVIANA CASTELLANOS"); // Agregar el título
		$io_pdf->addText(400,63,7,"GERENTE"); // Agregar el título
		$io_pdf->line(480,60,480,150);	//VERTICAL
		$io_pdf->addText(510,75,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(520,140,7,"EMPRESA"); // Agregar el título
		$io_pdf->addText(455,63,7,""); // Agregar el título
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(8,7,3,3); // Configuración de los margenes en centímetros
