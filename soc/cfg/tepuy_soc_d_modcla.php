...
require_once("tepuy_soc_c_modcla.php");
...
$io_modalidad   = new tepuy_soc_c_modcla($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SOC";
	$ls_ventanas = "tepuy_soc_d_modcla.php";
	...
	for ($i=1;$i<=5;$i++)
		{
		  ...
		  $object[$i][3]="<a href=javascript:uf_delete(".$i.");><img src=../../shared/imagebank/tools20/eliminar.png alt=Aceptar width=15 height=15 border=0></a>";
		}
	$total=5;	
    }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
              ...
              for ($i=1;$i<=$totrow;$i++)	   	   
                  {							                  
			        ...
			        $object[$i][2]="<input name=txtdencla".$li_row." type=text  id=txtdencla".$li_row."  class=sin-borde  size=30 style=text-align:center  value='".$ls_dencla."' readonly>";
		   	        $object[$i][3]="<a href=javascript:uf_delete(".$li_row.");><img src=../../shared/imagebank/tools20/eliminar.png alt=Aceptar width=15 height=15 border=0></a>";
                  }           
            }
         else
            {
	   ...
	   {     
          ...
          for($i=1;$i<=$total;$i++)
          {
			 ...
			 else
			 {
                 $object[$i][1]="<input type=text name=txtcodcla".$i." value='' class=sin-borde readonly  style=text-align:center  size=5>";
				 $object[$i][2]="<input type=text name=txtdencla".$i." value='' class=sin-borde readonly  style=text-align:center  size=30>";
				 $object[$i][3]="<a href=javascript:uf_delete(".$i.");><img src=../../shared/imagebank/tools20/eliminar.png alt=Aceptar width=15 height=10 border=0></a>";			 
			 }
          }       
       }
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
<table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
      ...
      <tr>
        <td height="22" colspan="2"><a href="javascript:uf_cat_clausulas();"><img src="../../shared/imagebank/tools20/nuevo.png" width="20" height="20" border="0" alt="Registrar Detalles Contables">Agregar Clausulas </a>
...
function uf_cat_clausulas()
{
	...
	pagina="tepuy_cat_dt_clausulas.php";
...
function ue_nuevo()
{
	...
	if (li_incluir==1)
	   {	
		 ...
		 f.action="tepuy_soc_d_modcla.php";
		 f.submit();
	   }
	else
	   {
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
	     f.operacion.value="";			
	     pagina="tepuy_soc_cat_modalidad.php";
