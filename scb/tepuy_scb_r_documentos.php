...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_documentos.php",$ls_permisos,$la_seguridad,$la_permisos);
$ls_reporte   = $io_fun_banco->uf_select_config("SCB","REPORTE","LISTADO_MOVBCO","tepuy_scb_rpp_documentos_pdf.php","C");//print $ls_reporte;
$li_diasem = date('w');
switch ($li_diasem){
...
<!--  <tr>
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_imprimir();"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" title="Imprimir" width="20" height="20" border="0"></a><a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.png" alt="Excel" title="Excel" width="20" height="20" border="0"></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" title="Salir" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/ayuda.png" alt="Ayuda" title="Ayuda" width="20" height="20"></td>
  </tr>
</table>
  <?Php
...
function uf_load_documentos($as_codemp,$as_codban,$as_ctaban,$as_codope,$as_conmov,$as_fecdes,$as_fechas,$as_estmov,$as_orden,&$lb_valido)
{
  ...
  $ls_sql  = "SELECT M.codemp,M.codban,M.ctaban,M.numdoc,M.codope,M.estmov,M.cod_pro,M.ced_bene,M.tipo_destino,
               ...
               WHERE M.codemp='".$as_codemp."' 
			     AND M.codban='".$as_codban."' 
				 AND M.ctaban='".$as_ctaban."'
				 AND M.codope<>'OP' $ls_straux 
				 AND M.codban=B.codban
				 AND M.codemp=B.codemp
  ...
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td height="22" colspan="3" align="center"><div align="left">
        ...
        <a href="javascript:cat_conceptos();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Cuentas Bancarias"></a></div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <p align="right"><a href="javascript:ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0">Buscar</a></p></td>
    </tr>
  </table>
		       ...
		       while ($row=$io_sql->fetch_row($rs_data))
		             {
				       ...
				       $ls_fecmov = $io_funcion->uf_convertirfecmostrar($row["fecmov"]);
	                   ...
	                   $object[$li_fila][5]="<input type=text id=txtmonto".$li_fila."  name=txtmonto".$li_fila."  value='".$ld_monmov."'  class=sin-borde  size=20  style=text-align:right  readonly>";
				     }
 ...
 function currencyDate(date)
  { 
	...
	function cat_conceptos()
	{
	   ...
	   pagina="tepuy_cat_conceptos.php?codope="+ls_codope;
	   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=516,height=400,resizable=yes,location=no");
	}
  ...
  if (li_leer==1)
	 {
	   ...
	   if (ls_codban=="" || ls_ctaban=="")
	      ...
	      {
            f.operacion.value = "BUSCAR";
            f.action          = "tepuy_scb_r_documentos.php";
			f.submit();
		  }
	}
  else
  ...
  if (li_imprimir=='1')
     {
	   ...
	   if (ls_codban=="" || ls_ctaban=="" || ls_nomban=="")
	      ...
	      {
 	        pagina="reportes/tepuy_scb_rpp_documentos_excel.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codope="+ls_codope+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&codconcep="+ls_concepto+"&orden="+ls_orden+"&hidestmov="+ls_estmov+"&nomban="+ls_nomban+"&tiporeporte="+ls_tiporeporte;
	        window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		  }  
	 }
  else
