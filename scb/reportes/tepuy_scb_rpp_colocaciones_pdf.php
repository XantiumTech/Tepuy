<?PHP
	...
	function uf_print_encabezado_pagina($as_titulo,$as_periodo,&$io_pdf)
	{
		...
		//     Modificaco por: Ing. Laura Cabré
		// Fecha Creación: 25/04/2006
		// Fecha de Modificacion: 08/01/2007 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//							  array('item'=>'<b>Total Créditos:</b>','saldo'=>$ldec_haber),
	//						  array('item'=>'<b>Saldo Actual:</b>','saldo'=>$ldec_saldoactual));//
		/*$la_data=array(array('fecha'=>'','operacion'=>'','numdoc'=>'','beneficiario'=>'<b>Totales:</b>','debito'=>$ldec_debe,'credito'=>$ldec_haber));							  
		$la_columna=array('fecha'=>'','operacion'=>'','numdoc'=>'','beneficiario'=>'','debito'=>'','credito'=>'');
				$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('fecha'=>array('justification'=>'center','width'=>60),'operacion'=>array('justification'=>'center','width'=>70),
						 			   'numdoc'=>array('justification'=>'center','width'=>90),'beneficiario'=>array('justification'=>'right','width'=>120),
									   'debito'=>array('justification'=>'right','width'=>90),'credito'=>array('justification'=>'right','width'=>90))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);	
		$io_pdf->ezText('                     ',10);//Inserto una linea en blanco*/
	...
	$data=$class_report->uf_generar_estado_cuenta($ls_codban,$ls_ctaban,$ls_orden,$ld_fecdesde,$ld_fechasta,&$ldec_saldoant,&$ldec_total_debe,&$ldec_total_haber,false);
	$ds_edocta->data=$data;
