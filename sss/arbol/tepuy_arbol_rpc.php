...
$arbol["nombre_fisico"][$i]="tepuy_rpc_d_clasificacion.php";
$arbol["id"][$i]="002";
$arbol["padre"][$i]="001";
...
$arbol["nombre_fisico"][$i]="tepuy_rpc_d_documento.php";
$arbol["id"][$i]="003";
$arbol["padre"][$i]="001";
$arbol["numero_hijos"][$i]=0;
...
$arbol["nombre_fisico"][$i]="tepuy_rpc_d_especialidad.php";
$arbol["id"][$i]="004";
$arbol["padre"][$i]="001";
$arbol["numero_hijos"][$i]=0;
...
$arbol["nombre_fisico"][$i]="tepuy_rpc_d_tipoempresa.php";
$arbol["id"][$i]="005";
$arbol["padre"][$i]="001";
$arbol["numero_hijos"][$i]=0;
...
$arbol["nombre_fisico"][$i]="tepuy_rpc_d_proveedor.php";
$arbol["id"][$i]="006";
$arbol["padre"][$i]="001";
$arbol["numero_hijos"][$i]=0;
...
$arbol["sistema"][$i]="RPC";
$arbol["nivel"][$i]=0;
$arbol["nombre_logico"][$i]="Transferencia";
$arbol["nombre_fisico"][$i]="";
$arbol["id"][$i]="015";
$arbol["padre"][$i]="000";
$arbol["numero_hijos"][$i]=1;
...
$arbol["nombre_fisico"][$i]="tepuy_rpc_p_transferencia.php";
$arbol["id"][$i]="016";
$arbol["padre"][$i]="015";
$arbol["numero_hijos"][$i]=0;
...
$arbol["nombre_fisico"][$i]="tepuy_rpc_r_beneficiario.php";
$arbol["id"][$i]="010";
$arbol["padre"][$i]="009";
$arbol["numero_hijos"][$i]=0;
...
$arbol["nivel"][$i]=1;
$arbol["nombre_logico"][$i]="Proveedores";
$arbol["nombre_fisico"][$i]="tepuy_rpc_r_provxespecia.php";
$arbol["id"][$i]="011";
$arbol["padre"][$i]="009";
$arbol["numero_hijos"][$i]=0;
...
$arbol["nombre_fisico"][$i]="tepuy_rpc_d_socio.php";
$arbol["id"][$i]="012";
$arbol["padre"][$i]="001";
$arbol["numero_hijos"][$i]=0;
...
$arbol["nombre_fisico"][$i]="tepuy_rpc_w_proxcla.php";
$arbol["id"][$i]="013";
$arbol["padre"][$i]="001";
$arbol["numero_hijos"][$i]=0;
...
$arbol["nombre_fisico"][$i]="tepuy_rpc_w_proxdoc.php";
$arbol["id"][$i]="014";
$arbol["padre"][$i]="001";
$arbol["numero_hijos"][$i]=0;
...
$arbol["nombre_fisico"][$i]="tepuy_rpc_w_proxesp.php";
$arbol["id"][$i]="014";
$arbol["padre"][$i]="001";
$arbol["numero_hijos"][$i]=0;
$gi_total=$i;
