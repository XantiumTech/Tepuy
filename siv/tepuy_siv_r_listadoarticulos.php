...
$io_fun_activo->uf_load_seguridad("SIV","tepuy_siv_r_listadoarticulos.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
      ...
      <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td height="22"><input name="txtcodalm" type="text" id="txtcodalm" size="24" style="text-align:center">
            <a href="javascript:uf_catalogoalmacen('txtcodalm','txtdenalm');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
        ...
        <tr>
          ...
          <td height="22"><input name="txtcodtipart" type="text" id="txtcodtipart"  style="text-align:center" size="24">
            <a href="javascript:uf_catalogotipoarticulo('txtcodtipart','txtdentipart');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
	...
	?>
        <tr>
          ...
          <td height="22"><input name="txtcodcatsig" type="text" id="txtcodcatsig"  style="text-align:center" size="24">
            <a href="javascript:uf_catalogosigecof();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
<script language="JavaScript">
	...
	{
		window.open("tepuy_catdinamic_almacend.php?coddestino="+ ls_coddestino +"&dendestino="+ ls_dendestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
	}
	...
	{
		window.open("tepuy_siv_cat_sigecof.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
	}
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			window.open("reportes/tepuy_siv_rpp_listadoarticulos.php?orden="+li_orden+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&codsigecof="+ls_codsigecof+"&codalm="+ls_codalm+"&codtipart="+ls_codtipart+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			f.action="tepuy_siv_r_inventario.php";
		}
		else
