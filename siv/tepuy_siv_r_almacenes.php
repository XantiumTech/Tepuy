...
$io_fun_activo->uf_load_seguridad("SIV","tepuy_siv_r_almacenes.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<script language="JavaScript">
	...
	{
		window.open("tepuy_catdinamic_almacend.php?coddestino="+ ls_coddestino +"&dendestino="+ ls_dendestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=700,height=400,left=120,top=70,location=no,resizable=yes");
	}
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			window.open("reportes/tepuy_siv_rpp_almacenes.php?ordenalm="+li_ordenalm+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			f.action="tepuy_siv_r_almacenes.php";
		}
		else
		{
