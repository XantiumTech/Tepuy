<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","tepuy_scg_r_libro_diario_legal.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<title>Libro Diario Legal </title>
...
?>		  
  <table width="530" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Libro Diario Legal </td>
    </tr>
  </table>
...
function uf_cambio_meses()
{
	 ...
	 f.action="tepuy_scg_r_libro_diario_legal.php";
	 f.submit();
