...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_separador_programas.php";
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">SEPARADORES DE PROGRAMAS<br>
      </td>
    </tr>
  </table>
      ...
      <td height="40" colspan="3" align="center">      <div align="left">
        <table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="4"><strong class="titulo-celdanew">Sector </strong></td>
            </tr>
          <tr>
            <td width="100"><div align="right"><span class="style1 style14">Sectores</span></div></td>
            <td width="223" height="23"><select name="cmbnivel" id="cmbnivel">
              ...
              <option value="06">Turismo y Recreación</option>
              <option value="08">Educación</option>
              ...
              <option value="13">Desarrollo Social y Participación</option>
...
function ue_showouput()
{
	...
	pagina="reportes/tepuy_spg_rpp_separador_programas.php?cmbnivel="+cmbnivel+"&tipoformato="+tipoformato;
