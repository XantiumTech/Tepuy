<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_r_retencionesislr.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_reporte=$io_fun_cxp->uf_select_config("CXP","REPORTE","FORMATO_RETMUN","tepuy_cxp_rpp_retencionesislr.php","C");
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<body>
<?php
if ($_SESSION["la_empresa"]["modageret"]=="B")
   {
     print "<script>";
     print "alert('Los comprobantes deben ser visualizados a través del módulo de Caja y Banco !!!');";
...
<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="4" align="center">Reporte de Retenciones de Impuestos sobre la Renta </td>
    </tr>
...
function ue_print()
{
	...
	if(li_imprimir==1)
	{
		...
		if(ls_comprobantes!="")
		{
			...
			formato="tepuy_cxp_rpp_retencionislr.php";
...
function ue_search()
{
	...
	ajax.send("catalogo=RETENCIONESISLR&mes="+mes+"&anio="+anio);
}
