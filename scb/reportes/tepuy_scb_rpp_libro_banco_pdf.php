<?PHP
	...
	function uf_print_cabecera($li_totrow,&$io_pdf)
	{
		...
		if($li_totrow>0)
			{
			$la_data[0]=array('fecha'=>'<b>Fecha</b>','operacion'=>'<b>Operación</b>','numdoc'=>'<b>Documento</b>','beneficiario'=>'<b>Proveedor/Beneficiario</b>','descripcion'=>'<b>                         Descripción</b>','debito'=>'<b>Créditos</b>','credito'=>'<b>Débitos</b>','saldo'=>'<b>Saldo</b>');
	...
	if($ls_tiporeporte==1)
	{
		...
		$io_report = new tepuy_scb_reportbsf($io_conect);
		$ls_tipbol = 'Bs.F.';
	}
