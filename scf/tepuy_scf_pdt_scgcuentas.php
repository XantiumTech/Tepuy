...
<table width="650" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="22" colspan="3"><div align="left">
          ...
          <a href="javascript:ue_cuentasscg();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Cuentas de Gastos"></a> 
      ...
      <tr>
        ...
        <a href="javascript: ue_aceptar();"><img src="../shared/imagebank/tools15/aprobado.png" alt="Agregar Detalle Presupuestario" width="15" height="15" border="0"></a> <a href="javascript: ue_cerrar();"><img src="../shared/imagebank/tools15/eliminar.png" width="15" height="15" border="0" alt="Cancelar Registro de Detalle Presupuestario"></a></div></td>
    <tr>
      <td height="22">&nbsp;</td>
      <td colspan="3">&nbsp;</td>
  </table> 
...
{
	f=document.formulario;
	pagina="tepuy_scf_cat_cuentasscg.php";
...
function ue_aceptar()
{
	...
	if(parseFloat(monto)>0)
	{
		...
		if(parametros!="")
		{
			...
			ajax.open("POST","class_folder/tepuy_scf_c_comprobante_ajax.php",true);
