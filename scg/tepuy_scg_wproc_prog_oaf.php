...
if(!array_key_exists("la_logusr",$_SESSION))
{
	...
	$ls_sistema="SCG";
	$ls_ventanas="tepuy_scg_wproc_prog_oaf.php";
...
?>
  ...
  <tr class="fd-blanco">
  <table width="1200" height="351" border="0" align="left" cellpadding="1" cellspacing="1" class="fondo-tabla">
        <tr class="titulo-ventana">
...
function ue_distribuir()
{
   ...
   else
   {
	 ...
	 if  (document.opcion=="M" ) 
     {
		 ...
		 {
			 pagina="tepuy_scg_wdist_manual.php?fila="+i+"&txtAsignado="+f.txtAsignado.value;
   ...
   if (document.opcion=="A")
   {
		 ...
		 {
		   f.operacion.value="DISTRIBUIR";
		   f.action="tepuy_scg_wproc_prog_oaf.php";
		   f.submit();
		 }  
     }
