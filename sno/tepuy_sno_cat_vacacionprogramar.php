<?php
   ...
   function uf_print($as_codper,$as_stavac)
   {
		...
		$ls_sql="SELECT sno_vacacpersonal.codper, sno_vacacpersonal.codvac, sno_vacacpersonal.fecvenvac, sno_vacacpersonal.fecdisvac, ".
				...
				"		sno_vacacpersonal.cod_5, sno_vacacpersonal.nro_dias_5, sno_vacacpersonal.Monto_5, sno_personal.cedper, ".
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				print "'$li_sabdom','$li_diapag','$li_pagcan','$ls_codper','$ls_nomper');\">".$li_codvac."</a></td>";
...
function aceptar(codvac,fecvenvac,fecdisvac,fecreivac,diavac,stavac,sueintbonvac,sueintvac,diabonvac,obsvac,diapenvac,persalvac,
                peringvac,dianorvac,quisalvac,quireivac,diaadivac,diaadibon,diafer,sabdom,diapag,pagcan,codper,nomper)
{
...
{
	window.open("tepuy_sno_cat_personalnomina.php?tipo=catvacacion","_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
}
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="tepuy_sno_cat_vacacionprogramar.php";
  	f.submit();
}
</script>
</html>