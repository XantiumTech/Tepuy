...
// ESTAS LINEAS SON NECESARIAS PARA QUE SE PUEDA MOSTRAR EL PDF //
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->ezSetDy(+13);
		$la_data=array(array('relacion'=>'<b>Item</b>','denominacion'=>'<b>Denominación</b>','ordinario'=>'<b>Presupuesto Ordinario</b>','FIDES'=>'<b>Presupuesto FIDES</b>','LAEE'=>'<b>Presupuesto LAEE</b>','pres_anual'=>'<b>Asignación</b>'));
		$la_columna=array('relacion'=>'','denominacion'=>'','ordinario'=>'','FIDES'=>'','LAEE'=>'','pres_anual'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('relacion'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la 
						 			   'denominacion'=>array('justification'=>'center','width'=>160), // Justificación y ancho de la
						 			   'ordinario'=>array('justification'=>'center','width'=>90), // Justificación y ancho 
						 			   'FIDES'=>array('justification'=>'center','width'=>90), // Justificación y ancho 
						 			   'LAEE'=>array('justification'=>'center','width'=>90), // Justificación y ancho 
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('relacion'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la 
						 			   ...
						 			   'ordinario'=>array('justification'=>'right','width'=>90), // Justificación y ancho 
						 			   'FIDES'=>array('justification'=>'right','width'=>90), // Justificación y ancho 
						 			   'LAEE'=>array('justification'=>'right','width'=>90), // Justificación y ancho 
						 			   'pres_anual'=>array('justification'=>'right','width'=>90))); // Justificación y ancho 
		$la_columnas=array('relacion'=>'<b>Item</b>','denominacion'=>'<b>Denominación</b>','ordinario'=>'<b>Presupuesto Ordinario</b>',
						   'FIDES'=>'<b>Presupuesto FIDES</b>','LAEE'=>'<b>Presupuesto LAEE</b>','pres_anual'=>'<b>Asignado</b>');
	...
	function uf_print_pie_cabecera($la_data_tot,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'right','width'=>190), // Justificación y ancho de la columna
									   ...
									   'ordinario'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
									   'FIDES'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
									   'LAEE'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
									   'pres_anual'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de la columna
		
		$la_columnas=array('total'=>'','ordinario'=>'','FIDES'=>'','LAEE'=>'','pres_anual'=>'');
	...
	function uf_insert_seguridad()
	{
	    ...
	    $ls_evento      = "IMPRIMIR";
	    $ls_descripcion = "Imprimio Relación Global de Proyectos";
...
//-----------------------------------------------------------------------------------------------------------------------------
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
		if($li_cmbnivel==0)
		{
			$ls_titulo=" <b> RELACION GLOBAL DE PROYECTOS </b>";
		}
		if($li_cmbnivel==1)
		{
			$ls_titulo=" <b> RELACIÓN GLOBAL DE PROYECTOS FINANCIADOS CON PRESUPUESTO ORDINARIO </b>";
		}
		if($li_cmbnivel==2)
		{
			$ls_titulo=" <b> RELACIÓN GLOBAL DE PROYECTOS FINANCIADOS POR FIDES </b>";
			$ls_fuente="04";
		}
		if($li_cmbnivel==3)
		{
			$ls_titulo=" <b> RELACIÓN GLOBAL DE PROYECTOS FINANCIADOS POR LAEE </b>";
			$ls_fuente="05";
		}
	...
	if ($lb_valido)
	   {*/
         ...
         $lb_valido=$io_report->uf_spg_reportes_distribucion_proyectos($li_cmbnivel,$cuenta_inversion,$ls_fuente);
			  ...
			  for ($z=1;$z<=$li_total;$z++)
			      {
					...
					$ld_ordinario=$io_report->dts_reporte->data["ordinario"][$z];
					$ld_FIDES=$io_report->dts_reporte->data["FIDES"][$z];
					$ld_LAEE=$io_report->dts_reporte->data["LAEE"][$z];
					...
					$ld_pres_anual=$ld_ordinario+$ld_FIDES+$ld_LAEE;  //programado de los meses
					$ld_total_ordinario=$ld_total_ordinario+$ld_ordinario;  //programado de los meses
					$ld_total_FIDES=$ld_total_FIDES+$ld_FIDES;  //programado de los meses
					$ld_total_LAEE=$ld_total_LAEE+$ld_LAEE;  //programado de los meses
					$ld_total_pres_anual=$ld_total_pres_anual+$ld_ordinario+$ld_FIDES+$ld_LAEE;



					$ld_pres_anual=number_format($ld_pres_anual,2,",",".");
					$ld_ordinario=number_format($ld_ordinario,2,",",".");
					$ld_LAEE=number_format($ld_LAEE,2,",",".");
					$ld_FIDES=number_format($ld_FIDES,2,",",".");

					$la_data[$z]=array('relacion'=>$z,'denominacion'=>$ls_denominacion,'ordinario'=>$ld_ordinario,'FIDES'=>$ld_FIDES,'LAEE'=>$ld_LAEE,'pres_anual'=>$ld_pres_anual);

					$ld_pres_anual=str_replace('.','',$ld_pres_anual);
					$ld_ordinario=str_replace('.','',$ld_ordinario);
					$ld_FIDES=str_replace('.','',$ld_FIDES);
					$ld_LAEE=str_replace('.','',$ld_LAEE);
					...
					if($z==$li_total)
					{
						 if($ls_tipoformato==1)
						 {
							...
							$ld_total_ordinario=number_format($ld_total_ordinario,2,",",".");
							$ld_total_FIDES=number_format($ld_total_FIDES,2,",",".");
							$ld_total_LAEE=number_format($ld_total_LAEE,2,",",".");

						 	 $la_data_tot[$z]=array('total'=>'<b>TOTAL BsF.</b>','ordinario'=>$ld_total_ordinario,'FIDES'=>$ld_total_FIDES,'LAEE'=>$ld_total_LAEE,'pres_anual'=>$ld_total_pres_anual);
