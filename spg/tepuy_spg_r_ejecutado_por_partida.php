...
if (!array_key_exists("la_logusr",$_SESSION))
   ...
   //////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_ejecutado_por_partida.php";
...
<!--  <tr> 
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_imprimir();"><img src="../shared/imagebank/tools20/imprimir.png" width="20" height="20" border="0"></a>
	</a><a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.png" alt="Excel" width="20" height="20" border="0"></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a>
...
function ue_imprimir()
{
	...
	if(li_imprimir==1)
	{
		...
		else
		{
			...
			{
				pagina="reportes/tepuy_spg_rpp_ejecutado_por_partida_waryna.php?txtcuentades="+txtcuentades
...
function ue_openexcel()
{
	...
	if(li_imprimir==1)
	{
		...
		else
		{
			...
			{
				pagina="reportes/tepuy_spg_rpp_ejecutado_por_partida_excel.php?txtcuentades="+txtcuentades
				+"&txtcuentahas="+txtcuentahas+"&txtfecdes="+txtfecdes+"&txtfechas="+txtfechas;
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}	
		}	
