...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_tipos_bien.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <td colspan="2"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
            ...
            <tr>
              ...
              <td height="22"><input name="txtcodpro" type="text" id="txtcodpro" size="15"  style="text-align:center" readonly>
                  <a href="javascript: uf_proveedor('txtcodpro','txtdenpro');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
            ...
            <tr>
              ...
              <td height="22"><input name="txtcodhasp" type="text" id="txtcodhasp" size="15"  style="text-align:center" readonly>
                  <a href="javascript: uf_proveedor('txtcodhasp','txtnomp');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
    ...
    <tr>
      ...
      <td height="13" colspan="3" align="center"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
...
<script language="JavaScript">
	...
	{
		window.open("tepuy_catdinamic_prov.php?coddestino1="+ ls_coddestino +"&dendestino1="+ ls_dendestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,left=120,top=70,location=no,resizable=yes");
	}
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/tepuy_saf_rpp_tipo_bien.php?ordenact="+li_ordenact+"&desde="+ld_desde+
				...
				f.action="tepuy_siv_r_tipos_bien.php";
