<?php
class tepuy_soc_c_aprobacion_orden_compra
{
  function tepuy_soc_c_aprobacion_orden_compra($as_path)
  {
	////////////////////////////////////////////////////////////////////////////////////////////////////
	//	     Function: tepuy_soc_c_aprobacion_orden_compra
	//		   Access: public 
	//	  Description: Constructor de la Clase
	//	   Creado Por: Ing. Miguel Palencia.
	// Fecha Creación: 29/05/2015 								Fecha Última Modificación : 29/05/2015 
	////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_load_ordenes_compra($as_numordcom,$as_codpro,$ad_fecdes,$ad_fechas,$as_tipordcom,$as_tipope)
	{
		...
		//	   Creado Por: Ing. Miguel Palencia.
		// Fecha Creación: 16/05/2015								Fecha Última Modificación : 16/05/2015
		////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido = true;
        $ls_straux = "";
		...
		$ls_sql ="SELECT soc_ordencompra.numordcom,soc_ordencompra.fecordcom,".
				 ...
				 "   AND (soc_ordencompra.estcom='1' OR soc_ordencompra.estcom='0') ".
				 "   $ls_straux											     ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->tepuy_soc_c_aprobacion_orden_compra.php->MÉTODO->uf_load_ordenes_compra.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		return $rs_data;
	...
	//	  Description: Función que recorre el grid de las ordenes de compra que esten dispuestas para Aprobacion/Reverso.
	//	   Creado Por: Ing. Miguel Palencia.
	// Fecha Creación: 02/06/2015								Fecha Última Modificación : 02/06/2015
	//////////////////////////////////////////////////////////////////////////////
	  ...
	  $ls_sql    = "UPDATE soc_ordencompra
					 ...
					 WHERE codemp='".$this->ls_codemp."'
					   ...
					   AND (estcom='1' OR estcom='0') ";
					   // el estcom=0 es cuando viene de ser generada
					   //print $ls_sql;
	  $rs_data   = $this->io_sql->execute($ls_sql);
	  if ($rs_data===false)
		 {
		   $lb_valido=false;
		   $this->io_mensajes->message("CLASE->tepuy_soc_c_aprobacion_orden_compra; METODO->uf_update_estatus_aprobacion;ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));	
		 }
	  else
		 {
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
