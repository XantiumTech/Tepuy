...
<title>EJECUCI&Oacute;N DE GASTOS ESPEC&Iacute;FICOS DE PERSONAL,</title>
...
<form name="form1" method="post" action="">
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">EJECUCI&Oacute;N DE GASTOS ESPEC&Iacute;FICOS DE PERSONAL,<br>
      MATERIALES, SERVICIOS Y TRANSFERENCIAS.</td>
    </tr>
  </table>
...
function ue_showouput()
{
	...
	if(estmodest==1)
	{
		...
		else
		{
		   ...
		   pagina="reportes/tepuy_spg_rpp_comparados_forma0514.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1+"&codestpro2="+codestpro2
	...
	else
	{
		...
		else
		{
		   ...
		   pagina="reportes/tepuy_spg_rpp_comparados_forma0514.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1+"&codestpro2="+codestpro2
		   +"&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&codestpro5="+codestpro5+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h
		   +"&codestpro3h="+codestpro3h+"&codestpro4h="+codestpro4h+"&codestpro5h="+codestpro5h+"&tipoformato="+tipoformato
