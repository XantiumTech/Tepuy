<?php
class tepuy_soc_c_clausulas
{

var $ls_sql;
var $is_msg_error;
	
	function tepuy_soc_c_clausulas($conn)
	{
...
//////////////////////////////////////////////////////////////////////////////  
	  ...
	  if ($rs_data===false)		     
		 {
		   $lb_valido=false;
		   $this->io_msg->message("CLASE->tepuy_SOC_C_CLAUSULAS; METODO->uf_insert_tiposervicio; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		 }
	  else
		 {
		   $lb_valido=true;
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
     {
       $lb_valido=false;
       $this->io_msg->message("CLASE->tepuy_SOC_C_CLAUSULAS; METODO->uf_delete_clausula; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
     }
  else
     {
		$lb_valido=true;
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
	 {
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->tepuy_SOC_C_CLAUSULAS; METODO->uf_select_clausula; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
