...
$ls_sql    = " SELECT a.*,b.denominacion FROM tepuy_deducciones a,scg_cuentas b                ".
	 ...
	 for ($z=1;$z<=$totrow;$z++)
		 {
		    ...
		    print "<td style=text-align:center><a href=\"javascript: aceptar('$ls_codded','$ls_dended','$ld_porded','$ls_cuenta','$ls_dencue','$ld_monded','$ls_forded','$ls_tipded','$tipopersdeduccion','$ls_codseniat','$cubretotal');\">".$ls_codded."</a></td>";
...
<script language="JavaScript">
  function aceptar(codigo,denominacion,porcentaje,cuenta,denocuenta,deducible,formula,tipodeduccion,tipopersdeduccion,codseniat,cubretotal)
  {
	//alert(cubretotal);
    	opener.document.form1.txtcodigo.value=codigo;
	opener.document.form1.txtcodigo.readOnly=true;
	opener.document.form1.txtcodseniat.value=codseniat;
	opener.document.form1.chkcubretotal.value = cubretotal;
    	if (cubretotal==1)
	   {
	     opener.document.form1.chkcubretotal.checked = true;
	   }
	else
	   {
	     opener.document.form1.chkcubretotal.checked = false;
	   }  
	...
	if (tipodeduccion=="S")
	   {
		...
		// opener.document.form1.radiotipoperdeduccion[0].disabled=false;
	     //opener.document.form1.radiotipoperdeduccion[1].disabled=false;
	   }
	else   
	if (tipodeduccion=="I")
	   {
