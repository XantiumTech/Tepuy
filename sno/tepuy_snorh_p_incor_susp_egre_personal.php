<?php
	...
	$io_fun_nomina->uf_load_seguridad("SNR","tepuy_snorh_p_incor_susp_egre_personal.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
        ...
        <td width="613" valign="top">
		  ...
		  <table width="510" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
              ...
              <tr>
                ...
                <td colspan="5"><div align="left">
                  <input name="txtfecegrper" type="text" id="txtfecegrper2"  onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" value="<?php print $ldt_fecegrper; ?>" size="15" maxlength="15" datepicker="true">
                  </div></td>
              </tr>
              <tr>
			  <?php
...
function uf_change_radio()
{
	...
	f.action="tepuy_snorh_p_incor_susp_egre_personal.php";
	f.submit();
}		
