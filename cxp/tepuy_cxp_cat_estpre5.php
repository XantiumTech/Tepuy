...
function aceptar(codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,denestpro1,denestpro2,denestpro3,denestpro4,denestpro5)
{
...
function ue_search()
{
	...
	ajax.send("catalogo=ESTRUCTURA5&codestpro1="+codestpro1+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+
			  "&codestpro4="+codestpro4+"&codestpro5="+codestpro5+"&denestpro5="+denestpro5+"&tipo="+tipo+
