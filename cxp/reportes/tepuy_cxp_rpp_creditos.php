...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_cxp->uf_load_seguridad_reporte("CXP","tepuy_cxp_r_listados.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_detalle($la_data,$as_titcuentas,$ai_i,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codcar'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
						 			   'dencar'=>array('justification'=>'center','width'=>170), // Justificación y ancho de la columna
						 			   ...
						 			   'porcar'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codcar'=>array('justification'=>'left','width'=>40), // Justificación y ancho de la columna
						 			   'dencar'=>array('justification'=>'left','width'=>170), // Justificación y ancho de la columna
						 			   'codestpro'=>array('justification'=>'center','width'=>160), // Justificación y ancho de la columna
						 			   'spg_cuenta'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'porcar'=>array('justification'=>'right','width'=>40), // Justificación y ancho de la columna
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$la_data[$li_i]=array('codcar'=>$ls_codcar,'dencar'=>$ls_dencar,'codestpro'=>$ls_codestpro,
