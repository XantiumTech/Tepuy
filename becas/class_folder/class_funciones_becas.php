<?php
class class_funciones_becas
{
	function class_funciones_becas()
	{
		//////////////////////////////////////////////////////////////////////////////
...
/*		if (empty($as_valor))
   ...
   //----------------------------------------------------------------------------------------------------------------------------
   function uf_load_seguridad_reporte_becas($as_sistema,$as_ventanas,$as_descripcion,$as_nomina)
   {
		//////////////////////////////////////////////////////////////////////////////
   ...
   //-----------------------------------------------------------------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
   	function uf_formatoprogramatica($as_codpro,&$as_programatica)
   	{
		...
		$ls_codest1=substr($as_codpro,0,20);
		$ls_codest2=substr($as_codpro,20,6);
		$ls_codest3=substr($as_codpro,26,3);
		$ls_codest4=substr($as_codpro,29,2);
		$ls_codest5=substr($as_codpro,31,2);
		$ls_codest1=substr($ls_codest1,(20-$li_len1),$li_len1);
		$ls_codest2=substr($ls_codest2,(6-$li_len2),$li_len2);
		$ls_codest3=substr($ls_codest3,(3-$li_len3),$li_len3);
		$ls_codest4=substr($ls_codest4,(2-$li_len4),$li_len4);
		$ls_codest5=substr($ls_codest5,(2-$li_len5),$li_len5);		
		switch($ls_modalidad)
		{
			case "1": // Modalidad por Proyecto
