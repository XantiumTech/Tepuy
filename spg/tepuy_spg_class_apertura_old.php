...
/***************************************************************************************************************************************/
class tepuy_spg_class_apertura // extends class_tepuy_int_spg
{
   var $int_spg;
...
/***************************************************************************************************************************************/
  function uf_spg_select_modalidad_apertura($as_codemp,&$as_estmodape)
  {
	 ...
	 $lb_valido=true;
     $ls_sql=" SELECT estmodape FROM tepuy_empresa s where codemp='".$as_codemp."' ";
...
function uf_spg_procesar_apertura($aa_seguridad)
{
	...
	{
	   $lb_valido = $this->sig_int->uf_tepuy_insert_comprobante( $this->is_codemp,$this->is_procedencia,$this->is_comprobante,$this->ldt_fecha,$this->ii_tipo_comp,$this->is_descripcion,$this->is_tipo,$this->is_cod_prov,$this->is_ced_ben );
	   if ($lb_valido)
	   { 
		 //////////////////////////////////         SEGURIDAD               ////////////////////////////////////////////////////////////////		
		   $ls_evento="INSERT";
