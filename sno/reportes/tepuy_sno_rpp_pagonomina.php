<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_periodo,&$io_pdf)
	{
		...
		$io_pdf->addText(50,714,6,"RIF-".$ls_rif); // Agregar el título 3
...
//		$la_data=array(array('programatica'=>'<b>Categoria prográmatica</b>','cuenta'=>'<b>Partida Presupuestaria </b>','denominacion'=>'<b>Denominación</b>','monto'=>'<b>Monto a Imputar Bs.</b>'));
		...
		$la_columnas1=array('programatica'=>'<b>Programatica</b>',
						   'cuenta'=>'<b>Cuentas</b>',
						   'denominacion'=>'<b>Denomnación</b>',
		...
		$la_config1=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('programatica'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'cuenta'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'center','width'=>270),// Justificación y ancho de la columna
...
//////////////////////////////////////////////////////////////////////////////
	...
	else // Imprimimos el reporte
	{
		...
		//$io_pdf->openHere('XYZ', 600, 800, 5); // INICIA EN LA PAGINA INDICADA
		...
		$io_report->uf_cargar_presupuesto_aporte_deducciones($tabla_aporte_deducciones,"sno_salida","tipsal","valsal");
		$io_report->uf_cargar_presupuesto_asignaciones($tabla_asignaciones,"sno_salida","tipsal","valsal");
