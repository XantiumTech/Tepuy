...
/********************************************************************************************************************************/	
class tepuy_spg_reporte_nuevos
{
    //conexion	
	var $sqlca;   
...
/********************************************************************************************************************************/	
    function  tepuy_spg_reporte_nuevos()
    {
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    01/02/2006          Fecha última Modificacion : 01/02/2006 Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$as_codestpro1_ori  = $this->fun->uf_cerosizquierda($as_codestpro1_ori,20);
		$as_codestpro2_ori  = $this->fun->uf_cerosizquierda($as_codestpro2_ori,6);
		$as_codestpro3_ori  = $this->fun->uf_cerosizquierda($as_codestpro3_ori,3);
		$as_codestpro4_ori  = $this->fun->uf_cerosizquierda($as_codestpro4_ori,2);
		$as_codestpro5_ori  = $this->fun->uf_cerosizquierda($as_codestpro5_ori,2);
		
		$as_codestpro1_des  = $this->fun->uf_cerosizquierda($as_codestpro1_des,20);
		$as_codestpro2_des  = $this->fun->uf_cerosizquierda($as_codestpro2_des,6);
		$as_codestpro3_des  = $this->fun->uf_cerosizquierda($as_codestpro3_des,3);
		$as_codestpro4_des  = $this->fun->uf_cerosizquierda($as_codestpro4_des,2);
		$as_codestpro5_des  = $this->fun->uf_cerosizquierda($as_codestpro5_des,2);
...
/********************************************************************************************************************************/	
	...
	function uf_spg_reporte_select_programatica_acumulado_formato2($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,
											         ...
											         $as_codestpro4_des,$as_codestpro5_des,$adt_fecini,$adt_fecfin,$ai_nivel,
											         $ab_subniveles,&$ai_MenorNivel,$as_cuentades,$as_cuentahas,
											         $as_codfuefindes,$as_codfuefinhas,&$rs_data)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    16/05/2006          Fecha última Modificacion :         Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (strtoupper($ls_gestor)=="MYSQL")
		{
			 $ls_str_sql = "CONCAT(PCT.codestpro1,PCT.codestpro2,PCT.codestpro3,PCT.codestpro4,PCT.codestpro5)";
		}
		else
		{
			 $ls_str_sql = "PCT.codestpro1||PCT.codestpro2||PCT.codestpro3||PCT.codestpro4||PCT.codestpro5";
		}
