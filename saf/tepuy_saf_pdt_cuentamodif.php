...
<form name="form1" method="post" action="">
  <table width="525" border="0" align="center" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="103"><a href="javascript: ue_agregar();"><img src="../shared/imagebank/tools15/aprobado.png" width="15" height="15" class="sin-borde">Agregar Detalle</a> </td>
      <td width="76"><a href="javascript: ue_cancelar();"><img src="../shared/imagebank/tools15/eliminar.png" width="15" height="15" class="sin-borde">Cancelar</a></td>
    </tr>
  </table>
</form>
</body>
