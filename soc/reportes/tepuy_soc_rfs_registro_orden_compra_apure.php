...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
										...
										$as_diaplacom,$as_seguro,$ad_porseg,$ad_monseg,$ls_forpagcom,$as_conent,$ad_monantpag,$ad_nomusu,&$io_pdf)
	{
        ...
        {
             $ls_titulo="Orden de Servicio xx"; $antes="OS-";
        }
		$tm=230;
...
//FORMATO ALCALDIA DE GUASDUALITO
		...
		$io_pdf->addText(184,118,6,"LIC. ANGELICA BELANDRIA"); // Agregar el título
		$io_pdf->addText(195,165,6,"JEFE DE COMPRAS"); // Agregar el título
		$io_pdf->addText(320,118,6,"LICDA. YURIBETH DAZA"); // Agregar el título
