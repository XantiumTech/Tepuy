...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_cat_revisiones_odi.js"></script>
...
<br>
	  ...
	  <tr>
        ...
        <td height="22" colspan="2"><div align="left">        
		  <input name="txtnroreg" type="text" id="txtnroreg" size=16 readonly  style="text-align:center">
		   <a href="javascript:catalogo_registro_odi();"><img src="../../../../shared/imagebank/tools15/buscar.png"  name="buscartip" width="15" height="15" border="0" id="buscartip"></a>
    ...
    <td width="150"><div align="right"><a href="javascript: Limpiar_busqueda(); "> <img src="../../../public/imagenes/nuevo.png" alt="Limpiar" width="15" height="15" border="0">Limpiar</a></div></td>
    <td width="202"><div align="right"><a href="javascript: Buscar()"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Haga click aqu&iacute; para Buscar</a></div></td>
  </tr>
    </table>
