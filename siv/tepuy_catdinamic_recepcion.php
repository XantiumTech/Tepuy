	...
	if($ls_operacion=="BUSCAR")
	{
		...
		if($li_row>0)
		{
			while($row=$io_sql->fetch_row($rs_cta))
			{
				...
				if($ls_estrevrec=="1")
				{
					print "<td><a href=\"javascript: aceptar('$ls_numconrec','$ls_numordcom','$ls_obsrec','$ls_codpro','$ls_nompro','$ls_codalm','$ls_nomfisalm','$ls_estpro','$ls_estrec','$ls_estrevrec','$ld_fecrec');\">".$ls_numordcom."</a></td>";
				}
				else
				{
				...
				if($ls_estrevrec=="0")
				{
					print "<td><a href=\"javascript: aceptar_copiar_reverso('$ls_numconrec','$ls_numordcom','$ls_obsrec','$ls_codpro','$ls_nompro','$ls_codalm','$ls_nomfisalm','$ls_estpro','$ls_estrec','$ls_estrevrec','$ld_fecrec');\"><img src=../shared/imagebank/tools15/aprobado.png alt=Aceptar title='Copiar el Reverso' width='15' height='15' border=0></a></td>";
				}
				else
				{
					print "<td><img src=../shared/imagebank/tools15/aprobado-off.png alt='Aceptar' width='15' height='15' border=0></a></td>";
				}
				print "</tr>";			
			}
		}
...
<script language="JavaScript">
	function aceptar(ls_numconrec,ls_numordcom,ls_obsrec,ls_codpro,ls_nompro,ls_codalm,ls_nomfisalm,ls_estpro,ls_estrec,ls_estrevrec,ld_fecrec)
	{ 
		...
		opener.document.form1.action="tepuy_siv_p_recepcion.php";
		opener.document.form1.submit();
		close();
	}
	
	function aceptar_copiar_reverso(ls_numconrec,ls_numordcom,ls_obsrec,ls_codpro,ls_nompro,ls_codalm,ls_nomfisalm,ls_estpro,ls_estrec,ls_estrevrec,ld_fecrec)
	{ 
		opener.document.form1.txtnumconrec.value=ls_numconrec;
		opener.document.form1.txtnumordcom.value=ls_numordcom;
		opener.document.form1.txtcodpro.value=ls_codpro;
	...
	function ue_search()
  	{
		...
		f.action="tepuy_catdinamic_recepcion.php";
		f.submit();
	}
</script>
