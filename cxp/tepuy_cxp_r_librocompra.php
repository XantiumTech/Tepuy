<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_r_librocompra.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
function uf_imprimir()
{
	...
	if(li_imprimir==1)
	{
		...
		pagina = "reportes/tepuy_cxp_rpp_librocompra_barinas.php?mes="+ls_mes+"&agno="+ls_agno+"&tiporeporte="+tiporeporte;
...
function ue_openexcel()
{
	...
	if(li_imprimir==1)
	{
		...
		// El de arriba es el formato original de Libro Compras y el de abajo el solicitado por Mayra (Barvialsa)
		pagina = "reportes/tepuy_cxp_rpp_librocompra_excel_barinas.php?mes="+ls_mes+"&agno="+ls_agno;
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	}
	else
	{
