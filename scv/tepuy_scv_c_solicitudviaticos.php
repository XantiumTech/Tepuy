...
class tepuy_scv_c_solicitudviaticos
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_scv_c_solicitudviaticos()
	{
	...
	function  uf_scv_insert_solicitudviatico($as_codemp,&$as_codsolvia,$as_codmis,$as_codrut,$as_coduniadm,$ad_fecsalvia,
	...
	function uf_scv_update_solicitudviatico($as_codemp,$as_codsolvia,$as_codmis,$as_codrut,$as_coduniadm,$ad_fecsalvia,
											$ad_fecregvia,$ad_fecsolvia,$ai_numdiavia,$as_obssolvia,$ai_solviaext,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function  uf_scv_insert_dt_personal($as_codemp,$as_codsolvia,$as_codper,$as_codclavia,$as_codnom,$aa_seguridad)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_codclavia=str_replace('.','',$as_codclavia);
		$ls_sql = "INSERT INTO scv_dt_personal (codemp,codsolvia,codper,codclavia,codnom) ".
				  "     VALUES('".$as_codemp."','".$as_codsolvia."','".$as_codper."','".$ls_codclavia."','".$as_codnom."')";
		$li_row=$this->io_sql->execute($ls_sql);
		if($li_row===false)
		{
	...
	function uf_scv_load_dt_asignacion($as_codemp,$as_codsolvia,&$ai_totrows,&$ao_object)
	{
		...
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ao_object[$ai_totrows][5]="<a href=javascript:uf_delete_dt_asignaciones(".$ai_totrows.");><img src=../shared/imagebank/tools15/eliminar.png alt=Eliminar width=15 height=15 border=0></a>";
...
//					" GROUP BY sno_personalnomina.codper".
		...
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ao_objectpersonal[$ai_totrows][6]="<a href=javascript:uf_delete_dt_personal(".$ai_totrows.");><img src=../shared/imagebank/tools15/eliminar.png alt=Eliminar width=15 height=15 border=0></a>";
