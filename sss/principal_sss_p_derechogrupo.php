...
$io_fun_seguridad->uf_load_seguridad("SSS","tepuywindow_sss_derecho_grupo.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<?php	
	...
	require_once("tepuy_sss_c_derechogrupo.php");
	$io_sss= new tepuy_sss_c_derechogrupo();
	require_once("../shared/class_folder/class_sql.php");
	$ls_nomgru=   $_SESSION["la_gruseg"];
	...
	{	
		...
		$ls_codintper="---------------------------------";
		$la_codintper[1]= "";
		$lb_existe=$io_sss->uf_sss_load_permisos($ls_codemp,$ls_nomgru,$ls_codsis,$ls_nomven,$li_enabled,$li_leer,$li_incluir,
		...
		else
		{
			...
			if($lb_existe)
			{
				if(array_key_exists("radioenable",$_POST))
				{
					...
					if(($ls_codsis=="SNOx")||($ls_codsis=="SPGx"))
					{
					...
					{
						$lb_valido=$io_sss->uf_sss_insert_permisos_internos($ls_codemp,$ls_nomgru,$ls_codsis,$ls_codintper,
																			$la_seguridad);
						$lb_valido=true;
						if($lb_valido)
						{
							$lb_existe=$io_sss->uf_sss_select_derechogrupo($ls_codemp,$ls_nomgru,$ls_codsis,$ls_nomven,$ls_codintper);
							if($lb_existe)
							{
								$lb_valido=$io_sss->uf_sss_update_derechogrupo($ls_codemp,$ls_nomgru,$ls_codsis,$ls_nomven,$li_visible,
							...
							else
							{
								...
								$lb_valido=$io_sss->uf_sss_insert_derechogrupo($ls_codemp,$ls_nomgru,$ls_codsis,$ls_nomven,$li_visible,
																			   $li_habilitada,$li_leer,$li_incluir,$li_cambiar,$li_eliminar,
																			   $li_imprimir,$li_administrador,$li_anular,$li_ejecutar,
																			   $ls_codintper,$la_seguridad);
					...
					if($lb_valido)
					{
						$lb_valido=$io_sss->uf_sss_procesar_usuariosgrupos($ls_codemp,$ls_nomgru,$ls_codsis,$ls_nomven,$li_visible,
																		   $li_habilitada,$li_leer,$li_incluir,$li_cambiar,$li_eliminar,
																		   $li_imprimir,$li_administrador,$li_anular,$li_ejecutar,
																		   $ls_codintper,$la_seguridad);
					}
...
<?php
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	$io_fun_seguridad->uf_print_permisos($ls_permisos,$la_permisos,$ls_logusr,"parent.location.href='tepuywindow_blank.php'");
  ...
  <table width="561" height="195" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="154"><table width="509" height="210" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td height="13" colspan="10"align="center" class="titulo-celdanew"><strong>Propiedades del Grupo <?php print $ls_nomgru; ?></strong></td>
        </tr>
        <tr>
          <td height="18"></td>
        ...
        <tr>
          ...
          <td width="172">
		  <?php
		  if(($ls_codsis=="SOC")||($ls_codsis=="SEP")||($ls_codsis=="CXP"))
		  {
		  ?>
   ...
   var valor = 0; 
	...
	function ue_guardar()
	{
		...
		{	
			...
			f.action="principal_sss_p_derechogrupo.php";
			f.submit();	
		}
		else
		{
