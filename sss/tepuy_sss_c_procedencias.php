<?php
class tepuy_sss_c_procedencias
 {
    var $ls_sql="";
	var $io_msg_error;
	
	function tepuy_sss_c_procedencias()//Constructor de la Clase.
	{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($this->uf_select_procedencia($ls_codigo))
	 {
		$ls_sql=" UPDATE tepuy_procedencias ".
		...
		if ($rs_data==false)
		   {
	         ...
	         $this->io_msg->message("CLASE->tepuy_sss_c_PROCEDENCIAS; METODO->uf_delete_procedencia;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));   
		 	 $lb_valido=false;
		   }
		else
		   {   
	 ...
	 {
	  $ls_sql=" INSERT INTO tepuy_procedencias".
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$ls_sql  = "SELECT * FROM tepuy_procedencias WHERE procede='".$as_codigo."'";
	$rs_data = $this->io_sql->select($ls_sql);
	if ($rs_data===false)
	   {
	     $lb_valido=false;
	     $this->io_msg->message("CLASE->tepuy_sss_c_PROCEDENCIAS; METODO->uf_select_procedencia;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));   
	   }
	else
	   {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$lb_valido = false;
	$ls_sql    = " DELETE FROM tepuy_procedencias WHERE procede='".$as_codigo."'";
    $this->io_sql->begin_transaction();
	$rs_data=$this->io_sql->execute($ls_sql);
	if ($rs_data===false)
	   { 
	          $this->io_msg_error="CLASE->tepuy_sss_c_PROCEDENCIAS; METODO->uf_delete_procedencia;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);   
	   }
    else
	   {
	     /////////////////////////////////         SEGURIDAD               /////////////////////////////		
