<?php
class tepuy_rcm_c_scb
{
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_rcm_c_scb()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_rcm_c_scb
		//		   Access: public 
	...
	function uf_convertir_scbcolocacion()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scbcolocacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scbconciliacion()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scbconciliacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scbdtcmpret()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scbdtcmpret ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_dt_cmp_ret_op()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_dt_cmp_ret_op ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_dt_movbco()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_dt_movbco ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_errorconcbco()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_errorconcbco ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_movbco()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_movbco ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_movbco_scg()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_movbco_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_movbco_spg()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_movbco_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_movbco_spgop()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_movbco_spgop ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_movbco_spi()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_movbco_spi ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_movcaja()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_movcaja ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_movcol()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_movcol ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_movcol_scg()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_movcol_scg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scb_movcol_spg()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scb MÉTODO->SELECT->uf_convertir_scb_movcol_spg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
