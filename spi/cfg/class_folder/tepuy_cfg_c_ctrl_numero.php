...
function  uf_sss_load_usuarios_disponibles($as_empresa,$as_codsis,$as_prefijo,&$aa_disponibles)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->tepuy_cfg_c_ctrl_numero MÉTODO->uf_sss_load_usuarios_disponibles ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$li_pos=0;
	...
	function  uf_sss_load_usuarios_asignados($as_codemp,$as_prefijo,&$aa_asignados)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->tepuy_cfg_c_ctrl_numero MÉTODO->uf_sss_load_usuarios_asignados ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$li_pos=0;
   ...
   function  uf_sss_buscar_usuarios_disponibles($as_empresa,$as_codsis,$as_prefijo,&$aa_disponibles)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->tepuy_cfg_c_ctrl_numero MÉTODO->uf_sss_buscar_usuarios_disponibles ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$li_pos=0;
	...
	function  uf_sss_buscar_usuarios_asignados($as_empresa,$as_codsis,$as_prefijo,&$aa_asignados)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->tepuy_cfg_c_ctrl_numero MÉTODO->uf_sss_buscar_usuarios_asignados ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$li_pos=0;
	...
	function  uf_verificar_comprobante($as_empresa,$as_prefijo,$as_codsis)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->tepuy_cfg_c_ctrl_numero MÉTODO->uf_verificar_comprobante ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$li_pos=0;
...
function  uf_buscar_usuarios_disponibles($as_empresa,$as_codsis,$as_prefijo,&$aa_disponibles)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->tepuy_cfg_c_ctrl_numero MÉTODO->uf_buscar_usuarios_disponibles ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$li_pos=0;
