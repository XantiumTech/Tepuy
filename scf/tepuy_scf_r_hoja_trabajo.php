<?php
	...
	$io_fun_scf->uf_load_seguridad("SCF","tepuy_scf_r_hoja_trabajo.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
function ue_search()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/tepuy_scf_rpp_hoja_trabajo.php?fecdes="+fecdes+"&fechas="+fechas;
