...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_relbmf3.php",$ls_permisos,$la_seguridad,$la_permisos);
          ...
          <div align="center">
            <table width="497" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
                ...
                <tr>
                  ...
                  <td width="368" height="22"><input name="txtcmpmov" type="text" id="txtcmpmov" size="15" style="text-align:center" readonly>
                    <a href="javascript: uf_desincorporaciones();"><img src="../shared/imagebank/tools15/buscar.png" alt="BUSCAR" width="15" height="15" border="0"></a></td>
                </tr>
                      </table>
          </div>
        </div>
...
<script language="JavaScript">
	...
	function uf_desincorporaciones()
	{
	    window.open("tepuy_saf_cat_desincorporaciones.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=70,location=no,resizable=yes");
	}
...
function ue_seccion()
{
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				ls_cmpmov_desde= f.txtcmpmov.value;
				ls_cmpmov_hasta= f.txtcmpmov.value;
				...
				window.open("reportes/tepuy_saf_rpp_relbmf3.php?ordenact="+li_ordenact+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&codgru="+ls_grupo+"&codsubgru="+ls_subgrupo+"&codsec="+ls_seccion+"&coduniadm="+ls_coduniadm+"&denuniadm="+ls_denuniadm+"&tipoformato="+tipoformato+"&cmpmov_desde="+ls_cmpmov_desde+"&cmpmov_hasta="+ls_cmpmov_hasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="tepuy_siv_r_relbmf4.php";
				//f.submit();
			}
			else
