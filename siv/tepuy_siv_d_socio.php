...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistemas Ordenes de Compras -><i>Sistema de Proveedores</i></td>
...
require_once("class_folder/tepuy_siv_c_socio.php");
...
$io_socio= new tepuy_rpc_c_socio($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////////
	...
	$ls_sistema="SIV";
	$ls_ventanas="tepuy_siv_d_socio.php";
...
function uf_ver()
{
   ...
   f.action="tepuy_rpc_d_socio.php";
   f.submit();
}
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		...
		pagina="tepuy_cat_socio.php?txtprov="+ls_prov;
