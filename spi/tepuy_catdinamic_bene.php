...
if ($ls_operacion=="BUSCAR")
   {
     $ls_sql  ="SELECT ced_bene,nombene, apebene FROM rpc_beneficiario where ced_bene like '".$ls_codigo."' AND nombene like '".$ls_nombre."' AND apebene like '".$ls_apellido."' AND ced_bene <>'----------'".
	           " ORDER BY ced_bene";
			   ...
			   while($row=$io_sql->fetch_row($rs_data))
			        {
					  ...
					  print "<td style=text-align:center><a href=\"javascript: aceptar('$ls_cedula','$ls_nomben'+' '+'$ls_apeben');\">".$ls_cedula."</a></td>";
					  print "<td style=text-align:left>".$ls_nomben." ".$ls_apeben."</td>";
					  print "</tr>";			
					}
			 }
	      else
