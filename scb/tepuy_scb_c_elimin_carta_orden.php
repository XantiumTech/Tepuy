<?php 
class tepuy_scb_c_elimin_carta_orden
{
	var $SQL;
	var $fun;
	var $msg;
	...
	var $ds_solbanco;
	var $la_security;
	function tepuy_scb_c_elimin_carta_orden($aa_security)
	{
	...
	{		
		...
		$ls_sql = "SELECT numdoc, cod_pro, ced_bene, nomproben, fecmov, conmov, estmov, monto,
