...
function aceptar(coduniadm,denuniadm,codestpro1,codestpro2,codestpro3,codestpro4,codestpro5)
{
	...
	if (opener.document.formulario.id=='tepuy_soc_p_registro_orden_compra.php')
	   {
...
function ue_search()
{
	...
	ajax.send("catalogo=UNIDADEJECUTORA&coduniadm="+ls_coduniadm+"&denuniadm="+ls_denuniadm+"&tipo="+ls_tipsolcot+"&orden="+ls_orden+
