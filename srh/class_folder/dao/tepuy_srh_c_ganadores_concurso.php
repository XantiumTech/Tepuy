...
class tepuy_srh_c_ganadores_concurso
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_ganadores_concurso($path)
	{   
...
function uf_srh_guardarganadores_concurso ($po_ganadores,$ps_operacion="insertar", $aa_seguridad)
  { 
		...
		//         access: public (tepuy_srh_ganadores_concurso)
...
function uf_srh_guardar_dt_ganadores_concurso($po_ganadores, $aa_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_ganadores_concurso)														
...
function uf_srh_eliminar_dt_ganadores_concurso($as_codcon, $aa_seguridad)
  {
		...
		//        access:  public (tepuy_srh_dt_ganadores_concurso)														
		//      Argumento: $ps_codper        //
		//	                $aa_seguridad    //  arreglo de registro de seguridad                                                
		//	      Returns: Retorna un Booleano																				    
...
}// end   class tepuy_srh_c_ganadores_concurso
?>