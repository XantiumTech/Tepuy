...
class tepuy_scb_c_cmp_ret
{
	...
	function uf_crear_comprobante($ld_fecdesde,$ld_fechasta, $ls_tipo, $ls_codproben, &$ls_mensaje)
	{
		...
		/*if !oApp.CFG_READ([SCB], [CONFIG], [RETIVACXP], [1], [I], @nIvaCXP)
		   return .F.
		endif*/
		$this->lb_ivacxp =true;
		...
		else
		{
			if($row=$this->io_sql->fetch_row($rs_result))
			{
				...
				for($li_i=1;$li_i<=$li_total_rows;$li_i++)
				{
					...
					$object[$li_i][11]= "<div align=center><a href=javascript:uf_delete_dt('$ls_numope','$ls_numfac');><img src=../shared/imagebank/tools15/eliminar.png alt='Eliminar Retención' width=15 height=15 border=0></a></div>";
