...
<table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="500" height="20" colspan="2" class="titulo-ventana">Cat&aacute;logo de Conceptos de Ayudas </td>
    </tr>
  </table>
  <br>
...
function ue_search()
{
	...
	envios="POST";
	//envios="CONCEPTOS";
	ajax.open(envios,"class_folder/tepuy_sep_c_catalogo_ajax.php",true);
	ajax.onreadystatechange=function(){
		if(ajax.readyState==1)
		{
	...
	ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	// Enviar todos los campos a la pagina para que haga el procesamiento
	ajax.send("catalogo=CONCEPTOSAYUDAS&codconsep="+codconsep+"&denconsep="+denconsep+"&codestpro1="+codestpro1+"&codestpro2="+codestpro2+
