...
//Initialization class variables
	require_once("../../class_folder/dao/tepuy_srh_c_uni_vipladin.php");
   require_once("../../class_folder/utilidades/class_funciones_srh.php");
	$io_uni_vi=new tepuy_srh_c_uni_vipladin('../../../');
	$io_fun_srh=new class_funciones_srh('../../../');
	
	$io_fun_srh->uf_load_seguridad("SRH","tepuy_srh_d_uni_vipladin.php",$ls_permisos,$la_seguridad,$la_permisos);
