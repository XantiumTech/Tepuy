...
if($ls_operacion=="BUSCAR")
{
	$ls_sql=" SELECT codrut,desrut,codpaiori,codestori,codciuori,".
			...
			" 	       WHERE scv_rutas.codpaiori=tepuy_pais.codpai) AS despaiori,".
			"        (SELECT  desest FROM tepuy_estados".
			"	       WHERE scv_rutas.codpaiori=tepuy_estados.codpai".
			"	         AND   scv_rutas.codestori=tepuy_estados.codest) AS desestori,".
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	...
	f.action="tepuy_scv_cat_rutas.php";
	f.submit();
  }
</script>
</html>
