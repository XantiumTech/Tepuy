  ...
  <div align="center">
    <table width="550" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="22" colspan="2" style="text-align:left"><input name="nombre" type="text" id="nombre" size="72" style="text-align:left" maxlength="254" style="text-align:left"></td>
      </tr>
      <tr>
        <td height="22">&nbsp;</td>
        <td height="22">&nbsp;</td>
	...
	print "<td style=text-align:center width=450>Denominación</td>";
	print "</tr>";
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_cat_ctasrep.php?codestpro1=<?php print $ls_codestpro1;?>&codestpro2=<?php print $ls_codestpro2;?>
