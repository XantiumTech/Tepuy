...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_separador_sector.php";
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">SEPARADORES A NIVEL DE SECTOR<br>
      </td>
    </tr>
  </table>
    ...
    <tr>
      <td height="40" colspan="3" align="center">      <div align="left">
        <table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="100"><div align="right"><span class="style1 style14">Sector</span></div></td>
...
function ue_showouput()
{
	...
	pagina="reportes/tepuy_spg_rpp_separador_sector.php?combo="+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato;
