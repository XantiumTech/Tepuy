...
<?php	
	...
	require_once("tepuy_sss_c_derechousuarios.php");
	$io_sss= new tepuy_sss_c_derechousuarios();
	...
	//print "Pantalla:".$ls_pantalla." nomven ".$ls_nomven;
		$ls_codintper="---------------------------------";
		$la_codintper[1]= "";
    ...
    <tr>
      <td height="154"><table width="509" height="210" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td colspan="6"><div align="right"><a href="javascript: ue_guardar();"><img src="../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Guardar</a></div></td>
          </tr>
      </table></td>
    </tr>
    <tr>
