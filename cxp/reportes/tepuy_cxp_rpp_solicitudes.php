...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_cxp->uf_load_seguridad_reporte("CXP","tepuy_cxp_r_solicitudes.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_ndnc_actuales($aa_data,$as_numdc,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		unset($la_columna);
		unset($la_config);
		$ls_valor="<b>Numero de nota: </b>".$as_numdc;
		$la_data[1] = array('numsol'=>'','consol'=>$ls_valor,'procedencia'=>'','fecha'=>'','debe'=>'','haber'=>'','saldo'=>'');
		$la_columna = array('numsol'=>'<b>Documento</b>','consol'=>'<b>Concepto</b>','procedencia'=>'Procedencia','fecha'=>'<b>F. Emisión</b>','debe'=>'<b>Debe</b>','haber'=>'<b>Haber</b>','saldo'=>'<b>Saldo</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 8,  // Tamaño de Letras de los títulos
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_pagos_actuales($aa_data,$as_nomban,$as_ctaban,$as_numdoc,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		unset($la_columna);
		unset($la_config);
		$ls_valor="<b>Banco: </b>".$as_nomban." <b> Cuenta: </b>".$as_ctaban." <b>Cheque: </b>".$as_numdoc;
		$la_data[1] = array('numsol'=>'','consol'=>$ls_valor,'procedencia'=>'','fecha'=>'','debe'=>'','haber'=>'','saldo'=>'');
	//	$la_data= array(array('datos'=>'<b>Banco: </b>'.$as_nomban.'<b>Cuenta: </b>'.$as_ctaban.'<b>Cheque: </b>'.$as_numdoc));
		$la_columna = array('numsol'=>'<b>Documento</b>','consol'=>'<b>Concepto</b>','procedencia'=>'Procedencia','fecha'=>'<b>F. Emisión</b>','debe'=>'<b>Debe</b>','haber'=>'<b>Haber</b>','saldo'=>'<b>Saldo</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 8,  // Tamaño de Letras de los títulos
...
//////////////////////////////////    NOTAS DEBITO/CREDITO    //////////////////////////////////
					...
					if($lb_valido)
					{
						...
						{
							$ls_numsol= $io_report->ds_detndnc->getValue('numsol',$li_j);
							...
							$la_datandnc[$li_j]= array('numsol'=>$ls_numsol,'consol'=>$ls_desope,'procedencia'=>$ls_procedencia,'fecha'=>$ld_fecope,'debe'=>$li_debe,'haber'=>$li_haber,'saldo'=>$ls_salsol);
						}
						if($li_totndnc>0)
						{
							uf_print_detalle_ndnc_actuales($la_datandnc,$ls_numdc,&$io_pdf);
						}
					}
//////////////////////////////////    NOTAS DEBITO/CREDITO    //////////////////////////////////
//////////////////////////////////       PAGOS ACTUALES       //////////////////////////////////
					...
					if($lb_valido)
					{
						...
						for($li_j=1;$li_j<=$li_totpagact;$li_j++)
						{
							...
							$ls_nomban= $io_report->ds_pagactuales->getValue('nomban',$li_j);
							$ls_ctaban= $io_report->ds_pagactuales->getValue('ctaban',$li_j);
							$ls_numdoc= $io_report->ds_pagactuales->getValue('numdoc',$li_j);
							$li_salsol= $li_salsol-$li_monto;
							$li_totaldebe=$li_totaldebe+$li_monto;
						...
						if($li_totpagact>0)
						{
							uf_print_detalle_pagos_actuales($la_datapag,$ls_nomban,$ls_ctaban,$ls_numdoc,&$io_pdf);
						}
//////////////////////////////////       PAGOS ACTUALES       //////////////////////////////////
					}
