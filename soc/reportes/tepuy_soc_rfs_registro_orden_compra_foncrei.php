...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_nompro,$as_rifpro,$as_nitpro,$as_obscom,&$io_pdf)
	{
		...
		$io_pdf->addText(160,63,7,"SUB-GERENTE"); // Agregar el título
		$io_pdf->line(260,60,260,132);	//VERTICAL		
		$io_pdf->addText(295,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(280,63,7,"GERENTE DE ADMINISTRACION"); // Agregar el título
	...
	function uf_print_cabecera($as_condicion,$as_lugcom,$as_fecentordcom,$as_formapago,&$io_pdf)
	{
		...
		//	   Creado Por: Ing. Miguel Palencia                            Modificado Por: Ing. Néstor Falcón.
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				if ($ls_codfuefin!="--")
				   {
				     $ls_denfuefin = $io_report->uf_select_denominacion('tepuy_fuentefinanciamiento','codfuefin','WHERE codfuefin='.$ls_codfuefin);   
				   }  
				else
				   {
				     $ls_denfuefin="";
