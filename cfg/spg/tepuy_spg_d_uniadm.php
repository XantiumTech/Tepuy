...
require_once("class_folder/tepuy_spg_c_uniadm.php");
...
$io_uniadm = new tepuy_spg_c_uniadm($conn);//Instanciando la Clase tepuy Definiciones.
...
function ue_nuevo()
{
  ...
  if (li_incluir==1)
	 {	
	   ...
	   f.action                = "tepuy_spg_d_uniadm.php";
       f.submit();
	}
	else
	{
