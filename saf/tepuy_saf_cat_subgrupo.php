...
{
	$ls_sql="SELECT * FROM saf_subgrupo".
		...
		while($row=$io_sql->fetch_row($rs_cta))
		{
			switch($ls_tipo)
			{
				case '':
					...
					print "<td><a href=\"javascript: aceptar('$ls_codgru','$ls_codsubgru','$ls_densubgru');\">".$ls_codsubgru."</td>";
				...
				case 'ACTIVOS':
					...
					print "<td><a href=\"javascript: aceptar_activos('$ls_codgru','$ls_codsubgru','$ls_densubgru');\">".$ls_codsubgru."</td>";
					print "<td>".$ls_densubgru."</td>";
				break;
		 	 print "</tr>";	
		   }			
...
<script language="JavaScript">
	...
	function ue_search()
	{
		...
		f.action="tepuy_saf_cat_subgrupo.php";
		f.submit();
	}
</script>
</html>