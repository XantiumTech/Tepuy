...
<html>
<head>
<title>Registro de Comunidad</title>
...
require_once("class_folder/tepuy_rpc_c_comunidad.php");
...
$io_comunidad = new tepuy_rpc_c_comunidad($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////////
	...
	$ls_sistema  = "CFG";
	$ls_ventanas = "tepuy_rpc_d_comunidad.php";
			        ...
			        {   
			          ...
			          if (campo_requerido(txtdenominacion,"La Denominación de la Comunidad debe estar llena !!")==false)
				      ...
				      else
				         {
					       ...
					       f.action          = "tepuy_rpc_d_comunidad.php";
					       f.submit();
					     }
			        }
		       }			
	...
	if (li_leer==1)
	   {
         if (f.cmbparroquia.value=="---")
            ...
            {   
			  ...
			  pagina            = "tepuy_cfg_cat_comunidad.php?hidpais="+ls_pais+"&hidestado="+ls_estado+"&hidmunicipio="+ls_municipio+"&hidparroquia="+ls_parroquia;
