...
class tepuy_srh_c_resultados_evaluacion_aspirante
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_resultados_evaluacion_aspirante($path)
	{   
 ...
 function getCodPersonal($as_codper, $as_codcon,&$ao_datos="")       
{
  ...
  {  
		...
		//         access: public (tepuy_srh_resultados_evaluacion_aspirante)															
...
}// end   class tepuy_srh_c_resultados_evaluacion_aspirante
?>