...
<form name="form1" method="post" action="">
  <table width="465" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="22" colspan="4" style="text-align:right"><a href="javascript:ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar Especialidad..." width="20" height="20" border="0">Buscar</a></td>
    </tr>
    <tr>
      <td height="13">&nbsp;</td>
      <td height="13">&nbsp;</td>
...
{
  f = document.form1;
  f.action    = "tepuy_rpc_cat_especialidad.php";
