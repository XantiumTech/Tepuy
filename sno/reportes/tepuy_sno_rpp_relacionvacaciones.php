<?PHP
	...
	function uf_insert_seguridad($as_titulo,$as_desnom,$as_periodo,$ai_tipo)
	{
		...
		if($ai_tipo==1)
		{
			$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte_nomina("SNO","tepuy_sno_r_relacionvacaciones.php",$ls_descripcion,$ls_codnom);
		}
		else
		{
			$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte_nomina("SNO","tepuy_sno_r_hrelacionvacaciones.php",$ls_descripcion,$ls_codnom);
		}
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_cabecera($as_cedper,$as_nomper,$ad_fecingper,$as_desuniadm,$ai_sueintvac,$ad_fecdisvac,$ad_fecreivac,
							   $ai_diavac,$as_codvac,$as_descar,$ai_sueintdia,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		unset($la_data);
		unset($la_columnas);
		$la_data[1]=array('sueldovac'=>'<b>Sueldo Integral de Vacaciones</b>','sueldodia'=>'<b>Sueldo Diario Integral</b>','cargo'=>'<b>Cargo</b>');
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_relacionvacacion_personal($ls_codper,$ls_codvac,$ls_conceptocero); // Cargar el DS con los datos de la cabecera del reporte
	}
	...
	else  // Imprimimos el reporte
	{
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			$li_sueintvac=$io_fun_nomina->uf_formatonumerico($io_report->DS->data["sueintvac"][$li_i]);
			$li_sueintdia=($io_report->DS->data["sueintvac"][$li_i]/30);
			...
			$li_diavac=$io_report->DS->data["diavac"][$li_i];
			$ls_codvac=$io_report->DS->data["codvac"][$li_i];
			...
			uf_print_cabecera($ls_cedper,$ls_nomper,$ld_fecingper,$ls_desuniadm,$li_sueintvac,$ld_fecdisvac,$ld_fecreivac,
							  $li_diavac,$ls_codvac,$ls_descar,$li_sueintdia,$io_pdf); // Imprimimos la cabecera del registro
