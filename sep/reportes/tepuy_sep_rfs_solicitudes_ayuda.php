<?php
	...
	//  MODIFICADO POR: ING.Miguel Palencia         FECHA DE MODIFICACION : 14/08/2007
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    session_start();   
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_sep->uf_load_seguridad_reporte("AYU","tepuy_sep_p_solicitud_ayuda.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
		...
		$io_pdf->addText($tm,730,11,"RELACION DE AYUDAS OTORGADAS"); // Agregar el título
...
//FORMATO ALCALDIA DE GUASDUALITO
 		$io_pdf->Rectangle(15,60,570,70);
		$io_pdf->line(15,80,585,80);	// LINEA QUE DIVIDE LAS PERSONAS QUE FIRMAN	
		$io_pdf->line(15,117,585,117);	// LINEA QUE DIVIDE LOS FUNCIONARIOS CONFORME
		$io_pdf->line(125,60,125,117);	// COLUMNA 1, FILA 1, COLUMNA 2, FILA 2	
		$io_pdf->line(240,60,240,117);		
		$io_pdf->line(380,60,380,117);
		$io_pdf->line(490,60,490,117);				
		$io_pdf->addText(250,120,9,"CONFORME FUNCIONARIOS"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(13,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]);
		$tm=100-($li_tm/2);
		$io_pdf->addText(47,73,7,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText($tm,63,7,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]); // Agregar el título
//		$io_pdf->addText(157,122,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(133,73,7,"LCDO. JEAN CARLOS OROZCO"); // Agregar el título
		$io_pdf->addText(146,63,7,"JEFE DE CONTABILIDAD"); // Agregar el título
//		$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(258,73,7,"LCDO. JOSE LUIS RODRIGUEZ"); // Agregar el título
		$io_pdf->addText(280,63,7,"ADMINISTRADOR"); // Agregar el título
//		$io_pdf->addText(440,122,7,"DESPACHO DEL ALCALDE"); // Agregar el título
/*		$io_pdf->addText(392,73,7,"JOSE ALVARADO"); // Agregar el título
		$io_pdf->addText(408,63,7,"ALCALDE"); // Agregar el título
		$io_pdf->addText(490,73,7,"LCDA.YURIBETH DAZA"); // Agregar el título
		$io_pdf->addText(493,63,7,"AUDITORIA INTERNA"); // Agregar el título
*/
		$io_pdf->addText(508,73,7,"JOSE ALVARADO"); // Agregar el título
		$io_pdf->addText(524,63,7,"ALCALDE"); // Agregar el título
		$io_pdf->addText(394,73,7,"LCDA.YURIBETH DAZA"); // Agregar el título
		$io_pdf->addText(398,63,7,"AUDITORIA INTERNA"); // Agregar el título
