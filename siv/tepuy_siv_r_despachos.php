...
$io_fun_activo->uf_load_seguridad("SIV","tepuy_siv_r_despachos.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<!-- ******** END ALLWEBMENUS CODE FOR menu ******** -->
  ...
  <tr> 
    <td width="20" height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:uf_imprimir();"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" width="20" height="20" border="0"></a></td>
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				if ((ld_desde!="")&&(ld_hasta!=""))
				{
					...
					window.open("reportes/tepuy_siv_rpp_despachos.php?ordenfec="+li_ordenfec+"&desde="+ld_desde+"&hasta="+ld_hasta+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
					f.action="tepuy_siv_r_despachos.php";
				}
				else
				{
