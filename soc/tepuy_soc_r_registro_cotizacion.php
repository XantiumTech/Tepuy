...
$io_fun_compra->uf_load_seguridad("SOC","tepuy_soc_r_registro_cotizacion.php",$ls_permisos,&$la_seguridad,$la_permisos);
...
<!--    <tr>
  ...
  ?>
    <table width="543" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
        <td height="22" colspan="6" class="titulo-celdanew">Reporte de Registro de Cotizaciones 
        ...
        <td height="22" colspan="6" style="text-align:center"><table width="434" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="171" style="text-align:left"><input name="txtnumcotdes" type="text" id="txtnumcotdes" value="<?php print $ls_numcotdes ?>" size="20" maxlength="15"  style="text-align:center "  onblur="javascript:rellenar_cad(this.value,15,this)" onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript: ue_catalogo('tepuy_soc_cat_cotizacion.php?origen=REPDES');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar hasta..." name="buscar1" width="15" height="15" border="0"  id="buscar1" /></a></td>
            ...
            <td width="154" style="text-align:left"><input name="txtnumcothas" type="text" id="txtnumcothas" value="<?php print $ls_numcothas ?>" size="20" maxlength="15"  style="text-align:center"  onblur="javascript:rellenar_cad(this.value,15,this)"  onkeypress="return keyRestrict(event,'1234567890');" />
                <a href="javascript: ue_catalogo('tepuy_soc_cat_cotizacion.php?origen=REPHAS');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar desde..." name="buscar2" width="15" height="15" border="0" id="buscar2" /></a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        ...
        <td height="22" colspan="6" style="text-align:center"><table width="435" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="157" style="text-align:left"><input name="txtcodprodes" type="text" id="txtcodprodes" value="<?php print $ls_codprodes ?>" size="15" maxlength="10"  style="text-align:center "  onblur="javascript:rellenar_cad(this.value,10,this)" onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript:ue_catalogoproveedores('REPDES');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar hasta..." name="buscar1" width="15" height="15" border="0"  id="buscar1" /></a></td>
            ...
            <td width="158" style="text-align:left"><input name="txtcodprohas" type="text" id="txtcodprohas" value="<?php print $ls_codprohas ?>" size="15" maxlength="10"  style="text-align:center"  onblur="javascript:rellenar_cad(this.value,10,this)"  onkeypress="return keyRestrict(event,'1234567890');" />
                <a href="javascript:ue_catalogoproveedores('REPHAS');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar desde..." name="buscar2" width="15" height="15" border="0" id="buscar2" /></a>
        ...
        <td height="22" colspan="6" style="text-align:center"><table width="435" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="134" style="text-align:left">
              <input name="txtfecsoldes" type="text" id="txtfeccotdes" value="<?php print $ls_feccotdes ?>" size="12" maxlength="10"  style="text-align:left"  datepicker="true" onkeypress="currencyDate(this);" /></td>
            <td width="49" style="text-align:right">&nbsp;</td>
            <td width="187" style="text-align:left">Hasta
              <input name="txtfeccothas" type="text" id="txtfeccothas" value="<?php print $ls_feccothas ?>" size="12" maxlength="10"  style="text-align:left"  datepicker="true" onkeypress="currencyDate(this);" /></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="22" colspan="6" style="text-align:center"><table width="434" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <a href="javascript: ue_catalogo('tepuy_soc_cat_solicitud_cotizacion.php?origen=REPDES');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar hasta..." name="buscar1" width="15" height="15" border="0"  id="buscar1" onclick="document.formulario.operacion.value='RC'" /></a></td>
            <td width="44" style="text-align:right">Hasta</td>
            ...
            <a href="javascript: ue_catalogo('tepuy_soc_cat_solicitud_cotizacion.php?origen=REPHAS');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar desde..." name="buscar2" width="15" height="15" border="0" id="buscar2" onclick="document.formulario.operacion.value='RC'" /></a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
function ue_imprimir()
{
	...
	pagina="reportes/tepuy_soc_rpp_registro_cotizacion.php?numcotdes="+ls_numcotdes+"&numcothas="+ls_numcothas+"&codprodes="+ls_codprodes+
...
{
	window.open("tepuy_soc_cat_proveedor.php?tipo="+ls_tipo,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=550,height=400,resizable=yes,location=no,left=50,top=50");          
}
