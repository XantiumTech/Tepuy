...
$io_fun_compra->uf_load_seguridad("SOC","tepuy_soc_p_aprobacion_orden_compra.php",$ls_permisos,&$la_seguridad,$la_permisos);
...
switch ($li_diasem){
  ...
  break;
   ...
   function uf_limpiarvariables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
	    global $ld_fecope,$li_totrows,$io_fun_compra,$ls_operacion,$ls_numordcom,$ls_codpro,$ls_nompro,$ld_fecope,$ld_fecdes,$ld_fechas,$ls_tipope,$ls_tipordcom;
   ...
   function uf_load_variables()
   {
	    ...
	    global $ls_tipope,$li_totrows,$ls_operacion,$ls_numordcom,$ls_tipordcom,$ls_codpro,$ls_nompro,$ld_fecope,$ld_fecdes,$ld_fechas;
...
<?php
require_once("class_folder/tepuy_soc_c_aprobacion_orden_compra.php");
$io_soc = new tepuy_soc_c_aprobacion_orden_compra("../");
uf_limpiarvariables();
switch($ls_operacion){
  case 'GUARDAR':
			uf_load_variables();
      /*if($lb_valido)
      {*/
        // COMPRUEBA DISPONIBILIDAD DE LAS PARTIDAS ANTES DE LA APROBACION Y EVITAR SOBREGIROS //
...
?>
    <table width="595" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <input name="txtfecope" type="text" id="txtfecope" value="<?php print $ld_fecope ?>" size="12" maxlength="10" datepicker="true" /></td>
      </tr>
      <tr>
        <td height="13">&nbsp;</td>
        <td height="13">&nbsp;</td>
      ...
      <tr>
        ...
        <td height="22" style="text-align:left"><label>
          <input name="txtnumordcom" type="text" id="txtnumordcom" value="<?php print $ls_numordcom ?>" size="20" maxlength="15" style="text-align:center" onKeyPress="return keyRestrict(event,'1234567890'); " onBlur="javascript:rellenar_cad(this.value,15)" />
        </label></td>
      ...
      <tr>
        ...
        <td height="22" colspan="5" style="text-align:left"><label>
          ...
          <a href="javascript:ue_catalogo_proveedores();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" /></a> 
      ...
      <tr>
        ...
        <td height="22" style="text-align:left"><label>
          <select name="cmbtipordcom" id="cmbtipordcom">
      ...
      <tr>
        <td height="22" colspan="6"><div align="right"><a href="javascript: ue_buscar();"><img src="../shared/imagebank/tools20/buscar.png" alt="Ordenes de Compra" width="20" height="20" border="0" onclick="ue_buscar()">Buscar Ordenes de Compras</a></div></td>
      </tr>
      <tr>
        <td height="13">&nbsp;</td>
        <td height="13">&nbsp;</td>
...
{
	 pagina="tepuy_soc_cat_proveedor.php";
	   ...
	   if (ls_tipope!='-')
		  {
		    ...
		    ajax.open("POST","class_folder/tepuy_soc_c_aprobacion_orden_compra_ajax.php",true);
