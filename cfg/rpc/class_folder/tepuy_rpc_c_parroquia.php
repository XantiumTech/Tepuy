<?php
class tepuy_rpc_c_parroquia
{

var $ls_sql;
var $is_msg_error;
	
	function tepuy_rpc_c_parroquia($conn)
	{
...
//////////////////////////////////////////////////////////////////////////////
	...
	$ls_sql = " INSERT INTO tepuy_parroquia ".
	...
	if ($rs_data===false)
	   {
	     $lb_valido=false;
		 $this->io_msg->message("CLASE->tepuy_RPC_C_PARROQUIA; METODO->uf_insert_parroquia; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
		 /////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
	     $lb_valido=false;
		 $this->io_msg->message("CLASE->tepuy_RPC_C_PARROQUIA; METODO->uf_update_parroquia; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
		 $lb_valido=true;
...
//////////////////////////////////////////////////////////////////////////////
  ...
  $lb_valido = false;
  $ls_sql    = " DELETE FROM tepuy_parroquia ".
  ...
  if ($rs_data===false)
	 {
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->tepuy_RPC_C_PARROQUIA; METODO->uf_delete_parroquia; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
	   $lb_valido=true;
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		  $lb_valido=false;
     	  $this->io_msg->message("CLASE->tepuy_RPC_C_PARROQUIA; METODO->uf_select_parroquia; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		  $lb_valido=false;
     	  $this->io_msg->message("CLASE->tepuy_RPC_C_PARROQUIA; METODO->uf_llenarcombo_estado; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
         $li_numrows=$this->io_sql->num_rows($rs_data);	   
