<?Php
	...
	$oi_fun_integrador->uf_load_seguridad("SEP","tepuy_mis_p_contabiliza_sep.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<?php
	...
	$in_class = new class_tepuy_sep_integracion();  
	uf_limpiarvariables();
	switch ($ls_operacion) 
	{
		case "NUEVO":
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td width="432" height="20" colspan="11" bgcolor="#E7E7E7"><table width="762" border="0" align="center" cellpadding="0" cellspacing="0">
        <td width="432" height="20" bgcolor="#E7E7E7" class="sin-borde2"><span class="descripcion_sistema">Solicitud de Ejecuci&oacute;n Presupuestaria -><i>M&oacute;dulo Integrador</i></span> </td>
        ...
        <tr>
          <td height="20" bgcolor="#E7E7E7" class="sin-borde2">&nbsp;</td>
...
function ue_procesar()
{
	...
	if(li_ejecutar==1)
	{
		...
		if(lb_valido)
		{
			...
			f.action="tepuy_mis_p_contabiliza_sep.php";
			f.submit();
		}
		else
		{
...
function uf_verdetalle(numsol)
{
	...
	window.open("tepuy_mis_pdt_sep.php?numsol="+numsol+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,left="+Xpos+",top="+Ypos+",location=no,resizable=no");
}
