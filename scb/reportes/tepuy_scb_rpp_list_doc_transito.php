<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_columna=array('fecha'=>'<b>Fecha</b>','documento'=>'<b>Documento</b>','operacion'=>'<b>Operacion</b>','proveedor'=>'<b>Proveedor</b>','estatus'=>'<b>Estatus</b>','monto'=>'<b>Monto</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('fecha'=>array('justification'=>'center','width'=>50),'documento'=>array('justification'=>'center','width'=>90),
						 			   'operacion'=>array('justification'=>'center','width'=>55),'proveedor'=>array('justification'=>'left','width'=>190),
						 			   'estatus'=>array('justification'=>'left','width'=>90),'monto'=>array('justification'=>'right','width'=>90))); // Justificación y ancho de la columna
	...
	if($li_total>0)
	{
		...
		for($i=1;$i<=$li_total;$i++)
		{
			...
			$la_data[$i] = array('fecha'=>$ld_fecmov,'documento'=>$ls_numdoc,'operacion'=>$ls_codope,'proveedor'=>$ls_nomproben,'estatus'=>$ls_estatus,'monto'=>$ld_mon);
			
		}
		uf_print_detalle($la_data,&$io_pdf);
		//$ldec_saldo         = $ldec_totalcreditos-$ldec_totaldebitos;//Calculo del saldo total para todas las cuentas
		$ldec_saldo         = $ldec_totaldebitos-$ldec_totalcreditos;//Calculo del saldo total para todas las cuentas
