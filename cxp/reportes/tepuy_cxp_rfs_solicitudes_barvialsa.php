...
//FORMATO ALCALDIA DE GUASDUALITO
		...
		$io_pdf->addText(164,118,6,"LCDA. INGHAID GARCIA"); // Agregar el título
		$io_pdf->addText(165,165,6,"JEFE DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(286,118,6,"LCDA. LILIANA MONTILLA"); // Agregar el título
		$io_pdf->addText(295,165,6,"ADMINISTRADORA"); // Agregar el título
//		$io_pdf->addText(440,122,7,"DESPACHO DEL ALCALDE"); // Agregar el título
		...
		$io_pdf->addText(418,118,6,"ING. JOSE GOICOECHEA"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(6,$ls_cargorep);
		$tm=440-($li_tm/2);
//		$io_pdf->addText(492,165,6,"ALCALDE"); // Agregar el título
		$io_pdf->addText($tm,165,6,"PRESIDENTE"); // Agregar el título
