<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2, &$io_pdf)
	{
		...
		$tm=505-($li_tm/2);
		$io_pdf->addText($tm,525,16,$as_titulo2); // Agregar el título
...
//--------------------------------------------------------------------------------------------------------------------------------
		...
		require_once("tepuy_spg_reporte_comparados_forma05.php");
		$io_report = new tepuy_spg_reporte_comparados_forma05();
...
//-----------------------------------------------------------------------------------------------------------------------------
		...
		global $ld_total_porc_pagado;
		 if($ls_tipoformato==1)
		 {
			require_once("tepuy_spg_reporte_comparados_forma05_bsf.php");
			$io_report = new tepuy_spg_reporte_comparados_forma05_bsf();
		 }
		 else
		 {
			require_once("tepuy_spg_reporte_comparados_forma05.php");
...
//--------------------------------------------------  Parámetros para Filtar el Reporte  ----------------------------------------
		...
		//print($ls_codestpro1.$ls_codestpro2.$ls_codestpro3.$ls_codestpro4.$ls_codestpro5);
		...
		//print($ls_codestpro1h.$ls_codestpro2h.$ls_codestpro3h.$ls_codestpro4h.$ls_codestpro5h);
...
//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
		$ls_mes = strtoupper($ls_mes);
		$ls_titulo  = "<b>EJECUCION FINANCIERA ACUMULADO POR CUENTAS </b>"; 
		$ls_periodo = "<b> HASTA ".$ls_mes." ".$li_ano."</b>" ;
//--------------------------------------------------------------------------------------------------------------------------------
