...
class tepuy_sss_c_usuariospresupuesto
{
	...
	function  uf_sss_load_estructurasdisponibles($as_codemp,$as_codusu,&$aa_disponibles)
	{
		...
		//	      Returns: Retorna un Booleano
		//    Description: Función que carga los datos de las Estructuras de Presupuesto
		//	   Creado Por: Ing. Luis Anibal Lang
		// Fecha Creación: 30/10/2006								Fecha Última Modificación : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;
	...
	function  uf_sss_select_derechos_usuarios($as_codemp,$as_codest,$as_codusu)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->usuariospresupuesto MÉTODO->uf_sss_select_derechos_usuarios ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
