<?php
class class_funciones_sfa
{
	//-----------------------------------------------------------------------------------------------------------------------------------
 	function class_funciones_sfa()
	{
		//////////////////////////////////////////////////////////////////////////////
		//	     Function: class_funciones_sfa
		//		   Access: public
   ...
   //---------------------------------------------------------------------------------------------------------------------------------
    function uf_sfa_select_administrador($as_codemp,$as_codusu,&$as_administrativo)
	{
     ///////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $this->io_sql=new class_sql($this->io_conexion);	
	   ...
	   $ls_sql=" SELECT administrativo ".
			   ...
			   "        codsis='SFA' AND nomven='tepuy_sfa_d_facturar.php' ";
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->SEP MÉTODO->uf_sfa_select_administrador ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
