									   ...
									   $ls_forpagcom,&$io_pdf)
	{
		...
		if($as_estcondat=="B") 
        {
			...
			// $ls_titulo_grid="Bienes";
			 $io_pdf->addText(222,675,10,"<b>X</b>");
        }
        else
        {
             $ls_titulo="Servicio";
			// $ls_titulo_grid="Servicios";
			 $io_pdf->addText(322,675,10,"<b>X</b>");
        }
		
		$ls_titulo1="<b>ORDEN DE COMPRA DE MATERIALES Y/O SERVICIOS</b>";
		$ls_titulo2="<b>VIALIDAD Y CONSTRUCCIONES SUCRE S.A.</b>";
		$ls_titulo3="<b>R.I.F.: G-20005595-2       N.I.T.: 0470199903</b>";
		$ls_titulo4="<b>AV. FRANCISCO MIRANDA, TORRE PEQUIVEN PB, CHACAO.</b>";
		$ls_titulo5="<b>TELF (0212) 201.57.06 FAX: 201.53.22.</b>";
		$io_pdf->addText(170,705,10,$ls_titulo1);
		$io_pdf->addText(100,750,8,$ls_titulo2);
		$io_pdf->addText(100,740,8,$ls_titulo3);
		$io_pdf->addText(100,730,8,$ls_titulo4);
		$io_pdf->addText(100,720,8,$ls_titulo5);
		...
		// cuadro inferior
        $io_pdf->Rectangle(14,60,570,90); 
		$io_pdf->line(14,135,585,135);	//HORIZONTAL	
		$io_pdf->addText(120,140,7,"<b>ELABORADO POR</b>"); // Agregar el título
		$io_pdf->addText(80,125,7,"FIRMA"); // Agregar el título
		$io_pdf->addText(240,125,7,"FECHA"); // Agregar el título
		$io_pdf->line(190,105,190,135);	//VERTICAL	
		$io_pdf->addText(125,98,7,"<b>PRESIDENCIA</b>"); // Agregar el título
		$io_pdf->addText(80,83,7,"FIRMA"); // Agregar el título
		$io_pdf->addText(240,83,7,"FECHA"); // Agregar el título
		$io_pdf->line(190,60,190,92);	//VERTICAL	
		$io_pdf->addText(380,140,7,"<b>JEFE DE ADMINISTRACIÓN Y FINANZAS</b>"); // Agregar el título
		$io_pdf->addText(370,125,7,"FIRMA"); // Agregar el título
		$io_pdf->line(470,105,470,135);	//VERTICAL
		$io_pdf->addText(510,125,7,"FECHA"); // Agregar el título
		$io_pdf->line(300,60,300,150);	//VERTICAL		
		$io_pdf->addText(420,98,7,"<b>PROVEEDOR</b>"); // Agregar el título
		$io_pdf->addText(370,83,7,"FIRMA"); // Agregar el título
		$io_pdf->addText(510,83,7,"FECHA"); // Agregar el título
		$io_pdf->line(470,60,470,92);	//VERTICAL		
		$io_pdf->line(15,105,585,105); //HORIZONTAL
		$io_pdf->line(15,92,585,92); //HORIZONTAL	
		// cuadro del tipo de orden	
		$io_pdf->Rectangle(16,668,570,20);
		$io_pdf->addText(18,675,9,"<b>Tipo de Orden</b>");
        $io_pdf->addText(250,675,9,"COMPRA");
		$io_pdf->addText(350,675,9,"SERVICIO");
		$io_pdf->Rectangle(220,675,10,10);   // rectangulo compra
		$io_pdf->Rectangle(320,675,10,10); // rectangulo Servico		
