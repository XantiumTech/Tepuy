   ...
   function uf_print($as_tipo)
   {
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					case "NOMINA": // llamado desde tepuy_snorh_p_configuracion.php
					...
					case "APORTE": // llamado desde tepuy_snorh_p_configuracion.php
						print "<tr class=celdas-blancas>";
					...
					case "FIDEICOMISO": // llamado desde tepuy_snorh_p_configuracion.php
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarfideicomiso('$ls_codtipdoc');\">".$ls_codtipdoc."</a></td>";
						print "<td>".$ls_dentipdoc."</td>";
						print "</tr>";			
						break;
				}
