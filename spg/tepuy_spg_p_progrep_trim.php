...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_p_progrep_trim.php";
 ...
 ?>
  ...
  <table width="798" height="169" border="0" align="center">
	...
	?>
      ...
      Manual </td>
          <td width="121"><a href="javascript:ue_distribuir();"><img src="../shared/imagebank/tools15/aprobado.png" alt="Aceptar" width="15" height="15" border="0"></a></td>
        </tr>
        <tr>
          <td height="13">&nbsp;</td>
          <td colspan="4">&nbsp;</td>
...
function uf_cargargrid()
{
	...
	f.action="tepuy_spg_p_progrep_trim.php";
	f.submit();
}
		...
		{ 
		 ...
		 if  (document.opcion=="M" ) 
		 {
		   if(li!="")
		   {
			 ...
			 {	 
				 pagina="tepuy_spg_p_progrep_trim_distribucion.php?fila="+li+"&txtAsignacion="+ld_asignado+"&marzo="+ld_marzo
