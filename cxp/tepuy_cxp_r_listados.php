<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_r_listados.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
      ...
      <td height="22" colspan="3" align="center"><table width="511" border="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td width="167" height="22"><div align="right">
              <input name="rdtiporeporte" type="radio" class="sin-borde" value="tepuy_cxp_rpp_deducciones.php" checked>
            Deducciones</div></td>
          <td width="130" height="22"><div align="center">
              <input name="rdtiporeporte" type="radio" class="sin-borde" value="tepuy_cxp_rpp_creditos.php" >
              Otros Cr&eacute;ditos 
          </div></td>
          <td width="206" height="22"><div align="left">
              <input name="rdtiporeporte" type="radio" class="sin-borde" value="tepuy_cxp_rpp_documentos.php" >
              Tipos de Documentos
          </div></td>
        </tr>
      </table></td>
