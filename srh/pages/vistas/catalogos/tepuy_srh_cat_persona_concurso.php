...
<table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
  ...
  <td><div align="right">Apellido Personal</div></td>
    ...
    <td width="182"><div align="right"><a href="javascript: Limpiar_busqueda();"> <img src="../../../public/imagenes/nuevo.png" alt="Limpiar" width="15" height="15" border="0">Limpiar</a></div></td> 
...
<script language="JavaScript">
		...
		var loadDataURL = "../../php/tepuy_srh_a_inscripcion_concurso.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_inscripcion_concurso.php";
		var mygrid;
 ...
 function Buscar()
		{
		 ...
		 hidcodcon=document.form1.hidcodcon.value;
		  ...
		  mygrid.loadXML("../../php/tepuy_srh_a_inscripcion_concurso.php?valor=buscar_Persona_Concurso"+"&txtcodper="+codper+"&txtnomper="+nomper+"&txtapeper="+apeper+"&hidcodcon="+hidcodcon);
         setTimeout (terminar_buscar,500);
		}
