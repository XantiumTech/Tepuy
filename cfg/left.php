...
<form action="" method="post" name="form1" target="mainFrame">
  <table width="169" border="0" cellpadding="0" cellspacing="0" frame="border">
    ...
    <tr>
      ...
      <td width="169">
    <?php
	require_once("tepuy_arbol_config.php");
...
function cambiar(item,ventana,sistema)
 {
  ...
  f=document.form1;
   if (visible) 
   {
     ...
     window.open("tepuywindow_blank.php","mainFrame","menubar=no,toolbar=no,scrollbars=yes,width=550,height=350,resizable=yes,location=no");
   }
   else 
   {
