...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "CFG";
	$ls_ventanas = "tepuy_sss_d__procedencia.php";
		              ...
		              else
		                 {
		                   if (valida_null(txtdescripcion,"La Descripción de la Procedencia esta vacia !!!")==false)
				           ...
				           else
				              {
					            ...
					            f.action="tepuy_sss_d__procedencia.php";
					            f.submit();
			                  }
				         }
			        }
