...
<html>
<head>
<title>Catálogo de Programatica Nivel 1 <?php print $arr["nomestpro1"] ?></title>
		  ...
		  for ($z=1;$z<=$totrow;$z++)
		      {
				...
				print "<td  style=text-align:center width=150><a href=\"javascript: aceptar('$ls_codestpro1','$ls_denestpro1','$ls_estcla','$li_estmodest');\">".$ls_codestpro1."</a></td>";
...
<script language="JavaScript">
  function aceptar(codigo,deno,estatus,li_estmodest)
  {
  ...
  f.action          = "tepuy_spg_cat_estpro1.php";
  f.submit();
  }
</script>
</html>