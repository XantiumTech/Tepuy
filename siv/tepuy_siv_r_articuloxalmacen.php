...
$io_fun_activo->uf_load_seguridad("SIV","tepuy_siv_r_articuloxalmacen.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
		...
		window.open("reportes/tepuy_siv_rpp_existencias.php?codart="+ls_codart+"&codalm="+ls_codalm+"&ordenalm="+li_ordenalm+"&ordenart="+li_ordenart,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
