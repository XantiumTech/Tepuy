...
var url= "../../php/tepuy_srh_a_registro_metas.php";
var metodo='get';
var img="<img src=\"../../../public/imagenes/progress.gif\"> ";


var loadDataURL = "../../php/tepuy_srh_a_registro_metas.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_registro_metas.php";
var mygrid;
...
function Buscar()
{
	 ...
	 else
	 {
		  ...
		  mygrid.loadXML("../../php/tepuy_srh_a_registro_metas.php?valor=buscar"+"&txtnroreg="+nroreg+"&txtfechades="+fechades+"&txtfechahas="+fechahas+"&txtcodper="+codper+"&txtnomper="+nomper+"&txtapeper="+apeper);
	...
	
	{
		...
		else
		{
			...
			if (opener.document.form1.hidcontrol.value=='1')	 {
				...
				opener.document.form1.action="../pantallas/tepuy_srh_p_registro_metas.php";
