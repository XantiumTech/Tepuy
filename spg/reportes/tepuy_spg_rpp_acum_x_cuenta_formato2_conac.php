...
//------------------------------------------------------------------------------------------------------------------------------
		...
		require_once("tepuy_spg_reporte_nuevos.php");
		$io_report = new tepuy_spg_reporte_nuevos();
...
//--------------------------------------------------  Parámetros para Filtar el Reporte  --------------------------------------
		...
		$io_function_report->uf_load_seguridad_reporte("SPG","tepuy_spg_r_acum_x_cuentas_formato2.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               ///////////////////////////////////
	...
	$lb_valido=$io_report->uf_spg_reporte_select_programatica_acumulado_formato2($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,
											         ...
											         $lb_subniv,&$ai_MenorNivel,$ls_cuentades,$ls_cuentahas,$ls_codfuefindes,
