<?php
class tepuy_scb_c_tipocolocacion
{
	 ...
	 var $is_logusr;
	 var $is_ventanas;
	function tepuy_scb_c_tipocolocacion($aa_security)
	{
...
function uf_guardar_tipocolocacion($ls_codigo,$ls_denominacion,$ls_status)
{
	...
	{
		$lb_valido=false;
		$this->is_msg_error="Error en metodo uf_guardar_tipocolocacion".$this->fun->uf_convertirmsg($this->io_sql->message);
