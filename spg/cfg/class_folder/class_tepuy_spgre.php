...
require_once("../../shared/class_folder/class_mensajes.php");
 class class_tepuy_spgre
 {
	...
	if($this->uf_select_plan_unico($as_cuenta))
	{
		...
		$ls_sql= "UPDATE tepuy_Plan_unico_re SET denominacion='".$as_denominacion+"'".
	...
	//      cuentas del plan único y procede a insertarla en la tabla tepuy_Plan_Unico
	/////////////////////////////////////////////////////////////////////////////
	...
	function uf_select_plan_unico($as_cuenta)
	{
		...
		$ls_sql="SELECT * FROM tepuy_Plan_Unico_re".
