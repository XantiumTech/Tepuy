...
if($ls_operacion=="GUARDARPRE")
{
	...
	if($lb_valido)
	{
		...
		if($lb_valido)
		{
			...
			$lb_valido=$in_classmovbanco->uf_procesar_dt_gasto($ls_codban,$ls_ctaban,$ls_mov_document,$ls_codope,$ls_estmov,$ls_programa,$ls_spgcuenta,$ls_mov_document,$ls_desmov,$ls_procedencia,$ldec_monto,$ls_operacion);
			if($lb_valido)
			{
...
<table width="583" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  ...
  <tr>
    ...
    <td height="22"><input name="codestpro2" type="text" id="codestpro2" size="22" maxlength="6" style="text-align:center" readonly>
  ...
  <tr>
    ...
    <td height="22"><input name="codestpro4" type="text" id="codestpro4" size="4" maxlength="2">
      <a href="javascript:catalogo_estpro4();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 4">
      </a><input name="denestpro4" type="text" class="sin-borde" id="denestpro4" size="53" readonly>
      </td>
  </tr>
  <tr>
    <td height="22"><div align="right"><?php print $dat["nomestpro5"];  ?></div></td>
    <td height="22"><input name="codestpro5" type="text" id="codestpro5" size="4" maxlength="2">
      <a href="javascript:catalogo_estpro5();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 5">
      </a><input name="denestpro5" type="text" class="sin-borde" id="denestpro5" size="53" readonly>
      </td>
  </tr>
  <?php
  }
  ...
  <tr>
    ...
    <a href="javascript:catalogo_cuentasSPG();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Catálogo de Cuentas de Gastos"></a>	 <input name="txtdenominacion" type="text" class="sin-borde" id="txtdenominacion3" style="text-align:left" size="50" maxlength="254"></td>
  </tr>
  <tr>
...
<script language="JavaScript">
  function aceptar_presupuestario()
  {
	...
	if((ls_numdoc!="")&&(ls_procede!="")&&(ls_codest1!="")&&(ls_codest2!="")&&(ls_codest3!="")&&(ls_cuenta!="")&&(ls_operacion!="")&&(ldec_monto!=""))
	{
		...
		f.action="tepuy_w_regdt_presupuesto.php";
		f.submit();
  	}
	else
	{
...
function catalogo_estpro4()
{
	...
	{
		pagina="tepuy_cat_public_estpro4.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&codestpro3="+codestpro3+"&denestpro3="+denestpro3;
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
	else
	{
...
function catalogo_estpro5()
{
	...
	{
		pagina="tepuy_cat_public_estpro5.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&codestpro3="+codestpro3+"&denestpro3="+denestpro3+"&codestpro4="+codestpro4+"&denestpro4="+denestpro4;
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
	else
	{
