<?php
	...
	else // Imprimimos el reporte
	{
		...
		$li_asignacionglobal=number_format($io_report->DS->data["totalasignacion"][1],2,",",".");
		$li_deduccionglobal=number_format($io_report->DS->data["totaldeduccion"][1],2,",",".");
		$li_aporteglobal=number_format(0,2,",",".");	
		$li_netoglobal=$io_report->DS->data["totalasignacion"][1]-$io_report->DS->data["totaldeduccion"][1];
		$li_netoglobal=number_format($li_netoglobal,2,",",".");			
		if(!(empty($ls_conceptop2)))
		{
			$li_aporteglobal=number_format($io_report->DS->data["totalaporte"][1],2,",",".");	
		}
