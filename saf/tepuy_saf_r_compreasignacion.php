...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_compreasignacion.php",$ls_permisos,$la_seguridad,$la_permisos);
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","COMPROBANTE_REA","tepuy_saf_rpp_comreasignacion.php","C");
...
require_once("tepuy_saf_c_comprobantes.php");
$io_saf=new tepuy_saf_c_comprobantes(); 
      ...
      <td colspan="3" align="center"><table width="512" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="334" height="20"><div align="left">
              ...
              <a href="javascript:uf_catalogoreasignacion();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
        ...
        <tr>
          ...
          <td height="32"><div align="left">
            ...
            <a href="javascript:uf_catalogoresponsable();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
        ...
        <tr>
          ...
          <td height="28"><input name="txtcodresuso" type="text" id="txtcodresuso" style="text-align:center" value="<?php print $ls_codres  ?>" size="20" readonly>
            <a href="javascript:uf_catalogoresponsableuso();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
function uf_catalogoreasignacion()
{
	...
	window.open("tepuy_saf_cat_reasignaciones.php?coddestino="+ ls_coddestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
}
	
function uf_catalogoresponsable()
{
	window.open("tepuy_saf_cat_personal.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
}

function uf_catalogoresponsableuso()
{
	window.open("tepuy_saf_cat_responsableuso.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
}
