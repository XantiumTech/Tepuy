...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_chq_caducados.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
		   ...
		   if (ls_mesdesde <= ls_meshasta)
			  {
				...
				pagina="reportes/tepuy_scb_rpp_chq_caducados.php?mesdes="+ls_mesdesde+""+"&meshas="+ls_meshasta+"&codban="+ls_codban+"&denban="+ls_nomban+"&ctaban="+ls_ctaban+"&dencta="+ls_dencta+"&feccad="+ld_feccad;
