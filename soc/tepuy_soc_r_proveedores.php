...
if (!array_key_exists("la_logusr",$_SESSION))
   {
	...
	$ls_reporte=$io_rpc->uf_select_config("SOC","REPORTE","LISTADO_PROVEEDORES","tepuy_soc_rpp_proveedor.php","C");
	unset($io_rpc);
?>
...
<!-- ******** END ALLWEBMENUS CODE FOR menu ******** -->
  <tr>
    <td height="43" bgcolor="#FFFFFF" class="toolbar">&nbsp;</td>
  </tr>
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" width="20" height="20" border="0"></a>
	                                                  <a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.png" alt="Excel" width="20" height="20" border="0"></a>
													  <img src="../shared/imagebank/tools20/ayuda.png" alt="Eliminar" width="20" height="20" border="0"><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a></td>
  </tr>
</table>
  <?php
...
<form name="form1" method="post" action="">
  ...
  <table width="438" height="242" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr>
      <td width="77"></td>
    </tr>
    <tr>
      <td height="22" colspan="3" align="center" class="titulo-celdanew"><span class="titulo-celdanew">Listado de Proveedores</span></td>
    </tr>
    <tr>
      <td height="44" colspan="3" align="center"><div align="left">
    ...
    <tr>
      <td height="13" colspan="3" align="center"><div align="right"></div></td>
    </tr>
    <tr>
      <td height="42" colspan="3" align="center">      <div align="left">
        <table width="415" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
		  ...
		  <tr>
            ...
            <td width="134"><input name="txtcodprov1" type="text" id="txtcodprov1" value="<?php print $ls_codprov1 ?>" size="12" maxlength="10"  style="text-align:center "  onBlur="javascript:rellenar_cad(this.value,10,document.form1.txtcodprov1.name)">
              <a href="javascript:uf_catalogoprov();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" onClick="document.form1.hidrango.value=1"></a></td>
            ...
            <td width="127"><input name="txtcodprov2" type="text" id="txtcodprov2" value="<?php print $ls_codprov2 ?>" size="12" maxlength="10"  style="text-align:center"  onBlur="javascript:rellenar_cad(this.value,10,document.form1.txtcodprov2.name)">
              <a href="javascript:uf_catalogoprov();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"  onClick="document.form1.hidrango.value=2"></a></td>
          </tr>
        </table>
      </div></td>
    </tr>
    <tr>
      <td height="13" colspan="3" align="center"><div align="right" class="style1 style14"></div>        <div align="right" class="style1 style14"></div>        <div align="left">          </div></td>
    </tr>
    <tr>
      <td height="22" colspan="3" align="left"><span class="style14"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Especialidad<?php
		 //Llenar Combo Banco
    ...
    <tr>
      <td height="65" colspan="3" align="center"><div align="left">
    ...
    if (codprov1<=codprov2)
	   {
			...
			//reporte=f.reporte.value;
			pagina="reportes/tepuy_soc_rpp_proveedores_excel.php?hidorden="+li_orden+"&hidtipo="+ls_tipo+"&hidcodprov1="+codprov1+"&hidcodprov2="+codprov2+"&hidcodesp="+codigoesp;
			window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	   }
    else
	   {
