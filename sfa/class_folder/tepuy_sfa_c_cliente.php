 ...
 // $ls_cuenta       = $ar_datos["cuenta"];
  ...
  if ($rs_data===false)
   ...
   {   
	 ...
	 $ls_descripcion ="Insertó en SFA al cliente ".$ls_cedula." con ".$ls_sql;
...
//print $ls_sql;
 ...
 if ($rs_data===false)
   ...
   {   
	 ...
	 $ls_evento="UPDATE";
     $ls_sql = str_replace("'",'`',$ls_sql);
	 $ls_descripcion ="Actualizó en RPC al cliente".$ls_cedula." con ".$ls_sql;
	 $ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
	 $aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
	 $aa_seguridad["ventanas"],$ls_descripcion);
	 /////////////////////////////////         SEGURIDAD               /////////////////////////// 			     
	...
	if(($lb_existe)&&(!$lb_relacion))
	  {
	    ...
	    if ($rs_data===false)
	    ...
	    else
	       {
		     ...
		     /////////////////////////////////         SEGURIDAD               /////////////////////////////		
			 $ls_evento="DELETE";
			 $ls_descripcion ="Eliminó en SFA al cliente ".$as_cedcli;
			 $ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
			 $aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
			 $aa_seguridad["ventanas"],$ls_descripcion);
			 /////////////////////////////////         SEGURIDAD               ///////////////////////////// 	  	     
...
//     Elaborado Por:  Ing. Miguel Palencia.
// Fecha de Creación:  02/11/2016       Fecha Última Actualización:02/11/2016.	 
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//	          Access:  public
//	       Arguments:  $as_codemp   : Código de la empresa.
//                     $ar_datos    : Arreglo cargado con la información de interés del personal a insertar como cliente.
 ...
 // $ls_contablecomp = $ar_datos["contablecomp"];
  ...
  if ($rs_data===false)
     ...
     {   
	   ...
	   $ls_evento      = "INSERT";
	   $ls_sql         = str_replace("'",'`',$ls_sql);
	   $ls_descripcion = "Insertó en SFA al Personal ".$ls_cedula." como Cliente ".$ls_sql;
	   $ls_variable    = $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
	   $aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
	   $aa_seguridad["ventanas"],$ls_descripcion);
	   /////////////////////////////////         SEGURIDAD               /////////////////////////////   			  
