   ...
   function class_generar_id_process()
   {
	...
	{ ////////////////////////////////////////////////////////////////////////////////////////////////////               
	  ...
	  $ls_sql = " SELECT ".$as_columna." FROM ".$as_tabla. //OJO MYSQL
	            " WHERE codemp='".$this->is_codemp."' ORDER BY ".$as_columna." DESC limit 1";/* ojo en postgres el anterios tenia comillas
	                                                                                            en el elemento del order by y se agrego el limit*/  
