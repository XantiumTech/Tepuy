...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_d_sistemaconstructivo.php";
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	require_once("class_folder/tepuy_sob_c_sistemaconstructivo.php");
	require_once("../shared/class_folder/class_mensajes.php");
	$io_sistemaconstructivo=new tepuy_sob_c_sistemaconstructivo();
	...
	{
		$lb_valido=$io_sistemaconstructivo->uf_guardar_sistemaconstructivo($ls_codsiscon,$ls_nomsiscon,$ls_dessiscon,$la_seguridad);
        ...
        <td width="516" height="168"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr>
              ...
              <td width="334" ><input name="txtcodsiscon"  style="text-align:center " type="text" id="txtcodsiscon" value="<? print  $ls_codsiscon?>" size="3" maxlength="3" readonly="true">
            ...
            <tr align="left">
              ...
              <td><input name="txtnomsiscon" id="txtnomsiscon" value="<? print $ls_nomsiscon?>" type="text" size="50" maxlength="50" onKeyPress="return(validaCajas(this,'x',event,50))"></td>
            </tr>
            <tr>
              <td height="4" align="right">Descripci&oacute;n</td>
              <td><textarea name="txtdessiscon" cols="53" rows="2" wrap="VIRTUAL" id="txtdessiscon" onKeyPress="return(validaCajas(this,'x',event))" onKeyDown="textCounter(this,254)"  onKeyUp="textCounter(this,254)" value="<? print $ls_dessiscon?>"><? print $ls_dessiscon?></textarea></td>
            </tr>
            <tr>
              <td height="8">&nbsp;</td>
              <td>&nbsp;</td>
...
function ue_nuevo()
{
	...
	{		
		...
		f.action="tepuy_sob_d_sistemaconstructivo.php";
		f.submit();
	}
	else
	{
