...
if(!array_key_exists("la_logusr",$_SESSION))
{
	...
	$ls_sistema="SCG";
	$ls_ventanas="tepuy_scg_wproc_prog_oaf_trim.php";
   ...
   else
   {
    ...
    document.opcion = f.radiobutton[i].value; 
	 ...
	 if  (document.opcion=="M" ) 
     {
		 ...
		 {
			 pagina="tepuy_scg_wdist_manual_trim.php?fila="+i+"&txtAsignado="+f.txtAsignado.value;
	   ...
	   if (document.opcion=="A")
	   {
		 ...
		 {
		   f.operacion.value="DISTRIBUIR";
		   f.action="tepuy_scg_wproc_prog_oaf_trim.php";
		   f.submit();
		 } 
	   }
...
{
 f.action="tepuy_scg_wproc_progrep_oaf_trim.php";
}
}
