...
function tepuy_srh_c_documentos($path)
	{   
	...
	function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_p_documentos)
		//      Argumento: 
...
function uf_srh_guardarDocumentos ($ao_documento,$as_operacion="insertar", $aa_seguridad)
  { 
		...
		//         access: public (tepuy_srh_documentos)														                //
...
}// end   class tepuy_srh_c_documentos
?>