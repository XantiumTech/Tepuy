...
var loadDataURL = "../../php/tepuy_srh_a_solicitud_adiestramiento.php?valor=createXML";
...
function Buscar()
{
	 ...
	 else
	 {
		  ...
		  mygrid.loadXML("../../php/tepuy_srh_a_solicitud_adiestramiento.php?valor=buscar"+"&txtnroreg="+nroreg+"&txtfecsoldes="+fecsoldes+"&txtfecsolhas="+fecsolhas+"&txtdes="+des+"&txtcodprov="+codprov);
...
function aceptar (ls_nroreg, ls_fecsol, ls_des, ls_codsol, ls_nomsol, ls_apesol,  ls_codprov,ls_denprov, ls_fecini, ls_fecfin, ls_durhras ,  ls_costo ,  ls_obs, ls_obj, ls_est, ls_are , ls_nrodestino ,  ls_fecsoldestino ,  ls_desdestino ,  ls_codsoldestino ,  ls_nomdestino , ls_codprovdestino ,  ls_denprovdestino ,  ls_fecinidestino ,  ls_fecfindestino ,  ls_durhrasdestino ,  ls_costodestino ,  ls_obsdestino, ls_objdestino, ls_estdestino, ls_aredestino)
	{
				...
				obj15.value=ls_are;
				 ...
				 ls_ejecucion= document.form1.hidstatus.value;
				  ...
				  if(ls_ejecucion=="1")
					...
					opener.document.form1.action="../pantallas/tepuy_srh_p_solicitud_adiestramiento.php";
