  ...
  <table width="577" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="156"><div align="left">
          <input type="text" name="txtfecdesde" id="txtfecdesde" datepicker="true" size="18" value="<?php print date("d/m/Y");?>" style="text-align:center">
      </div></td>
      <td width="83"><div align="right">Fecha Hasta </div></td>
      <td width="239"><div align="left">
          <input type="text" name="txtfechasta" id="txtfechasta" datepicker="true" size="18" value="<?php print date("d/m/Y");?>" style="text-align:center">
      </div></td>
    </tr>
    <tr>
...
var ajax=false;
function aceptar(ls_codemp,ls_numncnd,ld_fecha,ls_numord,ls_numrecdoc,ls_codtipdoc,ls_dentipdoc,ls_tipo,ls_codpro,ls_cedbene,ls_nomproben,li_estcon,li_estpre,ls_codope,ls_ctaprov,ls_dencuentaprov,ls_desope,ls_estnota,li_estapro)
{
