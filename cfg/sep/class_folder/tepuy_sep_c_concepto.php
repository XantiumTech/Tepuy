<?php
class tepuy_sep_c_concepto
{
var $ls_sql;
var $is_msg_error;	
		
	function tepuy_sep_c_concepto($conn)
	{
  ...
  if ($li_numrows===false)
	 {
	   ...
	   $this->io_msg->message("CLASE->CFG->tepuy_SEP_C_CONCEPTO; METODO->uf_insert_concepto; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
	 {
	   $this->io_sql->rollback();
   	   $this->io_msg->message("CLASE->CFG->tepuy_SEP_C_CONCEPTO; METODO->uf_update_concepto;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
   ...
   if($this->uf_delete_cargosxconcepto($as_codemp,$as_codconsep,$aa_seguridad))
     {
	   ...
	   if ($rs_data===false)
	      {
			$lb_valido=false;
	   	    $this->io_msg->message("CLASE->CFG->tepuy_SEP_C_CONCEPTO; METODO->uf_delete_concepto;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		  }
	   else
	      {
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
/////////////////////////////////////////////////////////////////////////////////////           		 
  ...
  if ($rs_data===false)
	 {
		 $lb_valido=false;
   	     $this->io_msg->message("CLASE->CFG->tepuy_SEP_C_CONCEPTO; METODO->uf_delete_cargosxconcepto;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
///////////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
	 {
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->CFG->tepuy_SEP_C_CONCEPTO; METODO->uf_select_concepto;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
...
////////////////////////////////////////////////////////////////////////////// 
	...
	if ($rs_data===false)
	   {
	     $lb_valido = false;
	     $this->io_msg->message("CLASE->CFG->tepuy_SEP_C_CONCEPTO; METODO->uf_llenarcombo_unidad;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
	     $li_numrows=$this->io_sql->num_rows($rs_data);	   
			  ...
			  if($lb_valido)
			  {
				 ...
				 if ($rs_data===false)
					{				 
					  $lb_valido=false;  
					  $this->io_sql->rollback();
   	                  $this->io_msg->message("CLASE->CFG->tepuy_SEP_C_CONCEPTO; METODO->uf_insert_dtcargos;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
					}
				else
					{				 
					  $lb_valido=true;  		                    
