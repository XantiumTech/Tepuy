...
{//1
	...
	if($ls_tipoacta=="s1")
	{
		$ls_sql="SELECT a.codcon,c.precon,a.tipact,a.codact,a.fecact,a.fecrecact,a.feciniact,a.fecfinact,o.desobr,a.cedinsact,a.cedresact,a.estact,ag.cod_pro,ag.cod_pro_ins,a.obsact,a.motact
			...
			AND ag.codobr=o.codobr AND a.codcon like '".$ls_codcon."' AND o.desobr like '".$ls_desobr."' ORDER BY $ls_campo $ls_orden";			
	}
	else
	{
		$ls_sql="SELECT a.codcon,c.precon,a.codact,a.tipact,a.fecact,a.fecrecact,a.feciniact,a.fecfinact,o.desobr,a.cedinsact,a.cedresact,a.estact,ag.cod_pro,ag.cod_pro_ins,a.obsact,a.motact
			FROM sob_acta a, sob_asignacion ag, sob_obra o,sob_contrato c
			WHERE a.codemp='".$ls_codemp."' AND a.codemp=ag.codemp AND ag.codemp=o.codemp AND a.tipact='".$ls_tipoacta."'  AND a.codemp=c.codemp AND a.codcon=c.codcon AND c.codasi=ag.codasi
			AND ag.codobr=o.codobr AND a.codcon like '".$ls_codcon."' AND o.desobr like '".$ls_desobr."' ORDER BY $ls_campo $ls_orden";			
	}	
