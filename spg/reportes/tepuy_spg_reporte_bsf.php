...
/********************************************************************************************************************************/	
    function  tepuy_spg_reporte_bsf()
    {
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    19/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT * ".
              " FROM ".
	          "       (SELECT MV.*, MV.montoaux AS monto, CC.denominacion as dencuenta, OP.denominacion as denoperacion,PR.denestpro5 ".
...
/********************************************************************************************************************************/	
   function  uf_spg_reporte_comprobante_formato2($as_spg_cuenta_ori,$as_spg_cuenta_des,$adt_fecini,$adt_fecfin,$as_comprobante,$as_procede)
   {
	 ...
	 // Fecha Creación :    19/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT * ".
              " FROM (SELECT  MV.*,  MV.montoaux  AS monto, CC.denominacion,  OP.denominacion as denoperacion, PR.denestpro5 ".
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    16/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT DM.*, DM.montoaux as monto,GC.denominacion,EP.denestpro5 ".
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //	Description :	Método que consulta y suma lo asignado por cuenta
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ldec_monto=0;
		$ls_codemp = $this->dts_empresa["codemp"];
		$ls_mysql  = "SELECT COALESCE(SUM(montoaux),0) As monto ".
...
/********************************************************************************************************************************/	
	...
	////////////////////////////////////////////////////////
	function uf_spg_reporte_select_mayor_analitico( $as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,
	                                               $as_codestpro4_ori,$as_codestpro5_ori,$as_codestpro1_des,
												   $as_codestpro2_des,$as_codestpro3_des,$as_codestpro4_des,
												   $as_codestpro5_des,$adt_fecini,$adt_fecfin,$as_cuenta_from,
												   $as_cuenta_to,$as_orden)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    01/02/2006          Fecha última Modificacion : 01/02/2006 Hora :
	  ...
	  $ls_mysql=" SELECT  MV.* , C.denominacion,MV.montoaux as monto_mov,MV.montoaux as monto  ". 
                "         FROM spg_dt_cmp MV,spg_operaciones OPE,spg_cuentas C ".
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($as_ckbctasinmov)
	 {
	    $ls_sql=" SELECT distinct PCT.codestpro1, PCT.codestpro2, PCT.codestpro3, PCT.codestpro4,PCT.codestpro5,PCT.spg_cuenta, ".
                "                 PCT.denominacion, PCT.status,PCT.asignadoaux as asignado, PCT.precomprometidoaux as precomprometido ,".
				"                 PCT.comprometidoaux as comprometido ,PCT.causadoaux as causado, ".
				"                 PCT.pagadoaux as pagado,PCT.aumentoaux as  aumento , PCT.disminucionaux as disminucion,PAT.denestpro5 as denestpro5, ".$ls_cadena_montos." ".
	 ...
	 else
	 {
	    $ls_sql=" SELECT distinct PCT.codestpro1, PCT.codestpro2, PCT.codestpro3, PCT.codestpro4,PCT.codestpro5, PCT.spg_cuenta, ".
		        "                 PCT.denominacion, PCT.status,PCT.asignadoaux as asignado, PCT.precomprometidoaux as precomprometido ,".
				"                 PCT.comprometidoaux as comprometido ,PCT.causadoaux as causado, ".
				"                 PCT.pagadoaux as pagado,PCT.aumentoaux as aumento,PCT.disminucionaux as disminucion,PAT.denestpro5 ,cast(0 as money) as aumentosA, ".
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //	Description :	Método que consulta y suma lo asignado por cuenta
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ldec_monto=0;
		$ls_codemp = $this->dts_empresa["codemp"];
		$ls_sql    = " SELECT COALESCE(SUM(montoaux),0) As monto ".
                     " FROM   spg_dt_cmp PCT,spg_operaciones O ".
...
/********************************************************************************************************************************/	
    ...
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    15/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT CMP.descripcion as cmp_descripcion, CMP.fecha as fecha, MOV.*,MOV.montoaux as monto,     ".
...
/********************************************************************************************************************************/	
    ...
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    15/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT CMP.descripcion as cmp_descripcion, CMP.fecha as fecha, MOV.*,MOV.montoaux as monto,CTA.denominacion".
