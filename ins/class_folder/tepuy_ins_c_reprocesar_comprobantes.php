...
class tepuy_ins_c_reprocesar_comprobantes
{
										...
										$as_procede,$as_comprobante,$adt_fecmov,$adt_fecha)
	{
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_insertar_movimiento_scb 1 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		}
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_insertar_movimiento_scb 2 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		}
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_insertar_movimiento_scb 3 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		}
        // transferencia al nuevo registro de banco detalle de gastos
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_insertar_movimiento_scb 4 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		}
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_insertar_movimiento_scb 5 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		}
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_insertar_movimiento_scb 6 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		}
        ...
        if(($as_estmov_new!="A")||($as_estmov_new!="O")) 
		{
			...
			if($li_row===false)
			{   
           		$this->io_message->message("CLASE->Instala MÉTODO->uf_insertar_movimiento_scb 7 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
				return false;
			}
		}
		return $lb_valido;
    ...
    function uf_delete_movimiento_scb($as_codemp,$as_codban,$as_ctaban,$as_numdoc,$as_codope,$as_estmov)
	{
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_delete_movimiento_scb 1 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		} 
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_delete_movimiento_scb 2 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		}
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_delete_movimiento_scb 3 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		}
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_delete_movimiento_scb 4 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		}
        // transferencia al nuevo registro de banco detalle contables
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_delete_movimiento_scb 5 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		}
		...
		if($li_row===false)
		{   
           	$this->io_message->message("CLASE->Instala MÉTODO->uf_delete_movimiento_scb 6 ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));			
			return false;
		}
		return $lb_valido;
