...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_chq_custodia_entregados.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
  ...
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="22" colspan="4" align="center"><table width="483" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td width="224"><div align="right"></div>            
            <div align="right">
  ...
  if (li_imprimir=='1')
     {
       if (ld_fecdesde!="" && ld_fechasta!="")
          {
 	        pagina="reportes/tepuy_scb_rpp_chq_custodia_entregados.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&tiprep="+ls_tiprep+"&codban="+ls_codban+"&denban="+ls_nomban+"&ctaban="+ls_ctaban+"&dencta="+ls_dencta
...
function rellenar_cad(cadena,longitud,objeto)
{
 ...
 function currencyDate(date)
  ...
  //  return false; 
	...
	{
		f=document.form1;
		window.open("tepuy_cat_bancos.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	...
	function cat_ctabanco()
	{
		...
		{
			window.open("tepuy_cat_ctabanco.php?codigo="+ls_codban+"&hidnomban="+ls_denban,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=620,height=400,left=50,top=50,location=no,resizable=yes");
		}
		else
		{
...
//Catalogo de cuentas contables
	function cat_desde()
	{
		...
		if(f.rb_provbene[0].checked)
		{
			window.open("tepuy_cat_prov_general.php?obj=txtprovbendesde","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
		}
		else if(f.rb_provbene[1].checked)
		{
			window.open("tepuy_cat_bene_general.php?obj=txtprovbendesde","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
		}
	}
	function cat_hasta()
	{
