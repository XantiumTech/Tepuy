<?php
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $io_pdf->Rectangle(19,70,570,40);

        $io_pdf->Rectangle(19,20,570,80);		
		$io_pdf->line(95,20,95,100);		
		$io_pdf->line(210,20,210,100);		
		$io_pdf->line(345,20,345,100);	
		$io_pdf->line(425,20,425,110);	
		
		$io_pdf->addText(200,102,8,"<b>INSTITUCION</b>"); // Agregar el título
		$io_pdf->addText(430,102,8,"<b>OFICINA NACIONAL DE PRESUPUESTO</b>"); // Agregar el título

			
		$io_pdf->addText(25,90,7,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(125,90,7,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(100,80,7,"DIRECTOR DE PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(240,90,7,"CONFORMADO POR:"); // Agregar el título
		$io_pdf->addText(250,80,7,"DIRECTOR DE "); // Agregar el título
		$io_pdf->addText(220,70,7,"PLANIFICACION Y PRESUPUESTO"); // Agregar el título
	    $io_pdf->addText(350,90,7,"CONFORMADO POR:"); // Agregar el título
		$io_pdf->addText(347,80,7," DIRECTOR GENERAL "); // Agregar el título
		$io_pdf->addText(475,90,7,"APROBADO POR: "); // Agregar el título*/
		$io_pdf->addText(479,80,7,"PRESIDENCIA"); // Agregar el título
