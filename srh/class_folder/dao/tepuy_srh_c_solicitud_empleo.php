...
class tepuy_srh_c_solicitud_empleo
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_solicitud_empleo($path)
	{   
  ...
  function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_p_solicitud_empleo)
		//      Argumento: 
 ...
 function getCedPersonal($as_cedper,&$ao_datos="")
  ...
  {  
		...
		//         access: public (tepuy_srh_solicitud_empleo)														            //
...
function uf_srh_buscar_solicitud_empleo($as_nrosol,$as_cedper,$as_apeper,$as_nomper,$as_fecsol1, $as_fecsol2,$as_tipo,$as_tipocaja)
	{
		...
		$lb_valido=true;				
		$ls_sql= "SELECT *  FROM srh_solicitud_empleo INNER JOIN srh_nivelseleccion ON (srh_nivelseleccion.codniv = srh_solicitud_empleo.codniv) INNER JOIN tepuy_parroquia ON (tepuy_parroquia.codpar = srh_solicitud_empleo.codpar AND tepuy_parroquia.codmun= srh_solicitud_empleo.codmun AND tepuy_parroquia.codest= srh_solicitud_empleo.codest) INNER JOIN tepuy_municipio ON (srh_solicitud_empleo.codmun = tepuy_municipio.codmun AND tepuy_parroquia.codmun = tepuy_municipio.codmun) INNER JOIN tepuy_estados ON (tepuy_municipio.codest = tepuy_estados.codest AND  srh_solicitud_empleo.codest = tepuy_estados.codest AND  tepuy_parroquia.codest = tepuy_estados.codest) INNER JOIN tepuy_pais ON (tepuy_municipio.codpai = tepuy_pais.codpai AND  srh_solicitud_empleo.codpai = tepuy_pais.codpai AND  tepuy_parroquia.codpai = tepuy_pais.codpai) INNER JOIN sno_profesion ON (sno_profesion.codpro = srh_solicitud_empleo.codpro)".
				" WHERE nrosol like '$as_nrosol' ".
...
function uf_srh_guardar_dt_solicitud_empleo($po_solicitud, $aa_seguridad)
  { 
		...
		//         access: public (tepuy_srh_dt_solicitud_empleo)														        //
...
function uf_srh_eliminar_dt_solicitud_empleo($ps_nrosol, $aa_seguridad)
  {
		...
		//        access:  public (tepuy_dt_srh_solicitud_empleo)														        //
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		else
		{
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ao_object[$ai_totrows][5]="<a href=javascript:catalogo_area(".$ai_totrows.");  align=center><img src=../../../../shared/imagebank/tools15/buscar.png alt=Buscar width=15 height=15 border=0 align=center></a>";
...
}// end   class tepuy_srh_c_solicitud_empleo
?>