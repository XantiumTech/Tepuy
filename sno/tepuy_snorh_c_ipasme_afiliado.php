<?PHP
class tepuy_snorh_c_ipasme_afiliado
{
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_snorh_c_ipasme_afiliado()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_snorh_c_ipasme_afiliado
		//		   Access: public (tepuy_snorh_d_ipasme_afiliado)
	...
	}// end function tepuy_snorh_c_ipasme_afiliado
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_gendisk_aporte($as_codnomdes,$as_codnomhas,$as_anocurper,$as_mescurper,$ad_fecmov,$as_ruta,$aa_seguridad)
	{
		...
		//         Access: public (desde la clase tepuy_snorh_r_ipasme_aporte)  
