...
<table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
  ...
  <tr>
    ...
    <td width="134" height="22"><div align="left">
      ...
      <a href="javascript:catalogo_tiporequerimiento();"><img src="../../../../shared/imagebank/tools15/buscar.png"  name="buscartip" width="15" height="15" border="0" id="buscartip"></a> </div></td> 
	...
	function catalogo_tiporequerimiento()
{
      pagina="../catalogos/tepuy_srh_cat_tiporequerimiento.php?valor_cat=0";
		...
		var loadDataURL = "../../php/tepuy_srh_a_requerimiento.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_requerimiento.php";
		var mygrid;
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_requerimiento.php?valor=buscar"+"&txtcodreq="+codreq+"&txtdenreq="+denreq+"&txtcodtipreq="+codtipreq);
	       setTimeout (terminar_buscar,500);
