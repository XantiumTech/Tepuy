...
/*			$lb_valido=$in_classcmp->uf_update_bsf_tepuycmp($ldec_monto,$ls_codemp,$ls_procede,$ls_comprobante,
...
<table width="567" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  ...
  <tr>
    ...
    <td height="22"><input name="txtdescripcion" type="text" id="txtdescripcion" size="80" maxlength="100" style="text-align:left" value="<?php print $ls_descripcion;?>" onBlur="javascript: ue_validarcomillas(this)"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <a href="javascript:catalogo_cuentasSCG();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Catálogo de Cuentas de Gastos"></a>	 <input name="txtdenominacion" type="text" class="sin-borde" id="txtdenominacion3" style="text-align:left" value="<?php print $ls_denominacion ?>" size="55" maxlength="254"></td>
  </tr>
  <tr>
...
<script language="JavaScript">
  function aceptar_presupuestario()
  {
	...
	if((ls_cuenta!="")&&(ls_procedencia!="")&&(ls_documento!="")&&(ldec_monto!="")&&(ls_debhab!="")&&(ls_descripcion!=""))
	{
		...
		f.action="tepuy_w_regdt_contable.php";
		f.submit();
	}
	else
	{
