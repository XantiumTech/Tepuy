...
<!-- ******** END ALLWEBMENUS CODE FOR menu ******** -->
 <!-- <tr>
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_nuevo();"><img src="../shared/imagebank/tools20/nuevo.png" alt="Nuevo" width="20" height="20" border="0"></a>
...
<?php
require_once("class_folder/tepuy_cfg_c_unidad_tributaria.php");
...
$io_unidad_tributaria = new tepuy_cfg_c_unidad_tributaria();
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "CFG";
	$ls_ventanas = "tepuy_cfg_d_unidad_tributaria.php";
...
{ 
  ...
  if (li_incluir==1)
	 {	
	   ...
	   //f.txtcodigo.focus(); 
	   f.action="tepuy_cfg_d_unidad_tributaria.php";
	   f.submit();
	}
  else
	{
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
	     f.operacion.value="";			
	     pagina="tepuy_cfg_cat_unidad_tributaria.php";
...
function ue_print()
{
	...
	if(li_imprimir==1)
		{	
		  f.operacion.value="";
		  pagina="reportes/tepuy_cfg_rpp_listado_unidades_tributarias.php";
