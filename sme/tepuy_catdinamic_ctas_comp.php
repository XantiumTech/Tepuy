...
{
	opener.document.form1.txtcontablecomp.value=cuenta;
	opener.document.form1.txtcontablecomp.readOnly=true;
	opener.document.form1.txtdencontablecomp.value=denominacion;
	close();
}
...
function ue_search()
{
	...
	f.action="tepuy_catdinamic_ctas_comp.php";
	f.submit();
}
</script>
</html>
