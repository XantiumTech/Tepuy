<?php
   ...
   function uf_print($ad_fecfer, $as_nomfer)
   {
		...
		else
		{
			...
			{
				$ld_fecfer=$io_funciones->uf_convertirfecmostrar($row["fecfer"]);
    ...
    <table width="500" border="0" cellpadding="1" cellspacing="0" class="formato-blanco" align="center">
      <tr>
        ...
        <td width="431"><div align="left">
          <input name="txtfecfer" type="text" id="txtfecfer" size="30" maxlength="10"  onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" onKeyUp="javascript: ue_mostrar(this,event);" datepicker="true">        
        </div></td>
      </tr>
      <tr>
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="tepuy_snorh_cat_diaferiado.php";
  	f.submit();
}
</script>
</html>
