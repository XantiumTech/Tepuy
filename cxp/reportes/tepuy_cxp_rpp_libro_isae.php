<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_agenteret,$as_rifagenteret,$as_diragenteret,$as_periodo,$as_totalordenes,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText($tm,690,10,$as_titulo); // columna, fila, tamaño de letra
	...
	function uf_print_detalle($la_data,$as_fecha,&$io_pdf)
	{
		...
		$io_pdf->line(300,619,300,605);	// ESTAS LINEAS DIVIDEN LOS ESP. VERT. DE LAS FIRMAS QUE APRUEBAN (1=columna,2=fila,3=columna,4=fila)
		$io_pdf->addText(305,608.5,9,"<b>FECHA DE ENTERAMIENTO: </b>"); // Agregar el título (1=columna, 2=fila, 3 tamaño de letra)
		$io_pdf->addText(430,608.5,9,$as_fecha); // Agregar el título (1=columna, 2=fila, 3 tamaño de letra)
		...
		//$io_pdf->saveState();
		$la_columna1=array('numero'=>'<b>Nro.</b>',
					'licencia'=>'<b>Licencia ISAE</b>',
					'nombre'=>'<b>Nombre Contribuyente</b>',
					'rif'=>'<b>CI / RIF</b>',
					'factura'=>'<b>Nro. de Factura</b>',
					//  'ordenpago'=>'<b>Número</b>',
					'fechaordenpago'=>'<b>Fecha</b>',
					'montobruto'=>'<b>Monto de la Factura</b>',
					'alicuota'=>'<b>Alícuota</b>',
  					'monimp'=>'<b> Retenido</b>');
		$la_config1=array('showHeadings'=>1, // Mostrar encabezados
						 'fontSize' => 7.8, // Tamaño de Letras
						 'titleFontSize' => 8.5,  // Tamaño de Letras de los títulos
						 'showLines'=>2, // Mostrar Líneas
						 'shaded'=>1, // Sombra entre líneas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'width'=>570, // Ancho de la tabla
						 'maxWidth'=>570, // Ancho Mínimo de la tabla
						 'xPos'=>305, // Orientación de la tabla
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>27),
								'licencia'=>array('justification'=>'center','width'=>50),
								'nombre'=>array('justification'=>'center','width'=>160),
						 		'rif'=>array('justification'=>'center','width'=>60), // Justificacion y ancho de la columna
								'factura'=>array('justification'=>'center','width'=>60), // 								   'ordenpago'=>array('justification'=>'center','width'=>60), // Justificacion y ancho de
							   'fechaordenpago'=>array('justification'=>'center','width'=>50),
				 			   'montobruto'=>array('justification'=>'center','width'=>60), // Justificacion y ancho de la columna
				 			   'alicuota'=>array('justification'=>'center','width'=>40), // Justificacion y ancho de la columna
							   'monimp'=>array('justification'=>'center','width'=>60))); 
...
//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_total($ai_totbasimp,$ai_totmonimp,&$io_pdf)
	{
		...
		// Fecha Creación: 14/07/2007 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data1[1]=array('total'=>'<b>TOTAL MONTO DEL IMPUESTO RETENIDO Bs. </b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'shaded'=>0, // Sombra entre líneas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'width'=>565, // Ancho de la tabla
						 'maxWidth'=>565, // Ancho Mínimo de la tabla
						 'xPos'=>305, // Orientación de la tabla
						 'cols'=>array('total'=>array('justification'=>'right','width'=>467), // Justificacion y ancho de la columna
						 			   'total2'=>array('justification'=>'right','width'=>100))); 
	...
	function uf_print_firmas($as_nombre,$as_cedula,$as_cargo,$as_telefono,$as_formapago,$as_numero,$as_fecha,$as_monto,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetY(500); //antes 560 ahora 
...
//		$la_data[5]=array('firma1'=>'TESORERO / AGENTE DE RETENCION','firma2'=>'JEFE UNIDAD DE TRIBUTOS INTERNOS');
	...
	$ls_titulo="<b>FORMATO UNICO PARA REPORTE DE RETENCIONES DEL IMPUESTO SOBRE LAS ACTIVIDADES ECONOMICAS</b>";
	...
	if($lb_valido)
	{
		...
		else
		{
			...
			$li_totalmontoimp=0;
			$li_i=0;
			uf_print_encabezado_pagina($ls_titulo,$ls_agenteret,$ls_rifagenteret,$ls_diragenteret,$ls_periodo,$li_totrow,$io_pdf);
		...
		//	while (!$rs_data->EOF)
			{
				...
				//$ls_factura=$io_report->DS->data["numcon"][$li_i];
				...
				if($ls_tipproben=="P")$ls_licencia=$io_report->uf_select_licencia("SELECT numlic FROM rpc_proveedor WHERE rifpro='".$ls_rif."'");			
				///////////////////////////////
				$la_data[$li_i]=array('numero'=>$li_i,'licencia'=>$ls_licencia,'nombre'=>$ls_nomsujret, 'rif'=>$ls_rif,
									'factura'=>$ls_factura,
				...
				//					'montobruto'=>number_format($li_totbruto,2,",","."),
									...
									'alicuota'=>number_format($li_porded,2,",",".")."%",
