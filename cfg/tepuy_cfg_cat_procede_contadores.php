...
<table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Procedencias</td>
    </tr>
</table>
  <br>
<?php
require_once("class_folder/tepuy_cfg_c_procedencias.php");
$io_procedencia=new tepuy_cfg_c_procedencias();
...
if(array_key_exists("codsis",$_GET))
{
	$ls_codsis  = $_GET["codsis"];
}
else
{
   $ls_codsis  = "";
...
<table width="498" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td align="right"><div align="left"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0" onClick="ue_search()">Buscar</a></div></td>
      <tr>
...
if ($ls_operacion=="BUSCAR")
   {
		if($ls_codsis=="SOC")
		{
		  $ls_cadena=" AND (opeproc='SPC' OR opeproc='CPC')";
		}
		if($ls_codsis=="CXP")
		{
		  $ls_cadena=" AND opeproc='SOP'";
		}
		if($ls_codsis=="SEP")
		{
		  $ls_cadena=" AND opeproc='SPC'";
		}
		$ls_codigo="%".$_POST["txtcodigo"]."%";
		$ls_sql= " SELECT * ".
		         " FROM  tepuy_procedencias ".
				 " WHERE codsis like '".$ls_codsis."' AND ".
				 "       procede like '".$ls_codigo."' ".$ls_cadena." ";
...
<script language="JavaScript">
  ...
  {
    opener.document.form1.txtprocede.value=codigo;
	opener.document.form1.txtdenpro.value=descripcion;
	opener.document.form1.txtprocede.readOnly=true;
  ...
  function ue_search()
  {
    ...
    f.action="tepuy_cfg_cat_procede_contadores.php?codsis=<?php print $ls_codsis; ?>";
    f.submit();
  }
</script>
</html>