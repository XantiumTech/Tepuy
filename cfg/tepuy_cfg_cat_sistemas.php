...
$ls_sql=" SELECT codsis,nomsis FROM sss_sistemas ORDER BY codsis ASC ";
...
<script language="JavaScript">
  ...
  {
    opener.document.form1.txtcodigosistema.value=codigo;
	opener.document.form1.txtcodigosistema.readOnly=true;
	close();
  }
</script>
</html>