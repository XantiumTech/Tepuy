...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_tipoenfermedad.js"></script>
...
<script language="JavaScript">
		...
		var loadDataURL = "../../php/tepuy_srh_a_tipoenfermedad.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_tipoenfermedad.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_tipoenfermedad.php?valor=buscar"+"&txtcodenf="+codenf+"&txtdenenf="+denenf);
		   setTimeout (terminar_buscar,500);	
		}
