...
if($ls_operacion=="BUSCAR")
{
	...
	if($ls_logusr!='PSEGIS')
	{
		$ls_criterio="AND upper(codusu) <> 'tepuy'";
	}
	...
	if($row=$io_sql->fetch_row($rs_cta))
	{
		...
		for($z=1;$z<=$totrow;$z++)
		{
			...
			print "<td><a href=\"javascript: aceptar('$ls_empresa','$ls_codigo','$ls_cedula','$ls_nombre','$ls_apellido',".
								"					 '$ls_telefono','$ls_nota','$ls_status','$ls_codigovie','$ls_tipusu','$ls_foto',".
								"                    '$ls_destino','$ld_ultingusu');\">".$ls_codigo."</a></td>";
...
<script language="JavaScript">
	function aceptar(empresa,codigo,cedula,nombre,apellido,telefono,nota,status,codviejo,tipusu,foto,destino,ultingusu)
	{
		if(destino=="")
		{
			...
			//opener.document.form1.cmbtipusu.value=tipusu;
	...
	function ue_search()
	{
		...
		f.action="tepuy_sss_cat_usuarios.php";
		f.submit();
	}
</script>
</html>
