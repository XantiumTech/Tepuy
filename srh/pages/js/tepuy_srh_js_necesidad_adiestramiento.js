...
var url= "../../php/tepuy_srh_a_necesidad_adiestramiento.php";
var metodo='get';
...
{
  lb_valido=true;
  var la_objetos=new Array ("txtnroreg","txtfecha","txtcodper", "txtcodsup");
  
 
  var la_mensajes=new Array ("el numero de registro", "la fecha de diagnostico", "el código del personal","el codigo del supervisor");
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_p_necesidad_adiestramiento.php";
  f.submit(); 
}
...
function Consultar()
{
	  ...
	  f.operacion.value="CONSULTAR";
  	  f.action="../pantallas/tepuy_srh_p_necesidad_adiestramiento.php";
	  f.existe.value="TRUE";			
	  f.submit();	
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_necesidad_adiestramiento.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
...
{
  f= document.form1;
  pagina="../catalogos/tepuy_srh_cat_personal.php?valor_cat=0"+"&tipo=10";
...
{
      f= document.form1;
      pagina="../catalogos/tepuy_srh_cat_personal.php?valor_cat=0"+"&tipo=2";
      window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
