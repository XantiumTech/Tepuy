...
// Edición - Opciones de Tercer Nivel
stm_aix("p1i5","p1i0",[0," Mensual  ","","",-1,-1,0,"tepuy_spi_p_apertura.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Trimestral  ","","",-1,-1,0,"tepuy_spi_p_apertura_trimestral.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();

stm_aix("p1i2","p1i0",[0,"Comprobantes ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
// Edición - Opciones de Tercer Nivel
stm_aix("p1i5","p1i0",[0," Ejecuci&oacute;n Financiera  ","","",-1,-1,0,"tepuy_spi_p_comprobante.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
...
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
// Edición - Opciones de Tercer Nivel
stm_aix("p1i5","p1i0",[0," Aumentos  ","","",-1,-1,0,"tepuy_spi_p_aumento.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Disminuciones  ","","",-1,-1,0,"tepuy_spi_p_disminucion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
stm_ai("p1i1",[6,1,"#e6e6e6","",0,0,0]);
...
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
// Edición - Opciones de Tercer Nivel
stm_aix("p1i5","p1i0",[0," Mensual  ","","",-1,-1,0,"tepuy_spi_p_progrep.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Trimestral  ","","",-1,-1,0,"tepuy_spi_p_progrep_trimestral.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
stm_ep();
...
stm_aix("p4i0","p1i0",[0," Acumulado por Cuentas    ","","",-1,-1,0,"tepuy_spi_r_acum_x_cuentas.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p4i0","p1i0",[0," Mayor Analitico ","","",-1,-1,0,"tepuy_spi_r_mayor_analitico.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p4i0","p1i0",[0," Listado Apertura ","","",-1,-1,0,"tepuy_spi_r_listado_apertura.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p4i0","p1i0",[0," Comprobante ","","",-1,-1,0,"tepuy_spi_r_comprobante_formato1.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p4i0","p1i0",[0," Modificaciones Presupuestarias Aprobadas ","","",-1,-1,0,"tepuy_spi_r_modificaciones_presupuestarias_aprobadas.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p4i0","p1i0",[0," Modificaciones Presupuestarias No Aprobadas ","","",-1,-1,0,"tepuy_spi_r_modificaciones_presupuestarias_no_aprobadas.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p4i0","p1i0",[0," Listado de  Cuentas Presupuestarias  ","","",-1,-1,0,"tepuy_spi_r_cuentas.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
...
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
stm_aix("p4i0","p1i0",[0," Ejecucion Trimestral de Presupuesto de Ingreso  ","","",-1,-1,0,"tepuy_spi_r_ejecucion_trimestral.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Consolidado de Ejecuci&oacute;n Trimestral de Ingresos y Fuentes Financieras ","","",-1,-1,0,"tepuy_spi_r_instructivo_consolidado_ejecucion_trimestral.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Presupuesto de Caja ","","",-1,-1,0,"tepuy_spi_r_instructivo_presupuesto_caja.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
stm_ep();
