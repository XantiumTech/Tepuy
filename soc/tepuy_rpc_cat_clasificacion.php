			   ...
			   while($row=$io_sql->fetch_row($rs_data))
			        {
			          ...
			          echo "<td width=100 style=text-align:center><a href=\"javascript: aceptar('$ls_codcal','$ls_dencal');\">".$ls_codcal."</a></td>";
			          echo "<td width=400 style=text-align:left>".$ls_dencal."</td>";
					  echo "</tr>";
					}
               echo "</table>";
