		  ...
		  <table  border="1">
            <tr>             
			  ...
			  for($li_i=0;$li_i<$li_count;$li_i++)
			  {
					...
					print "<a href=javascript:ue_mostrar_foto('$ls_codigo')><img src='tepuy_sob_d_verfotos2.php?codigo=$ls_codigo'  border='0' width='120' height='120' style=' border-color:#3399FF; border:groove ' title='$ls_nombre'/></a>";					
					print "\n $ls_nombre";
					print"</td>";
			  }
			 	?>	
...
<script language="javascript">
	...
	{
		pagina="tepuy_sob_d_verfotoampliada.php?codigo="+codigo;
