...
//					   array('name'=>'<b>Observación: </b> '.$as_obsordcom));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' =>10, //9 Tamaño de Letras
		...
		if ($as_estcondat=='B')
		   {
			...
			/*$la_columnas=array('renglon'=>'<b>Reng.</b>','codigo'=>'<b>Código</b>',
			...
			$la_config      = array('showHeadings'=>1, // Mostrar encabezados
						 		    'fontSize' =>10, //7.5 Tamaño de Letras
						 			'titleFontSize'=>11,  //9 Tamaño de Letras de los títulos
						 			'showLines'=>1, // Mostrar Líneas
						 			'shaded'=>0, // Sombra entre líneas
						 			'width'=>570, // Ancho de la tabla
						 			'maxWidth'=>570, // Ancho Máximo de la tabla
									...
									'cols'=>array('renglon'=>array('justification'=>'center','width'=>40),      // Justificación y ancho de la columna
												//  'codigo'=>array('justification'=>'center','width'=>40),      // Justificación y ancho de la columna
						 			   			  ...
						 			   			  'cantidad'=>array('justification'=>'right','width'=>53),     // Justificación y ancho de la columna
	...
	function uf_print_detalle_cuentas($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codestpro'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   ...
						 			   'denominacion'=>array('justification'=>'left','width'=>285), // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($as_estcondat,$as_lugcom,$as_codmoneda,$ad_tasa,$ad_mondiv,$as_pais,$as_estado,$as_municipio,$as_parroquia,$ld_montot,$ls_monlet,$as_obsordcom,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize'=>10, //7 Tamaño de Letras
						 'titleFontSize'=>11,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 'width'=>575, // Ancho de la tabla
						 'maxWidth'=>575, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('monlet'=>array('justification'=>'left','width'=>415),
						               'monnum'=>array('justification'=>'right','width'=>160))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
		if(strlen(trim($as_obsordcom))>0)
		{
			...
			$la_columna=array('name'=>'');		
			$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' =>12, //9 Tamaño de Letras
						 'showLines'=>1, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 'xOrientation'=>'center', // Orientación de la tabla
						 'width'=>570, // Ancho de la tabla						 						 					 
...
/*				
        ...
        {			
				...
				$la_config=array('showHeadings'=>0, // Mostrar encabezados
								 'fontSize' => 12,   //8 Tamaño de Letras
								 'showLines'=>1,    // Mostrar Líneas
								 'shaded'=>0,       // Sombra entre líneas
								 'xOrientation'=>'center', // Orientación de la tabla
								 'width'=>570,      // Ancho de la tabla						 						 
...
/*        if( ($as_estcondat=="B")  || ($as_estcondat=="-") )
	...
	function uf_print_detalle_sep($la_datasep,&$io_pdf)
	{
		...
		$la_config =array('showHeadings'=>1, // Mostrar encabezados
						  'fontSize'=> 10, //8 Tamaño de Letras
						  'titleFontSize'=>12,  //8 Tamaño de Letras de los títulos
						  'showLines'=>1, // Mostrar Líneas
						  'shaded'=>0, // Sombra entre líneas
						  'xOrientation'=>'center', // Orientación de la tabla
						  'width'=>570, // Ancho de la tabla						 										 
	...
	function uf_print_piecabeceramonto_bsf($li_montotaux,&$io_pdf)
	{
		...
		$la_columnas=array('titulo'=>'','contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 11, //9 Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 'showLines'=>0, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
	...
	else  // Imprimimos el reporte
	{
		...
		//	$io_pdf->selectFont('../../shared/ezpdf/fonts/Helvetica.afm'); // Seleccionamos el tipo de letra
		    ...
		    if ($ls_estcondat=='B')
			   {
 			     $io_pdf->ezSetCmMargins(9,4.5,3.3,3); // Configuración de los margenes en centímetros   
			   }
			elseif($ls_estcondat=='S')
			   {
			     //$io_pdf->ezSetCmMargins(9,6.7,3.3,3); // Configuración de los margenes en centímetros
				$io_pdf->ezSetCmMargins(9,3,3.3,3); // Configuración de los margenes en centímetros      
			   }
