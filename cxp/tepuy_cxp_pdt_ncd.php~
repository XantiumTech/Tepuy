<?php
   ...
   function uf_imprimirresultados($as_numsol)
   {
		...
		$ls_sql="SELECT numsol, cod_pro, ced_bene, fecope, desope, ".
				...
				" GROUP BY codemp, numsol, codope, cod_pro, ced_bene ";
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				print "  </tr>";
				print "</table>";
				$ls_sql="SELECT cxp_dc_spg.codestpro, cxp_dc_spg.spg_cuenta, cxp_dc_spg.monto ".
						"  FROM cxp_dc_spg  ".
