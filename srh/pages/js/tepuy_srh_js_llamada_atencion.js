...
var url= "../../php/tepuy_srh_a_llamada_atencion.php";
var metodo='get';
...
{
  lb_valido=true;
  var la_objetos=new Array ("txtnrollam", "txtfecllam","txtcodper", "cmbcausa", "cmbtipo" );
  
 
  var la_mensajes=new Array ("el numero de registro", "la fecha de registro",   "el codigo del trabajador",  "la causa del registro (Amonestación / Llamda de Atención)", "el tipo");
...
{   
  f=document.form1;
   ...
   f.action="tepuy_srh_p_llamada_atencion.php";
   f.submit();
...
{
     f= document.form1;
     pagina="../catalogos/tepuy_srh_cat_causa_llamada_atencion.php?valor_cat=0"; 
  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_llamada_atencion.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=605,height=500,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
