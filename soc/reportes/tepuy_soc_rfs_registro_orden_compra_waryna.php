...
/*		$li_tm=$io_pdf->getTextWidth(13,$ad_nomusu);
		$tm=124-($li_tm/2);
		$io_pdf->addText(62,165,6,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText($tm,118,6,$ad_nomusu); // Agregar el título
		//$io_pdf->addText(187,104,6,"JEAN CARLOS OROZCO"); // Agregar el título
		//$io_pdf->addText(184,118,6,"LCDO. JHONNY MERCADO"); // Agregar el título
		$io_pdf->addText(184,118,6,"LCDA. JUDEXY BENITEZ"); // Agregar el título
		$io_pdf->addText(195,165,6,"JEFA DE COMPRAS"); // Agregar el título
		//$io_pdf->addText(320,118,6,"LCDA. LILIANA MONTILLA"); // Agregar el título
		$io_pdf->addText(320,118,6," LCDA. MARIA E. MEJIA"); // Agregar el título
		$io_pdf->addText(335,165,6,"ADMINISTRADORA"); // Agregar el título
...
//		$io_pdf->addText(492,165,6,"ALCALDE"); // Agregar el título
		$io_pdf->addText($tm,165,6,$ls_cargorep); // Agregar el título
//		$io_pdf->addText(498,125,7,"OMAR BARRIETO"); // Agregar el título
//		$io_pdf->addText(485,167,7,"CONTRALOR MUNICIPAL"); // Agregar el título

*/

		$li_tm=$io_pdf->getTextWidth(13,$ad_nomusu);
		$tm=120-($li_tm/2);
		$io_pdf->addText(60,165,6,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText($tm,118,6,$ad_nomusu); // Agregar el título
		// CONTABILIDAD ///
		...
		// TESORERO (A) ///
		$ls_jefe=$_SESSION["la_empresa"]["nomrep"];
		$li_tm=$io_pdf->getTextWidth(13,$ls_jefe);
		$tm=535-($li_tm/2);
		$io_pdf->addText($tm,118,6,$ls_jefe); // Agregar el Nombre del Jefe de Contabilidad

		$ls_cargo_jefe=$_SESSION["la_empresa"]["cargorep"];
		$li_tm=$io_pdf->getTextWidth(13,$ls_cargo_jefe);
		$tm=526-($li_tm/2);

		$io_pdf->addText($tm,165,6,$ls_cargo_jefe); // Agregar el título
		...
		if ($as_estcondat=='B')
		   {
			...
			$la_columnas=array('renglon'=>'<b>Renglón</b>','codigo'=>'<b>Código</b>',
			...
			$la_config      = array('showHeadings'=>1, // Mostrar encabezados
									...
									'cols'=>array('renglon'=>array('justification'=>'center','width'=>40),      // Justificación y ancho de la columna
												  'codigo'=>array('justification'=>'center','width'=>40),      // Justificación y ancho de la columna
						 			   			  ...
						 			   			  'unidad'=>array('justification'=>'right','width'=>51),       // Justificación y ancho de la columna
