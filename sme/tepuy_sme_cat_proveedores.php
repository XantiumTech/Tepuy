...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td height="22">&nbsp;</td>
      <td height="22" align="right">&nbsp;</td>
      <td height="22">      <div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0">Buscar Proveedor </a></div>
    <tr>
	 ...
	 while ($row=$io_sql->fetch_row($rs_data))
		   {
			 ...
			 $ls_contablecomp  = $row["sc_cuenta_comp"];
			 ...
			 '$ls_banco','$ls_cuenta','$ls_moneda','$ls_provee','$ls_contra','$ls_contable','$ls_contablecomp','$ls_denocontable','$ls_dencontablecomp','$ls_observacion','$ls_cedula','$ls_nomrep','$ls_cargo',
			 ...
			 '$ls_inspector','$ls_pais','$ls_estado','$ls_municipio','$ls_parroquia','$ls_pagweb','$ls_email','$ls_estprov','$ls_fecvenRNC','$ls_regSSO','$ls_fecvenSSO','$ls_regINCE','$ls_fecvenINCE','$ls_emailrep','$ls_grado','$ls_codbansig','$ls_denbansig','$ls_tipconpro','$lb_registronacional');\">".$ls_codpro."</a></td>";
...
function aceptar(codpro,nompro,dirpro,tipoorg,telpro,faxpro,nacpro,especialidad,rifpro,nitpro,capital,monmax,banco,cuenta,moneda,provee,contra,contable,contablecomp,denocontable,dencontablecomp,observacion,cedula,nomrep,cargo,
				 ...
				 regSSO,fecvenSSO,regINCE,fecvenINCE,emailrep,grado,codbansig,denbansig,ls_tipconpro,registronacional)
  {
	...
	opener.document.form1.txtcontablecomp.value = contablecomp;
	opener.document.form1.txtdencuenta.value    = denocontable;
	opener.document.form1.txtdencontablecomp.value    = dencontablecomp;
  ...
  function ue_search()
  {
    ...
    f.action="tepuy_sme_cat_proveedores.php";
    f.submit();
  }
</script>
</html>
