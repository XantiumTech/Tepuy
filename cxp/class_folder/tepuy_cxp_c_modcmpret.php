...
class tepuy_cxp_c_modcmpret
 {
	...
	//----------------------------------------------------------------------------------------------------------------
	function tepuy_cxp_c_modcmpret($as_path)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
*/		if($as_tipo=="P"){
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_load_solicitudesreten($as_numsol,$as_codret,$ad_fecemides,$ad_fecemihas,$as_tipooperacion)
	{
		//////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_load_solicitudes que tienen aplicada ese tipo de retencion
		//		   Access: public
		//		 Argument: as_numsol        // Numero de orden de pago
		...
		// Fecha Creación: 21/01/2016						Fecha Última Modificación : 
		//////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
			case "I":
			$ls_cadena_tipo=" AND cxp_dt_solicitudes.numrecdoc=cxp_rd_deducciones.numrecdoc AND cxp_rd_deducciones.estcmp=0";
			$ls_cadena_tipo1=" AND cxp_rd_deducciones.codded=tepuy_deducciones.codded AND tepuy_deducciones.iva=1 ";
				break;
			case "M":
			$ls_cadena_tipo=" AND cxp_dt_solicitudes.numrecdoc=cxp_rd_deducciones.numrecdoc AND cxp_rd_deducciones.estcmpim=0";
			$ls_cadena_tipo1=" AND cxp_rd_deducciones.codded=tepuy_deducciones.codded AND tepuy_deducciones.estretmun=1 ";
				break;
			case "S":
			$ls_cadena_tipo=" AND  cxp_dt_solicitudes.numrecdoc=cxp_rd_deducciones.numrecdoc AND cxp_rd_deducciones.estcmpislr=0";
			$ls_cadena_tipo1=" AND cxp_rd_deducciones.codded=tepuy_deducciones.codded AND tepuy_deducciones.islr=1 ";
				break;
			case "T":
			$ls_cadena_tipo=" AND cxp_dt_solicitudes.numrecdoc=cxp_rd_deducciones.numrecdoc AND cxp_rd_deducciones.estcmptimbrefiscal=0";
			$ls_cadena_tipo1=" AND cxp_rd_deducciones.codded=tepuy_deducciones.codded AND tepuy_deducciones.otras=1 ";
				break;
			case "O":
			$ls_cadena_tipo=" AND cxp_dt_solicitudes.numrecdoc=cxp_rd_deducciones.numrecdoc AND cxp_rd_deducciones.estcmpaporte=0";
			$ls_cadena_tipo1=" AND cxp_rd_deducciones.codded=tepuy_deducciones.codded AND tepuy_deducciones.retaposol=1 ";
				break;
		}
		...
		$ls_sql="SELECT cxp_solicitudes.numsol,cxp_solicitudes.estprosol,cxp_solicitudes.monsol,".
				"       cxp_solicitudes.estaprosol,cxp_solicitudes.fecemisol,cxp_solicitudes.tipproben,cxp_solicitudes.ced_bene,cxp_solicitudes.cod_pro,SUM(cxp_rd_deducciones.monobjret) as monobjret,SUM(cxp_rd_deducciones.monret) as monret,".
				...
				"                                                ELSE 'NINGUNO'".
				"         END) AS nombre".
				"  FROM cxp_solicitudes, cxp_dt_solicitudes, cxp_rd_deducciones, tepuy_deducciones ".
				...
				"   AND (cxp_solicitudes.estprosol='C' OR cxp_solicitudes.estprosol='P')";
				//"   AND cxp_solicitudes.estaprosol='".$as_tipooperacion."'";
		//print "codret: ".$as_codret;
		$ls_sql= $ls_sql.$ls_cadena_tipo;
		$ls_sql= $ls_sql." GROUP BY cxp_solicitudes.numsol "; //"ORDER BY cxp_solicitudes.numsol ";
		//print $ls_sql;
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
