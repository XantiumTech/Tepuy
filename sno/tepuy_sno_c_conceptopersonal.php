<?PHP
class tepuy_sno_c_conceptopersonal
{
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_sno_c_conceptopersonal()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_sno_c_conceptopersonal
		//		   Access: public (tepuy_sno_d_conceptopersonal)
	...
	}// end function tepuy_sno_c_conceptopersonal
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_load_aplicaconcepto($as_codcar,$as_codasicar,$as_codconc,&$ai_totperfil,&$ai_totrows,&$aa_object)
	{
		...
		//		   Access: public (tepuy_sno_p_aplicaconcepto)
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_load_conceptos_x_personal($as_codper,&$ai_totrows,&$aa_object)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_load_conceptos_x_personal
		//		   Access: public (tepuy_sno_d_persxconce.php)
