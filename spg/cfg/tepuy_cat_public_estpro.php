	...
	if ($li_estmodest==1)
	   {
		 $ls_sql = "SELECT a.codestpro1 as codestpro1,a.denestpro1 as denestpro1,b.codestpro2 as codestpro2,           ".
				   ...
				   " WHERE a.codemp=b.codemp         AND a.codemp=c.codemp          AND a.codemp='".$ls_codemp."' AND  ".
				   "       a.codestpro1=b.codestpro1 AND a.codestpro1=c.codestpro1  AND b.codestpro2=c.codestpro2 AND  ".
				   "       c.codestpro3 like '%".$ls_codestpro."%' AND c.denestpro3 like '%".$ls_denestpro."%'         ";
	   }
	else
	   {
		 $ls_sql="SELECT a.codestpro1 as codestpro1,a.denestpro1 as denestpro1,b.codestpro2 as codestpro2,          ".
