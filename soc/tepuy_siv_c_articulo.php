...
class tepuy_siv_c_articulo
{
	...
	function uf_siv_select_catalogo(&$ai_estnum,&$ai_estcmp)
	{
		...
		//         Access: public (tepuy_siv_d_articulo)
									 ...
									 $as_fabart,$as_ubiart,$as_docart)
	{
		...
		$ls_sql="INSERT INTO siv_articulo (codemp,codart,denart,codtipart,codunimed,feccreart,obsart,exiart,exiiniart, ".
				...
				"                          ancart, proart,fotart,codcatsig,sc_cuenta,codmil,serart,ubiart,docart,fabart)".
				...
				"         '".$as_sccuenta."','".$as_codmil."','".$as_serart."','".$as_ubiart."','".$as_docart."','".$as_fabart."')";
		//print $ls_sql; 
		...
		else
		{
				...
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ai_prearta);
	
				$this->io_rcbsf->io_ds_datos->insertRow("campo","preartbaux");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ai_preartb);
				
				$this->io_rcbsf->io_ds_datos->insertRow("campo","preartcaux");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ai_preartc);

				$this->io_rcbsf->io_ds_datos->insertRow("campo","preartdaux");
				$this->io_rcbsf->io_ds_datos->insertRow("monto",$ai_preartd);
