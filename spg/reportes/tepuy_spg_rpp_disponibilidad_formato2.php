		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			if(empty($ls_programatica_next)&&(!empty($ls_programatica)))
			{
				...
				else
				{
					...
					$ls_programatica_ant=substr($ls_codestpro1,-2)."-".substr($ls_codestpro2,-2)."-".substr($ls_codestpro3,-2);
				}
			}
			...
			if (!empty($ls_programatica_next))
			{
				 if($ls_tipoformato==1)
				 {
						...
						uf_print_pie_cabecera($ld_totalasignado,$ld_totaldisponible,$ld_totalejecutado,$ld_totalacumulado,'Bs.F',$io_pdf);				
				 ...
				 else
				 {
					...
					//	uf_print_pie_cabecera($ld_totalasignado_bsf,$ld_totaldisponible_bsf,$ld_totalejecutado_bsf,$ld_totalacumulado_bsf,'Bs.F',$io_pdf);													
