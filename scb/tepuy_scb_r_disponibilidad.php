...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_disponibilidad.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
if (array_key_exists("operacion",$_POST))
   ...
   $title[1]="<input name=chkall type=checkbox id=chkall value=1 style=width:15px;height:15px class=sin-borde onClick=javascript:uf_select_all();>";    $title[2]="Código";     $title[3]="Nombre"; 
   $grid="grid";
	...
	//////////////////////////////////////////////////////////////////////////////
	  ...
	  $ls_sql  = "SELECT codban,nomban FROM scb_banco WHERE codemp='".$ls_codemp."' AND codban<>'---' ORDER BY codban ASC";
...
?>
  <table width="439" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="379" height="22" align="left"><table width="253" class="formato-catalogo">
        <tr>
          <td width="121"><label>
...
Detallada</td>
    ...
    <tr>
      ...
      <td height="22" style="text-align:left"><input name="txtfecha" type="text" id="txtfecha"  style="text-align:left" value="<?php print $ld_fecha;?>" size="12" maxlength="10" onKeyPress="currencyDate(this);"  datepicker="true">
     </td>
    </tr>
    <tr>
        ...
        if (ls_bancos.length>0)
           {
	         if (f.opcion[0].checked)
	            {
		          pagina="reportes/tepuy_scb_rpp_disponibilidad_pdf.php?fecha="+ld_fecha+"&bancos="+ls_bancos+"&tiporeporte="+ls_tiporeporte; 	
		          window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	            }
	         else
	            {
		          pagina="reportes/tepuy_scb_rpp_disponibilidad_det_pdf.php?fecha="+ld_fecha+"&bancos="+ls_bancos+"&tiporeporte="+ls_tiporeporte;  
		          window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	            }
	       }
	    else
