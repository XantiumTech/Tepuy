<?php
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  --------------------------------------
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","tepuy_spg_r_compromisos_causados_parcialmente.php",$ls_desc_event);
	////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////////////
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			if (!empty($ls_cod_pro_next))
			{
				 ...
				 {// Hacemos un rollback de los registros, agregamos una nueva página y volvemos a imprimir
					...
					if($ls_tipoformato==1)
					{
						//uf_print_pie_cabecera($ld_subtotal_comprometer,$ld_subtotal_causado,$ld_subtotal_pagado,$io_pdf,"Total Bs.F.");	
					}
					else
					{
