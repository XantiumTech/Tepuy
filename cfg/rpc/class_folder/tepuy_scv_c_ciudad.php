<?php
class tepuy_scv_c_ciudad
{

	var $ls_sql;
	var $is_msg_error;
	
	function tepuy_scv_c_ciudad($conn)
	{
...
function uf_scv_update_ciudad($as_codpai,$as_codest,$as_codciu,$as_desciu,$aa_seguridad) 
{
	...
	{
		$this->io_sql->rollback();
		$this->is_msg_error="CLASE->tepuy_scv_c_ciudad METODO->uf_scv_update_ciudad ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);
	}
	else
	{
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
function uf_scv_delete_ciudad($as_codpai,$as_codest,$as_codciu,$aa_seguridad)
{
	...
	{
		$lb_valido=false;
		$this->io_msg->message("CLASE->tepuy_scv_c_ciudad METODO->uf_scv_delete_ciudad ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	}
	else
	{
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
	...
	{
		$lb_valido=false; 
		$this->io_msg->message("CLASE->tepuy_scv_c_ciudad METODO->uf_llenarcombo_pais ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	}
	return $rs_data;         
...
function uf_load_estados($as_codpais)
{
	...
	// Fecha de Creación:  02/10/2006      
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
	$ls_sql= " SELECT * FROM tepuy_estados".
