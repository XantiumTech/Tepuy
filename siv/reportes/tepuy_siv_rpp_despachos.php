<?php
	...
	//  MODIFICADO POR: ING.Miguel Palencia         FECHA DE MODIFICACION : 01/09/2007
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	session_start();   
	...
	function uf_print_cabecera($as_numorddes,$as_fecdes,$as_numsol,&$io_pdf)
	{
		...
		$la_data=array(array('name'=>'<b>Ordén de Despacho</b>  '.substr($as_numorddes,10,5).''),
					   array('name'=>'<b>Número de Control Interno   </b>  '.substr($as_numsol,10,5).''),
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>670, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('articulo'=>array('justification'=>'left','width'=>252), // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		$io_fun_inventario->uf_load_seguridad_reporte("SIV","tepuy_siv_r_despachos.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               ///////////////////////////////////////////////////
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			if($lb_valido)
			{
				...
				//	$la_data[$li_s]=array('articulo'=>$ls_denart,'almacen'=>$ls_nomfisalm,'unidad'=>$ls_unidad,'solicitada'=>$li_cansol,'despachada'=>$li_canart,'precio'=>$li_preuniart,'total'=>$li_montotart);
										$la_data[$li_s]=array('articulo'=>$ls_denart,'almacen'=>$ls_nomfisalm,'unidad'=>$ls_unidad,'despachada'=>$li_canart,'precio'=>$li_preuniart,'total'=>$li_montotart);
				}
