...
var loadDataURL = "../../php/tepuy_srh_a_enfermedades.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_enfermedades.php";
var mygrid;
...
function Buscar()
		{
		 ...
		 apeper=document.form1.txtapeper.value;
		  ...
		  mygrid.loadXML("../../php/tepuy_srh_a_enfermedades.php?valor=buscar"+"&txtnroreg="+nroreg+"&txtcodper="+codper+"&txtnomper="+nomper+"&txtapeper="+apeper);
