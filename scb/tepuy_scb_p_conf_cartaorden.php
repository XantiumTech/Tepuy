...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_p_conf_cartaorden.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<!--  <tr>
  ...
  <tr>
    <td height="20" class="toolbar"><div align="left"><a href="javascript: ue_nuevo();"><img  src="../shared/imagebank/tools20/nuevo.png" alt="Nuevo" title="Nuevo" width="20" height="20" border="0"></a><a href="javascript: ue_guardar();"><img src="../shared/imagebank/tools20/grabar.png" alt="Guardar" title="Guardar" width="20" height="20" border="0"></a><a href="javascript: ue_buscar();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" title="Buscar" width="20" height="20" border="0"></a>
	<a href="javascript:ue_imprimir()"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" title="Imprimir" width="20" height="20" border="0"></a>
	<a href="javascript: ue_eliminar();"><img src="../shared/imagebank/tools20/eliminar.png" alt="Eliminar" title="Eliminar" width="20" height="20" border="0"></a><a href="javascript: ue_cerrar();"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" title="Salir" width="20" height="20" border="0"></a></div></td>
  </tr>
</table>
<?php
...
function ue_nuevo()
{
	location.href="tepuy_scb_p_conf_cartaorden.php";
}

function ue_buscar()
{
	window.open("tepuy_cat_cartaorden.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=300,left=30,top=30,location=no,resizable=yes");
}
...
function ue_imprimir()
{
	...
	ls_opener="conf";
	window.open("reportes/tepuy_scb_rpp_cartaorden_pdf.php?codigo="+ls_codigo+"&opener="+ls_opener,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=700,height=600,left=0,top=0,location=no,resizable=yes");
}
