<?php
class tepuy_cfg_c_inicio_contadores
{
	var $ls_sql;
	var $is_msg_error;
//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_cfg_c_inicio_contadores($conn)
	{
...
function uf_select_nro_control_id($as_codemp,$as_id,$as_codsis,$as_procede) 
{
    ...
    {
       $lb_valido=false;
 	   $this->io_msg->message("CLASE->tepuy_cfg_c_inicio_contadores; METODO->uf_select_nro_control_id; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
    }
    else
    {
...
function uf_update_contador($as_codemp,$as_id,$as_codsis,$as_procede,$ai_nro_inicial,$ai_nro_final,$as_prefijo,$aa_seguridad) 
{
   ...
   {
	   $lb_valido=false;
  	   $this->io_msg->message("CLASE->tepuy_cfg_c_inicio_contadores; METODO->uf_update_contador; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
   }
   else
   {
		$lb_valido=true;
...
function uf_select_id($as_codemp,&$as_id,$as_codsis,$as_procede) 
{
    ...
    {
       $lb_valido=false;
 	   $this->io_msg->message("CLASE->tepuy_cfg_c_inicio_contadores; METODO->uf_select_id; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
    }
    else
    {
	   $li_numrows=$this->io_sql->num_rows($rs_data);
...
function uf_guardar_contador($as_codemp,$as_id,$as_codsis,$as_procede,$ai_nro_inicial,$ai_nro_final,$as_prefijo,$aa_seguridad) 
{
	...
	{
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->tepuy_cfg_c_inicio_contadores; METODO->uf_guardar_contador; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	}
	else
	{
		$lb_valido=true;
...
function uf_update_id_actual($as_codemp,$as_id,$as_codsis,$as_procede,$ai_estidact,$aa_seguridad) 
{
   ...
   {
	   $lb_valido=false;
  	   $this->io_msg->message("CLASE->tepuy_cfg_c_inicio_contadores; METODO->uf_update_id_actual; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
   }
   else
   {
		$lb_valido=true;
...
function uf_select_denominacion_procede(&$as_despro,$as_procede) 
{
    ...
    {
       $lb_valido=false;
 	   $this->io_msg->message("CLASE->tepuy_cfg_c_inicio_contadores; METODO->uf_select_denominacion_procede; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
    }
    else
    {
	   $li_numrows=$this->io_sql->num_rows($rs_data);
...
function uf_select_denominacion_sistema(&$as_nomsis,$as_codsis) 
{
    ...
    {
       $lb_valido=false;
 	   $this->io_msg->message("CLASE->tepuy_cfg_c_inicio_contadores; METODO->uf_select_denominacion_sistema; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
    }
    else
    {
	   $li_numrows=$this->io_sql->num_rows($rs_data);
...
function uf_llenarcombo_tiposer()
{
	...
	if ($rs_data===false)
	   {
	     $lb_valido=false;
 	     $this->io_msg->message("CLASE->tepuy_SOC_C_SERVICIO; METODO->uf_llenarcombo_tiposer; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
    else
	   {
	     $li_numrows=$this->io_sql->num_rows($rs_data);
