<?php
	...
	{	
		...
		// Titulos el Grid
		$lo_title[1]=utf8_encode("Nro. de Ficha");
		$lo_title[2]="Tipo";
		$lo_title[3]="Monto";
		$lo_title[4]=" "; 
		$ls_codpro="";
		...
		for($li_fila=1;$li_fila<=$ai_totrowrecepciones;$li_fila++)
		{
			...
			$lo_object[$li_fila][4]="<a href=javascript:ue_delete_recepcion('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>".
		...
		$lo_object[$ai_totrowrecepciones][4]="<a><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>".
		...
		print "    <tr>";
		print " 	  <td height='22' align='left'><a href='javascript:ue_catalogorecepciones();'><img src='../shared/imagebank/tools/nuevo.png' title='Agregar Detalle Recepciones' width='20' height='20' border='0'>Agregar Detalle Recepciones</a></td>";
		print "    </tr>";
		print "  </table>";
		print "<p>&nbsp;</p>";
	...
	{	
		...
		$lo_title[4]=" "; 
		$lo_object[0]="";
		require_once("tepuy_cxp_c_solicitudpago.php");
		$io_solicitud=new tepuy_cxp_c_solicitudpago("../../");
		...
		$lo_object[$li_fila][4]="<a><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>".
