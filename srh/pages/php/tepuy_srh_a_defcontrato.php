<?
	session_start();
	require_once("../../class_folder/dao/tepuy_srh_c_defcontrato.php");
	
	require_once("../../class_folder/utilidades/class_funciones_srh.php");

	$io_defcontrato= new tepuy_srh_c_defcontrato('../../../');
    $io_fun_srh=new class_funciones_srh('../../../');
	$io_fun_srh->uf_load_seguridad("SRH","tepuy_srh_d_defcontrato.php",$ls_permisos,$la_seguridad,$la_permisos);
