...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_ejecucion_compromisos.php";
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		{
			pagina="reportes/tepuy_spg_rpp_ejecucion_compromisos.php?txtcomprobante="+txtcomprobante+"&txtprocede="+txtprocede
...
{
	   pagina="tepuy_cat_comprobantesspg_reporte.php?tipocat=rep_ejecucion";
