...
<table width="473" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td align="right">&nbsp;</td>
        <td>      <div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0">Buscar</a></div>
  </table> 
<p align="center">
<?php
...
function ue_search()
{
  ...
  f.action="tepuy_catdin_bene.php";
  f.submit();
}
</script>
</html>