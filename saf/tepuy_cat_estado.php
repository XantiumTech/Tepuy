...
session_start();
   ...
   function uf_imprimirresultados($as_codpai, $as_codest, $as_desest)
   {
		...
		print "</tr>";
		$ls_sql="SELECT codest,desest FROM tepuy_estados".
    ...
    <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td><div align="right"><a href="javascript: ue_search();">
          <img src="imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a></div></td>
      </tr>
    </table>
  <br>
<?
