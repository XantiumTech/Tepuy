<?PHP
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo2,&$io_pdf)
	{
		...
		$io_pdf->addText(55,702,10,'<b>Datos de la Institución</b>'); // Agregar el título
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_columnas=array('periodo'=>'<b>Período</b>',
						   ...
						   'nomina'=>'<b>Código de la Nómina</b>',
						   'denominacion'=>'<b>Denominación de la Nómina   </b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('periodo'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   'asignaciones'=>array('justification'=>'lefth','width'=>140), // Justificación y ancho de la columna
						 			   'nomina'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'right','width'=>240))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
