<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_cmpmov,$ad_fecha,&$io_pdf)
	{
		...
		//$io_pdf->addJpegFromFile('../../shared/imagebank/LOGO ZONA EDUCATIVA LARA.jpg',12,540,280,50); // Agregar Logo
        $io_pdf->addText(801,580,8,"<b>REPÚBLICA BOLIVARIANA DE VENEZUELA</b>"); // Agregar la Fecha
		$io_pdf->addText(815,570,8,"<b>MINISTERIO DE EDUCACIÓN SUPERIOR</b>"); // Agregar la Fecha
		$io_pdf->addText(858,560,8,"<b>DIRECCIÓN DEL DESPACHO</b>"); // Agregar la Fecha
		$io_pdf->addText(797,550,8,"<b>OFICINA DE ADMINISTRACIÓN Y SERVICIOS</b>"); // Agregar la Fecha
		$io_pdf->addText(805,540,8,"<b>COORDINACIÓN DE BIENES NACIONALES</b>"); // Agregar la Fecha
		...
		$io_pdf->addText(850,520,8,"No.:  ".$as_cmpmov); // Agregar la Fecha
		$io_pdf->addText(850,505,8,"Fecha:  ".date("d/m/Y")); // Agregar la Fecha
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_codemp,$as_nomemp,$ls_coduniadm,$ls_denuniadm,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);
	    $io_pdf->rectangle(16,380,965,120);
		$io_pdf->addText(45,489,9,"<b>Organismo</b>"); // Agregar texto
		$io_pdf->addText(50,475,9,$as_codemp); // Agregar texto
		$io_pdf->addText(100,475,9,$as_nomemp); // Agregar texto
		$io_pdf->line(95,470,95,487);   //linea vertical
		$io_pdf->line(17,487,980,487);  // linea horizontal
		$io_pdf->line(17,470,980,470);  // linea horizontal
		$io_pdf->addText(45,460,9,"<b>Unidad Administradora</b>"); // Agregar texto
		...
		$io_pdf->line(17,455,980,455);  //linea horizontal
		$io_pdf->line(17,435,980,435);  // linea horizontal
		$io_pdf->addText(45,425,9,"<b>Dependencia Usuaria (Unidad Solicitante)</b>"); // Agregar texto
		$io_pdf->line(17,420,980,420);  // linea horizontal
		$io_pdf->line(95,400,95,420);   //linea vertical
		$io_pdf->addText(30,430,9,''); // Agregar texto
		$io_pdf->addText(100,430,9,''); // Agregar texto
		$io_pdf->line(17,400,980,400);  // linea horizontal
		$io_pdf->addText(45,390,9,"<b>Almacén Responsable</b>"); // Agregar texto
		$io_pdf->ezSetY(382);
		$la_data[1]=array('cantidad'=>'<b>Código</b>',
						  'catalogo'=>'<b>Denominación</b>',
						  'codact'=>'<b>C.I.</b>',
						  'denact'=>'<b>Apellidos y Nombres</b>',
						  'codcau'=>'<b>Cargo</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>965, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('cantidad'=>array('justification'=>'center','width'=>200), // Justificación y ancho de la columna
						 			   'catalogo'=>array('justification'=>'center','width'=>250), // Justificación y ancho de la columna
						 			   'codact'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   'denact'=>array('justification'=>'center','width'=>298), // Justificación y ancho de la columna
						 			   'codcau'=>array('justification'=>'center','width'=>97))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
		$la_data[2]=array('canti'=>'',
						  'cata'=>'',
						  'coda'=>'',
						  'dena'=>'',
						  'codca'=>'');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>965, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('canti'=>array('justification'=>'center','width'=>200), // Justificación y ancho de la columna
						 			   'cata'=>array('justification'=>'center','width'=>250), // Justificación y ancho de la columna
						 			   'coda'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   'dena'=>array('justification'=>'center','width'=>298), // Justificación y ancho de la columna
						 			   'codca'=>array('justification'=>'center','width'=>97))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
...
///////////////////////////////////////////         Cuadro Inferior        /////////////////////////////////////////////////////////
	...
	else // Imprimimos el reporte
	{
		...
		$io_fun_activos->uf_load_seguridad_reporte("SAF","tepuy_saf_r_compreasignacion.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////
