...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_escalageneral.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_escalageneral.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img;
		   mygrid.loadXML("../../php/tepuy_srh_a_escalageneral.php?valor=buscar"+"&txtcodesc="+codesc+"&txtdenesc="+denesc);
           setTimeout (terminar_buscar,500);
		...
		function aceptar(ls_codesc,ls_denesc,ls_coddestino,ls_dendestino,ls_valini,ls_valfin,ls_valinidestino,ls_valfindestino)
		{
			...
			{		
				...
				opener.document.form1.action="../pantallas/tepuy_srh_d_escalageneral.php";
