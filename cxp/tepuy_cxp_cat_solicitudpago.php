...
<html>
<head>
<title>Cat&aacute;logo de Ordenes de Pago </title>
...
<table width="530" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="526" height="20" colspan="2" class="titulo-ventana">Cat&aacute;logo de Ordenes de Pago </td>
    </tr>
  </table>
  <br>
    <table width="520" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        <td height="21"><div align="right">N&uacute;mero de Orden de Pago </div></td>
...
function ue_cambiardestino()
{
	...
	if(tipdes!="-")
	{
		...
		if(tipdes=="P")
		{
			window.open("tepuy_cxp_cat_proveedor.php?tipo="+tipo+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
		}
		else
		{
			window.open("tepuy_cxp_cat_beneficiario.php?tipo="+tipo+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
		}	
	}
}
