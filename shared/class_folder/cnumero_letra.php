...
class cnumero_letra
{
	...
	function uf_convertir_letra($adec_numero,$ls_prefijo,$ls_sufijo)
	{
		...
		{
			$ls_montoletra=$ls_prefijo.strtoupper($this->uf_letra($ldec_bolivares).' Bolivares '.$this->io_function->iif_string("'$ldec_centimos' >'0'", " Con ".floatval(round($ldec_centimos,2)*100)."/100 Centimos"," Con 00 Centimos ")).$ls_sufijo;
		}
