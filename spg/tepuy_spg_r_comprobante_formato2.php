...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
    ...
    $ls_reporte=$io_fun_gasto->uf_select_config("SPG","REPORTE","COMPROBANTE_FORM2","tepuy_spg_rpp_comprobante_formato2.php","C");
    
	$dat=$_SESSION["la_empresa"];
	$ls_empresa=$dat["codemp"];
	$ls_logusr=$_SESSION["la_logusr"];
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_comprobante_formato2.php";
      ...
      <td colspan="3" align="center">      <div align="left">
        <table width="480" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="84"><div align="left"><a href="javascript:catalogo_cuentas();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a></div></td>
            <td width="94">
              <div align="right"></div>
...
function ue_showouput(ls_reporte)
{
	...
	if(li_imprimir==1)
	{
		...
		{
			pagina="reportes/"+ls_reporte+"?txtcuentades="+txtcuentades
