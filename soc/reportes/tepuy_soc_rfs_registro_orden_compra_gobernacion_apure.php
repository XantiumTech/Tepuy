...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm,$as_uniejeaso,$as_codfuefin,
									   ...
									   $ls_forpagcom,&$io_pdf)
	{
        ...
        $io_pdf->Rectangle(105,700,480,60);
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],15,693,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		if($as_estcondat=="B") 
        {
		...
		// cuadro inferior
        $io_pdf->Rectangle(15,30,575,113);
		$io_pdf->line(15,85,590,85);
		$io_pdf->line(120,85,120,143);
		$io_pdf->line(140,85,140,115);
		$io_pdf->line(160,85,160,115);
		$io_pdf->line(180,85,180,143);
			
		$io_pdf->line(320,85,320,143);
		$io_pdf->line(340,85,340,115);
		$io_pdf->line(360,85,360,115);
		$io_pdf->line(380,85,380,143);
			
		$io_pdf->line(320,30,320,103);
		$io_pdf->line(340,30,340,60);
		$io_pdf->line(360,30,360,60);
		$io_pdf->line(380,30,380,103);
			
		$io_pdf->line(530,85,530,143);
		$io_pdf->line(550,85,550,115);
		$io_pdf->line(570,85,570,115);
			
		$io_pdf->addText(140,136,6,"FECHA");
		$io_pdf->addText(132,114,6,"D       M       A");
		$io_pdf->addText(340,136,6,"FECHA");
		$io_pdf->addText(332,114,6,"D       M       A");
		$io_pdf->addText(550,136,6,"FECHA");
		$io_pdf->addText(542,114,6,"D       M       A");
		$io_pdf->addText(550,79,6,"FECHA");
		$io_pdf->addText(542,59,6,"D       M       A");
		$io_pdf->addText(138,79,6,"FECHA");
		$io_pdf->addText(130,59,6,"D       M       A");
		$io_pdf->addText(340,79,6,"FECHA");
		$io_pdf->addText(332,59,6,"D       M       A");
			
		$io_pdf->addText(42,87,6,"JEFE DE COMPRAS ");
		$io_pdf->addText(80,30,6,"");
		$io_pdf->addText(210,87,6,"DIRECTOR DE ADMINISTRACION");
		$io_pdf->addText(310,30,6,"");
		$io_pdf->addText(440,87,6,"GOBERNADOR");
		$io_pdf->addText(450,33,6,"");
		$io_pdf->addText(25,32,6,"ANALISTA DE PRESUPUESTO");
		$io_pdf->addText(199,37,6,"JEFE DE REGISTRO Y CONTROL");
		$io_pdf->addText(230,31,6,"DE BIENES");
		$io_pdf->addText(440,32,6,"ALMACENISTA");
			
		$io_pdf->line(120,30,120,85);
		$io_pdf->line(140,30,140,60);
		$io_pdf->line(160,30,160,60);
		$io_pdf->line(180,30,180,85);
		
		$io_pdf->line(530,30,530,85);
		$io_pdf->line(550,30,550,60);
		$io_pdf->line(570,30,570,60);
		...
		if (!empty($as_uniejeaso))
		   {
			 $la_data[1]=array('columna1'=>'<b>Unidades Ejecutoras Asociadas: </b>'.$as_uniejeaso);
			 $la_columnas=array('columna1'=>'');
			 $la_config=array('showHeadings'=>0, // Mostrar encabezados
							  'fontSize' => 9, // Tamaño de Letras
							  'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	function uf_print_piecabeceramonto_bsf($li_montotaux,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_data[1]=array('titulo'=>'<b>Monto Bs.</b>','contenido'=>$li_montotaux);
		$la_columnas=array('titulo'=>'',
						   'contenido'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
		...
		$la_data[1]=array('titulo'=>'<b> Observacion: </b>');
		$la_columnas=array('titulo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(8.5,5.5,3,3); // Configuración de los margenes en centímetros
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,$ls_uniejeaso,
