<?php
	...
	$io_fun_nomina->uf_load_seguridad("SNO","tepuy_sno_p_hmodificarnomina.php",$ls_permisos,$la_seguridad,$la_permisos);
   ...
   function uf_limpiarvariables()
   {
		...
		global $ls_recdocfid, $ls_tipdocfid, $ls_codbenfid, $ls_cueconfid;
	...
	switch ($ls_operacion) 
	{
		...
		case "GUARDAR":
			...
			$lb_valido=$io_nomina->uf_update_nomina_historico($ls_codnom,$ls_consulnom,substr($ls_descomnom,0,1),
															  ...
															  $ls_tipdocfid,$ls_codbenfid,$ls_cueconfid,$la_seguridad);
			if($lb_valido)
			{
				uf_limpiarvariables();
				$ls_existe="FALSE";
...
<tr>
			...
			<td colspan="3"><div align="left" >
              ...
              <a href="javascript: ue_buscarnomina();"><img id="concepto" src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Concepto"></a></div></td>
          </tr>
              <tr >
			...
			<tr class="titulo-celdanew">
				...
				<tr>
				  ...
				  <td height="22" colspan="3">
			        ...
			        <a href="javascript: ue_buscartipodocumento('NOMINA');"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="15" height="15" border="0"></a> </div>				    <div align="right"></div>			        <div align="left"></div></td>
			    </tr>
              <tr>
                <td height="22"><div align="right">
		...
		if(f.activo.value=="")
		{
			if((lb_existe=="TRUE")&&(li_cambiar==1))
			{
				...
				if ((codnom!="")&&(desnom!="")&&(desconnom!="")&&(codproben!=""))
				{
					...
					f.action="tepuy_sno_p_hmodificarnomina.php";
					f.submit();
				}
				else
				{
...
{	f=document.form1;
	...
	if (li_leer==1)
   	{
		window.open("tepuy_snorh_cat_nomina.php?tipo=HISTORICO","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
   	}
	else
   	{
 		alert("No tiene permiso para realizar esta operacion");
