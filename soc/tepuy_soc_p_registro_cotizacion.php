...
$io_fun_compra->uf_load_seguridad("SOC","tepuy_soc_p_registro_cotizacion.php",$ls_permisos,&$la_seguridad,$la_permisos);
$ls_reporte = $io_fun_compra->uf_select_config("SOC","REPORTE","FORMATO_REGCOT","tepuy_soc_rfs_registro_cotizacion.php","C");
...
switch ($li_diasem){
  ...
  break;
   ...
   function uf_limpiarvariables()
   {
        ...
        global $ls_codemp,$ls_numcot,$ls_tipcot,$ls_fecregcot,$ls_codpro,$ls_nompro,$ls_tipconpro,$ls_obscot,$li_diaent,$ld_poriva,$ls_operacion;
   ...
   function uf_load_variables()
   {
		...
		global $ls_estcot,$ls_numcot,$ls_tipcot,$ls_codpro,$ls_nompro,$ls_tipconpro,$ls_obscot,$ls_forpag,$li_diaent,$ld_poriva,$li_estinciva;
...
<?php
require_once("class_folder/tepuy_soc_c_registro_cotizacion.php");
$io_soc=new tepuy_soc_c_registro_cotizacion("../");
uf_limpiarvariables();
switch($ls_operacion){
  case 'GUARDAR':
			uf_load_variables();
...
?>
    <table width="800" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <input name="hidestcot" type="hidden" id="hidestcot" value="<?php print $ls_estcot ?>" />      </tr>
      ...
      <tr>
        ...
        <td height="22"><label>
          <input name="txtnumcot" type="text" id="txtnumcot" value="<?php print $ls_numcot ?>" size="20" maxlength="15" style="text-align:center" read tabindex="0"/>
        </label></td>
        ...
        <td height="22">&nbsp;</td>
            <td colspan="22" style="text-align:right">Fecha</td>
            <td width="217"><input name="txtfecregcot" type="text" id="txtfecregcot" style="text-align:center" onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" value="<?php print $ls_fecregcot;?>" size="15"  datepicker="true"></td>

      </tr>
      <tr>
        <td height="22" style="text-align:right">Tipo</td>
        <td height="22"><select name="cmbtipcot" id="cmbtipcot" tabindex="1" onchange="javascript:ue_cargargrid()" style="width:120px">
      ...
      <tr>
        ...
        <td height="22" colspan="5"><label>
          ...
          <a href="javascript:ue_catalogo_proveedores();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"  /></a></label>          <label>
      ...
      <tr>
        ...
        <td height="22" colspan="5"><label>
          <input name="txtobscot" type="text" id="txtobscot" value="<?php print $ls_obscot ?>" size="114" maxlength="254" style="text-align:left" tabindex="3" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyzáéíóú '+'¡!:;_°#@/?¿%&$*-,.+(){}[]='); " />
        </label></td>
      </tr>
      <tr>
        <td height="22"><div align="right">Forma de Pago </div></td>
        <td height="22"><label>
          <select name="cmbformapago" id="cmbformapago" tabindex="4">
            <option value="-" <?php print $ls_contado ?>>---seleccione---</option>
            <option value="Contado" <?php print $ls_contado ?>>Contado</option>
            <option value="Cr&eacute;dito">Cr&eacute;dito</option>
            <option value="Cheque" <?php print $ls_cheque ?>>Cheque</option>
            <option value="Carta">Carta de Cr&eacute;dito</option>
            <option value="Abono" <?php print $ls_abono ?>>Abono en Cuenta</option>
            <option value="Otros" <?php print $ls_otros ?>>Otros</option>
          </select>
        </label></td>
        <td height="22">Plazo de Entrega 
          <input name="txtdiasentrega" type="text" id="txtdiasentrega" value="<?php print $li_diaent ?>" size="6" maxlength="3" style="text-align:right" tabindex="5" onKeyPress="return keyRestrict(event,'1234567890'); "/> 
        <strong>dias </strong></td>
      ...
      <tr>
        <td height="22" colspan="2"><a href="javascript:uf_catalogo_solicitudes();"><img src="../shared/imagebank/tools20/nuevo.png" alt="Agregar Detalle Bienes" width="20" height="20" border="0" />Agregar Solicitud de Cotizaci&oacute;n</a>
        ...
        <td height="134" colspan="6">
          <table width="800" border="0" cellpadding="0" cellspacing="0" align="center" class="formato-blanco">
            ...
            <tr>
              ...
              <td width="36" height="13" align="right">&nbsp;</td>
              <td width="358" height="13" class="formato-blanco2">&nbsp;</td>
              <td width="179" height="13" align="center" class="formato-blanco2">&nbsp;</td>
            </tr>
            <tr>
              <td height="22">&nbsp;</td>
...
function ue_nuevo()
{
	...
	if (li_incluir==1)
		 ...
		 f.action          = "tepuy_soc_p_registro_cotizacion.php";
		 f.submit();
   	   }
	else
   	   {
...
function ue_cargargrid()
{
	...
	ajax.open("POST","class_folder/tepuy_soc_c_registro_cotizacion_ajax.php",true);
           ...
           { 
	         if (ls_codpro=="")
	         ...
	         else
		        {
				  ...
				  if (ls_estcot=='0')
				     {
				       pagina="tepuy_soc_cat_solicitud_cotizacion.php?origen=RC&codpro="+ls_codpro;
...
function ue_catalogo_proveedores()
{
  ...
  if (ls_estcot=='0')
     {
       pagina="tepuy_soc_cat_proveedor.php?tipo=RC";
	   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=650,height=500 resizable=yes,location=no,left=50,top=50,dependent=yer");
     }
  else
     {
					    ...
					    if (li_incorpora=='1')
					       {
					         if ((ld_porcre>0) && (ls_tipconpro=='O' || ls_tipconpro=='E'))
							    {
							      ld_preart = (ld_preart/(1+ld_porcre/100));
							      ld_creart = (ld_preart*(ld_porcre/100));
							    }
					         else
							    {
							      ld_creart = 0;
						     ...
						     ld_subart = redondear(ld_subart,2);
						     //ld_creart = redondear(ld_creart,2);
						     ld_creart = ld_creart.toFixed(2); 
						     ld_totart = redondear(ld_totart,2);
					         eval("f.txtpreart"+fila+".value='"+uf_convertir(ld_preart)+"'");
					       ...
					       {                                    
					         if ((ld_porcre>0) && (ls_tipconpro=='O' || ls_tipconpro=='E'))
						        {
							      ld_creart = ld_preart*ld_canart*(ld_porcre/100);
							    }
						     else
						        {
							      ld_creart = 0;
					    ...
					    if (li_incorpora=='1')
					       { 
					         if ((ld_porcre>0) && (ls_tipconpro=='O' || ls_tipconpro=='E'))
						 	 ...
						 	 ld_subser = redondear(ld_subser,2);
						 	 //ld_creser = redondear(ld_creser,2);
						 	 ld_creser= ld_creser.toFixed(2);
						 	 ld_totser = redondear(ld_totser,2);
...
function ue_buscar()
{
	...
	if (li_leer==1)
   	{
		window.open("tepuy_soc_cat_cotizacion.php?origen=RC","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=700,height=400,left=50,top=50,location=no,resizable=yes");
   	}
	else
   	{
 		alert("No tiene permiso para realizar esta operación !!!");
