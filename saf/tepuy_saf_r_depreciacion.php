...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_depreciacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="547" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Reporte de Depreciaci&oacute;n</td>
    </tr>
  </table>
...
function uf_mostrar_reporte()
{
	...
	if(li_imprimir==1)
	{
		...
		window.open("reportes/tepuy_saf_rpp_depreciacion.php?ordenact="+li_ordenact+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
	else
