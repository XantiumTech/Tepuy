<?php
class tepuy_rcm_c_scg
{
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_rcm_c_scg()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_rcm_c_scg
		//		   Access: public 
...
/*		$ld_fecha=date("Y_m_d_H_i");
	...
	function uf_convertir_scgcuentas()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scg MÉTODO->SELECT->uf_convertir_scgcuentas ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scgdtcmp()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scg MÉTODO->SELECT->uf_convertir_scgdtcmp ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scgdtmpcmp()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scg MÉTODO->SELECT->uf_convertir_scgdtmpcmp ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scgpcreporte()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scg MÉTODO->SELECT->uf_convertir_scgpcreporte ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_scgpcreporteant()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scg MÉTODO->SELECT->uf_convertir_scgpcreporteant ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
