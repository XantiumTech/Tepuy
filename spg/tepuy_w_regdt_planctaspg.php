...
$object[$i][4] ="<a href=javascript:uf_delete_dt('".$i."');><img src=imagebank/tools15/eliminar.png alt=Cancelar Registro de Detalle Presupuestario width=15 height=15 border=0></a>"; 
?>
</form>
</body>
<script language="JavaScript">
function cat()
{
 ...
 window.open("tepuy_catdinamic_ctaspure.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
// f.submit();
}
  function aceptar_cuenta()
  {
	...
	fop.action="tepuy_spg_d_planctas.php";
	fop.submit();	
  }
  function uf_close()
  {
