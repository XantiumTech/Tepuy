    ...
    <table width="500" border="0" cellpadding="1" cellspacing="0" class="formato-blanco" align="center">
      <tr>
        ...
        <td width="391"><div align="left">
          ...
          <a href="javascript: ue_buscarprestamo();"><img id="tipo" src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="15" height="15" border="0"></a>
...
{
	window.open("tepuy_sno_cat_tipoprestamo.php?tipo=prestamo","_blank","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
}

function ue_buscarpersonal()
{
	window.open("tepuy_sno_cat_personalnomina.php?tipo=catprestamo","_blank","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
}
...
function ue_search(existe)
{
	f=document.form1;
  	...
  	f.action="tepuy_sno_cat_prestamo.php?tipo=<?php print $ls_tipo;?>";
  	f.submit();
}
</script>
</html>
