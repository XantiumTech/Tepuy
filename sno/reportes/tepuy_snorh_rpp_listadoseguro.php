<?PHP
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte("SNR","tepuy_snorh_r_listadopersonal.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		$la_data[1]=array('codigo'=>'<b>Cédula</b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
									   ...
									   'sexo'=>array('justification'=>'center','width'=>60))); // Justificación y ancho de la columna
	...
	$ls_titulo="<b>Listado de Personal al Seguro</b>";
	...
	$ls_titulo2="<b> ".$io_fecha->uf_load_nombre_mes($ls_mes)."</b>";
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=uf_insert_seguridad($ls_titulo); // Seguridad de Reporte
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_listadoseguro($ls_codnomdes,$ls_codnomhas,$ls_codperdes,$ls_codperhas,$ls_mes,$ls_activo,
	...
	else  // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$la_data[$li_i]=array('codigo'=>$ls_codper,'nombre'=>$ls_nombre,'fecha'=>$ld_fecnacper,'edad'=>$li_edad,'sexo'=>$li_sexo);
		}
