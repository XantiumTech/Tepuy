      ...
      <td height="22" colspan="3" align="center"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          ...
          <td width="123" height="22"><input name="txtcodmov" type="text" id="txtcodmov" size="15"  style="text-align:center" readonly>
              <a href="javascript: uf_comprobante();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
      ...
      <td height="22" colspan="3" align="center"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          ...
          <td width="311" height="22"><input name="txtcodres" type="text" id="txtcodres" size="15"  style="text-align:center" readonly>
              <a href="javascript: uf_personal('');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0">
...
<script language="JavaScript">
	...
	{
		window.open("tepuy_catdinamic_movimientos_salidas.php?destino="+ ls_destino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,left=120,top=70,location=no,resizable=yes");
	}
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/tepuy_saf_rpp_autorizacion.php?ordenact="+li_ordenact+"&desde="+ld_desde+
				...
				f.action="tepuy_saf_r_autorizacion.php";
