    ...
    <table width="600" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td colspan="4"><div align="right"><a href="javascript: ue_search();">
          ...
          <img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Buscar</a></div></td>
      </tr>
  </table>
  <br>
<?php
...
{
	$ls_sql="SELECT saf_activo.*, saf_dta.ideact, saf_dta.seract,saf_dta.idchapa FROM saf_activo,saf_dta".
	...
	if($li_numrows>0)
	{
		while($row=$io_sql->fetch_row($rs_cta))
		{
			...
			print " <td><a href=\"javascript: aceptar('$ls_codact','$ls_denact','$ls_seract','$ls_ideact');\">".$ls_codact."</a></td>";
...
<script language="JavaScript">  
  function aceptar(codact,denact,seract,ideact)
  {
	...
	opener.document.form1.txtdenact.value=denact;
  ...
  f.action="tepuy_saf_cat_codactivo.php";
  f.submit();
  }
