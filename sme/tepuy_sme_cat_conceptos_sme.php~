...
<html>
<head>
<title>Cat&aacute;logo de Conceptos para Servicios M&eacute;dicos</title>
...
<table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="500" height="20" colspan="2" class="titulo-ventana">Cat&aacute;logo de Conceptos para Servicio M&eacute;dicos</td>
    </tr>
  </table>
  <br>
    <table width="500" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
	  ...
	  <tr>
        <td colspan="2"><div align="right"><a href="javascript: ue_search('<?php print $ls_cmbtipdes.'-'.$ls_codtar;?>');"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a><a href="javascript: ue_close();"> <img src="../shared/imagebank/eliminar.png" width="15" height="15" class="sin-borde">Cerrar</a></div></td>
	  </tr>
	</table> 
	<p>
...
function ue_search(cmbtipdes)
{
	...
	envios="POST";
	//envios="CONCEPTOS";
	ajax.open(envios,"class_folder/tepuy_sme_c_catalogo_ajax.php",true);
	ajax.onreadystatechange=function(){
		if(ajax.readyState==1)
		{
	...
	ajax.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
	// Enviar todos los campos a la pagina para que haga el procesamiento
	ajax.send("catalogo=CONCEPTOSSME&codconsep="+codconsep+"&denconsep="+denconsep+"&codestpro1="+codestpro1+"&codestpro2="+codestpro2+
			  "&codestpro3="+codestpro3+"&codestpro4="+codestpro4+"&codestpro5="+codestpro5+"&orden="+orden+"&campoorden="+campoorden+"&cmbtipdes="+cmbtipdes);
}
