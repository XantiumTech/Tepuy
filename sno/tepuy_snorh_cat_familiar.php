   ...
   function uf_print($as_codper, $as_cedfam, $as_nomfam, $as_apefam)
   {
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				print "'$ls_nexfam','$li_estfam','$li_hcfam','$li_hcmfam');\">".$ls_cedfam."</a></td>";
...
function aceptar(cedfam,nomfam,apefam,sexfam,fecnacfam,nexfam,estfam,hcfam,hcmfam)
{
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="tepuy_snorh_cat_familiar.php";
  	f.submit();
}
</script>
</html>
