...
if(!array_key_exists("la_logusr",$_SESSION))
{
	...
	$ls_sistema="SCG";
	$ls_ventanas="tepuy_scg_wproc_progrep_trim.php";
	...
	{	
		...
		{
			$ls_permisos="";
			//print("Bienvenido usuario tepuy");
		}
		else
		{
...
//////////////////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////
?>
<table width="682" border="0" align="center" cellpadding="1" cellspacing="1" class="formato-blanco">
          ...
          <tr class="formato-blanco">
            <td width="105"><div align="right" class="fd-blanco">Distribuci&oacute;n</div></td>
			<?Php 	 
			  ...
			  ?>
            <td width="125" class="fd-blanco">
              <input name="radiobutton" type="radio" value="N" <? print $ls_ninguno ?>>
             Ninguno</td>
            <td width="105"><span class="Estilo3">
              <input name="radiobutton" type="radio" value="A" <? print $ls_auto ?>>
            </span> <span class="fd-blanco">Automatico</span></td>
            <td width="137"><span class="Estilo3">
              <input name="radiobutton" type="radio" value="M" <? print $ls_manual ?>>
            </span> <span class="fd-blanco">Manual </span></td>
            <td width="192" class="Estilo3">
	...
	?>
            ...
            <td colspan="4"><input name="operacion" type="hidden" id="operacion" value="<? $_POST["operacion"]?>">
                <select name="cmbrep" id="cmbrep">
                  ...
                  <option value="0408" <?  print $bg ?>>Balance General</option>
                  <option value="0406" <?  print $est ?> >Estado de Resultado</option>
                  <option value="0405"  <?  print $inv ?>>Inversiones</option>
                  <option value="0414"  <?  print $cta ?>>Cuenta de Ahorro Inversi&oacute;n</option>
                </select>
                <span class="cd-titulo"> <a href="javascript: uf_selec();"><img src="../shared/imagebank/tools15/aprobado.png" alt="Aceptar" width="15" height="15" border="0"></a> </span></td>
          </tr>
          <tr class="formato-blanco">
          ...
          <tr class="formato-blanco">
            ...
            <td class="fd-blanco"><span class="cd-titulo">
              <input name="txtAsignado" type="text" class="fd-blanco" id="txtAsignado"  onBlur="uf_format(this)" onKeyPress="return(currencyFormat(this,'.',',',event))" value="<? print $ld_asignado?>" size="23" maxlength="25">
            </span></td>
            <td class="fd-blanco"><div align="right">Cuenta</div></td>
            <td colspan="2" class="fd-blanco"><input name="txtCuenta" type="text" id="txtCuenta2" value="<? print $ls_cuenta ?>" size="22" readonly></td>
          </tr>
          <tr>
  ...
  <table width="868" border="0" align="left" cellpadding="1" cellspacing="1" class="fondo-tabla">
    <tr class="titulo-ventana">
	  ...
	  <td width="110"><div align="center">Saldo Real Anterio</div></td>
	  <td width="110"><div align="center">Saldo Aprobado</div></td>
	  <td width="110"><div align="center">Saldo Modificado</div></td>
				...
				if($lb_valido)
				{
					 ...
					 { 
								...
								if($ls_status=="S")
								{
									...
									<td ><a href="javascript: aceptar('<? print $ds_prorep->getValue("asignado",$i);?>','<? print $ds_prorep->getValue("sc_cuenta",$i);?>','<? print $i?>','<? print $li_num?>','<? print $ls_status ?>','','<?php print $ds_prorep->getValue("saldo_real_ant",$i) ?>','<?php print $ds_prorep->getValue("saldo_apro",$i) ?>','<?php print $ds_prorep->getValue("saldo_mod",$i) ?>');"><? print $ds_prorep->getValue("sc_cuenta",$i);?></a></td>
									<?
								}
								elseif($ls_status=="C")
								{
	  ...
	  if ($li_rtn>0) //tiene registro
	  {
		 ...
		 { 
			...
			if($ls_status=="S")
			{
				?>
    <tr class="celdas-azules">
			    <td ><a href="javascript: aceptar('<? print $ds_prorep->getValue("asignado",$i);?>','<? print $ds_prorep->getValue("sc_cuenta",$i);?>','<? print $i?>','<? print $li_num?>','<? print $ls_status ?>','<? print $ds_prorep->getValue("enero",$i);?>','<?php print $ds_prorep->getValue("saldo_real_ant",$i) ?>','<?php print $ds_prorep->getValue("saldo_apro",$i) ?>','<?php print $ds_prorep->getValue("saldo_mod",$i) ?>');"><? print $ds_prorep->getValue("sc_cuenta",$i);?></a></td>
			    <?
		    }
		    elseif($ls_status=="C")
		    {
...
function ue_distribuir()
{
   ...
   else
   {
	    ...
	    if  (document.opcion=="M" ) 
	    {
			 ...
			 {
				 i=f.fila.value;
				 pagina="tepuy_scg_wdist_manual_trim.php?fila="+i+"&txtAsignado="+f.txtAsignado.value+"&txtsaldoreal="+f.txtsaldoreal.value+"&txtsaldoapro="+f.txtsaldoaprob.value+"&txtsaldomod="+f.txtsaldomod.value;
	   ...
	   if (document.opcion=="A")
	   {
			 ...
			 {
			   f.operacion.value="DISTRIBUIR";
			   f.action="tepuy_scg_wproc_progrep_trim.php";
			   f.submit();
			 }  
	   }
