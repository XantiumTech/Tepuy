<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","tepuy_scg_r_comprobante_formato1.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	$ls_reporte=$io_fun_scg->uf_select_config("SCG","REPORTE","COMPROBANTE_FORMATO1","tepuy_scg_rpp_comprobante_formato1.php","C");
	$ls_reporte2=$io_fun_scg->uf_select_config("SCG","REPORTE","COMPROBANTE_FORMATO1_SINDT","tepuy_scg_rpp_comprobante_formato1_sindt.php","C");
...
function ue_openexcel()
{
	...
	{	
		...
		if(f.chkmostrar.checked)
		{
			pagina="reportes/tepuy_scg_rpp_comprobante_formato1_excel.php?txtcompdes="+txtcompdes
					+"&txtcomphas="+txtcomphas+"&txtprocdes="+txtprocdes+"&txtprochas="+txtprochas
					+"&txtfecdes="+txtfecdes+"&rborden="+orden+"&txtfechas="+txtfechas+"&tiporeporte="+tiporeporte;
		}
		else
		{
			pagina="reportes/tepuy_scg_rpp_comprobante_formato1_sindt_excel.php?txtcompdes="+txtcompdes
					+"&txtcomphas="+txtcomphas+"&txtprocdes="+txtprocdes+"&txtprochas="+txtprochas
					+"&txtfecdes="+txtfecdes+"&rborden="+orden+"&txtfechas="+txtfechas+"&tiporeporte="+tiporeporte;
		}
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
