...
$io_fun_viaticos->uf_load_seguridad("SCV","tepuy_scv_d_config.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<!--  <tr>
  ...
  <tr> 
    <td width="21" height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_nuevo();"></a><a href="javascript:ue_guardar();"></a><a href="javascript:ue_buscar();"></a><a href="javascript:ue_eliminar();"></a><a href="javascript: ue_cerrar();"><a href="javascript:ue_guardar();"><img src="../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0"></a></td>
    <td width="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_buscar();"></a><a href="javascript: ue_cerrar();"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a></td>
...
require_once("class_folder/tepuy_scv_c_config.php");
$io_scv= new tepuy_scv_c_config($conn);
        ...
        <table width="668"  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="471" height="22" ><input name="txtspgnac" type="text" id="txtspgnac" value="<?php print  $ls_spgnac; ?>" size="25" style="text-align:center " readonly>
              <a href="javascript: ue_buscarspg('NACIONALES');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
          ...
          <tr>
            ...
            <td height="22"><input name="txtspgint" id="txtspgint" value="<?php print $ls_spgint; ?>" type="text" size="25"  style="text-align:center " readonly>
              <a href="javascript: ue_buscarspg('INTERNACIONALES');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
          ...
          <tr> 
            ...
            <td height="22"><input name="txtscben" type="text" id="txtscben"  style="text-align:center " value="<?php print $ls_scben; ?>" size="25" readonly>
              <a href="javascript: ue_buscarcontable('');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
function ue_guardar()
{
	...
	{  	
		...
		if((ls_spgnac!="")&&(ls_spgint!="")&&(ls_scben!=""))
		{
		   ...
		   f.action="tepuy_scv_d_config.php";
		   f.submit();
		}
		else
		{
...
{
	 window.open("tepuy_scv_cat_cuentapresupuesto.php?tipo="+ls_destino+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,left=50,top=50,resizable=yes,location=no");
}	

function ue_buscarcontable(ls_destino)	
{
	 window.open("tepuy_scv_cat_cuentacontable.php?tipo="+ls_destino+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,left=50,top=50,resizable=yes,location=no");
}	
