<?PHP
class tepuy_sno_c_metodo_banco_2
{
	var $io_mensajes;
	var $io_funciones;
	var $io_sno;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_sno_c_metodo_banco_2()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_sno_c_metodo_banco_2
		//		   Access: public 
	...
	}// end function tepuy_sno_c_metodo_banco_2
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_eap_micasa($as_ruta,$aa_ds_banco)
	{  
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_fondo_comun($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$as_codmetban,$as_desope) 
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//	   Creado Por: Ing. María Roa
		// Fecha Creación: 01/01/2006 								
		// Modificado Por: Ing. Miguel Palencia						Fecha Última Modificación : 05/05/2006
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------/*
	function uf_metodo_banco_industrial($as_ruta,$aa_ds_banco)
	{  
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($li_count>0)
		{
			...
			for($li_i=1;(($li_i<=$li_count)&&($lb_valido));$li_i++)
			{
				...
				$ls_cedper=$this->io_funciones->uf_cerosizquierda($aa_ds_banco->getValue("cedper",$li_i),11);
	...
	//-----------------------------------------------------------------------------------------------------------------------------------/*
	function uf_metodo_banco_mercantil($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcuenta,$adec_montot)
	{  
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($li_count>0)
		{
			...
			for($li_i=1;(($li_i<=$li_count)&&($lb_valido));$li_i++)
			{
				...
				$ldec_neto=$aa_ds_banco->data["monnetres"][$li_i];  
				$ldec_neto=$this->io_funciones->uf_cerosizquierda($ldec_neto*100,13);
				$ls_cedper=$this->io_funciones->uf_cerosizquierda(substr($aa_ds_banco->data["cedper"][$li_i],0,8),8);
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_mi_casa($as_ruta,$aa_ds_banco)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_provincial_guanare($as_ruta,$aa_ds_banco,$ad_fecproc)
	{ 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_provincial($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcuenta,$adec_montot)
	{  
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($li_count>0)
		{
			...
			for($li_i=1;(($li_i<=$li_count)&&($lb_valido));$li_i++)
			{
			    ...
			    $ldec_neto=$this->io_funciones->uf_cerosizquierda($ldec_neto,17);
				$ls_cedper=$this->io_funciones->uf_trim($aa_ds_banco->data["cedper"][$li_i]);
				$ls_cedper=$this->io_funciones->uf_rellenar_izq($ls_cedper,"0",15);
				$ls_nomper=trim($aa_ds_banco->data["nomper"][$li_i]);
				$ls_apeper=trim($aa_ds_banco->data["apeper"][$li_i]);
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_sofitasa($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codmetban)
	{  
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_caroni_v_2($as_ruta,$aa_ds_banco,$ad_fecproc)
	{ 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_metodo_banco_sofitasa
		//		   Access: public 
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_buscar_total(&$quincena1,&$quincena2,&$total_gen,$aa_ds_banco,$filtro_banco,&$trabajadores)
	{
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_venezuela($as_ruta,$as_archivo,$aa_ds_banco,$ad_fecproc,$as_codcuenta,$adec_montot,$as_ctaban)
	{ 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$trabajadores=0;
		$this->uf_buscar_total($quincena1,$quincena2,$total_gen,$aa_ds_banco,$sudeban,$trabajadores);
		$trabajadores=$this->io_funciones->uf_cerosizquierda($trabajadores, 4);
		if ($li_count>0)
		{ // if $li_count
			
			for($i=1;$i<=$as_archivo;$i++)
			{ // for (cantidad de archivos a generar)
				$ls_nombrearchivo=$as_ruta."/venezuela-".$i.".txt";
				//Chequea si existe el archivo.
				if (file_exists("$ls_nombrearchivo"))
				{ // revisa archivo
					if(@unlink("$ls_nombrearchivo")===false)//Borrar el archivo de texto existente para crearlo nuevo.
				...
				{ // if adiciona
					...
					else
					{
						...
						{
							// Primera Quincena //
							$li_total_deposito=$quincena1;
						}
						else // Con Decimal
						{
							// Segunda Quincena //
							$li_total_deposito=$quincena2;
						}			
					}
				}
				else
				{
					...
					//$ldec_totdep=$this->io_funciones->uf_cerosizquierda($ldec_totdep*100,13);
					//$ldec_totdep=$this->io_funciones->uf_cerosizquierda($total_gen, 13);
					$total=$this->io_funciones->uf_cerosizquierda($li_total_deposito, 13);
					//print "Total: ".$total;

					$ls_cadena="H".$ls_nombre.$ls_codcueban."01".$li_dia."/".$li_mes."/".$li_ano.$total."03291"." "."\r\n";
					if ($ls_creararchivo)
					{
						if (@fwrite($ls_creararchivo,$ls_cadena)===false)//Escritura
						{
				...
				// FIN DE LA LINEA DE CABECERA //
				//print "valor de i:".$i;
				//print "Valor de li_count:".$li_count;
				for($li_i=1;(($li_i<=$li_count)&&($lb_valido));$li_i++)
				{
					$ls_cedper=$this->io_funciones->uf_trim($aa_ds_banco->data["cedper"][$li_i]);
					...
					//print "valor de archivo: ".$as_archivo;
					if($as_archivo==1)
					{
						// Con Decimal //
				...
				//*-Si estoy acumulando reemplazo la cabecera con la información acumulada
			/*	if (($lb_valido)&&($lb_adicionado))
				{
				...
				if($lb_valido)
				{
					$li_total_personal=number_format($li_total_personal,0,"","");
					if($i==1)
					{
						// Primera Quincena //
						$li_total_personal=number_format($li_total_personal,0,"","");
					...
					{
						// Segunda Quincena //
						$li_total_personal=$quincena2;
						$li_total_personal=number_format($li_total_personal,0,"","");
					}
					$li_total_deposito=number_format($li_total_deposito,0,"","");
			...
			} // end for (cantidad de archivos a generar 
		} // end if $li_count
		else
		{
			$this->io_mensajes->message("No hay datos que generar.");
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_venezuelaespecial($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcuenta,$adec_montot)
	{ 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//	   Creado Por: Ing. María Roa
		// Fecha Creación: 01/01/2006 								
		// Modificado Por: Ing. Miguel Palencia						Fecha Última Modificación : 02/11/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$li_total_deposito=0;
		$li_total_personal=0;
		$lb_valido=true;
		...
		if ($li_count>0)
		{
			...
			for($li_i=1;(($li_i<=$li_count)&&($lb_valido));$li_i++)
			{
				...
				$ldec_neto=number_format($ldec_neto*100,0,"","");
				$ldec_neto=str_pad($ldec_neto,11,"0",0);
				$ls_nomper= strtoupper(trim($aa_ds_banco->data["nomper"][$li_i]));
				$ls_apeper= strtoupper(trim($aa_ds_banco->data["apeper"][$li_i]));
				$ls_personal=$this->io_funciones->uf_rellenar_der(substr($ls_apeper." ".$ls_nomper,0,40)," ",40);
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_venezuela_sng($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcuenta,$adec_montot)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($li_count>0)
		{
			...
			for($li_i=1;(($li_i<=$li_count)&&($lb_valido));$li_i++)
			{
				...
				$ldec_neto=$this->io_funciones->uf_cerosizquierda($ldec_neto,11);
				$ls_nomper=$this->io_funciones->uf_trim($aa_ds_banco->data["nomper"][$li_i]);
				$ls_apeper=$this->io_funciones->uf_trim($aa_ds_banco->data["apeper"][$li_i]);
				$ls_personal=$this->io_funciones->uf_rellenar_der(substr($ls_apeper.", ".$ls_nomper,0,40)," ",40);
				$ls_cedper=$this->io_funciones->uf_trim($aa_ds_banco->data["cedper"][$li_i]);
				$ls_cedper=$this->io_funciones->uf_cerosizquierda($ls_cedper,10);
				$ls_codtipcueban="";
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_lara($as_ruta,$aa_ds_banco,$as_codcuenta,$adec_montot)
	{  
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_metodo_banco_lara
		//		   Access: public 
		//	    Arguments: aa_ds_banco // arreglo (datastore) datos banco 
		//				   $as_codcuenta // Código de cuenta donde se hace el débito
		//	  Description: genera el archivo txt a disco para  el Banco Lara para pago de nomina
		//	   Creado Por: Ing. Miguel Palencia
		// Fecha Creación: 24/08/2006 								
		...
		if($li_count>0)
		{
			...
			for($li_i=1;(($li_i<=$li_count)&&($lb_valido));$li_i++)
			{
				...
				$ls_codcueban=trim($aa_ds_banco->data["codcueban"][$li_i]);
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banpro($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot)
	{  
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($li_count>0)
		{
			...
			for($li_i=1;(($li_i<=$li_count)&&($lb_valido));$li_i++)
			{
				...
				$ls_codcueban=$this->io_funciones->uf_trim(str_replace("-","",$aa_ds_banco->data["codcueban"][$li_i]));
				$ls_codcueban=substr($ls_codcueban,0,20);
				$ls_codcueban=$this->io_funciones->uf_cerosizquierda($ls_codcueban,20);
				$ldec_neto=$aa_ds_banco->data["monnetres"][$li_i];  
	...
	//-----------------------------------------------------------------------------------------------------------------------------------	
	function uf_metodo_banco_banfotran($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot,$as_codmetban)
	{  
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_venezuela_pagotaquilla($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcuenta,$adec_montot)
	{ 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($li_count>0)
		{
			...
			for($li_i=1;(($li_i<=$li_count)&&($lb_valido));$li_i++)
			{
				...
				$ls_nombre=$aa_ds_banco->data["apeper"][$li_i]." ".$aa_ds_banco->data["nomper"][$li_i];
				$ls_nombre=strtolower($ls_nombre);
				$ls_nombre=str_replace(".","",$ls_nombre);
				$ls_nombre=str_replace(",","",$ls_nombre);
				$ls_nombre=str_replace("ñ","",$ls_nombre);
				$ls_nombre=str_replace("á","a",$ls_nombre);
				$ls_nombre=str_replace("é","e",$ls_nombre);
				$ls_nombre=str_replace("í","i",$ls_nombre);
				$ls_nombre=str_replace("ó","o",$ls_nombre);
				$ls_nombre=str_replace("ú","u",$ls_nombre);
	...
	//-----------------------------------------------------------------------------------------------------------------------------------	
	function uf_metodo_banco_mercantilonline($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot,$as_codmetban)
	{  
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$li_numlote=str_pad($li_numlote,15,"0",0);
		if($li_count>0)
		{
			if (file_exists("$ls_nombrearchivo"))
			{
			...
			{		
				...
				$ls_tipreg="00";
				$ls_rifemp=str_replace("-","",$this->ls_rifemp);
				$tamano=strlen($ls_rifemp);
				$letra=substr($ls_rifemp,0,1);
				$numero=substr($ls_rifemp,1,$tamano);
				$ls_numero2=$this->io_funciones->uf_rellenar_izq($numero,"0",10);
				$ls_rifemp=$letra.$ls_numero2;
			...
			{		
				...
				{
					$li_tipregistro="01";
					$ls_nacper=$aa_ds_banco->data["nacper"][$li_i]; //Nacionalidad del Personal
					$ls_cedper=$aa_ds_banco->data["cedper"][$li_i];   //cedula del personal
					$ls_cedper=$this->io_funciones->uf_trim(str_replace(".","",$ls_cedper));
					$ls_cedper=$this->io_funciones->uf_rellenar_izq($ls_cedper,"0", 10);
					$ls_nomper=rtrim($aa_ds_banco->data["nomper"][$li_i]);   //Nombre del personal
					$ls_apeper=rtrim($aa_ds_banco->data["apeper"][$li_i]);   //Apellido del personal
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_venezuela_prepagoabono($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcuenta,$adec_montot)
	{ 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_metodo_banco_venezuela
		//		   Access: public 
		...
		if ($li_count>0)
		{
			...
			$ldec_totdepprepago=number_format($aa_ds_banco->data["totalprepago"][1],2,".","");
			if ($lb_adicionado2)
			{
			...
			else
			{
				...
				$li_cantidad=str_pad($aa_ds_banco->data["nroprepago"][1],7,"0",0);
			...
			for($li_i=1;(($li_i<=$li_count)&&($lb_valido));$li_i++)
			{
				$ls_cedper=trim($this->io_funciones->uf_trim($aa_ds_banco->data["cedper"][$li_i]));
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_federal($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$as_codmetban,$as_desope,$ad_fdesde,$ad_fhasta,
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco_agricola($as_ruta,$aa_ds_banco) 
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if(($li_count>0)&&($lb_valido))
		{
			...
			{
				$ls_nacper=$aa_ds_banco->data["nacper"][$li_i];
				$ls_cedper=str_pad(trim($aa_ds_banco->data["cedper"][$li_i]),14,"0",0);
				$ls_codcueban=$aa_ds_banco->data["codcueban"][$li_i];
				$ls_codcueban=$this->io_funciones->uf_trim(str_replace("-","",$ls_codcueban));
				$ls_codcueban=$this->io_funciones->uf_cerosizquierda(substr($ls_codcueban,0,12),12);
				$ldec_neto=number_format($aa_ds_banco->data["monnetres"][$li_i],2,".","");
