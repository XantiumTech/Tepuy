...
<html>
<head>
<title>Tranferencia del Personal de N&oacute;mina a Cliente</title>
...
<script type="text/javascript" language="JavaScript1.2" src="../shared/js/tepuy_cat_ordenar.js"></script>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Facturaci&oacute;n</td>
...
<!-- ******** END ALLWEBMENUS CODE FOR menu ******** -->
 <!-- <tr>
  ...
  <tr> 
    <td height="32" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:uf_transferir_personal();"><img src="../shared/imagebank/tools20/ejecutar.png" alt="Transferir personal..." name="Transferir" width="20" height="20" border="0" id="Transferir"></a><a href="javascript:ue_guardar();"></a><a href="javascript:ue_buscar();"></a><a href="javascript:ue_eliminar();"></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/ayuda.png" alt="Ayuda" width="20" height="20"></td>
  </tr>
</table>
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SFA";
	$ls_ventanas = "tepuy_sfa_d_transferencia.php";
...
if  (array_key_exists("operacion",$_POST))
	{
	  ...
	  //$ls_sccuentacomp= $_POST["txtcontablecomp"];
...
{ 
	...
	{ 
		if (array_key_exists("checkper".$i,$_POST))
		{
			...
			$rs_data   = $io_cliente->uf_load_datos_personal($ls_codemp,$ls_cedper);
		    	if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				$lr_datos["fecregcli"]     = $ls_fecingper;
				//$lr_datos["contablecomp"] = $ls_sccuentacomp;
				$lr_datos["codban"]       = $ls_codban;
				$lr_datos["ctaban"]       = $ls_ctaban;
				$lb_valido                = $io_cliente->uf_insert_cliente($ls_codemp,$lr_datos,$la_seguridad);
				if (!$lb_valido)
				{
					break;
				}
          ...
          <div align="center">
            <table width="490"  border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
              <tr class="titulo-celdanew">
                <td height="22" class="titulo-ventana">Transferencia de Personal de Nomina a Clientes</td>
              </tr>
...
<!--                  <tr>
                    <td height="26" colspan="4"><strong>Cta. Contable (Cuentas x Cobrar)</strong> <label>
                      <input name="txtcontablecomp" type="text" id="txtcontablecomp" value="<?php print $ls_sccuentacomp ?>" size="30" maxlength="25" style="text-align:center" readonly>
                      <a href="javascript:catalogo_cuentas(1);"><img src="../shared/imagebank/tools15/buscar.png" name="catalogo" width="15" height="15" border="0" id="catalogo" onMouseOver="xstooltip_show('tooltip_cuentas', 'catalogo',0,95);" onMouseOut="xstooltip_hide('tooltip_cuentas');"></a>
                      <input name="txtdencontablecomp" type="text" class="sin-borde" id="txtdenccontablecomp" value="<?php print $ls_dencontablecomp ?>" size="30" style="text-align:left" readonly>
                    </label></td>
                  </tr>
-->
                  <tr>
                    <td height="26" colspan="4"><strong>Cuenta Contable (Cuentas x Cobrar)</strong> <label>
                      ...
                      <a href="javascript:catalogo_cuentas(2);"><img src="../shared/imagebank/tools15/buscar.png" name="catalogo" width="15" height="15" border="0" id="catalogo" onMouseOver="xstooltip_show('tooltip_cuentas', 'catalogo',0,95);" onMouseOut="xstooltip_hide('tooltip_cuentas');"></a>
                  ...
                  <tr>
                    ...
                    <td width="124" height="22"><input name="txtcedula1" type="text" id="txtcedula1" value="<?php print $ls_cedula1 ?>" size="15" maxlength="10"  style="text-align:center " onKeyPress="return keyRestrict(event,'0123456789');">
                      <a href="javascript:uf_catalogo_personal();"><img src="../shared/imagebank/tools15/buscar.png" alt="C&oacute;digos..." width="15" height="15" border="0"  onClick="document.form1.hidrango.value=1"></a></td>
                    ...
                    <td width="159" height="22"><input name="txtcedula2" type="text" id="txtcedula2" value="<?php print $ls_cedula2 ?>" size="15" maxlength="10"  style="text-align:center " onKeyPress="return keyRestrict(event,'0123456789');">
                        <a href="javascript:uf_catalogo_personal();"><img src="../shared/imagebank/tools15/buscar.png" alt="C&oacute;digos..." width="15" height="15" border="0"  onClick="document.form1.hidrango.value=2"><strong><span class="style14">
...
if ($ls_operacion=="BUSCAR")
   {
	 $lb_valido = true;
	 $li_total  = 0;
	 $rs_data   = $io_cliente->uf_load_personal($ls_codemp,$ls_cedula1,$ls_cedula2,$ls_orden,&$lb_valido);
	 if ($lb_valido)
	    {
...
<div id="tooltip_cuentas" class="xstooltip">
	...
	al cliente una vez sea transferido.<br/>
</div>
</body>
	    ...
	    if (lb_marcadas)
		   {
			 ...
			 if (ls_cuenta=="")
			    {
				  alert("Debe establecer la Cuenta Contable (Cuentas x Cobrar) que será asociada al Cliente !!!");
				}
			 else
			    {
				//ls_cuentacomp = f.txtcontablecomp.value;
				  //mostrar('transferir');
				//alert('transferir');
				//if (ls_cuentacomp=="")
			    	//{
				//  alert("Debe establecer la Cuenta Contable (Compromiso) que será asociada al cliente !!!");
				//}
			 	//else
			    	//{
				  f.operacion.value = "TRANSFERIR";
				  f.action          = "tepuy_sfa_d_transferencia.php";
				  f.submit();
				//}
			}
		   }
...
function uf_catalogo_personal()
{
  ...
  if (li_leer==1)
	 {
       pagina="tepuy_sfa_cat_personal.php";
