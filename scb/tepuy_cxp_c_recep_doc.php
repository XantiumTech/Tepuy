<?php
class tepuy_cxp_c_recep_doc
 {
    var $ls_sql;
	var $is_msg_error;
	
	function tepuy_cxp_c_recep_doc($conn)
	{
	...
	if ($rs_data===false)
	   {
		 ...
		 $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_update_recepcion; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		 $lb_valido=false;
	   }
	else
	  {
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  $ls_sql=" INSERT INTO cxp_rd (codemp, numrecdoc, codtipdoc, ced_bene, cod_pro, codcla, ".
	...
	if ($li_row===false)
	   {
		  $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_insert_recepcion; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		  $lb_valido=false;
	   }
	else
	   {
...
////////////////////////////////////////////////////////////////////////////// 
	...
	if ($rs_data===false)
	   {
	     $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_select_recepcion; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
    else
	   {
						...
						if ($lb_valido)
						   {
							 ...
							 if ($li_numrows===false)
								{  
								  $this->io_sql->rollback();
								  $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_delete_recepcion; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
								  $lb_valido=false; 
								}
							 else
								{
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($li_numrows===false)
	 {
	   $this->io_sql->rollback();
	   $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_insert_dt_scg; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   $lb_valido=false;
	 }
  else
	{
...
////////////////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($li_numrows===false)
	 {
	   $this->io_sql->rollback();
	   $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_insert_dt_spg; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   $lb_valido=false;
	 }
	else
	{
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($li_numrows===false)
	 {
	   $this->io_sql->rollback();
	   $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_delete_dt_scg; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   $lb_valido=false;
	 }
  else
	 {
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($li_numrows===false)
	 {
	   $this->io_sql->rollback();
   	   $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_delete_dt_spg; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   $lb_valido=false;
	 }
  else
	{
...
////////////////////////////////////////////////////////////////////////////// //////////////////////////////////////////////////////////////////////////////
  ...
  if ($li_row===false)
	 {
	   $this->io_sql->rollback();
	   $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_insert_dedxrecepdoc; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
...
//////////////////////////////////////////////////////////////////////////////   
  ...
  if ($rs_data===false)
	 {
	   $this->io_sql->rollback();
	   $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_insert_carxrecepdoc; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   $lb_valido=false;
     }
  else
	{
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
	 {
	   $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_insert_cargos_comprobante; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   $lb_valido=false;
     }
  else
	{
...
//////////////////////////////////////////////////////////////////////////////
  ...
  if ($li_row===false)
	 {
	   $this->io_sql->rollback();
	   $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_insert_historicord; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   $lb_valido=false;
	 }
  else
	{
...
//////////////////////////////////////////////////////////////////////////////
  ...
  if ($li_numrows===false)
	 {
	   $this->io_sql->rollback();
	   $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_delete_historico; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   $lb_valido=false;
	 }
	else
	 {
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($li_numrows===false)
	  {
		$this->io_sql->rollback();
   	    $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_delete_dtded; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		$lb_valido=false;
      }
	else
	  {
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($li_numrows===false)
	  {
		$this->io_sql->rollback();
   	    $this->io_msg->message("CLASE->tepuy_CXP_C_RECEP_DOC; METODO->uf_delete_dtotroscre; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		$lb_valido=false;
	  }
	else
	  {
...
{
	$ls_sql ="SELECT a.*,b.porcar FROM soc_solicitudcargos a,tepuy_cargos b ".
	         " WHERE a.codemp='".$as_codemp."' AND a.numordcom='".$as_comprobante."' AND a.codcar=b.codcar"; 
	$rs_data=$this->io_sql->select($ls_sql);
	if ($rs_data===false)
	   {	
	     $lb_valido=false;
		 $this->io_msg->message("CLASE->tepuy_CLASS_C_RECEP_DOC; METODO->uf_load_dtcargos_comprobantesoc; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	 else
	   {
	     $lb_valido=true;
...
{
	$ls_sql=" SELECT a.*,b.porcar FROM sep_solicitudcargos a, tepuy_cargos b ".
	        "  WHERE a.codemp='".$as_codemp."' AND a.numsol='".$as_numsol."' AND a.codcar=b.codcar"; 
	$rs_data=$this->io_sql->select($ls_sql);
	if ($rs_data===false)
	   {	
	     $lb_valido=false;
		 $this->io_msg->message("CLASE->tepuy_CLASS_C_RECEP_DOC; METODO->uf_load_dtcargos_comprobantesep; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	 else
	   {
	     $lb_valido=true;
...
function uf_load_estatus($as_codemp,$as_numrecdoc,$as_codtipdoc,$as_cedbene,$as_codpro,&$as_estprodoc)
{
  ...
  if ($rs_data===false)
     {
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->tepuy_CLASS_C_RECEP_DOC; METODO->uf_load_estatus;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
     {
	   if ($row=$this->io_sql->fetch_row($rs_data))
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
     {
	  $this->io_msg->message("CLASE->tepuy_CLASS_C_RECEP_DOC; METODO->uf_select_rd_cargos;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));   
	 }
  else
     {
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
     {
	   $ab_existe=false;
	   $this->io_msg->message("CLASE->tepuy_CLASS_C_RECEP_DOC; METODO->uf_select_rd_deducciones;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));   
	 }
  else
     {
	   $li_numrows=$this->io_sql->num_rows($rs_data);
...
////////////////////////////////////////////////////////////////////////////// 
   ...
   switch ($ls_gestor){
   case 'MYSQL':
	  $ls_cadena=" CONCAT(a.codestpro1,a.codestpro2,a.codestpro3,a.codestpro4,a.codestpro5)= ".
				 " CONCAT(b.codestpro1,b.codestpro2,b.codestpro3,b.codestpro4,b.codestpro5) ";
	  $ls_where =" AND CONCAT(b.codestpro1,b.codestpro2,b.codestpro3,b.codestpro4,b.codestpro5)= ".
				 " CONCAT(c.codestpro1,c.codestpro2,c.codestpro3,c.codestpro4,c.codestpro5) ";
	  break;
   case 'ORACLE':
	  $ls_cadena = " CONCAT(a.codestpro1||a.codestpro2||a.codestpro3||a.codestpro4||a.codestpro5)= ".
				   " CONCAT(b.codestpro1||b.codestpro2||b.codestpro3||b.codestpro4||b.codestpro5) ";
	  ...
	  break;
   case 'POSTGRE':
	  $ls_cadena = " (a.codestpro1||a.codestpro2||a.codestpro3||a.codestpro4||a.codestpro5)= ".
				   " (b.codestpro1||b.codestpro2||b.codestpro3||b.codestpro4||b.codestpro5) ";
	  $ls_where	 = " AND (b.codestpro1||b.codestpro2||b.codestpro3||b.codestpro4||b.codestpro5)= ".
				   " (c.codestpro1||c.codestpro2||c.codestpro3||c.codestpro4||c.codestpro5)";
	  break;	    
   case 'ANYWHERE':
	  $ls_cadena=" CONCAT(a.codestpro1+a.codestpro2+a.codestpro3+a.codestpro4+a.codestpro5) = ".
		"          CONCAT(b.codestpro1+b.codestpro2+b.codestpro3+b.codestpro4+b.codestpro5) ";
	  $ls_where =" CONCAT(b.codestpro1+b.codestpro2+b.codestpro3+b.codestpro4+b.codestpro5)= ".
				 " CONCAT(c.codestpro1+c.codestpro2+c.codestpro3+c.codestpro4+c.codestpro5)  ";
	  break;
   }
   if( ($as_estcondat=="B") || ($as_estcondat=="-") || ($as_estcondat=="") )
  {
		$ls_sql="SELECT b.numordcom,b.codestpro1,b.codestpro2,b.codestpro3,b.codestpro4,b.codestpro5,b.spg_cuenta,
					   coalesce(a.monobjret,0) as baseimp ,coalesce(a.monret,b.monto) as monto,c.sc_cuenta,a.codcar
				FROM   spg_cuentas c,soc_cuentagasto b
				LEFT   OUTER JOIN soc_solicitudcargos a
				ON     (a.numordcom=b.numordcom AND ".$ls_cadena." AND a.spg_cuenta=b.spg_cuenta)
				WHERE  b.numordcom='".$as_numordcom."' AND b.codemp='".$as_codemp."' AND (b.estcondat='B' OR b.estcondat='-' OR b.estcondat='' ) AND b.spg_cuenta=c.spg_cuenta ".$ls_where."
				ORDER BY b.numordcom";
  ...
  if($as_estcondat=="S") 
  {
  	  $ls_sql="SELECT b.numordcom,b.codestpro1,b.codestpro2,b.codestpro3,b.codestpro4,b.codestpro5,b.spg_cuenta,
				...
				LEFT   OUTER JOIN soc_solicitudcargos a
				ON     (a.numordcom=b.numordcom AND ".$ls_cadena." AND a.spg_cuenta=b.spg_cuenta)
				WHERE  b.numordcom='".$as_numordcom."' AND b.codemp='".$as_codemp."' AND (b.estcondat='S') AND b.spg_cuenta=c.spg_cuenta ".$ls_where."
				ORDER BY numordcom";
  ...
  if ($rs_data===false)
     {
	   $lb_valido=false;
       $this->io_msg->message("CLASE->tepuy_CXP_RECEP_DOC; METODO->uf_load_dt_orden_compra; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
     }
  else
     {
	   $lb_valido=true;
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  $ls_sql = " SELECT  a.*,b.sc_cuenta                                                                           ".
            "   FROM  sep_cuentagasto a,spg_cuentas b                                                           ".
			"  WHERE  a.numsol='".$as_numsol."' AND a.codemp='".$as_codemp."' AND a.spg_cuenta=b.spg_cuenta AND ".
			"         $ls_cadena "; 	
print $ls_sql;			  
  $rs_data=$this->io_sql->select($ls_sql);
  if ($rs_data===false)
     {
	   $lb_valido=false;
       $this->io_msg->message("CLASE->tepuy_CXP_RECEP_DOC; METODO->uf_load_dtotros_sep; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
     }
  else
     {
	   $lb_valido=true;
...
{
  $ls_sql=" SELECT codestpro,spg_cuenta FROM tepuy_cargos WHERE codemp='".$as_codemp."' AND codcar='".$as_codcar."'";
  $rs_data=$this->io_sql->select($ls_sql);
  if ($rs_data===false)
     {
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->tepuy_CXP_RECEP_DOC; METODO->uf_load_datos_cargo; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
     {
	   $lb_valido=true;
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
     {
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->tepuy_CXP_RECEP_DOC; METODO->uf_load_sccuenta_proveedor; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
     {
	   $lb_valido=true;
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
     {
	   $lb_valido=false; 
	   $this->io_msg->message("CLASE->tepuy_CXP_RECEP_DOC; METODO->uf_load_cuenta_contable; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
     {
	   if ($row=$this->io_sql->fetch_row($rs_data))
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
  $lb_valido = false;
  $ls_sql    = " SELECT * FROM tepuy_cargos WHERE codemp='".$as_codemp."' AND spg_cuenta='".$as_cuentapre."'";
  $rs_data=$this->io_sql->select($ls_sql);
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_msg->message("CLASE->tepuy_CXP_RECEP_DOC; METODO->check_cargo; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
     {
	   if ($row=$this->io_sql->fetch_row($rs_data))
