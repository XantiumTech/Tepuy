<?PHP
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte("SNR","tepuy_snorh_r_vacaciones.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_detalle($ai_codvac,$ad_fecvenvac,$ad_fecdisvac,$ad_fecreivac,$ai_diavac,$ai_stavac,$ai_sueintvac,
							  $as_obsvac,$ai_dianorvac,$ai_diaadivac,$ai_diabonvac,$ai_diaadibon,$ai_diafer,$ai_sabdom,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[0]=array('sabdom'=>'<b>Sabados y Domingos </b>'.$ai_sabdom,
						  'total'=>'<b>Total Días de Vacación </b>'.$ai_dianorvac,'sueldo'=>'<b>Sueldo Integral de Vacaciones '.$ls_titulo.'</b> '.$ai_sueintvac);
		$la_columnas=array('sabdom'=>'<b>Sabados y Domingos</b>',
						   'total'=>'<b>Total Días de Vacación</b>',
						   'sueldo'=>'<b>Sueldo Integral de Vacaciones</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
						 'showLines'=>1, // Mostrar Líneas
					...
					switch($li_stavac)
					{
						...
						case "4":
  			   		...
  			   		uf_print_detalle($li_codvac,$ld_fecvenvac,$ld_fecdisvac,$ld_fecreivac,$li_diavac,$li_stavac,$li_sueintvac,
									 $ls_obsvac,$li_dianorvac,$li_diaadivac,$li_diabonvac,$li_diaadibon,$li_diafer,$li_sabdom,$io_pdf); // Imprimimos el detalle  
