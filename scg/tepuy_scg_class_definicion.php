...
{      
	...
	$SQL=new class_sql($con);
		...
		$ls_sql = "DELETE FROM tepuy_plan_unico WHERE sc_cuenta='".$as_cuenta."' AND denominacion='".$as_denominacion."'";
...
{      
		...
		$ls_sql = "DELETE FROM tepuy_plan_unico WHERE sig_cuenta='".$as_cuenta."' AND denominacion='".$as_denominacion."'";
