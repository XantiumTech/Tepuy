...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_distribucion_mensual_presupuesto.php";
...
?>
  ...
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
	   ...
	   ?>
        <table width="550" height="65" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          ...
          <tr class="titulo-celda">
            <td height="13" colspan="9" valign="top" class="titulo-celdanew"><strong class="titulo-celdanew">Rango Codigo Presupuestario </strong></td>
          </tr>
          <tr class="formato-blanco">
            <td width="38" height="18" align="center"><div align="right">Desde</div></td>
    ...
    <tr>
      <td colspan="4" align="center"><table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			pagina="reportes/tepuy_spg_rpp_distribucion_mensual_presupuesto.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
