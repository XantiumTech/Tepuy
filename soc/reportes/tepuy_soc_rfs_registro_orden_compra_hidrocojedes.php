...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,$ld_perentdesde,$ld_perenthasta,&$io_pdf)
	{
		...
		$io_pdf->line(480,700,480,760); // linea verical
		$io_pdf->line(480,730,585,730); // linea horizontal
		...
		/*$io_pdf->ezSetY(695);
		$la_data[1]=array('columna1'=>'<b>Procedencia Nº SEP</b>',
		                 'columna2'=>'<b>Fecha <b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>250), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>320))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_datafech,$la_columna,'',$la_config);
		unset($la_data);
		unset($la_columna);
		unset($la_config);
		*/
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
function uf_print_numsep($la_datafech,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_numsep
		//		   Access: private 
		...
		if($lb_valido)	
		{
			...
			if($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ld_fecordcom=$io_funciones->uf_convertirfecmostrar($ld_fecordcom);
					...
					$rs_dat=$io_report->uf_select_procedenciasep($ls_numordcom,&$lb_valido);
					$li_i = 0;
					while($row=$io_sql->fetch_row($rs_dat))
						{ 
							$li_i=$li_i+1;
							$ls_numsol=$row["numsol"];
							$rs=$io_report->uf_select_fechasep($ls_numordcom,&$lb_valido);
							...
							$la_datafech[$li_i]=array('columna1'=>$ls_numsol,'columna2'=>$ld_fecregsol);
				...
				{  
 					uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
											   ...
											   &$io_pdf);
					uf_print_numsep($la_datafech,&$io_pdf);
				}
				else
				{
					uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
