<?php
class tepuy_snorh_c_seleccionarhnomina
{
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_snorh_c_seleccionarhnomina()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_snorh_c_seleccionarhnomina
		//		   Access: public (tepuy_snorh_p_seleccionarhnomina)
	...
	}// end function tepuy_snorh_c_seleccionarhnomina
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_insert_temporal($as_codnom,$ai_anocurnom,$as_peractnom)
	{
		...
		{// insertamos el temporal de asignación de cargo
			$ls_sql="INSERT INTO sno_thasignacioncargo (codemp, codnom, anocur, codperi, codasicar, denasicar, claasicar, minorguniadm, ".
					...
					"			 numocuasicar, codproasicar)".
					"     SELECT codemp, codnom, anocur, codperi, codasicar, denasicar, claasicar, minorguniadm, ofiuniadm, uniuniadm, ".
					"			 depuniadm, prouniadm, codtab, codpas, codgra, codded, codtipper, numvacasicar, numocuasicar, codproasicar ".
		...
		{// insertamos el temporal de concepto
			$ls_sql="INSERT INTO sno_thconcepto (codemp, codnom, anocur, codperi, codconc, nomcon, titcon, sigcon, forcon, glocon, ".
					...
					"			 cedben, conprenom, sueintvaccon, aplarccon, conprocon, repacucon, repconsunicon, consunicon, quirepcon, ".
					...
					"			 sueintvaccon, aplarccon, conprocon, repacucon, repconsunicon, consunicon, quirepcon, asifidper, asifidpat, frevarcon ".
					"       FROM sno_hconcepto ".
					"      WHERE codemp='".$this->ls_codemp."'".
					"        AND codnom='".$as_codnom."'".
					"        AND anocur='".$ai_anocurnom."'".
		...
		{// insertamos el temporal de constante
			$ls_sql="INSERT INTO sno_thconstante (codemp, codnom, anocur, codperi, codcons, nomcon, unicon, equcon, topcon, valcon, reicon, tipnumcon)".
					"     SELECT codemp, codnom, anocur, codperi, codcons, nomcon, unicon, equcon, topcon, valcon, reicon, tipnumcon ".
					"       FROM sno_hconstante ".
					"      WHERE codemp='".$this->ls_codemp."'".
					"        AND codnom='".$as_codnom."'".
					"        AND anocur='".$ai_anocurnom."'".
		...
		{// insertamos el temporal de constante personal
			$ls_sql="INSERT INTO sno_thconstantepersonal (codemp, codnom, anocur, codperi, codper, codcons, moncon)".
					"     SELECT codemp, codnom, anocur, codperi, codper, codcons, moncon ".
		...
		{// insertamos el temporal de nómina
			$ls_sql="INSERT INTO sno_thnomina (codemp, codnom, anocurnom, peractnom, desnom, tippernom, despernom, fecininom, numpernom, tipnom, ".
					...
					"			 tipdocfid, codbenfid, cueconfid, divcon) ".
		...
		{// insertamos el temporal de personal nómina
			$ls_sql="INSERT INTO sno_thpersonalnomina (codemp, codnom, anocur, codperi, codper, codsubnom, codasicar, codtab, codgra, ".
					...
					"			 conjub, catjub, codclavia, codunirac, pagtaqper, fecascper, grado ".
		...
		{// insertamos el temporal de unidad administrativa
			$ls_sql="INSERT INTO sno_thunidadadmin (codemp, codnom, anocur, codperi, minorguniadm, ofiuniadm, uniuniadm, depuniadm, ".
					...
					"     SELECT codemp, codnom, anocur, codperi, minorguniadm, ofiuniadm, uniuniadm, depuniadm, prouniadm, desuniadm, codprouniadm ".
		...
		{// insertamos el temporal de vacacion personal
			$ls_sql="INSERT INTO sno_thvacacpersonal (codemp, codnom, anocur, codperi, codper, codvac, fecvenvac, fecdisvac, fecreivac, ".
					...
					"			 nro_dias_4, monto_4, periodo_5, cod_5, nro_dias_5, monto_5) ".
					...
					"			 monto_4, periodo_5, cod_5, nro_dias_5, monto_5 ".
		...
		if($lb_valido)
		{// insertamos el temporal de proyectopersonal
			$ls_sql="INSERT INTO sno_thclasificacionobrero (codemp, grado, codnom, anocur, codperi, suemin, suemax, tipcla, obscla, anovig, nrogac) ".
					"     SELECT codemp, grado, codnom, anocur, codperi, suemin, suemax, tipcla, obscla, anovig, nrogac ".
