...
$io_fun_activo->uf_load_seguridad("SIV","tepuy_siv_r_valtoma.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				{
					window.open("reportes/tepuy_siv_rpp_valtoma.php?desde="+ld_desde+"&hasta="+ld_hasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
					f.action="tepuy_siv_r_valtoma.php";
				}
				else
				{
