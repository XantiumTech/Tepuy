...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_depmensual.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="547" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Reporte de Depreciaci&oacute;n Mensual </td>
    </tr>
  </table>
  <table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="48" colspan="3" align="center"><table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td style="display:none"><strong>Reporte en</strong>
    ...
    <tr>
      <td colspan="3" align="center"><div align="left">
        <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td height="33"><div align="right"></div>              <div align="right"></div>              <div align="right">C&oacute;digo
...
function uf_mostrar_reporte()
{
	...
	if(li_imprimir==1)
	{
		...
		window.open("reportes/tepuy_saf_rpp_depmensual.php?ordenact="+li_ordenact+"&mes="+ls_mes+"&anio="+ls_anio+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
	else
