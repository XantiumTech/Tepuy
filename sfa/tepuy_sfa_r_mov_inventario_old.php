...
$io_fun_factura->uf_load_seguridad("SFA","tepuy_sfa_r_mov_inventario.php",$ls_permisos,&$la_seguridad,$la_permisos);
$ls_reporte = $io_fun_factura->uf_select_config("SFA","REPORTE","LISTADO_MOVIMIENTO_INVENTARIO","tepuy_sfa_rpp_mov_inventario_waryna.php","C");
...
if (array_key_exists("operacion",$_POST))
   {
     ...
     $ls_nummovdes = $_POST["txtnummovdes"];
     $ls_nummovhas = $_POST["txtnummovhas"];
     $ls_cedclides = $_POST["txtcedclides"];
	 $ls_cedclihas = $_POST["txtcedclihas"];
	 $ls_fecmovdes = $_POST["txtfecmovdes"];
	 $ls_fecmovhas = $_POST["txtfecmovhas"];
...
else
   {
     ...
     $ls_cedclides = "";
	 $ls_cedclihas = "";
     $ls_fecmovdes = '01/'.date("m/Y");
	 $ls_fecmovhas = date("d/m/Y");
	 $ls_coduniadmdes = "";
	 $ls_coduniadmhas = "";
	 $ls_cedclides = "";
	 $ls_cedclihas = "";
...
<!--       <tr>
        <td height="13" colspan="6"><table width="490" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
         <tr>
            <td colspan="4" style="text-align:left"><strong>Movimiento del Inventario</strong></td>
          </tr>
          <tr>
            <td width="63" style="text-align:right">Desde</td>
            <td width="171" style="text-align:left"><input name="txtnummovdes" type="text" id="txtnummovdes" value="<?php print $ls_nummovdes ?>" size="20" maxlength="15"  style="text-align:center "  onblur="javascript:rellenar_cad(this.value,15,this)" onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript: ue_catalogo('tepuy_sfa_cat_inventario.php?tipo=DESDE');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar hasta..." name="buscar1" width="15" height="15" border="0"  id="buscar1" /></a></td>
            <td width="44" style="text-align:right">Hasta</td>
            <td width="154" style="text-align:left"><input name="txtnummovhas" type="text" id="txtnummovhas" value="<?php print $ls_nummovhas ?>" size="20" maxlength="15"  style="text-align:center"  onblur="javascript:rellenar_cad(this.value,15,this)"  onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript: ue_catalogo('tepuy_sfa_cat_inventario.php?tipo=HASTA');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar desde..." name="buscar2" width="15" height="15" border="0" id="buscar2" /></a></td>
          </tr> 
        </table></td>
      </tr>
      <tr>
      ...
      <tr>-->
        <td height="22" colspan="6" style="text-align:center"><table width="490" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="63" style="text-align:right">Desde</td>
            <td width="171" style="text-align:left"><input name="txtfecmovdes" type="text" id="txtfecmovdes" value="<?php print $ls_fecmovdes ?>" size="12" maxlength="10"  style="text-align:left"  datepicker="true" onkeypress="currencyDate(this);" />
              <a href="javascript: ue_catalogo('tepuy_soc_cat_analisis_cotizacion.php?catalogo=txtnumanacotdes');"></a></td>
            <td width="44" style="text-align:right">Hasta</td>
            <td width="154" style="text-align:left"><input name="txtfecmovhas" type="text" id="txtfecmovhas" value="<?php print $ls_fecmovhas ?>" size="12" maxlength="10"  style="text-align:left"  datepicker="true" onkeypress="currencyDate(this);" />
...
function ue_imprimir()
{
	...
	//ls_nummovdes = f.txtnummovdes.value;
	//ls_nummovhas = f.txtnummovhas.value;
	ls_fecmovdes = f.txtfecmovdes.value;
	ls_fecmovhas = f.txtfecmovhas.value;
	ls_codprodes    = f.txtcodprodes.value;
	ls_codprohas    = f.txtcodprohas.value;


		ls_reporte  = f.formato.value;
		ls_reporte  = "tepuy_sfa_rpp_mov_inventario.php";
		//alert(ls_reporte);
		tiporeporte = f.cmbbsf.value;
		pagina="reportes/"+ls_reporte+"?fecmovdes="+ls_fecmovdes+"&fecmovhas="+ls_fecmovhas+"&codprodes="+ls_codprodes+"&codprohas="+ls_codprohas;
