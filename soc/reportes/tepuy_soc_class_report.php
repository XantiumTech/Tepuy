<?php
class tepuy_soc_class_report
{
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_soc_class_report()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_soc_class_report
		//		   Access: public 
		//	  Description: Constructor de la Clase
		//	   Creado Por: Ing. Miguel Palencia /Ing. Miguel Palencia /Ing. Laura Cabre
	...
	}// end function tepuy_soc_class_report
	//-----------------------------------------------------------------------------------------------------------------------------------
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  $ls_sql = "SELECT $as_tabla.cod_pro, 
					...
					max(soc_sol_cotizacion.consolcot) as concepto,
  ...
  if ($rs_data===false)
     { 
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->tepuy_soc_class_report.php->MÉTODO->uf_load_cabecera_formato_solicitud_cotizacion.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }			  
  return $rs_data;
}//function uf_load_cabecera_formato_solicitud_cotizacion
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  elseif($as_tabla=='soc_dtsc_servicios')
     {
	   $ls_straux = " substr($as_tabla.$as_campo,4) as codite,max($as_table.denser) as denite,max($as_tabla.canser) as canite, max(siv_unidadmedida.denunimed) as denunimed";
	   //$ls_newtab = $ls_sqlaux = "";
	   $ls_newtab = ", siv_unidadmedida"; 
	   $ls_sqlaux = " AND $as_table.codunimed=siv_unidadmedida.codunimed";
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->tepuy_soc_class_report.php->MÉTODO->uf_load_dt_solicitud_cotizacion.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	   $this->io_sql->message;
	 }			  
  return $rs_data;
}//function uf_load_dt_solicitud_cotizacion.
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->tepuy_soc_class_report.php->MÉTODO->uf_load_dt_registro_cotizacion.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }			  
  return $rs_data;
}//function uf_load_dt_registro_cotizacion.
	...
	function uf_select_orden_imprimir($as_numordcom,$as_estcondat,&$lb_valido)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql=" SELECT soc_ordencompra.codemp,soc_ordencompra.numordcom,soc_ordencompra.estcondat,soc_ordencompra.cod_pro,   ".
				"        soc_ordencompra.codfuefin,soc_ordencompra.fecordcom,soc_ordencompra.obscom,soc_ordencompra.obsordcom, ".
				"        soc_ordencompra.monsubtot,soc_ordencompra.monimp,soc_ordencompra.montot,soc_ordencompra.coduniadm,    ".
				"        soc_ordencompra.forpagcom,soc_ordencompra.diaplacom,spg_unidadadministrativa.denuniadm,               ".
				"        soc_ordencompra.montotdiv,soc_ordencompra.montotaux,soc_ordencompra.lugentnomdep, 					   ".
				"        soc_ordencompra.lugentdir, soc_ordencompra.concom,soc_ordencompra.fecent,soc_ordencompra.estlugcom,   ".
				"        soc_ordencompra.codmon,soc_ordencompra.codpai,soc_ordencompra.codest,soc_ordencompra.codmun,          ".
				"        soc_ordencompra.codpar,soc_ordencompra.estsegcom,soc_ordencompra.porsegcom,soc_ordencompra.monsegcom, ".
				"        soc_ordencompra.monant, soc_ordencompra.tascamordcom,soc_ordencompra.numanacot,rpc_proveedor.nompro,rpc_proveedor.dirpro,       ".
				"        rpc_proveedor.rifpro,rpc_proveedor.nitpro,rpc_proveedor.telpro,rpc_proveedor.nomreppro,               ".
				"        rpc_proveedor.nomreppro,rpc_proveedor.faxpro, soc_ordencompra.uniejeaso,sss_usuarios.nomusu,sss_usuarios.apeusu,					           ".
				"        soc_ordencompra.fechentdesde,soc_ordencompra.fechenthasta,                      			           ".
		        "       (SELECT denfuefin																					   ".
				"          FROM tepuy_fuentefinanciamiento																	   ".
				"         WHERE tepuy_fuentefinanciamiento.codfuefin<>'--' AND 											   ".
				"		        tepuy_fuentefinanciamiento.codemp=soc_ordencompra.codemp AND 								   ".
				"			    tepuy_fuentefinanciamiento.codfuefin=soc_ordencompra.codfuefin) AS denfuefin 				   ".
				"   FROM soc_ordencompra, spg_unidadadministrativa, rpc_proveedor, sss_usuarios		 ".
				...
				"    AND soc_ordencompra.codusuapr=sss_usuarios.codusu "; //print $ls_sql;
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
		...
		switch ($as_estcondat)
		{
		  ...
		  case 'S':
		       $ls_sql=" SELECT soc_dt_servicio.numordcom, soc_dt_servicio.codser as codartser, soc_servicios.denser as denartser , ".
					   ...
					   "        soc_ordencompra.fecordcom, ".
					   "        (SELECT COALESCE(denunimed,'') FROM siv_unidadmedida WHERE soc_servicios.codunimed=siv_unidadmedida.codunimed) as denunimed ".					   
	...
	function uf_select_extraer_iva($as_numarticulo,$as_estcondat,$as_numordcom,&$lb_valido)
	{
		///////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_select_detalle_orden_imprimir
		//         Access: public 
		...
		{
		   case 'B':
               $ls_sql=" SELECT tepuy_cargos.porcar as porcar, tepuy_cargos.dencar as dencar ".
					   " FROM   tepuy_cargos , siv_articulo, siv_cargosarticulo, soc_dt_bienes,soc_dta_cargos ".
					   " WHERE  siv_articulo.codart='".$as_numarticulo."' AND ".
					 //  "	siv_cargosarticulo.codart='".$as_numarticulo."' AND ".
					   " soc_dt_bienes.codart='".$as_numarticulo."' AND soc_dt_bienes.numordcom='".$as_numordcom."' ".
					   " AND  soc_dta_cargos.codart='".$as_numarticulo."' AND soc_dt_bienes.numordcom='".$as_numordcom."' ".
					   " AND  soc_dta_cargos.codcar=tepuy_cargos.codcar ".
					   " GROUP BY tepuy_cargos.porcar ";
					    //"	soc_solicitudcargos.numordcom='".$as_numordcom."' AND ".
					  // "	siv_cargosarticulo.codcar=tepuy_cargos.codcar ";
		  		//print $ls_sql;
		  		//die();
		   		break;
		  ...
		  case 'S':
               $ls_sql=" SELECT tepuy_cargos.porcar as porcar, tepuy_cargos.dencar as dencar ".
					   " FROM   tepuy_cargos , soc_servicios, soc_serviciocargo, soc_solicitudcargos ".
					   " WHERE  soc_servicios.codser='".$as_numarticulo."' AND ".
					   "	soc_serviciocargo.codcar=tepuy_cargos.codcar AND ".
					   "	soc_solicitudcargos.numordcom='".$as_numordcom."' AND ".
					   "	soc_solicitudcargos.codcar=tepuy_cargos.codcar GROUP BY tepuy_cargos.porcar";
					   //"	soc_serviciocargo.codcar=tepuy_cargos.codcar GROUP BY tepuy_cargos.porcar";
		  //print $ls_sql;  //		 
		  //die();
				break;
		}
		...
		return $rs_data;
	}// end function uf_select_extraer_iva
	//-----------------------------------------------------------------------------------------------------------------------------------



	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_select_detalle_orden_compra($as_numordcom,$as_estcondat,&$lb_valido)
	{
		///////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_select_detalle_orden_compra
		//         Access: public 
		//	    Arguments: as_numordcom    ---> Orden de Compra a imprimir
		//                 $as_estcondat  ---< tipo de la orden de compra bienes o servicios 
		//	      Returns: lb_valido True si se creo el Data stored correctamente ó False si no se creo
		...
		switch ($as_estcondat)
		{
		   case 'B':
               $ls_sql=" SELECT soc_dt_bienes.numordcom, soc_dt_bienes.codart as codartser, siv_articulo.denart as denartser, ".
					   ...
					   "        soc_dt_bienes.orden, siv_articulo.codunimed, siv_unidadmedida.denunimed, ".
					   "        soc_ordencompra.fecordcom, ".
					   "        (SELECT tepuy_cargos.porcar 
					              FROM tepuy_cargos, soc_solicitudcargos
								 WHERE soc_ordencompra.codemp=soc_solicitudcargos.codemp ".
					   "           AND soc_ordencompra.numordcom=soc_solicitudcargos.numordcom ".
					   "           AND soc_ordencompra.estcondat=soc_solicitudcargos.estcondat ".
					   "           AND soc_solicitudcargos.codemp=tepuy_cargos.codemp ".
					   "           AND soc_solicitudcargos.codcar=tepuy_cargos.codcar GROUP BY tepuy_cargos.porcar) AS porimp ".
					   " FROM   soc_ordencompra , soc_dt_bienes , siv_articulo, siv_unidadmedida ".
					   " WHERE  soc_dt_bienes.codemp='".$this->ls_codemp."' AND ".
           		       "        soc_dt_bienes.numordcom='".$as_numordcom."' AND ".
					   "        soc_dt_bienes.estcondat='".$as_estcondat."' AND ".
		...
		return $rs_data;
	}// end function uf_select_detalle_orden_compra
	//-----------------------------------------------------------------------------------------------------------------------------------
   ...
   //---------------------------------------------------------------------------------------------------------------------------------------
	...
	//---------------------------------------------------------------------------------------------------------------------------------------
		function uf_cargar_cotizaciones($as_numanacot, &$aa_proveedores)
		{
			...
			$lb_valido=false;
			$ls_sql= "SELECT a.numsolcot, cxa.numcot, c.feccot, c.montotcot,c.poriva,p.nompro,sc.consolcot
					  FROM soc_analisicotizacion a, soc_cotizacion c, rpc_proveedor p, soc_cotxanalisis cxa, soc_sol_cotizacion sc
					  ...
					  AND c.codemp=sc.codemp and c.numsolcot=sc.numsolcot";		
			//print $ls_sql;
				$rs_data=$this->io_sql->select($ls_sql);
				if($rs_data===false)
				{
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->tepuy_soc_class_report.php->MÉTODO->uf_load_solicitudes_cotizacion.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }
  return $rs_data;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->tepuy_soc_class_report.php->MÉTODO->uf_load_registro_cotizaciones.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }
  return $rs_data;
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->tepuy_soc_class_report.php->MÉTODO->uf_load_orden_servicio.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }
  return $rs_data;
}
//---------------------------------------------------------------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------------------------------------------------------	
	function uf_select_sumario_orden_compra($as_numordcomdes,$as_numordcomhas,$as_codprodes,$as_codprohas,
                                            $as_fecordcomdes,$as_fecordcomhas,$as_coduniadmdes,
                                            $as_coduniadmhas,$as_rdanucom,$as_rdemi,$as_rdpre,$as_rdcon,
                                            $as_rdanu,$as_rdinv,$as_artdes,$as_arthas,$as_serdes,$as_serhas,
								            $as_tipord,$as_tipo,&$lb_valido)
	{
		///////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_select_sumario_orden_compra
		//         Access: public 
		//	    Arguments: as_numordcom   ---> Orden de Compra a imprimir
		//                 $as_tipord  ---> tipo de la orden de compra bienes o servicios 
		//	      Returns: lb_valido True si se creo el Data stored correctamente ó False si no se creo
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("ERROR->uf_select_sumario_orden_compra".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_valido=false;	
		}
        return $rs_data;
    }//fin de uf_select_sumario_orden_compra
   //---------------------------------------------------------------------------------------------------------------------------------------
   ...
   //---------------------------------------------------------------------------------------------------------------------------------	
   //---------------------------------------------------------------------------------------------------------------------------------	
	function uf_select_nombre_unidad_administrativa($ls_sql)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_select_nombre_proveedor
		//		   Access: private 
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
		 ...
		 {
			$lb_valido=false;
			$this->io_mensajes->message("CLASE->Report MÉTODO->uf_select_nombre_unidad_administrativa ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		 }		
		 else
		 {
			 if($row=$this->io_sql->fetch_row($rs))
		 ...
		 return $as_denuniadm;    
	}//fin 	uf_select_nombre_unidad_administrativa
   //---------------------------------------------------------------------------------------------------------------------------------	
...
//---------------------------------------------------------------------------------------------------------------------------------------
    ...
    function uf_select_denominacion($as_tabla,$as_campo,$as_where)
	{
	 ...
	 //////////////////////////////////////////////////////////////////////////////
		 ...
		 if ($rs_data===false)
		    {
			  $lb_valido=false;
			  $this->io_msg->message("ERROR: CLASS=tepuy_soc_class_report.php; Metodo=uf_select_denominacion;".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		    }		
		 else
		    {
		      if ($row=$this->io_sql->fetch_row($rs_data))
	...
	function uf_load_nombre_usuario()
	{
		...
		if ($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_soc_class_report.php->MÉTODO->uf_load_nombre_usuario.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			return false;
		}
		else
		{
...
function uf_select_pais_municipio_estado($ls_numordcom,$ls_estcondat,$ls_codpai,$ls_codest,$ls_codmun)
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_select_detalleorden_imprimir($as_numordcom,$as_estcondat,&$lb_valido)
	{
		///////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_select_detalleorden_imprimir
		//         Access: public 
		//	    Arguments: as_numordcom    ---> Orden de Compra a imprimir
		//                 $as_estcondat  ---< tipo de la orden de compra bienes o servicios 
		//	      Returns: lb_valido True si se creo el Data stored correctamente ó False si no se creo
		...
		// Fecha Creación: 21/06/2007					Fecha Última Modificación : 19/06/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		switch ($as_estcondat)
		{
		   case 'B':
               $ls_sql=" SELECT soc_dt_bienes.numordcom, soc_dt_bienes.codart as codartser, siv_articulo.denart as denartser, ".
					   ...
					   "        soc_dt_bienes.orden, siv_articulo.codunimed, siv_unidadmedida.denunimed, ".
					   "        soc_ordencompra.fecordcom, ".
					   "        (SELECT COALESCE(denunimed,'') FROM siv_unidadmedida WHERE siv_articulo.codunimed=siv_unidadmedida.codunimed) as denunimed ".
					   " FROM   soc_ordencompra , soc_dt_bienes , siv_articulo, siv_unidadmedida ".
					   " WHERE  soc_dt_bienes.codemp='".$this->ls_codemp."' AND ".
           		       "        soc_dt_bienes.numordcom='".$as_numordcom."' AND ".
					   "        soc_dt_bienes.estcondat='".$as_estcondat."' AND ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Report MÉTODO->uf_select_detalleorden_imprimir ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		return $rs_data;
	}// end function uf_select_detalle_orden_imprimir
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_select_cargos($as_numordcom,$as_estcondat,&$lb_valido)
	{
		///////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//                 $as_estcondat  ---< tipo de la orden de compra bienes o servicios 
		//	      Returns: lb_valido True si se creo el Data stored correctamente ó False si no se creo
		//    Description: función que busca el porcentaje de cargo de una solicitud
		// (Se creo esta función debido a que cuando una solicitud tiene 2 porcentajes de cargos diferentes
		//  sale un error de subquery ya que devuelve mas de un registro)
		//	   Creado Por: Ing. Miguel Palencia                    Modificado por: Ing. Gloriely Fréitez
		// Fecha Creación: 21/06/2007					Fecha Última Modificación : 19/06/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		...
		{
		   case 'B':
               $ls_sql= "        (SELECT tepuy_cargos.porcar 
					              FROM tepuy_cargos, soc_solicitudcargos
								 WHERE soc_ordencompra.codemp=soc_solicitudcargos.codemp ".
					   "           AND soc_ordencompra.numordcom=soc_solicitudcargos.numordcom ".
					   "           AND soc_ordencompra.estcondat=soc_solicitudcargos.estcondat ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Report MÉTODO->uf_select_cargos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		return $rs_data;
	}// end function uf_select_cargos
  //-----------------------------------------------------------------------------------------------------------------------------------

	function uf_select_procedenciasep($as_numordcom,&$lb_valido)
	{
		///////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_select_procedenciasep
		//         Access: public 
		//	    Arguments: as_numordcom    ---> Orden de Compra a imprimir
		//                 $as_estcondat  ---< tipo de la orden de compra bienes o servicios 
		//	      Returns: lb_valido True si se creo el Data stored correctamente ó False si no se creo
		...
		$ls_sql=" SELECT numsol	              ".
				"   FROM soc_ordencompra, soc_enlace_sep ".
				"  WHERE soc_ordencompra.codemp='".$this->ls_codemp."' 				  ".
				"    AND soc_ordencompra.numordcom='".$as_numordcom."'				  ".
				"    AND soc_enlace_sep.numordcom=soc_ordencompra.numordcom	";
		
		$rs_dat=$this->io_sql->select($ls_sql);
		if($rs_dat===false)
		{
			$this->io_mensajes->message("CLASE->Report MÉTODO->uf_select_procedenciasep ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		return $rs_dat;
	}// end function uf_select_procedenciasep
	//-----------------------------------------------------------------------------------------------------------------------------------
   function uf_select_fechasep($as_numordcom,&$lb_valido)
	{
		///////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_select_fechasep
		//         Access: public 
		//	    Arguments: as_numordcom    ---> Orden de Compra a imprimir
		//                 $as_estcondat  ---< tipo de la orden de compra bienes o servicios 
		//	      Returns: lb_valido True si se creo el Data stored correctamente ó False si no se creo
		//    Description: función que busca la fecha de la sep para imprimir
		//	   Creado Por: Ing. Miguel Palencia
		// Fecha Creación: 21/06/2007									Fecha Última Modificación :  
		//////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="  SELECT fecregsol		   ".
				"   FROM sep_solicitud, soc_enlace_sep ".
				"  WHERE sep_solicitud.codemp='".$this->ls_codemp."' 				  ".
				"    AND soc_enlace_sep.numordcom='".$as_numordcom."'				  ".
				"    AND sep_solicitud.numsol=soc_enlace_sep.numsol				  "; //print $ls_sql;
		
		$rs=$this->io_sql->select($ls_sql);
		if($rs===false)
		{
			$this->io_mensajes->message("CLASE->Report MÉTODO->uf_select_fechasep ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		return $rs;
	}// end function uf_select_fechasep
