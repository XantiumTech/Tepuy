...
var url= "../../php/tepuy_srh_a_bono_merito.php";
var metodo='get';
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_p_bono_merito.php";
  f.submit(); 
}
...
function catalogo_personal()
{
  ...
  pagina="../catalogos/tepuy_srh_cat_personal.php?valor_cat=0"+"&tipo=13";
...
{	
     f=document.form1;
	 pagina="../catalogos/tepuy_srh_cat_tablapuntosbonomerito.php?valor_cat=0&tipo=2";
	 window.open(pagina,"catalogo2","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
function catalogo_puntuacion_bono()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_puntuacion_bono_merito.php?valor=0";
  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_bono_merito.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
...
function consultar_items () {
	 ...
	 if  ( ($('txtcodtipper').value=="") ) 		
	 {
	  ...
	  f.operacion.value="CONSULTAR";
  	  f.action="../pantallas/tepuy_srh_p_bono_merito.php";
	  f.existe.value="TRUE";			
	  f.submit();	
	 }
