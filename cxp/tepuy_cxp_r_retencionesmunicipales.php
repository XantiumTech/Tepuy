<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_r_retencionesmunicipales.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_reporte=$io_fun_cxp->uf_select_config("CXP","REPORTE","FORMATO_RETMUN","tepuy_cxp_rpp_retencionesmunicipales.php","C");
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
function ue_print()
{
	...
	if(li_imprimir==1)
	{
		...
		if(ls_comprobantes!="")
		{
			...
			formato="tepuy_cxp_rpp_retencionesmunicipales.php";
		...
		{
			alert("Debe seleccionar al menos un Comprobante de Documento.");	   
		}	  
	}
	else
	{
...
function ue_search()
{
	...
	ajax.send("catalogo=RETENCIONESMUNICIPALES&tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+
