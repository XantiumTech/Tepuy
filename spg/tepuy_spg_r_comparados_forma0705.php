...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_comparados_forma0705.php";
...
<title>RESUMEN DEL PRESUPUESTO DE GASTOS A NIVEL</title>
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">RESUMEN DEL PRESUPUESTO DE GASTOS A NIVEL<br>
      DE PROYECTOS Y ACCIONES CENTRALIZADAS</td>
    </tr>
  </table>
...
function ue_showouput()
{
	...
	codfuefindes= f.txtcodfuefindes.value;
	codfuefinhas= f.txtcodfuefinhas.value;
    if(estmodest==1)
	{
		if(txtetiqueta=="Mensual")
		{
			...
			else
			{
				...
				{
				   pagina="reportes/tepuy_spg_rpp_comparados_forma0705.php?combo="+combo
						   +"&combomes="+combomes+"&txtetiqueta="+txtetiqueta+"&codestpro1="+codestpro1+"&codestpro2="+codestpro2
				   +"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h
				   +"&tipoformato="+tipoformato+"&txtcodfuefindes="+codfuefindes+"&txtcodfuefinhas="+codfuefinhas;
		...
		else
		{
			...
			{
			   pagina="reportes/tepuy_spg_rpp_comparados_forma0705.php?combo="+combo+"&txtetiqueta="+txtetiqueta
			   +"&codestpro1="+codestpro1+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
			   +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&tipoformato="+tipoformato+"&txtcodfuefindes="+codfuefindes+"&txtcodfuefinhas="+codfuefinhas;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
	}
			...
			else
			{
				...
				else
				{
				   pagina="reportes/tepuy_spg_rpp_comparados_forma0705.php?combo="+combo
						   ...
						   +"&codestpro4h="+codestpro4h+"&codestpro5h="+codestpro5h+"&tipoformato="+tipoformato+"&txtcodfuefindes="+codfuefindes+"&txtcodfuefinhas="+codfuefinhas;
				   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
				}
			}	
		}
