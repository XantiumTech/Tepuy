...
class tepuy_scf_c_cierre
 {
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_scf_c_cierre($as_path)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_scf_c_cierre
		//		   Access: public 
	...
	}// end function tepuy_scf_c_cierre
	//-----------------------------------------------------------------------------------------------------------------------------------
												...
												&$as_comprobante,&$ad_fecha,&$as_descripcion,$aa_seguridad)
	{
		...
		if($lb_valido)
		{
			if($li_saldofinanciera<>0)
			{
				...
				if($lb_valido===false)
				{  
					$this->io_mensajes->message("ERROR-> ".$this->io_tepuy_int->is_msg_error);
					break;
				}
				if($lb_valido)
				{
	    ...
	    if($lb_valido)
	    {
	        ...
	        if($lb_valido===false)
		    {
				$this->io_mensajes->message("ERROR-> No se puede guardar el comprobante");//.$this->io_tepuy_int->is_msg_error);
		    }		   
		}
		if($lb_valido)
		{
	...
	{		
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_guardar
		//		   Access: public (tepuy_scf_p_cierre.php)
		//	    Arguments: as_comprobante  // Número de Comprobante
		//				   ad_fecha  // Fecha del comprobante
		//				   as_procede  // Procede del comprobante
