...
{
 $ls_coduniadmcede=$_GET["ls_coduniadmcede"];
}
else
{
 $ls_coduniadmcede="";
...
<?php
	...
	$ls_sistema="SAF";
	$ls_ventanas="tepuy_saf_d_incorporacioneslote.php";
	...
	switch (rtrim($ls_operacion)) 
	{
		...
		break;
		case "bienes":
			$lb_valido=$io_saf->uf_saf_load_bienes_unidadcedente($ls_codemp,$li_totrows,$lo_object,$ls_coduniadmcede);		
			if (!$lb_valido)
			{
				$io_msg->message("No hay registros");
			}
...
?></td>
    ...
    <tr class="formato-blanco">
      ...
      <td width="242" height="22" colspan="2" align="right"><div align="right"> <a href="javascript: ue_cancelar();"><img src="../shared/imagebank/tools15/eliminar.png" alt="Cancelar" width="15" height="15" border="0"></a><a href="javascript: ue_cancelar();">Cerrar</a> </div></td>
    </tr>
  </table>
  <p align="center">&nbsp;</p>
