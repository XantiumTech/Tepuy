var url= "../../php/tepuy_srh_a_requisitos_concurso.php";
var metodo='get';
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_d_requisitos_concurso.php";
  f.submit();
}
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_requisitos_concurso.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
