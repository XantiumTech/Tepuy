...
var url    = '../../php/tepuy_srh_a_personal.php';
...
function ue_guardar()
{
        ...
        la_objetos =new Array ("txtcodper","txtcedper","txtnomper","txtapeper",
							   ...
							   "cmbcodmun","cmbcodpar","txtnumhijper", "cmbtipvivper","txtfecingadmpub",
        ...
        la_mensajes=new Array ("el Codigo","la Cedula","el Nombre","el Apellido",
							   ...
							   "el Municipio","la Parroquia","el Numero de Hijos", "el Tipo de Vivienda",
 ...
 {  lb_valido= true;}
  ...
  if(lb_valido)
    { 
		...
		la_objetos =new Array ("txtcodestrea", "cmbtipestrea", "txtinsestrea", "txtdesestrea", "txttitestrea", "txtcalestrea", "txtescval", 
	"txtanoaprestrea", "txthorestrea", "txtfeciniact", "txtfecfinact", "txtfecgraestrea");
        la_mensajes=new Array ("el Codigo del Estudio","el Tipo de Estudio","el Instituto","la Descripcion",
						       "el Titulo Obtenido","la Calificación","la Escala de Evaluación",
						       "el ultimo año aprobado","las horas","la Fecha de inicio","la Fecha de Finalización", "la Fecha de Grado");
...
function ue_guardar_beneficiarios()
  ...
  if(lb_valido)
    {
	  la_objetos =new Array ("txtcedben", "txtnomben", "txtapeben", "cmbforpagben");
      la_mensajes=new Array ("la cedula del beneficiario","el nombre del beneficiario","el apellido del beneficiario","la forma de pago");
	  lb_valido = valida_datos_llenos(la_objetos,la_mensajes);
...
function ue_guardar_deduccion_familiar()
  {
    ...
    {	
	  ...
	  la_objetos =new Array ("txtcedfam1", "txtcodtipded1");
      la_mensajes=new Array ("la cedula del familiar","el código de la deduccion");
	  lb_valido = valida_datos_llenos(la_objetos,la_mensajes);
	  if (lb_valido)
	  {
		  ...
		  params = "operacion=ue_guardar_deduccion_fam&objeto="+objeto+"&insmod="+$F('hidguardar_deducc')
		  new Ajax.Request(url,{method:'post',parameters:params,onComplete:onGuardar});	  
     }
	}
}
...
function ue_guardar_movimiento()
  {
	 ...
	 if(lb_valido)
    {	
	  la_objetos =new Array ("txtnummov", "txtcodper", "txtcodcar", "txtfecreg", "txtcoduniadm", "txtfecinimov", "txtcodgrumov", "txtmotivo" );
      la_mensajes=new Array ("el numero de movimiento", "el codigo del personal","el codigo del cargo","la fecha registro", "la unidad administrativa propuesta" ,"la fecha de inicio del movimiento","el codigo del grupo de movimiento", "el motivo del movimiento");
	  lb_valido = valida_datos_llenos(la_objetos,la_mensajes);
...
function ue_eliminar_beneficiario()
  {
    ...
    {	
	 if (confirm("¿ Esta seguro de Eliminar este Registro ?"))
	 {
	  ...
	  params = "operacion=ue_eliminar_beneficiario&codben="+$F('txtcodben')+"&codper="+$F('txtcodper')
	  new Ajax.Request(url,{method:'get',parameters:params,onComplete:onEliminar});	  
    }
	else
	{
...
function ue_buscardedicacion()
	{
	window.open("../../../../sno/tepuy_snorh_cat_dedicacion.php?tipo=trabajoant","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
	}
function catalogo_tipo_movimiento()
{
    
  pagina="../catalogos/tepuy_srh_cat_grupomovimiento.php?valor_cat=0";
...
{
   pagina="../catalogos/tepuy_srh_cat_cargo.php?valor_cat=0&tipo=3";
   window.open(pagina,"catalogo1","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
{
   pagina="../catalogos/tepuy_srh_cat_cargo_rac.php?valor_cat=0";
   window.open(pagina,"catalogo1","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
function catalogo_familiar()
{
   ...
   codper= $('txtcodper').value;
   window.open("../catalogos/tepuy_srh_cat_familiares.php?tipo=2&codper="+codper,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
...
function ue_buscartipopersonalsss()
{
	...
	window.open("../../../../sno/tepuy_snorh_cat_tipopersonalsss.php?tipo=personal","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
...
{
	window.open("../catalogos/tepuy_srh_cat_configuracion_deduccion.php?valor_cat=0&tipo=2","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}
...
function catalogo_deducciones_personal()
{
	...
	{ 
	  function onBuscar(respuesta)
	  {
		
	   if (trim(respuesta.responseText)=="no encontro")
		 {
		   alert ('El personal no tiene deducciones asociadas. Primero debe asociar deducciones al personal y luego al familiar.');
		 }
		else
		{
		  codper= $('txtcodper').value;	
	 	  window.open("../catalogos/tepuy_srh_cat_deducciones.php?valor_cat=0&tipo=2&codper="+codper,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
		}
	  }	
	
	
	  codper= $('txtcodper').value;	
	  params = "operacion=ue_buscar_deduccion&codper="+codper;
      new Ajax.Request(url,{method:'get',parameters:params,onComplete:onBuscar});	
	}
}

function ue_BuscarUnidadVipladin()
{
	window.open("../catalogos/tepuy_srh_cat_uni_vipladin.php?valor_cat=0&tipo=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}


function catalogo_unidad_adm()
{
	window.open("../catalogos/tepuy_srh_cat_unidadadmin.php?valor_cat=0&tipo=3","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=yes");
}
...
function ue_buscarprofesion()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_profesion.php?valor_cat=0";
...
{
	window.open("../../../../sno/tepuy_snorh_cat_componente.php?tipo=personal","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
}
...
function ue_buscarrango()
{
	...
	if(codcom!="")
	{
		window.open("../../../../sno/tepuy_snorh_cat_rango.php?tipo=personal&codcom="+codcom+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
	}
	else
	{
...
{
	window.open("../../../../sno/tepuy_snorh_cat_banco.php?tipo=beneficiario","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
}
...
function ue_buscar()
{
	window.open("../catalogos/tepuy_srh_cat_personal.php?valor_cat=1&tipo=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
...
function ue_buscar_premio () 
{
	...
	{ codper= $('txtcodper').value;
	  window.open("../catalogos/tepuy_srh_cat_premiaciones.php?codper="+codper,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
...
function ue_buscar_estudios () 
{
	...
	{ codper= $('txtcodper').value;
	  window.open("../catalogos/tepuy_srh_cat_estudios.php?codper="+codper,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
...

{
	...
	{ codper= $('txtcodper').value;
	  window.open("../catalogos/tepuy_srh_cat_trabajos.php?codper="+codper,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
...
function ue_buscar_familiares()
{
  ...
  if ($('txtcodper').value=='') 
	...
	{ codper= $('txtcodper').value;
	  window.open("../catalogos/tepuy_srh_cat_familiares.php?codper="+codper,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
}
...
function ue_buscar_beneficiarios()
{
  ...
  if ($('txtcodper').value=='') 
	...
	{ codper= $('txtcodper').value;
	  window.open("../catalogos/tepuy_srh_cat_beneficiarios.php?codper="+codper,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
}
...
if ($('txtcodper').value=='') 
	...
	{ codper= $('txtcodper').value;
	  window.open("../catalogos/tepuy_srh_cat_permisos.php?codper="+codper,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
}
...
if ($('txtcodper').value=='') 
	...
	{ codper= $('txtcodper').value;
	  window.open("../catalogos/tepuy_srh_cat_deducciones.php?codper="+codper,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
}
...
function ue_buscarcausa()
{
	  ...
	  {
		window.open("../../../../sno/tepuy_snorh_cat_causa.php?tipo=personal","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
	  }
}
...
if ($('txtcodper').value=='') 
	...
	{ codper= $('txtcodper').value;
	  window.open("../catalogos/tepuy_srh_cat_deducciones_familiar.php?codper="+codper,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=630,height=400,left=50,top=50,location=no,resizable=yes");
	}
}
...
function ue_buscar_movimientos()
{
  ...
  window.open("../catalogos/tepuy_srh_cat_movimiento_personal.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=625,height=500,left=50,top=50,location=no,resizable=yes");
...
function ue_imprimir_mov()
{
	...
	if (codper!="")
	{
		pagina="../../../reporte/tepuy_srh_rfs_movimiento_personal.php?nroreg="+nroreg+"&codper="+codper;
...
function calcular_monto ()
 {
	if  ( ($('txtcodper').value=="") || ($('txtcodtipded').value=="")) 		
	 {
		 alert("El código del personal y el código del tipo de la deducción no pueden estar vacíos.");
	   ...
	   function onConsultar(respuesta)
		{
		$('txtmontod').value  = trim(respuesta.responseText);
	
	  }	
	
	  params = "operacion=calcular_monto_deduccion&codper="+$F('txtcodper')+"&codtipded="+$F('txtcodtipded');
...
function calcular_monto_familiar ()
 {
	if  ( ($('txtcodper').value=="") || ($('txtcodtipded1').value=="")|| ($('txtcedfam1').value=="") ) 		
	 {
		 alert("El código del personal, el código del tipo de la deducción, y la cédula del familiar no pueden estar vacíos.");
	   ...
	   function onConsultar(respuesta)
		{
		$('txtmontodfam').value  = trim(respuesta.responseText);
	
	  }	
	
	  params = "operacion=calcular_monto_deduccion_fam&codper="+$F('txtcodper')+"&codtipded="+$F('txtcodtipded1')+"&cedfam="+$F('txtcedfam1');
	  new Ajax.Request(url,{method:'get',parameters:params,onComplete:onConsultar});
...
function ue_ayuda()
{
	...
	//window.open("../hlp/index.php?sistema=SNO&subsistema=SNR&nomfis=sno/tepuy_hlp_snr_personal.php","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}
...
function ue_cargar_foto()
{
	 ...
	 {
	 	 pagina="tepuy_srh_cargar_foto.php?cedper="+$F('txtcedper');
