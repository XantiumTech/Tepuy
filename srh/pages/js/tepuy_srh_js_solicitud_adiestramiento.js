...
var url="../../php/tepuy_srh_a_solicitud_adiestramiento.php";
var metodo='get';
...
function ue_guardar()
{
  lb_valido=true;
  lb_valido=true;
  var la_objetos=new Array ("txtnroreg","txtfecsol", "txtdes", "txtcodper",  "txtcodprov", "txtfecini", "txtfecfin", "txtdurhras","txtcosto", "txtobs", "txtobj", "txtare", "txtest");
  
 
  var la_mensajes=new Array ("el número de registro","la fecha de la solicitud", "la descripción de la solicitud", "el código del solicitante",  "el código del proveedor", "la fecha de inicio del adiestramiento", "la fecha de culminación del adiestramiento", "la duración en horas del adiestramiento","el costo del adiestramiento" ,"la observacion", "el objetivo del adiestramiento", "el area o contenido a ser atendido", "la estrategia de capacitación");
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_p_solicitud_adiestramiento.php";
  f.submit(); 
}
...
{
   pagina="../catalogos/tepuy_srh_cat_personal.php?valor_cat=0"+"&tipo=8";
  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
function catalogo_unidad()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_uni_vipladin.php?valor=0";
...
{
   pagina="../catalogos/tepuy_srh_cat_proveedores.php";
...
{
	f=document.form1;
	window.open("../catalogos/tepuy_srh_cat_solicitud_adiestramiento.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=680,height=500,left=50,top=50,location=no,resizable=yes");
}
