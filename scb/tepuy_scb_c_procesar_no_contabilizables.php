<?php
class tepuy_scb_c_procesar_no_contabilizables{

	function tepuy_scb_c_procesar_no_contabilizables()
	{
	  ...
	  $this->io_movbco    = new tepuy_scb_c_movbanco($this->io_seguridad);
	}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_msg->message("ERROR. CLASE->tepuy_scb_c_procesar_no_contabilizables.php;Función->uf_cargar_documentos();".$this->io_function->uf_convertirmsg($this->io_sql->message));
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_msg->message("ERROR. CLASS->tepuy_scb_c_procesar_no_contabilizables.php;Función->uf_duplicar_movimiento_bancario();".$this->io_function->uf_convertirmsg($this->io_sql->message));
	   echo $this->io_sql->message;
	 }
  return $lb_valido;
}//function uf_duplicar_movimiento_bancario().
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_msg->message("ERROR. CLASS->tepuy_scb_c_procesar_no_contabilizables.php;Función->uf_duplicar_fuente_financiamiento();".$this->io_function->uf_convertirmsg($this->io_sql->message));
	   echo $this->io_sql->message;
	 }
  return $lb_valido;
}//function uf_duplicar_fuente_financiamiento().
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
     {
	   $lb_valido = false;
	   $this->io_msg->message("ERROR. CLASS->tepuy_scb_c_procesar_no_contabilizables.php;Función->uf_delete_all_movimientos();".$this->io_function->uf_convertirmsg($this->io_sql->message));
	   echo $this->io_sql->message;
	 }
  else
     {
