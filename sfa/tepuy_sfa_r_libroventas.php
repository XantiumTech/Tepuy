<?php
	...
	$io_fun_cxp=new class_funciones_sfa();
	$io_fun_cxp->uf_load_seguridad("SFA","tepuy_sfa_r_libroventas.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
 <tr>
   <td height="30" colspan="11" class="cd-logo"><img src="../shared/imagebank/header.jpg" alt="a" width="778" height="40"></td>
 </tr>
 <tr>
...
?>
	 <table width="426" border="0" cellpadding="0" cellspacing="0" class="contorno">
	   <tr class="titulo-celdanew">
		 <td width="424" height="22" class="titulo-celdanew">Libro de Ventas</td>
	   </tr>
...
function uf_imprimir()
{
	...
	if(li_imprimir==1)
	{
		...
		//pagina = "reportes/tepuy_cxp_rpp_librocompra.php?mes="+ls_mes+"&agno="+ls_agno+"&tiporeporte="+tiporeporte;
		// El de arriba es el formato original de Libro Compras y el de abajo el solicitado por Mayra (Barvialsa)
		pagina = "reportes/tepuy_sfa_rpp_libroventas_waryna.php?mes="+ls_mes+"&agno="+ls_agno+"&tiporeporte="+tiporeporte;
...
function ue_openexcel()
{
	...
	if(li_imprimir==1)
	{
		ls_mes = f.mes.value;
		ls_agno = f.ano.value;		
		//pagina = "reportes/tepuy_cxp_rpp_librocompra_excel.php?mes="+ls_mes+"&agno="+ls_agno;
		// El de arriba es el formato original de Libro Compras y el de abajo el solicitado por Mayra (Barvialsa)
		pagina = "reportes/tepuy_sfa_rpp_libroventas_excel_waryna.php?mes="+ls_mes+"&agno="+ls_agno;
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	}
	else
	{
