...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_tipopersonal.js"></script>
...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_tipopersonal.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_tipopersonal.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_tipopersonal.php?valor=buscar"+"&txtcodtipper="+codtipper+"&txtdentipper="+dentipper);
           setTimeout (terminar_buscar,500);
