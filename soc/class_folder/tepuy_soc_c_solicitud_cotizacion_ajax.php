<?php
		...
		case "LIMPIAR":
			switch($ls_tipo)
			{
				case "B": // Bienes
					...
					uf_print_bienes($li_totalbienes,$agregaiva);
					uf_print_proveedores($li_totalproveedores);
					break;
				case "S": // Servicios
					$agregaiva=0;
					$ls_titulo="Servicios";
					uf_print_servicios($li_totalservicios,$agregaiva);
					uf_print_proveedores($li_totalproveedores);
					break;
			}
			break;
	...
	{	
		...
		for($li_fila=1;$li_fila<=$ai_total;$li_fila++)
		{
			...
			$ls_nompro = utf8_decode($io_funciones_soc->uf_obtenervalor("txtnompro".$li_fila,""));
			$ls_dirpro = utf8_decode($io_funciones_soc->uf_obtenervalor("txtdirpro".$li_fila,""));
			...
			{
				$lo_object[$li_fila][5]="<a href=javascript:ue_delete_proveedor('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";
			}
		}
		print "<p>&nbsp;</p>";
		print "  <table width='800' border='0' align='center' cellpadding='0' cellspacing='0'";
		print "    <tr>";
		print " 	  <td height='22' align='left'><a href='javascript:ue_catalogoproveedores();'><img src='../shared/imagebank/tools/nuevo.png' title='Agregar Proveedor' width='20' height='20' border='0'>Agregar Proveedor</a></td>";
		print "    </tr>";
		print "  </table>";
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_bienes($ai_total,$as_agregaiva)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		for($li_fila=1;$li_fila<=$ai_total;$li_fila++)
		{
			...
			$ls_denart = utf8_decode($io_funciones_soc->uf_obtenervalor("txtdenart".$li_fila,""));
			...
			$ls_codcar = $io_funciones_soc->uf_obtenervalor("txtcodiva".$li_fila,"");
			if ($as_agregaiva==1)
			{
				if ($li_fila==$aqui)//($li_fila==$aqui)
				{
					//print "fila:".$li_fila."total:".$aqui;
					$ls_codcar = $ls_codivasel;
				}
			}
			else
			{
				$io_funciones_soc->uf_obtenervalor("txtcodiva".$li_fila,"");
			}
			$lo_object[$li_fila][1]="<input type=text name=txtcodart".$li_fila."  id=txtcodart".$li_fila."  class=sin-borde style=text-align:center size=25  value='".$ls_codart."'  readonly><input type=hidden name=hidnumsep".$li_fila." id=hidnumsep".$li_fila." value='".$ls_numsep."'>";
			$lo_object[$li_fila][2]="<input type=text name=txtdenart".$li_fila."  id=txtdenart".$li_fila."  class=sin-borde style=text-align:left   size=92  value='".$ls_denart."'  readonly>";
			...
			$lo_object[$li_fila][4]="<input type=text name=txtcodiva".$li_fila."  id=txtcodiva".$li_fila."  class=sin-borde style=text-align:right  size=15  value='".$ls_codcar."'  onKeyPress=return(ue_formatonumero(this,'.',',',event));>"; 
			...
			{
				$lo_object[$li_fila][5]="<a href=javascript:ue_delete_bienes('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";
			}
		}
		print "<p>&nbsp;</p>";
		print "  <table width='800' border='0' align='center' cellpadding='0' cellspacing='0'";
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_servicios($ai_total,$as_agregaiva)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		for($li_fila=1;$li_fila<=$ai_total;$li_fila++)
		{
			...
			$ls_denser = utf8_decode($io_funciones_soc->uf_obtenervalor("txtdenser".$li_fila,""));
			...
			$lo_object[$li_fila][1]="<input type=text name=txtcodser".$li_fila."    id=txtcodser".$li_fila." class=sin-borde  style=text-align:center  size=20   value='".$ls_codser."' readonly><input type=hidden name=hidnumsep".$li_fila." id=hidnumsep".$li_fila." value='".$ls_numsep."'>";
			$lo_object[$li_fila][2]="<input type=text name=txtdenser".$li_fila."    id=txtdenser".$li_fila." class=sin-borde  style=text-align:left    size=100  value='".$ls_denser."' readonly>";
			...
			{
				$lo_object[$li_fila][5] ="<a href=javascript:ue_delete_servicios('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";
			}
		}
		print "<p>&nbsp;</p>";
		print "  <table width='800' border='0' align='center' cellpadding='0' cellspacing='0'";
		print "    <tr>";
		print "		<td height='22' align='left'><a href='javascript:ue_catalogoservicios();'><img src='../shared/imagebank/tools/nuevo.png' width='20' height='20' border='0' title='Agregar Detalle Servicios'>Agregar Detalle Servicios</a></td>";
		print "    </tr>";
		print "  </table>";
	...
	{	
		...
		$lo_title[4]="Cod. I.V.A.";
		$lo_title[5]="";
		require_once("tepuy_soc_c_solicitud_cotizacion.php");
		$io_solicitud=new tepuy_soc_c_solicitud_cotizacion("../../");
		...
		while($row=$io_solicitud->io_sql->fetch_row($rs_data))	  
		{
			...
			$lo_object[$li_fila][2]="<input type=text name=txtdenart".$li_fila."  id=txtdenart".$li_fila."  class=sin-borde style=text-align:left   size=92  value='".$ls_denart."'  readonly>";
			$lo_object[$li_fila][3]="<input type=text name=txtcanart".$li_fila."  id=txtcanart".$li_fila."  class=sin-borde style=text-align:right  size=15  value='".$li_canart."'  onKeyPress=return(ue_formatonumero(this,'.',',',event));>";
			$lo_object[$li_fila][4]="<input type=text name=txtcodiva".$li_fila."  id=txtcodiva".$li_fila."  class=sin-borde style=text-align:left   size=15  value='".$ls_codcar."'  readonly>";
			$lo_object[$li_fila][5]="<a href=javascript:ue_delete_bienes('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";
		}
		$li_fila=$li_fila+1;
		$lo_object[$li_fila][1]="<input type=text name=txtcodart".$li_fila."  id=txtcodart".$li_fila."  class=sin-borde  style=text-align:center  size=25  value=''  readonly><input type=hidden name=hidnumsep".$li_fila." id=hidnumsep".$li_fila." value=''>";
		$lo_object[$li_fila][2]="<input type=text name=txtdenart".$li_fila."  id=txtdenart".$li_fila."  class=sin-borde  style=text-align:left    size=92  value=''  readonly>";
		...
		$lo_object[$li_fila][4]="<input type=text name=txtcodiva".$li_fila."  id=txtcodiva".$li_fila."  class=sin-borde  style=text-align:left    size=15  value=''  readonly>";
		$lo_object[$li_fila][5]="";
		print "<p>&nbsp;</p>";
		print "  <table width='800' border='0' align='center' cellpadding='0' cellspacing='0'";
		print "    <tr>";
	...
	{	
		...
		$li_fila=$li_fila+1;
		$lo_object[$li_fila][1]="<input type=text name=txtcodser".$li_fila."  id=txtcodser".$li_fila."  class=sin-borde  style=text-align:center  size=20   value='' readonly><input type=hidden name=hidnumsep".$li_fila." id=hidnumsep".$li_fila."  value=''>";
		$lo_object[$li_fila][2]="<input type=text name=txtdenser".$li_fila."  id=txtdenser".$li_fila."  class=sin-borde  style=text-align:left    size=100  value='' readonly>";
	...
	{	
		...
		while ($row=$io_solicitud->io_sql->fetch_row($rs_data))	  
		      {
			    ...
			    $lo_object[$li_fila][2]="<input name=txtdensep".$li_fila." id=txtdensep".$li_fila."  type=text class=sin-borde  size=85   style=text-align:left    value='".$ls_densep."' readonly><input type=hidden name=txtdenuni".$li_fila." id=txtdenuni".$li_fila."  value='".$ls_denuni."'>";
		 	    $lo_object[$li_fila][3]="<input name=txtmonsep".$li_fila." id=txtmonsep".$li_fila."  type=text class=sin-borde  size=25   style=text-align:right   value='".$ld_monsep."' readonly>";
			    $lo_object[$li_fila][4]="<a href=javascript:ue_delete_sep('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";
		      }
		$li_fila++;
		...
		$lo_object[$li_fila][3]="<input type=text name=txtmonsep".$li_fila."  id=txtmonsep".$li_fila."  class=sin-borde  style=text-align:right   size=25  value='' onKeyPress=return(ue_formatonumero(this,'.',',',event));>"; 
		$lo_object[$li_fila][4] ="";
		if ($li_fila>1)
		   {
	   		 print "<p>&nbsp;</p>";
		...
		for ($li_fila=1;$li_fila<$ai_total;$li_fila++)
		    {
			  ...
			  $lo_object[$li_fila][4]="<a href=javascript:ue_delete_bienes('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";
		    }
			 ...
			 while ($row=$io_solicitud->io_sql->fetch_row($rs_data))	  
				   {
					 ...
					 $ld_canart = number_format($ld_canart,2,',','.');
					 $lo_object[$li_fila][1]="<input type=text name=txtcodart".$li_fila."  id=txtcodart".$li_fila."  class=sin-borde style=text-align:center size=25  value='".$ls_codart."'  readonly><input type=hidden name=hidnumsep".$li_fila." id=hidnumsep".$li_fila." value='".$as_numsep."'>";
					 $lo_object[$li_fila][2]="<input type=text name=txtdenart".$li_fila."  id=txtdenart".$li_fila."  class=sin-borde style=text-align:left   size=92  value='".$ls_denart."'  readonly>";
					 $lo_object[$li_fila][3]="<input type=text name=txtcanart".$li_fila."  id=txtcanart".$li_fila."  class=sin-borde style=text-align:right  size=15  value='".$ld_canart."'  onKeyPress=return(ue_formatonumero(this,'.',',',event));>"; 
					 $lo_object[$li_fila][4]="<a href=javascript:ue_delete_bienes('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";
					 $li_fila++;
  	     ...
  	     for ($li_fila=1;$li_fila<$ai_total;$li_fila++)
			 {
			   ...
			   $lo_object[$li_fila][2]="<input type=text name=txtdenser".$li_fila."  id=txtdenser".$li_fila."  class=sin-borde style=text-align:left   size=100  value='".$ls_denser."'  readonly>";
			   $lo_object[$li_fila][3]="<input type=text name=txtcanser".$li_fila."  id=txtcanser".$li_fila."  class=sin-borde style=text-align:right  size=10   value='".$li_canser."'  onKeyPress=return(ue_formatonumero(this,'.',',',event));>"; 
			   $lo_object[$li_fila][4]="<a href=javascript:ue_delete_servicios('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";
			 }
		  if (!empty($as_numsep) && ($as_opesep!="DELETE"))
		     {
			   ...
			   while ($row=$io_solicitud->io_sql->fetch_row($rs_data))	  
				     {
					   ...
					   $lo_object[$li_fila][1]="<input type=text name=txtcodser".$li_fila."  id=txtcodser".$li_fila."  class=sin-borde style=text-align:center size=20   value='".$ls_codser."'  readonly><input type=hidden name=hidnumsep".$li_fila."  value='".$ls_numsep."'>";
					   $lo_object[$li_fila][2]="<input type=text name=txtdenser".$li_fila."  id=txtdenser".$li_fila."  class=sin-borde style=text-align:left   size=100  value='".$ls_denser."'  readonly>";
					   $lo_object[$li_fila][3]="<input type=text name=txtcanser".$li_fila."  id=txtcanser".$li_fila."  class=sin-borde style=text-align:right  size=10   value='".$li_canser."'  onKeyPress=return(ue_formatonumero(this,'.',',',event));>"; 
					   $lo_object[$li_fila][4]="<a href=javascript:ue_delete_servicios('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";
					   $li_fila++;
		     ...
		     for ($li_fila=1;$li_fila<=$ai_total;$li_fila++)
		         {
				   ...
				   $ls_densep = utf8_decode($io_funciones_soc->uf_obtenervalor("txtdensep".$li_fila,""));
			       ...
			       $lo_object[$li_fila][3]="<input type=text name=txtmonsep".$li_fila."  id=txtmonsep".$li_fila."  class=sin-borde style=text-align:right  size=25  value='".$ld_monsep."'  readonly>"; 
			       if ($li_fila==$ai_total)// si el la última fila no pinto el eliminar
			          {
			 	        $lo_object[$li_fila][4]="";
			          } 
