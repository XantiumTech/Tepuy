...
<body>
<?php
require_once("tepuy_saf_c_traslado.php");
$io_saf=  new tepuy_saf_c_traslado();
...
{
		window.open("tepuy_saf_cat_codactivo.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=50,top=50,location=no,resizable=yes");
