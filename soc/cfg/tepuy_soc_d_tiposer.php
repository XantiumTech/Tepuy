...
require_once("tepuy_soc_c_tiposer.php");
...
$io_tipo      = new tepuy_soc_c_tiposer($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SOC";
	$ls_ventanas = "tepuy_soc_d_tiposer.php";
...
{
	window.open("tepuy_soc_cat_milco.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}
...
function ue_nuevo()
{
	...
	if (li_incluir==1)
	   {	
	     ...
	     f.action="tepuy_soc_d_tiposer.php";
	     f.submit();
       }
	else
	   {
