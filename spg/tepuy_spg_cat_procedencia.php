...
<script language="JavaScript">
  ...
  {
    opener.document.form1.txtprocedencia.value=codigo;
	opener.document.form1.txtdenpro.value=descripcion;
    //opener.document.form1.procede.value=codigo;
...
*/	opener.document.form1.txtprocedencia.readOnly=true;
	close();
  }
  ...
  function ue_search()
  {
    ...
    f.action="tepuy_spg_cat_procedencia.php";
    f.submit();
  }
</script>
</html>