<?php
	...
	$io_fun_srh->uf_load_seguridad("SRH","tepuy_srh_d_personal.php",$ls_permisos,$la_seguridad,$la_permisos);
	//--------------------------------------------------------------------------------------------------------------
...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_personal.js"></script>
...
<td width="823">
  ...
  <div id="demo" class="yui-navset">
    <ul class="yui-nav">
		...
		<li><a href="#tab8"><em>Premiaciones</em></a></li>
    </ul>            
    <div class="yui-content">
        <div><p><table width="750" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="135" rowspan="7"><div align="center"><img id="foto" name="foto" src="../../../fotos/silueta.jpg" width="96" height="96" ></div></td>
        </tr>
		 <tr>
        ...
        <tr>
          ...
          <td><div align="left">
			...
			<a href="javascript: ue_buscar_solicitud_empleo();"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Buscar Solicitud de Empleo</a>
          </div> </td> 
        </tr>
        <tr>
  ...
  <input name="reset" type="reset" onclick="return showCalendar('txtfecingper', '%d/%m/%Y');" value=" ... " /></td>
		...
		<tr>
          ...
          <td colspan="2"><div align="left">
              ...
              <a href="javascript: ue_buscarprofesion();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Buscar" width="15" height="15" border="0"></a>
        ...
        <tr>
          ...
          <td colspan="2"><div align="left">  <select name="cmbcodmun" id="cmbcodmun" style="width:145px" onChange="ue_CambioMunicipio()"  onclick="ue_valida_cmbcodmun();">
               ...
               </select> </div> <input name="hidcodmun"  type="hidden" id="hidcodmun"  value=""></td>
        </tr>
        <tr>
          ...
          </div> <input name="hidcodpar"  type="hidden" id="hidcodpar"  value=""></td>
        </tr>    
        ...
        <tr>
          ...
          <td colspan="2"><div align="left">
              <input name="txtnumhijper" type="text" id="txtnumhijper"  size="5" maxlength="2" style="text-align:left" onKeyUp="javascript: ue_validarnumero(this);">
          </div></td>
        </tr>
        <tr>
		...
		<tr>
          ...
          <td colspan="2"><label>
            ...
            <a href="javascript: ue_buscarcomponente();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Buscar" width="15" height="15" border="0"></a>
        ...
        <tr>
          ...
          <td colspan="2"><label>
            ...
            <a href="javascript: ue_buscarrango();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Buscar" width="15" height="15" border="0"></a>
        ...
        <tr>
          ...
          <td colspan="2"><div align="left">
              <input name="txtcuecajahoper" type="text" id="txtcuecajahoper"  size="30" maxlength="25" onKeyUp="javascript: ue_validarnumero(this);">
            Tiene Caja de Ahorro
            <input name="chkcajahoper" type="checkbox" class="sin-borde" id="chkcajahoper" value="1"  >
          </div></td>
        </tr>
        <tr>
          <td height="22"><div align="right">Cuenta Ley de Pol&iacute;tica </div></td>
          <td colspan="2"><div align="left">
              <input name="txtcuelphper" type="text" id="txtcuelphper" size="30" maxlength="25" onKeyUp="javascript: ue_validarnumero(this);">
          </div></td>
        </tr>
        <tr>
          <td height="22"><div align="right">Cuenta Fideicomiso </div></td>
          <td colspan="2"><div align="left">
              <input name="txtcuefidper" type="text" id="txtcuefidper"  size="30" maxlength="25" onKeyUp="javascript: ue_validarnumero(this);">
          </div></td>
        </tr>
       ...
       <tr class="titulo-ventana">
        ...
        <tr>
		 ...
		 <tr>
        <td height="22"><div align="left"><a href="javascript: ue_limpiar_estudios();ue_nuevo_codestudio();"><img src="../../../../shared/imagebank/tools20/nuevo.png" alt="Grabar" width="20" height="20" border="0">Nuevo Estudio</a></div></td>

        <td width="136">
			<a href="javascript: ue_guardar_estudios();"><img src="../../../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Guardar Estudio</a></td>
		  <td width="141">
			<a href="javascript: ue_eliminar_estudio();"><img src="../../../../shared/imagebank/tools20/eliminar.png" alt="Grabar" width="20" height="20" border="0">Eliminar  Estudio</a></td>
          <td width="251"><span class="toolbar"><a href="javascript: ue_buscar_estudios();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Estudios</a></span></td>
      </tr>
      </table>
          <p>&nbsp;</p>
          </p></div>
		...
		<tr>
        <td height="22"><div align="left"><a href="javascript: ue_limpiar_trabajo();ue_nuevo_trabajo();"><img src="../../../../shared/imagebank/tools20/nuevo.png" alt="Grabar" width="20" height="20" border="0">Nueva Experiencia</a></div></td>

        <td width="152">
			<a href="javascript: ue_guardar_trabajos();"><img src="../../../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Guardar Experiencia</a></td>
		  <td width="167">
			<a href="javascript: ue_eliminar_trabajo();"><img src="../../../../shared/imagebank/tools20/eliminar.png" alt="Grabar" width="20" height="20" border="0">Eliminar  Experiencia </a></td>
          <td width="199"><span class="toolbar"><a href="javascript: ue_buscar_trabajos();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Experiencia</a></span></td>
		...
		<tr>
        <td height="22"><div align="center"><a href="javascript:ue_limpiar_familia();"><img src="../../../../shared/imagebank/tools20/nuevo.png" alt="Grabar" width="20" height="20" border="0">Nuevo Familiar</a></div></td>

        <td width="134">
			<a href="javascript: ue_guardar_familiares();"><img src="../../../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Guardar Familiar</a></td>
		  <td width="142">
			<a href="javascript: ue_eliminar_familiar();"><img src="../../../../shared/imagebank/tools20/eliminar.png" alt="Grabar" width="20" height="20" border="0">Eliminar Familiar</a></td>
          <td width="194"><span class="toolbar"><a href="javascript: ue_buscar_familiares();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Familiares</a></span></td>
      ...
      <tr>
		...
		<tr>
         <td height="22"><div align="left"><a href="javascript: ue_limpiar_beneficiario();ue_nuevo_beneficiario();"><img src="../../../../shared/imagebank/tools20/nuevo.png" alt="Grabar" width="20" height="20" border="0">Nuevo Beneficiario</a></div></td>
        <td width="172">
			<a href="javascript: ue_guardar_beneficiarios();"><img src="../../../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Guardar Beneficiario </a></td>
		  <td width="170">
			<a href="javascript: ue_eliminar_beneficiario();"><img src="../../../../shared/imagebank/tools20/eliminar.png" alt="Grabar" width="20" height="20" border="0">Eliminar Beneficiario </a></td>
          <td width="174"><span class="toolbar"><a href="javascript: ue_buscar_beneficiarios();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Beneficiarios </a></span></td>
	  ...
	  <tr>
        <td height="22"><div align="left"><a href="javascript: ue_limpiar_permiso(); ue_nuevo_permiso();"><img src="../../../../shared/imagebank/tools20/nuevo.png" alt="Grabar" width="20" height="20" border="0">Nuevo Permiso</a></div></td>
        <td width="173">
			<a href="javascript: ue_guardar_permiso();"><img src="../../../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Guardar Permiso</a></td>
		  <td width="172">
			<a href="javascript: ue_eliminar_permiso();"><img src="../../../../shared/imagebank/tools20/eliminar.png" alt="Grabar" width="20" height="20" border="0">Eliminar  Permiso </a></td>
          <td width="183"><span class="toolbar"><a href="javascript: ue_buscar_permisos();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Permisos </a></span></td>
   ...
   <!-- <div><p><table width="677" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
	  ...
	  <tr>
        <td  colspan="3"><div align="right" class="sin-borde2">C&oacute;digo Personal</div></td>
        <td align="right"><div align="left">
          <input name="txtcodper6" type="text" id="txtcodper6" size="28" class="sin-borde">
        </div></td>
      </tr>
       <tr>
        <td  colspan="3"><div align="right" class="sin-borde2">N&ordm; Expediente</div></td>
        <td align="right"><div align="left">
          <input name="txtnumexpper6" type="text" id="txtnumexpper6" size="28" class="sin-borde">
        </div></td>
      </tr>
	  <tr>
        <td  colspan="3" align="right"><div align="right" class="sin-borde2">Tipo Personal</div></td>
        <td  align="right"><div align="left"><input name="txtdestippersss6" type="text" id="txtdestippersss6" size="28" class="sin-borde"></div></td>
      </tr>
      <tr>
      ...
      <a href="javascript:catalogo_tipo_deduccion();"><img src="../../../public/imagenes/buscar.png" alt="Cat&aacute;logo de Tipo Deduccion" name="buscartip" width="15" height="15" border="0" id="buscartip"></a></td>
        ...
        <td colspan="2"><div align="left">
           <input name="txtmontod" type="text" id="txtmontod" size="16" maxlength="10" onFocus="javascript: calcular_monto();" readonly>
           </div></td>
      </tr> 
      ...
      <tr>
        <td height="22"><div align="left"><a href="javascript: ue_limpiar_deduccion();"><img src="../../../../shared/imagebank/tools20/nuevo.png" alt="Grabar" width="20" height="20" border="0">Nueva Deducci&oacute;n</a></div></td>

        <td width="169">
			<a href="javascript: ue_guardar_deduccion();"><img src="../../../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Guardar Deducci&oacute;n </a></td>
		  <td width="158">
			<a href="javascript: ue_eliminar_deduccion();"><img src="../../../../shared/imagebank/tools20/eliminar.png" alt="Grabar" width="20" height="20" border="0">Eliminar  Deducci&oacute;n </a></td>
          <td width="168"><span class="toolbar"><a href="javascript: ue_buscar_deducciones();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Deducciones</a></span></td>
          <td width="10">&nbsp;</td>
      </tr>
      ...
      <a href="javascript:catalogo_familiar();"><img src="../../../public/imagenes/buscar.png" alt="Cat&aacute;logo de Tipo Deduccion" name="buscartip" width="15" height="15" border="0" id="buscartip"></a></td>
      ...
      <a href="javascript:catalogo_deducciones_personal();"><img src="../../../public/imagenes/buscar.png" alt="Cat&aacute;logo de Tipo Deduccion" name="buscartip" width="15" height="15" border="0" id="buscartip"></a></td>
            <td colspan="2"> <input name="txtdentipded1"  type="text" class="sin-borde" id="txtdentipded1"  size="40" maxlength="80" readonly>             </td>
      </tr>
      <tr>
        <td height="22"><div align="right">Monto a Deducir </div></td>
        <td colspan="2"><div align="left">
           <input name="txtmontodfam" type="text" id="txtmontodfam" size="16" maxlength="10" onFocus="javascript: calcular_monto_familiar();" readonly>
           </div></td>
      </tr> 
      <tr>
        <td height="22">&nbsp;</td>
      ...
      <tr>
		...
		<td height="22"><div align="left"><a href="javascript:ue_limpiar_deduccion_familiar();"><img src="../../../../shared/imagebank/tools20/nuevo.png" alt="Grabar" width="20" height="20" border="0">Nueva Deducci&oacute;n Familiar</a></div>			
		</td>
        <td >
			<a href="javascript: ue_guardar_deduccion_familiar();"><img src="../../../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Guardar Deducci&oacute;n Familiar  </a></td>
		  <td width="158">
			<a href="javascript: ue_eliminar_deduccion_familiar();"><img src="../../../../shared/imagebank/tools20/eliminar.png" alt="Grabar" width="20" height="20" border="0">Eliminar  Deducci&oacute;n Familiar </a></td>
          <td colspan="2"><span class="toolbar"><a href="javascript: ue_buscar_deducciones_familiar();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Deducci&oacute;n Familiar</a></span></td>
	...
	<div><p><table width="677" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
	  ...
	  <tr>
        <td height="22"><div align="left"><a href="javascript:ue_limpiar_premio(); ue_nuevo_premio();"><img src="../../../../shared/imagebank/tools20/nuevo.png" alt="Grabar" width="20" height="20" border="0">Nueva Premici&oacute;n</a></div>			
		</td>

        <td width="167">
			<a href="javascript: ue_guardar_premio();"><img src="../../../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Guardar Premiaci&oacute;n</a></td>
		  <td width="180">
			<a href="javascript: ue_eliminar_premio();"><img src="../../../../shared/imagebank/tools20/eliminar.png" alt="Grabar" width="20" height="20" border="0">Eliminar  Premiaci&oacute;n</a></td>
          <td width="188"><span class="toolbar"><a href="javascript: ue_buscar_premio();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Premiaci&oacute;n</a></span></td>
      </tr>
