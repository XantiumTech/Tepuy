<?php
	...
	function uf_cabezera($as_nomresalm,$as_nompro,$as_nomreppro,$as_nombre,&$io_pdf)
	{
		...
		//$io_pdf->addText(300,70,7,"Teléfono: 0251-232.30.54 - 233.36.34 ext 1103-1163");
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_detalle($as_estpro,$as_numordcom,$as_nombre,$as_montotart,$as_ciuemp,$adt_fecrec,$as_fechent,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
	    $la_data=array(array('name'=>'los cuales fueron recibidos  desde el '.$adt_fecrec.' hasta el '.$as_fechent.' segun <b>'.$ls_tipo_orden.' No. '.$as_numordcom.'</b> Acta levantada '),
	...
	function uf_print_pie_cabecera($as_nombre,&$io_pdf)
	{
		...
		//	   Creado Por : Ing. Miguel Palencia
		//  Modificado Por: Ing. Yozelin Barragán              Modificado Por: Ing. Gloriely Fréitez
		// Fecha Creación: 05/02/2007                   Fecha de Modificación: 03/04/2008
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
   /*     $io_pdf->addText(30,180,12,"POR LA EMPRESA");   
		...
		$io_pdf->addText(250,65,7,"Zona Educativa del Estado Lara");
		$io_pdf->addText(190,55,7,"Carrera 18 esquina calle 25 Edificio Buria. Barquisimeto-Estado Lara-Venezuela");
		$io_pdf->addText(220,45,7,"Teléfono: 0251-232.30.54 - 233.36.34 ext 1103-1163");	
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_firma(&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function : uf_print_pie_firma
		//		    Acess : private
		//	    Arguments : ad_total // Total General
		//    Description : función que imprime el fin de la cabecera de cada página
		//	   Creado Por : Ing. Gloriely Fréitez
		// Fecha Creación: 03/04/2008
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->addText(50,180,12,"Sin más nada a que hacer referencia, se despide de usted,");
		$io_pdf->addText(263,160,10,"<b>Atentamente,</b>");
		$io_pdf->addText(250,100,10,"<b>Lic. Alexander Escudero</b>");
		$io_pdf->addText(200,90,10,"<b>Jefe de la División de Administración y Servicios</b>");		
	...
	//--------------------------------------------------------------------------------------------------------------------------------
		...
		if($ls_tipoformato==1)
		{
			require_once("tepuy_siv_class_reportbsf.php");
			$io_report=new tepuy_siv_class_reportbsf();
    ...
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	 ...
	 else // Imprimimos el reporte
	 {
		...
		$io_fun_inventario->uf_load_seguridad_reporte("SIV","tepuy_siv_r_acta_recepcion_bienes.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////////
		...
		for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
		{
			  ...
			  $ls_fecha_ent=$io_funciones->uf_convertirfecmostrar($io_report->dts_reporte->data["fecentr"][$li_s]);	
			  
			  if ($ls_fecha_ent=='00/00/0000')
			  {
			  	$ls_fecha_ent=$ldt_fecrec;
			  }		 
		...
		uf_print_pie_detalle($ls_estpro,$ls_numordcom,$ls_nombre,$ls_montotart,$ls_ciuemp,$ldt_fecrec,$ls_fecha_ent,$io_pdf); 
		uf_print_pie_cabecera($ls_nombre,$io_pdf);
		uf_print_detalle($la_data,$io_pdf); // Imprimimos el detalle
		unset($la_data);
		uf_print_pie_firma(&$io_pdf);
