...
class tepuy_srh_c_enfermedades
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_enfermedades($path)
	{   
	...
	function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_p_enfermedades)
		//      Argumento: 
  ...
  {  
		...
		//         access: public (tepuy_srh_enfermedades)														         	    //
...
}// end   class tepuy_srh_c_enfermedades
?>