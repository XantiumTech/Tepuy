            ...
            <tr>
              <td height="8" colspan="3" align="left"><table width="572" height="45" border="0" align="center" cellpadding="0" cellspacing="2" class="formato-blanco">
                <tr>
                  ...
                  <td colspan="3" ><input name="txtcodfuefin" type="text" id="txtcodfuefin"  style="text-align:left" value="<? print $ls_codfuefin ?>" size="4" maxlength="4" readonly="true">                    <a href="javascript:ue_catfuentesfin();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
/***********************************************************************************************************************************/
        ...
        function ue_imprimir()
        {
	        ...
	        pagina="tepuy_sob_rpp_obras_pdf.php?consulta="+consulta;
	        window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=200,resizable=yes,location=no");
        }		
</script>
