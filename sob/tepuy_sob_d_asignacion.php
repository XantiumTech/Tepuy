...
/********************************************         SEGURIDAD       ****************************************************/
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_d_asignacion.php";
...
require_once("class_folder/tepuy_sob_c_puntodecuenta.php");
$io_puntodecuenta=new tepuy_sob_c_puntodecuenta();
...
$ls_titulopartidas="Asignacion de la Obra";//"Partidas Asignadas";
...
$la_columpartidas[4]="Monto de la Obra";//"(Ref)Pre. Uni.";
//$la_columpartidas[6]="Pre. Unitario";
$la_columpartidas[5]="Monto Diponible";
$la_columpartidas[6]="Monto a Asignar";
//$la_columpartidas[7]="Total";

$ls_titulocuentas="Cuentas de Gastos";
$li_anchocuentas=600;
$ls_nametable="grid2";
$la_columcuentas[1]="Partida Presupuestario";
$la_columcuentas[2]="Cuenta";
$la_columcuentas[3]="Monto";
$la_columcuentas[4]="Edición";

$ls_titulocargos="Impuesto al Valor Agregado";
$li_anchocargos=600;
$ls_nametable="grid3";
...
if(array_key_exists("operacion",$_POST))
{
	...
	for($li_i=1;$li_i<$li_filaspartidas;$li_i++)
     {
	        ...
	        $la_objectpartidas[$li_i][3]="<input name=txtnompar".$li_i." type=text id=txtnompar".$li_i." value='".$ls_nombre."' class=sin-borde style= text-align:left size=40 readonly>";  // Antes size=25
	        //$la_objectpartidas[$li_i][4]="<input name=txtnomuni".$li_i." type=text id=txtnomuni".$li_i." value='".$ls_unidad."' class=sin-borde size=15 style= text-align:center readonly>";
	        //$la_objectpartidas[$li_i][4]="<input name=txtpreuni".$li_i." type=text id=txtpreuni".$li_i." value='".$ls_preuni."' class=sin-borde size=15 style= text-align:center readonly>";
			$la_objectpartidas[$li_i][4]="<input name=txtpreunimod".$li_i." type=text id=txtpreunimod".$li_i." value='".$ls_preunimod."' class=sin-borde size=15 style= text-align:center onKeyPress=return(currencyFormat(this,'.',',',event))>";
	        $la_objectpartidas[$li_i][5]="<input name=txtcanttot".$li_i." type=text id=txtcanttot".$li_i." value='".$ls_canttot."' class=sin-borde size=15 style= text-align:center readonly>";
	        $la_objectpartidas[$li_i][6]="<input name=txtcantpar".$li_i." type=text id=txtcantpar".$li_i." value='".$ls_cantpar."' class=sin-borde size=15 style= text-align:center onKeyPress=return(currencyFormat(this,'.',',',event)) readonly>";
	        //$la_objectpartidas[$li_i][7]="<input name=txttotal".$li_i." type=text id=txttotal".$li_i." value='".$ls_total."' class=sin-borde size=15 style= text-align:center readonly>";	
			if($ls_canttot==0)
			{
	        ...
	        $la_objectpartidas[$li_i][3]="<input name=txtnompar".$li_i." type=text id=txtnompar".$li_i." value='".$ls_nombre."' class=sin-borde style= text-align:left size=40 readonly>"; // Antes size=25
	        //$la_objectpartidas[$li_i][4]="<input name=txtnomuni".$li_i." type=text id=txtnomuni".$li_i." value='".$ls_unidad."' class=sin-borde size=15 style= text-align:center readonly>";
	        //$la_objectpartidas[$li_i][4]="<input name=txtpreuni".$li_i." type=text id=txtpreuni".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_preuni)."' class=sin-borde size=15 style= text-align:center readonly>";
	        ...
	        $la_objectpartidas[$li_i][5]="<input name=txtcanttot".$li_i." type=text id=txtcanttot".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_canttot)."' class=sin-borde size=15 style= text-align:center readonly>";
	        $la_objectpartidas[$li_i][6]="<input name=txtcantpar".$li_i." type=text id=txtcantpar".$li_i." class=sin-borde size=15 style= text-align:center readonly>";
	        //$la_objectpartidas[$li_i][7]="<input name=txttotal".$li_i." type=text id=txttotal".$li_i." class=sin-borde size=15 style= text-align:center readonly>";	
			}
	}	
	...
	$la_objectpartidas[$li_filaspartidas][3]="<input name=txtnompar".$li_filaspartidas." type=text id=txtnompar".$li_filaspartidas." class=sin-borde style= text-align:left size=40 readonly>"; // Antes size=25
	//$la_objectpartidas[$li_filaspartidas][4]="<input name=txtnomuni".$li_filaspartidas." type=text id=txtnomuni".$li_filaspartidas." class=sin-borde size=15 style= text-align:center readonly>";
	//$la_objectpartidas[$li_filaspartidas][4]="<input name=txtpreuni".$li_filaspartidas." type=text id=txtpreuni".$li_filaspartidas." class=sin-borde size=15 style= text-align:center readonly>";
	...
	$la_objectpartidas[$li_filaspartidas][5]="<input name=txtcanttot".$li_filaspartidas." type=text id=txtcanttot".$li_filaspartidas." class=sin-borde size=15 style= text-align:center readonly>";
	$la_objectpartidas[$li_filaspartidas][6]="<input name=txtcantpar".$li_filaspartidas." type=text id=txtcantpar".$li_filaspartidas." class=sin-borde size=15 style= text-align:center $ls_readonly>";
	//$la_objectpartidas[$li_filaspartidas][7]="<input name=txttotal".$li_filaspartidas." type=text id=txttotal".$li_filaspartidas." class=sin-borde size=15 style= text-align:center readonly>";
	...
	if ($ls_operacion != "ue_cargarcuenta" && $ls_operacion != "ue_removercuenta")
	{
		...
		{		
		   ...
		   $la_objectcuentas[$li_i][2]="<input name=txtnomcue".$li_i." type=text id=txtnomcue".$li_i." class=sin-borde style= text-align:left size=10 value='".$ls_nombre."' readonly >";
		   $la_objectcuentas[$li_i][3]="<input name=txtmoncue".$li_i." type=text id=txtmoncue".$li_i." class=sin-borde size=20 style= text-align:center value='".$ls_moncar."' onKeyPress=return(currencyFormat(this,'.',',',event)) onBlur=javascript:ue_validardispo()><input name=disponible".$li_i." type=hidden id=disponible".$li_i." value='".$ls_disponible."'>";
		   $la_objectcuentas[$li_i][4]="<a href=javascript:ue_removercuenta(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
		}	
		...
		$la_objectcuentas[$li_filascuentas][2]="<input name=txtnomcue".$li_filascuentas." type=text id=txtnomcue".$li_filascuentas." class=sin-borde style= text-align:left size=10 readonly><input name=disponible".$li_filascuentas." type=hidden id=disponible".$li_filascuentas.">";
		$la_objectcuentas[$li_filascuentas][3]="<input name=txtmoncue".$li_filascuentas." type=text id=txtmoncue".$li_filascuentas." class=sin-borde style= text-align:center size=20 readonly>";
		$la_objectcuentas[$li_filasfuentes][4]="<input name=txtvacio type=text id=txtvacio class=sin-borde style= text-align:center size=15 readonly>";
	}
	if ($ls_operacion != "ue_cargarcargo" && $ls_operacion != "ue_removercargo")
	{
		...
		{		
			...
			$la_objectcargos[$li_i][1]="<input name=txtcodcar".$li_i." type=text id=txtcodcar".$li_i." class=sin-borde style= text-align:center size=15 value='".$ls_codigo."' readonly><input name=prog".$li_i." type=hidden id=prog".$li_i." value='".$ls_prog."'><input name=spgcuenta".$li_i." type=hidden id=spgcuenta".$li_i." value='".$ls_spgcuenta."'>";
		...
		$la_objectcargos[$li_filascargos][4]="<input name=txtvacio type=text id=txtvacio class=sin-borde style= text-align:center size=15 readonly>";
	}
}
/*******************************************************************************************************************************************************/
...
else
{
	...
	$la_objectcuentas[1][2]="<input name=txtnomcue1 type=text id=txtnomcue1 class=sin-borde style= text-align:left size=10 readonly>";
	$la_objectcuentas[1][3]="<input name=txtmoncue1 type=text id=txtmoncue1 class=sin-borde style= text-align:center size=20 readonly><input name=disponible1 type=hidden id=disponible1>";
	$la_objectcuentas[1][4]="<input name=txtvacio2 type=text id=txtvacio2 class=sin-borde style= text-align:center size=15 readonly>";
	
	$li_filascargos=1;
	$la_objectcargos[1][1]="<input name=txtcodcar1 type=text id=txtcodcar1 class=sin-borde style= text-align:center size=15 readonly><input name=formula1 type=hidden id=formula1><input name=prog1 type=hidden id=prog1><input name=spgcuenta1 type=hidden id=spgcuenta1>";
	...
	$la_objectcargos[1][4]="<input name=txtvacio2 type=text id=txtvacio2 class=sin-borde style= text-align:center size=15 readonly>";
...
if($ls_operacion=="ue_actulizarmontoasi")
{
	...
	for($li_i=1;$li_i<=$li_filaspartidas;$li_i++)
	{
	        ...
	        //$la_objectpartidas[$li_i][4]="<input name=txtnomuni".$li_i." type=text id=txtnomuni".$li_i." value='".$ls_unidad."' class=sin-borde size=15 style= text-align:center readonly>";
	        //$la_objectpartidas[$li_i][4]="<input name=txtpreuni".$li_i." type=text id=txtpreuni".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_preuni)."' class=sin-borde size=15 style= text-align:center readonly>";
		$la_objectpartidas[$li_i][4]="<input name=txtpreunimod".$li_i." type=text id=txtpreunimod".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_preuni)."' class=sin-borde size=15 style= text-align:center onKeyPress=return(currencyFormat(this,'.',',',event))>";
	        $la_objectpartidas[$li_i][5]="<input name=txtcanttot".$li_i." type=text id=txtcanttot".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_canttot)."' class=sin-borde size=15 style= text-align:center readonly>";
	        $la_objectpartidas[$li_i][6]="<input name=txtcantpar".$li_i." type=text id=txtcantpar".$li_i." class=sin-borde size=15 style= text-align:center onKeyPress=return(currencyFormat(this,'.',',',event)) $ls_readonly>";
		// EVITA EL TOTAL
	        //$la_objectpartidas[$li_i][7]="<input name=txttotal".$li_i." type=text id=txttotal".$li_i." class=sin-borde size=15 style= text-align:center readonly>";	
			if($ls_canttot==0)
			{
		...
		$la_objectpartidas[$li_i][4]="<input name=txtpreunimod".$li_i." type=text id=txtpreunimod".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_preuni)."' class=sin-borde size=15 style= text-align:center readonly>";
	        $la_objectpartidas[$li_i][5]="<input name=txtcanttot".$li_i." type=text id=txtcanttot".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_canttot)."' class=sin-borde size=15 style= text-align:center readonly>";
	        $la_objectpartidas[$li_i][6]="<input name=txtcantpar".$li_i." type=text id=txtcantpar".$li_i." class=sin-borde size=15 style= text-align:center $ls_readonly>";
		// EVITA EL TOTAL
	        //$la_objectpartidas[$li_i][7]="<input name=txttotal".$li_i." type=text id=txttotal".$li_i." class=sin-borde size=15 style= text-align:center readonly>";	
			}
	}
...
elseif($ls_operacion=="ue_agregarcargo")
{
	...
	$la_objectcuentas[$li_filascuentas][1]="<input name=txtcodcue".$li_filascuentas." type=text id=txtcodcue".$li_filascuentas." class=sin-borde style= text-align:center size=40 readonly><input name=codest1".$li_filascuentas." type=hidden id=codest1".$li_filascuentas."><input name=codest2".$li_filascuentas." type=hidden id=codest2".$li_filascuentas."><input name=codest3".$li_filascuentas." type=hidden id=codest3".$li_filascuentas."><input name=codest4".$li_filascuentas." type=hidden id=codest4".$li_filascuentas."><input name=codest5".$li_filascuentas." type=hidden id=codest5".$li_filascuentas.">";
	$la_objectcuentas[$li_filascuentas][2]="<input name=txtnomcue".$li_filascuentas." type=text id=txtnomcue".$li_filascuentas." class=sin-borde style= text-align:left size=10 readonly>";
	$la_objectcuentas[$li_filascuentas][3]="<input name=txtmoncue".$li_filascuentas." type=text id=txtmoncue".$li_filascuentas." class=sin-borde size=20 style= text-align:center readonly><input name=disponible".$li_filascuentas." type=hidden id=disponible".$li_filascuentas." value='".$ls_disponible."'>";
	$la_objectcuentas[$li_filascuentas][4]="<input name=txtvacio".$li_filascuentas." type=text id=txtvacio class=sin-borde style= text-align:center size=15 readonly>";
	$li_filascargos=$_POST["filascargos"];
	...
	$la_objectcargos[$li_filascargos][1]="<input name=txtcodcar".$li_filascargos." type=text id=txtcodcar".$li_filascargos." class=sin-borde style= text-align:center size=15 ><input name=prog".$li_filascargos." type=hidden id=prog".$li_filascargos."><input name=spgcuenta".$li_filascargos." type=hidden id=spgcuenta".$li_filascargos.">";
	...
	$la_objectcargos[$li_filascargos][4]="<input name=txtvacio".$li_filascargos." type=text id=txtvacio class=sin-borde style= text-align:center size=15 readonly>";
}
/***************************************************************************************************************************************************************************/
...
elseif($ls_operacion=="ue_removercuenta")
{
	...
	for($li_i=1;$li_i<=$li_filascuentas;$li_i++)
	{
		...
		{		
			$li_temp=$li_temp+1;
			$ls_codigo     = $_POST["txtcodcue".$li_temp];
		    $ls_codest1    = $_POST["codest1".$li_temp];
		    $ls_codest2    = $_POST["codest2".$li_temp];
		    $ls_codest3    = $_POST["codest3".$li_temp];
		    $ls_codest4    = $_POST["codest4".$li_temp];
		    $ls_codest5    = $_POST["codest5".$li_temp];
			$ls_disponible = $_POST["disponible".$li_temp];
		    $ls_nombre     = $_POST["txtnomcue".$li_temp];
		    $ls_moncar     = $_POST["txtmoncue".$li_temp];
		    ...
		    $la_objectcuentas[$li_temp][2]="<input name=txtnomcue".$li_temp." type=text id=txtnomcue".$li_temp." class=sin-borde style= text-align:left size=10 value='".$ls_nombre."' readonly >";
		    $la_objectcuentas[$li_temp][3]="<input name=txtmoncue".$li_temp." type=text id=txtmoncue".$li_temp." class=sin-borde size=20 style= text-align:center value='".$ls_moncar."' onKeyPress=return(currencyFormat(this,'.',',',event)) onBlur=javascript:ue_validardispo()><input name=disponible".$li_temp." type=hidden id=disponible".$li_temp." value='".$ls_disponible."'>";
		    $la_objectcuentas[$li_temp][4]="<a href=javascript:ue_removercuenta(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
		}
	}
	$la_objectcuentas[$li_filascuentas][1]="<input name=txtcodcue".$li_filascuentas." type=text id=txtcodcue".$li_filascuentas." class=sin-borde style= text-align:center size=40 readonly><input name=codest1".$li_filascuentas." type=hidden id=codest1".$li_filascuentas."><input name=codest2".$li_filascuentas." type=hidden id=codest2".$li_filascuentas."><input name=codest3".$li_filascuentas." type=hidden id=codest3".$li_filascuentas."><input name=codest4".$li_filascuentas." type=hidden id=codest4".$li_filascuentas."><input name=codest5".$li_filascuentas." type=hidden id=codest5".$li_filascuentas.">";
	$la_objectcuentas[$li_filascuentas][2]="<input name=txtnomcue".$li_filascuentas." type=text id=txtnomcue".$li_filascuentas." class=sin-borde style= text-align:left size=10 readonly>";
	$la_objectcuentas[$li_filascuentas][3]="<input name=txtmoncue".$li_filascuentas." type=text id=txtmoncue".$li_filascuentas." class=sin-borde size=20 style= text-align:center readonly><input name=disponible".$li_filascuentas." type=hidden id=disponible".$li_filascuentas.">";
	$la_objectcuentas[$li_filascuentas][4]="<input name=txtvacio".$li_filascuentas." type=text id=txtvacio class=sin-borde style= text-align:center size=15 readonly>";
...
elseif($ls_operacion=="ue_removercargo")
{
	...
	for($li_i=1;$li_i<=$li_filascargos;$li_i++)
	{
		...
		{		
			...
			$la_objectcargos[$li_temp][4]="<a href=javascript:ue_removercargo(".$li_temp.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
			$ld_result=$io_evalform->uf_evaluar($ls_formula,$ld_baseimpo,$lb_valido);
		    $ld_montotasi=$ld_montotasi+$ld_result;
		}
	}
  ...
  if($lb_valido)
  {
   /************  GUARDANDO PARTIDAS   ***********/
    ...
    for ($li_i=1;$li_i<$li_filaspartidas;$li_i++)
	 ...
	 $io_asignacion->uf_update_dtpartidas($ls_codasi,$ls_codobrasi,$la_partidas,$li_partidas,$la_seguridad);
   /***********************************************/
   ...
   $io_asignacion->uf_update_dtcargos($ls_codasi,$ls_basimpasi,$la_cargos,$li_filascargos,$la_seguridad);
  /***********************************************/ 
	...
	for ($li_i=1;$li_i<$li_filascuentas;$li_i++)
     {
	   ...
	   //print "ESTRUC->".$la_cuentas["codest1"][$li_i]."".$la_cuentas["codest2"][$li_i]."<br>";
	 }
    $io_asignacion->uf_update_dtcuentas($ls_codasi,$la_cuentas,$li_filascuentas,$la_seguridad);
   /***********************************************/ 	
  
   $io_asignacion->uf_update_estadoobra($ls_codobrasi,2);
	/*print "<script language=javascript>";
...
{   
   ...
   { 
     $lb_flag=$io_asignacion->uf_update_estado($ls_codasi,3,$la_seguridad);
	 if($lb_flag)
	 {
	  for ($li_i=1;$li_i<$li_filaspartidas;$li_i++)
       {
	    if(!empty($_POST["flagpar".$li_i]))
	     {
	        ...
	        $io_asignacion->uf_update_actcantidad($ls_codobrasi,$ls_codparG,$ls_canparG,$ls_canejeG,$la_seguridad);
...
{   
	...
	for($li_i=1;$li_i<=$li_filaspartidas;$li_i++)
	{
		...
		if(($ls_cantpar!=0))
		{
		 $la_objectpartidas[$li_i][1]="<input type=checkbox name=flagpar".$li_i." value=1 class=sin-borde checked>";
		}
		else
		{
		 $la_objectpartidas[$li_i][1]="<input type=checkbox name=flagpar".$li_i." value=1 class=sin-borde>";
	    ...
	    //$la_objectpartidas[$li_i][4]="<input name=txtnomuni".$li_i." type=text id=txtnomuni".$li_i." value='".$ls_unidad."' class=sin-borde size=15 style= text-align:center readonly>";
	    //$la_objectpartidas[$li_i][4]="<input name=txtpreuni".$li_i." type=text id=txtpreuni".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_preuni)."' class=sin-borde size=15 style= text-align:center readonly>";
		$la_objectpartidas[$li_i][4]="<input name=txtpreunimod".$li_i." type=text id=txtpreunimod".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_preunimod)."' class=sin-borde size=15 style= text-align:center onKeyPress=return(currencyFormat(this,'.',',',event))>";
	    $la_objectpartidas[$li_i][5]="<input name=txtcanttot".$li_i." type=text id=txtcanttot".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ld_cant)."' class=sin-borde size=15 style= text-align:center readonly>";
	    $la_objectpartidas[$li_i][6]="<input name=txtcantpar".$li_i." type=text id=txtcantpar".$li_i." class=sin-borde size=15 style= text-align:center value='".$io_funcsob->uf_convertir_numerocadena($ls_cantpar)."' onKeyPress=return(currencyFormat(this,'.',',',event)) $ls_readonly>";
	// EVITA MOSTRAR EL TOTAL
	   // $la_objectpartidas[$li_i][7]="<input name=txttotal".$li_i." type=text id=txttotal".$li_i." class=sin-borde size=15 style= text-align:center value='".$io_funcsob->uf_convertir_numerocadena($ld_total)."' readonly>";
	...
	for($li_i=1;$li_i<=$li_filascuentas;$li_i++)
	{
		...
		$la_objectcuentas[$li_i][1]="<input name=txtcodcue".$li_i." type=text id=txtcodcue".$li_i." class=sin-borde style= text-align:center size=40 value='".$ls_codigo."' readonly><input name=codest1".$li_i." type=hidden id=codest1".$li_i." value='".$ls_codest1."'><input name=codest2".$li_i." type=hidden id=codest2".$li_i." value='".$ls_codest2."'><input name=codest3".$li_i." type=hidden id=codest3".$li_i." value='".$ls_codest3."'><input name=codest4".$li_i." type=hidden id=codest4".$li_i." value='".$ls_codest4."'><input name=codest5".$li_i." type=hidden id=codest5".$li_i." value='".$ls_codest5."'>";
		$la_objectcuentas[$li_i][2]="<input name=txtnomcue".$li_i." type=text id=txtnomcue".$li_i." class=sin-borde style= text-align:left size=10 value='".$ls_nombre."' readonly >";
		$la_objectcuentas[$li_i][3]="<input name=txtmoncue".$li_i." type=text id=txtmoncue".$li_i." class=sin-borde size=20 style= text-align:center value='".$io_funcsob->uf_convertir_numerocadena($ls_moncar)."' onKeyPress=return(currencyFormat(this,'.',',',event)) onBlur=javascript:ue_validardispo()><input name=disponible".$li_i." type=hidden id=disponible".$li_i." value='".$ls_disponible."'>";
		$la_objectcuentas[$li_i][4]="<div align=center><a href=javascript:ue_removercuenta(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a></div>";
	}	
	$li_filascuentas=$li_filascuentas+1;
	$la_objectcuentas[$li_filascuentas][1]="<input name=txtcodcue".$li_filascuentas." type=text id=txtcodcue".$li_filascuentas." class=sin-borde style= text-align:center size=40 readonly><input name=codest1".$li_filascuentas." type=hidden id=codest1".$li_filascuentas."><input name=codest2".$li_filascuentas." type=hidden id=codest2".$li_filascuentas."><input name=codest3".$li_filascuentas." type=hidden id=codest3".$li_filascuentas."><input name=codest4".$li_filascuentas." type=hidden id=codest4".$li_filascuentas."><input name=codest5".$li_filascuentas." type=hidden id=codest5".$li_filascuentas.">";
	$la_objectcuentas[$li_filascuentas][2]="<input name=txtnomcue".$li_filascuentas." type=text id=txtnomcue".$li_filascuentas." class=sin-borde style= text-align:left size=10 readonly>";
...
/*************************CARGANDO CARGOS***********************/ //OJOOO FALTA CTSSPG DEL CARGO!!!!!
	$lb_validoca=$io_asignacion->uf_select_cargos($ls_codasi,$la_cargos,$li_totalfilas);
	if($lb_validoca)
	{
	...
	for($li_i=1;$li_i<=$li_filascargos;$li_i++)
	{
		...
		$la_objectcargos[$li_i][1]="<input name=txtcodcar".$li_i." type=text id=txtcodcar".$li_i." class=sin-borde style= text-align:center size=15 value='".$ls_codigo."' readonly><input name=prog".$li_filascargos." type=hidden id=prog".$li_filascargos." value='".$ls_codestpro."'><input name=spgcuenta".$li_filascargos." type=hidden id=spgcuenta".$li_filascargos." value='".$ls_spgcta."'>";
		$la_objectcargos[$li_i][2]="<input name=txtnomcar".$li_i." type=text id=txtnomcar".$li_i." class=sin-borde style= text-align:left size=60 value='".$ls_nombre."' readonly >";
		...
		$la_objectcargos[$li_i][4]="<div align=center><a href=javascript:ue_removercargo(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a></div>";
	}	
	$li_filascargos=$li_filascargos+1;
	$la_objectcargos[$li_filascargos][1]="<input name=txtcodcar".$li_filascargos." type=text id=txtcodcar".$li_filascargos." class=sin-borde style= text-align:center size=15 ><input name=prog".$li_filascargos." type=hidden id=prog".$li_filascargos." value=''><input name=spgcuenta".$li_filascargos." type=hidden id=spgcuenta".$li_filascargos." value=''>";
	$la_objectcargos[$li_filascargos][2]="<input name=txtnomcar".$li_filascargos." type=text id=txtnomcar".$li_filascargos." class=sin-borde style= text-align:left size=50 >";
	$la_objectcargos[$li_filascargos][3]="<input name=txtmoncar".$li_filascargos." type=text id=txtmoncar".$li_filascargos." class=sin-borde size=20 style= text-align:center><input name=formula".$li_filascargos." type=hidden id=formula".$li_filascargos.">";
	$la_objectcargos[$li_filascargos][4]="<input name=txtvacio".$li_filascargos." type=text id=txtvacio class=sin-borde style= text-align:center size=15 readonly>";
	}
...
/*************************CARGANDO CARGOS***********************/ //OJOOO FALTA CTSSPG DEL CARGO!!!!!
	...
	for($li_i=1;$li_i<=$li_filascargos;$li_i++)
	{
		...
		$ls_spgcta=$io_datastore->getValue("spg_cuenta",$li_i);
		$la_objectcargos[$li_i][1]="<input name=txtcodcar".$li_i." type=text id=txtcodcar".$li_i." class=sin-borde style= text-align:center size=15 value='".$ls_codigo."' readonly><input name=prog".$li_i." type=hidden id=prog".$li_i."><input name=spgcuenta".$li_i." type=hidden id=spgcuenta".$li_i.">";
		$la_objectcargos[$li_i][2]="<input name=txtnomcar".$li_i." type=text id=txtnomcar".$li_i." class=sin-borde style= text-align:left size=60 value='".$ls_nombre."' readonly >";
		$la_objectcargos[$li_i][3]="<input name=txtmoncar".$li_i." type=text id=txtmoncar".$li_i." class=sin-borde size=20 style= text-align:center value='".$io_funcsob->uf_convertir_numerocadena($ls_moncar)."' readonly><input name=formula".$li_i." type=hidden id=formula".$li_i." value='".$ls_formula."'>";
		$la_objectcargos[$li_i][4]="<div align=center><a href=javascript:ue_removercargo(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a></div>";
	}	
...
?>	
  ...
  <input name="hidresmonasi" type="hidden" id="hidresmonasi" value="<? print $ls_resmonasi ?>">
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      ...
      <tr class="formato-blanco">
       ...
       <tr class="formato-blanco">
        ...
        <td colspan="7"><input name="txtcodobrasi" type="text" id="txtcodobrasi" style="text-align:center " value="<? print $ls_codobrasi ?>" size="6" maxlength="6" readonly="true">
        <a href="javascript:ue_catobra();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
        <input name="txtnomobrasi" type="text" id="txtnomobrasi"  style="text-align:left" class="sin-borde" value="<? print $ls_nomobrasi ?>" size="70" maxlength="100" readonly="true">          </td>
      </tr>
      <tr class="formato-blanco">
      ...
      <tr class="formato-blanco">
        <td height="13" colspan="10" align="center" valign="top" class="sin-borde"><table width="469" height="137" border="0" cellpadding="0" cellspacing="4" class="formato-blanco">
          <tr>
            ...
            <td>&nbsp;</td>
            <td>Estatus:</td>
            <td><span class="style6"><input name="txtestobr" type="text" class="celdas-grises" id="txtestobr"  style="text-align:left" value="<? print $ls_staobr ?>" size="20" maxlength="20" readonly="true">
            </span></td></tr>
          <tr>
            <td width="121"><span class="style6">Monto Total</span></td>
            <td width="138"><span class="style6">
              <input name="txtmontotobr" type="text" id="txtmontotobr"  style="text-align: right" value="<? print $ls_monobr ?>" size="20" maxlength="20"  readonly="true">
            </span></td>
            <td width="70"><span class="center">I.V.A. </span></td>
            <td width="118"><span class="style6">
            <input name="txtresmonasi" type="text" id="txtresmonasi"  style="text-align: right" value="<? print str_replace('-','', $ls_resmontasi) ?>" size="20" maxlength="20"  readonly="true">
            </span></td>
          </tr>
          <tr>
            <td><span class="style6">Monto Asignado</span></td>
            <td><span class="style6">
              <input name="txtmontotasi" type="text" id="txtmontotasi"  style="text-align:right" value="<? print $ls_montasi ?>" size="20" maxlength="20" readonly="true">
            </span></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td>Fecha Inicio</td>
            <td><span class="style6">
              <input name="txtfeciniobr" type="text" id="txtfeciniobr"  style="text-align:left" value="<? print $ls_feciniobr ?>" size="20" maxlength="20" readonly="true">
            </span></td>
            <td><span class="style6">Fecha Fin</span></td>
            <td><span class="style6">
              <input name="txtfecfinobr" type="text" id="txtfecfinobr"  style="text-align:left" value="<? print $ls_fecfinobr ?>" size="20" maxlength="20" readonly="true">
            </span></td>
          </tr>
          <tr>
            <td><span class="style6">Estado</span></td>
            <td><span class="style6">
              <input name="txtestobr" type="text" id="txtestobr"  style="text-align:left" value="<? print $la_obra["desest"][1] ?>" size="20" maxlength="20" readonly="true">
            </span></td>
            <td>Municipio</td>
            <td><span class="style6">
              <input name="txtmunobr" type="text" id="txtmunobr"  style="text-align:left" value="<? print $la_obra["denmun"][1] ?>" size="20" maxlength="20" readonly="true">
            </span></td>
          </tr>
          <tr>
            <td>Parroquia</td>
            <td><span class="style6">
              <input name="txtparobr" type="text" id="txtparobr"  style="text-align:left" value="<? print $la_obra["denpar"][1] ?>" size="20" maxlength="20" readonly="true">
            </span></td>
            <td>Comunidad</td>
            <td><span class="style6">
              <input name="txtnomcom" type="text" id="txtnomcom"  style="text-align:left" value="<? print $la_obra["nomcom"][1] ?>" size="20" maxlength="20" readonly="true">
            </span></td>
          </tr>
        </table></td>
    </tr>
      ...
      <tr class="formato-blanco">
		...
		<input name="opemostrar" type="hidden" id="opemostrar" value="<? print $ls_opemostrar ?>">        </td>
      </tr>
      <tr class="formato-blanco">
        <td height="22">&nbsp;</td>
        <td>&nbsp;</td>
        ...
        <td colspan="3">&nbsp;</td>
        <td width="130">&nbsp;</td>
        <td width="83"><div align="right">Estado</div></td>
        <td width="127"><span class="style6">
          <input name="txtestasi" type="text" class="celdas-grises" id="txtestasi"  style="text-align: center" value="<? print $ls_estadoasi ?>" size="15" maxlength="15" readonly="true">
        </span></td>
      </tr>
      <tr class="formato-blanco">
        <td width="40" height="22"><div align="right"></div></td>
        <td width="76"><div align="right">C&oacute;digo</div></td>
        <td><input name="txtcodasi" type="text" id="txtcodasi" style="text-align:center " value="<? print $ls_codasi ?>" size="6" maxlength="6"  readonly="true" >          <div align="right"></div></td>
        <td colspan="3"><div align="right"></div></td>
        <td colspan="3"><input name="txtptocueasi" type="hidden" id="txtptocueasi" style="text-align:center " value="<? print $ls_ptocueasi ?>" size="3" maxlength="3" readonly="true">
        <a href="javascript:ue_catpuntodecuenta();"></a></td>
      </tr>
       <tr class="formato-blanco">
        <td height="22">&nbsp;</td>
        <td height="22"><div align="right">Contratista</div></td>
        <td colspan="7"><input name="txtcodproasi" type="text" id="txtcodproasi" style="text-align:center " value="<? print $ls_codproasi ?>" size="10" maxlength="10" readonly="true">
          <a href="javascript:ue_catcontratista();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
        <input name="txtnomproasi" type="text" id="txtnomproasi"  style="text-align:left" class="sin-borde" value="<? print $ls_nomproasi ?>" size="70" maxlength="100" readonly="true">        </td></tr>
    <!--  <tr class="formato-blanco">
       <td height="22">&nbsp;</td>
        <td height="22"><div align="right">Inspectora</div></td>
        <td colspan="7"><input name="txtcodinsasi" type="text" id="txtcodinsasi" style="text-align:center " value="<? print $ls_codinsasi ?>" size="10" maxlength="10" readonly="true">
          <a href="javascript:ue_catinspectora();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
          <input name="txtnominsasi" type="text" id="txtnominsasi"  style="text-align:left" class="sin-borde" value="<? print $ls_nominsasi ?>" size="70" maxlength="100" readonly="true"></td>-->
      </tr>
      <tr class="formato-blanco">
        <td height="22">&nbsp;</td>
        <td height="22"><div align="right">Fecha</div></td>
        <td colspan="7"><input name="txtfecasi" type="text" id="txtfecasi"  style="text-align:left" value="<? print $ls_fecasi ?>" size="11" maxlength="10"   onKeyPress="javascript:ue_validafecha();" datepicker="true" readonly="true"></td>
      </tr>
      <tr class="formato-blanco">
        <td height="22"><div align="right"></div></td>
        <td height="22"><div align="right">Observacion</div></td>
        <td colspan="7"><textarea name="txtobsasi" cols="80" rows="2" id="txtobsasi" onKeyPress="return(validaCajas(this,'x',event))"  onKeyDown="textCounter(this,254)" ><? print $ls_obsasi ?></textarea></td>
      </tr>
      <tr class="formato-blanco">
        <td colspan="9">&nbsp;</td>
      </tr>
      ...
      <tr class="formato-blanco">
        ...
        <td><input name="txtmonparasi" type="text" id="txtmonparasi"  style="text-align: right" value="<? print $ls_monparasi ?>" size="20" maxlength="20" readonly="true"></td>
      </tr>
      <tr class="formato-blanco">
        <td height="23">&nbsp;</td>
        <td>&nbsp;</td>
        ...
        <td><input name="txtbasimpasi" type="text" id="txtbasimpasi"  style="text-align: right" value="<? print $ls_basimpasi ?>" size="20" maxlength="20" onKeyPress="return(currencyFormat(this,'.',',',event))" onBlur="uf_validarbasimp();"></td>
      </tr>
      <tr class="formato-blanco">
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        ...
        <td><input name="txtmontotasi" type="text" id="txtmontotasi"  style="text-align: right" value="<? print $ls_montotasi ?>" size="20" maxlength="20"  readonly="true"></td>
      </tr>
      <tr class="formato-blanco">
        <td colspan="9"><div align="center">
          <table width="609" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr align="center" class="formato-blanco">
			  ...
			  <input name="filascuentas" type="hidden" id="filascuentas" value="<? print $li_filascuentas;?>">
				<input name="hidremovercuenta" type="hidden" id="hidremovercuenta" value="<? print $li_removercuenta;?>">
            </tr>
            <tr class="formato-blanco">
              <td colspan="2">&nbsp;</td>
            </tr>
      ...
      <tr class="formato-blanco">
        <td colspan="9"><table width="609" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr class="formato-blanco">
            <td width="14" height="11">&nbsp;</td>
            <td width="593"><a href="javascript:ue_catcargos();"></a><a href="javascript:ue_catcargos();">Agregar Detalle </a></td>
          </tr>
          <tr align="center" class="formato-blanco">
...
function ue_catcontratista()
{
	f=document.form1;
	f.operacion.value="";			
	pagina="tepuy_cat_contratista.php";
	popupWin(pagina,"catalogo",580,600);
...
function ue_catinspectora()
{
	f=document.form1;
	f.operacion.value="";			
	pagina="tepuy_cat_inspectora.php";
...
function ue_catobra()
{
	f=document.form1;
	f.operacion.value="";			
	pagina="tepuy_cat_obra.php?estado=''";
...
function ue_catcuentagasto()
{
	...
	//pagina="tepuy_sob_cat_cuentasspg.php";
	//popupWin(pagina,"catalogo",650,500);
	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=720,height=650,resizable=yes,location=no,status=yes");
}
...
{
	pagina="tepuy_cat_puntodecuenta.php";
...
function ue_buscar()
{
  ...
  if(li_leer==1)
   {
     f.operacion.value="";
     //pagina="tepuy_cat_asignacion.php?estado="+"&origen=DA";
	 pagina="tepuy_cat_asignacion.php?hidorigen=DA&estado=";
     popupWin(pagina,"catalogo",850,450);
...
function ue_cargarcontratista(codigo,nombre)
{
	f=document.form1; 
	/*ins=f.txtcodinsasi.value;alert("aqui");
	if(ins==codigo)
	{
...
//(ls_codasi,ls_codobr,ls_codpro,ls_codproins,ld_puncue,ls_obsasi,ls_monparasi,ls_basimpasi,ls_montotasi,ls_estasi,ls_desobr,ls_nompro,ls_fecasi)
{
	...
	f.txtmontotasi.value=uf_convertir(ls_montotasi);
	...
	f.action="tepuy_sob_d_asignacion.php";
...
function ue_montarobra(ls_codigo,ls_descripcion,ls_estado,ls_codest,ls_codten,ls_codtipest,ls_codpai,ls_codmun,ls_codpar,ls_codcom,
...
function ue_cargarcuenta(codcuenta,nomcuenta,codest1,codest2,codest3,codest4,codest5,dispo)
{
	...
	for(li_i=1;li_i<=f.filascuentas.value && !lb_existe;li_i++)
	{
		if (codest4=="00")
		{
		codpre=codest1.substring(18)+"-"+codest2.substring(4)+"-"+codest3.substring(1);
		}
		else
		{
...
function ue_cargarcargo(cod,nom,formula,progra,spg_cu)
{
	...
	for (li_i=1;li_i<li_totrowpre;li_i++)
    {
	    ...
	    if ((ls_spgcta==spg_cu) && (ls_codestpro==progra))
		{
			lb_repeat = true;
			li_filpre = li_i;
			break;
	...
	{
		ls_codestpro1=progra.substr(0,20);
		ls_codestpro2=progra.substr(20,6);
		ls_codestpro3=progra.substr(26,3);
		ls_codestpro4=progra.substr(29,2);
		ls_codestpro5=progra.substr(31,2);
		ld_resulaux=uf_convertir(ld_result);
		eval("f.txtcodcue"+li_totrowpre+".value='"+progra+"'");
		 ...
		 if(eval("f.txtcantpar"+li_i+".value")=="")
		  {
		  ...
		  else
		   {
			 ...
			 if(ld_canttot<ld_cantpar)
		         {
		          alert("El Monto que está Asignando, supera el Monto Disponible de la Obra!!");
...
{
	f=document.form1;
	ld_monparasi=uf_convertir_monto(f.txtmontotasi.value);
	ld_montotcue=0;
	lb_flag=false;
	for(li_i=1;li_i<=f.filascuentas.value;li_i++)
	{
    ...
    if(ld_montotcue==0)
	{
	 alert("Debe asignar al menos una cuenta de gastos a la Asignacion!!");
	}
	else
	{
	   lb_flag=true;
