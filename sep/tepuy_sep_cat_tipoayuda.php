...
<html>
<head>
<title>Cat&aacute;logo de Tipos Ayuda</title>
...
<table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
  <tr>
   <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Tipos de Ayuda </td>
  </tr>
</table>
<div align="center"><br>
<?php
...
if ($row=$io_sql->fetch_row($rs))
{
     ...
     $io_ds->data=$data;
    // $totrow=$io_ds->getRowCount("codtipayuda");
	 ...
	 { 
		...
		//$codigo       = $data["codtipayuda"][$z];
		//$denominacion = $data["dentipayuda"][$z];
...
{ 
	...
	alert("No se han creado Tipos de Ayuda!!!");
	close();
	</script>
	<?php
}	
