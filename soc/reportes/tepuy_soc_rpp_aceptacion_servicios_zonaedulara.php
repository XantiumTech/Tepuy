<?php
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_soc->uf_load_seguridad_reporte("SOC","tepuy_soc_r_aceptacion_servicios.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecha,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],46,710,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		...
		//$io_pdf->addJpegFromFile('../../shared/imagebank/LOGO ZONA EDUCATIVA LARA.jpg',46,710,300,40); // Agregar Logo
	...
	function uf_print_cuerpo($as_nomemp,$as_numordcom,$ad_fecordcom,$ai_montot,$as_totordser,$as_ciuemp,$ad_fecrecser,&$io_pdf)
	{
		...
		$io_pdf->ezTable($la_data1,$la_columna,'',$la_config);*/
	     	$io_pdf->ezSetCmMargins(3.6,15,3,3); // Configuración de los margenes en centímetros
	        $io_pdf->setStrokeColor(0,0,0);
			$io_pdf->Rectangle(15,190,570,150);
			//$io_pdf->addText(260,333,7,"<b>UNIDAD SOLICITANTE</b>"); // Agregar el título
			$io_pdf->line(15,330,585,330);  // LINEA HORIZONAL ARRIBA
			$io_pdf->line(15,320,585,320);  // LINEA HORIZONAL 
			$io_pdf->addText(17,323,7,"<b>CONFORME POR EL PLANTEL:</b>"); // Agregar el título
			$io_pdf->addText(17,310,7,"<b>NOMBRES Y APELLIDOS:</b>"); // Agregar el título
			$io_pdf->addText(17,300,7,"<b>_______________________________________________________________________</b>"); // Agregar el título
			$io_pdf->addText(17,285,7,"<b>CÉDULA DE IDENTIDAD:__________________________________________________</b>"); // Agregar el título
            $io_pdf->addText(17,270,7,"<b>TELÉFONO:_____________________________________________________________</b>"); // Agregar el título
			$io_pdf->addText(17,255,7,"<b>DIRECCIÓN:_____________________________________________________________</b>"); // Agregar el título
            $io_pdf->addText(17,195,7,"<b>FIRMA Y SELLO</b>"); // Agregar el título
			$io_pdf->addText(303,323,7,"<b>CONFORME POR: LA COMUNIDAD EDUCATIVA</b>"); // Agregar el título
		    $io_pdf->addText(303,310,7,"<b>NOMBRES Y APELLIDOS:</b>"); // Agregar el título
			$io_pdf->addText(303,300,7,"<b>____________________________________________________________________</b>"); // Agregar el título
			$io_pdf->addText(303,285,7,"<b>CÉDULA DE IDENTIDAD:_______________________________________________</b>"); // Agregar el título
            $io_pdf->addText(303,270,7,"<b>TELÉFONO:__________________________________________________________</b>"); // Agregar el título
			$io_pdf->addText(303,255,7,"<b>DIRECCIÓN:__________________________________________________________</b>"); // Agregar el título
            $io_pdf->addText(303,195,7,"<b>FIRMA Y SELLO</b>"); // Agregar el título
			$io_pdf->Rectangle(15,70,570,120);
			$io_pdf->line(15,175,585,175);  // LINEA HORIZONAL ARRIBA
			$io_pdf->line(300,80,300,330);  // LINEA VERTICAL
			$io_pdf->line(15,90,585,90);  // LINEA HORIZONAL ABAJO
	        $io_pdf->line(15,80,585,80);  // LINEA HORIZONAL ABAJO
			$io_pdf->addText(140,180,7,"<b>AVALADO</b>"); // Agregar el título
			$io_pdf->addText(430,180,7,"<b>AVALADO</b>"); // Agregar el título
			$io_pdf->addText(17,95,7,"<b>FIRMA Y SELLO</b>"); // Agregar el título
			$io_pdf->addText(303,95,7,"<b>FIRMA Y SELLO</b>"); // Agregar el título
			$io_pdf->addText(100,73,7,"<b>COORDINADOR DEL PROYECTO</b>"); // Agregar el título
			$io_pdf->addText(350,73,7,"<b>JEFE COORDINACIÓN DE SERVICIOS GENERALES</b>"); // Agregar el título
			$io_pdf->addText(15,60,7,"NOTA: El Coordinador del Proyecto es miembro principal de la Comisión de Compra y Servicio y responsable de la ejecución del Presupuesto Asignado");
