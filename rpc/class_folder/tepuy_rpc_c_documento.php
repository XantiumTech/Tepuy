<?php
class tepuy_rpc_c_documento
{
var $ls_sql;
var $is_msg_error;
	
		function tepuy_rpc_c_documento($conn)
		{
...
function uf_insert_documento($as_codemp,$as_coddoc,$as_dendoc,$aa_seguridad) 
{
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		   $lb_valido=false;
		   $this->is_msg->message("CLASE->tepuy_RPC_C_DOCUMENTO; METODO->uf_insert_documento; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
		 /////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
function uf_update_documento($as_codemp,$as_coddoc,$as_dendoc,$aa_seguridad) 
{
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		 $lb_valido=false;
		 $this->is_msg->message("CLASE->tepuy_RPC_C_DOCUMENTO; METODO->uf_update_documento; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
		 $lb_valido=true;
  ...
  if(!$lb_relacion)
	{ 		  
      ...
      if ($rs_data===false)
	     {
	       $lb_valido=false;
		   $this->is_msg->message("CLASE->tepuy_RPC_C_DOCUMENTO; METODO->uf_delete_documento; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	     }
      else
	     {
	       $lb_valido=true;
...
if ($rs_data===false)
   {
     $this->is_msg->message("CLASE->tepuy_RPC_C_DOCUMENTO; METODO->uf_select_documento; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
     $lb_valido=false;
   }
else
   {
...
//////////////////////////////////////////////////////////////////////////////
	...
	if($rs_data===false)
	  {
		$lb_valido=false;
        $this->is_msg->message("CLASE->tepuy_RPC_C_DOCUMENTO; METODO->uf_check_relaciones; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	  }
	else
	  {
...
function uf_load_documentos($as_codemp,&$aa_data) 
{
	...
	if ($rs_data===false)
	{
		$this->is_msg->message("CLASE->tepuy_RPC_C_DOCUMENTO; METODO->uf_load_documentos; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		$lb_valido=false;
	}
	else
	{
