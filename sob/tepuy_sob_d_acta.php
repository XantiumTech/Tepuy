...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_d_acta.php";

	$la_seguridad["empresa"]=$ls_empresa;//window
...
require_once("class_folder/tepuy_sob_c_acta.php");
$io_acta=new tepuy_sob_c_acta();
...
elseif($ls_operacion=="ue_guardar")
{
	...
	if(!$lb_existe)
	{
		$lb_valido=$io_acta->uf_guardar_acta($ls_codcon,$ls_codact,$ls_tipoacta,$ls_fecact,$ls_feciniact,$ls_fecfinact,$ls_fecrecact,  $li_numero,    "001"     ,$ls_motact,     "",    $ls_cedinsact, $ls_cedresact, $ls_cedsupact,           "",         $ls_obsact,$la_seguridad);
			if ($lb_valido)																																				
			{
		...
		else
		{
			...
			if($li_estado==1)
			{	
				$lb_valido=$io_acta->uf_update_acta($ls_codcon,$ls_codact,$ls_tipoacta,$ls_fecact,$ls_feciniact,$ls_fecfinact,$ls_fecrecact,$li_numero,      "001",   $ls_motact,     ""       ,$ls_cedinsact,$ls_cedresact,$ls_cedsupact,          "",             $ls_obsact,$la_seguridad);
				if($lb_valido)
				{					
					$ls_datoscontrato="OCULTAR";
					$ls_datosobra="OCULTAR";
...
<input name="hidstatus" type="hidden" id="hidstatus">
  <table width="685" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      <tr class="formato-blanco">
		...
		?>			
         <select name="cmbtipoacta" size="1" id="cmbtipoacta" onChange="javascript:ue_cambiaracta();">
              ...
              <input name="hidtipoacta" type="hidden" id="hidtipoacta" value="<? print $ls_tipoacta ?>">
        </div></td>
        <td width="29">&nbsp;</td>
      ...
      <tr class="formato-blanco">
        ...
        <td colspan="2"><input name="txtcodcon" type="text" id="txtcodcon" style="text-align:center " value="<? print $ls_codigo ?>" size="32" maxlength="32" readonly="true">
		...
		<a href="javascript:ue_catcontrato();" >
			<img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" >
		</a>
		<?
		}
		else
				...
				<tr class="formato-blanco">
				  ...
				  <td height="79" colspan="7" align="center" valign="top" class="sin-borde">				  <table width="480" height="111" border="0" cellpadding="0"  cellspacing="0" >
                    <tr class="letras-pequeñas">
                      ...
                      <td width="96"><input name="txtfecinicon"  stype="text" id="fecinicon"  style="text-align:center "value="<? print $ls_fecinicon?>" size="11" maxlength="11" readonly="true"></td>
                      <td width="60"><div align="right">Duraci&oacute;n</div></td>
                      <td width="198"><input name="txtplacon"  style="text-align:center "  type="text" id="txtplacon" value="<? print $ls_placon?> <? print $ls_placonuni?>" size="11" maxlength="11" readonly="true">
&nbsp;&nbsp;&nbsp;
                      </td>
                    </tr>
                    <tr class="letras-pequeñas">
                      ...
                      <input name="txtcontasi" type="text" id="txtcontasi" value="<? print $ls_contasi?>" size="70" maxlength="254" readonly="true"></td>
                    </tr>
                    <tr class="letras-pequeñas">
                      <td height="19" valign="top" class="navigation"><div align="right">Monto</div></td>
                      <td height="19" colspan="3" valign="top"><input name="txtmoncon" type="text"  readonly="true" id="txtmoncon"  style="text-align: right "value="<? print $ls_moncon?>" size="21" maxlength="21"></td>
                    </tr>
                    <tr class="letras-pequeñas">
                      <td height="19" valign="top" class="navigation"><div align="right">Estado Actual</div></td>
                      <td height="19" colspan="3" valign="top"><input name="txtestcon" type="text" id="txtestcon" value="<? print $ls_estcon?>" size="21" maxlength="30" readonly="true" style="text-align:center "></td>
                    </tr>
                    <tr class="letras-pequeñas">
                      <td height="19" valign="top" class="navigation"><div align="right">C&oacute;digo de la Obra</div></td>
                      <td height="19" colspan="3" valign="top"><input name="txtcodobr" id="txtcodobr2" value="<? print $ls_codobr?>" readonly="true"  style="text-align:center "  type="text" size="6" ></td>
                    </tr>
                    <tr class="letras-pequeñas">
                      <td height="19" valign="top" class="navigation"><div align="right">Descripci&oacute;n</div></td>
                      <td height="19" colspan="3" valign="top"><input name="txtdesobr" type="text" id="txtdesobr2" value="<? print $ls_desobr?>" size="70" readonly="true"></td>
                    </tr>
                  </table></td>
				  <td height="79" class="sin-borde">&nbsp;</td>
    			</tr>
      ...
      <tr class="formato-blanco">
        ...
        <td height="39"><input name="txtcodact" id="txtcodact" style="text-align:center " value="<? print $ls_codact?>" readonly="true" type="text" size="6" maxlength="6">        </td>
        <td height="39" width="250"><div align="left">Estado
          <input name="txtestact" type="text" class="celdas-grises" id="txtestact" value="<? print $ls_estact;?>" size="20" maxlength="20" style="text-align:center ">
        </div></td>
        <td height="39" colspan="2">&nbsp;</td>
        <td width="106" height="39"><div align="right">Fecha:</div></td>
        <td width="122" height="39"><input name="txtfecact" type="text" id="txtfecact"  style="text-align:center" value="<? print $ls_fecact ?>" size="10" maxlength="10"  readonly="true"></td>
        <td height="39">&nbsp;</td>
      </tr>
	  <?Php
	  if ($ls_tipoacta=="1" )
      ...
      <tr class="formato-blanco">
        ...
        <td height="26"><input name="txtfeciniact"   type="text" id="txtfeciniact" style="text-align:left" value="<? print $ls_feciniact ?>" size="11" maxlength="10"    readonly="true" datepicker="true"></td>
        <td height="26">&nbsp;</td>
        <td height="26">&nbsp;</td>
      </tr>
	  <?Php
	  ...
	  ?>
        ...
        <td height="26" ><input name="txtfecfinact"   type="text" id="txtfecfinact"  style="text-align:left" value="<? print $ls_fecfinact ?>" size="11" maxlength="10"   readonly="true" datepicker="true"></td>
        <td height="26">&nbsp;</td>
        <td height="26">&nbsp;</td>
      </tr>  
	  <?
	  ...
	  ?>
	   <tr class="formato-blanco">
        ...
        <td height="26"><input name="txtfecrecact"   type="text" id="txtfecrecact" style="text-align:left" value="<? print $ls_fecrecact ?>" size="11" maxlength="10"    readonly="true" datepicker="true"></td>
        <td height="26">&nbsp;</td>
        <td height="26">&nbsp;</td>
      </tr>
      ...
      <tr class="formato-blanco">
        ...
        <td height="25" colspan="5" width="800"><input name="txtnominsact" type="text"  style="text-align: left" id="txtnominsact" readonly="true" size="50" value="<? print $ls_nominsact?>" maxlength="50">          &nbsp;&nbsp;&nbsp;&nbsp;C.I.
        <input name="txtcedinsact" type="text" id="txtcedinsact" value="<? print $ls_cedinsact?>" size="10" readonly="true" maxlength="10" style="text-align:center ">
        &nbsp;
        C.I.V.        
        <input name="txtcivinsact" type="text" id="txtcivinsact"  value="<? print $ls_civinsact;?>" size="10" style="text-align:center " readonly="true" maxlength="10"> 
        <a href="javascript:ue_catinspectores();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"  ></a>          <div align="left"></div>        </td>
		<td height="25">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="24">&nbsp;</td>
        ...
        <td height="24" colspan="5"><input name="txtnomresact" type="text" id="txtnomresact" value="<? print $ls_nomresact?>" size="50" readonly="true" maxlength="50" style="text-align:left ">
        &nbsp;&nbsp;&nbsp;&nbsp;C.I.
        <input name="txtcedresact" type="text" id="txtcedresact"  value="<? print $ls_cedresact?>" size="10" maxlength="10" style="text-align:center " readonly="true">
        &nbsp;&nbsp;C.I.V.
        <input name="txtcivresact" type="text" style="text-align:center " value="<? print $ls_civresact;?>" readonly="true " size="10" maxlength="10">
        <a href="javascript:ue_catresidentes();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a></td>
        <td height="24">&nbsp;</td>
      </tr>		
      <?Php
	  	if($ls_tipoacta=="5")
	  ...
	  ?>
        ...
        <td colspan="5"><textarea name="txtmotact" cols="80" rows="2" id="txtmotact" onKeyDown="textCounter(this,254)" onKeyUp="textCounter(this,254)" onKeyPress="return(validaCajas(this,'x',event,254))"><? print $ls_motact;?></textarea></td>
        <td>&nbsp;</td>
      </tr>
	  <?
	  }
	  ...
	  ?>
        ...
        <td colspan="5"><textarea name="txtmotact" cols="80" rows="2" id="txtmotact" onKeyDown="textCounter(this,254)" onKeyUp="textCounter(this,254)"><? print $ls_motact;?></textarea></td>
        <td>&nbsp;</td>
      </tr>
	   <?
	  }
      ...
      <tr class="formato-blanco">
        ...
        <td colspan="5"><textarea name="txtobsact" cols="80" rows="2" id="txtobsact" onKeyDown="textCounter(this,254)" onKeyUp="textCounter(this,254)" onKeyPress="return(validaCajas(this,'x',event,254))"><? print $ls_obsact;?></textarea></td>
        <td>&nbsp;</td>
      </tr>
...
<input name="hidcodproins" type="hidden" id="hidcodproins" value="<? print $ls_codproins;?>">
<input name="hidcodpro" type="hidden" id="hidcodpro" value="<? print $ls_codpro;?>">
<input name="hidplacon" type="hidden" id="hidplacon" value="<? print $ls_placon;?>">
<input name="hidplaconuni" type="hidden" id="hidplaconuni" value="<? print $ls_placonuni;?>">
<input name="hidcontrol" type="hidden" id="hidcontrol" value="<? print $ls_control?>">
...
<input type="hidden" name="hidcodigo" id="hidcodigo" value="<? print $ls_codcon?>">
<input type="hidden" name="hidmotivo" id="hidmotivo" value="<? print $ls_motact?>">
<?Php
if($ls_operacion=="imprimir_acta")
{
	...
	<script language="javascript">
		...
		var documento="ACTA";
		pagina="tepuy_sob_d_filechooser.php?tipact="+tipact+"&codact="+codact+"&codcon="+codcon+"&documento="+documento;
...
function ue_catcontrato()
{
	...
	pagina="tepuy_cat_contratoactas.php?tipoacta="+tipoacta;
	...
	else
	{
		if( f.hidtipoacta.value=="5" || f.hidtipoacta.value=="6")
		{
			if(f.txtfeciniact.value=="" || f.txtfecfinact.value=="")
			{
				...
				pagina="tepuy_cat_inspectores.php?codpro="+codpro+"&tipocatalogo="+tipocatalogo;
...
function ue_buscar()
{
	...
	{
		var tipoacta=f.hidtipoacta.value;
		pagina="tepuy_cat_acta.php?tipoacta="+tipoacta;
...
function ue_imprimir()
{
	...
	/*var tipoacta=f.hidtipoacta.value;
	pagina="tepuy_sob_d_filechooser.php";
	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=400,height=150,resizable=yes,location=no,status=no,left=300,top=200");*/
}
