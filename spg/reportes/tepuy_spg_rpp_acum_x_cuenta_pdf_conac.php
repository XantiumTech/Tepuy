<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo1,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],10,550,$_SESSION["ls_width"],$_SESSION["ls_height"]);
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		//    Description: función que imprime las firmas del reporte
		//	   Creado Por: Ing. Arnaldo Suárez
		// Fecha Creación: 09/05/2008 
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_firmas=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->ezSetY(200);
		$la_columna=array('elaborado'=>'<b>ELABORADO POR</b>','verificado'=>'<b>VERIFICADO POR</b>','conformado'=>'<b>CONFORMADO</b>',
		                     'conformado2'=>'<b>CONFORMADO</b>','aprobado'=>'<b>APROBADO</b>');
	    $la_data=array(array('elaborado'=>'','verificado'=>'','conformado'=>'',
		                     'conformado2'=>'','aprobado'=>''),
					   array('elaborado'=>'','verificado'=>'','conformado'=>'',
		                     'conformado2'=>'','aprobado'=>''),
					   array('elaborado'=>'','verificado'=>'','conformado'=>'',
		                     'conformado2'=>'','aprobado'=>''),
					   array('elaborado'=>'','verificado'=>'','conformado'=>'',
		                     'conformado2'=>'','aprobado'=>''),
					   array('elaborado'=>'<b>FIRMA / SELLO</b>','verificado'=>'<b>DIRECTOR DE PRESUPUESTO</b>','conformado'=>'<b>DIRECTOR DE PLANIFICACION Y PRESUPUESTO</b>',
		                     'conformado2'=>'<b>DIRECTOR GENERAL</b>','aprobado'=>'<b>PRESIDENCIA</b>'),
					   array('elaborado'=>'','verificado'=>'<b>FIRMA / SELLO / FECHA </b>','conformado'=>'',
		                     'conformado2'=>'','aprobado'=>''));
		$la_config=array('showHeadings'=>1,     // Mostrar encabezados
						 ...
						 'maxWidth'=>990, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('elaborado'=>array('justification'=>'center','width'=>198), // Justificación y ancho de la 
						 			   'verificado'=>array('justification'=>'center','width'=>198), // Justificación y ancho de la 
						 			   'conformado'=>array('justification'=>'center','width'=>198), // Justificación y ancho de la 
						 			   'conformado2'=>array('justification'=>'center','width'=>198), // Justificación y ancho de la 
									   'aprobado'=>array('justification'=>'center','width'=>198))); // Justificación y ancho de la 
	$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	$io_pdf->restoreState();
	$io_pdf->closeObject();
	$io_pdf->addObject($io_firmas,'all');
...
//------------------------------------------------------------------------------------------------------------------------------		
	...
	//----------------------------------------------------  Parámetros del encabezado  ---------------------------------------------
			$ls_titulo=" <b> ACUMULADO POR CUENTAS DESDE FECHA  ".$ldt_fecini_rep."  HASTA  </b>"."<b>".$fecfin."</b>";  
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			if($z==$li_tot)
			{
					if($ls_tipoformato==1)
					{
						  ...
						  $la_data_tot[$z]=array('total'=>'<b>TOTAL BsF.</b>','asignado'=>$ld_total_asignado,'aumento'=>$ld_total_aumento,
					...
					{
						  $ld_total_asignado_bsf   = $io_rcbsf->uf_convertir_monedabsf($ld_total_asignado, $li_candeccon,$li_tipconmon,1000,$li_redconmon);	
						  $ld_total_aumento_bsf    = $io_rcbsf->uf_convertir_monedabsf($ld_total_aumento, $li_candeccon,$li_tipconmon,1000,$li_redconmon);	
						  $ld_total_disminucion_bsf= $io_rcbsf->uf_convertir_monedabsf($ld_total_disminucion, $li_candeccon,$li_tipconmon,1000,$li_redconmon);	
						  $ld_total_monto_actualizado_bsf= $io_rcbsf->uf_convertir_monedabsf($ld_total_monto_actualizado, $li_candeccon,$li_tipconmon,1000,$li_redconmon);	
						  $ld_total_precompromiso_bsf= $io_rcbsf->uf_convertir_monedabsf($ld_total_precompromiso, $li_candeccon,$li_tipconmon,1000,$li_redconmon);	
						  $ld_total_compromiso_bsf= $io_rcbsf->uf_convertir_monedabsf($ld_total_compromiso, $li_candeccon,$li_tipconmon,1000,$li_redconmon);	
						  $ld_total_saldo_comprometer_bsf= $io_rcbsf->uf_convertir_monedabsf($ld_total_saldo_comprometer, $li_candeccon,$li_tipconmon,1000,$li_redconmon);	
						  ...
						  $ld_total_por_paga_bsf= $io_rcbsf->uf_convertir_monedabsf($ld_total_por_paga, $li_candeccon,$li_tipconmon,1000,$li_redconmon);	
						 
						  $ld_total_asignado_bsf=number_format($ld_total_asignado_bsf,2,",",".");
						  $ld_total_aumento_bsf=number_format($ld_total_aumento_bsf,2,",",".");
						  $ld_total_disminucion_bsf=number_format($ld_total_disminucion_bsf,2,",",".");
						  $ld_total_monto_actualizado_bsf=number_format($ld_total_monto_actualizado_bsf,2,",",".");
						  $ld_total_precompromiso_bsf=number_format($ld_total_precompromiso_bsf,2,",",".");
						  $ld_total_compromiso_bsf=number_format($ld_total_compromiso_bsf,2,",",".");
						  $ld_total_saldo_comprometer_bsf=number_format($ld_total_saldo_comprometer_bsf,2,",",".");
						  $ld_total_causado_bsf=number_format($ld_total_causado_bsf,2,",",".");
						  $ld_total_pagado_bsf=number_format($ld_total_pagado_bsf,2,",",".");
						  $ld_total_por_paga_bsf=number_format($ld_total_por_paga_bsf,2,",",".");
						   
						  $la_data_tot_bsf[$z]=array('total'=>'<b>TOTAL BsF. </b>','asignado'=>$ld_total_asignado_bsf,'aumento'=>$ld_total_aumento_bsf,
												 'disminución'=>$ld_total_disminucion_bsf,'montoactualizado'=>$ld_total_monto_actualizado_bsf,
												 'precomprometido'=>$ld_total_precompromiso_bsf,'comprometido'=>$ld_total_compromiso_bsf,
												 'saldoporcomprometer'=>$ld_total_saldo_comprometer_bsf,'causado'=>$ld_total_causado_bsf,
												 'pagado'=>$ld_total_pagado_bsf,'porpagar'=>$ld_total_por_paga_bsf);
						  ...
						  $la_data_tot[$z]=array('total'=>'<b>TOTAL Bs.</b>','asignado'=>$ld_total_asignado,'aumento'=>$ld_total_aumento,
												 'disminución'=>$ld_total_disminucion,'montoactualizado'=>$ld_total_monto_actualizado,
												 'precomprometido'=>$ld_total_precompromiso,'comprometido'=>$ld_total_compromiso,
												 'saldoporcomprometer'=>$ld_total_saldo_comprometer,'causado'=>$ld_total_causado,
												 'pagado'=>$ld_total_pagado,'porpagar'=>$ld_total_por_paga);
