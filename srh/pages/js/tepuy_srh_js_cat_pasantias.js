...
var url= "../../php/tepuy_srh_a_pasantias.php";
var metodo='get';
var img="<img src=\"../../../public/imagenes/progress.gif\"> ";


var loadDataURL = "../../php/tepuy_srh_a_pasantias.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_pasantias.php";
var mygrid;
...
function Buscar()
{
	 ...
	 else
	 {
		  ...
		  mygrid.loadXML("../../php/tepuy_srh_a_pasantias.php?valor=buscar"+"&txtnropas="+nropas+"&txtfecinides="+fecinides+"&txtfecinihas="+fecinihas+"&txtcedpas="+cedpas+"&txtnompas="+nompas+"&txtapepas="+apepas);
