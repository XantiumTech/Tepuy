...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_p_evaluacion_adiestramiento.php";
  f.submit(); 
}
...
function Consultar()
{
     if  ($('txtnroreg').value=="")  		
	 {
	  ...
	  f.operacion.value="CONSULTAR";
  	  f.action="../pantallas/tepuy_srh_p_evaluacion_adiestramiento.php";
	  f.existe.value="TRUE";			
	  f.submit();	
	 }
}
...
{
     pagina="../catalogos/tepuy_srh_cat_solicitud_adiestramiento.php?valor=0";
...
{
	f=document.form1;
	window.open("../catalogos/tepuy_srh_cat_evaluacion_adiestramiento.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,left=50,top=50,location=no,resizable=yes");
	}
