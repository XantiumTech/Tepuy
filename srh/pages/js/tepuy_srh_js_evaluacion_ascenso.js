...
var url= "../../php/tepuy_srh_a_evaluacion_ascenso.php";
var metodo='get';
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_p_evaluacion_ascenso.php";
  f.submit(); 
}
...
function catalogo_personal()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_nivelseleccion.php?valor_cat=0"+"&tipo=4";
...
function consultar_items () {
	 ...
	 if  ( ($('txtcodeval').value=="") ) 		
	 {
	  ...
	  f.operacion.value="CONSULTAR";
  	  f.action="../pantallas/tepuy_srh_p_evaluacion_ascenso.php";
	  f.existe.value="TRUE";			
	  f.submit();	
	 }
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_evaluacion_ascenso.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=540,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
...
function catalogo_registro_ascenso()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_registro_ascenso.php?valor_cat=0";
