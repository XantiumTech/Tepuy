...
var url= "../../php/tepuy_srh_a_solicitud_empleo.php";
var metodo='get';
...
/* f=document.form1;
	...
	f.action="tepuy_srh_p_solicitud_empleo.php";
	f.submit();*/
...
function catalogo_nivel()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_nivelseleccion.php?valor_cat=0";
...
function catalogo_area()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_area.php?valor_cat=0";
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_solicitud_empleo.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
