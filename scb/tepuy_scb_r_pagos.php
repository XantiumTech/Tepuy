...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_pagos.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<!--  <tr>
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_imprimir();"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" title="Imprimir" width="20" height="20" border="0"></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" title="Salir" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/ayuda.png" alt="Ayuda" title="Ayuda" width="20" height="20"></td>
  </tr>
</table>
<?php
  ...
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <td height="68" colspan="4" align="center"><table width="483" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          ...
          <td width="389"><div align="left">
            <input name="txtcodban" type="text" id="txtcodban" style="text-align:center" size="6" maxlength="3">
              <a href="javascript:cat_bancos();"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Bancos" width="15" height="15" border="0"></a>              
        ...
        <tr>
          ...
          <td><div align="left">
            ...
            <a href="javascript:cat_ctabanco();"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Cuentas Bancarias" width="15" height="15" border="0"></a>
      ...
      <td height="68" colspan="4" align="center"><table width="483" border="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="177" align="left"><input name="txtprovbendesde" type="text" id="txtprovbendesde" style="text-align:center" maxlength="10" onBlur="javascript:rellenar_cadena(this.value,10,this.name);">
              <a href="javascript:cat_desde()"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Cuentas" width="15" height="15" border="0"></a></td>
          ...
          <td width="189" align="left"><input name="txtprovbenhasta" type="text" id="txtprovbenhasta" style="text-align:center" maxlength="10" onBlur="javascript:rellenar_cadena(this.value,10,this.name);">
            <a href="javascript:cat_hasta()"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Cuentas" width="15" height="15" border="0"></a></td>
        </tr>
      </table></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="35" colspan="4" align="center"><table width="483" border="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          <td height="22" align="center">
		    <div align="left">Tipo de Reporte 
		      <select name="reporte">
		            <option value="CB">Formato Original</option>
		            <option value="FR">Formato (Resumen x Banco)</option>					
                </select>
	          <span class="Estilo1">
  ...
  if (li_imprimir=='1') 
     {
		  if(f.rb[0].checked==true)
		  {
			...
			{
			//	pagina="reportes/tepuy_scb_rpp_pagos_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&tiprep="+ls_tiprep+"&orden="+ls_orden+"&operacion="+ls_codope+"&tiporeporte="+ls_tiporeporte+"&reporte="+ls_reporte;
				pagina="reportes/tepuy_scb_rpp_pagos_waryna_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&tiprep="+ls_tiprep+"&orden="+ls_orden+"&operacion="+ls_codope+"&tiporeporte="+ls_tiporeporte+"&reporte="+ls_reporte;
		  ...
		  else
		  {
			...
			{
			//	pagina="reportes/tepuy_scb_rpp_pagos_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&probendes="+ls_probendesde+"&probenhas="+ls_probenhasta+"&tiprep="+ls_tiprep+"&tipproben="+ls_tipproben+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&nomban="+ls_nomban+"&dencta="+ls_dencta+"&orden="+ls_orden+"&operacion="+ls_codope+"&tiporeporte="+ls_tiporeporte+"&reporte="+ls_reporte;
				pagina="reportes/tepuy_scb_rpp_pagos_waryna_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&probendes="+ls_probendesde+"&probenhas="+ls_probenhasta+"&tiprep="+ls_tiprep+"&tipproben="+ls_tipproben+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&nomban="+ls_nomban+"&dencta="+ls_dencta+"&orden="+ls_orden+"&operacion="+ls_codope+"&tiporeporte="+ls_tiporeporte+"&reporte="+ls_reporte;
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
			else
			{
				alert("Seleccione el rango Proveedor(es)/Beneficiario(s) !!!");	
			}
		  }
	 }
  else
...
function cat_bancos()
{
	...
	{
		window.open("tepuy_cat_bancos.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=540,height=400,left=50,top=50,location=no,resizable=yes");
	}
}
...
function cat_ctabanco()
{
	...
	if(f.rb[1].checked==true)
	{
		...
		{
			window.open("tepuy_cat_ctabanco.php?codigo="+ls_codban+"&hidnomban="+ls_denban,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=640,height=400,left=50,top=50,location=no,resizable=yes");
		}
		else
		{
...
function cat_desde()
{
	...
	if(f.rb[1].checked)
	{
		if(f.rb_provbene[0].checked)
		{
			window.open("tepuy_cat_prov_general.php?obj=txtprovbendesde","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=yes");
		}
		else if(f.rb_provbene[1].checked)
		{
			window.open("tepuy_cat_bene_general.php?obj=txtprovbendesde","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=yes");
		}
	}
}
...
function cat_hasta()
{
	...
	if(f.rb[1].checked)
	{
		if(f.rb_provbene[0].checked)
		{
			window.open("tepuy_cat_prov_general.php?obj=txtprovbenhasta","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes,dependent=yes");
		}
		else if(f.rb_provbene[1].checked)
		{
			window.open("tepuy_cat_bene_general.php?obj=txtprovbenhasta","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes,dependent=yes");
		}
	}
}
