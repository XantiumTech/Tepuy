...
class tepuy_srh_c_departamento
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_srh_c_departamento($path)
	...
	function uf_srh_select_departamento($as_coddep)
	{
		...
		//         Access: public (tepuy_srh_d_departamento)
	...
	function  uf_srh_insert_departamento($as_coddep,$as_dendep,$as_coduniadm,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql = "INSERT INTO srh_departamento (coddep, dendep,minorguniadm,ofiuniadm, uniuniadm, depuniadm, prouniadm,codemp) ".
					" VALUES('".$as_coddep."','".$as_dendep."', '".$minorguniadm."','".$ofiuniadm."', '".$uniuniadm."', '".$depuniadm."', '".$prouniadm."' ,'".$this->ls_codemp."')" ;
	...
	function uf_srh_update_departamento($as_coddep,$as_dendep, $as_coduniadm,$aa_seguridad) 
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function uf_srh_delete_departamento($as_coddep,$aa_seguridad)
	...
	function uf_srh_buscar_departamento($as_coddep,$as_dendep)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$lb_valido=true;
		$ls_sql="SELECT srh_departamento.*, sno_unidadadmin.desuniadm FROM srh_departamento, sno_unidadadmin ".
				" WHERE srh_departamento.minorguniadm =  sno_unidadadmin.minorguniadm " .
		...
		{	
			...
			while ($row=$this->io_sql->fetch_row($rs_data)) 
			{
					...
					$cell->appendChild($dom->createTextNode($row['coddep']." ^javascript:aceptar(\"$ls_coddep\",\"$ls_dendep\",\"$ls_coddestino\",\"$ls_dendestino\", \"$ls_coduniadm\", \"$ls_coduniadmdestino\", \"$ls_denuniadm\", \"$ls_denuniamddestino\");^_self"));
					$cell = $row_->appendChild($dom->createElement('cell'));
...
}// end   class tepuy_srh_c_departamento
?>
