...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_distribucion_asignacion.php";
...
<!--  <tr> 
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.png" width="20" height="20" border="0"></a></a><a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.png" alt="Excel" width="20" height="20" border="0"></a></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a>
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Distribución del Presupuesto </td>
    </tr>
  </table>
	   ...
	   ?>
          ...
          <!--DWLayoutTable-->
		    ...
		    <tr class="formato-blanco">
		      ...
		      <td width="20"></td>
		      <td width="136"><input name="codestpro3" style="text-align:center" type="text" id="codestpro3" value="<?php print $ls_codestpro3 ?>" size="22" maxlength="3"></td>
            ...
            <td></td>
            <td><input name="codestpro3h" style="text-align:center" type="text" id="codestpro3h" value="<?php print $ls_codestpro3h ?>" size="22" maxlength="3"></td>
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			else
			{
				...
				{
				  pagina="reportes/tepuy_spg_rpp_asignacion_presupuestaria.php?codestpro1="+codestpro1
				//  pagina="reportes/tepuy_spg_rpp_asignacion.php?codestpro1="+codestpro1
