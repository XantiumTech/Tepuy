		        ...
		        if ($lb_valido)
		           {
					 ...
					 $ls_contable="12103010103";$ls_denocuenta="Ayudas Economicas";		
			       }
		         else
		           {
...
Venezolano            </label>
          ...
          <tr class="formato-blanco">
            <td height="22" align="right"><span class="sin-borde"><strong>(*)</strong></span>&nbsp;C&oacute;digo Contable&nbsp;</td>
...
function ue_nuevo()
{
    ...
    if(li_incluir==1)
    {
		...
		f.txtcelular.value="";
		f.txtemail.value="";
		f.txtcontable.value="12103010103";
		f.txtcuenta.value="";
