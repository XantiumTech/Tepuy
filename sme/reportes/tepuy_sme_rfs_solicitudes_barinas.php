...
//////////////////////////////////AGREGA TITULO  ///////////////////////////
		...
		$io_pdf->addText($tmy+122,$tmx-40,7,"DIRECCION DE RECURSOS HUMANOS"); // Agregar el título
		...
		$io_pdf->addText(514,$tmx-40,7,"No.: ".$as_numsol); // Agregar el título
...
//FORMATO ALCALDIA DE BARINAS
		...
		$ls_cargo_presupuesto = $_SESSION["la_empresa"]["cargo_rrhh"];
                ...
                $io_pdf->addText(400,30,7, $ls_jefe_presupuesto); // Agregar el tï¿½tulo
