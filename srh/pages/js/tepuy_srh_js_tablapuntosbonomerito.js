var url= "../../php/tepuy_srh_a_tablapuntosbonomerito.php";
var metodo='get';
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_d_tablapuntosbonomerito.php";
  f.submit();
}
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_tablapuntosbonomerito.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
