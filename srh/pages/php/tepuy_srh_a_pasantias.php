<?
	session_start();
	require_once("../../class_folder/dao/tepuy_srh_c_pasantias.php");
	...
	$io_pasantia= new tepuy_srh_c_pasantias('../../../');
    $io_fun_srh=new class_funciones_srh('../../../');
	$io_fun_srh->uf_load_seguridad("SRH","tepuy_srh_p_pasantias.php",$ls_permisos,$la_seguridad,$la_permisos);
