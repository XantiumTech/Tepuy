      ...
      <table width="850" height="22" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td height="35" colspan="5"><label>
              <textarea name="txtconordcom" cols="90" wrap="physical" id="txtconordcom" style="text-align:left" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyzáéíóú '+'¡!:;_°#@/?¿%&$*-,.+(){}[]='); "><?php print $ls_conordcom ?></textarea>
            </label></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td height="35" colspan="5"><label>
              <textarea name="txtobscom" cols="90" id="txtobscom" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyzáéíóú '+'¡!:;_°#@/?¿%&$*-,.+(){}[]='); "><?php print $ls_obscom ?></textarea>
            </label></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td height="22" colspan="3"><div align="left">
              <label>
              <input name="txtlugentnomdep" type="text" id="txtlugentnomdep" value="<?php echo $ls_lugentnomdep; ?>" size="20" maxlength="100" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyzáéíóú '+'¡!:;_°#@/?¿%&$*-,.+(){}[]='); ">
              </label>
</div></td>
          ...
          <tr>
            ...
            <td height="20" colspan="3"><input name="txtlugentdir" type="text" id="txtlugentdir" value="<?php echo $ls_lugentdir; ?>" size="20" maxlength="254" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyzáéíóú '+'¡!:;_°#@/?¿%&$*-,.+(){}[]='); "></td>
...
function ue_cargar_solicitud()
{
  ...
  if ((ls_tipsol=="SEP")||(ls_tipsol==""))
     ...
     {
	   alert("Si desea procesar Solicitudes de Ejecución Presupuestaria, No indique Unidad d Solicitante ya que estas vienen definidas desde las mismas !!!");
     }
}
			     ...
			     if (ls_fecentordcom!='')
				    {
					  ...
					  if (!valido)
					     {
						   alert("La Fecha de Entrega debe ser mayor o igual a la Fecha de Emisión de la Orden de Compra !!!");
						 }
					}
			   }
			if (valido)
