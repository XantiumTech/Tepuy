...
<table width="630" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="500" height="20" align="center" valign="middle" class="titulo-ventana">Catálogo de Cotizaciones</td>
    </tr>
  </table>
  <br>
    <table width="630" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
      <tr>
        <td width="128" height="22"><div align="right">N&deg; Solicitud Cotizaci&oacute;n </div></td>
        <td width="189" height="22"><input type="text" name="txtnumsol" onBlur="javascript:rellenar_cad(this,15)"  style="text-align:center "></td>
        <td width="130"><div align="right">Fecha Inicio </div></td>
        <td width="143"><input name="txtfecini" type="text" id="txtfecini" size="11" maxlength="10" datepicker="true"  value="<?PHP print "01/".date("m/Y")?>" onKeyPress="javascript:currencyDate(this)"></td>
      </tr>
      <tr>
        <td height="22"><div align="right">N&deg; Cotizaci&oacute;n </div></td>
	  ...
	  <tr>
        <td colspan="4"><div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a><a href="javascript: ue_close();"> <img src="../shared/imagebank/eliminar.png" width="15" height="15" class="sin-borde">Cerrar</a></div></td>
	  </tr>
  </table> 
	<p>
...
function ue_aceptar(as_numsolcot,as_numcot,as_nompro,as_codpro,ad_feccot,ai_poriva,ai_montotcot,as_tipsolcot)
{
	...
	//alert("esta entrando la solicitud "+as_numsolcot);
	...
	//opener.document.formulario.totalcotizaciones.value=total;	
	...
	parametros=parametros+"&txtnumsol"+total+"="+as_numsolcot+"&txtnumcot"+total+"="+as_numcot+"&txtnompro"+total+"="+as_nompro+
				"&txtcodpro"+total+"="+as_codpro+
			   "&txtfecha"+total+"="+ad_feccot+"&txtmonto"+total+"="+ai_montotcot+""+
			   "&txtiva"+total+"="+ai_poriva+""+"&txttipsolcot"+total+"="+as_tipsolcot+
