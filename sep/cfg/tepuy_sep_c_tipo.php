...
function uf_insert_tipoayuda($as_codtipayuda,$as_dentipayuda,$aa_seguridad) 
{
	...
	//	Access       : public
	//	Arguments    :
	//  as_codtip    = Código del Tipo de Ayuda en la SEP.
	//  as_dentip    = Denominación del Tipo de Ayuda de SEP.
	...
	$ls_sql=" INSERT INTO sep_tipoayuda ". 
			" (codtipayuda, codtipcon, dentipayuda) ". 
			" VALUES ('".$as_codtipayuda."','".$as_codtipcon."','".$as_dentipayuda."')";
//print $ls-sql;
	...
	if ($rs_data===false)
	...
	else
	 {
	   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
	   $ls_evento="INSERT";
	   $ls_descripcion ="Insertó Tipo Ayuda en SEP ".$as_codtip;
...
//        $as_codcla:  Código del Tipo de Ayuda a actualizar.
...
////////////////////////////////////////////////////////////////////////////// 
 //$as_spgcuenta="4070102010000";
  ...
  $ls_sql=" UPDATE sep_tipoayuda ".
		  " SET  dentipayuda='".$as_denayuda."' ".", codtipcon='".$as_codtipcon."' ".
...
//print $ls_sql;
  ...
  if ($rs_data===false)
  ...
  else
	 {
	   ...
	   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
	   $ls_evento="UPDATE";
	   $ls_descripcion ="Actualizó en SEP El Tipo de Ayuda ".$as_codayuda;
	   $ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
	   $aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
	   $aa_seguridad["ventanas"],$ls_descripcion);
	   /////////////////////////////////         SEGURIDAD               /////////////////////////////		     
...
//	       Arguments: 
//        $as_codemp:  Código de la Empresa.
//        $as_codcla:  Código del Tipo de Ayuda a eliminar.
//     $aa_seguridad:  Arreglo cargado con la información relacionada al
//                     nombre de la ventana,nombre del usuario etc.
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
  ...
  else
     {
		...
		/////////////////////////////////         SEGURIDAD               /////////////////////////////		
		$ls_evento="DELETE";
		$ls_descripcion ="Eliminó en SEP Tipo de Ayuda ".$as_codayuda;
		$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
		$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
		$aa_seguridad["ventanas"],$ls_descripcion);
		/////////////////////////////////         SEGURIDAD               ///////////////////////////// 		     
...
//	       Arguments: 
//        $as_codemp:  Código de la Empresa.
//        $as_codcla:  Código del Tipo de Ayuda
