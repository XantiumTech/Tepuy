<?
	session_start();
	require_once("../../class_folder/dao/tepuy_srh_c_departamento.php");
    require_once("../../class_folder/utilidades/class_funciones_srh.php");
	$io_dep=new tepuy_srh_c_departamento('../../../');
	$io_fun_srh=new class_funciones_srh('../../../');
	
	$io_fun_srh->uf_load_seguridad("SRH","tepuy_srh_d_departamento.php",$ls_permisos,$la_seguridad,$la_permisos);
		...
		$evento=$_GET['valor'];
			...
			{				
					...
					if ($lb_existe)
					{
							...
							$lb_update=$io_dep->uf_srh_update_departamento($ls_coddep,$ls_dendep,$ls_uniadm,$la_seguridad);
					...
					{
						$lb_guardar= $io_dep->uf_srh_insert_departamento($ls_coddep,$ls_dendep,$ls_uniadm,$la_seguridad);
						 if ($lb_guardar)
							{
			...
			elseif($evento=="buscar")
			{
					...
					print $io_dep->uf_srh_buscar_departamento($ls_coddep, $ls_dendep);
