...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  require_once("class_folder/tepuy_cxp_c_aprob.php");
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="CXP";
	$ls_ventanas="tepuy_cxp_p_aprob_rd.php";
...
<input name="txtfechas" type="text" id="txtfechas"  value="<?php print $ls_fechat ?>" size="13" maxlength="10" datepicker="true" onKeyPress="currencyDate(this);" style="text-align:left" ></td>
      ...
      <tr>
        ...
        <td height="22" colspan="3"><input name="txtcodproben" type="text" id="txtcodproben" value="<?php print $ls_codproben ?>" style="text-align:center"> 
          &nbsp;<a href="javascript:catalogo_proveedor();"><img src="../shared/imagebank/tools15/buscar.png" alt="Cat&aacute;logo Proveedores / Beneficiarios" width="15" height="15" border="0"></a>
      ...
      <tr>
        <td height="13" colspan="4" align="center"><div align="right"><a href="javascript:ue_search();"><img src="../shared/imagebank/tools20/buscar.png" width="20" height="20" border="0">Buscar Recepciones</a></div></td>
      </tr>
      <tr>
...
function ue_guardar()
  {          
     ...
     {    	 
		 ...
		 f.action="tepuy_cxp_p_aprob_rd.php";
		 f.submit();
	 }
	 else
	 {
...
function catalogo_proveedor()
{
    ...
    {  
	 ...
	 document.form1.action="tepuy_cxp_p_aprob_rd.php";
