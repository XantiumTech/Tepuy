<?php
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////
class class_tepuy_scbcol_integracion
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function class_tepuy_scbcol_integracion()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: class_tepuy_scbcol_integracion
		//		   Access: public 
		...
		$this->as_codban="";
		$this->as_ctaban="";
	}// end function class_tepuy_scbcol_integracion
	//-----------------------------------------------------------------------------------------------------------------------------------
													...
													$aa_seguridad)
	{
	    ...
	    $this->is_comprobante=$this->io_tepuy_int->uf_fill_comprobante(trim($this->is_numcol));		
	...
	function uf_procesar_contable()
	{
		...
		{                 
			while(($row=$this->io_sql->fetch_row($rs_data))&&($lb_valido))
		    {
				...
				$lb_valido=$this->io_tepuy_int->uf_scg_insert_datastore($this->is_codemp,$ls_scg_cuenta,$ls_debhab,$ldec_monto,$ls_documento,$this->is_procede,$this->is_descripcion);
				if($lb_valido===false)
				{  
										     ...
										     $as_estcol_new,$as_procede,$as_comprobante,$adt_fecha)
	{
		...
		$ls_sql="INSERT INTO scb_movcol_spg (codemp,codban,ctaban,numcol,numdoc,codope,estcol,codestpro,".
		        "                             spg_cuenta,operacion,desmov,monto) ".
											...
											$ad_fechaconta,$aa_seguridad)
	{
		...
		//		   Access: public (tepuy_mis_p_reverso_scbcol.php)
		//	    Arguments: as_codban  // Código de Banco
		//				   as_ctaban  // Cuenta Bancaria
		//				   as_numcol  // Número de colocación
		//				   as_numdoc  // Número de Documento
		...
		$ls_ced_bene="----------"; 
		$ls_cod_pro="----------";	
	    $lb_valido=$this->io_tepuy_int->uf_obtener_comprobante($this->is_codemp,$this->is_procede,$this->is_comprobante,
		...
		$lb_valido = $this->io_tepuy_int->uf_init_delete($this->is_codemp,$this->is_procede,$this->is_comprobante,
