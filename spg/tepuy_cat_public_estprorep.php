...
if($ls_operacion=="BUSCAR")
{
	$ls_sql=" SELECT a.codestpro1 as codestpro1,a.denestpro1 as denestpro1,b.codestpro2 as codestpro2, ".
			"		b.denestpro2 as denestpro2 ".
            " FROM spg_ep1 a,spg_ep2 b ".
            " WHERE a.codemp=b.codemp AND  a.codemp='0001' AND ".
            "       a.codestpro1=b.codestpro1 AND b.codestpro2 like '".$ls_codigo."' AND ".
            "       b.denestpro2 like '".$ls_denominacion."' ";
