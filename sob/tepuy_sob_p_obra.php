...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_p_obra.php";
...
require_once("class_folder/tepuy_sob_c_obra.php");
$io_obra1=new tepuy_sob_c_obra();
...
$ls_titulopartidas="Datos de la Obra a Asignar";
$li_anchopartidas=600;
$ls_nametable="grid";
$la_columpartidas[1]="Código";
$la_columpartidas[2]="Nombre de la Obra";
$la_columpartidas[3]="Monto en Bs. Asignado";
$la_columpartidas[4]="Monto a Asignar";
//$la_columpartidas[5]="U.M.";
$la_columpartidas[5]="Edición";
...
if(array_key_exists("operacion",$_POST))
{
	...
	if ($ls_operacion != "ue_cargarobra" && $ls_operacion != "ue_removerpartida")
	{
		for($li_i=1;$li_i<$li_filaspartidas;$li_i++)
		{
			...
			//$la_objectpartidas[$li_i][6]="&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removerpartida(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center onClick=javascript:valida_monto_total(this,".$li_i.")></a>";
			$la_objectpartidas[$li_i][5]="&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removerpartida(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center onClick=javascript:valida_monto_total(this,".$li_i.")></a>";
		}	
		...
		$la_objectpartidas[$li_filaspartidas][5]="<input name=txtvacio".$li_filaspartidas." type=text id=txtvacio class=sin-borde style= text-align:center size=2 readonly>";
	}		
	...
	if ($ls_operacion != "ue_cargarfuente" && $ls_operacion != "ue_removerfuente")
	{
		...
		{		
			...
			$la_objectfuentes[$li_i][4]="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removerfuente(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
		}	
...
else
{
	...
	$la_objectpartidas[1][5]="<input name=txtvacio type=text id=txtvacio class=sin-borde style= text-align:center size=2 readonly>";
...
{	
	...
	?>
	<input  name="auxfilas" id="auxfilas" type="hidden" value="<? print $li_filaspartidas; ?>">
...
elseif($ls_operacion=="ue_removerpartida")
{
	...
	for($li_i=1;$li_i<=$li_filaspartidas;$li_i++)
	{
		...
		{		
			...
			//$la_objectpartidas[$li_temp][6]="&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removerpartida(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center onClick=javascript:valida_monto_total(this,".$li_temp.")></a>";
			$la_objectpartidas[$li_temp][5]="&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removerpartida(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center onClick=javascript:valida_monto_total(this,".$li_temp.")></a>";
...
elseif($ls_operacion=="ue_removerfuente")
{
	...
	for($li_i=1;$li_i<=$li_filasfuentes;$li_i++)
	{
		...
		{		
			...
			$la_objectfuentes[$li_temp][4]="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removerfuente(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
		}
	}
	$la_objectfuentes[$li_filasfuentes][1]="<input name=txtcodfuefin".$li_filasfuentes." type=text id=txtcodfuefin".$li_filasfuentes." class=sin-borde style= text-align:center size=5 readonly>";
	$la_objectfuentes[$li_filasfuentes][2]="<input name=txtnomfuefin".$li_filasfuentes." type=text id=txtnomfuefin".$li_filasfuentes." class=sin-borde style= text-align:left size=50 readonly>";
...
elseif($ls_operacion=="ue_montarobra")
{
	...
	for($li_i=1;$li_i<=$li_filaspartidas;$li_i++)
	{
		...
		$la_objectpartidas[$li_i][4]="<input name=txtcanpar".$li_i." type=text id=txtcanpar".$li_i." class=sin-borde style= text-align:right size=15 value='".$ls_canpar."' onKeyPress=return(validaCajas(this,'d',event,15))  onKeyUp=javascript:uf_llamada_validarmonto(this) onBlur=javascript:ue_getformat(this)  >";
		//$la_objectpartidas[$li_i][5]="<input name=txtnomuni".$li_i." type=text id=txtnomuni".$li_i." class=sin-borde size=5 style= text-align:center value='".$ls_unidad."' readonly>";
		//$la_objectpartidas[$li_i][6]="&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removerpartida(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center on Click=javascript:valida_monto_total(this,".$li_i.")></a>";
		$la_objectpartidas[$li_i][5]="&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removerpartida(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center on Click=javascript:valida_monto_total(this,".$li_i.")></a>";
	}	
	$li_filaspartidas=$li_filaspartidas+1;
	$la_objectpartidas[$li_filaspartidas][1]="<input name=txtcodpar".$li_filaspartidas." type=text id=txtcodpar".$li_filaspartidas." class=sin-borde style= text-align:center size=10 readonly>";
	$la_objectpartidas[$li_filaspartidas][2]="<input name=txtnompar".$li_filaspartidas." type=text id=txtnompar".$li_filaspartidas." class=sin-borde style= text-align:left size=50 readonly>";
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema Control de Obras</td>
...
?>	
  ...
  <table width="743" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      ...
      <tr class="formato-blanco">
        ...
        <td width="47"><input name="txtcodobr" type="text" id="txtcodobr" style="text-align:center "  value="<? print $ls_codobr ?>" size="8" maxlength="8" readonly="true"></td>
        <td width="88"><input name="operacion" type="hidden" id="operacion"><input name="hidstatus" type="hidden" id="hidstatus"></td>
        <td width="206">&nbsp;</td>
        <td width="73"><div align="right">Fecha:</div></td>
        <td width="205"><input name="txtfeccreobr" type="text" id="txtfeccreobr"  style="text-align:left" onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" value="<? print $ls_feccreobr ?>" size="15" maxlength="15" datepicker="true" ></td>
      </tr>
      <tr class="formato-blanco">
        <td height="22"><div align="right"></div></td>
        <td height="22"><div align="right">Descripci&oacute;n</div></td>
        <td colspan="5"><textarea name="txtnomobr" cols="80"  onKeyDown="textCounter(this,254)"  onKeyUp="textCounter(this,254)"  rows="2" id="txtnomobr" ><? print $ls_nomobr ?></textarea></td>
      </tr>
       <tr class="formato-blanco">
        <td height="200" colspan="7"><table width="636" border="0" align="center" cellpadding="0" cellspacing="0"  class="sin-borde">
          <tr class="titulo-celdanew">
          ...
          <tr class="formato-blanco">
            ...
            <td colspan="2" valign="bottom"><input name="txtstaobr" readonly="true" type="text" class="celdas-grises" id="txtstaobr" value="<? print $ls_staobr;?>" size="15" style="text-align:center " maxlength="20"></td>
            <td width="57">&nbsp;</td>
            <td width="104">&nbsp;</td>
            <td colspan="2">&nbsp;</td>
          </tr>
          <tr class="formato-blanco">
           ...
           <!-- <td colspan="2"><div align="right">Organismo Ejecutor</div></td>
            <td colspan="6"><input name="txtcodpro" type="text" id="txtcodpro"  style="text-align: center" value="<? print $ls_codpro ?>" size="4" maxlength="4" readonly="true">
                <a href="javascript:ue_catpropietario();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
                <input name="txtnompro" type="text" id="txtnompro3"  style="text-align:left" class="sin-borde" value="<? print $ls_nompro ?>" size="50" maxlength="100" readonly="true" >
                <div align="right"></div>
         ...
         <!--   <td colspan="2" align="right"><div align="right">Responsable</div></td>
            <td colspan="6"><input name="txtresobr" type="text" id="txtresobr"   style="text-align:left;" value="<? print $ls_resobr ?>" size="57" maxlength="50"></td>
          </tr>
<td align="right"><div align="left"></div></td>-->
		<td height="22">&nbsp;</td>
            <td width="33">&nbsp;</td>
         <td width="110" valign="middle"><div align="right">Responsable</div></td>
            <td colspan="2"><input name="txtresobr" type="text" id="txtresobr"   style="text-align:left;" value="<? print $ls_resobr ?>" size="57" maxlength="50"></td>
          <tr class="formato-blanco"><!--
          ...
          <tr class="formato-blanco">
	        ...
	        ?>
              ...
              <input name="hidtenencia" type="hidden" id="hidtenencia3" value="<? print $ls_codten ?>">
              <div align="left"></div></td>
          </tr>
          <tr class="formato-blanco">
            <td>&nbsp;</td>
            <td colspan="2"><div align="right">Sistema Constructivo</div></td>
            <td height="22" colspan="6" align="left"><input name="txtcodsiscon" type="text" id="txtcodsiscon"  style="text-align:center" value="<? print $ls_codsiscon ?>" size="3" maxlength="3"  readonly="true"  >
                <a href="javascript:ue_catsistemaconstructivo();"> <img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"> </a>
                <input name="txtnomsiscon" type="text" id="txtnomsiscon"  style="text-align:left" class="sin-borde" value="<? print $ls_nomsiscon ?>" size="50" maxlength="100"  readonly="true"  >                  </tr>
          <tr class="formato-blanco">
            <td>&nbsp;</td>-->
		<td height="22">&nbsp;</td>
            <td width="33">&nbsp;</td>
            <td colspan="2"><div align="right">Tipo de Obra</div></td>
            <td height="22" colspan="6" align="left"><input name="txtcodtob" type="text" id="txtcodtob"  style="text-align:center" value="<? print $ls_codtob ?>" size="3" maxlength="3"  readonly="true" >
                <a href="javascript:ue_cattipoobra();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
                <input name="txtnomtob" type="text" id="txtnomtob"  style="text-align:left" class="sin-borde" value="<? print $ls_nomtob ?>" size="50" maxlength="100"  readonly="true" >                  </tr>
          <tr class="formato-blanco">
            <td><div align="left"></div></td>
            <!--<td colspan="2"><div align="right">Tipo de Estructura</div></td>
            <td height="19" colspan="6" align="left"><input name="txtcodtipest" type="text" id="txtcodtipest"  style="text-align:center" value="<? print $ls_codtipest ?>" size="3" maxlength="3"  readonly="true" >
                <a href="javascript:ue_cattipoestructura();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
                <input name="txtnomtipest" type="text" id="txtnomtipest3"  style="text-align:left" class="sin-borde" value="<? print $ls_nomtipest ?>" size="50" maxlength="100"  readonly="true" >                  </tr>-->
          <tr class="formato-blanco">
            <td>&nbsp;</td>
            <td colspan="2">&nbsp;</td>
          ...
          <tr class="formato-blanco">
            ...
            <td height="19" colspan="3" align="left"><input name="txtfeciniobr" type="text" id="txtfeciniobr"  style="text-align:left" value="<? print $ls_feciniobr ?>" size="11" maxlength="10"   datepicker="true"  readonly="true" >
&nbsp;&nbsp;&nbsp; Fecha de Fin
      <input name="txtfecfinobr" id="txtfecfinobr" type="text"  style="text-align:left" value="<? print $ls_fecfinobr ?>" size="11" maxlength="10" datepicker="true" readonly="true" >
            <td colspan="2">&nbsp;</td>
          </tr>
          <tr class="formato-blanco">
      ...
      <input name="hidestado" type="hidden" id="hidestado" value="<? print $ls_codest ?>"></td>
            ...
            <td width="96"  height="22"><?Php
              ...
              <input name="hidmunicipio" type="hidden" id="hidmunicipio6" value="<? print $ls_codmun ?>"></td>
            ...
            <td align="right"><div align="left">
                ...
                <input name="hidparroquia" type="hidden" id="hidparroquia6" value="<? print $ls_codpar ?>">
            </div></td>
          ...
          <tr class="formato-blanco">
            <td><div align="left"></div></td>
            <td colspan="2"><div align="right">Direcci&oacute;n de Ejecuci&oacute;n de la Obra</div></td>
            <td height="22" colspan="6" align="left"><div align="left">
                <input name="txtdirobr" type="text" id="txtdirobr" style="text-align:left" value="<? print $ls_dirobr ?>" size="60" maxlength="200">
            </div></td>
          </tr>
          <tr class="formato-blanco">
            <td height="16">&nbsp;</td>
          ...
          <tr class="formato-blanco">
            ...
            <td colspan="6"><textarea name="txtobsobr" cols="60" rows="2" id="textarea" onKeyDown="textCounter(this,254)"  onKeyUp="textCounter(this,254)" style="text-align:left"><? print $ls_obsobr ?></textarea></td>
          </tr>
          <tr class="formato-blanco">
            <td colspan="2">&nbsp;</td>
            <td colspan="6">&nbsp;</td>
          ...
          <table width="610" border="0" align="center" cellpadding="0" cellspacing="0"  class="sin-borde">
            <tr class="formato-blanco">
              ...
              <td width="585"><div align="left">
				...
				<a href="javascript:ue_catobra();">Agregar Detalle</a>
			  </div></td>
            </tr>
			...
			<input name="hidremoverpartida" type="hidden" id="hidremoverpartida" value="<? print $li_removerpartida;?>">
          </table>
        </div></td>
      </tr>
      <tr class="formato-blanco">
        ...
        <td colspan="2"><input name="txtmonto" type="text" id="txtmonto"  style="text-align:right" value="<? print $li_monto ?>"  read="true" size="22" maxlength="21"  ></td>
      </tr>
      <tr class="formato-blanco">
        <td colspan="7">&nbsp;</td>
      </tr>
        ...
        <td colspan="7"><div align="center">
          <table width="609" border="0" align="center" cellpadding="0" cellspacing="0"  class="sin-borde">
            ...
            <tr align="center" class="formato-blanco">
			  ...
			  <input name="filasfuentes" type="hidden" id="filasfuentes" value="<? print $li_filasfuentes;?>">
				<input name="hidremoverfuente" type="hidden" id="hidremoverfuente" value="<? print $li_removerfuente;?>">
            </tr>
          </table>
        </div></td>
      </tr>
      <tr class="formato-blanco">
        ...
        <td colspan="2"><input name="txttotalfuente" type="text" id="txttotalfuente" style="text-align:right" value="<? print $ls_totalfuente;?>" size="21" maxlength="25" readonly="true" ></td>
      </tr>
      <tr class="formato-blanco">
        <td colspan="7">&nbsp;</td>
      </tr>
  ...
  <?
   if($ls_operacion=="ue_cargarobra" || $ls_operacion=="ue_removerpartida" || $ls_operacion=="ue_cargarfuente" || $ls_operacion=="ue_removerfuente")
   {
   ?>
   	<script language="javascript">
		f=document.form1;
...
function ue_catsistemaconstructivo()
{
	f=document.form1;
	f.operacion.value="";			
	pagina="tepuy_cat_sistemaconstructivo.php";
...
{		
	...
	if (f.txtcodobr.value!="")
	{
		f.operacion.value="";	
		var hidopener="obra"
		pagina="tepuy_sob_cat_obra.php?hidopener="+hidopener;
...
function ue_catfuentefinanciamiento()
{
	...
	{			
		f.operacion.value="";
		pagina="tepuy_cat_fuentefinan.php";
		popupWin(pagina,"catalogo",520,200);
...
function ue_verfotos()
{
	...
	pagina="tepuy_sob_d_verfotos.php?opener="+opener+"&campocodigo="+codigo;
...
function ue_cargarobra(codigo,nombre,descripcion,prepar)
{
	f=document.form1;
			  		   ...
			  		   ls_fechainicio,ls_fechafin,ls_nomten,ls_nomtipest,ls_nomsiscon,ls_nomtob,ls_estado,ls_codpais)
{
	...
	f.operacion.value="ue_montarobra";
	f.hidstatus.value="C";
...
function valida_monto_total(txt,filaeliminar)
{
	...
	for(li_i=1;li_i<f.filaspartidas.value;li_i++)
	{
		...
		if(li_i!=filaeliminar && cantidad!="" && cantidad!="0,00" && cantidad!="0,0" && cantidad!="0," && cantidad!="0")
		{
			...
			if (cantidad>precio)
			{
				alert("El Monto a Asignar no puede ser mayor al Monto de la Obra");
				montototal=0,00;
				ls_cero="0,00";
				eval("f.txtcanpar"+li_i+".value='"+ls_cero+"'");
			}
			else
			{
				montoparcial=cantidad;
...
function ue_buscar()
{
	...
	{
		var estado="";
		pagina="tepuy_cat_obra.php?estado="+estado;
	...
	if(((lb_status=="C")&&(li_cambiar==1))||(lb_status!="C")&&(li_incluir==1))
	{
		with(form1)
		{
			...
			else
			{
				...
				{
					if(ue_valida_null(txtcodtob,"Tipo de Obra")==false)
					{
						f.txtcodtob.focus();
					}
					else
