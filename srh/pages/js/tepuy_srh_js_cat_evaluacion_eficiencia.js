...
var loadDataURL = "../../php/tepuy_srh_a_evaluacion_eficiencia.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_evaluacion_eficiencia.php";
var mygrid;
...
function Buscar()
{
	...
	fechahas=document.form1.txtfechahas.value;
	 ...
	 else
	 {
		...
		mygrid.loadXML("../../php/tepuy_srh_a_evaluacion_eficiencia.php?valor=buscar"+"&txtfechades="+fechades+"&txtfechahas="+fechahas+"&txtnroeval="+nroeval+"&txttipo="+tipo+"&hidtipo="+hidtipo);
				  ...
				  ls_denevaldestino, ls_accion, ls_acciondestino)
	{
		...
		obj21.value=ls_accion;
	      ...
	      if(ls_ejecucion=="1")
			...
			opener.document.form1.action="../pantallas/tepuy_srh_p_evaluacion_eficiencia.php";
