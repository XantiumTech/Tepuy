...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_d_puntodecuenta.php";
...
if(array_key_exists("operacion",$_POST))
{
	...
	if($ls_operacion!="ue_cargarcuenta" && $ls_operacion!="ue_removercuenta")
	{
		for($li_i=1;$li_i<$li_filas;$li_i++)
		{
			...
			$la_objeto[$li_i][6]="<a href=javascript:ue_removercuenta(".$li_i.");><div align=center><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></div></a>";
		}	
...
elseif($ls_operacion=="ue_guardar")
{
	...
	if($lb_validoselect===0)
	{
		...
		if($ls_imprimir=="IMPRIMIR")
		{
			  ...
			  $ls_pagina="tepuy_sob_d_filechooser.php?codpuncue=".$ls_codpuncue."&codobr=".$ls_codobr."&documento=".$ls_documento;
			  print "<script language=JavaScript>";
...
elseif($ls_operacion=="ue_removercuenta")
{
	...
	for($li_i=1;$li_i<=$li_filas;$li_i++)
	{
		if($li_i!=$li_removerfila)
		{
			...
			$la_objeto[$li_temp][6]="<a href=javascript:ue_removercuenta(".$li_temp.");><div align=center><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></div></a>";
		}		
	}	
	$la_objeto[$li_filas][1]="<input type=text name=xxx".$li_filas." id=xxx".$li_filas." size=1 class=sin-borde readonly>";
	$la_objeto[$li_filas][2]="<input type=text name=xxx".$li_filas." id=xxx".$li_filas." size=1 class=sin-borde readonly>";
  ...
  <table width="738" border="0" align="center" cellpadding="0" cellspacing="3"  class="contorno">
    ...
    <tr class="formato-blanco">
      ...
      <td colspan="3">C&oacute;digo
          <input name="txtcodobr" type="text" id="txtcodobr" style="text-align:center " value="<? print $ls_codobr ?>" size="8" maxlength="8" readonly="true">
		  ...
		  <img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0">		  </a>
		  <?
		  }
		  else
		  {
    ...
    <tr class="formato-blanco">
      ...
      <td colspan="7" align="center" valign="top"><table width="417" height="92" border="0" cellpadding="0" cellspacing="4">
          ...
          <tr class="letras-pequeñas">
            ...
            <td><span class="style6">
              <input name="txtestobr" type="text" id="txtestobr"  style="text-align:left" value="<? print $ls_estobr?>" size="20" maxlength="20" readonly="true">
            </span></td>
            <td>Municipio</td>
            <td><span class="style6">
              <input name="txtmunobr" type="text" id="txtmunobr"  style="text-align:left" value="<? print $ls_munobr ?>" size="20" maxlength="20" readonly="true">
            </span></td>
          </tr>
          <tr class="letras-pequeñas">
            <td height="18">Parroquia</td>
            <td><span class="style6">
              <input name="txtparobr" type="text" id="txtparobr"  style="text-align:left" value="<? print $ls_parobr ?>" size="20" maxlength="20" readonly="true">
            </span></td>
            <td>Comunidad</td>
            <td><span class="style6">
              <input name="txtnomcom" type="text" id="txtnomcom"  style="text-align:left" value="<? print $ls_comobr ?>" size="20" maxlength="20" readonly="true">
            </span></td>
          </tr>
      </table>      </td>
      <td>&nbsp;</td>
    ...
    <tr class="formato-blanco">
      ...
      <td width="30" height="18">
        <div align="left">
          <input name="txtcodpuncue" id="txtcodpuncue" style="text-align:center " value="<? print $ls_codpuncue?>" readonly="true" type="text" size="3" maxlength="3">
      </div></td>
      <td height="18" colspan="2"><div align="right"></div></td>
      <td height="18">&nbsp;</td>
      <td height="18"><div align="right">Fecha</div></td>
      <td width="160" height="18"><input name="txtfecpuncue" type="text" id="txtfecpuncue"  style="text-align:left" value="<? print $ls_fecpuncue?>" size="11" maxlength="11"  readonly="true" datepicker="true"></td>
      <td height="18">&nbsp;</td>
    </tr>
    <tr class="formato-blanco">
      <td height="18">&nbsp;</td>
      <td height="18"><div align="right">Presentado a</div></td>
      <td height="18" colspan="7"><input name="txtdespuncue" type="text" id="txtdespuncue" value="<? print $ls_despuncue?>" size="50" maxlength="50"></td>
    </tr>
    <tr class="formato-blanco">
      <td height="18">&nbsp;</td>
      <td height="18"><div align="right">Presentado por</div></td>
      <td height="18" colspan="6"><input name="txtrempuncue" type="text" id="txtrempuncue" value="<? print $ls_rempuncue?>" size="50" maxlength="50"></td>
      <td height="18">&nbsp;</td>
    </tr>
    <tr class="formato-blanco">
      <td height="44">&nbsp;</td>
      <td height="44"><div align="right">Asunto</div></td>
      <td height="44" colspan="6"><textarea name="txtasupuncue"  id="txtasupuncue" cols="80" rows="2" wrap="VIRTUAL" onKeyDown="textCounter(this,255)"><? print $ls_asupuncue?></textarea></td>
      <td height="44">&nbsp;</td>
    </tr>
    <tr class="formato-blanco">
      <td height="20">&nbsp;</td>
      <td height="20"><div align="right">Contratista</div></td>
      <td height="20" colspan="6"><input name="txtcodpropuncue" type="text" id="txtcodpropuncue" style="text-align:center " value="<? print $ls_codpropuncue ?>" size="10" maxlength="10" readonly="false">
          <a href="javascript:ue_catcontratista();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
          <input name="txtnompropuncue" type="text" id="txtnompropuncue"  style="text-align:left" class="sin-borde" value="<? print $ls_nompropuncue ?>" size="70" maxlength="100" readonly="true"></td>
      <td height="20">&nbsp;</td>
    </tr>
    <tr class="formato-blanco">
      <td height="18">&nbsp;</td>
      <td><div align="right">Representante Legal</div></td>
      <td colspan="6"><input name="txtreplegcon" type="text" id="txtreplegcon" value="<? print $ls_replegcon?>" size="50" maxlength="50"></td>
      <td>&nbsp;</td>
    </tr>
    <tr class="formato-blanco">
      <td height="19">&nbsp;</td>
      <td><div align="right">Lapso de Ejecuci&oacute;n </div></td>
      <td><input name="txtlapejepuncue" type="text" id="txtlapejepuncue" style="text-align:right " value="<? print $ls_lapejepuncue?>" size="6" maxlength="6" onKeyDown="javascritp:document.form1.cmblapejeunipuncue.disabled=false;" onKeyPress="return(validaCajas(this,'d',event,21))"></td>
      <td width="99"><?Php
    ...
    <tr class="formato-blanco">
      ...
      <td colspan="6">
        <input name="txtmonnetpuncue" type="text" id="txtmonnetpuncue" value="<? print $ls_monnetpuncue?>" size="21" maxlength="21" style="text-align:right " onKeyPress="return(validaCajas(this,'d',event,21)) "  onBlur="javascript:ue_getformat(this)" >
        Bs.
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr class="formato-blanco">
      ...
      <td colspan="6"><input name="txtbasimp" type="text" id="txtbasimp" value="<? print $ls_basimp?>" size="21" maxlength="21" style="text-align:right " onKeyPress="return(validaCajas(this,'d',event,21))">
Bs.
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
      <td>&nbsp;</td>
    </tr>
    <tr class="formato-blanco">
      ...
      <td colspan="6"><input name="txtmonivapuncue" type="text" id="txtmonivapuncue" value="<? print $ls_monivapuncue?>" size="21" maxlength="21" style="text-align:right " onKeyPress="return(validaCajas(this,'d',event,21))">
Bs.
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
      <td>&nbsp;</td>
    </tr>
    <tr class="formato-blanco">
      ...
      <td colspan="6"><input name="txtmonbrupuncue" type="text" id="txtmonbrupuncue" value="<? print $ls_monbrupuncue?>" size="21" maxlength="21" style="text-align:right " onKeyPress="return(validaCajas(this,'d',event,21))" readonly="true">
      Bs.</td>
      <td>&nbsp;</td>
    </tr>
    <tr class="formato-blanco">
      ...
      <td colspan="6"><input name="txtporantpuncue" type="text" id="txtporantpuncue" value="<? print $ls_porantpuncue?>" size="6" maxlength="6" style="text-align:right " onKeyPress="return(validaCajas(this,'d',event,6))" onKeyUp="javascript:ue_calcularmonto(this,document.form1.txtmonantpuncue)" onBlur="javascript:ue_getformat(this)">
      %&nbsp;&nbsp;&nbsp;
        <input name="txtmonantpuncue" type="text" id="txtmonantpuncue" value="<? print $ls_monantpuncue?>" size="21" maxlength="21" style="text-align:right " onKeyPress="return(validaCajas(this,'d',event,21))" readonly="true">
        Bs.      </td>
      <td>&nbsp;</td>
    </tr>
    ...
    <tr class="formato-blanco">
      ...
      <td colspan="6"><textarea name="txtobspuncue" cols="80" rows="2" wrap="VIRTUAL" id="txtobspuncue" onKeyDown="textCounter(this,255)"><? print $ls_obspuncue?></textarea></td>
      <td>&nbsp;</td>
    </tr>
    <tr class="formato-blanco">
      <td height="24">&nbsp;</td>
...
<input name="hidfilas" type="hidden" id="hidfilas" value="<? print $li_filas;?>">
<input name="hidfilaeliminar" type="hidden" id="hidfilaeliminar" value="<? print $li_filaeliminar;?>">
...
function ue_removercargo(li_fila)
{
	...
	f.action="tepuy_sob_d_puntodecuenta.php";
	f.submit();
}
