...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_tipoaccidente.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_yipoaccidente.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_tipoaccidente.php?valor=buscar"+"&txtcodacc="+codacc+"&txtdenacc="+denacc);
           setTimeout (terminar_buscar,500);
