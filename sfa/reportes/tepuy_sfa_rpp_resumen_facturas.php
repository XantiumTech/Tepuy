<?php
	...
	function uf_print_cabecera_detalle($as_cliente,&$io_pdf)
	{
		...
		$la_config1=array('showHeadings'=>0, // Mostrar encabezados
						...
						// 'xPos'=>310, // Orientación de la tabla
						 ...
						 'cols'=>array('name'=>array('justification'=>'left','width'=>750))); // Ancho Máximo de la tabla
	...
	{	 
		...
		$io_pdf->ezSetDy(-2);
				...
				array('codpro'=>$ls_codpro,'denpro'=>$ls_denpro,'canpro'=>$li_canpro,'preunipro'=>$li_preunipro,'monsubpro'=>$li_monsubpro,'poriva'=>$li_poriva,'moncarpro'=>$li_moncarpro,'montotpro'=>$li_montotpro,'estatus'=>$status);

		$la_columna=array('codpro'=>'<b>Código</b>',
						  'denpro'=>'<b>Denominación</b>',
						  'canpro'=>'<b>Cantidad</b>',
						  'preunipro'=>'<b>Precio Unitario</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						...
						// 'xPos'=>100, // Orientación de la tabla
						 'shaded'=>0, // Sombra entre líneas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
						 'cols'=>array('codpro'=>array('justification'=>'center','width'=>50), // Justificación y ancho de la columna
						 			   'denpro'=>array('justification'=>'center','width'=>160), // Justificación y ancho de la columna
						 			   'canpro'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   ...
						 			   'montotpro'=>array('justification'=>'center','width'=>110), // Justificación y ancho de la columna
	...
	function uf_print_resumen_factura($aa_data,&$io_pdf)
	{
		...
		$la_columna=array('titulo'=>'<b>TOTALES </b>',
				   ...
				   'subtotal'=>'<b>Sub-Total Bs.</b> ',
				   'impuesto'=>'<b>Total Impuesto Bs. </b> ',
				   'total'=>'<b>Total Bs. </b> ');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						...
						// 'xPos'=>310, // Orientación de la tabla
						 ...
						 'maxWidth'=>650, // Orientaci? de la tabla
						 'cols'=>array('titulo'=>array('justification'=>'left','width'=>120),      // Justificaci? y ancho de la columna
						 		'cantidad'=>array('justification'=>'right','width'=>160), // Ancho Máximo de la tabla
						 		'subtotal'=>array('justification'=>'right','width'=>160), // Ancho Máximo de la tabla
						 		'impuesto'=>array('justification'=>'right','width'=>120), // Ancho Máximo de la tabla
						 		'total'=>array('justification'=>'right','width'=>190))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($aa_data,$la_columna,'',$la_config);
		unset($aa_data);
		unset($la_columna);
		unset($la_config);
		$la_data1=array(array('name'=>'<b> Detalles de la Factura </b>'));				
		$la_columna1=array('name'=>'');		
		$la_config1=array('showHeadings'=>0, // Mostrar encabezados
						...
						// 'xPos'=>310, // Orientación de la tabla
						 'width'=>750, // Ancho de la tabla						 
						 'maxWidth'=>750, // Orientaci? de la tabla
						 'cols'=>array('name'=>array('justification'=>'center','width'=>750))); // Ancho Máximo de la tabla
		$io_pdf->ezTable($la_data1,$la_columna1,'',$la_config1);
		unset($la_data1);
		unset($la_columna1);
		unset($la_config1);
	...
	$ls_titulo ="RESUMEN DE FACTURAS EMITIDAS";	
	...
	//print "Desde: ".$ls_cedclides." Hasta: ".$ls_cedclihas; die();
	//--------------------------------------------------------------------------------------------------------------------------------
	$rs_data = $io_report->uf_select_resumen_facturas($ls_numfacturades,$ls_numfacturahas,$ls_cedclides,
	...
	else // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			{     
				...
				$resumen="<b>"."N. Factura: "."</b>".$ls_numfactura."<b>"." Forma de pago: "."</b>".$ls_formadepago."<b>"." Cliente: "."</b>".$ls_nombre;
				uf_print_cabecera_detalle($resumen,$io_pdf);
				////////////////////////////Productos de la Factura /////////////////////
				$rs_datos_cuenta=$io_report->uf_select_dt_resumen_factura($ls_numfactura,$ls_cedcli,&$lb_valido); 
				if($lb_valido)
				{
					 ...
					 if ($li_totrows>0)
					 {
						...
						////////// subtotales de productos de  cliente x factura //////////
						...
						////// cambio formato a los detalles del producto /////
							...
							$li_monsubpro	= number_format($li_monsubpro,2,",",".");
							$li_moncarpro	= number_format($li_moncarpro,2,",",".");
							$li_montotpro	= number_format($li_montotpro,2,",",".");
							
							$la_data[$li_s]= array('codpro'=>$ls_codpro,'denpro'=>$ls_denpro,'canpro'=>$li_canpro,'preunipro'=>$li_preunipro,'monsubpro'=>$li_monsubpro,'poriva'=>$li_poriva,'moncarpro'=>$li_moncarpro,'montotpro'=>$li_montotpro,'estatus'=>$status);
						}
						$li_gensumtotpro=$li_gensumtotpro+$li_sumtotpro;
						...
						$aa_data[1]=array('titulo'=>'<b> RESUMEN </b>','cantidad'=>"Cant. Productos ".'<b>'.$li_sumcanpro.'</b>','subtotal'=>"Sub-Total Bs. ".'<b>'.$li_sumsubpro.'</b>','impuesto'=>"Impuesto Bs. ".'<b>'.$li_sumcarpro.'</b>','total'=>" Total Factura Bs. ".'<b>'.$li_sumtotpro.'</b>');
