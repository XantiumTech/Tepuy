...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_cxp->uf_load_seguridad_reporte("CXP","tepuy_cxp_r_relacionsolicitudes.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_detalle($la_data,$ai_i,$li_totsol,$li_totbruto,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_datatit[1]=array('numsol'=>'<b>Solicitud</b>','nombre'=>'<b>Proveedor / Beneficiario</b>','fecemisol'=>'<b>Fecha Emision</b>',
							 'estprosol'=>'<b>Estatus</b>','monsol'=>'<b>Monto Neto'.$ls_titulo.'</b>','montot'=>'<b>Total Bs. '.$ls_titulo.'</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numsol'=>array('justification'=>'center','width'=>88), // Justificación y ancho de la columna
						 			   'nombre'=>array('justification'=>'center','width'=>200), // Justificación y ancho de la columna
						 			   'fecemisol'=>array('justification'=>'center','width'=>62), // Justificación y ancho de la columna
						 			   'estprosol'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'monsol'=>array('justification'=>'center','width'=>75), // Justificación y ancho de la columna
						 			   'montot'=>array('justification'=>'center','width'=>75))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numsol'=>array('justification'=>'center','width'=>88), // Justificación y ancho de la columna
						 			   ...
						 			   'fecemisol'=>array('justification'=>'center','width'=>62), // Justificación y ancho de la columna
						 			   'estprosol'=>array('justification'=>'left','width'=>70), // Justificación y ancho de la columna
		...
		$la_datatot[1]=array('titulo'=>'<b>Totales: '.$ai_i.' ordenes </b>','totsol'=>$li_totsol,'totbruto'=>$li_totbruto);
		$la_columnas=array('titulo'=>'<b>Totales</b>',
						   'totsol'=>'<b>Total</b>',
						   'totbruto'=>'<b>Total</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 ...
						 'cols'=>array('titulo'=>array('justification'=>'right','width'=>420), // Justificación y ancho de la columna
						 			   'totsol'=>array('justification'=>'right','width'=>75), // Justificación y ancho de la columna
						 			   'totbruto'=>array('justification'=>'right','width'=>75))); // Justificación y ancho de la columna
	...
	if($lb_valido)
	{
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$li_monbruto=$io_report->uf_select_montobruto($ls_numsol); // Busca el monto total de la orden
				switch ($ls_estprosol)
				{
					case 'E':
						$ls_denest='Emitida';
				...
				$li_totmonbruto=$li_totmonbruto+$li_monbruto;
				$li_monsol=number_format($li_monsol,2,",",".");
				$li_monbruto=number_format($li_monbruto,2,",",".");
				...
				$la_data[$li_i]=array('numsol'=>$ls_numsol,'nombre'=>$ls_nombre,'fecemisol'=>$ld_fecemisol,
									  'estprosol'=>$ls_denest,'monsol'=>$li_monsol,'montot'=>$li_monbruto);
			}
			uf_print_encabezado_pagina($ls_titulo,&$io_pdf);
			uf_print_detalle($la_data,$li_i,number_format($li_totmonsol,2,",","."),number_format($li_totmonbruto,2,",","."),&$io_pdf);
		}
