...
$arbol["nombre_fisico"][$li_i]="tepuy_scf_p_comprobante.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="001";
...
$arbol["nombre_fisico"][$li_i]="tepuy_scf_p_cierremensual.php";
$arbol["id"][$li_i]=$li_i;
...
$arbol["nombre_fisico"][$li_i]="tepuy_scf_p_cierreanual.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="004";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuy_scf_p_configuracion.php";
$arbol["id"][$li_i]=$li_i;
...
$arbol["nombre_fisico"][$li_i]="tepuy_scf_r_mayor_analitico.php";
$arbol["id"][$li_i]=$li_i;
...
$arbol["nombre_fisico"][$li_i]="tepuy_scf_r_balance_comprobacion.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="002";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuy_scf_r_comprobantes.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="002";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuy_scf_r_listadocuentas.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="002";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuy_scf_r_listadoplanunico.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="002";
$arbol["numero_hijos"][$li_i]=0;
