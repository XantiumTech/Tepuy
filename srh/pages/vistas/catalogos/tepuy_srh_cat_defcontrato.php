...
<html>
<head>
<title>Cat&aacute;logo de Configuraci&oacute; de Contratos</title>
...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Configuraci&oacute; de Contratos </td>
    </tr>
  </table>
<br>
...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_defcontrato.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_defcontrato.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_area.php?valor=buscar"+"&txtcodcont="+codcont+"&txtdescont="+descont);
           setTimeout (terminar_buscar,500);
