...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_mayor_analitico.php";
...
<title>Reporte de Tarjeta de Control de Cuentas</title>
...
<!--  <tr> 
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.png" width="20" height="20" border="0"></a>
	                                                  </a><a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.png" alt="Excel" width="20" height="20" border="0"></a>
													  <a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a>
...
?>
  <table width="580" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Tarjeta Control </td>
    </tr>
  </table>
  <table width="580" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><div align="left">
	   ...
	   ?>
           ...
           <table width="542" height="59" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          <!--DWLayoutTable-->
    ...
    <tr>
      <td colspan="3" align="center"><table width="542" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr class="titulo-celdanew">
	...
	?>
      <td height="22" colspan="3" align="center"><div align="right"><span class="Estilo1">
        </span><input name="estmodest" type="hidden" id="estmodest" value="<?php print  $li_estmodest; ?>">
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			else
			{
				...
				{
				  pagina="reportes/tepuy_spg_rpp_mayor_analitico_pdf.php?codestpro1="+codestpro1
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			else
			{
				...
				{
				  pagina="reportes/tepuy_spg_rpp_mayor_analitico_excel.php?codestpro1="+codestpro1
							+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
							+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&txtcuentades="+txtcuentades
							+"&txtcuentahas="+txtcuentahas+"&txtfecdes="+txtfecdes+"&rborden="+orden+"&txtfechas="+txtfechas
