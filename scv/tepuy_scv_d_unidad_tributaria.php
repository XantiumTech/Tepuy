...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Control de Viaticos</td>
...
<!-- ******** END ALLWEBMENUS CODE FOR menu ******** -->
 <!-- <tr>
  ...
  <tr>
    <td height="38" bgcolor="#FFFFFF" class="toolbar">&nbsp;</td>
  </tr>
  <tr> 
    <td height="29" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_nuevo();"><img src="../shared/imagebank/tools20/nuevo.png" alt="Nuevo" width="20" height="20" border="0"></a>
	<a href="javascript:ue_guardar();"><img src="../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0"></a>
	<a href="javascript:ue_buscar();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"></a>
	<a href="javascript:ue_print();"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" width="20" height="20" border="0"></a>
...
<?php
require_once("class_folder/tepuy_scv_c_unidad_tributaria.php");
...
$io_unidad_tributaria = new tepuy_scv_c_unidad_tributaria();
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SCV";
	$ls_ventanas = "tepuy_scv_d_unidad_tributaria.php";
...
if (array_key_exists("operacion",$_POST))
   ...
   {
	 $ls_operacion = "";
	 $ls_codigo    = $io_unidad_tributaria->retornar_ultimo();
	 $ls_anno      = "";
     $ld_fecentvig = "";
	 $ls_gacofi    = "";
	 $ld_fecpubgac = "";
...
if ($ls_operacion=="ELIMINAR")
   {
	 /* $ls_ultimo= "select max(codunitri) from tepuy_unidad_tributaria ";
	  ...
	  if ($lb_existe)
	     { 
	       ...
	       $lb_tiene     = $io_chkrel->uf_check_relaciones($ls_empresa,$ls_condicion,'tepuy_unidad_tributaria',$ls_codigo,$ls_mensaje);
	       if (!$lb_tiene)
	          {
    ...
    <tr>
      <td width="616" height="221"><table width="564"  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
       ...
       <tr>
        ...
        <tr>
          <td height="22" align="right">Decreto N&ordm;: </td>
        ...
        <tr>
          ...
          <td height="22" colspan="2"><input name="txtvalunitri" type="text" id="txtvalunitri" value="<?php print number_format($ls_valunitri,2,'','','.');?>" style="text-align:right" size="15" maxlength="10" onKeyPress="return(currencyFormat(this,'.',',',event))">
           </p></td>
        </tr>            
        <tr>
...
{ 
  ...
  if (li_incluir==1)
	 {	
	   ...
	   //f.txtcodigo.focus(); 
	   f.action="tepuy_scv_d_unidad_tributaria.php";
	   f.submit();
	}
  else
	{
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
	     f.operacion.value="";			
	     pagina="tepuy_scv_cat_unidad_tributaria.php";
...
function ue_print()
{
	...
	if(li_imprimir==1)
		{	
		  f.operacion.value="";
		  pagina="reportes/tepuy_scv_rpp_listado_unidades_tributarias.php";
