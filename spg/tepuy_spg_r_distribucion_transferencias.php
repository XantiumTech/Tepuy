...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_distribucion_transferencias.php";
...
<title>RESUMEN DEL PRESUPUESTO DE GASTOS DE INVERSIÓN</title>
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">RELACION DE TRANSFERENCIAS<br>
      </td>
    </tr>
  </table>
      ...
      <td height="40" colspan="3" align="center">      <div align="left">
        <table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="4"><strong class="titulo-celdanew">Tipo de Transferencias </strong></td>
            </tr>
          <tr>
            ...
            <td width="223" height="23"><select name="cmbnivel" id="cmbnivel">
              ...
              <option value="1">Sector Publico</option>
...
function ue_showouput()
{
	...
	pagina="reportes/tepuy_spg_rpp_distribucion_transferencias.php?combo="+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato;
