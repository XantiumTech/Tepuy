<?php
   ...
   function uf_print($as_codconc, $as_nomcon, $as_tipo)
   {
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $ls_campo,$io_fun_nomina,$li_len1,$li_len2,$li_len3,$li_len4,$li_len5,$ls_modalidad;
		...
		$ls_sql="SELECT anocur, codperi, codconc, nomcon, titcon, sigcon, forcon, glocon, acumaxcon, valmincon, valmaxcon, concon, ".
				...
				"		aplarccon, conprocon, repacucon, repconsunicon, consunicon, quirepcon, ".
				"		asifidper, asifidpat, frevarcon, ".
				"		(SELECT nompro ".
				"		   FROM rpc_proveedor ".
				...
				"		    AND spg_cuentas.codestpro4=substr(sno_thconcepto.codpro,30,2) ".
				"		    AND spg_cuentas.codestpro5=substr(sno_thconcepto.codpro,32,3) ".
				"		    AND spg_cuentas.spg_cuenta=sno_thconcepto.cueprepatcon) as dencueprepat, ".
				"		(SELECT denominacion ".
				"		   FROM scg_cuentas ".
				"		  WHERE codemp=sno_thconcepto.codemp ".
				"		    AND scg_cuentas.sc_cuenta=sno_thconcepto.cueconpatcon) as dencueconpat, ".
				"		(SELECT denestpro1 ".
				"		   FROM spg_ep1 ".
				"		  WHERE spg_ep1.codemp=sno_thconcepto.codemp".
				"		    AND spg_ep1.codestpro1=substr(sno_thconcepto.codpro,1,20)) as denestpro1, ".
				"		(SELECT denestpro2 ".
				"		   FROM spg_ep2 ".
				"		  WHERE spg_ep2.codemp=sno_thconcepto.codemp".
				"		    AND spg_ep2.codestpro1=substr(sno_thconcepto.codpro,1,20) ".
				"		    AND spg_ep2.codestpro2=substr(sno_thconcepto.codpro,21,6)) as denestpro2, ".
				"		(SELECT denestpro3 ".
				"		   FROM spg_ep3 ".
				"		  WHERE spg_ep3.codemp=sno_thconcepto.codemp".
				"		    AND spg_ep3.codestpro1=substr(sno_thconcepto.codpro,1,20) ".
				"		    AND spg_ep3.codestpro2=substr(sno_thconcepto.codpro,21,6) ".
				"		    AND spg_ep3.codestpro3=substr(sno_thconcepto.codpro,27,3)) as denestpro3, ".
				"		(SELECT denestpro4 ".
				"		   FROM spg_ep4 ".
				"		  WHERE spg_ep4.codemp=sno_thconcepto.codemp".
				"		    AND spg_ep4.codestpro1=substr(sno_thconcepto.codpro,1,20) ".
				"		    AND spg_ep4.codestpro2=substr(sno_thconcepto.codpro,21,6) ".
				"		    AND spg_ep4.codestpro3=substr(sno_thconcepto.codpro,27,3) ".
				"		    AND spg_ep4.codestpro4=substr(sno_thconcepto.codpro,30,2)) as denestpro4, ".
				"		(SELECT denestpro5 ".
				"		   FROM spg_ep5 ".
				"		  WHERE spg_ep5.codemp=sno_thconcepto.codemp".
				"		    AND spg_ep5.codestpro1=substr(sno_thconcepto.codpro,1,20) ".
				"		    AND spg_ep5.codestpro2=substr(sno_thconcepto.codpro,21,6) ".
				"		    AND spg_ep5.codestpro3=substr(sno_thconcepto.codpro,27,3) ".
				"		    AND spg_ep5.codestpro4=substr(sno_thconcepto.codpro,30,2) ".
				"		    AND spg_ep5.codestpro5=substr(sno_thconcepto.codpro,32,2)) as denestpro5 ".
				"  FROM sno_thconcepto ".
				" WHERE codemp='".$ls_codemp."'".
		...
		{ 
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_codestpro1=substr($ls_codestpro1,(strlen($ls_codestpro1)-$li_len1),$li_len1);
				$ls_codestpro2=substr($ls_codpro,20,6);
				$ls_codestpro2=substr($ls_codestpro2,(strlen($ls_codestpro2)-$li_len2),$li_len2);
				$ls_codestpro3=substr($ls_codpro,26,3);
				$ls_codestpro3=substr($ls_codestpro3,(strlen($ls_codestpro3)-$li_len3),$li_len3);
				$ls_codestpro4=substr($ls_codpro,29,2);
				$ls_codestpro4=substr($ls_codestpro4,(strlen($ls_codestpro4)-$li_len4),$li_len4);
				$ls_codestpro5=substr($ls_codpro,31,2);
				$ls_codestpro5=substr($ls_codestpro5,(strlen($ls_codestpro5)-$li_len5),$li_len5);
				...
				$ls_dencueprepat=$row["dencueprepat"];
				$ls_dencueconpat=$row["dencueconpat"];
				...
				switch ($as_tipo)
				{
					case "":  // el llamado se hace desde tepuy_sno_d_hconcepto.php
						...
						print "'$ls_repacucon','$ls_repconsunicon','$ls_consunicon','$ls_quirepcon',";
						print "'$ls_asifidper','$ls_asifidpat','$ls_frevarcon');\">".$ls_codconc."</a></td>";
					...
					case "MODIFICAR":  // el llamado se hace desde tepuy_sno_p_hmodificarconcepto.php
						print "<tr class=celdas-blancas>";
						...
						print "'$ls_nombre','$ls_sigcon','$li_sueintvaccon','$li_aplarccon','$li_conprocon','$ls_asifidper','$ls_asifidpat');\">".$ls_codconc."</a></td>";
						print "<td>".$ls_nomcon."</td>";
						print "<td>".$ls_signo."</td>";
						print "<td><input name='txtforcon' type='text' class='sin-borde' id='txtforcon' size='30' maxlength='30' title='".$ls_forcon."' value='".$ls_forcon."'></td>";
						print "</tr>";			
					...
					case "replisconcdes": // el llamado se hace desde tepuy_sno_r_hlistadoconcepto.php
						print "<tr class=celdas-blancas>";
					...
					case "replisconchas": // el llamado se hace desde tepuy_sno_r_hlistadoconcepto.php
						print "<tr class=celdas-blancas>";
					...
					case "repapopat": // el llamado se hace desde tepuy_sno_r_haportepatronal.php
						print "<tr class=celdas-blancas>";
					...
					case "represconcdes": // el llamado se hace desde tepuy_sno_r_hresumenconcepto.php
						print "<tr class=celdas-blancas>";
					...
					case "represconchas": // el llamado se hace desde tepuy_sno_r_hresumenconcepto.php
						print "<tr class=celdas-blancas>";
					...
					case "represconcunides": // el llamado se hace desde tepuy_sno_r_resumenconceptounidad.php
						print "<tr class=celdas-blancas>";
					...
					case "represconcunihas": // el llamado se hace desde tepuy_sno_r_resumenconceptounidad.php
						print "<tr class=celdas-blancas>";
					...
					case "repcuanomdes": // el llamado se hace desde tepuy_sno_r_cuadrenomina.php
						print "<tr class=celdas-blancas>";
					...
					case "repcuanomhas": // el llamado se hace desde tepuy_sno_r_cuadrenomina.php
						print "<tr class=celdas-blancas>";
					...
					case "reppredes": // el llamado se hace desde tepuy_sno_r_hlistadoprestamo.php
						print "<tr class=celdas-blancas>";
					...
					case "repprehas": // el llamado se hace desde tepuy_sno_r_hlistadoprestamo.php
						print "<tr class=celdas-blancas>";
					...
					case "repdetpredes": // el llamado se hace desde tepuy_sno_r_hlistadoprestamo.php
						print "<tr class=celdas-blancas>";
					...
					case "repdetprehas": // el llamado se hace desde tepuy_sno_r_hlistadoprestamo.php
						print "<tr class=celdas-blancas>";
...
function aceptar(codconc,nomcon,titcon,sigcon,forcon,glocon,acumaxcon,valmincon,valmaxcon,concon,cueprecon,cueconcon,aplisrcon,
				 ...
				 repacucon,repconsunicon,consunicon,quirepcon,asifidper,asifidpat,frevarcon)
{
...
function aceptarmodificar(codconc,nomcon,titcon,aplisrcon,sueintcon,intprocon,codestpro1,codestpro2,codestpro3,denestpro1,
						  ...
						  sueintvaccon,aplarccon,conprocon,asifidper,asifidpat)
{
	opener.document.form1.txtcodconc.value="";
	opener.document.form1.txtnomcon.value="";
	opener.document.form1.txttitcon.value="";
	...
	{
		opener.document.form1.chkaplisrcon.checked=true;
		opener.document.form1.chkaplisrcon.disabled=false;
	}
	if(sueintcon=="1")
	{
		opener.document.form1.chksueintcon.checked=true;
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="tepuy_sno_cat_hconcepto.php?tipo=<?php print $ls_tipo;?>";
  	f.submit();
}
</script>
</html>
