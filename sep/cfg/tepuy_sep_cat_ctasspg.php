...
if($ls_operacion=="BUSCAR")
{
	...
	$ls_cadena =" SELECT spg_cuenta,denominacion,status ".
	            " FROM   spg_cuentas ".
		   		" WHERE  codemp = '".$as_codemp."' AND spg_cuenta like '%".$ls_codigo."%' AND ".
				"        denominacion like '%".$ls_denominacion."%'  AND  sc_cuenta like '%".$ls_codscg."%' ".
				" ORDER BY spg_cuenta, denominacion,status ";
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_sep_cat_ctasspg.php";
	  f.submit();
  }
