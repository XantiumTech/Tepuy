...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_detalle($la_data,$ai_i,$ai_totmonsol,&$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-2);
		$la_datatit[1]=array('ficha'=>'<b>Ficha</b>','numsol'=>'<b>Orden de Pago</b>','nombre'=>'<b>Proveedor/Beneficiario</b>','fecemisol'=>'<b>Fecha Emision</b>','denest'=>'<b>Estatus</b>','monsol'=>'<b>Monto '.$ls_titulo.'</b>');
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('ficha'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la columna
						 			   'numsol'=>array('justification'=>'center','width'=>90), // Justificación y ancho de la columna
		...
		else  // Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_totrow;$li_i++)
			{
				...
				$ld_fecemisol=$io_funciones->uf_convertirfecmostrar($ld_fecemisol);
					...
					$la_data[$li_i]=array('ficha'=>$ls_ficha,'numsol'=>$ls_numsol,'nombre'=>$ls_nombre,'fecemisol'=>$ld_fecemisol,'denest'=>$ls_denest,
									  'monsol'=>$li_monsol);
			}
