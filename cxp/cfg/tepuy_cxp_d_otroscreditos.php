...
require_once("class_folder/tepuy_cxp_c_otroscreditos.php");
...
$io_otroscreditos = new tepuy_cxp_c_otroscreditos($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema   = "CXP";
	$ls_ventanas  = "tepuy_cxp_d_otroscreditos.php";
...
if ($ls_operacion=="NUEVO")
   {
	 $ls_codigo=$io_funciondb->uf_generar_codigo($lb_empresa,$ls_codemp,'tepuy_cargos','codcar');
	 if(empty($ls_codigo))
	 {
...
if ($ls_operacion=="ue_guardar")
   {
	 ...
	 if ($lb_existe)
			   ...
			   if ($lb_valfor)
			      {
					...
					$lb_valido = $io_otroscreditos->uf_update_otroscreditos($ls_codemp,$lr_datos,$li_estmodest,$la_seguridad);
				    if ($lb_valido)
					   {
						 $io_sql->commit();
		...
		{  
		  ...
		  if ($lb_valfor)
			 {
			   $lb_valido=$io_otroscreditos->uf_insert_otroscreditos($ls_codemp,$lr_datos,$li_estmodest,$la_seguridad);
			   if ($lb_valido)
				  {
				    $io_sql->commit();
...
if ($ls_operacion=="ELIMINAR")
   {
	  ...
	  if ($lb_existe)
	     {
		   $ls_condicion = " AND (column_name='codcar')";//Nombre del o los campos que deseamos buscar.
	       $ls_mensaje   = "";                           //Mensaje que será enviado al usuario si se encuentran relaciones a asociadas al campo.
	       $lb_tiene     = $io_chkrel->uf_check_relaciones($ls_codemp,$ls_condicion,'tepuy_cargos',$ls_codigo,$ls_mensaje);//Verifica los movimientos asociados a la cuenta  
		   if (!$lb_tiene)
		      {
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
      <table width="651" height="268" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td width="636" height="266"><div align="center">
            <table width="580"  border="0" align="center" class="formato-blanco" cellpadding="0" cellspacing="0">
              <tr>
              ...
              <tr>
                <td height="22" align="right">% / 100 (Use Decimales)</td>
                <td height="22" colspan="2"><input name="txtporcentaje" type="text" id="txtporcentaje" onKeyPress="return keyRestrict(event,'1234567890.');" value="<?php print $ld_porcentaje ?>" style="text-align:right">                </td>
              </tr>
			  <?php 
			     $ls_confiva="";
			     $ls_valido=$io_otroscreditos->uf_select_configuracion_iva($ls_codemp,&$ls_confiva);
              ...
              <tr>
                ...
                <td width="320" height="22"><input name="txtcodestpro"      type="text" id="txtcodestpro"      style="text-align:center" value="<?php print $ls_codestpro ?>" size="40" maxlength="33" readonly>
              ...
              <tr>
                ...
                <td width="156" height="22"><input name="txtpresupuestaria" type="text" id="txtpresupuestaria" style="text-align:center" value="<?php print $ls_spgcuenta ?>" size="25" maxlength="25" readonly>                </td>
                <td width="320" height="22"><a href="javascript:catalogo_contable();"><img src="../../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a></td>
              </tr>
			  <?php 
			     }
			  ?>
              <tr>
                ...
                <td height="22" colspan="2"><input name="chklibcompras" type="checkbox" class="sin-borde" id="chklibcompras" value="1" checked <?php print $ls_estlibcompras; ?>></td>
              </tr>
              <tr>
...
function ue_nuevo()
{
  ...
  if (li_incluir==1)
	 {	
	   ...
	   f.action="tepuy_cxp_d_otroscreditos.php";
	   f.submit();
	}
  else
	{
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
  	     f.operacion.value="";			
	     pagina="tepuy_cxp_cat_creditos.php?confiva="+confiva;
...
function uf_editor()
 {
   ...
   window.open("class_tepuy_formulas.php?txtformula="+formula,"catalogo","menubar=no,toolbar=no,scrollbars=no,width=560,height=270,resizable=yes,location=no");
 }
...
{
	pagina="tepuy_cxp_cat_scgcuentas.php";  
	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=700,height=600,resizable=yes,location=no");
}
