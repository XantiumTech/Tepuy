<?php
	...
	$oi_fun_integrador->uf_load_seguridad("SOC","tepuy_mis_p_reverso_anula_soc.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
function ue_procesar()
{
	...
	{	
		...
		if(lb_valido)
		{
			...
			f.action="tepuy_mis_p_reverso_anula_soc.php";
			f.submit();
		}
		else
		{
