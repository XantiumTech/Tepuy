...
<form name="form1" method="post" action="">
  ...
  <br>
	 <table width="539" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        <td height="22">&nbsp;</td>
        <td height="22"><input name="hiddeducible" type="hidden" id="hiddeducible"></td>
        <td height="22">&nbsp;</td>
        <td height="22">&nbsp;</td>
      </tr>
      <tr>
        ...
        <td width="220" height="22"><a href="javascript: uf_agregar(document.form1.txtvar.value)"><img src="../../shared/imagebank/tools15/aprobado.png" alt="Agregar" width="15" height="15" border="0"></a></td>
      ...
      <tr>
        ...
        <td height="22"><a href="javascript: uf_agregar(document.form1.select3.value)"><img src="../../shared/imagebank/tools15/aprobado.png" alt="Agregar" width="15" height="15" border="0"></a></td>
        <td height="22">&nbsp;</td>
      </tr>
      <tr>
        ...
        <td height="22"><a href="javascript: uf_agregar(document.form1.txtvalor.value)"><img src="../../shared/imagebank/tools15/aprobado.png" alt="Agregar" width="15" height="15" border="0"></a></td>
        <td height="22">&nbsp;</td>
      </tr>
      <tr>
        ...
        <td height="22" colspan="3"><input name="txtformula" type="txtformula" value="<?php print $ls_formula;?>" size="70" maxlength="70" onChange="javascript:this.value=this.value.toUpperCase();">
          <a href="javascript: uf_blanqueo()"><img src="../../shared/imagebank/tools15/actualizar.png" alt="Blanquear" width="15" height="15" border="0"></a></td>
      </tr>
      <tr>
        ...
        <td height="22" colspan="4"><div align="center">
          <table width="306" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
            <tr>
              ...
              <td width="135"><a href="javascript: uf_verificar();"><img src="../../shared/imagebank/tools20/aprobado-off.png" alt="Verificar" width="20" height="20" border="0">Probar Fórmula</a></td>
              <td width="119"><a href="javascript: uf_volver();"><img src="../../shared/imagebank/tools20/deshacer.png" alt="Volver" width="20" height="20" border="0">Retornar Fórmula</a></td>
              <td width="25">&nbsp;</td>
            </tr>
          </table>
        </div></td>
  ...
  if ((ld_monto_prueba!="")&&(ls_formula!=""))
     {
       ...
       f.action="class_tepuy_formulas.php";
       f.submit(); 
	 }
  else
     {
