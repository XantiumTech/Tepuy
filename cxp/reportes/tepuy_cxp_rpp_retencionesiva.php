<?PHP
	...
	function uf_print_encabezadopagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addText(240,555,15,"<b>".$as_titulo."</b>"); // Agregar el t�ulo
// pie de pagina articulo de retencion de IVA
	...
	$as_pie='BASE LEGAL: LEY DEL I.V.A. (ARTICULO 11). ';
	$as_pie1='LA ADMINISTRACION TRIBUTARIA PODRA DESIGNAR COMO RESPONSABLE DEL PAGO DEL IMPUESTO, EN CALIDAD DE AGENTE DE RETENCION, A QUIENES ';
	$as_pie2='POR SUS FUNCIONES PUBLICAS O POR RAZON DE SUS ACTIVIDADES PRIVADAS INTERVENGAN EN OPERACIONES GRAVADAS CON EL IMPIESTO ESTABLECIDO EN ESTA LEY.';
	$io_pdf->Rectangle(50,50,892,28);	
		$io_pdf->addText(52,65,9,"<b>".$as_pie."</b>".$as_pie1); // Agregar el t�ulo
		$io_pdf->addText(52,55,9,$as_pie2); // Agregar el t�ulo
		$io_pdf->restoreState();
		$io_pdf->closeObject();
