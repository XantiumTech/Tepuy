...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_concurso.js"></script>
...
<table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
  ...
  <tr>
    ...
    <td width="171"><div align="right"><a href="javascript: Limpiar_busqueda(); "> <img src="../../../public/imagenes/nuevo.png" alt="Limpiar" width="15" height="15" border="0">Limpiar</a></div></td>
    <td width="206"><div align="right"><a href="javascript: Buscar()"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Haga click aqu&iacute; para Buscar</a></div></td>
  </tr>
</table>
    ...
    function catalogo_cargo()
{
	   ...
	   ls_cargo = f.txtcodcar.value;			
			...
			pagina="tepuy_srh_cat_cargos.php";
		...
		var loadDataURL = "../../php/tepuy_srh_a_concurso.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_concurso.php";
  ...
  function Buscar()
		{
		 ...
		 if (document.form1.comboestatus.value=="--Seleccione--") 
		 {
		  ...
		  estatus="";
		  mygrid.loadXML("../../php/tepuy_srh_a_concurso.php?valor=buscar"+"&txtcodcon="+codcon+"&txtdescon="+descon+"&txtfechaaper="+fechaaper+"&txtfechacie="+fechacie+"&comboestatus="+estatus+"&txttipo="+tipo+"&hidtipo="+hidtipo);//// modificado el 28/02/2008ç
		  ...
		  divResultado = document.getElementById('mostrar');
		  divResultado.innerHTML= img; 		  
		  mygrid.loadXML("../../php/tepuy_srh_a_concurso.php?valor=buscar"+"&txtcodcon="+codcon+"&txtdescon="+descon+"&txtfechaaper="+fechaaper+"&txtfechacie="+fechacie+"&comboestatus="+estatus+"&txttipo="+tipo+"&hidtipo="+hidtipo); //// modificado el 28/02/2008
		  setTimeout (terminar_buscar,500);
	  }
