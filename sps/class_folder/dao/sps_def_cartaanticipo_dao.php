...
class sps_def_cartaanticipo_dao extends class_dao
{
  ...
  {	
  	  ...
  	  //$ls_directorio = "C:\Documents and Settings\Maria Alejandra Roa\Escritorio\Barquisimeto.rtf";
  	  //print "DIR:".$ls_directorio;
  	  //$ls_arcrtfcarant=$HTTP_POST_FILES[$po_object->arcrtfcarant]['name'];
  	  //print "ERR:".$ls_arcrtfcarant;
