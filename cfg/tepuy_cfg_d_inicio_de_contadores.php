...
require_once("class_folder/tepuy_cfg_c_inicio_contadores.php");
...
/////////////////////////////////////////////////////////////////////////////
$io_contadores = new tepuy_cfg_c_inicio_contadores($conn);
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "CFG";
	$ls_ventanas = "tepuy_cfg_d_inicio_de_contadores.php";
...
{
	 $ls_id=$io_funciondb->uf_generar_codigo($lb_empresa,$ls_codemp,'tepuy_ctrl_numero','id');
	 if(empty($ls_id))
	 {
	 ...
	 {//4 			   
		  ...
		  $object[$i][7]="<a href=javascript:uf_actualizar(".$i.");><img src=../shared/imagebank/tools20/aprobado.png alt=Aceptar width=15 height=15 border=0></a>";
	}
	$total=2;	
}
//----------------------------------------------------------------------------------------------------------------------------------
  ...
  <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td height="22"><label>
          ...
          <a href="javascript:uf_catalogo_sistemas();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
      ...
      <tr> 
        ...
        <td height="22"><p>
          ...
          <a href="javascript:uf_catalogo_procede();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
	...
	if (((lb_status=="GRABADO")&&(li_cambiar==1))||(lb_status=="NUEVO")&&(li_incluir==1))
	{
		...
		if(tildados>0)
		{
			...
			else
			{
				 ...
				 f.action="tepuy_cfg_d_inicio_de_contadores.php";
				 f.submit();
			}
		}	
	}
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
	     f.operacion.value="";			
		 pagina="tepuy_cfg_cat_contadores.php";
...
function uf_catalogo_sistemas()
{
	...
	f.txtprocede.value="";
	f.txtdenpro.value="";
	pagina="tepuy_cfg_cat_sistemas_contadores.php";
	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no");
}
function uf_catalogo_procede()
{
	...
	{
		pagina="tepuy_cfg_cat_procede_contadores.php?codsis="+codsis;
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no");
	}	
}
</script>
