...
class tepuy_snorh_c_ct_met
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_snorh_c_ct_met()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_snorh_c_profesion
		//		   Access: public (tepuy_snorh_d_ct_met)
	...
	}// end function tepuy_snorh_c_ct_met
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------------------------------------------------------------------		
	function uf_insert_ct($as_codigo,$as_denominacion,$ad_valor,$as_metcestic,$as_codcli,$as_codprod,$as_punent,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="INSERT INTO sno_cestaticket(codemp, codcestic, dencestic, moncestic, metcestic, codcli, codprod, punent)". 
			    "     VALUES ('".$this->ls_codemp."','".$as_codigo."','".$as_denominacion."',".$ad_valor.",".$as_metcestic.",".
				"			  '".$as_codcli."','".$as_codprod."','".$as_punent."')";
	...
	//-----------------------------------------------------------------------------------------------------------------------------------		
	function uf_update_ct($as_codigo,$as_denominacion,$ad_valor,$as_metcestic,$as_codcli,$as_codprod,$as_punent,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_insert_ct
		//		   Access: private
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_guardar($as_existe,$as_codigo,$as_denominacion,$ad_valor,$as_metcestic,$as_codcli,$as_codprod,$as_punent,$aa_seguridad)
	{		
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_guardar
		//		   Access: public (tepuy_snorh_d_ct_met)
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_load_ct(&$as_existe,&$as_codigo,&$as_denominacion,&$ai_valor,&$as_cmbmet,&$as_codcli,&$as_codprod,&$as_punent)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_load_ct
		//		   Access: public (tepuy_snorh_d_ct_met)
