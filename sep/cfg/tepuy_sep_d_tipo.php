...
$io_tipo      = new tepuy_sep_c_tipo($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SEP";
	$ls_ventanas = "tepuy_sep_d_tipo.php";
...
{           
     ...
     {   		  
		     if($ls_estatus=="NUEVO")
		     {
			   $io_msg->message("Este Código de Tipo de SEP ya existe !!!");  
			   $lb_valido=false;
			 }
		     elseif($ls_estatus=="GRABADO")
		     {			 
				    $lb_valido=true;				   					
				    if( ($esttip=="B") || ($esttip=="S") || ($esttip=="O"))
				    {
						 ...
						 if($io_tipo->uf_validar_insert($esttip,$afepre))
						 {
                                                 if($esttip=="B")
									  {
										  ...
										  $io_msg->message("El Tipo de Ejecución Presupuestaria No será Guardado");
										  $lb_valido=false;
									  }elseif($esttip=="S")
									  {
					...
					{												
						  if( (($esttip=="B")&&($afepre=="O")) || (($esttip=="S")&&($afepre=="O")) )
				           {
   							    $io_msg->message("Los Bienes o Servicios solo pueden tener Afectación Presupuestaria de tipo Precompromiso o Sin Afectacion");
							    $io_msg->message("El Tipo de Ejecución Presupuestaria No será Guardado");
						   }
						   else
						   {					 			 			 
								   $lb_valido=$io_tipo->uf_update_tiposep($ls_codigo,$ls_denominacion,$afepre,$esttip,$la_seguridad);
								   if ($lb_valido)
									  {
	 ...
	 {   
		...
		{								
			 ...
			 {
				$lb_valido=$io_tipo->uf_insert_tiposep($ls_codigo,$ls_denominacion,$afepre,$esttip,$la_seguridad);
				if ($lb_valido)
				{
...
<table width="631" height="198" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  <tr>
    <td width="629" height="161"><div align="center">
      <table width="572" height="154"  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
        ...
        <tr>
          ...
          <td height="22" colspan="3" ><input name="txtcodigo" type="text" id="txtcodigo" value="<?php print $ls_codigo ?>" size="5" maxlength="2" onKeyPress="return keyRestrict(event,'1234567890');" onBlur="javascript:rellenar_cad(this.value,2)" style="text-align:center ">
              <input name="operacion" type="hidden" class="formato-blanco" id="operacion2"  value="<?php print $ls_operacion?>">          </td>
        </tr>
        <tr>
	    ...
	    ?>
            <input name="afepre" type="radio" value="R" checked <?php print $ls_afeprepre ?>>
      Precompromiso</td>
          <td height="22"><input name="afepre" type="radio" value="O" <?php print $ls_afeprecom ?>>
      Compromiso</td>
          <td height="22"><input name="afepre" type="radio" value="S" <?php print $ls_afepresin ?>>
          Sin Afectacion</td>
        </tr>
        <tr>
      ...
      Servicios</td>
          <td width="170" height="22"><input name="esttip" type="radio" value="O" <?php print $ls_esttipotr ?>>
      Otros</td>
        </tr>
        <tr>
          <td height="22">&nbsp;</td>
