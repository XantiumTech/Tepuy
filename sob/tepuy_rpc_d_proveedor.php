...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SOC";
	$ls_ventanas = "tepuy_rpc_d_proveedor.php";
 ...
 <p>&nbsp;  </p>
   ...
   <table width="770"  border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
    <tr class="titulo-celdanew">
      <td height="12" colspan="5" class="titulo-celdanew">Datos B&aacute;sicos del Proveedor </strong></font></td>
    </tr>
    <tr>
      <td height="12">&nbsp;</td>
...
function uf_socio(prov)
{
  ...
  if (prov=="")
   ...
   else
      {
		...
		pagina="tepuy_rpc_d_socio.php?txtprov="+prov +"&txtnombre="+ls_nomprov;
...
function uf_documento(prov)
{
   ...
   if (prov=="")
      ...
      {
        ls_nomprov=f.txtnombre.value;
		pagina="tepuy_rpc_w_proxdoc.php?txtprov="+prov +"&txtnombre="+ls_nomprov;
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=500,resizable=yes,location=no");
	  }	
}
...
function uf_clasificacion(prov)
{
 ...
 if (prov=="")
    ...
    {
      ls_nomprov=f.txtnombre.value;
	  pagina="tepuy_rpc_w_proxcla.php?txtprov="+prov +"&txtnombre="+ls_nomprov;
...
function uf_especialidad(prov)
{
 ...
 if (prov=="")
      ...
      {
 	    ls_nomprov=f.txtnombre.value;
		pagina="tepuy_rpc_w_proxesp.php?codprov="+prov +"&nomprov="+ls_nomprov;
									                                         ...
									                                         {//29
																				if((f.chkestpro.checked==false)&&(f.chkestcon.checked==false))
																				{
																				 ...
																				 {//29
																				   ...
																				   f.action="tepuy_rpc_d_proveedor.php";
																				   f.submit();
																				  }		  
										                                     }//29
									                                    }//27
...
/*Function:  ue_buscar()
    ...
    function ue_buscar()
    {
		...
		{
			f.operacion.value="";			
			pagina="tepuy_rpc_cat_proveedores.php";
