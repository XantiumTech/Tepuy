...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_incdesinc.php",$ls_permisos,$la_seguridad,$la_permisos);
      ...
      <td height="22" colspan="3" align="center"><div align="left" class="style14">
        ...
        <tr>
          ...
          <td width="418" height="22"><div align="left">
              ...
              <a href="javascript:uf_catalogo_activo('txtcoddesde','txtdendesde');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a> 
        ...
        <tr>
          ...
          <td height="22"><div align="left">
              ...
              <a href="javascript:uf_catalogo_activo('txtcodhasta','txtdenhasta');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
              ...
              <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                ...
                <tr>
                  ...
                  <td height="22"><input name="txtcoduni" type="text" id="txtcoduni" size="15"  style="text-align:center" readonly>
                      <a href="javascript: uf_unidad();"><img src="../shared/imagebank/tools15/buscar.png" alt="BUSCAR" width="15" height="15" border="0"></a>
                ...
                <tr>
                  ...
                  <td height="22"><input name="txtcodunidep" type="text" id="txtcodunidep" size="15"  style="text-align:center" readonly>
                      <a href="javascript: uf_dependencia('unidep');"><img src="../shared/imagebank/tools15/buscar.png" alt="BUSCAR" width="15" height="15" border="0"></a>
              ...
              <table width="497" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
                ...
                <tr>
                  ...
                  <td><input name="txtcodgru" type="text" id="txtcodgru" size="21" maxlength="20"  style="text-align:center ">
                      <a href="javascript:uf_catalogo_grupo('txtcodgru','txtdengru');"><img src="../shared/imagebank/tools15/buscar.png" alt="BUSCAR" width="15" height="15" border="0"></a>
                      <input name="txtdengru" type="text" class="sin-borde" id="txtdengru" size="40" readonly></td>
                </tr>
                <tr>
                  ...
                  <td><input name="txtcodsubgru" type="text" id="txtcodsubgru" size="21" maxlength="20"  style="text-align:center ">
                      <a href="javascript:uf_catalogo_subgrupo('txtcodsubgru','txtdensubgru');"><img src="../shared/imagebank/tools15/buscar.png" alt="BUSCAR" width="15" height="15" border="0"></a>
                      <input name="txtdensubgru" type="text" class="sin-borde" id="txtdensubgru" size="40" readonly></td>
                <tr>
                  ...
                  <td><input name="txtcodsec" type="text" id="txtcodsec" size="21" maxlength="20"  style="text-align:center ">
                      <a href="javascript:uf_catalogo_seccion('txtcodsec','txtdensec');"><img src="../shared/imagebank/tools15/buscar.png" alt="BUSCAR" width="15" height="15" border="0"></a>
                      <input name="txtdensec" type="text" class="sin-borde" id="txtdensec" size="40" readonly></td>
                </tr>
              </table>
            </div>    
        </div>
...
<script language="JavaScript">
	...
	{
		window.open("tepuy_saf_cat_activo.php?coddestino="+ ls_coddestino +"&dendestino="+ ls_dendestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,left=120,top=70,location=no,resizable=yes");
	}
	
	function uf_resprimario(ls_destino)
	{
		window.open("tepuy_saf_cat_personal.php?destino="+ ls_destino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,left=120,top=70,location=no,resizable=yes");
	}
	
	function uf_unidad(ls_destino)
	{
		window.open("tepuy_saf_cat_unidad.php?destino="+ ls_destino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,left=120,top=70,location=no,resizable=yes");
	}
	
	function uf_dependencia(ls_destino)
	{
		window.open("tepuy_saf_cat_unidad_srvdep.php?destino="+ ls_destino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,left=120,top=70,location=no,resizable=yes");
	}
	
			function uf_catalogo_grupo(ls_codgrupo,ls_dengrupo)
	{
		window.open("tepuy_saf_cat_grupo.php?txtcodgru="+ ls_codgrupo+"&txtdengru="+ls_dengrupo+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
	}
	
			function uf_catalogo_subgrupo(ls_codsubgrupo,ls_densubgrupo)
	{
		window.open("tepuy_saf_cat_subgrupo.php?txtcodsubgru="+ ls_codsubgrupo +"&txtdensubgru="+ ls_densubgrupo +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
	}
	
			function uf_catalogo_seccion(ls_codseccion,ls_denseccion)
	{
		window.open("tepuy_saf_cat_seccion.php?txtcodsec="+ ls_codseccion +"&txtdensec="+ ls_denseccion +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
	}
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				window.open("reportes/tepuy_saf_rpp_incdesinc.php?coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&codgru="+ls_grupo+"&codsubgru="+ls_subgrupo+"&codsec="+ls_seccion+"&coduniadm="+ls_coduniadm+"&denuniadm="+ls_denuniadm+"&tipoformato="+tipoformato+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="tepuy_siv_r_incdesinc.php";
				//f.submit();
			}
			else
