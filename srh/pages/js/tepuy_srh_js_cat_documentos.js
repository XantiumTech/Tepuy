var url= "../../php/tepuy_srh_a_documentos.php";
var metodo='get';
var img="<img src=\"../../../public/imagenes/progress.gif\"> ";


var loadDataURL = "../../php/tepuy_srh_a_documentos.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_documentos.php";
var mygrid;
...
function Buscar()
{
	 ...
	 mygrid.loadXML("../../php/tepuy_srh_a_documentos.php?valor=buscar"+"&txtnrodoc="+nrodoc+"&txtdendoc="+dendoc+"&txtcodtipdoc="+tipdoc);
...
function catalogo_tipocontrato()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_tipodocumentos.php?valor_cat=1";
...
function catalogo_tipodocumento()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_tipodocumento.php?valor_cat=0";
