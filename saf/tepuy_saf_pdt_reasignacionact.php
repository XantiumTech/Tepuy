  ...
  <table width="502" border="0" align="center" class="formato-blanco">
    ...
    <tr>
      ...
      <td colspan="3"><input name="txtcoduni" type="text" id="txtcoduni" style="text-align:center " value="<?php print $ls_coduninew ?>" readonly>
        <a href="javascript: ue_cataunidad();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
    ...
    <tr>
      ...
      <td colspan="3"><input name="txtcodresnew" type="text" id="txtcodresnew" style="text-align:center " value="<?php print $ls_codresnew ?>" readonly>
        <a href="javascript: ue_catapersonal();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
    ...
    <tr>
      ...
      <td colspan="3"><input name="txtsccuenta" type="text" id="txtsccuenta" value="<?php print $ls_sccuenta ?>" style="text-align:center "></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="105"><a href="javascript: ue_agregar();"><img src="../shared/imagebank/tools15/aprobado.png" width="15" height="15" class="sin-borde">Agregar Detalle</a> </td>
      <td width="74"><a href="javascript: ue_cancelar();"><img src="../shared/imagebank/tools15/eliminar.png" width="15" height="15" class="sin-borde">Cancelar</a></td>
    </tr>
  </table>
</form>
</body>
...
{
	ls_estact="IM";
	window.open("tepuy_saf_cat_codactivo.php?estact="+ls_estact+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=630,height=400,left=50,top=50,location=no,resizable=yes");
}

function ue_cataunidad()
{
	f=document.form1;
	ls_sccuenta=f.txtsccuenta.value;
	if(ls_sccuenta!="")
	{
		window.open("tepuy_catdinamic_unidad.php?submit='1'","_blank","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
...
{
	window.open("tepuy_cat_personalnuevo.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,left=50,top=50,location=no,resizable=yes");
}
