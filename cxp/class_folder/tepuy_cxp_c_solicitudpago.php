...
/*			$this->io_rcbsf->io_ds_datos->insertRow("campo","monsolaux");
	...
	function uf_select_ndnc($as_numsol,$as_numrecdoc,$as_codtipdoc,$as_cedbene,$as_codpro)
	{
		...
		//		   Access: private
		//	    Arguments: as_numsol    //  Número de Solicitud
		//				   as_numrecdoc // Número de Recepcion de documentos
		//				   as_codtipdoc // Código de tipo de documento
		...
		//	   Creado Por: Ing. Miguel Palencia
		// Fecha Creación: 28/04/2008 								Fecha Última Modificación : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_existe=true;
		$ls_sql="SELECT numdc ".
				"  FROM cxp_sol_dc ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Solicitud MÉTODO->uf_select_ndnc ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
			$lb_existe=false;
		}
		else
		{
