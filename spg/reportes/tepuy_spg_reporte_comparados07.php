...
/****************************************************************************************************************************************/	
class tepuy_spg_reporte_comparados07
{
    //conexion	
	var $sqlca;   
	...
	var $dts_prog;
/****************************************************************************************************************************************/	
    function  tepuy_spg_reporte_comparados07()
    {
		...
		$this->tepuy_int_spg=new class_tepuy_int_spg();
		$this->io_spg_report_funciones=new tepuy_spg_funciones_reportes();
    }
/****************************************************************************************************************************************/
	///////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$lb_valido=$this->uf_spg_reporte_select_proyecto($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,
											         ...
											         $as_codestpro4_des,$as_codestpro5_des,$as_estcla,$as_codfuefindes,
													 $as_codfuefinhas);
	if($lb_valido)
	{
	 $lb_valido = true;	 
	 ...
	 for($z=1;$z<=$li_total;$z++)
	 {
		...
		$ls_codestpro4=$as_codestpro4_ori;
		$ls_codestpro5=$as_codestpro5_ori;
	...
	/*	$ls_sql=" SELECT c.spg_cuenta, c.nivel, max(c.denominacion) as denominacion, sum(c.asignado) as asignado, ".
		...
		$ls_sql=" SELECT C.spg_cuenta, C.nivel, max(C.denominacion) as denominacion, ".
			    ...
			    " WHERE  P.codemp='".$ls_codemp."' AND R.codrep='0705' AND R.status <> 'I' AND ".
							  ...
							  $lb_valido=$this->uf_spg_reporte_calcular_programado($li_mesdes,$li_meshas-1,$ld_monto_programado_ant,
								...
								{   
									...
									$lb_valido=$this->uf_spg_reporte_calcular_ejecutado_meses($ls_spg_cuenta,$li_mesdes,$ls_estructura_desde,
																	...
																	$ld_causado,$ld_pagado,$ls_tipo,$lb_pasar,
																	$as_codfuefindes,$as_codfuefinhas);
								}//if		
								if($lb_valido)
								{	
...
/****************************************************************************************************************************************/	
    function uf_spg_reportes_comparados_forma0705_acciones($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,
											               $as_codestpro5_ori,$as_codestpro1_des,$as_codestpro2_des,$as_codestpro3_des,
											               $as_codestpro4_des,$as_codestpro5_des,$as_combomes,$as_cant_mes,$as_estcla,
														   $as_codfuefindes,$as_codfuefinhas)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$lb_valido=$this->uf_spg_reporte_select_proyecto($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,
											         $as_codestpro5_ori,$as_codestpro1_des,$as_codestpro2_des,$as_codestpro3_des,
											         $as_codestpro4_des,$as_codestpro5_des,$as_estcla,
													 $as_codfuefindes,$as_codfuefinhas);
	if($lb_valido)
	{
	 $lb_valido = true;	 
...
/****************************************************************************************************************************************/
   ...
   /*  $ls_sql=" SELECT  distinct ".$ls_cadena." as programatica ".
			 ...
			 "	      P.codemp='".$ls_codemp."'  AND EP.codfuefin BETWEEN '".$as_codfuefindes."' AND '".$as_codfuefinhas."' AND      R.status <> 'I' AND  C.codemp=R.codemp AND R.codemp=P.codemp AND  ".
	...
	// print $ls_sql;
	 ...
	 {
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->tepuy_spg_class_report MÉTODO->uf_spg_reporte_select_proyecto ERROR->".$this->fun->uf_convertirmsg($this->SQL->message));
	 }
	else
	{
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    02/06/2006          Fecha última Modificacion :      Hora :
	  ...
	  if($ab_pasar)
	  {
		  ...
		  $as_spg_cuenta=$this->tepuy_int_spg->uf_spg_cuenta_sin_cero($as_spg_cuenta)."%";
	 ...
	 else
	 {
		  ...
		  {
			  $ls_tabla="spg_ep3"; 
			  $ls_cadena_fuefin="AND DT.codestpro1=EP.codestpro1 AND DT.codestpro2=EP.codestpro2 AND DT.codestpro3=EP.codestpro3";
	      }
		  elseif($li_estmodest==2)
		  {
			  $ls_tabla="spg_ep5";
			  $ls_cadena_fuefin=" AND DT.codestpro1=EP.codestpro1 AND DT.codestpro2=EP.codestpro2 AND DT.codestpro3=EP.codestpro3 AND ".
								"	  DT.codestpro4=EP.codestpro4 AND DT.codestpro5=EP.codestpro5";
		  } 
	 ...
	 // Fecha Creación :    14/06/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql=" SELECT c.spg_cuenta, c.nivel, max(c.denominacion) as denominacion, sum(c.asignado) as asignado, ".
                ...
                "        c.codestpro2=r.codestpro2 AND c.codestpro3=r.codestpro3 AND c.codestpro4=r.codestpro4 AND ".
                "        c.codestpro5=r.codestpro5) AND (c.spg_cuenta = r.spg_cuenta) AND (r.status <> 'I') ".
                " GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, ".
				"          c.codestpro5  ".
                " ORDER  BY c.spg_cuenta ";
        $rs_data=$this->SQL->select($ls_sql);
		...
		{		
			...
			while($row=$this->SQL->fetch_row($rs_data))
			{
				   ...
				   {	
					 ...
					 $lb_valido=$this->uf_spg_reporte_calcular_programado_r($ls_codrep,$ls_spg_cuenta,$ls_estructura_desde,
					                                                        $ls_estructura_hasta,$li_mesdes,$li_meshas,
	                                                                        $ld_monto_programado,$ld_monto_programado_acum,$ls_forma);
					  if($lb_valido)
					  {//calculo el reprogramción del proximo mes 
						   $ld_monto_progracum_ant=0;
						   $ld_monto_programado_ant=0;
...
/****************************************************************************************************************************************/
	...
	//   CLASE REPORTES SPG  COMPARADOS " RESUMEN DEL PRESUPUESTO DE GASTOS POR PARTIDAS FORMA #0704 "  //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_distribucion_ingresos($ai_nivel)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_comparados_forma0704
	 //         Access :	private
	 //     Argumentos :    $as_trimestres // rango del trimestre
	 ...
	 // Fecha Creación :    14/06/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_gestor = $_SESSION["ls_gestor"];
		$ls_codemp = $this->dts_empresa["codemp"];
		$this->dts_cab->resetds("spi_cuenta");
		$this->dts_reporte->resetds("spi_cuenta");
		if($ai_nivel==1)
		{
			$agrupa=" GROUP BY c.spi_cuenta, c.nivel  ";
			$nivelmas=" WHERE  c.nivel=1";
			$hasta=3;
		}
		if($ai_nivel==2)
		{
			$nivelmas=" WHERE  c.nivel=1 OR c.nivel=2 ";
			//$agrupa=" GROUP BY c.spg_cuenta, c.nivel ";
			$agrupa=" GROUP BY c.spi_cuenta, c.nivel  ";
			$hasta=5;
		}
		if($ai_nivel==3)
		{
			$nivelmas=" WHERE  c.nivel=1 OR c.nivel=2 OR c.nivel=3 ";
			//$agrupa=" GROUP BY c.spg_cuenta, c.nivel ";
			$agrupa=" GROUP BY c.spi_cuenta, c.nivel  ";
			$hasta=7;
		}
		if($ai_nivel==4)
		{
			$nivelmas=" WHERE  c.nivel=1 OR c.nivel=2 OR c.nivel=3 OR c.nivel=4 ";
			//$agrupa=" GROUP BY c.spg_cuenta, c.nivel ";
			$agrupa=" GROUP BY c.spi_cuenta, c.nivel  ";
			$hasta=9;
		}
		$ls_sql=" SELECT c.spi_cuenta, c.nivel, max(c.denominacion) as denominacion, sum(c.previsto) as previsto, ".
                "        sum(c.aumento) as aumento, sum(c.disminucion) as disminucion, sum(c.enero) as enero, ".
                "        sum(c.febrero) as febrero, sum(c.marzo) as marzo, sum(c.abril) as abril, sum(c.mayo) as mayo, ".
                "        sum(c.junio) as junio, sum(c.julio) as julio, sum(c.agosto) as agosto, sum(c.septiembre) as septiembre,".
                "        sum(c.octubre) as octubre, sum(c.noviembre) as noviembre, sum(c.diciembre) as diciembre ".
...
///
		if($rs_data===false)
		   {
			  $lb_valido=false;
			 $this->is_msg_error="Error en consulta metodo uf_spg_reportes_distribucion_partidas".$this->fun->uf_convertirmsg($this->SQL->message);
		   }
		   else
		   {
			   if($row=$this->SQL->fetch_row($rs_data))
			   ...
			   $li_total_row=$dts_disponible->getRowCount("spi_cuenta");
			   for ($li_i=1;$li_i<=$li_total_row;$li_i++)

				{
				   	$ls_spg_cuenta = $dts_disponible->getValue("spi_cuenta",$li_i);
					//print $ls_spg_cuenta;
					$ls_denominacion = $dts_disponible->getValue("denominacion",$li_i);
				   	$li_nivel = $dts_disponible->getValue("nivel",$li_i);
				   	$ld_asignado = $dts_disponible->getValue("previsto",$li_i);

				   	$ld_aumento=$dts_disponible->getValue("aumento",$li_i);
				   	$ld_disminucion=$dts_disponible->getValue("disminucion",$li_i);
				   	$ld_enero=$dts_disponible->getValue("enero",$li_i);
				   	$ld_febrero=$dts_disponible->getValue("febrero",$li_i);
				   	$ld_marzo=$dts_disponible->getValue("marzo",$li_i);
				   	$ld_abril=$dts_disponible->getValue("abril",$li_i);
				   	$ld_mayo=$dts_disponible->getValue("mayo",$li_i);
				   	$ld_junio=$dts_disponible->getValue("junio",$li_i);
				   	$ld_julio=$dts_disponible->getValue("julio",$li_i);
				   	$ld_agosto=$dts_disponible->getValue("agosto",$li_i);
				   	$ld_septiembre=$dts_disponible->getValue("septiembre",$li_i);
				   	$ld_octubre=$dts_disponible->getValue("octubre",$li_i);
				   	$ld_noviembre=$dts_disponible->getValue("noviembre",$li_i);
				   	$ld_diciembre=$dts_disponible->getValue("diciembre",$li_i);
					
						$this->dts_reporte->insertRow("spi_cuenta",$ls_spg_cuenta);
						$this->dts_reporte->insertRow("denominacion",$ls_denominacion);
						$this->dts_reporte->insertRow("asignado",$ld_asignado);					 
						$this->dts_reporte->insertRow("nivel",$li_nivel);
     ...
     return $lb_valido;
    }//fin uf_spg_reportes_distribucion_ingresos
/****************************************************************************************************************************************/
...
/****************************************************************************************************************************************/
	...
	//   CLASE REPORTES SPG  COMPARADOS " RESUMEN DEL PRESUPUESTO DE GASTOS POR PARTIDAS FORMA #0704 "  //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_distribucion_partidas($as_combomes,$ai_nivel,$as_cant_mes)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_comparados_forma0704
	 //         Access :	private
	 //     Argumentos :    $as_trimestres // rango del trimestre
	 ...
	 // Fecha Creación :    14/06/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($ai_nivel==1)
		{
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, c.codestpro5  ";
			$nivelmas=" WHERE  c.nivel=1";
			$hasta=3;
		}
		if($ai_nivel==2)
		...
		if($ai_nivel==5)
		{
			$nivelmas=" WHERE  c.nivel=1 OR c.nivel=2 OR c.nivel=3 OR c.nivel=4 OR c.nivel=5 ";
			//$agrupa=" GROUP BY c.spg_cuenta, c.nivel ";
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, c.codestpro5  ";
			$hasta=13;
		}
...
///
		   ...
		   else
		   {
			   ...
			   for ($li_i=1;$li_i<=$li_total_row;$li_i++)

				{
					...
					$ls_spg_cuenta_next = $dts_disponible->getValue("spg_cuenta",$h);
					//}//if
					
					//{
					$ls_denominacion = $dts_disponible->getValue("denominacion",$li_i);
				   	$li_nivel = $dts_disponible->getValue("nivel",$li_i);
				   	$ld_asignado = $dts_disponible->getValue("asignado",$li_i);

					$ld_asignado_acumulado=$ld_asignado_acumulado+$ld_asignado;
				   	$ld_comprometido=$dts_disponible->getValue("comprometido",$li_i);
				   	$ld_causado=$dts_disponible->getValue("causado",$li_i);
				   	$ld_pagado=$dts_disponible->getValue("pagado",$li_i);
				   	$ld_aumento=$dts_disponible->getValue("aumento",$li_i);
				   	$ld_disminucion=$dts_disponible->getValue("disminucion",$li_i);
				   	$ld_enero=$dts_disponible->getValue("enero",$li_i);
				   	$ld_febrero=$dts_disponible->getValue("febrero",$li_i);
					...
					{
						$this->dts_reporte->insertRow("spg_cuenta",substr($ls_spg_cuenta,0,$hasta));
						$this->dts_reporte->insertRow("denominacion",$ls_denominacion);
						$this->dts_reporte->insertRow("asignado",$ld_asignado_acumulado);
						$this->dts_reporte->insertRow("monto_programado",$ld_monto_programado);
						$this->dts_reporte->insertRow("monto_acumulado",$ld_monto_programado_acum);
						$this->dts_reporte->insertRow("aumdis_mes",$ld_aumdismes);
						$this->dts_reporte->insertRow("aumdis_acumulado",$ld_aumdisacum);
     ...
     return $lb_valido;
    }//fin uf_spg_reportes_distribucion_partidas
/****************************************************************************************************************************************/	
...
/****************************************************************************************************************************************/
	...
	//   CLASE REPORTES SPG  COMPARADOS " RESUMEN DEL PRESUPUESTO DE GASTOS POR PARTIDAS FORMA #0704 "  //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_distribucion_inversion($ai_nivel,$as_cuenta_inversion,$as_proyecto,$as_fuente)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_distribucion_inversion
	 //         Access :	private
	 //     Argumentos :    $as_trimestres // rango del trimestre
	 //                     $ai_nivel     //  nivel de la cuenta                
     //	       Returns :	Retorna true o false si se realizo la consulta para el reporte
	 ...
	 // Fecha Creación :    14/06/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$this->dts_reporte->resetds("spg_cuenta");
        	$ls_tipo="O";
		$filtro1="substring(c.spg_cuenta,1,3)=".$as_cuenta_inversion." AND ";
		//$filtro="AND (h.proyecto=".'"'.$as_proyecto.'"'." OR ".$filtro1;
		$filtro=$filtro1;
		$nivel=" (c.nivel=3 OR c.nivel=4 OR c.nivel=5) ";
		//print $ai_nivel;
		if($ai_nivel==0)
		{
			//$menos=" AND c.codestpro1=e.codestpro1 AND c.codestpro2=e.codestpro2 AND c.codestpro3=e.codestpro3 AND c.codestpro4=e.codestpro4 AND c.codestpro5=e.codestpro5 ";
			$menos=" AND (c.codestpro1=h.codestpro1 AND c.codestpro2=h.codestpro2 AND c.codestpro3=h.codestpro3) ";
			//$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, c.codestpro5  ";
			$agrupa=" GROUP BY c.codestpro1, c.codestpro2, c.codestpro3, c.nivel, c.spg_cuenta ";
			$filtro="AND substring(c.spg_cuenta,1,3)=".$as_cuenta_inversion;
			$nivelmas=" WHERE  ".$nivel.$menos.$filtro;
			//$nivelmas=" WHERE  c.spg_cuenta=4040000000000 ";
			$hasta=3;
		}
		if($ai_nivel==1) //ORDINARIO
		{
			$menos=" AND h.codfuefin<>04 AND c.codestpro1=h.codestpro1 AND c.codestpro2=h.codestpro2 AND c.codestpro3=h.codestpro3 ";
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2, c.codestpro3  ";
			$nivelmas=" WHERE  ".$filtro.$nivel.$menos;
			//$nivelmas=" WHERE  c.spg_cuenta=4040000000000 ";
			$hasta=3;
		}
		if($ai_nivel==2) //cfg
		...
		if($ai_nivel==3) //LAEE
		{
			$menos=" AND e.codfuefin=05 AND c.codestpro1=e.codestpro1 AND c.codestpro2=e.codestpro2 AND c.codestpro3=e.codestpro3 AND c.codestpro4=e.codestpro4 AND c.codestpro5=e.codestpro5 ";
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, c.codestpro5  ";
			$nivelmas=" WHERE  ".$filtro.$nivel.$menos;
			//$nivelmas=" WHERE  c.spg_cuenta=4040000000000 ";
			$hasta=3;
		}
		//$ls_sql=" SELECT e.codfuefin, c.spg_cuenta, c.nivel, max(c.denominacion) as denominacion, sum(c.asignado) as asignado, ".
		$ls_sql=" SELECT c.spg_cuenta, c.nivel, max(c.denominacion) as denominacion, sum(c.asignado) as asignado, ".
                "        sum(c.comprometido) as comprometido, sum(c.causado) as causado, sum(c.pagado) as pagado, ".
                "        sum(c.aumento) as aumento, sum(c.disminucion) as disminucion, sum(c.enero) as enero, ".
                "        sum(c.febrero) as febrero, sum(c.marzo) as marzo, sum(c.abril) as abril, sum(c.mayo) as mayo, ".
                ...
                "        sum(c.octubre) as octubre, sum(c.noviembre) as noviembre, sum(c.diciembre) as diciembre, ".
                "        c.codestpro1,c.codestpro2,c.codestpro3,c.codestpro4,c.codestpro5 ".
		//" FROM   spg_cuentas c, spg_ep5 e, spg_ep3 h ".
		" FROM   spg_cuentas c, spg_ep3 h ".
              /*  " FROM   spg_cuentas c, spg_plantillareporte r ".*/
		$nivelmas.
              /*  " WHERE  c.codemp=r.codemp AND r.codemp='".$ls_codemp."' AND r.codrep='0704' AND (c.codestpro1=r.codestpro1 AND ".
                "        c.codestpro2=r.codestpro2 AND c.codestpro3=r.codestpro3 AND c.codestpro4=r.codestpro4 AND ".
                "        c.codestpro5=r.codestpro5) AND (c.spg_cuenta = r.spg_cuenta) AND (r.status <> 'I') ".*/
                $agrupa.
                " ORDER  BY c.codestpro1, c.codestpro2, c.codestpro3, c.spg_cuenta";
...
///
		if($rs_data===false)
		   {
			  $lb_valido=false;
			 $this->is_msg_error="Error en consulta metodo uf_spg_reportes_distribucion_inversion".$this->fun->uf_convertirmsg($this->SQL->message);
		   }
		   else
		   {
			   if($row=$this->SQL->fetch_row($rs_data))
			   ...
			   for ($li_i=1;$li_i<=$li_total_row;$li_i++)

				{
					...
					$ls_catprog=substr($ls_codestpro1,18,2).substr($ls_codestpro2,4,2).substr($ls_codestpro3,1,2);
					...
					//{
						$this->dts_reporte->insertRow("spg_cuenta",$ls_spg_cuenta);
						$this->dts_reporte->insertRow("catprog",$ls_catprog);
						$this->dts_reporte->insertRow("denominacion",$ls_denominacion);
						$this->dts_reporte->insertRow("asignado",$ld_asignado_acumulado);
						$this->dts_reporte->insertRow("monto_programado",$ld_monto_programado);
						$this->dts_reporte->insertRow("monto_acumulado",$ld_monto_programado_acum);
     ...
     return $lb_valido;
    }//fin uf_spg_reportes_distribucion_inversion
/****************************************************************************************************************************************/	
...
/****************************************************************************************************************************************/
	...
	//   CLASE REPORTES SPG  COMPARADOS " RESUMEN DEL PRESUPUESTO DE GASTOS POR PARTIDAS FORMA #0704 "  //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_distribucion_proyectos($ai_nivel,$as_cuenta_inversion,$as_fuente)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_distribucion_inversion
	 //         Access :	private
	 //     Argumentos :    $as_trimestres // rango del trimestre
	 ...
	 // Fecha Creación :    14/06/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$this->dts_reporte->resetds("spg_cuenta");
        	$ls_tipo="O";
		//$filtro="substring(c.spg_cuenta,1,3)=".$as_cuenta_inversion;
		$filtro="c.codestpro1=00000000000000000011 AND c.codestpro2=000004 ";
		$nivel=" AND c.nivel=5 ";
		//print $ai_nivel;
		if($ai_nivel==0)
		{
		...
		if($ai_nivel==1) //ORDINARIO
		{
			$menos=" AND e.codfuefin<>04 AND. e.codfuefin<>05 AND c.codestpro1=e.codestpro1 AND c.codestpro2=e.codestpro2 AND c.codestpro3=e.codestpro3 AND c.codestpro4=e.codestpro4 AND c.codestpro5=e.codestpro5 ";
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, c.codestpro5  ";
			$nivelmas=" WHERE  ".$filtro.$nivel.$menos;
			//$nivelmas=" WHERE  c.spg_cuenta=4040000000000 ";
			$hasta=3;
		...
		if($ai_nivel==2) //FIDES
		{
			$filtro="";
			$nivel=" c.nivel=5 ";			
			$menos=" AND e.codfuefin=04 AND c.codestpro1=e.codestpro1 AND c.codestpro2=e.codestpro2 AND c.codestpro3=e.codestpro3 AND c.codestpro4=e.codestpro4 AND c.codestpro5=e.codestpro5 ";
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, c.codestpro5  ";
			$nivelmas=" WHERE  ".$filtro.$nivel.$menos;
			//$nivelmas=" WHERE  c.spg_cuenta=4040000000000 ";
			$hasta=3;
		...
		$nivelmas.
              /*  " WHERE  c.codemp=r.codemp AND r.codemp='".$ls_codemp."' AND r.codrep='0704' AND (c.codestpro1=r.codestpro1 AND ".
                ...
                "        c.codestpro5=r.codestpro5) AND (c.spg_cuenta = r.spg_cuenta) AND (r.status <> 'I') ".*/
                $agrupa.
                " ORDER  BY c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, c.codestpro5, c.spg_cuenta";
		...
		if($rs_data===false)
		   ...
		   else
		   {
			   ...
			   for ($li_i=1;$li_i<=$li_total_row;$li_i++)
				...
				{
					$ls_ordinario = 0; $ls_FIDES=0; $ls_LAEE=0;				   	
					$ls_spg_cuenta = $dts_disponible->getValue("spg_cuenta",$li_i);
					$h=$li_i;
					if(($li_1+1)<$li_total_row)
					{
					...
					$ls_spg_cuenta_next = $dts_disponible->getValue("spg_cuenta",$h);
					$ld_asignado = $dts_disponible->getValue("asignado",$li_i);
					$ls_codfuefin = $dts_disponible->getValue("codfuefin",$li_i);

					if($ls_codfuefin=="--"){$ls_ordinario=$ld_asignado;}
					if($ls_codfuefin=="04"){$ls_FIDES= $ld_asignado;}
					if($ls_codfuefin=="05"){$ls_LAEE= $ld_asignado;}
//		print $ls_ordinario;
//		print $ls_codfuefin;
					//}//if
					...
					//{
						...
						$this->dts_reporte->insertRow("catprog",$ls_catprog);
						$this->dts_reporte->insertRow("denominacion",$ls_denominacion);
						$this->dts_reporte->insertRow("ordinario",$ls_ordinario);
						$this->dts_reporte->insertRow("FIDES",$ls_FIDES);
						$this->dts_reporte->insertRow("LAEE",$ls_LAEE);
						$this->dts_reporte->insertRow("monto_programado",$ld_monto_programado);
						$this->dts_reporte->insertRow("monto_acumulado",$ld_monto_programado_acum);
						$this->dts_reporte->insertRow("aumdis_mes",$ld_aumdismes);
						$this->dts_reporte->insertRow("aumdis_acumulado",$ld_aumdisacum);
     ...
     return $lb_valido;
    }//fin uf_spg_reportes_distribucion_proyectos
/****************************************************************************************************************************************/	
...
/****************************************************************************************************************************************/
	...
	//   CLASE REPORTES SPG  COMPARADOS " RESUMEN DEL PRESUPUESTO DE GASTOS POR PARTIDAS FORMA #0704 "  //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_distribucion_transferencias($ai_nivel,$as_cuenta_inversion,$as_cuenta_inversion1,$as_fuente)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_distribucion_transferencias
	 //         Access :	private
	 //     Argumentos :    $as_trimestres // rango del trimestre
	 //                     $ai_nivel     //  nivel de la cuenta                
     //	       Returns :	Retorna true o false si se realizo la consulta para el reporte
	 ...
	 // Fecha Creación :    14/06/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$nivel=" AND (c.nivel=3 OR c.nivel=4 OR c.nivel=5) ";
		//print $ai_nivel;
		if($ai_nivel==0)
		{
			$filtro="substring(c.spg_cuenta,1,3)=".$as_cuenta_inversion;
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, c.codestpro5  ";
			$nivelmas=" WHERE  ".$filtro;//.$nivel;
			//$nivelmas=" WHERE  c.spg_cuenta=4040000000000 ";
			$hasta=3;
		}
		if($ai_nivel==1) //TRANSFERENCIAS PUBLICAS
		{
			$filtro="substring(c.spg_cuenta,1,7)=".$as_cuenta_inversion;
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, c.codestpro5  ";
			$nivelmas=" WHERE  ".$filtro.$nivel;
			//$nivelmas=" WHERE  c.spg_cuenta=4040000000000 ";
			$hasta=3;
		}
		if($ai_nivel==2) //TRANSFERENCIAS PRIVADAS
		{
			
			$filtro="(substring(c.spg_cuenta,1,7)=".$as_cuenta_inversion." "."OR substring(c.spg_cuenta,1,7)=".$as_cuenta_inversion1.")";
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, c.codestpro5  ";
			$nivelmas=" WHERE  ".$filtro.$nivel;
			//$nivelmas=" WHERE  c.spg_cuenta=4040000000000 ";
			$hasta=3;
...
//print $ld_asignado;
     ...
     return $lb_valido;
    }//fin uf_spg_reportes_distribucion_transferencias
/****************************************************************************************************************************************/	
...
/****************************************************************************************************************************************/
	...
	//   CLASE REPORTES SPG  COMPARADOS " RESUMEN DEL PRESUPUESTO DE GASTOS POR PARTIDAS FORMA #0704 "  //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_distribucion_sector_programa($as_combomes,$ai_nivel)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_comparados_forma0704
	 //         Access :	private
	 //     Argumentos :    $as_trimestres // rango del trimestre
	 ...
	 // Fecha Creación :    14/06/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($ai_nivel==16)
		{
			$nivelmas=" WHERE  c.nivel=1 AND c.codestpro1=e.codestpro1 AND c.codestpro2=e.codestpro2 ";
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2  ";
		}
		else
		{
			$ai_nivel1="000000000000000000".$ai_nivel;
			$nivelmas=" WHERE  c.codestpro1=".$ai_nivel1." AND c.nivel=1 AND c.codestpro1=e.codestpro1 AND c.codestpro2=e.codestpro2 ";
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel, c.codestpro1, c.codestpro2  ";
		}
		$ls_sql=" SELECT e.denestpro2, c.spg_cuenta, c.nivel, max(c.denominacion) as denominacion, sum(c.asignado) as asignado, ".
                "        sum(c.comprometido) as comprometido, sum(c.causado) as causado, sum(c.pagado) as pagado, ".
                "        sum(c.aumento) as aumento, sum(c.disminucion) as disminucion, sum(c.enero) as enero, ".
                "        sum(c.febrero) as febrero, sum(c.marzo) as marzo, sum(c.abril) as abril, sum(c.mayo) as mayo, ".
                "        sum(c.junio) as junio, sum(c.julio) as julio, sum(c.agosto) as agosto, sum(c.septiembre) as septiembre,".
                "        sum(c.octubre) as octubre, sum(c.noviembre) as noviembre, sum(c.diciembre) as diciembre, ".
                "        c.codestpro1, c.codestpro2, c.codestpro3, c.codestpro4, c.codestpro5 ".
		" FROM   spg_cuentas c, spg_ep2 e".
		$nivelmas.
                $agrupa.
                " ORDER  BY c.codestpro1, c.codestpro2, c.spg_cuenta";
...
///
		if($rs_data===false)
		   {
			  $lb_valido=false;
			 $this->is_msg_error="Error en consulta metodo uf_spg_reportes_distribucion_sector_programa".$this->fun->uf_convertirmsg($this->SQL->message);
		   }
		   else
		   {
			   if($row=$this->SQL->fetch_row($rs_data))
			   ...
			   for ($li_i=1;$li_i<=$li_total_row;$li_i++)

				{
					...
					$ls_codestpro1_next = $dts_disponible->getValue("codestpro1",$h);
					$ls_codestpro2_next = $dts_disponible->getValue("codestpro2",$h);
					//}//if
					
					//{
					$ls_spg_cuenta = $dts_disponible->getValue("spg_cuenta",$li_i);
					$ls_denominacion = $dts_disponible->getValue("denestpro2",$li_i);
				   	$li_nivel = $dts_disponible->getValue("nivel",$li_i);
				   	$ld_asignado = $dts_disponible->getValue("asignado",$li_i);
					...
					//}//if
					if(($ls_codestpro1_next!=$ls_codestpro1) || ($ls_codestpro2_next!=$ls_codestpro2))
					{
						$this->dts_reporte->insertRow("codestpro1",substr($ls_codestpro1,18,2));
						$this->dts_reporte->insertRow("codestpro2",substr($ls_codestpro2,4,2));
						$this->dts_reporte->insertRow("spg_cuenta",substr($ls_spg_cuenta,0,$hasta));
						$this->dts_reporte->insertRow("denestpro2",$ls_denominacion);
						$this->dts_reporte->insertRow("asignado",$ld_asignado_acumulado);
						$this->dts_reporte->insertRow("nivel",$li_nivel);
						//print $ls_denominacion;
						$ld_asignado_acumulado=0;
					}//if
     ...
     return $lb_valido;
    }//fin uf_spg_reportes_distribucion_sector_programa
/****************************************************************************************************************************************/	
...
/****************************************************************************************************************************************/
	...
	//   CLASE REPORTES SPG  COMPARADOS " RESUMEN DEL PRESUPUESTO DE GASTOS POR PARTIDAS FORMA #0704 "  //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_distribucion_sector_partida($as_combomes,$ai_nivel,&$li_cantidad_sector)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_comparados_forma0704
	 //         Access :	private
	 //     Argumentos :    $as_trimestres // rango del trimestre
	 ...
	 // Fecha Creación :    14/06/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($ai_nivel==16)
		{
			$nivelmas=" WHERE  c.nivel=1 AND c.codestpro1=e.codestpro1 ";
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1  ";
		}
		else
		{
			$ai_nivel1="000000000000000000".$ai_nivel;
			$nivelmas=" WHERE  c.codestpro1=".$ai_nivel1." AND c.nivel=1 AND c.codestpro1=e.codestpro1 ";
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel, c.codestpro1 ";
		}
...
///
		   ...
		   else
		   {
			   ...
			   for ($li_i=1;$li_i<=$li_total_row;$li_i++)

				{
					...
					$ls_denominacion = $dts_disponible->getValue("denestpro1",$li_i);
					$ls_denominacion_cuenta = $dts_disponible->getValue("denominacion",$li_i);
				   	$li_nivel = $dts_disponible->getValue("nivel",$li_i);
				   	$ld_asignado = $dts_disponible->getValue("asignado",$li_i);
					...
					$ld_asignado_acumulado=$ld_asignado_acumulado+$ld_asignado;
						...
						$this->dts_reporte->insertRow("codestpro1",substr($ls_codestpro1,18,2));
						$this->dts_reporte->insertRow("spg_cuenta",substr($ls_spg_cuenta,0,3));
						$this->dts_reporte->insertRow("denestpro1",$ls_denominacion);
						$this->dts_reporte->insertRow("denominacioncuenta",$ls_denominacion_cuenta);
						$this->dts_reporte->insertRow("asignado",$ld_asignado);
						$this->dts_reporte->insertRow("nivel",$li_nivel);
					if($ls_codestpro1_next!=$ls_codestpro1)
					{
					$li_cantidad_sector=$li_cantidad_sector+1;
					}//ifelse
				}//while
				$lb_valido=true;
		    //}//while
     ...
     return $lb_valido;
    }//fin uf_spg_reportes_distribucion_sector_partida
/****************************************************************************************************************************************/	
...
/****************************************************************************************************************************************/
	...
	//   CLASE REPORTES SPG  COMPARADOS " RESUMEN DEL PRESUPUESTO DE GASTOS POR PARTIDAS FORMA #0704 "  //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_spg_reporte_distribucion_sector_programa_partida($as_codestpro1,$as_codestpro2,$as_codestpro1h,$as_codestpro2h,$ai_nivel)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_comparados_forma0704
	 //         Access :	private
	 //     Argumentos :    $as_trimestres // rango del trimestre
	 ...
	 // Fecha Creación :    14/06/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$this->dts_reporte->resetds("spg_cuenta");
        	$ls_tipo="O";
		$ls_struc_programatica_des=$as_codestpro1.$as_codestpro2;
		$ls_struc_programatica_has=$as_codestpro1h.$as_codestpro2h;		
		$ls_concat_programatica="CONCAT(c.codestpro1,c.codestpro2)";

		if($ai_nivel==1)
		{
			$nivelmas=" WHERE nivel=1 AND ".$ls_concat_programatica." between ".$ls_struc_programatica_des." AND ".$ls_struc_programatica_has;
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel,  c.codestpro1, c.codestpro2  ";
		}
		else
		{
			$nivelmas=" WHERE nivel=1 ";
			$agrupa=" GROUP BY c.spg_cuenta, c.nivel, c.codestpro1, c.codestpro2 ";
		}
...
///
     ...
     return $lb_valido;
    }//fin uf_spg_reportes_distribucion_sector_programa_partida
/****************************************************************************************************************************************/	
...
/****************************************************************************************************************************************/
	...
	//   CLASE REPORTES SPG  COMPARADOS " RESUMEN DEL PRESUPUESTO DE GASTOS POR PARTIDAS FORMA #0704 "  //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_separador_sector($ai_nivel,$ai_desde,$ai_hasta)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_separador_sector
	 //         Access :	private
	 //     Argumentos :    $as_trimestres // rango del trimestre
	 //                     $ai_nivel     //  nivel de la cuenta                
     //	       Returns :	Retorna true o false si se realizo la consulta para el reporte
	 //	   Description :	Reporte que genera salida  del comparados del instructivo07 de la forma 0704
	 //     Creado por :    Ing. Miguel Palencia.
	 // Fecha Creación :    14/11/2009          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido = true;
		$dts_disponible=new class_datastore();	 
		$ls_gestor = $_SESSION["ls_gestor"];
		$ls_codemp = $this->dts_empresa["codemp"];
		$this->dts_cab->resetds("spg_ep1");
		$this->dts_reporte->resetds("spg_ep1");
        	$ls_tipo="O";
		//print $ai_nivel;
		if($ai_nivel==16)
		{
			$agrupa=" GROUP BY c.codestpro1 ";
			$nivelmas=" WHERE  c.codestpro1<>00000000000000000000 ";
			$nivelmas="";
		}
		else //EL sector seleccionado
		{
			$agrupa=" GROUP BY c.codestpro1 ";
			$ai_nivel="000000000000000000".$ai_nivel;
			$nivelmas=" WHERE  c.codestpro1=".$ai_nivel;
			$hasta=3;
		}
		$ls_sql=" SELECT c.codestpro1, c.denestpro1 ".
		" FROM   spg_ep1 c ".$nivelmas.$agrupa.
                " ORDER  BY c.codestpro1";
...
///
		if($rs_data===false)
		   {
			  $lb_valido=false;
			 $this->is_msg_error="Error en consulta metodo uf_spg_reportes_separador_sector".$this->fun->uf_convertirmsg($this->SQL->message);
		   }
		   else
		   {
			   if($row=$this->SQL->fetch_row($rs_data))
			   ...
			   $li_total_row=$dts_disponible->getRowCount("spg_ep1");
			//print "desde ".$ai_desde. "hasta ".$ai_hasta;		
			   for ($li_i=$ai_desde;$li_i<=$ai_hasta;$li_i++)

				{
				   	
					$ls_codestpro1 = $dts_disponible->getValue("codestpro1",$li_i);
					$ls_denestpro1 = $dts_disponible->getValue("denestpro1",$li_i);
					/*print "li_i ".$li_i;
					print "codigo ".$ls_codestpro1;
					print $ls_denestpro1;*/
     ...
     return $lb_valido;
    }//fin uf_spg_reportes_separador_sector
/****************************************************************************************************************************************/	
...
/****************************************************************************************************************************************/
	...
	//   CLASE REPORTES SPG  COMPARADOS " RESUMEN DEL PRESUPUESTO DE GASTOS POR PARTIDAS FORMA #0704 "  //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_separador_programas($ai_nivel,$ai_desde,$ai_hasta)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_separador_sector
	 //         Access :	private
	 //     Argumentos :    $as_trimestres // rango del trimestre
	 ...
	 // Fecha Creación :    14/11/2009          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($ai_nivel==16)
		{
			$agrupa=" GROUP BY c.codestpro1, c.codestpro2 ";
			$nivelmas=" WHERE  c.codestpro1<>00000000000000000000"." AND c.codestpro1=e.codestpro1 ";
			//$nivelmas="";
		}
		else //EL sector seleccionado
		{
			$agrupa=" GROUP BY c.codestpro1,c.codestpro2 ";
			$ai_nivel="000000000000000000".$ai_nivel;
			$nivelmas=" WHERE  c.codestpro1=".$ai_nivel." AND c.codestpro1=e.codestpro1 ";
		}
		$ls_sql=" SELECT c.codestpro1, c.codestpro2, c.denestpro2, e.denestpro1 ".
		" FROM   spg_ep1 e, spg_ep2 c ".$nivelmas.$agrupa.
                " ORDER  BY c.codestpro1, c.codestpro2, c.denestpro2";
...
///
			...
			//print "desde ".$ai_desde. "hasta ".$ai_hasta;		
			   for ($li_i=$ai_desde;$li_i<=$ai_hasta;$li_i++)

				{
					...
					$ls_denestpro1 = $dts_disponible->getValue("denestpro1",$li_i);
					$ls_codestpro2 = $dts_disponible->getValue("codestpro2",$li_i);
					$ls_denestpro2 = $dts_disponible->getValue("denestpro2",$li_i);
					/*print "li_i ".$li_i;
					print "codigo 1 ".$ls_codestpro1;
					print $ls_denestpro1;
					print "codigo 2 ".$ls_codestpro2;
					print $ls_denestpro2;*/
					$this->dts_reporte->insertRow("codestpro1",$ls_codestpro1);
					$this->dts_reporte->insertRow("denestpro1",$ls_denestpro1);
     ...
     return $lb_valido;
    }//fin uf_spg_reportes_separador_programas
/****************************************************************************************************************************************/	
...
/****************************************************************************************************************************************/
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_distribucion_categorias($ai_nivel,$ai_desde,$ai_hasta)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_distribucion_categorias
	 //         Access :	private
	 //     Argumentos :    $as_trimestres // rango del trimestre
	 //                     $ai_nivel     //  nivel de la cuenta                
     //	       Returns :	Retorna true o false si se realizo la consulta para el reporte
	 ...
	 // Fecha Creación :    14/11/2009          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_gestor = $_SESSION["ls_gestor"];
		$ls_codemp = $this->dts_empresa["codemp"];
		$this->dts_cab->resetds("spg_ep3");
		$this->dts_reporte->resetds("spg_ep3");
        	$ls_tipo="O";
		//print $ai_nivel;
		if($ai_nivel==16)
		{
			$agrupa=" GROUP BY c.codestpro1, c.codestpro2, c.codestpro3 ";
			$nivelmas=" WHERE  c.codestpro1=e.codestpro1 AND c.codestpro1=d.codestpro1 AND c.codestpro2=d.codestpro2 ";
		}
		else //EL sector seleccionado
		{
			$agrupa=" GROUP BY c.codestpro1,c.codestpro2,c.codestpro3 ";
			$ai_nivel="000000000000000000".$ai_nivel;
			$nivelmas=" WHERE  e.codestpro1=".$ai_nivel." AND c.codestpro1=".$ai_nivel. " AND c.codestpro2=d.codestpro2 AND c.codestpro1=d.codestpro1";
			$hasta=3;
		}
		$ls_sql=" SELECT c.codestpro1, c.codestpro2, c.codestpro3, e.denestpro1, d.denestpro2, c.denestpro3, c.responsable ".
		" FROM   spg_ep3 c, spg_ep2 d, spg_ep1 e ".$nivelmas.$agrupa.
                " ORDER  BY c.codestpro1";
		...
		if($rs_data===false)
		   ...
		   else
		   {
			   ...
			   $li_total_row=$dts_disponible->getRowCount("spg_ep3");
			//print $li_total_row;	
			   for ($li_i=$ai_desde;$li_i<=$ai_hasta;$li_i++)

				{
					...
					$ls_codestpro1 = $dts_disponible->getValue("codestpro1",$li_i);
					$ls_siguiente=$dts_disponible->getValue("codestpro1",$li_i+1);
					$ls_denestpro1 = $dts_disponible->getValue("denestpro1",$li_i);
					$ls_codestpro2 = $dts_disponible->getValue("codestpro2",$li_i);
					$ls_denestpro2 = $dts_disponible->getValue("denestpro2",$li_i);
					$ls_codestpro3 = $dts_disponible->getValue("codestpro3",$li_i);
					$ls_denestpro3 = $dts_disponible->getValue("denestpro3",$li_i);
					$ls_responsable= $dts_disponible->getValue("responsable",$li_i);
					
					$compara=substr($ls_codestpro3,1,2);
					if($compara=='00')
					{
						$ls_denestpro3=$ls_denestpro1;
					}
					$this->dts_reporte->insertRow("codestpro1",substr($ls_codestpro1,18,2));
					$this->dts_reporte->insertRow("denestpro1",$ls_denestpro1);
					$this->dts_reporte->insertRow("codestpro2",substr($ls_codestpro2,4,2));
					$this->dts_reporte->insertRow("denestpro2",$ls_denestpro2);
					$this->dts_reporte->insertRow("codestpro3",substr($ls_codestpro3,1,2));
					$this->dts_reporte->insertRow("denestpro3",$ls_denestpro3);
					$this->dts_reporte->insertRow("responsable",$ls_responsable);
				}//for
				$lb_valido=true;
				$this->SQL->free_result($rs_data);
		}//else
     return $lb_valido;
    }//fin uf_spg_reportes_distribucion_categorias
/****************************************************************************************************************************************/	
