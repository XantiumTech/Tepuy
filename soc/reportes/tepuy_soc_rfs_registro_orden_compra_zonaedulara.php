...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_lugentnomdep,$ls_lugentdir,$ls_desest,$ls_denmun,&$io_pdf)
	{
		...
		$tm=296-($li_tm/2);
		$io_pdf->addText($tm,945,14,'<b>'.$ls_titulo.'</b>'); // Agregar el título
		$io_pdf->addText(485,960,9," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(485,930,9,"<b>Fecha </b>".$ad_fecordcom); // Agregar el título
		...
		$io_pdf->addText(40,80,7,"<b>Lic. Mirna T. Vies de A.</b>"); // Agregar el título
		$io_pdf->addText(45,70,7,"Directora de la Zona."); // Agregar el título
		$io_pdf->addText(40,63,7,"Educativa Estado Lara"); // Agregar el título
		$io_pdf->line(140,60,140,155);	//VERTICAL	
		$io_pdf->addText(167,120,7,"Lic. Alexander Escudero"); // Agregar el título
		$io_pdf->addText(167,110,7,"Jefe Div. Admini. y Serv."); // Agregar el título
		$io_pdf->addText(175,73,7,"Lic. Julián Zavarce"); // Agregar el título
		$io_pdf->addText(165,63,7,"Jefe Div. Planif. y Presup."); // Agregar el título
		$io_pdf->line(270,60,270,155);	//VERTICAL		
		$io_pdf->addText(315,120,7,"Lic. Ana Castillo"); // Agregar el título
		$io_pdf->addText(305,110,7,"Jefe Coord. de Compras"); // Agregar el título
		$io_pdf->addText(310,73,7,"Lic. Ramón Cabello"); // Agregar el título
		$io_pdf->addText(300,63,7,"Jefe Coord. de Contabilidad"); // Agregar el título
		$io_pdf->line(420,60,420,155);	//VERTICAL		
		$io_pdf->addText(470,120,7,"Lic. Aura M. Rodriguez"); // Agregar el título
		$io_pdf->addText(450,110,7,"Jefe Unidad de Verificaión y Control"); // Agregar el título
		$io_pdf->addText(422,95,7,"Auditado Por:"); // Agregar el título
		$io_pdf->addText(455,63,7,"Unidad de Auditoria Delegada"); // Agregar el título
		$io_pdf->line(140,105,585,105); //HORIZONTAL	
			
		$ls_periodo=substr($ls_periodo,0,4);
		$io_pdf->Rectangle(15,825,570,90);  
		$io_pdf->addText(17,895,10,"Año: ".$ls_periodo); // Agregar el título
		$io_pdf->addText(130,895,10,"Organismo: ".$ls_codadscito.'  '.$ls_orgadscito); // Agregar el título
		$io_pdf->addText(17,875,10,"Unidad Administradora: ".$ls_codemp.'  '.$ls_nombre); // Agregar el título
		$io_pdf->addText(17,855,10,"Unidad Solicitante: "); // Agregar el título
		$io_pdf->addText(17,835,10,"Municipio: ".$ls_denmun); // Agregar el título
		$io_pdf->addText(300,835,10,"Estado: ".$ls_desest); // Agregar el título
		$io_pdf->ezSetY(820);
		...
		$io_pdf->Rectangle(15,155,570,95); // primer rectángulo inferior
	    ...
	    $io_pdf->addText(17,205,8,"aprobarse se exigirá al beneficiario Fianza"); 
		...
		$io_pdf->addText(17,175,8,"Banco o Compañía de Seguro, Notariada");
		$io_pdf->addText(17,165,8,"y vigente.");
		$io_pdf->addText(210,240,8,"<b>CLÁUSULA PENAL</b>"); 
		$io_pdf->line(325,155,325,250);  // LINEA VERTICAL
		$io_pdf->addText(177,225,8,"Queda establecida la Cláusula Penal"); 
		$io_pdf->addText(177,215,8,"según la cual elproveedor pagará al fisco");
		$io_pdf->addText(177,205,8,"el 0,5% sobre el monto de la mercancía");
		$io_pdf->addText(177,195,8,"respectiva por cada día hábil del retardo"); 
		...
		$io_pdf->addText(327,205,8,"Orden de Compra, sin indemnización"); 
