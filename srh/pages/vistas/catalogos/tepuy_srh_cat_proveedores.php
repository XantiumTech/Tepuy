...
<br>
  ...
  <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
    ...
    <td width="193"><div align="right"><a href="javascript: Limpiar_busqueda();"> <img src="../../../public/imagenes/nuevo.png" alt="Limpiar" width="15" height="15" border="0">Limpiar</a></div></td> 
    <td width="212"><div align="right"><a href="javascript: Buscar()"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Haga click aqu&iacute; para Buscar</a></div></td>
...
<p>&nbsp;</p>
	...
	<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_solicitud_adiestramiento.php?valor=createXML_proveedor";
		var actionURL = "../../php/tepuy_srh_a_solicitud_adiestramiento.php";
		//var authorsURL = "ajax_folder/tepuy_srh_a_solicitud_adiestramiento.php.php?type=getAuthorsList"
		var mygrid;
...
function Limpiar_busqueda () 
{
	...
	document.form1.txtdenprov.value="";
		...
		function Buscar()
		{
		   ...
		   mygrid.loadXML("../../php/tepuy_srh_a_solicitud_adiestramiento.php?valor=buscar_proveedor"+"&txtcodprov="+codprov+"&txtdenprov="+denprov);
