...
class tepuy_srh_c_aspectos
{
	...
	function tepuy_srh_c_aspectos($path)
...
function uf_srh_getProximoCodigo($as_codeval, $as_codaspaux)
  {
		...
		//         Access: public (tepuy_srh_p_accidentes)
		//      Argumento: 
...
function  uf_srh_insert_aspectos($ao_aspecto,$aa_seguridad)
	{
		...
		//         areaess: public (tepuy_srh_d_aspectos_evaluacion)
		//      Argumento: $as_codasp   // codigo de aspecto de evaluación
		 ...
		 $num=$this->io_sql->num_rows($rs_data);
		  ...
		  if ($num!=0) {
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ao_object[$ai_totrows][3]="<a href=javascript:uf_agregar_dt(".$ai_totrows."); align=center><img src=../../../../shared/imagebank/tools/grabar.png alt=Aceptar width=15 height=15 border=0 align=center></a>";
				$ao_object[$ai_totrows][4]="<a href=javascript:uf_delete_dt(".$ai_totrows."); align=center><img src=../../../../shared/imagebank/tools15/eliminar.png alt=Eliminar width=15 height=15 border=0 align=center></a>";	
...
}// end   class tepuy_srh_c_aspectos
?>