...
$io_fun_activo->uf_load_seguridad("SIV","tepuy_siv_r_articuloxsolicitar.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			{li_ordenart=1;}
			window.open("reportes/tepuy_siv_rpp_articulosxsolicitar.php?ordenart="+li_ordenart+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
