<?php
	...
	$io_fun_nomina->uf_load_seguridad_nomina("SNO","tepuy_sno_d_constpersonal.php",$ls_codnom,$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<?php 
	...
	switch ($ls_operacion) 
	{
		case "NUEVO":
			...
			$lb_valido=$io_constante->uf_load_constantepersonal($ls_codigo,$li_inicio,$li_registros,$li_totrows,$lo_object,$li_totpag);
			break;
		...
		case "GUARDAR":
			...
			for($li_i=1;$li_i<=$li_totrows&&$lb_valido;$li_i++)
			{
				 ...
				 $lb_valido=$io_constante->update_const_personal($ls_codigo,$ls_moncon,$ls_codper);
...
<!-- ******** END ALLWEBMENUS CODE FOR menu ******** -->
  <tr>
    ...
    <tr>
    <td class="toolbar" width="25"><div align="center"><a href="javascript: uf_guardar();"><img src="../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="25"><div align="center"><a href="javascript: uf_volver();"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a></div></td>
...
<div align="center">
  ...
  <?php
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	$io_fun_nomina->uf_print_permisos($ls_permisos,$la_permisos,$ls_logusr,"location.href='tepuy_sno_d_constantes.php'");
	unset($io_fun_nomina);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
     ?>		  
    <p>&nbsp;</p>
    ...
    <table width="712" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
      ...
      <tr>
		...
		<?php
			...
			if(($li_pagina - 1) > 0) 
			{
				print "<a href='tepuy_sno_d_constpersonal.php?txtcodcons=".$ls_codigo."&txttopcon=".$ls_tope."&txtnomcon=".$ls_nomcon."&pagina=".($li_pagina-1)."'>< Anterior</a> ";
			}
			...
			{ 
				...
				{
					print "<a href='tepuy_sno_d_constpersonal.php?txtcodcons=".$ls_codigo."&txttopcon=".$ls_tope."&txtnomcon=".$ls_nomcon."&pagina=".($li_i)."'>$li_i</a> "; 
				}
			}
			if(($li_pagina + 1)<=$li_totpag) 
			{
				print " <a href='tepuy_sno_d_constpersonal.php?txtcodcons=".$ls_codigo."&txttopcon=".$ls_tope."&txtnomcon=".$ls_nomcon."&pagina=".($li_pagina+1)."'>Siguiente ></a>";
			}
	...
	{		
		...
		if(li_cambiar==1)
		{
			...
			if(lb_valido)
			{
				...
				f.action="tepuy_sno_d_constpersonal.php?pagina=<?php print $li_pagina; ?>";
				f.submit();
			}
		}
		else
...
function uf_volver()
{
	  ...
	  f.action="tepuy_sno_d_constantes.php?txtcodcons="+cod;
	  f.submit(); 
}
</script>
</html>
