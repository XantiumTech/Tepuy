...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_ejecucion_trimestral_x_programatica.php";
...
function ue_showouput()
{
	...
	else
	{
		...
		pagina="reportes/tepuy_spg_rpp_instructivo_ejecucion_trimestral_x_programatica.php?trimestre="+trimestre;
