...
<?
	//require_once("tepuy_spg_c_estprog.php");
	include("class_folder\class_mensajes.php");
	include("tepuy_saf_c_grupo.php");
	...
	//$class_estprog2=new tepuy_spg_c_estprog();
	$ds=null;
...
function ue_buscar()
{
	...
	window.open("tepuy_catdinamic_subgrupo.php?codigo="+codigo+"&deno="+deno,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}
function ue_cerrar()
{
	f=document.form1;
...
{
	f=document.form1;
	f.action="tepuy_saf_d_grupo.php";
	f.submit();
}
function uf_ir()
{
