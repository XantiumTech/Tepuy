...
//-----------------------------------------------------------------------------------------------------------------------------------
class tepuy_snorh_c_incor_susp_egre_personal
{
	var $io_sql;
	var $io_msg;
	var $io_function;
	...
	var $io_connect;
//-----------------------------------------------------------------------------------------------------------------------------------
function tepuy_snorh_c_incor_susp_egre_personal()
{
...
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	{   //////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////
		 ...
		 {
		      $lb_valido=false;
		      $this->io_msg->message("CLASE->tepuy_snorh_incor_susp_egre_personal MÉTODO->uf_llenarcombo_nomina ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		 }
	return $lb_valido;
	}//fin
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	{
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->tepuy_snorh_incor_susp_egre_personal MÉTODO->uf_load_grid_personal ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
	}
	return  $lb_valido;
}//fin 
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	{
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->tepuy_snorh_incor_susp_egre_personal MÉTODO->uf_load_grid_personalnomina ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
	}
	return  $lb_valido;
}//fin 
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	{
	    $lb_valido=false;
	    $this->io_msg->message("CLASE->tepuy_snorh_incor_susp_egre_personal MÉTODO->uf_update_status_personal ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
	}
	else
	{
...
//-----------------------------------------------------------------------------------------------------------------------------------	
	...
	{
	    $lb_valido=false;
	    $this->io_msg->message("CLASE->tepuy_snorh_incor_susp_egre_personal MÉTODO->uf_update_status_personalnomina ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
	}
	else
	{
	    if($row=$this->io_sql->fetch_row($rs_data))  
