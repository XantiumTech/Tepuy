...
<br>
      ...
      <tr>
        ...
        <!--<td height="22" colspan="2" align="right"><a href="javascript: ue_search(2);"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0">Buscar</a></td>-->
<!-- Para poder insertar una variable en comando JavaScript -->
        <td height="22" colspan="2" align="right"><a href='javascript: ue_search(<?php
print $tipo.");'"?>> <img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0">Buscar</a></td>
      </tr>
    </table>
	<br>
<?php
					...
					$tipo="1";
					  if ($ls_estctascg=="S")
					  ...
					  else
					     {
						   ...
						   echo "<td style=text-align:center><a href=\"javascript: aceptar('$ls_ctascg','$ls_denctascg','$ls_estctascg','$tipo');\">".$ls_ctascg."</a></td>";
						 }
...
function aceptar(cuenta,denominacion,status,tipo)
{
	...
	{
	opener.document.form1.txtcontablea.value=cuenta;
	opener.document.form1.txtcontablea.readOnly=true;
	opener.document.form1.txtdencuentaa.value=denominacion;
	}
	//alert(tipo);
	close();
}

function ue_search(tipo)
{
	f=document.form1;
	f.operacion.value="BUSCAR";
	f.action="tepuy_catdinamic_ctas.php"+"?tipo="+tipo;
	f.submit();
}
</script>
</html>
