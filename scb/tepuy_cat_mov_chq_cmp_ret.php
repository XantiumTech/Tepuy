...
<form name="form1" method="post" action="">
  ...
  <table width="565" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Movimientos Bancarios</td>
    </tr>
  </table>
  <br>
  <div align="center">
      ...
      <tr>
        ...
        <td colspan="2"><div align="left">
          <input name="txtdocumento" type="text" id="txtdocumento" onBlur="javascript: rellenar_cad(document.form1.txtdocumento.value,15,'doc');">        
			...
			?>
			<td width="37" align="right">Fecha </td>
            <td align="left"><div align="right">Desde
        </div></td>
            <td align="left"><input name="txtfechadesde" type="text" id="txtfechadesde" style="text-align:center"  size="10" maxlength="10"  onKeyPress="currencyDate(this);" onBlur="javascript:valFecha(this);" value="<?php print $ls_fecdesde;?>"></td>
      </tr>
      <tr>
        ...
        <td width="120" align="left"><input name="txtprovbene" type="text" id="txtprovbene" style="text-align:center" value="" size="14" maxlength="10"><input type="hidden" name="txtdesproben" ></td>
        <td><div align="right"></div></td>
        <td width="47"><div align="right">Hasta </div></td>
        <td width="152" align="left"><input name="txtfechahasta" type="text" id="txtfechahasta" size="10" maxlength="10"  style="text-align:center"   onKeyPress="currencyDate(this);" onBlur="javascript:valFecha(this);" value="<?php print $ls_fechasta;?>"> </td>
      </tr>
      <tr>
...
if($ls_operacion=="BUSCAR")
{
		$ls_sql="SELECT * FROM scb_movbco 
				 WHERE codemp='".$as_codemp."' AND numdoc like '".$ls_documento."'";// AND codope='OP' ";
...
<script language="JavaScript">
  ...
  function uf_aceptar(ls_documento,ls_codope,ls_fecha,ls_descripcion,ldec_monto,ldec_monobjret,ldec_monret,ls_prov,ls_bene,ls_provbene,ls_codban,ls_nomban,ls_ctaban,ls_dencta,ls_estmov,ls_cuenta_scg,li_cobing,li_estint,ls_codconmov,ldec_saldo)
  {
	...
	f.txtdesmov.value=ls_descripcion;
