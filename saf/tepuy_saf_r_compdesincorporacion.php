...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_compdesincorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","COMPROBANTE_DESIN","tepuy_saf_rpp_comdesincorporacion.php","C");
      ...
      <td colspan="3" align="center"><table width="512" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="414" height="22"><div align="left">
              ...
              <a href="javascript:uf_catalogoincorporacion();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
function uf_catalogoincorporacion()
{
	...
	window.open("tepuy_saf_cat_desincorporaciones.php?coddestino="+ ls_coddestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
}
...
function uf_mostrar_reporte(ls_reporte)
{
	...
	if(li_imprimir==1)
	{
		...
		if((ls_cmpmov!="")&&(ls_coduniadm!="---")&&(ls_codres!=""))
		{
