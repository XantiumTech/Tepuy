...
<html>
<head>
<title>Definici&oacute;n de Tipos de Colocaci&oacute;n</title>
...
require_once("tepuy_scb_c_tipocolocacion.php");
...
$io_seguridad= new tepuy_c_seguridad();
	...
	$ls_sistema="SCB";
	$ls_ventanas="tepuy_scb_d_tipocolocacion.php";
	$la_security[1]=$ls_empresa;
	$la_security[2]=$ls_sistema;
	$la_security[3]=$ls_logusr;
	$la_security[4]=$ls_ventanas;
	$in_classtipocolocacion=new tepuy_scb_c_tipocolocacion($la_security);
...
if ($ls_operacion == "ELIMINAR")
   {
     $lb_existe = $in_classtipocolocacion->uf_select_colocacion($as_codban,$as_ctaban,$as_colocacion,$as_cuentascg,$as_cuentaspi);
	 if ($lb_existe)
	    {
	      $ls_condicion = " AND (column_name='codtipcol')";//Nombre del o los campos que deseamos buscar.
	      $ls_mensaje   = "";                              //Mensaje que será enviado al usuario si se encuentran relaciones a asociadas al campo.
	      $lb_tiene     = $io_chkrel->uf_check_relaciones($ls_codemp,$ls_condicion,'scb_tipocolocacion',$ls_codigo,$ls_mensaje);//Verifica los movimientos asociados a la cuenta  
		  if (!$lb_tiene)
		     {
			   $lb_valido=$in_classtipocolocacion->uf_delete_tipocolocacion($ls_codigo,$ls_denominacion);				
			   if ($lb_valido)
				  {
				    $io_sql->commit();
...
<form name="form1" method="post" action="">
  <table width="629" height="183" border="0" align="center" class="formato-blanco">
    <tr>
      <td height="177" colspan="3"><div align="center">
          <?php 
		//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
		...
		?>
          <table width="566" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
            <tr class="titulo-ventana">
              <td height="22" colspan="3">Definici&oacute;n de Tipos de Colocaci&oacute;n</td>
            </tr>
            ...
            <tr class="formato-blanco">
              ...
              <td height="22" colspan="2"><div align="left" >
                  <input name="txtcodigotipcol" type="text" id="txtcodigotipcol" style="text-align:center " value="<?php print $ls_codigo?>" size="6" maxlength="3" onBlur="javascript:rellenar_cad(this.value,3,'cod')" <?php print $readonly ?>  onKeyPress="return keyRestrict(event,'1234567890');">
              </div></td>
            </tr>
            <tr class="formato-blanco">
              <td height="22"><div align="right">Denominaci&oacute;n</div></td>
              <td height="22" colspan="2"><div align="left">
                  <input name="txtdenotipcol" type="text" id="txtdenotipcol" style="text-align:left" value="<?php print $ls_denominacion?>" size="40" maxlength="30">
              </div></td>
            </tr>
            <tr class="formato-blanco">
              <td height="22">&nbsp;</td>
...
function ue_nuevo()
{
	...
	if (li_incluir==1)
	   {	
         ...
         f.action="tepuy_scb_d_tipocolocacion.php";
		 f.submit();
	   }
	else
	   {
...
function ue_guardar()
{
	...
	if (((lb_status=="C")&&(li_cambiar==1))||(lb_status=="N")&&(li_incluir==1))
	   {
	     ls_codigo=f.txtcodigotipcol.value;
	     ls_denominacion=f.txtdenotipcol.value;
...
function ue_buscar()
{
	...
	if (li_leer==1)
       {
	     window.open("tepuy_scb_cat_tipocolocacion.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=550,height=400,left=50,top=50,location=no,resizable=yes");
       }
	else
	   {
		 alert("No tiene permiso para realizar esta operación");
...
//Funciones de validacion de fecha.
	function rellenar_cad(cadena,longitud,campo)
	{
		...
		if(campo=="cod")
		{
			document.form1.txtcodigotipcol.value=cadena;
		}
	}
</script>
</html>
