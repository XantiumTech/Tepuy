<?php
   ...
   function uf_print($as_codconc, $as_nomcon, $as_codnomdes, $as_codnomhas, $as_tipo)
   {
		...
		if(($as_tipo=="repcesticdes")||($as_tipo=="repcestichas")||($as_tipo=="repcondes")||($as_tipo=="repconhas"))
		{
			$ls_sql="SELECT codconc,nomcon,sigcon,forcon,forpatcon,intprocon ".
					"  FROM sno_concepto ".
					" WHERE codemp='".$ls_codemp."'".
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					case "":  // el llamado se hace desde tepuy_sno_d_concepto.php
					...
					case "VACACION": // el llamado se hace desde tepuy_sno_d_vacacionconcepto.php
						print "<tr class=celdas-blancas>";
					...
					case "NOMINA": // el llamado se hace desde tepuy_sno_cat_calcularnomina.php
						print "<tr class=celdas-blancas>";
					...
					case "PRIMA": // el llamado se hace desde tepuy_sno_d_primaconcepto.php
						print "<tr class=celdas-blancas>";
					...
					case "replisconcdes": // el llamado se hace desde tepuy_sno_r_listadoconcepto.php
						print "<tr class=celdas-blancas>";
					...
					case "replisconchas": // el llamado se hace desde tepuy_sno_r_listadoconcepto.php
						print "<tr class=celdas-blancas>";
					...
					case "AJUSTARAPORTE": // el llamado se hace desde tepuy_sno_p_ajustaraporte.php
						print "<tr class=celdas-blancas>";
					...
					case "APLICARCONCEPTO": // el llamado se hace desde tepuy_sno_p_aplicarconcepto.php
						print "<tr class=celdas-blancas>";
					...
					case "IMPORTAR": // el llamado se hace desde tepuy_sno_p_impexpdato.php
						print "<tr class=celdas-blancas>";
						print "<td><a href=\"javascript: aceptarimportar('$ls_codconc','$ls_campo');\">".$ls_codconc."</a></td>";
						print "<td>".$ls_nomcon."</td>";
						print "<td>".$ls_sigcon."</td>";
						print "<td><input name='txtforcon' type='text' class='sin-borde' id='txtforcon' size='30' maxlength='30' title='".$ls_forcon."' value='".$ls_forcon."'></td>";
						print "</tr>";			
					...
					case "repapopat": // el llamado se hace desde tepuy_sno_r_aportepatronal.php
						print "<tr class=celdas-blancas>";
					...
					case "represconcdes": // el llamado se hace desde tepuy_sno_r_resumenconcepto.php
						print "<tr class=celdas-blancas>";
					...
					case "represconchas": // el llamado se hace desde tepuy_sno_r_resumenconcepto.php
						print "<tr class=celdas-blancas>";
					...
					case "repapopatcon": // el llamado se hace desde tepuy_snorh_r_aportepatronal.php
						print "<tr class=celdas-blancas>";
					...
					case "repcesticdes": // el llamado se hace desde tepuy_snorh_r_cestaticket.php
						print "<tr class=celdas-blancas>";
					...
					case "repcestichas": // el llamado se hace desde tepuy_snorh_r_cestaticket.php
						print "<tr class=celdas-blancas>";
					...
					case "repcondes": // el llamado se hace desde tepuy_snorh_r_conceptos.php
						print "<tr class=celdas-blancas>";
					...
					case "repconhas": // el llamado se hace desde tepuy_snorh_r_conceptos.php
						print "<tr class=celdas-blancas>";
					...
					case "reppredes": // el llamado se hace desde tepuy_snorh_r_listadoprestamo.php
						print "<tr class=celdas-blancas>";
					...
					case "repprehas": // el llamado se hace desde tepuy_snorh_r_listadoprestamo.php
						print "<tr class=celdas-blancas>";
					...
					case "repdetpredes": // el llamado se hace desde tepuy_snorh_r_detalleprestamo.php
						print "<tr class=celdas-blancas>";
					...
					case "repdetprehas": // el llamado se hace desde tepuy_snorh_r_detalleprestamo.php
						print "<tr class=celdas-blancas>";
...
function aceptar(codconc,intprocon)
{
	...
	opener.document.form1.existe.value="TRUE";		
  	...
  	opener.document.form1.action="tepuy_sno_d_concepto.php";
...
function aceptarajustaraporte(codconc,nomcon)
{
	...
	opener.document.form1.action="tepuy_sno_p_ajustaraporte.php";
	opener.document.form1.submit();
	close();
}
...
function aceptarimportar(codconc,campo)
{
	eval("opener.document.form1."+campo+".value='"+codconc+"';");
	eval("opener.document.form1."+campo+".readOnly=true;");
	close();
}
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="tepuy_sno_cat_concepto.php?tipo=<?PHP print $ls_tipo;?>&campo=<?PHP print $ls_campo;?>";
  	f.submit();
}
</script>
</html>
