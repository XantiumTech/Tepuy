...
$io_fun_viaticos->uf_load_seguridad("SCV","tepuy_scv_d_misiones.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
require_once("class_folder/tepuy_scv_c_misiones.php");
$io_mision= new tepuy_scv_c_misiones($conn);
...
switch ($ls_operacion) 
{
	...
	case "GUARDAR":
		...
		{  
			...
			if ($lb_valido)
			{
				$io_msg->message("La Misión ha sido incluida");
				$lb_empresa=true;
				$ls_codmis=$io_funciondb->uf_generar_codigo($lb_empresa,$ls_codemp,'scv_misiones','codmis');
				$ls_estatus="NUEVO";
				$ls_denmis="";
...
function ue_nuevo()
{
   ...
   {			 
	  ...
	  f.action="tepuy_scv_d_misiones.php";
	  f.submit();
   }
   else
   {
	...
	if (li_leer==1)
	   {
		 ...
		 pagina="tepuy_scv_cat_misiones.php?destino="+ls_destino+"";
