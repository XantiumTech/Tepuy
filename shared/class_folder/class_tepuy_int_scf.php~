...
ini_set('precision','15');
 ////////////////////////////////////////////////////////////////////////////////////////////////////
 //           CLASS:  class_tepuy_int_scf
 //	         Access:  public
 //     Programador:  Ing. Miguel Palencia  e Ing. Juniors Fraga
 //     Description:  Esta clase teiene como objeto el manejo de todos los métodos relacionados a los 
 //                   contables del sistema tepuy, es utilizados para el manejo de cuentas y comprobantes
 ...
 //Clases Asociadas : class_tepuy_int,class_tepuy_int_int,class_tepuy_int_spg,class_tepuy_int_spg
 ////////////////////////////////////////////////////////////////////////////////////////////////////
 class class_tepuy_int_scf extends class_tepuy_int
 {
    var $io_function;
	var $io_fecha;
	var $is_fecha;
	...
	} // end function class_tepuy_int_scf
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_procesar_delete_movimiento($as_codemp,$as_procede,$as_comprobante,$as_fecha,$as_cuenta,$as_procede_doc,
											   $as_documento,$as_operacion,$adec_monto,$as_codban,$as_ctaban)
    {		
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_procesar_delete_movimiento
		//		   Access: public 
        ...
        if($this->uf_scf_select_movimiento($as_cuenta,$as_procede_doc,$as_documento,$as_operacion,&$ldec_monto_movimiento,
										   &$li_orden))
		{
			$lb_valido = $this->uf_scf_delete_movimiento($as_codemp,$as_procede,$as_comprobante,$as_fecha,$as_cuenta,
														 $as_procede_doc,$as_documento,$as_operacion,$as_codban,$as_ctaban);
			if($lb_valido)  
			{ 
				$lb_valido=$this->uf_scf_procesar_saldos_contables($as_cuenta,$as_operacion,$ldec_monto_movimiento,0); 
			}
		}
		else
		{
		...
		return $lb_valido;
	} // end function uf_scf_procesar_delete_movimiento
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_select_movimiento($as_cuenta,$as_procede_doc,$as_documento,$as_debhab,&$adec_monto,&$ai_orden)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_select_movimiento
		//		   Access: public 
		...
		if($rs_mov===false)
		{
			$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_scf_select_movimiento ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
		}
		else
		{
		...
		return $lb_existe;
	} // end function uf_scf_select_movimiento
	//-----------------------------------------------------------------------------------------------------------------------------------
	
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_delete_movimiento($as_codemp,$as_procede,$as_comprobante,$as_fecha,$as_cuenta,$as_procede_doc,$as_documento,
									  $as_operacion,$as_codban,$as_ctaban)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_delete_movimiento
		//		   Access: public 
		//       Argument: as_codemp // Código de empresa
		//       		   as_procede // Procedencia del documento
		//       		   as_comprobante // Número de Comprobante
		...
		if($li_result===false)
		{
			$this->is_msg_error = "CLASE->tepuy_int_scf MÉTODO->uf_scf_delete_movimiento ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			return false;
		}
	    return $lb_valido;
	} // end function uf_scf_delete_movimiento
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_procesar_insert_movimiento($as_codemp,$as_procede, $as_comprobante, $as_fecha,
    ...
    {											  
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_procesar_insert_movimiento
		//		   Access: public 
		//       Argument: as_codemp // Código de empresa
		//       		   as_procede // Procedencia del documento
		//       		   as_comprobante // Número de Comprobante
		...
		if($this->uf_scf_select_movimiento($as_cuenta,$as_procede_doc,$as_documento,$as_debhab,&$adec_monto_actual,&$li_orden)) 
		{
		   $this->is_msg_error="ERROR-> El movimiento contable ya existe";
		   return false; 	
		}
		$lb_valido=$this->uf_scf_insert_movimiento($as_cuenta,$as_procede_doc,$as_documento,$as_debhab,$as_descripcion,$adec_monto_actual);
		if($lb_valido) 
		{ 
			$lb_valido=$this->uf_scf_procesar_saldos_contables($as_cuenta,$as_debhab,$adec_monto_anterior,$adec_monto_actual);
		}
		return $lb_valido;
	} //end function uf_scf_procesar_insert_movimiento
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_procesar_update_movimiento($as_codemp,$as_procede, $as_comprobante, $as_fecha,
                                     	       $as_tipo_destino,$as_cod_prov, $as_ced_bene, $as_cuenta,
										       $as_procede_doc, $as_documento,$as_debhab,$as_descripcion,
										       $adec_monto_anterior, $adec_monto_actual,$as_codban,$as_ctaban)
    {											  
		...
		$lb_valido = $this->uf_scf_delete_movimiento($as_codemp,$as_procede,$as_comprobante,$as_fecha,$as_cuenta,$as_procede_doc,$as_documento,$as_debhab,$as_codban,$as_ctaban);
		if($lb_valido)  
		{ 
			$lb_valido=$this->uf_scf_procesar_saldos_contables($as_cuenta,$as_debhab,$adec_monto_anterior,0); 
		}	 		
		$lb_valido=$this->uf_scf_insert_movimiento($as_cuenta,$as_procede_doc,$as_documento,$as_debhab,$as_descripcion,$adec_monto_actual);
		if($lb_valido) 
		{ 
			$lb_valido = $this->uf_scf_procesar_saldos_contables($as_cuenta,$as_debhab,0,$adec_monto_actual);
		}
		return $lb_valido;
	} //end function uf_scf_procesar_insert_movimiento
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_insert_movimiento($as_cuenta,$as_procede_doc,$as_documento,$as_debhab,$as_descripcion,$adec_monto)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_procesar_insert_movimiento
		//		   Access: public 
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$li_orden=$this->uf_scf_obtener_orden_movimiento();
		...
		$ls_sql="INSERT INTO scg_dt_cmp (codemp,procede,comprobante,fecha,codban,ctaban,sc_cuenta,procede_doc,documento,debhab,descripcion,".
				"						 monto,orden) " . 
				" VALUES ('".$this->is_codemp."','".$this->is_procedencia."','".$this->is_comprobante."','".$ls_fecha."','".$this->as_codban."','".$this->as_ctaban."',".
		...
		if($li_result===false)
		{
			...
			{   
				$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_scf_insert_movimiento ERROR->Fallo alguna clave foranea";
			}
			else
			{
				$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_scf_insert_movimiento ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			}
		   	$lb_valido=false;
		}
		return $lb_valido;
	} // end function uf_scf_insert_movimiento
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_obtener_orden_movimiento()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_obtener_orden_movimiento
		//		   Access: public 
		...
		if($rs_saldos===false)
		{
			$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_scf_obtener_orden_movimiento ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			$lb_valido=false;
		}
		else
		{
		...
		return $li_orden;
	} // end function uf_scf_obtener_orden_movimiento
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_pad_scf_cuenta($as_formcont,$as_cuenta)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_pad_scf_cuenta
		//		   Access: public 
		...
		return $ls_cadena;
	} // end function uf_pad_scf_cuenta
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_next_cuenta_nivel($as_cuenta)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_next_cuenta_nivel
		//		   Access: public 
		...
		$ls_cadena="";
		$ls_fill="";
		$li_MaxNivel=count($this->ia_niveles_scf);
		$li_nivel=$this->uf_scf_obtener_nivel($as_cuenta);
		if($li_nivel>1)
		{
			$li_anterior=$this->ia_niveles_scf[ $li_nivel - 1 ]; 	
			$ls_cadena=substr($as_cuenta,0, $li_anterior+1);
			$li_longitud=strlen($ls_cadena);
			$li_long=(($this->ia_niveles_scf[$li_MaxNivel]+1) - $li_longitud);
			$ls_newcadena=$this->io_function->uf_cerosderecha(trim($ls_cadena),$li_long+$li_longitud);
			$ls_cadena=$ls_newcadena;
		}
		return $ls_cadena;
	} // end function uf_scf_next_cuenta_nivel	
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_obtener_nivel($as_cuenta)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_obtener_nivel
		//		   Access: public 
		//      Arguments: as_cuenta // cuenta contable
		...
		$li_longitud=0;
		$ls_cadena="";
		$li_nivel=count($this->ia_niveles_scf);
		do
		{		
			$li_anterior = $this->ia_niveles_scf[ $li_nivel - 1 ]  + 1;
			$li_longitud = $this->ia_niveles_scf[ $li_nivel ] - $this->ia_niveles_scf[ $li_nivel - 1 ];
		...
		return $li_nivel;
	} // end function uf_scf_obtener_nivel
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_sin_ceros($as_cuenta)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_sin_ceros
		//		   Access: public 
		//      Arguments: as_cuenta // cuenta contable
		...
		$ls_cadena="";
		$li_nivel=$this->uf_scf_obtener_nivel($as_cuenta);
		$li_anterior=$this->ia_niveles_scf[$li_nivel];
		$ls_cadena=substr($as_cuenta,0,$li_anterior+1);	
		return $ls_cadena;
	} // end function uf_scf_sin_ceros
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_select_cuenta($as_codemp,$as_sc_cuenta,&$as_status,&$as_denominacion)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_select_cuenta
		//		   Access: public 
		...
		if ($rs_cuentas===false)
		{
			$this->is_msg_error = "CLASE->tepuy_int_scf MÉTODO->uf_scf_select_cuenta ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			return false;
		}
		else
		{
		...
		return $lb_existe;
	}  // end function uf_scf_select_cuenta()
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_select_cuenta_sin_cero($as_codemp,$as_cuenta)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_select_cuenta_sin_cero
		//		   Access: public 
		//      Arguments: as_codemp // Código de Empresa
		//      		   as_cuenta // cuenta contable
		...
		if ($rs_data===false)
		{
			$this->is_msg_error = "CLASE->tepuy_int_scf MÉTODO->uf_scf_select_cuenta_sin_cero ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			return false;
		}
		else
		{
		...
		return $li_total;
	}// end function uf_scf_select_cuenta_sin_cero
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_select_cuenta_movimiento($as_codemp,$as_sc_cuenta)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_select_cuenta_movimiento
		//		   Access: public 
		//      Arguments: as_codemp // Código de Empresa
		//      		   as_sc_cuenta // cuenta contable
		...
		if ($rs_data===false)
		{
			$this->is_msg_error = "CLASE->tepuy_int_scf MÉTODO->uf_scf_select_cuenta_movimiento ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			return false;
		}
		else
		{
		...
		return $lb_existe;
	}// end function uf_scf_select_cuenta_movimiento
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_select_plan_unico($as_cuenta)
	{
		...
		{
		   $lb_valido=false;
		   $this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_select_plan_unico ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
		}
		else
		{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_valida_cuenta($as_codemp,$as_cuenta)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_valida_cuenta
		//		   Access: public 
		//      Arguments: as_codemp // Código de Empresa
		//      		   as_cuenta // cuenta contable
		//	  Description: Método que verifica si existe o no la cuenta
		...
		{
			$lb_existe=false; 
			$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_scf_valida_cuenta ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
		}
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
		...
		return $lb_existe;
	} // end function uf_scf_valida_cuenta
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_procesar_saldos_contables($as_cuenta,$as_debhab,$adec_monto_anterior,$adec_monto_actual)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_procesar_saldos_contables
		//		   Access: public 
		//      Arguments: as_cuenta // Cuenta Contable
		...
		$li_nivel=$this->uf_scf_obtener_nivel( $ls_nextCuenta );
		do 
		{
			if ($this->uf_scf_select_saldo($ls_nextCuenta,$ls_fecha)) 
			{
				$lb_valido=($this->uf_scf_update_saldo($ls_nextCuenta,$ls_fecha,$adec_monto_anterior,$adec_monto_actual,$as_debhab)); 
			}		
			else
			{
				$lb_valido=($this->uf_scf_insert_saldo($ls_nextCuenta,$ls_fecha,$adec_monto_actual,$as_debhab)); 
			}
			if
			($this->uf_scf_obtener_nivel($ls_nextCuenta)==0)
			{
				break;
			}
			$ls_nextCuenta=$this->uf_scf_next_cuenta_nivel($ls_nextCuenta);
			if($ls_nextCuenta!="")
			{
				$li_nivel=($this->uf_scf_obtener_nivel($ls_nextCuenta));
			}
		...
		return $lb_valido;
	} // end function uf_scf_procesar_saldos_contables
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_select_saldo($as_cuenta,$as_fecha)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_select_saldo
		//		   Access: public 
		//      Arguments: as_cuenta // Cuenta Contable
		...
		if($rs_data===false)
		{
			 $this->is_msg_error = "CLASE->tepuy_int_scf MÉTODO->uf_scf_select_saldo ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			 $lb_existe = false;		
		}
		else
		{
		...
		return $lb_existe;
	} // end function uf_scf_select_saldo
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_update_saldo($as_sc_cuenta,$as_fecha,$adec_monto_anterior,$adec_monto_actual,$as_debhab)
    {	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_update_saldo
		//		   Access: public 
		...
		return $lb_valido;
	} // end function uf_scf_update_saldo
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_insert_saldo($as_cuenta,$as_fecha,$adec_monto_actual,$as_debhab)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_insert_saldo
		//		   Access: public 
		//      Arguments: as_cuenta // Cuenta Contable
		//      		   as_fecha // Fecha del movimiento
		//      		   adec_monto_actual // Monto Actual del movimiento
		...
		if($li_exec===false)
		{
			$this->is_msg_error = "CLASE->tepuy_int_scf MÉTODO->uf_scf_insert_saldo ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			$lb_valido=false;
		}
		return $lb_valido;
	} // end function uf_scf_insert_saldo
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_select_plan_unico_cuenta($as_sc_cuenta,$as_denominacion)
	{
		...
		if($rs_data===false)
		{
			$this->is_msg_error = "CLASE->tepuy_int_scf MÉTODO->uf_select_plan_unico_cuenta ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			return false;
		}
		else
		{
    ...
    {	
		...
		$ls_sql="SELECT sig_cuenta,denominacion ".
				"  FROM tepuy_plan_unico_re ".
				" WHERE sig_cuenta='". $as_sc_cuenta ."'";
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
			$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_select_plan_unico_cuenta_recurso ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			return false;
		}
		else
		{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function  uf_scf_insert_cuenta($as_codemp,$as_cuenta,$as_denominacion,$as_status,$ai_nivel,$as_cuenta_ref,$as_mensaje)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_insert_cuenta
		//		   Access: public 
		//      Arguments: as_codemp // Código de Empresa
		//      		   as_cuenta // Cuenta Contable
		//      		   as_denominacion // Denominación de la cuenta contable
		...
		if($li_result===false)
		{
			$this->is_msg_error = "CLASE->tepuy_int_scf MÉTODO->uf_scf_insert_cuenta ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			$lb_valido=false;
		}
		return $lb_valido;
	 } // end function uf_scf_insert_cuenta
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_cargar_datastore_plan_cuentas($ads_cuentas)
	{
		...
		{
			$lb_valido=false;
			$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_cargar_datastore_plan_cuentas ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
		}
		else
		{
	...
	function uf_cargar_comprobante_cierre($as_codemp,$as_procede,$as_comprobante,$as_fecha)
	{
		...
		$ls_sql="SELECT C.procede, C.comprobante, C.fecha, D.descripcion, D.sc_cuenta, D.debhab, D.monto, D.documento, CTA.status ". 
				"  FROM tepuy_cmp C,scg_dt_cmp D,scg_cuentas CTA ".
		...
		{
			$lb_valido=false;
			$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_cargar_comprobante_cierre ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
		}
		else
		{
			while ($row=$this->io_sql->fetch_row($rs_data)) 
	...
	function uf_cargar_comprobante_cierre_delete($as_codemp,$as_procede,$as_comprobante,$as_fecha)
	{
		...
		{
			$lb_valido=false;
			$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_cargar_comprobante_cierre_delete ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
		}
		else
		{
			while ($row=$this->io_sql->fetch_row($rs_data)) 
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_fecha_cierre($as_fecha,$ai_day)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_fecha_cierre
		//		   Access: public 
		...
		return $ls_fecha;
	} // end function uf_scf_fecha_cierre
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_cargar_datastore_cuentas($ads_cuentas,$as_cuentas)
	{
		...
		{
			$lb_valido=false;
			$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_cargar_datastore_cuentas ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
		}
		else
		{
			while ($row=$this->io_sql->fetch_row($rs_data)) 
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	 function uf_scf_cargar_detalle_comprobante($as_codemp,$as_procede,$as_comprobante,$as_fecha,$lds_detalle_cmp,$as_codban,
	 											$as_ctaban)
     {	 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_cargar_detalle_comprobante
		//		   Access: public 
		//      Arguments: as_codemp // Código de Empresa
		//      		   as_procede // Procede del Comprobante
		...
		$ls_sql="SELECT DISTINCT DT.sc_cuenta as sc_cuenta, C.denominacion as denominacion, DT.procede_doc as procede_doc, ".
				...
				"  FROM scg_dt_cmp DT, scg_cuentas C, tepuy_procedencias P ".
		...
		if($rs_data==false)
		{
			$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_scf_cargar_detalle_comprobante ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			$lb_valido=false;
		}
		return $rs_data;
	 }  // end function uf_scf_cargar_detalle_comprobante
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_existe_comprobante_cierre()
	{
		...
		$ls_fecha_cierre = $this->uf_scf_fecha_cierre($this->dat_emp["periodo"],-1);
	...
	function uf_scf_make_cierre()
	{
		...
		$ls_cuenta=$this->uf_pad_scf_cuenta($this->dat_emp["formcont"],$ls_cuenta);
		$ls_procede_doc=$this->is_procedencia;
		$lb_existe=$this->uf_scf_select_cuenta($_SESSION["la_empresa"]["codemp"],$ls_cuenta,&$ls_status,&$ls_denominacion);
		$this->as_codban="---";
		$this->as_ctaban="-------------------------";
		if($lb_existe)
		{
			if($this->uf_scf_saldo($ls_cuenta,&$ldec_saldo,$this->id_fecha))
			{
				if($ldec_saldo!=0)
				{ 
					...
					$lb_valido = $this->uf_scf_procesar_insert_movimiento($this->is_codemp,$this->is_procedencia,$this->is_comprobante,$this->id_fecha,$this->is_tipo,$this->is_cod_prov,$this->is_ced_ben,$ls_cuenta,$ls_procede_doc,$ls_documento,$ls_operacion,$ls_descripcion,$ldec_monto_anterior,$ldec_monto_actual,$this->as_codban,$this->as_ctaban);
					if(!($lb_valido))
					{
						return false;
					}	 	
		...
		while ($row=$this->io_sql->fetch_row($rs_cierre))
		{
			$ldec_saldo=0;	
			$ls_cuenta = $row["sc_cuenta"];
			$lb_saldo=$this->uf_scf_saldo($ls_cuenta,&$ldec_saldo,$this->id_fecha);
			if($lb_saldo)
			{
		...
		return $lb_valido;
	 }  // end function uf_scf_make_cierre
 	//-----------------------------------------------------------------------------------------------------------------------------------

 	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_saldo($as_cuenta,&$adec_saldo,$adt_fec_cierre)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_saldo
		//		   Access: public 
		//      Arguments: as_cuenta // Cuenta Contable
		...
		$this->is_codemp=$_SESSION["la_empresa"]["codemp"];////agregado 22/02/2008

		if(!$this->uf_scf_select_cuenta($this->is_codemp,$as_cuenta,&$ls_status,&$ls_denominacion))
		{
		...
		if($rs_saldo===false)
		{
			$this->is_msg_error = "CLASE->tepuy_int_scf MÉTODO->uf_scf_saldo ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			return false;
		}
		else
		{
		...
		return true;
	} // end function de uf_scf_saldo()
 	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_comprobante_update($li_monto)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_comprobante_update
		//		   Access: public 
		...
		if($li_exec===false)
		{
			$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_scf_comprobante_update ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			$lb_valido=false;
		}	   
		return $lb_valido;
	}  // end function uf_scf_comprobante_update
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_comprobante_update_cero()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_comprobante_update_cero
		//		   Access: public 
		...
		//	      Returns: booleano lb_valido
		//	   Creado Por: Ing. Juniors Fraga
		// Modificado Por: Ing. Miguel Palencia								Fecha Última Modificación : 14/08/2007
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ld_fecha=$this->io_function->uf_convertirdatetobd($this->id_fecha);
		$ls_sql="UPDATE tepuy_cmp ".
		...
		if($li_exec===false)
		{
			$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_scf_comprobante_update_cero ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			$lb_valido=false;
		}	   
		return $lb_valido;
	}  // end function uf_scf_comprobante_update_cero
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_insert_plan_unico_cuenta($as_cuenta,$as_denominacion,$as_status)
	{
		...
		if($this->uf_select_plan_unico($as_cuenta))
		{
			if($as_status=='C')
			{
				$ls_sql="UPDATE tepuy_plan_unico ".
						"   SET denominacion='".$as_denominacion."'".
						" WHERE sc_cuenta='".trim($as_cuenta)."'";
				$li_exec=$this->io_sql->execute($ls_sql);
				if($li_exec===false)
				{
					$this->is_msg_error="CLASE->tepuy_int_scf MÉTODO->uf_insert_plan_unico_cuenta ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
		...
		{
			$ls_sql="INSERT INTO tepuy_plan_unico (sc_cuenta,denominacion) ".
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_update_cuenta($as_codemp,$as_sc_cuenta,$as_denominacion)
	{	 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_update_cuenta
		//		   Access: public 
		//      Arguments: as_codemp  // Código de Empresa
		//				   as_cuenta // cuenta Contable
		//    			   as_denominacion // Denominación de la cuenya
		...
		if($li_result===false)
		{
			$this->is_msg_error = "CLASE->tepuy_int_scf MÉTODO->uf_scf_update_cuenta ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			$this->io_sql->rollback();		  			
			return false;
		}
		else 
		...
		return $lb_valido;
	} // end function uf_scf_update_cuenta
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_delete_cuenta($as_codemp, $as_cuenta)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_update_cuenta
		//		   Access: public 
		...
		if($li_result===false)
		{
			$this->is_msg_error = "CLASE->tepuy_int_scf MÉTODO->uf_scf_delete_cuenta ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message);
			$this->io_sql->rollback();					
			$lb_valido = false;
		}
		else
		...
		return $lb_valido;
	} // end function uf_scf_delete_cuenta
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------------------------------------------------------------------------------------
    function uf_scf_procesar_cierre()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_scf_procesar_cierre
		//		   Access: public 
...
//		$this->io_sql->begin_transaction();
		...
		if($lb_valido)
		{
			...
			{                 
				$lb_valido = $this->uf_tepuy_insert_comprobante($this->is_codemp,$this->is_procedencia,$this->is_comprobante,
				...
				if($lb_valido)
				{
					$lb_valido = $this->uf_scf_make_cierre();
					if (!($lb_valido))
					{
						$this->io_sql->rollback();
						return false;
		...
		return $lb_valido ;
	 }  // end function uf_scf_procesar_cierre
 	//-----------------------------------------------------------------------------------------------------------------------------------

 	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_procesar_movimiento_cmp($as_codemp,$as_procedencia,$as_comprobante,$ad_fecha,$as_proveedor,$as_beneficiario,
											...
											$as_descripcion,$adec_monto,$as_codban,$as_ctaban)
	{
		...
		if(!$this->uf_scf_select_cuenta($as_codemp,$as_sc_cuenta,&$ls_status,&$ls_denominacion))
		{
		...
		if($this->uf_scf_select_movimiento($as_sc_cuenta,$as_procede_doc,$as_documento,$as_operacion, &$adec_monto_anterior,&$ai_orden))
		{	
		...
		if($lb_valido)
		{
			$lb_valido= $this->uf_scf_insert_movimiento($as_sc_cuenta,$as_procede_doc,$as_documento,$as_operacion,$as_descripcion,&$adec_monto);
		}
		if($lb_valido)
		{
			$lb_valido = $this->uf_scf_procesar_saldos_contables($as_sc_cuenta,$as_operacion,$adec_monto_anterior,$adec_monto);
		}
		//-- Realizo transaccion --
		if($lb_valido)
		{
		...
		return $lb_valido;
	}  // end function uf_scf_procesar_movimiento_cmp
 	//-----------------------------------------------------------------------------------------------------------------------------------

 	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_scf_update_movimiento($as_cuenta, $as_procede_doc, $as_documento, $as_debhab, $as_descripcion, $adec_monto)
	{
		////////////////////////////////////////////////////////////////////////////////////////////////////
		// 	 Function:  uf_scf_insert_movimiento
		// 	   Access:  public
		...
		return $lb_valido;
	} // end function uf_scf_update_movimiento	
 	//-----------------------------------------------------------------------------------------------------------------------------------
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 }
?>
