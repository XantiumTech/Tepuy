...
if($ls_operacion=="BUSCAR")
{
	$ls_sql="SELECT scv_solicitudviatico.codsolvia,scv_solicitudviatico.codmis,scv_solicitudviatico.codrut,".
			...
			"       scv_solicitudviatico.fecregvia,scv_solicitudviatico.obssolvia,scv_solicitudviatico.monsolvia,".
			"       scv_solicitudviatico.numdiavia,scv_solicitudviatico.estsolvia,scv_solicitudviatico.solviaext,".
			"       scv_misiones.denmis,scv_rutas.desrut,scv_dt_personal.ficha,".
			"       (SELECT denuniadm".
			...
			"  FROM scv_solicitudviatico,scv_misiones,scv_rutas,scv_dt_personal".
			...
			" GROUP BY scv_solicitudviatico.codemp,scv_solicitudviatico.codsolvia,scv_solicitudviatico.codmis,scv_solicitudviatico.codrut,".
            "          scv_solicitudviatico.fecsolvia,scv_solicitudviatico.coduniadm,scv_solicitudviatico.fecsalvia,".
			"          scv_solicitudviatico.fecregvia,scv_solicitudviatico.obssolvia,".
			"          scv_solicitudviatico.numdiavia,scv_solicitudviatico.estsolvia,scv_solicitudviatico.solviaext,".
			"          scv_misiones.denmis,scv_rutas.desrut".
		...
		for($z=1;$z<=$totrow;$z++)
		{
			switch ($ls_destino)
			{
				case "SOLICITUD":
					...
					$li_monsolvia=number_format($li_monsolvia,2,',','.');
					print "<td align='center'><a href=\"javascript: aceptar('$ls_codsolvia','$ls_codmis','$ls_denmis','$ls_codrut',".
						  "                                                 '$ls_desrut','$ld_fecsolvia','$ls_coduniadm','$ls_denuniadm',".
						  "													'$ld_fecsalvia','$ld_fecregvia',".
						  "                                                 '$ls_obssolvia','$li_numdiavia',".
						  "                                                 '$ls_estsolvia','$li_solviaext','$li_monsolvia');\">".$ls_codsolvia."</a></td>";
				...
				case "CALCULO":
					...
					if($ls_estsolvia=="R")
					{
						...
						$li_numdiavia=number_format($li_numdiavia,2,',','.');
						$li_monsolvia=number_format($li_monsolvia,2,',','.');
						print "<td align='center'><a href=\"javascript: aceptar_cal('$ls_codsolvia','$ls_codmis','$ls_denmis','$ls_codrut',".
...
<script language="JavaScript">
  function aceptar(ls_codsolvia,ls_codmis,ls_denmis,ls_codrut,ls_desrut,ld_fecsolvia,ls_coduniadm,ls_denuniadm,
  				   ld_fecsalvia,ld_fecregvia,ls_obssolvia,li_numdiavia,ls_estsolvia,li_solviaext,li_monsolvia)
  {
	...
	//opener.document.form1.txttotsolvia.value=li_monsolvia;
	opener.document.form1.operacion.value="BUSCARDETALLE";
	opener.document.form1.hidestatus.value="C";
	opener.document.form1.action="tepuy_scv_p_solicitudviaticos.php";
	if(li_solviaext==1)
  				       ...
  				       ld_fecsalvia,ld_fecregvia,ls_obssolvia,li_numdiavia,ls_estsolvia,li_solviaext,li_monsolvia)
  {
	...
	opener.document.form1.hidestsolvia.value=ls_estsolvia;
	opener.document.form1.txttotsolvia.value=li_monsolvia;
	opener.document.form1.operacion.value="BUSCARDETALLEPRESUPUESTO";
	opener.document.form1.hidestatus.value="C";
	opener.document.form1.action="tepuy_scv_p_calcularviaticos.php";
	if(li_solviaext==1)
	{opener.document.form1.chksolviaext.checked=true;}
	else
	{opener.document.form1.chksolviaext.checked=false;}
  ...
  function ue_search()
  {
	...
	f.action="tepuy_scv_cat_sol_via.php";
	f.submit();
  }
</script>
</html>
