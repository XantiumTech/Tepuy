<?php
		...
		for ($li_fila=1;$li_fila<=$ai_total;$li_fila++)
		    {
			  ...
			  if ($li_fila==$ai_total)// si el la última fila no pinto el eliminar
			     ...
			     {
				   $lo_object[$li_fila][9]="<a href=javascript:ue_delete_bienes('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";
			     }
		}
		print "<p>&nbsp;</p>";
		  ...
		  for ($li_fila=1;$li_fila<=$ai_total;$li_fila++)
		      {
				...
				if ($li_fila==$ai_total)// si el la última fila no pinto el eliminar
			       ...
			       {
				     $lo_object[$li_fila][9] ="<a href=javascript:ue_delete_servicios('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";
			       }
		      }
		print "<p>&nbsp;</p>";
	...
	{	
		...
		require_once("tepuy_soc_c_registro_cotizacion.php");
		$io_registro = new tepuy_soc_c_registro_cotizacion("../../");
		...
		while ($row=$io_registro->io_sql->fetch_row($rs_data))	  
		      {
				...
				$ld_porcre = $io_registro->uf_load_porcentaje_iva_2016($ls_codcar,$lb_valido);//Porcentaje del Crédito en caso de tenerlo.
