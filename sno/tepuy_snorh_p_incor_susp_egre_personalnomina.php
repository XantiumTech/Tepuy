<?php
	...
	$io_fun_nomina->uf_load_seguridad("SNR","tepuy_snorh_p_incor_susp_egre_personalnomina.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<?php
	...
	require_once("tepuy_snorh_c_incor_susp_egre_personal.php");
	...
	$io_c_incorsuspegr= new tepuy_snorh_c_incor_susp_egre_personal();
        ...
        <td width="583" valign="top">
		  ...
		  <table width="500" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
              ...
              <tr>
                ...
                <td colspan="4">
                  <div align="left">
                    <input name="txtfecsusper" type="text" id="txtfecsusper" onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" value="<?php print $ldt_fecsusper ; ?>" size="15" maxlength="15" datepicker="true">
</div></td>
              </tr>
            <tr>
...
function uf_change_radio()
{
	...
	f.action="tepuy_snorh_p_incor_susp_egre_personalnomina.php";
	f.submit();
}		
