...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  <tr> 
    <td height="50" class="cd-logo"><img src="../shared/imagebank/header.jpg" width="778" height="40"></td>
  </tr>
  <tr>
    <td height="40" class="cd-menu">
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
			
          <td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Control de Viaticos-->Beneficiarios</td>
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SCV";
	$ls_ventanas = "tepuy_scv_d_beneficiario.php";
                        ...
                        if (valida_null(txtapellido,"El Apellido esta vacio!!")==false)
		                ...
		                else
		                   {
		                     if (valida_null(txtdireccion,"La Dirección esta vacia!!")==false)
		                        ...
		                        {
		                          if (valida_null(txtcontable,"El Código Contable en la O. Pago (a Nivel del Causado) esta vacio!!")==false) 
	   		                         {
	   	                               txtcontable.focus();
		                             }
			                      else
						 {
						if (valida_null(txtcontablecomp,"El Código Contable en la Solicitud (a Nivel del Compromiso) esta vacio!!")==false) 
	   		                         {
										    ...
										    else
											   {
												 if (f.cmbmunicipio.value!='---' && f.cmbparroquia.value=='---') 
												 ...
												 else
												    {
													  ...
													  f.action="tepuy_scv_d_beneficiario.php";
													  f.submit();
												    }
											  } 
										  }
...
{
	f.operacion.value="";			
	pagina="tepuy_scv_cat_bancos_sigecof.php";
