...
if (!array_key_exists("la_logusr",$_SESSION))
   {
	...
	$ls_reporte=$io_rpc->uf_select_config("RPC","REPORTE","LISTADO_PROVEEDORES","tepuy_rpc_rpp_proveedor.php","C");
	unset($io_rpc);
?>
    ...
    if (codprov1<=codprov2)
	   {
			...
			//reporte=f.reporte.value;
			pagina="reportes/tepuy_rpc_rpp_proveedor_excel.php?hidorden="+li_orden+"&hidtipo="+ls_tipo+"&hidcodprov1="+codprov1+"&hidcodprov2="+codprov2+"&hidcodesp="+codigoesp;
			window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
	   }
    else
	   {
