<?php
class tepuy_c_generar_consecutivo
 {
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_c_generar_consecutivo()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_c_generar_consecutivo
		//		   Access: public 
	...
	}// end function tepuy_c_generar_consecutivo
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_load_data_existente($as_tabla,$as_campo,$as_filtro,$as_valor,$as_prefijo)
	{
		...
		// Fecha Creación: 26/07/2007 								Fecha Última Modificación : 
		//////////////////////////////////////////////////////////////////////////////
		require_once("tepuy_release.php");
