...
stm_aix("p1i0","p0i0",[0,"Comprobante Contable ","","",-1,-1,0,"tepuywindow_scg_comprobante.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i2","p1i0",[0,"Comprobante Cierre de Ejercicio ","","",-1,-1,0,"tepuywindow_scg_cmp_cierre.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
...
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
// Edición - Opciones de Tercer Nivel
stm_aix("p1i5","p1i0",[0," Mensual  ","","",-1,-1,0,"tepuy_scg_wproc_progrep.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Trimestral  ","","",-1,-1,0,"tepuy_scg_wproc_progrep_trim.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
...
stm_aix("p1i5","p1i0",[0," Mensual  ","","",-1,-1,0,"tepuy_scg_wproc_prog_oaf.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Trimestral  ","","",-1,-1,0,"tepuy_scg_wproc_prog_oaf_trim.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
/*
...
stm_aix("p1i0","p0i0",[0," Mayor Analitico ","","",-1,-1,0,"tepuy_scg_r_mayor_analitico.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i2","p1i0",[0," Balance de Comprobaci&oacute;n ","","",-1,-1,0,"tepuy_scg_r_balance_comprobacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
...
stm_aix("p1i5","p1i0",[0," Formato 1  ","","",-1,-1,0,"tepuy_scg_r_comprobante_formato1.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Formato 2  ","","",-1,-1,0,"tepuy_scg_r_comprobante_formato2.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
stm_aix("p1i2","p1i0",[0," Estado de Resultado ","","",-1,-1,0,"tepuy_scg_r_estado_resultado.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i2","p1i0",[0," Balance General ","","",-1,-1,0,"tepuy_scg_r_balance_general.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i0","p0i0",[0," Listado de Cuentas ","","",-1,-1,0,"tepuy_scg_r_cuentas.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i0","p0i0",[0," Movimientos del Mes ","","",-1,-1,0,"tepuy_scg_r_movimientos_mes.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
//stm_ep();
stm_aix("p1i2","p1i2",[0," Comparados ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p2","p1",[1,2,0,0,2,3,0]);
stm_aix("p1i2","p1i2",[0," Instructivo 2007 ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p2","p1",[1,2,0,0,2,3,0]);
stm_aix("p1i2","p1i2",[0," Instructivo 04 ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p2","p1",[1,2,0,0,2,3,0]);
stm_aix("p1i5","p1i0",[0," Estado de Resultado Forma 0406  ","","",-1,-1,0,"tepuy_scg_r_comparados_est_resultado.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
stm_aix("p1i2","p1i2",[0," Instructivo 07 ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p2","p1",[1,2,0,0,2,3,0]);
stm_aix("p1i5","p1i0",[0," Inversiones  Forma 0714","","",-1,-1,0,"tepuy_scg_r_comparados_forma0714.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Balance General Forma 0718","","",-1,-1,0,"tepuy_scg_r_comparados_balance_general.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i5","p1i0",[0," Origen y Aplicación de Fondos Forma 0719","","",-1,-1,0,"tepuy_scg_r_comparados_oaf.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
stm_ep();
stm_aix("p1i2","p1i2",[0," Instructivo 2008 ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p2","p1",[1,2,0,0,2,3,0]);
stm_aix("p1i5","p1i0",[0," Balance General Forma 07","","",-1,-1,0,"tepuy_scg_r_balance_general_07.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
stm_ep();
stm_ep();
...
stm_bpx("p5","p1",[1,4,0,0,2,3,6,7]);
stm_aix("p1i0","p0i0",[0," Configuración Origen y Aplicación de Fondos ","","",-1,-1,0,"tepuy_scg_ctas_oaf.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
