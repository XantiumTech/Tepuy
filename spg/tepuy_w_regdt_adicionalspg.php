...
///////////////Guardar los detalles del presupuesto////////////////////////////////////
...
<table width="583" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  ...
  <tr>
   ...
   <tr>
    ...
    <td>
      <input name="codestpro1" type="text" id="codestpro1" style="text-align:center" size="22" maxlength="20" readonly>
  ...
  <tr>
    ...
    <a href="javascript:catalogo_cuentasSPG();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Catálogo de Cuentas de Gastos"></a>	 <input name="txtdenominacion" type="text" class="sin-borde" id="txtdenominacion" style="text-align:left" value="<?php print $ls_denominacion ?>" size="50" maxlength="254"></td>
  </tr>
  <tr>
    <td height="22"><div align="right">Operaci&oacute;n</div></td>
    <td><div align="left">      <input name="txtoperacion" type="text" id="txtoperacion" style="text-align:center " size="22" maxlength="3" value ="<?php print $ls_operacionpre;?>" readonly>
    </div></td>
  </tr>
  <tr>
...
<script language="JavaScript">
  function aceptar_presupuestario()
  {
    ...
    if(estmodest==1)
	{
		if((ls_cuenta!="")&&(ls_estpro1!="")&&(ls_estpro2!="")&&(ls_estpro3!="")&&(ls_descripcion!="")&&(ls_procedencia!="")&&
		(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto!=""))
		{
			f.operacion.value="GUARDARPRE";
			f.action="tepuy_w_regdt_adicionalspg.php";
			f.submit();
		}
		else
		{
	...
	else
	{
		...
		(ls_descripcion!="")&&(ls_procedencia!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto!=""))
		{
			f.operacion.value="GUARDARPRE";
			f.action="tepuy_w_regdt_adicionalspg.php";
			f.submit();
