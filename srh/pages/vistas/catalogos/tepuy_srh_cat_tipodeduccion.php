...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_tipodeduccion.js"></script>
...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_tipodeduccion.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_tipodeduccion.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_tipodeduccion.php?valor=buscar"+"&txtcodtipded="+codtipded+"&txtdentipded="+dentipded);
		   setTimeout (terminar_buscar,500);
