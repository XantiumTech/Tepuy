...
class tepuy_srh_c_evaluacion_desempeno
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_evaluacion_desempeno($path)
	{  
...
function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_p_evaluacion_desempeno)
		//      Argumento: 
...
function uf_srh_buscar_evaluacion_desempeno($as_nroeval,$as_fecha1,$as_fecha2)
	{
		...
		//         access: public (tepuy_srh_evaluacion_desempeno)												
		//      Argumento: $as_nroeval   //  código de la evaluación de desempeño
 ...
 function uf_srh_guardar_evaluacion_odi($ao_evaluacion, $aa_seguridad)
  { 
	 ...
	 if (($ao_evaluacion->pesran==0) || ($ao_evaluacion->pesran=='0'))
	 {
	  ...
	  $ls_sql = "INSERT INTO srh_evaluacion_odi (nroeval, odi, rango, peso_rango, codemp) ".	  
	            " VALUES ('$ao_evaluacion->nroeval','$ao_evaluacion->odi','$ao_evaluacion->rango', '$ao_evaluacion->pesran','".$this->ls_codemp."')";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="SELECT * ".
				...
				"  AND srh_evaluacion_odi.odi = srh_dt_odi.odi ".
				...
				" ORDER BY srh_evaluacion_odi.odi ";
		...
		else
		{
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ao_object[$ai_totrows][1]="<textarea name=txtodi".$ai_totrows."  cols=60 rows=3 id=txtodi".$ai_totrows." class=sin-borde readonly>".$ls_odi."</textarea>";
...
}// end   class tepuy_srh_c_evaluacion_desempeno
?>
