...
if($ls_operacion=="BUSCAR")
{
	$ls_sql=" SELECT codestpro1,codestpro2,denestpro2 ".
	        " FROM spg_ep2 ".
			" WHERE codemp='".$ls_codemp."' AND codestpro1 ='".$ls_codestprog1."' AND codestpro2 like '".$ls_codigo."' AND ".
			" denestpro2 like '".$ls_denominacion."' ";
...
print "</table>";
 ...
 { ?>
   ...
   alert("No se han creado estructuras de Nivel 2 !!!");
   close();
   </script>
 <?php
 }
