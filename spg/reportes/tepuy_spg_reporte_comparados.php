...
/********************************************************************************************************************************/	
class tepuy_spg_reporte_comparados
{
    //conexion	
	var $sqlca;   
	...
	var $dts_prog;
/********************************************************************************************************************************/	
    function  tepuy_spg_reporte_comparados()
    {
...
/********************************************************************************************************************************/	
    ...
    function uf_spg_reportes_comparados_ejecucion_financiera_formato3($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,
																	  ...
																	  $as_codestpro5_des,$as_ctasinmov,$as_ominoprog,                                                                      $as_trimestres,$ai_nivel)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    30/05/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido = false;	 
		...
		else
		{
		  ...
		  $ls_sql=" SELECT spg_cuenta, nivel, max(denominacion) as denominacion, sum(asignado) as asignado, ".
                  ...
                  " FROM   spg_cuentas  ".
                  " WHERE  codemp='".$ls_codemp."' AND ".$ls_cadena." between '".$ls_estructura_desde."' AND '".$ls_estructura_hasta."' ".
                  " GROUP BY spg_cuenta ".
                  " ORDER BY spg_cuenta ";
		}
...
/****************************************************************************************************************************************/	
    function uf_spg_reporte_calcular_programado_r($as_codrep,$as_spg_cuenta,$as_estructura_desde,$as_estructura_hasta,$ai_mesdes,
	                                              $ai_meshas,&$ad_monto_programado,&$ad_monto_acumulado,$as_forma)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/******************************************************************************************************************/
    function uf_spg_reportes_select_ejecucion_financiera_global()
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_select_ejecucion_financiera_global
	 //         Access :	private
	 //     Argumentos :    $as_codestpro3 // codigo
	 ...
	 $ls_sql=" SELECT ".$ls_cadena." as programatica ".
             " FROM spg_cuentas ";
	 $rs_data=$this->SQL->select($ls_sql);
	 if($rs_data===false)
	 {   // error interno sql
...
/****************************************************************************************************************************************/
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $ls_sql=" SELECT distinct ".$ls_cadena." as programatica ".
             " FROM spg_cuentas ".
			 " WHERE codemp='".$ls_codemp."' AND ".$ls_cadena." ".
...
/****************************************************************************************************************************************/
	////////////////////////////////////////////////////////////////////////////
	//   CLASE REPORTES SPG  COMPARADOS " EJECUCION FINANCIERA  GLOBAL " //
	///////////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_comparados_ejecucion_financiera_global($as_ctasinmov,$as_ominoprog,$as_combomes,$ai_nivel,$as_cant_mes)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_comparados_ejecucion_financiera_GLOBAL
	 //         Access :	private
	 //     Argumentos :    as_codestpro1_ori ... $as_codestpro5_ori //rango nivel estructura presupuestaria origen
	 //                     as_codestpro1_des ... $as_codestpro5_des //rango nivel estructura presupuestaria destino
     //	       Returns :	Retorna true o false si se realizo la consulta para el reporte
	 //	   Description :	Reporte que genera salida  del Ejecucion Financiera Formato 3
	 //     Creado por :    Ing. Miguel Palencia.
	 // Fecha Creación :    13/05/2010          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido = false;	 
		$ls_gestor = $_SESSION["ls_gestor"];
		$ls_codemp = $this->dts_empresa["codemp"];
		...
		if($as_ominoprog==1)
		{
		  ...
		  $ls_sql=" SELECT c.spg_cuenta, c.nivel, max(c.denominacion) as denominacion, sum(c.asignado) as asignado, ".
				  ...
				  "        c.codestpro1,c.codestpro2,c.codestpro3,c.codestpro4,c.codestpro5 ".
                  " FROM   spg_cuentas c, spg_plantillareporte r ".
                  " WHERE  c.codemp=r.codemp AND r.codemp='".$ls_codemp."' AND ".
                  "        (c.spg_cuenta = r.spg_cuenta) AND (r.status <> 'I') AND codrep='0707' AND ".
                  " GROUP BY c.spg_cuenta, c.nivel ".
                  " ORDER BY c.spg_cuenta ";
		}
		else
		{
		...
		else
		{
			while($row=$this->SQL->fetch_row($rs_data))
			{
			   ...
			   $ld_noviembre=$row["noviembre"];
			   $ld_diciembre=$row["diciembre"];
			   $ld_programa=$ls_estructura_desde;
			   ...
			   {	
				  ...
				  if($lb_valido)
				  {
					...
					{// calculo la programacion de los meses anteriores
                      ...
                      $lb_valido=$this->uf_spg_reporte_calcular_meses_anteriores($as_cant_mes,1,$ls_spg_cuenta,$li_mesdes,$ls_estructura_desde,
																				 ...
																				 $ld_ejec_acum_t_ant,$ld_aumento,$ld_disminucion);				
					  ...
					  {		 
						  ...
						  $lb_valido=$this->uf_spg_reporte_calcular_ejecutado_meses($as_cant_mes,1,$ls_spg_cuenta,$li_mesdes,$ls_estructura_desde,
														...
														$lb_pasar,$ld_ejec_acum_t_ant,$ld_aumento,$ld_disminucion);
					 }									
				   }//if($li_mesdes>3) 
				   else
				   {
				  ...
				  if($ldt_mesdes>=2)
				  {
					  $lb_valido=$this->uf_spg_reporte_calcular_meses_anteriores($as_cant_mes,1,$ls_spg_cuenta,$li_mesdes,$ls_estructura_desde,$ls_estructura_hasta,
																				 $li_meshas,$ld_monto_ejecutado,
																				 $ld_monto_acumulado,$ld_aumdismes,$ld_aumdisacum,
																				 $ld_comprometer,$ld_causado,$ld_pagado,$ls_tipo,$ld_ejec_acum_t_ant,$ld_aumento,$ld_disminucion);				
					  $ld_monto_ant=$ld_asignado+($ld_aumdismes+$ld_aumdisacum)-($ld_comprometer+$ld_ejec_acum_t_ant);
                  }
				  else
				  {
			     ...
			     if($lb_valido)
			     {
					 ...
					 $this->dts_reporte->insertRow("disponible_fecha",$ld_dispon_fecha);
					 $this->dts_reporte->insertRow("nivel",$li_nivel);
					 $this->dts_reporte->insertRow("programa",$ld_programa);
     ...
     return $lb_valido;
    }//fin uf_spg_reportes_comparados_ejecucion_financiera_GLOBAL
/****************************************************************************************************************************************/	
...
/****************************************************************************************************************************************/
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //	   Description :	Reporte que genera salida  del Ejecucion Financiera Formato 3
	 //     Creado por :    Ing. Miguel Palencia.
	 // Fecha Creación :    12/06/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido = false;	 
		$ls_gestor = $_SESSION["ls_gestor"];
		$ls_codemp = $this->dts_empresa["codemp"];
		...
		if($as_ominoprog==1)
		{
		  ...
		  $ls_sql=" SELECT c.spg_cuenta, c.nivel, max(c.denominacion) as denominacion, sum(c.asignado) as asignado, ".
                  ...
                  "        (c.spg_cuenta = r.spg_cuenta) AND (r.status <> 'I') AND codrep='0707' AND ".
		          "        ".$ls_cadena."    between '".$ls_estructura_desde."' AND '".$ls_estructura_hasta."' ".
                  " GROUP BY c.spg_cuenta, c.nivel, c.codestpro1,c.codestpro2,c.codestpro3,c.codestpro4,c.codestpro5 ".
                  " ORDER BY c.spg_cuenta ";
		}
		else
		{
		  ...
		  $ls_sql=" SELECT spg_cuenta, nivel, max(denominacion) as denominacion, sum(asignado) as asignado, ".
                  ...
                  " FROM   spg_cuentas  ".
                  " WHERE  codemp='".$ls_codemp."' AND ".$ls_cadena." between '".$ls_estructura_desde."' AND '".$ls_estructura_hasta."' ".
                  " GROUP BY spg_cuenta, nivel, codestpro1, codestpro2, codestpro3, codestpro4, codestpro5 ".
                  " ORDER BY spg_cuenta ";
		}
...
//		    if(($li_comprometer)&&($ldt_fecha>=$li_mesdes)&&($ldt_fecha<=$li_meshas))
		...
		//  if(($li_comprometer)&&($ldt_fecha>=$li_mesantdes)&&($ldt_fecha<=$li_mesanthas))
		  if(($li_comprometer)&&($ldt_fecha<=$li_mesanthas))
		  { 
		    $ad_comprometer=$ad_comprometer+$ld_monto;
		  }//if
		  //Causar
...
/****************************************************************************************************************************************/	
    function uf_spg_reporte_calcular_ejecutado_meses($as_cant_mes,$as_clave,$as_spg_cuenta,$ai_mesdes,$as_estructura_desde,$as_estructura_hasta,
	                                                 $ai_meshas,&$ad_monto_ejecutado,
													 &$ad_monto_acumulado,&$ad_aumdismes,&$ad_aumdisacum,
	                                                 &$ad_comprometer, &$ad_causado,&$ad_pagado,$as_tipo,$ab_pasar,$ad_ejec_acum_t_ant,&$ld_aumento,&$ld_disminucion)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reporte_calcular_ejecutado_trimestre
	 //         Access :	private
	 //     Argumentos :    $as_spg_cuenta  // cuenta
	 ...
	 // Fecha Creación :    02/06/2006          Fecha última Modificacion :      Hora :
	  ...
	  $li_mesdes=$li_ano."-".$this->fun->uf_cerosizquierda($ai_mesdes,2);
	  $li_meshas=$li_ano."-".$this->fun->uf_cerosizquierda($ai_meshas,2);
// ESTO ES PARA ACUMULAR EL AUMENTO Y LA DISMINUCION DESDE ENERO HASTA EL MES QUE REQUIERE //
//	if($li_mesdes>3){ $ai_mesdes='01'; }
/////////////////////////////////////////////////////////////////////////////////////////////
	  if($ab_pasar)
	  {
		  if($li_mesdes>3)
...
//print $ls_sql;
// POR AQUI PASA CUANDO NECESITAMOS ARMAR LA EJECUCION ACUMULADA DEL PRESUPUESTO DE GASTOS 
	  $rs_ejec=$this->SQL->select($ls_sql);
	  if($rs_ejec===false)
	  { // error interno sql
		$this->is_msg_error="Error en consulta metodo uf_spg_reporte_calcular_ejecutado_trimestre".$this->fun->uf_convertirmsg($this->SQL->message);
...
/****************************************************************************************************************************************/
    function uf_spg_reporte_calcular_meses_anteriores($as_cant_mes,$as_clave,$as_spg_cuenta,$ai_mesdes,$as_estructura_desde,$as_estructura_hasta,
	                                                 $ai_meshas,&$ad_monto_ejecutado,
													 &$ad_monto_acumulado,&$ad_aumdismes,&$ad_aumdisacum,
	                                                 &$ad_comprometer, &$ad_causado,&$ad_pagado,$as_tipo,$ad_ejec_acum_t_ant,&$ld_aumento,&$ld_disminucion)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
