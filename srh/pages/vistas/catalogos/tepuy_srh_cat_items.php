...
<br>
    ...
    <td width="173" height="22"><div align="left">
      ...
      <a href="javascript:catalogo_tipoevaluacion();"><img src="../../../../shared/imagebank/tools15/buscar.png" name="buscartip" width="15" height="15" border="0" id="buscartip"></a> </div></td> 
  ...
  <tr>
    ...
    <td width="173" height="22"><div align="left">
      ...
      <a href="javascript:catalogo_aspectos();"><img src="../../../../shared/imagebank/tools15/buscar.png" name="buscartip" width="15" height="15" border="0" id="buscartip"></a> </div></td> 
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td width="173"><div align="right"><a href="javascript: Limpiar_busqueda(); "> <img src="../../../public/imagenes/nuevo.png" alt="Limpiar" width="15" height="15" border="0">Limpiar</a></div></td> 
    <td width="222"><div align="right"><a href="javascript: Buscar()"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Haga click aqu&iacute; para Buscar</a></div></td>
...
{
       f= document.form1;
	   pagina="../catalogos/tepuy_srh_cat_tipoevaluacion.php?valor_cat=0";
...
function catalogo_aspectos()
  {
       f= document.form1;
       pagina="../catalogos/tepuy_srh_cat_aspectos.php?valor_cat=0";
...
function Limpiar_busqueda () 
{
	...
	document.form1.txtdenasp.value="";
		...
		var loadDataURL = "../../php/tepuy_srh_a_items.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_items.php";
...
function Buscar()
		{
		   ...
		   mygrid.loadXML("../../php/tepuy_srh_a_items.php?valor=buscar"+"&txtcodeval="+codeval+"&txtcodasp="+codasp);
...
function aceptar (ls_codeval,ls_deneval,ls_codasp,ls_denasp,ls_codevaldestino,ls_denevaldestino, ls_codaspdestino, ls_denaspdestino)
	{
		...
		opener.document.form1.action="../pantallas/tepuy_srh_d_items.php";
