...
<table width="650" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="22"><div align="left">
          ...
          <input name="estmodest" type="hidden" id="estmodest" value="<?php print $ls_modalidad; ?>">
		   <input name="codestpro1" type="hidden" id="codestpro1">
		   <input name="codestpro2" type="hidden" id="codestpro2">
		   <input name="codestpro3" type="hidden" id="codestpro3">
        </div></td>
      </tr>
      <tr>
        <td height="22"><div align="right"><?php print $_SESSION["la_empresa"]["nomestpro1"];?></div></td>
        <td height="22"><div align="left">
          <input name="txtcodestpro1" type="text" id="txtcodestpro1" size="<?php print $li_maxlen; ?>" maxlength="20" style="text-align:center" readonly>
          <a href="javascript:ue_estructura1();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Buscar"></a>
      ...
      <tr>
        ...
        <td height="22"><div align="left">
          <input name="txtcodestpro2" type="text" id="txtcodestpro2" size="<?php print $li_maxlen; ?>" maxlength="6" style="text-align:center" readonly>
          <a href="javascript:ue_estructura2();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Buscar"></a>
      ...
      <tr>
        ...
        <td height="22"><div align="left">
          <input name="txtcodestpro3" type="text" id="txtcodestpro3" size="<?php print $li_maxlen; ?>" maxlength="3" style="text-align:center" readonly>
          <a href="javascript:ue_estructura3();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Buscar"></a>
...
<?php }
      ...
      <tr>
        ...
        <td height="22"><div align="left">
          <input name="txtcodestpro4" type="text" id="txtcodestpro4" size="<?php print $li_maxlen; ?>" maxlength="2" style="text-align:center" readonly>
          <a href="javascript:ue_estructura4();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Buscar"></a>
      ...
      <tr>
        ...
        <td height="22"><div align="left">
          <input name="txtcodestpro5" type="text" id="txtcodestpro5" size="<?php print $li_maxlen; ?>" maxlength="2" style="text-align:center" readonly>
          <a href="javascript:ue_estructura5();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Buscar"></a>
...
<?php }?>
      <tr>
        ...
        <td height="22"><div align="left">
          ...
          <a href="javascript:ue_cuentasspg();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Cuentas de Gastos"></a> 
      ...
      <tr>
        ...
        <td height="22"><div align="left">
          ...
          <a href="javascript: ue_aceptar();"><img src="../shared/imagebank/tools15/aprobado.png" alt="Agregar Detalle Presupuestario" width="15" height="15" border="0"></a>
		  <a href="javascript: ue_cerrar();"><img src="../shared/imagebank/tools15/eliminar.png" width="15" height="15" border="0" alt="Cancelar Registro de Detalle Presupuestario"></a></div></td>
    <tr>
      <td height="22">&nbsp;</td>
      <td>&nbsp;</td>
  </table> 
...
function ue_aceptar()
{
	...
	if(parseFloat(monto)>0)
	{
		...
		if(valdisponible)
		{
			...
			ue_rellenarcampo(f.codestpro1,20);
			ue_rellenarcampo(f.codestpro2,6);
			ue_rellenarcampo(f.codestpro3,3);
			codestpro=f.codestpro1.value+f.codestpro2.value+f.codestpro3.value+f.txtcodestpro4.value+f.txtcodestpro5.value;
			...
			for(j=1;(j<totrowspg)&&(valido);j++)
			{
				...
				if((codpro==codestpro)&&(spgcuenta==cuentapresupuesto))
				{
			...
			if(existe==false)
			{
				...
				monto=f.txtmonto.value;
				parametros=parametros+"&txtspgnrocomp"+totrowspg+"="+numrecdoc+"&txtprogramatica"+totrowspg+"="+codestpro+""+
									  ...
									  "&txtcodfuefin"+totrowspg+"="+ls_codfuefin;
			}
			else
			{
...
{
	window.open("tepuy_cxp_cat_estpre1.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,resizable=yes,location=no");
	f=document.formulario;
...
function ue_estructura2()
{
	...
	if(codestpro1!="")
	{
		pagina="tepuy_cxp_cat_estpre2.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1;
...
function ue_estructura3()
{
	...
	if(estmodest==2)
	{
		...
		{
			pagina="tepuy_cxp_cat_estpre3.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2;
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,resizable=yes,location=no");
		}
		else
		{
...
function ue_estructura4()
{
	...
	{
    	pagina="tepuy_cxp_cat_estpre4.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&codestpro3="+codestpro3+"&denestpro3="+denestpro3;
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,resizable=yes,location=no");
		f.txtcodestpro5.value="";
		f.txtdenestpro5.value="";
		f.txtspgcuenta.value="";
...
function ue_estructura5()
{
	...
	pagina="tepuy_cxp_cat_estpre5.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&codestpro3="+codestpro3+"&denestpro3="+denestpro3+"&codestpro4="+codestpro4+"&denestpro4="+denestpro4;
	window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,resizable=yes,location=no");
	f.txtspgcuenta.value="";
	f.txtdenominacion.value="";
	f.sccuenta.value="";
...
function ue_cuentasspg()
{
	...
	if(estmodest==1) // Si es por proyecto
	{
		...
		if((codestpro1!="")&&(codestpro2!="")&&(codestpro3!=""))
		{
			pagina="tepuy_cxp_cat_cuentasspg.php";
