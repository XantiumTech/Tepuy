<?php
class tepuy_soc_c_anulacion_orden_compra
{
  function tepuy_soc_c_anulacion_orden_compra($as_path)
  {
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//	     Function: tepuy_soc_c_anulacion_orden_compra
	//		   Access: public 
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  $ls_sql = "SELECT soc_ordencompra.numordcom,soc_ordencompra.cod_pro,	   					".
	...
	{
		$lb_valido=false;
		$this->io_msg->message("CLASE->tepuy_soc_c_anulacion_orden_compra.MÉTODO->uf_load_ordenes_compra.ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	}
	return $rs_data;
			 ...
			 if (array_key_exists("chk".$i,$_POST))
			    {
				  ...
				  if ($rs_data===false)
					 {
					   $lb_valido = false;
					   $this->io_mensajes->message("CLASE->tepuy_soc_c_anulacion_orden_compra.php->MÉTODO->uf_update_estatus_orden_compra.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
					   break;
					 }
				  else
					 {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_datos===false)
     {
	   $lb_valido = false;
	   $this->io_mensajes->message("CLASE->tepuy_soc_c_anulacion_orden_compra.php->MÉTODO->uf_delete_enlace_sep.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_result===false)
     {
	   $lb_valido= false;
	   $this->io_mensajes->message("CLASE->tepuy_soc_c_anulacion_orden_compra.php->MÉTODO->uf_update_estatus_incorporacion_item.ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message)); 
	 }
  else
     {
