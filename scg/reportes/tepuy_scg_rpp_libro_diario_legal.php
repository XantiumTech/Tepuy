<?php
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_scg->uf_load_seguridad_reporte("SCG","tepuy_scg_r_libro_diario.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_2017($la_data,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detalle
		//		    Acess: private 
		...
		$la_columnas=array('cuenta'=>'<b>Cuenta</b>',
						   ...
						   'haber'=>'<b>Haber</b>              ');
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
	}// end function uf_print_detalle_2017
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_cabecera_2017($adec_totaldebe,$adec_totalhaber,$adec_total_saldo,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function : uf_print_pie_cabecera
		//		    Acess : private 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xOrientation'=>'center', // Orientación de la tabla
						 'xPos'=>299, // Orientación de la tabla
				 		 'cols'=>array('total'=>array('justification'=>'right','width'=>390), // Justificación y ancho de la columna
						 			   'debe'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'haber'=>array('justification'=>'right','width'=>80))); // Justificación y ancho de la columna
						 			  
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	}// end function uf_print_pie_cabecera_2017
	//--------------------------------------------------------------------------------------------------------------------------------
...
/*		$ld_fecdesde=$_GET["txtfecdes"];
	...
	else
	{
	 ...
	 if($ls_hidbot==true)
	 {
	   ...
	   $ld_fecdesde=$ls_cmbagnodes."-".$ls_cmbmesdes."-01"." 00:00:00";
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
		$ldt_fecha=" <b>Desde  ".substr($fecdes,8,2)."/".substr($fecdes,5,2)."/".substr($fecdes,0,4)."  al ".$fechas."</b> ";
		$ls_titulo=" <b>LIBRO DIARIO LEGAL</b> ";       
	//--------------------------------------------------------------------------------------------------------------------------------
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	$lb_valido=uf_insert_seguridad("<b>Libro Diario Legal en PDF</b>"); // Seguridad de Reporte
	if($lb_valido)
	{
		//print "Cta. Desde:".$ls_cuentadesde." Cta. Hasta: ".$ls_cuentahasta;
		//print "Fecha Desde:".$ld_fecdesde." Cta. Hasta: ".$ld_fechasta;die();
		$lb_valido=$io_report->uf_scg_reporte_libro_diario_legal($ls_cuentadesde,$ls_cuentahasta,$ld_fecdesde,$ld_fechasta,$li_nivel);
	}
	 ...
	 else // Imprimimos el reporte
	 {
		...
		uf_print_detalle_2017($la_data,$io_pdf); // Imprimimos el detalle
		if($ldec_totaldebe<0)
		{
		...
		uf_print_pie_cabecera_2017($ldec_totaldebe,$ldec_totalhaber,$ldec_total_saldo,$io_pdf);
		unset($la_data);			
