		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					...
					case "afiliado": // llamado desde tepuy_snorh_d_ipasme_afiliado.php
						print "<tr class=celdas-blancas>";
					...
					case "replisdepdes": // llamado desde tepuy_snorh_r_ipasme_dependencias.php
						print "<tr class=celdas-blancas>";
					...
					case "replisdephas": // llamado desde tepuy_snorh_r_ipasme_dependencias.php
						print "<tr class=celdas-blancas>";
...
function ue_search(existe)
{
	f=document.form1;
  	...
  	f.action="tepuy_snorh_cat_ipasme_dependencias.php?tipo=<?PHP print $ls_tipo;?>";
  	f.submit();
}
</script>
</html>
