...
ini_set('display_errors', 1);
	...
	function uf_print_encabezado_pagina($as_nummov,$ad_fecmov,$as_cedaut,$as_nomaut,$ad_nomusu,$as_titulo,&$aa_data,&$io_pdf)
	{
		...
		$la_data[1]  = array('titulo'=>'Personal que Autorizó el Ingreso');
		...
		$la_config	 = array('showHeadings'=>0, // Mostrar encabezados
							 ...
							 //'xPos'=>140, // Orientación de la tabla
						 	 ...
						 	 'cols'=>array('titulo'=>array('justification'=>'center','width'=>570))); // Justificación y ancho de la columna)); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		unset($la_data);
		unset($la_columnas);
		unset($la_config);
		$io_pdf->ezSetDy(-2);
		$aa_columnas=array('cedaut'=>'<b> N. de Cédula </b>','nomaut'=>'<b> Nombres y Apellidos: </b>');
		$aa_config=array('showHeadings'=>1, // Mostrar encabezados
					...
					//	 'xPos'=>170, // Orientación de la tabla
						 ...
						 'maxWidth'=>570,
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('cedaut'=>array('justification'=>'lefth','width'=>170),     // Justificación y ancho de la columna
						 		'nomaut'=>array('justification'=>'center','width'=>400)));     // Justificación y ancho de la columna
	...
	//	$io_pdf->line(550,40,550,110);		
		$io_pdf->addText(105,102,7,"ELABORADO POR"); // Agregar el título
		$i=120; 
		$li_tm=$io_pdf->getTextWidth(10,$ad_nomusu);
		$i=$i-($li_tm/2)+30;
		$io_pdf->addText($i,43,6,$ad_nomusu); // Agregar el título
		$io_pdf->addText(275,102,7,"VERIFICADO POR"); // Agregar el título
		$io_pdf->addText(450,102,7,"AUTORIZADO"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(10,$as_nomaut);
		$i=475; 
		$li_tm=$io_pdf->getTextWidth(10,$as_nomaut);
		$i=$i-($li_tm/2)+30;
		$io_pdf->addText($i,43,6,$as_nomaut); // Agregar el título $as_nomaut
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('codpro'=>array('justification'=>'left','width'=>60), // Justificación y ancho de la columna
						 			   'denpro'=>array('justification'=>'left','width'=>140), // Justificación y ancho de la columna
						 			   'unimed'=>array('justification'=>'left','width'=>60), // Justificación y ancho de la columna
						 			   'exipro'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
	...
	function uf_print_totales($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'right','width'=>330), // Justificación y ancho de la columna
						 			   'totpro'=>array('justification'=>'right','width'=>70))); // Justificación y ancho de la columna
	...
	{
		$ls_descripcion="Generó el Reporte del Movimiento de Inventario";
