  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////   
   public function get_personal_anticipo($ps_codper,$ps_nomper,$ps_apeper,$ps_order,&$pa_datos="")
   {
	...
	function uf_contabilizar_anticipos_spg($as_codnom,$as_codper,$adt_fecantper)
	{
		...
		$ls_sql = " SELECT sps_anticipos.monant, sno_unidadadmin.codprouniadm, sno_fideiconfigurable.cueprefid ".
  ...
  {	
		...
		$ls_sql    = "INSERT INTO sps_dt_spg(codemp, codnom, codcom, tipo, codestpro1, codestpro2, codestpro3, codestpro4, codestpro5, spg_cuenta, operacion, ced_bene, descripcion, monto, estatus, estrd, codtipdoc, fechaconta, fechaanula) VALUES 
		              ( '".$this->ls_codemp."','" .$ps_codnom."','".$ps_comprobante."','".$pi_tipo."','".$ls_codestpro1."','".$ls_codestpro2."','".$ls_codestpro3."','".$ls_codestpro4."','".$ls_codestpro5."',
					    '".$ps_cueprefid."','".$ps_operacion."','".$ps_codper."','".$ps_descripcion."','".$pd_monant."','".$pi_estatus."','".$pi_genrecdoc."','".$ps_tipdoc."','".$ldt_fecha."','".$ldt_fecha."' ) ";
