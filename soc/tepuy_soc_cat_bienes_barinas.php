...
{   
	...
	for (j=1;(j<li_totrowbienes)&&(valido);j++)
	    { 
		  ...
		  parametros = parametros+"&txtcodart"+j+"="+ls_codart+"&txtdenart"+j+"="+ls_denart+"&txtcanart"+j+"="+ld_canart+"&hidnumsep"+j+"="+ls_numsep;		   
		} 
...
function ue_aceptar_bienes_orden_compra(as_codart,as_denart,as_denunimed,as_unidad,as_spg_cuenta,ai_precio,ai_totalcargos,ai_existecuenta)
{
	//---------------------------------------------------------------------------------
	// Verificamos que el artículo no esté en el formulario
	//---------------------------------------------------------------------------------
