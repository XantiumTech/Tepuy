...
<?php 
require_once("class_folder/tepuy_spg_c_fuentfinan.php");
...
$io_fuente= new tepuy_spg_c_fuentfinan($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_d_fuentfinan.php";
...
if(array_key_exists("operacion",$_POST))
{
  ...
  $lb_empresa=true;
  $ls_tabla="tepuy_spg_fuentefinanciamiento";
  $ls_campo="codfuefin"; 
 }
else
{
...
if ($ls_operacion=="NUEVO")
   {
	 ...
	 $ls_codemp=$arremp["codemp"];
     $ls_status='N';
	 $ls_codfuefin=$io_funciondb->uf_generar_codigo($lb_empresa,$ls_codemp,"tepuy_fuentefinanciamiento","codfuefin",$ls_status);
...
function ue_nuevo()
{
  ...
  if (li_incluir==1)
	 {	
	   ...
	   f.action="tepuy_spg_d_fuentfinan.php";
	   f.submit();
	 }
   else
     {
     ...
     with (document.form1)
	      {
	        if (campo_requerido(txtcodigo,"El código de la Fuente de Financiamiento debe estar lleno !!")==false)
		       ...
		       {
		         resul=rellenar_cad(document.form1.txtcodigo.value,2);	   
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
	     f.operacion.value="";			
	     pagina="tepuy_spg_cat_fuentefinan.php";
