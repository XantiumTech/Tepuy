<?php
class tepuy_scv_c_otrasasignaciones
{
	var $ls_sql;
	var $is_msg_error;
		
	function tepuy_scv_c_otrasasignaciones($conn)
	{
	...
	function uf_scv_select_otrasasignaciones($as_codemp,$as_codotrasi) 
	{
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->tepuy_scv_c_otrasasignaciones METODO->uf_scv_select_otrasasignaciones ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_scv_insert_otrasasignaciones($as_codemp,$as_codotrasi,$as_denotrasi,$ai_tarotrasi,$aa_seguridad) 
	{
		...
		if ($rs_data===false)		     
		{
			...
			$this->io_msg->message("CLASE->tepuy_scv_c_otrasasignaciones METODO->uf_scv_insert_otrasasignaciones ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	function uf_scv_update_otrasasignaciones($as_codemp,$as_codotrasi,$as_denotrasi,$ai_tarotrasi,$aa_seguridad) 
	{
		...
		{
			$this->io_sql->rollback();
			$this->io_msg->message("CLASE->tepuy_scv_c_otrasasignaciones METODO->uf_scv_update_otrasasignaciones; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$lb_valido=true;
	...
	function uf_scv_delete_otrasasignaciones($as_codemp,$as_codotrasi,$aa_seguridad)
	{
		...
		if (!$lb_relacion)
		{
			...
			{
				$this->io_sql->rollback();
				$this->io_msg->message("CLASE->tepuy_scv_c_otrasasignaciones METODO->uf_scv_delete_otrasasignaciones ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
			}
			else
			{
				$lb_valido=true;
	...
	function uf_scv_check_relaciones($as_codemp,$as_codtar)
	{
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->tepuy_scv_c_otrasasignaciones METODO->uf_check_relaciones; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
...
} //Fin de la class tepuy_scv_c_misiones
?> 
