<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","tepuy_scg_r_libro_diario_general.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	$ls_reporte=$io_fun_scg->uf_select_config("SCG","REPORTE","libro_diario_general","tepuy_scg_rpp_libro_diario_general.php","C");
	$ls_reporte2=$io_fun_scg->uf_select_config("SCG","REPORTE","libro_diario_general_SINDT","tepuy_scg_rpp_libro_diario_general_sindt.php","C");
...
<title>Listado de Libro Diario General</title>
...
?>		  
  <table width="530" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Listado de Libro Diario General</td>
    </tr>
  </table>
      ...
      <td colspan="3" align="center"><div align="left">
          ...
          <!--DWLayoutTable-->
		    ...
		    <tr class="formato-blanco">
		      ...
		      <td width="40"><div align="left"><a href="javascript:catalogo_compdes();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a></div></td>
		      ...
		      <td width="36"><a href="javascript:catalogo_comphas();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 2"></a></td>
	         </tr>
        </table>
      </div>        </td>
    </tr>
      ...
      <td colspan="3" align="center">      <div align="left">
        <table width="480" height="33" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          ...
          <tr class="formato-blanco">
            ...
            <td width="40"><a href="javascript:catalogo_procdes();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a></td>
            ...
            <td width="38"><a href="javascript:catalogo_prochas();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 2"></a></td>
          </tr>
        </table>
      </div></td>
    </tr>
    ...
    <tr>
      <td colspan="3" align="center">
        <table width="480" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td height="22">&nbsp;</td>
            <td colspan="5"><input name="chkmostrar" type="checkbox" class="sin-borde" id="chkmostrar" value="0" unchecked> 
              Mostrar Descripci&oacute;n en los Detalles.          
...
function ue_openexcel()
{
	...
	{	
		...
		if(f.chkmostrar.checked)
		{
			pagina="reportes/tepuy_scg_rpp_libro_diario_general_excel.php?txtcompdes="+txtcompdes
					+"&txtcomphas="+txtcomphas+"&txtprocdes="+txtprocdes+"&txtprochas="+txtprochas
					+"&txtfecdes="+txtfecdes+"&rborden="+orden+"&txtfechas="+txtfechas+"&tiporeporte="+tiporeporte;
		}
		else
		{
			pagina="reportes/tepuy_scg_rpp_libro_diario_general_sindt_excel.php?txtcompdes="+txtcompdes
					+"&txtcomphas="+txtcomphas+"&txtprocdes="+txtprocdes+"&txtprochas="+txtprochas
					+"&txtfecdes="+txtfecdes+"&rborden="+orden+"&txtfechas="+txtfechas+"&tiporeporte="+tiporeporte;
		}
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
...
{
	   pagina="tepuy_cat_rep_comprobantes.php?tipocat=repcompdes";
	   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
function catalogo_comphas()
{
		pagina="tepuy_cat_rep_comprobantes.php?tipocat=repcomphas";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
function catalogo_procdes()
{
	   pagina="tepuy_cat_rep_comprobantes.php?tipocat=rep_proc_des";
	   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
function catalogo_prochas()
{
		pagina="tepuy_cat_rep_comprobantes.php?tipocat=rep_proc_has";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
