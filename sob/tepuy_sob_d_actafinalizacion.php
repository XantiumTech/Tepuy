...
<html>
<head>
<title>Elaboraci&oacute;n de Acta de Finalizaci&oacute;n</title>
...
if	(array_key_exists("txtplacon",$_POST)){$ls_placon=$_POST["txtplacon"]; }
else{$ls_placon="";}
...
if($ls_operacion=="ue_nuevo")//Abre una ficha de obra nueva
{
	...
	if(!$lb_tieneacta)
	{
		$ls_codact=$io_funsob->uf_generar_codigoacta(2,$ls_codcon);	
		$ls_fecinicon="";	
		$ls_feciniact="";
		$ls_fecfinact="";
		$ls_nominsact="";
	...
	{
		$io_msg->message("Este Contrato ya tiene un Acta de Finalización!!!");
		$ls_datoscontrato="OCULTAR";
		$ls_datosobra="OCULTAR";
		$ls_placon="";
		$ls_placonuni="";
...
elseif($ls_operacion=="ue_cargarcontrato")
{
	...
	if($lb_valido)
	{
		...
		$ls_placon=$ls_placon." ".$la_data["nomuni"][1];
...
elseif($ls_operacion=="ue_guardar")
{
	...
	$li_numero=0;
	$lb_existe=$io_acta->uf_select_acta($ls_codcon,$ls_codact,2,&$aa_data);
	if(!$lb_existe)
	{
		$lb_valido=$io_acta->uf_guardar_acta($ls_codcon,$ls_codact,2,$ls_fecact,$ls_feciniact,$ls_fecfinact,"",$li_numero,"001","","",$ls_cedinsact,$ls_cedresact,"","",$ls_obsact);
			if ($lb_valido)																																				
			{
				$lb_valido=$io_contrato->uf_update_ultimoacta($ls_codcon,2);
				if($lb_valido)
				{
					$io_mensaje->incluir();
					$ls_datoscontrato="OCULTAR";
		...
		{
			$lb_valido=$io_acta->uf_select_estado($ls_codcon,$ls_codact,2,$li_estado);
			if($li_estado==1)
			{	
				$lb_valido=$io_acta->uf_update_acta($ls_codcon,$ls_codact,2,$ls_fecact,$ls_feciniact,$ls_fecfinact,"",$li_numero,"001","","",$ls_cedinsact,$ls_cedresact,"","",$ls_obsact);
				if($lb_valido)
				{					
					$ls_datoscontrato="OCULTAR";
					$ls_datosobra="OCULTAR";
...
elseif($ls_operacion=="ue_eliminar")
{
	...
	if($lb_valido)
	{
		if($li_estado==1)
		{
			$lb_valido=$io_acta->uf_update_estado($ls_codcon,$ls_codact,2,3);
			if($lb_valido)
				$io_mensaje->anular();
			else
...
<!--  <tr>
  ...
  <table width="685" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      ...
      <tr class="formato-blanco">
        ...
        <td colspan="2"><input name="txtcodcon" type="text" id="txtcodcon" style="text-align:center " value="<? print $ls_codcon ?>" size="8" maxlength="8" readonly="true">
		...
		{
		?>
			<img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" onClick="javascript:mensaje();">		
		<?
		}
		?>
		</td>
		...
		<?Php
			...
			?>		
				<tr class="formato-blanco">
				  ...
				  <td height="79" colspan="8" align="center" valign="top" class="sin-borde">				  <table width="500" height="111" border="0" cellpadding="0"  cellspacing="0" >
                    <tr class="letras-pequeñas">
                      <td width="82" height="13"><div align="right">Fecha de Inicio</div></td>
                      <td width="140"><input name="txtfecinicon"  stype="text" id="fecinicon"  style="text-align:center "value="<? print $ls_fecinicon?>" size="11" maxlength="11" readonly="true"></td>
                      <td width="60"><div align="right">Duraci&oacute;n</div></td>
                      <td width="218"><input name="txtplacon"  style="text-align:center "  type="text" id="txtfecasi" value="<? print $ls_placon?>" size="11" maxlength="11" readonly="true">
&nbsp;&nbsp;&nbsp;
                      </td>
                    </tr>
                    <tr class="letras-pequeñas">
                    ...
                    <tr class="letras-pequeñas">
                      <td height="19" valign="top" class="navigation"><div align="right">C&oacute;digo</div></td>
	  ...
	  <tr class="formato-blanco">
        <td height="13" colspan="10" class="titulo-celdanew">Datos del Acta de Finalizaci&oacute;n </td>
      </tr>	  
      <tr class="formato-blanco">
        <td height="39">&nbsp;</td>
        ...
        <td width="88" height="39"><input name="txtfecact" type="text" id="txtfecact"  style="text-align:center" value="<? print $ls_fecact ?>" size="10" maxlength="10"  readonly="true"></td>
        <td height="39">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="26">&nbsp;</td>
        ...
        <td height="26"><input name="txtfeciniact"   type="text" id="txtfeciniact" onBlur="javascript:ue_comparar_intervalo('txtfecact','txtfeciniact','La fecha de inicio del Acta debe ser mayor o igual a la fecha actual');"    style="text-align:left" value="<? print $ls_feciniact ?>" size="11" maxlength="10"    readonly="true" datepicker="true"></td>
        <td height="26" colspan="3"><div align="right">Fecha de Finalizaci&oacute;n</div></td>
        <td height="26"><input name="txtfecfinact"   type="text" id="txtfecfinact2"  style="text-align:left" value="<? print $ls_fecfinact ?>" size="11" maxlength="10"   readonly="true" datepicker="true"></td>
        <td height="26">&nbsp;</td>
        <td height="26">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        ...
        <td height="25" colspan="6"><input name="txtnominsact" type="text"  style="text-align: left" id="txtnominsact" readonly="true" size="50" value="<? print $ls_nominsact?>" maxlength="50">
&nbsp;&nbsp;&nbsp;&nbsp;C.I.
    <input name="txtcedinsact" type="text" id="txtcedinsact" onkeypress="return acceptNum(event)" value="<? print $ls_cedinsact?>" size="10" readonly="true" maxlength="10" style="text-align:center ">
&nbsp; C.I.V.
    <input name="txtcivinsact" type="text" id="txtcivinsact" onkeypress="return acceptNum(event)" value="<? print $ls_civinsact?>" size="10" style="text-align:center " readonly="true" maxlength="10">
    <a href="javascript:ue_catinspectores();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"  ></a>
    <div align="left"></div></td>
      ...
      <tr class="formato-blanco">
        ...
        <td height="24" colspan="6"><input name="txtnomresact" type="text" id="txtnomresact" value="<? print $ls_nomresact?>" size="50" readonly="true" maxlength="50" style="text-align:left ">
&nbsp;&nbsp;&nbsp;&nbsp;C.I.
    <input name="txtcedresact" type="text" id="txtcedresact" onkeypress="return acceptNum(event)" value="<? print $ls_cedresact?>" size="10" maxlength="10" style="text-align:center " readonly="true">
&nbsp;&nbsp;C.I.V.
    <input name="txtcivresact" type="text" onkeypress="return acceptNum(event)"  style="text-align:center " value="<? print $ls_civresact?>" readonly="true " size="10" maxlength="10">
    <a href="javascript:ue_catresidentes();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a></td>
      ...
      <tr class="formato-blanco">
        ...
        <td colspan="6"><textarea name="txtobsact" cols="80" rows="2" id="txtobsact" onKeyDown="textCounter(this,254)" onKeyUp="textCounter(this,254)"><? print $ls_obsact;?></textarea></td>
        <td>&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td colspan="10">&nbsp;</td>
...
function ue_catcontrato()
{
	f=document.form1;
	f.operacion.value="";			
	var tipoacta= "FINALIZACION";
	pagina="tepuy_cat_contratoactas.php?tipoacta="+tipoacta;
	window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=700,height=500,resizable=yes,location=no,top=0,left=0");
}
...
function ue_nuevo()
{
  ...
  else
  {
	  ...
	  f.action="tepuy_sob_d_actafinalizacion.php";
	  f.submit();  
  }	
}
function ue_buscar()
