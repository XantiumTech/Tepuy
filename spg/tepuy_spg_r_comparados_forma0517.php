...
function ue_showouput()
{
	...
	if(estmodest==1)
	{
		...
		{
		   pagina="reportes/tepuy_spg_rpp_comparados_forma0517.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1+"&codestpro2="+codestpro2
	...
	else
	{
		...
		else
		{
		   ...
		   +"&codestpro4h="+codestpro4h+"&codestpro5h="+codestpro5h+"&tipoformato="+tipoformato+"&txtcodfuefindes="+txtcodfuefindes
