...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_p_cmp_ret_mun_otros.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<!--  <tr>
  ...
  <tr>
    <td height="20" class="toolbar"><div align="left"><a href="javascript: ue_nuevo();"><img src="../shared/imagebank/tools20/nuevo.png" alt="Nuevo" title="Nuevo" width="20" height="20" border="0"></a><a href="javascript: ue_guardar();"><img src="../shared/imagebank/tools20/grabar.png" alt="Guardar" title="Guardar" width="20" height="20" border="0"></a><a href="javascript: ue_cerrar();"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" title="Salir" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/ayuda.png" alt="Ayuda" title="Ayuda" width="20" height="20"></div></td>
  </tr>
</table>
<?php
	...
	require_once("tepuy_scb_c_cmp_ret_iva.php");
	...
	$io_cmpret   = new tepuy_scb_c_cmp_ret_iva('0000000003');	
	...
	else
	{
		...
		{					
			...
			$object[$li_i][7] = "<div align=right><input type=text name=txtporiva".$li_i." value='0,00' style=text-align:right  class=sin-borde size=15 onKeyPress=return(currencyFormat(this,'.',',',event)) maxlength =25 > <a href=javascript:uf_iva(".$li_i.");><img src=../shared/imagebank/tools15/buscar.png width=15 height=15 border=0></a></div>";			
			...
			$object[$li_i][9] = "<div align=right><input type=text name=txtivaret".$li_i." value='0,00' style=text-align:right  class=sin-borde size=15 onKeyPress=return(currencyFormat(this,'.',',',event)) maxlength =25 ><a href=javascript:uf_cat_deducciones(".$li_i.");><img src=../shared/imagebank/tools15/buscar.png width=15 height=15 border=0></a></div><input  name=txtpor".$li_i." id=txtpor".$li_i." style=text-align:right  class=sin-borde size=15 type=hidden >";			
			$object[$li_i][10]= "<input type=text name=txtnumdoc".$li_i." value=''     style=text-align:center class=sin-borde size=16 maxlength = 15  >";					
			$object[$li_i][11]= "<a href=javascript:uf_delete_dt(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt='Eliminar Retención' width=15 height=10 border=0></a><input type=hidden name=hidforcar".$li_i."  value=''><input type=hidden name=hidcodded".$li_i."  value=''><input type=hidden name=hidforded".$li_i."  value=''>";	
		}
	}
         ...
         if($ls_numfacl!="")		 
		 {
				 ...
				 {			
					  ...
					  {					
						 ...
						 //$ldec_poriva=str_replace('.','',$ldec_poriva);
						 //$ldec_poriva=str_replace(',','.',$ldec_poriva);				 
		...
		if($lb_valido)
		{
			...
			if($lb_valido)			
			{
				...
				{					
					...
					$object[$li_i][7] = "<div align=right><input type=text name=txtporiva".$li_i." value='0,00' style=text-align:right  class=sin-borde size=15 onKeyPress=return(currencyFormat(this,'.',',',event)) maxlength =25> <a href=javascript:uf_iva(".$li_i.");><img src=../shared/imagebank/tools15/buscar.png  width=15 height=15 border=0></a></div>";			
					$object[$li_i][8] = "<input type=text name=txttotimp".$li_i." value='0,00' style=text-align:right  class=sin-borde size=15 onKeyPress=return(currencyFormat(this,'.',',',event)) maxlength =25 >";							
					$object[$li_i][9] = "<div align=right><input type=text name=txtivaret".$li_i." value='0,00' style=text-align:right  class=sin-borde size=15 onKeyPress=return(currencyFormat(this,'.',',',event)) maxlength =25> <a href=javascript:uf_cat_deducciones(".$li_i.");><img src=../shared/imagebank/tools15/buscar.png  width=15 height=15 border=0></a></div><input name=txtpor".$li_i."  style=text-align:right  class=sin-borde size=15 type=hidden >";			
					$object[$li_i][10]= "<input type=text name=txtnumdoc".$li_i." value=''     style=text-align:center class=sin-borde size=16 maxlength = 15  >";					
					$object[$li_i][11]= "<a href=javascript:uf_delete_dt(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt='Eliminar Retención' width=15 height=10 border=0></a><input type=hidden name=hidforcar".$li_i."  value=''><input type=hidden name=hidcodded".$li_i."  value=''><input type=hidden name=hidforded".$li_i."  value=''>";	
                }					
			}
	...
	if($ls_operacion=="DELETE_DT")		
	{
		...
		for($li_i=1;$li_i<=$li_totalrow;$li_i++)
	    {
			...
			{				
				 ...
				 $object[$li_x][7] = "<div align=right><input type=text name=txtporiva".$li_x." value='".$ld_poriva."' style=text-align:right  class=sin-borde size=15 onKeyPress=return(currencyFormat(this,'.',',',event)) maxlength =25> <a href=javascript:uf_iva(".$li_x.");><img src=../shared/imagebank/tools15/buscar.png  width=15 height=15 border=0></a></div>";			
				 ...
				 $object[$li_x][11]= "<a href=javascript:uf_delete_dt(".$li_x.");><img src=../shared/imagebank/tools15/eliminar.png alt='Eliminar Retención' width=15 height=10 border=0></a><input type=hidden name=hidforcar".$li_x." value='".$ls_formula."'><input type=hidden name=hidcodded".$li_x." value='".$ls_codded."'><input type=hidden name=hidforded".$li_x." value='".$ls_forded."'>";	
			}	     
	        else
	        {	
		       $li_rowdelete=0;
    ...
    {            
      ...
      for($li_i=1;$li_i<=$li_total;$li_i++)
	  {
		 ...
		 $object[$li_i][7] = "<div align=right><input type=text name=txtporiva".$li_i." value='".$ld_poriva."' style=text-align:right  class=sin-borde size=15 onKeyPress=return(currencyFormat(this,'.',',',event)) maxlength =25><a href=javascript:uf_iva(".$li_i.");><img src=../shared/imagebank/tools15/buscar.png  width=15 height=15 border=0></a></div>";			
		 ...
		 $object[$li_i][11]= "<a href=javascript:uf_delete_dt(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt='Eliminar Retención' width=15 height=10 border=0></a><input type=hidden name=hidforcar".$li_i." value='".$ls_formula."'><input type=hidden name=hidcodded".$li_i." value='".$ls_codded."'><input type=hidden name=hidforded".$li_i." value='".$ls_forded."'>";	
	  }
    } 
    ...
    <tr>
      <td><table width="693" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno" id="tabla">
          <tr class="titulo-celdanew">
            <td height="22" colspan="4" class="titulo-celdanew">Registro Manual de Comprobante de Retenci&oacute;n </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <a href="javascript:cat_sol();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>  <label>
            &nbsp;&nbsp;&nbsp;<input name="txtdesmov" type="text" id="txtdesmov" value="<?php print $ls_desmov;?>" size="80" maxlength="200" class="sin-borde">
            </label></td>
          </tr>
          <tr>
            <td height="13">&nbsp;</td>
...
Beneficiario<a href="javascript:catalogo_proveedor();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a></td>
            <td height="22">&nbsp;</td>
          </tr>
          <tr>
...
<script language="javascript">
  function ue_nuevo()
  {
	  location.href="tepuy_scb_p_cmp_ret_mun_otros.php";	 
  }
  function ue_guardar()
  {
	  f=document.form1;
  ...
  function ue_buscar()
  {
	window.open("tepuy_cat_cmp_ret.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
  }
function ue_cerrar()
{
	f=document.form1;
  ...
  function uf_ret_iva(li_row)
  {
	  ...
	  {
		  pagina="tepuy_cxp_cat_iva_ret.php";
		  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=600,resizable=yes,location=no");	  
	  }  
	  else
	  {
  ...
  function rellenar_cad(cadena,longitud,campo)
  {
   ...
   { 
	...
	function cat_sol()
	{
		pagina="tepuy_cat_mov_chq_cmp_ret.php";
		ancho=screen.width;
   ...
   { 
    ...
    function catalogo_proveedor()
	{
		...
		{ 
		  pagina="tepuy_catdinamic_prov.php";
	...
	function uf_cat_deducciones(fila) 
    {
	   ...
	   ldec_monto=parseFloat(uf_convertir_monto(ldec_monto));//Lo convierto a decimal separado solo por punto( . )
	   ldec_monobjret=eval("f.txtbasimp"+fila+".value");
	   ldec_monobjret=parseFloat(uf_convertir_monto(ldec_monobjret));//Lo convierto a decimal separado solo por punto( . )
	   ls_origen="1";
	   if((ls_documento!="")&& uf_validar_montos(fila))   
	   {
	   	   ldec_monobjret=uf_convertir(ldec_monobjret + ldec_monto);//Lo convierto a formato decimal con separdores de miles y decimales	
	       ldec_monto=uf_convertir(ldec_monto);//Lo convierto a formato decimal con separdores de miles y decimales	   
		   pagina="tepuy_cat_deducciones_otros.php?monto="+ldec_monto+"&objret="+ldec_monobjret+"&txtdocumento="+ls_documento+"&origen="+ls_origen+"&fila="+fila;
   ...
   function uf_validar_montos(fila)
   {
	   ...
	   ldec_monto_sin_iva=parseFloat(uf_convertir_monto(ldec_monto_sin_iva));//Lo convierto a decimal separado solo por punto( . )
	   ldec_monto_con_iva=eval("f.txtconiva"+fila+".value");
	   ldec_monto_con_iva=parseFloat(uf_convertir_monto(ldec_monto_con_iva));//Lo convierto a decimal separado solo por punto( . )
	   ldec_base_imponible=eval("f.txtbasimp"+fila+".value");
	   ldec_base_imponible=parseFloat(uf_convertir_monto(ldec_base_imponible));//Lo convierto a decimal separado solo por punto( . )
	   ldec_total_impuesto=eval("f.txttotimp"+fila+".value");
	   ldec_total_impuesto=parseFloat(uf_convertir_monto(ldec_total_impuesto));//Lo convierto a decimal separado solo por punto( . )
