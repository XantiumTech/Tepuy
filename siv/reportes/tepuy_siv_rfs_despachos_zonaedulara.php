<?php
		                           ...
		                           $as_desmun,$as_desparr,$as_nomdirec,&$io_pdf)
	{
		...
		//	   Creado Por: Ing. Luis Anibal Lang     Modificado por: Ing. Gloriely Fréitez
		// Fecha Creación: 26/04/2006                Fecha Creación: 29/05/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/*	$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
		$tm=320;*/
		$io_pdf->addText(235,930,11,"<b>".$as_titulo."</b>"); // Agregar el título
	    ...
	    $la_data=array(array('name'=>'NOMBRE DEL PROYECTO: '.$as_nomproy.'     COD. PROYECTO: '.$as_codproy.''),
					   ...
					   array('name'=>'DIRECCIÓN: '.$as_direccion.''),
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>325); // Justificación y ancho de la 
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
		
		// cuadro inferior
		$io_pdf->Rectangle(30,180,550,70);	//primer rectángulo
		$io_pdf->line(30,235,580,235);  // linea horizontal	
		$io_pdf->line(320,110,320,250); //linea vertical
		$io_pdf->Rectangle(30,110,550,70);
		$io_pdf->addText(95,240,7,"COORDINADOR DE DOTACIÓN (Firma y Sello)"); // Agregar el título
		$io_pdf->addText(90,185,7,"Fecha ____/____/_____       Hora:___________"); // Agregar el título
		$io_pdf->addText(390,240,7,"JEFE DE ALMACÉN (Firma y Sello)"); // Agregar el título
		$io_pdf->addText(380,185,7,"Fecha ____/____/_____       Hora:___________"); // Agregar el título
		$io_pdf->line(30,165,580,165);  // linea horizontal	
		$io_pdf->addText(110,170,7,"RESPONSABLE (Firma y Sello)"); // Agregar el título
		$io_pdf->addText(90,113,7,"Fecha ____/____/_____       Hora:___________"); // Agregar el título
		$io_pdf->addText(390,170,7,"COMUNIDAD EDUCATIVA (Firma y Sello)"); // Agregar el título
		$io_pdf->addText(380,113,7,"Fecha ____/____/_____       Hora:___________"); // Agregar el título
		$io_pdf->addText(30,102,7,"REALIZADO POR: " .$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]); // Agregar el título
		$io_pdf->addText(245,92,7,"Fecha ____/____/____"); // Agregar el título
		$io_pdf->addText(250,80,7,"Hora:____________"); // Agregar el título
		$io_pdf->addText(245,60,7,"Fecha ____/____/____"); // Agregar el título
		$io_pdf->addText(250,43,7,"Hora:___________"); // Agregar el título
		$io_pdf->Rectangle(320,40,260,70);
	    $io_pdf->line(320,97,580,97);  // linea horizontal
		$io_pdf->addText(390,102,7,"DEPARTAMENTO DE SEGURIDAD"); // Agregar el título
		$io_pdf->addText(380,43,7,"Fecha ____/____/_____       Hora:___________"); // Agregar el título
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$io_pdf->ezSetDy(-5);
		//$io_pdf->ezSetY(750);
		$la_columna=array('renglon'=>'<b>Renglón</b>',
		                  'articulo'=>'<b>Artículo</b>',
						  'almacen'=>'<b>Almacén</b>',
						  'impu'=>'<b>Imputación Presupuestaria</b>',
						  'unidad'=>'<b>Unidad</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('renglon'=>array('justification'=>'center','width'=>35),
						               'articulo'=>array('justification'=>'left','width'=>80), // Justificación y ancho de la columna
									   ...
									   'unidad'=>array('justification'=>'left','width'=>45), // Justificación y ancho de la columna
						 			   'solicitada'=>array('justification'=>'right','width'=>52), // Justificación y ancho de la columna
						 			   'despachada'=>array('justification'=>'right','width'=>60), // Justificación y ancho de la columna
						 			   'precio'=>array('justification'=>'right','width'=>50), // Justificación y ancho de la columna
						 			   'total'=>array('justification'=>'right','width'=>62))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
	...
	function uf_print_totales($la_data,&$io_pdf)
	{
		...
		// Fecha Creación: 06/07/2006                 Fecha Modificación: 28/05/2008 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>560, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('total'=>array('justification'=>'right','width'=>265), // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		$io_pdf->ezSetCmMargins(7,10,3,3); // Configuración de los margenes en centímetros
		uf_print_encabezado_pagina($ls_titulo,$ls_fecha,$ls_numorddes,$ls_codproy,$ls_nomproy,$ls_denplantel,$ls_direccion,
		                           $ls_desmun,$ls_desparr,$ls_nomdirec,$io_pdf); // Imprimimos el encabezado de la página
