...
class tepuy_srh_c_escalageneral
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_srh_c_escalageneral($path)
...
function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_d_escalageneral)
		//      Argumento: 
...
function uf_srh_guardar_escalageneral ($ao_escala,$as_operacion="insertar", $aa_seguridad)
  { 
		...
		//         access: public (tepuy_srh_escalageneral)
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		else
		{
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ao_object[$ai_totrows][5]="<a href=javascript:uf_agregar_dt(".$ai_totrows.");><img src=../../../../shared/imagebank/tools15/aprobado.png alt=Aceptar width=15 height=15 border=0 align=center></a>";
				$ao_object[$ai_totrows][6]="<a href=javascript:uf_delete_dt(".$ai_totrows.");><img src=../../../../shared/imagebank/tools15/eliminar.png alt=Eliminar width=15 height=15 border=0 align=center></a>";			
			}
			$this->io_sql->free_result($rs_data);
		}
		return $lb_valido;
...
function uf_srh_guardar_dt_escalageneral($ao_escala, $aa_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_escalageneral)														
...
function uf_srh_eliminar_dt_escalageneral($as_codesc, $aa_seguridad)
  {
		...
		//        access:  public (tepuy_srh_dt_escalageneral)														
