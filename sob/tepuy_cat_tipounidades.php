...
<html>
<head>
<title>Catálogo de Tipos de Unidades</title>
...
<table width="500" border="0" align="center" cellpadding="1" cellspacing="1" >
  <tr>
   <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Tipos de Unidades</td>
  </tr>
</table>
<br>
...
<?Php
	...
	if($row=$io_sql->fetch_row($rs_data))
	{
		...
		$li_totrow=$io_dstipounidad->getRowCount("codtun");
		print "<table width=500 border=0 cellpadding=1 cellspacing=1 class=fondo-tabla>";
		print "<tr class=titulo-celda>";
		print "<td><a href=javascript:ue_ordenar('codtun','');><font color=#FFFFFF>Código</font></a></td>";
		print "<td><a href=javascript:ue_ordenar('nomtun','');><font color=#FFFFFF>Nombre</font></a></td>";
		print "<td><a href=javascript:ue_ordenar('destun','');><font color=#FFFFFF>Descripción</font></a></td>";
		print "</tr>";
		for($li_z=1;$li_z<=$li_totrow;$li_z++)
		{
			print "<tr class=celdas-blancas>";
			$ls_codigo=$data["codtun"][$li_z];
			$ls_nombre=$data["nomtun"][$li_z];
			$ls_descripcion=$data["destun"][$li_z];
	  ...
	  {
		$io_msg->message("No se han creado Tipos de Unidades");
	  }
...
<script language="JavaScript">
  function aceptar(codigo,nombre,descripcion)
  {
	...
	if(codigoaux=="-")
		alert("Seleccione un Tipo de Unidad válido!!!");
	else
	{
		opener.ue_cargartipounidad(codigo,nombre,descripcion);
		close();
	}
  }
</script>
