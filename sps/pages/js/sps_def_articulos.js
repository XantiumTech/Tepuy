...
function ue_buscar()
{
	...
	catalogo = popupWin(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=300,resizable=yes,location=no,top=0,left=0");
}
...
function ue_chequear_articulo()
{
  ...
  {            	  	
  	  //Deshabilitamos el codigo, numero del articulo y fecha vigente  
	  deshabilitar("txtid_art,txtnumart,txtfecvig,btnbusart");
	  //Habilitamos los datos de personales del beneficiario
	  ...
	  {       
		  ...
		  { 
		    ...
		    {
		      eval(cajas[c]+".value = det_articulos."+campos[c]+"["+f+"];");
		    }
			ue_agregar_detalle();
		  }
	   }
