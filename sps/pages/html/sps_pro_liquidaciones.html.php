            ...
            <div>
              <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formato-blanco" style="border-color:#FFFFFF">
                ...
                <tr>
                  ...
                  <td width="85" ><div align="right">N&ordm; Liquidaci&oacute;n </div></td>
                  <td width="331" ><label>
                ...
                <tr>
                  <td width="181" height="22" align="right">Personal N&ordm; </td>
                  <td colspan="5" ><label>
                    <input name="txtcodper" type="text" id="txtcodper" size="15" style="text-align:center">
                  <a href="javascript: ue_buscarpersonal();"><img src="../../../shared/imagebank/tools20/buscar.png" alt="Buscar" name="personal" width="20" height="20" border="0" id="personal"></a></label></td>
                  <td ><label>
                ...
                <tr>
                  ...
                  <td colspan="6"><label>
                    <input name="txtnomper" type="text" id="txtnomper" size="68">
                    </label>                  </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="6">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td colspan="6"><label>
                    <input name="txtapeper" type="text" id="txtapeper" size="68">
                  </label></td>
                </tr>
                <tr>
                  <td height="16">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td colspan="6"><label>
                    ...
                    <input name="txtdennom" type="text" id="txtdennom" size="54">
                  </label></td>
                </tr>
                <tr>
                  <td height="16">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td colspan="6"><label>
                    <input name="txtcargo" type="text" id="txtcargo" size="68">
                  </label></td>
                </tr>
                <tr>
                  <td height="16">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td colspan="6"><label>
                    <input name="txtdedicacion" type="text" id="txtdedicacion" size="68">
                  </label></td>
                </tr>
                <tr>
                  <td height="16">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td colspan="6"><label>
                    <input name="txttipopersonal" type="text" id="txttipopersonal" size="68">
                  </label></td>
                </tr>
                <tr>
                  <td height="16">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td width="54"><div align="right">A&ntilde;os</div></td>
                  <td width="46"><label>
                    <input name="txtano" type="text" id="txtano" size="2" maxlength="4" style="text-align:center">
                  </label></td>
                  <td width="44"><div align="right">Meses</div></td>
                  <td width="33"><label>
                    <input name="txtmes" type="text" id="txtmes" size="2" maxlength="4" style="text-align:center">
                  </label></td>
                  <td><div align="right">D&iacute;as</div></td>
                  <td><label>
                    <input name="txtdia" type="text" id="txtdia" size="2" maxlength="4" style="text-align:center">
                  </label></td>
                </tr>
                <tr>
                  <td height="16">&nbsp;</td>
                ...
                <tr>
                  ...
                  <td colspan="6"><label>
                    <select name="cmbcauret" id="cmbcauret">
                    </select>
                  </label></td>
                </tr>
              </table>
              ...
              <table width="99%" border="0" cellspacing="0" cellpadding="0" class="formato-blanco" style="border-color:#FFFFFF">
                ...
                <tr>
                  ...
                  <td height="16" colspan="2"><label>
                    ...
                    <a href="javascript: ue_buscar_sc_cuenta();"><img src="../../../shared/imagebank/tools20/buscar.png" alt="Buscar" name="sc_cuenta" width="20" height="20" border="0" id="sc_cuenta"></a></label></td>
                  <td height="16">&nbsp;</td>
                  <td height="16">&nbsp;</td>
                  <td height="16">&nbsp;</td>
                </tr>
