<?php
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_scg->uf_load_seguridad_reporte("SCG","tepuy_scg_r_comparados_balance_general.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	{
		case "0":
			require_once("tepuy_scg_class_comparados.php");
			$io_report  = new tepuy_scg_class_comparados();
			$ls_bolivares ="Bolivares";
			break;

		case "1":
			require_once("tepuy_scg_class_comparadosbsf.php");
			$io_report  = new tepuy_scg_class_comparadosbsf();
	...
	if($lb_valido)
	{
		...
		else// Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_tot;$li_i++)
			{
				...
				$la_data[$li_i]=array('cuentas'=>$ls_cuenta,'denominacion'=>$ls_denominacion ,'periodo1'=>$ldec_periodo,
							  'acumulado1'=>$ldec_acumulado,'periodo2'=>$ldec_periodo2,'acumulado2'=>$ldec_acumulado2,'absoluta1'=>$ldec_absoluta1,'porc1'=>number_format($ldec_porc1,2,",","."),'absoluta2'=>$ldec_absoluta2,'porc2'=>number_format($ldec_porc2,2,",","."),'reprox'=>number_format($ldec_reprog,2,",","."));
			}//for
