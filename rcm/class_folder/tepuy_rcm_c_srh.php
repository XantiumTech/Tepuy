<?php
class tepuy_rcm_c_srh
{
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_rcm_c_srh()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_rcm_c_srh
		//		   Access: public 
...
/*		$ld_fecha=date("Y_m_d_H_i");
	...
	function uf_convertir_srhcontratos()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_srh MÉTODO->SELECT->uf_convertir_srhcontratos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_srhmovimientopersonal()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scv MÉTODO->SELECT->uf_convertir_srhmovimientopersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_srhsolicitudadiestramientos()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_scv MÉTODO->SELECT->uf_convertir_srhsolicitudadiestramientos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
