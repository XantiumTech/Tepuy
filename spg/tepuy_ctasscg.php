...
$con=$in->uf_conectar();
include("../shared/class_folder/class_tepuy_int_scg.php");
require_once("tepuy_spg_c_unidad.php");
$dat=$_SESSION["la_empresa"];
$nvo_estprog=new tepuy_spg_c_unidad();
...
<script language="JavaScript">
  ...
  function aceptar(cuenta,d,status)
  {
	...
	opener.document.form1.txtdencuentascg.value=d;
