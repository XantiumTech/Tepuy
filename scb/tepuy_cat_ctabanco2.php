...
$io_update 		 = new class_funciones_banco();/////agregado el 13/12/2007
$io_conf   = new tepuy_scb_c_emision_chq();
...
<table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        <td height="22">&nbsp;</td>
        <td height="22"><div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a></div>
...
////////////////////////////////////////////agregado el 13/12/2007//////////////////////////////////////////////////	
       if ($ls_operacion=="TOMAR") 
	   { 
	    $ls_status=$arr["confi_ch"];
		if ($ls_status==1)		 
		 {		   
		  require_once("../shared/class_folder/class_mensajes.php");
		  $io_msg1		= new class_mensajes();	
		    ...
		    $ls_valor=$io_update->uf_select_cheques($ls_codban,$ls_ctaban);
			//print "primero".$ls_valor;
		      if($ls_valor!="")
			   {			      
		         $ls_estatus=1;
				   $ls_valor=$io_update->uf_select_cheques($ls_codban,$ls_ctaban);
				   //print "segundo".$ls_valor;
		           $io_update->uf_update_estado_cheque($ls_estatus,$ls_codemp,$ls_codban,$ls_ctaban,$ls_valor);
				?>
	              <script language="javascript">
				  /////////////////////////////////////////////////////////////77
				     function ue_ver(numche)
                     { 
					   longitud=15
					   if (numche!="")
					    {
						 var mystring=new String(numche);
			             cadena_ceros="";
			             ...
			             numche=cadena_ceros+numche;						
                         opener.document.form1.txtdocumento.value=numche;
						 document.form1.txtlectura.value="readonly";					 					 
						}
                     }
				 //////////////////////////////////////////////////////////////////
				      ue_ver(<?php print $ls_valor;?>)
					  close();
			      </script>
	          <?php
			   }
	            ...
	            <script language="javascript">
					...
					////////////////////////////////////////////////////////////77
				     function ue_ver2()
					 {					   						
                       opener.document.form1.txtdocumento.value=" ";	 				 					 
...
<script language="JavaScript">
  ...
  function aceptar(codban,nomban,ctaban,dencta,ctascg,denctascg,fecapertura,feccierre,status,codtipcta,nomtipcta,saldo)
  {
	...
	opener.document.form1.txtdisponible.value=uf_convertir(saldo);
	   ...
	   f.action="tepuy_cat_ctabanco2.php";
	   f.submit();
