...
var url= "../../php/tepuy_srh_a_ganadores_concurso.php";
var metodo='get';
var img="<img src=\"../../../public/imagenes/progress.gif\"> ";


var loadDataURL = "../../php/tepuy_srh_a_ganadores_concurso.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_ganadores_concurso.php";
var mygrid;
 ...
 fechahas=document.form1.txtfechahas.value;
  ...
  if (!valfec)
	 ...
	 else
	 {
		 ...
		 mygrid.loadXML("../../php/tepuy_srh_a_ganadores_concurso.php?valor=buscar"+"&txtfechades="+fechades+"&txtfechahas="+fechahas+"&txtcodcon="+codcon);
...
function aceptar ( ls_codcon, ls_fecha, ls_descon, ls_codcondestino,ls_descondestino, ls_fechadestino, ls_ejecucion)
	{
		...
		if(ls_ejecucion=="1")
		{
		 ...
		 opener.document.form1.hidstatus.value="";
			...
			opener.document.form1.action="../pantallas/tepuy_srh_p_ganadores_concurso.php";
...
function catalogo_concurso()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_concurso.php";
