...
if((!array_key_exists("ls_database",$_SESSION))||(!array_key_exists("ls_hostname",$_SESSION))||(!array_key_exists("ls_gestor",$_SESSION))||(!array_key_exists("ls_login",$_SESSION)))
{
	...
	print "opener.location.href='../tepuy_inicio_sesion.php';";
	print "close();";
	print "</script>";		
} 
...
<html>
<head>
<title>Cat&aacute;logo de Contratos Otorgados</title>
  ...
  <p align="center">
    <input name="operacion" type="hidden" id="operacion">
  	 ...
  	 <table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
    	<tr>
     	 	<td width="800" colspan="2" class="titulo-celda">Cat&aacute;logo de Contratos Otorgados</td>
    	</tr>
	 </table>
	 <br>
	 <table width="800" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        <td height="29">&nbsp;</td>
        <td height="29"><div align="right">N&uacute;mero de Contrato </div></td>
       <!-- <td><input name="txtcodobr" type="text" id="txtcodobr" value="<? print $ls_codigoobr;?>" size="6" maxlength="6"></td>-->
        <td><input name="txtcodobr" type="text" id="txtcodobr" value="<? print $ls_contrato;?>" size="6" maxlength="6"></td>
        <td>&nbsp;</td>
...
if($ls_operacion=="BUSCAR")
{
	if ($ls_opener!="")
	{
		if($ls_opener=="anticipo" || $ls_opener=="variacion" || $ls_opener=="valuacion")
		{
			$ls_sql="SELECT c.codcon, c.monto, c.placon,c.placonuni, c.mulcon, c.fecfincon, c.tiemulcon, c.mulreuni,c.lapgarcon, c.lapgaruni,  c.codtco, a.cod_pro, a.cod_pro_ins,
					c.monmaxcon, c.pormaxcon,  c.obscon,  c.porejefiscon, t.nomtco, c.porejefincon, c.monejefincon,c.codasi,o.codobr,o.desobr,c.feccon,c.fecinicon,c.estcon,c.precon,c.estspgscg, a.basimpasi
		...
		elseif($ls_opener=="contrato")
		{
			$ls_sql="SELECT c.codcon, c.monto, c.placon,c.placonuni, c.mulcon, c.fecfincon, c.tiemulcon, c.mulreuni,c.lapgarcon, c.lapgaruni,  c.codtco, a.cod_pro, a.cod_pro_ins,
					c.monmaxcon, c.pormaxcon,  c.obscon,  c.porejefiscon, t.nomtco, c.porejefincon, c.monejefincon,c.codasi,o.codobr,o.desobr,c.feccon,c.fecinicon,c.estcon,c.precon,c.estspgscg, a.basimpasi
					FROM sob_contrato c,sob_asignacion a,sob_obra o, sob_tipocontrato t
					WHERE c.codemp='".$ls_codemp."' AND a.codemp='".$ls_codemp."' AND o.codemp='".$ls_codemp."' AND c.codasi=a.codasi AND a.codobr=o.codobr AND c.codtco=t.codtco
					AND o.codobr like '".$ls_codobr."'	AND  o.desobr like '".$ls_desobr."' AND (c.estcon=6 OR c.estcon=9 OR c.estcon=1) AND c.estspgscg=1  AND c.codcon like '".$ls_codcon."'
					AND a.codasi like '".$ls_codasi."' AND c.estcon<>3";
		}		
	}
	else
	...
	}else
	{
		...
		if($row=$io_sql->fetch_row($rs_data))
		{
			...
			print "<td><a href=javascript:ue_ordenar('c.precon','BUSCAR');><font color=#FFFFFF>Contrato.</font></a></td>";
			...
			for($li_z=1;$li_z<=$li_totrow;$li_z++)
			{
				...
				$ls_baseimp=$data["basimpasi"][$li_z];				
				//print "Imponible:".$ls_baseimp;
				if($ls_opener=="anticipo")
				{
				...
				'$ls_obscon','$ls_porejefiscon','$ls_porejefincon','$ls_monejefincon','$ls_codasi','$ls_feccrecon','$ls_fecinicon','$ls_nomtco','$ls_codobr','$ls_codpro','$ls_codproins','$ls_fecfincon','$ls_precon');\">".$ls_codigo."</a></td>";
				}
				else
				{
				print "<td ><a href=\"javascript: aceptar_contrato('$ls_codigo','$ls_desobr','$ls_estado','$ls_codest','$ld_monto','$ls_placon',
				'$ls_placonuni','$ls_mulcon','$ls_tiemulcon','$ls_mulreuni','$ls_lapgarcon','$ls_lapgaruni','$ls_codtco','$ls_monmaxcon','$ls_pormaxcon',
				'$ls_obscon','$ls_porejefiscon','$ls_porejefincon','$ls_monejefincon','$ls_codasi','$ls_feccrecon','$ls_fecinicon','$ls_nomtco','$ls_codobr','$ls_codpro','$ls_codproins','$ls_fecfincon','$ls_precon','$ls_baseimp');\">".$ls_codigo."</a></td>";
				}
				print "<td>".$ls_precon."</td>";
...
function aceptar(ls_codigo,ls_desobr,ls_estado,ls_codest,ld_monto,ls_placon,ls_placonuni,ls_mulcon,ls_tiemulcon,ls_mulreuni,ls_lapgarcon,ls_lapgaruni,
				...
				ls_fecinicon,ls_nomtco,ls_codobr,ls_codpro,ls_codproins,ls_fecfincon,ls_precon)
  {
  ...
  function aceptar_contrato(ls_codigo,ls_desobr,ls_estado,ls_codest,ld_monto,ls_placon,ls_placonuni,ls_mulcon,ls_tiemulcon,ls_mulreuni,ls_lapgarcon,ls_lapgaruni,
				ls_codtco,ls_monmaxcon,ls_pormaxcon,ls_obscon,ls_porejefiscon,ls_porejefincon,ls_monejefincon,ls_codasi,ls_feccrecon,
  ...
  f.action="tepuy_cat_contrato.php";
  f.submit();
  }
</script>
