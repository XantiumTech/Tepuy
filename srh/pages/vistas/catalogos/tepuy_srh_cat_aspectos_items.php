...
function Limpiar_busqueda () 
{
	...
	document.form1.txtdenasp.value="";
        ...
        var loadDataURL = "../../php/tepuy_srh_a_aspectos.php?valor=createXML_aspectos"+"&codeval="+codeval;
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_aspectos.php?valor=buscar_aspectos"+"&txtcodasp="+codasp+"&txtdenasp="+denasp+"&codeval="+codeval);
 		  setTimeout (terminar_buscar,500);
