...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Ejecuci&oacute;n Presupuestaria</td>
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SEP";
	$ls_ventanas = "tepuy_sep_p_transferencia.php";
	    ...
	    if (lb_marcadas)
		   {
			 ...
			 if (ls_cuenta=="")
				...
				if (ls_cuentacomp=="")
				  ...
				  f.action          = "tepuy_sep_p_transferencia.php";
				  f.submit();
				}
			}
		   }
