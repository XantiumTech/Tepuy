...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_activo_bien.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<!--  <tr>
  ...
  <tr>
    <td height="423" colspan="11" bgcolor="#E7E7E7" class="toolbar">&nbsp;</td>
  </tr>
  <tr> 
      ...
      <td height="22" colspan="3" align="center"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td height="22"><input name="txtcoduni" type="text" id="txtcoduni" size="15"  style="text-align:center" readonly>
              <a href="javascript: uf_unidad();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
      ...
      <td height="13" colspan="3" align="center"><table width="515" border="0">
        ...
        <tr>
          ...
          <td width="440">
              ...
              <a href="javascript:ue_grupo();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a> 
        ...
        <tr>
          ...
          <td>
		   <input name="txtcodsubgru" type="text" id="txtcodsubgru" size="21" maxlength="20"  style="text-align:center ">
              <a href="javascript:ue_subgrupo();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a> 
        ...
        <tr>
          ...
          <td><input name="txtcodsec" type="text" id="txtcodsec" size="21" maxlength="20"  style="text-align:center ">
              <a href="javascript:ue_seccion();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a> 
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/tepuy_saf_rpp_activo_bien.php?ordenact="+li_ordenact+"&desde="+ld_desde+
				...
				f.action="tepuy_siv_r_activo_bien.php";
