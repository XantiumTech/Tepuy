...
class tepuy_c_inicio_sesion
{
	...
	function tepuy_c_inicio_sesion()
	{
	...
	function  uf_sss_select_login($as_login,$as_password)
	{
		...
		//         Access: public (tepuy_inicio_sesion)
		...
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$_SESSION["la_tipusu"]=$row['tipusu'];
				//print "usuario".$row['tipusu'];
			}
			else
			{
				$lb_valido=false;
...
} //end class tepuy_c_inicio_sesion
?>
