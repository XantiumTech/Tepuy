...
class tepuy_c_inmueble_edificio
{
	var $dat;
	var $SQL;
	var $fun;
	
	function tepuy_c_inmueble_edificio()
	{
...
//---------------------------------------------------------------------------------------------------------------------------------------
											  ...
											  $as_estlegprop, $as_avaluo, $as_feccont, $as_moncont, $aa_seguridad)
	{
		...
		else
		{
			...
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="INSERT";
			$ls_descripcion ="se actualizó el Inmuble-Edificio ".$as_expact;
			$ls_variable= $this->seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
											$aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
											$aa_seguridad["ventanas"],$ls_descripcion);
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	/////////////////////////////////////////////////////////////////////////////////////////
		...
		else
		{
			...
			if($cantidad>0)
			{
				...
				$as_areatot     = $row["areatot"];
				$as_areacons    = $row["areacons"];
				$as_numpiso     = $row["numpiso"];
				$as_areatotpiso = $row["areatotpiso"];
				$as_areanex     = $row["areanex"];
...
///--------------------------------------------------------------------------------------------------------------------------------------
}//fin de la clase tepuy_c_inmueble_edificio
?>