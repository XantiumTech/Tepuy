...
<br>
    <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        <td>&nbsp;</td>
        <td colspan="3"><div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Buscar</a></div></td>
        <td colspan="3"><div align="right"><a href="javascript: ue_aceptar();"><img src="../shared/imagebank/tools20/aprobado.png" width="20" height="20" border="0">Aceptar</a></div></td>
      </tr>
    </table> 
<?php	
if(array_key_exists("operacion",$_POST))
{
	...
	$ls_codact="%".$_POST["txtcodtipest"]."%";
	$ls_denact="%".$_POST["txtdentipest"]."%";		
}
else
{
	$ls_operacion="";
...
else
{
	...
	function uf_print($ls_tipo,&$totrow)
	{
		...
		else
		{
			...
			{
				$object[1][1]="<input name=chktip1".$z." type=checkbox id=chktip1 value=1 class=sin-borde onClick=javascript:uf_selected('".$z."');>";
				$object[1][2]="<input type=text name=txtdentipest1".$z." value='' id=txtdentipest1 class=sin-borde readonly style=text-alin:center size=30 maxlength=30>
				<input type=hidden name=txtcodtipest1 value='' id=txtcodtipest1 readonly >";		
				$object[1][3]="<input type=text name=txtcodcomp1".$z." value='' id=txtcodcomp1 class=sin-borde readonly style=text-align:left size=12 maxlength=12>";	
				$object[1][4]="<input type=text name=txtdencomp1".$z." value='' id=txtdencomp1 class=sin-borde readonly style=text-align:left size=50 maxlength=50>";
			}
...
function ue_aceptar()
  {
	  ...
	  fop.action="tepuy_saf_d_inmueble_edificio.php";
	  fop.submit();
	  close(); 	  
}
...
function ue_search()
{
	...
	f.action="tepuy_saf_cat_material_edificio.php?total=<?PHP print $ls_totalgrid;?>";
	f.submit();
}
