...
if($ls_operacion=="")
{
	...
	if($ls_municipal=="0")
    	$ls_sql=" SELECT * FROM tepuy_deducciones ";  
	else
		$ls_sql=" SELECT * FROM tepuy_deducciones where estretmun = '1' ";  
	...
	for($z=1;$z<=$totrow;$z++)
	{
		...
		else
		{
			...
			$lb_sel="";
					...
					$object[$z][2]="<input type=text name=txtdoc".$z." value='".$ls_documento."'     id=txtdoc".$z." class=sin-borde readonly style=text-align:right  size=17 maxlength=15>";
					//$object[$z][3]="<input type=text name=txtcodded".$z." value='".$ls_codded."' id=txtcodcar".$z." class=sin-borde readonly style=text-align:center size=15 maxlength=10 >";		
...
if($ls_operacion=="PROCESAR")
{
	...
	for($z=1;$z<=$totrow;$z++)
	{
		...
		if(array_key_exists("chk".$z,$_POST))
		{
			...
			$la_deducciones["MonRet"][$z]=$ldec_montoret; print $ldec_montoret;
...
<form name="form1" method="post" action="">
  <table width="550" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td align="center"><div align="left">          <a href="javascript: uf_aceptar();"><img src="../shared/imagebank/tools20/aprobado.png" alt="Aceptar" width="20" height="20" border="0"></a> <a href="javascript: uf_aceptar();">Procesar Deducciones</a> </div>
    </tr>
  </table>
  <p align="center">
    <?Php
...
<script language="JavaScript">
  ...
  function uf_aceptar()
  {
	...
	f.actio="tepuy_cat_deducciones.php"
  ...
  function uf_calcular_monret()
  {
	...
	f.action="tepuy_cat_deducciones.php";
	f.submit();
  }
