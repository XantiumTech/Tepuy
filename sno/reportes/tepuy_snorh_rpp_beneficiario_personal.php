<?PHP
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte("SNR","tepuy_snorh_r_personal_beneficiario.php",$ls_descripcion);
		return $lb_valido;
	}
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_cabecera(&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos' => 312,
						 'cols'=>array('cedper'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'nomper'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
						 			   'cedben'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'nomben'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'innerLineThickness' =>0.5,
						 'xPos' => 312,
						 'cols'=>array('cedper'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
						 			   'nomper'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
						 			   'cedben'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'nomben'=>array('justification'=>'left','width'=>150), // Justificación y ancho de la columna
						 			   'nexben'=>array('justification'=>'center','width'=>55), // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		if ($li_numrowtot>0)
		{
			...
			{    $i++;
				 ...
				 $ls_data[$i]=array('cedper'=>$ls_cedper,'nomper'=>$ls_nomper,'cedben'=>$ls_cedbene,
