...
/****************************************************************************************************************************************/	
class tepuy_spg_reporte_comparados_forma05
{
    //conexion	
	var $sqlca;   
...
/****************************************************************************************************************************************/	
    function  tepuy_spg_reporte_comparados_forma05()
    {
...
/****************************************************************************************************************************************/
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    18/10/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido = false;	 
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //	   Description :	Reporte que genera salida  del Ejecucion Financiera Formato 3
	 //     Creado por :    Ing. Yozelin Barragán.
	 // Fecha Creación :    28/01/2007          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido = false;	 
		$ls_gestor = $_SESSION["ls_gestor"];
		$ls_codemp = $this->dts_empresa["codemp"];
			...
			while($row=$this->SQL->fetch_row($rs_data))
			{
			   ...
			   {				  
				   ...
				   if($lb_valido)
				   {
					  ...
					  $ld_causado=0;
					  $ld_pagado=0;
					  $lb_valido=$this->uf_spg_reporte_calcular_ejecutado_trimestre_act_acum($ls_spg_cuenta,$ls_estructura_desde,$ls_estructura_hasta,
																						$li_mesdes,$li_meshas,$ld_monto_ejecutado,
																						$ld_ejecutado_acumulado,$ld_aumdismes,$ld_aumdisacum,
																						$ld_comprometer,$ld_causado,$ld_pagado,$ls_tipo,
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //     Creado por :    Ing. Yozelin Barragán.
	 // Fecha Creación :    18/10/2006          Fecha última Modificacion :26/06/2006      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  $lb_valido = true;	 
	  $ls_gestor = $_SESSION["ls_gestor"];
	  $ls_codemp = $this->dts_empresa["codemp"];
	  ...
	  if(($as_codrep=="0415")||($as_codrep=="0518"))
	  {
		  if (strtoupper($ls_gestor)=="MYSQL")
		  {
			   $ls_cadena="CONCAT(codestpro1,codestpro2)";
		  }
		  else
		  {
			   $ls_cadena="codestpro1||codestpro2";
		  }
	  } 
	  else
	  {
...
/****************************************************************************************************************************************/	
    function uf_spg_reporte_calcular_programado_trimestre_anterior($as_clave,$ad_asignado,$as_spg_cuenta,$as_estructura_desde,
																   ...
																   $ad_noviembre,$ad_diciembre,$as_codfuefindes,$as_codfuefinhas)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $ld_monto_programado=0;
	 $ld_monto_acumulado=0;
/*	 $lb_valido=$this->uf_spg_reporte_calcular_programado($li_mesdes,$li_meshas,$ld_monto_programado,$ld_monto_acumulado,$ad_enero,
	                                                      $ad_febrero,$ad_marzo,$ad_abril,$ad_mayo,$ad_junio,$ad_julio,$ad_agosto,
														  $ad_septiembre,$ad_octubre,$ad_noviembre,$ad_diciembre,$as_codfuefindes,
														  $as_codfuefinhas);*/
														  													  
	 $lb_valido=$this->uf_spg_reporte_calcular_programado($li_mesdes,$li_meshas,$ld_monto_programado,$ld_monto_acumulado,
	                                                      $as_estructura_desde,$as_estructura_hasta,"0503",$as_spg_cuenta,
														  $as_codfuefindes,$as_codfuefinhas);
	 $ld_monto_ejecutado=0;
...
function uf_spg_reporte_calcular_ejecutado_trimestre_act_acum($as_spg_cuenta,$as_estructura_desde,$as_estructura_hasta,$ai_mesdes,
	                                                         $ai_meshas,&$ad_monto_ejecutado,&$ad_monto_acumulado,&$ad_aumdismes,
														     &$ad_aumdisacum,&$ad_comprometer,&$ad_causado,&$ad_pagado,$as_tipo,
														     &$ld_ejec_t_ant,$as_codfuefindes,$as_codfuefinhas)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 /* $ls_sql=" SELECT DT.fecha, DT.monto, OP.aumento, OP.disminucion, OP.precomprometer,OP.comprometer, OP.causar, OP.pagar ".
	  ...
	  else
	  {
		while($row=$this->SQL->fetch_row($rs_ejec))
		{
		  ...
		  if(($li_comprometer)&&($ldt_fecha>=$li_mesdesant)&&($ldt_fecha<=$li_meshas))
		  { 
		    $ad_comprometer=$ad_comprometer+$ld_monto;
		  }//if
		  //if(($li_causar)&&($ldt_fecha>=$li_mesdes)&&($ldt_fecha<=$li_meshas))
		  if(($li_causar)&&($ldt_fecha>=$li_mesdesant)&&($ldt_fecha<=$li_meshas))
		  { 
		    $ad_causado=$ad_causado+$ld_monto;
		  }//if
		  if(($li_pagar)&&($ldt_fecha>=$li_mesdesant)&&($ldt_fecha<=$li_meshas))
		  { 
		    $ad_pagado=$ad_pagado+$ld_monto;
		  }//if
		  if(($li_aumento)&&($ldt_fecha>=$li_mesdes)&&($ldt_fecha<=$li_meshas))
...
/****************************************************************************************************************************************/
    function uf_spg_reportes_select_ejecucion_financiera_forma0503($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,
	                                            				   $as_codestpro4_ori,$as_codestpro5_ori,$as_codestpro1_des,
					                                               $as_codestpro2_des,$as_codestpro3_des,$as_codestpro4_des,
											  					   $as_codestpro5_des,$as_codfuefindes,$as_codfuefinhas,&$rs_data)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/****************************************************************************************************************************************/	
	///////////////////////////////////////////////////////////////////////////////////////////////////////
	//   CLASE REPORTES SPG  COMPARADOS " EJECUCIÓN FINANCIERA DE LOS PROYECTOS DEL ENTE FORMA  #0516 " //
	/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //     Creado por :    Ing. Yozelin Barragán.
	 // Fecha Creación :    19/10/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($lb_valido)
	{
	 ...
	 for($z=1;$z<=$li_total;$z++)
	 {
		...
		$ls_sql=" SELECT C.spg_cuenta, C.nivel, max(C.denominacion) as denominacion, ".
			    ...
			    " WHERE  P.codemp='".$ls_codemp."' AND R.codrep='0516' AND R.status <> 'I' AND ".
				"        ".$ls_cadena."  BETWEEN '".$ls_estructura_desde."' AND '".$ls_estructura_hasta."' AND ".
				"        EP.codfuefin BETWEEN '".$as_codfuefindes."' AND '".$as_codfuefinhas."' AND ".
						  ...
						  {						
							...
							{// calculo la programacion de los meses anteriores
							  ...
							  $lb_valido=$this->uf_spg_reporte_calcular_programado(1,$li_meshas-1,$ld_monto_programado_ant,
																				   ...
																				   $ld_agosto,$ld_septiembre,$ld_octubre,
																				   $ld_noviembre,$ld_diciembre,$as_codfuefindes,
																				   $as_codfuefinhas);	
								if($lb_valido)
								{   
								    $ab_pasar=true;
...
/****************************************************************************************************************************************/
    function uf_spg_reporte_select_proyecto( $as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,$as_codestpro5_ori,
											 ...
											 $as_estcla,$as_codrep,$as_codfuefindes,$as_codfuefinhas)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/****************************************************************************************************************************************/
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//   CLASE REPORTES SPG  COMPARADOS " EJECUCIÓN FINANCIERA DE LAS ACCIONES CENTRALIZADAS DEL ENTE #0517 "  //
	////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($lb_valido)
	{
	 ...
	 for($z=1;$z<=$li_total;$z++)
	 {
		...
		$ls_codestpro2_ori=substr($ls_programatica,20,6);
		$ls_codestpro3_ori=substr($ls_programatica,26,3);
	    $ls_codestpro4_ori=substr($ls_programatica,29,2);
	    $ls_codestpro5_ori=substr($ls_programatica,31,2);
		$ls_estructura_desde=$ls_codestpro1_ori.$ls_codestpro2_ori.$ls_codestpro3_ori.$ls_codestpro4_ori.$ls_codestpro5_ori;
		$ls_estructura_hasta=$ls_codestpro1_ori.$ls_codestpro2_ori.$ls_codestpro3_ori.$ls_codestpro4_ori.$ls_codestpro5_ori; 
...
/****************************************************************************************************************************************/
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//   CLASE REPORTES SPG  COMPARADOS " EJECUCIÓN FINANCIERA DE LAS ACCIONES ESPECIFICAS DEL ENTE FORMA #0518 "  //
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/****************************************************************************************************************************************/
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 {
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->tepuy_spg_class_report MÉTODO->uf_spg_reporte0415_select_proyecto ERROR->".$this->fun->uf_convertirmsg($this->SQL->message));
	 }
	else
	{
		if($row=$this->SQL->fetch_row($rs_data))
...
/**********************************************************************************************************************************************/
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//   CLASE REPORTES SPG  COMPARADOS " EJECUCIÓN DE GASTOS ESPECÍFICOS DE PERSONAL,MATERIALES, SERVICIOS Y TRANSFERENCIAS.     //
	//                                    FORMA  #0514 "                                                                          //
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //                     $ai_nivel    //  nivel 
     //	       Returns :	Retorna true o false si se realizo la consulta para el reporte
	 //	   Description :	Reporte que genera salida  EJECUCIÓN DE GASTOS ESPECÍFICOS DE PERSONAL,
	...
	/*	$ls_sql=" SELECT spg_cuenta,denominacion,codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,asignado ".
		...
		$ls_sql=" SELECT C.spg_cuenta,C.denominacion,C.codestpro1,C.codestpro2,C.codestpro3,C.codestpro4,C.codestpro5,C.asignado ".
				...
				"     EP.codfuefin BETWEEN '".$as_codfuefindes."' AND '".$as_codfuefinhas."'  AND ".
				"	  ".$ls_cadena."  BETWEEN '".$ls_estructura_desde."' AND '".$ls_estructura_hasta."' ".$ls_cadena_fuefin." ".
				" ORDER BY C.spg_cuenta";
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    24/08/2006               Fecha última Modificacion :      Hora :
	  ...
	  {   // error interno sql
		  $this->is_msg_error="Error en consulta metodo uf_spg_reportes_comparados_formato0514".$this->fun->uf_convertirmsg($this->SQL->message);
		  /*$this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_forma05  
