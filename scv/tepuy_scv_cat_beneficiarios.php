...
<form name="form1" method="post" action="">
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
   <td height="22" colspan="2"><div align="right"><a href="javascript:ue_search();"><img src="../shared/imagebank/tools20/buscar.png" width="20" height="20" border="0">Buscar Beneficiario</a></div></td>
   </tr>
...
<script language="JavaScript">
	...
	function ue_search()
	{
		...
		f.action="tepuy_scv_cat_beneficiarios.php";
		f.submit();
	}
</script>
</html>