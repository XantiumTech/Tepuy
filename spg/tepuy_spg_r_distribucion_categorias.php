...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_distribucion_categorias.php";
...
<title>INDICE DE CATEGORIAS PROGRAMATICAS</title>
...
$ls_sql="SELECT codestpro1, denestpro1 FROM spg_ep1 ORDER BY codestpro1";	
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">INDICE DE CATEGORIAS PROGRAMATICAS<br>
      </td>
    </tr>
  </table>
    ...
    <tr>
      <td height="40" colspan="3" align="center">      <div align="left">
        <table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr> 
            <td width="100"><div align="right">Sector</div></td>
...
function ue_llenarsector()
{
	document.form1.operacion.value="sector";
...
function ue_showouput()
{
	...
	pagina="reportes/tepuy_spg_rpp_distribucion_categorias.php?combo="+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato;
