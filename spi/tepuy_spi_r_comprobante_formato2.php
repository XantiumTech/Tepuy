...
<!--  <tr> 
  ...
  <tr> 
    <td height="32" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput('<?php print $ls_codemp ?>');"><img src="../shared/imagebank/tools20/imprimir.png" width="20" height="20" border="0"></a></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a>
...
function ue_showouput(codemp)
{
	...
	{
		pagina="reportes/tepuy_spg_rpp_comprobante_formato2.php?hidcodemp="+codemp+"&txtcuentades="+txtcuentades
