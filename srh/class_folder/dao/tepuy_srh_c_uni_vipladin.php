...
class tepuy_srh_c_uni_vipladin
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_srh_c_uni_vipladin($path)
...
//--------------------------------------------------------------------------------------------------------------------------------	
	function uf_srh_select_uni_vipladin($as_coduni)
	{
		...
		//         Access: public (tepuy_srh_d_uni_vipladin)
...
//-------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_srh_delete_uni_vipladin($as_coduni,$aa_seguridad)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$lb_existe= uf_srh_select_unidad_personal ($as_coduni);
		if($lb_existe)
		{
			$lb_existe=true;		
			$lb_valido=false;
