...
<form name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="565" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        <td height="22">&nbsp;</td>
        <td height="22" colspan="4" style="text-align:right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar..." width="20" height="20" border="0">Buscar</a></td>
      </tr>
      <tr>
			   ...
			   while($row=$io_sql->fetch_row($rs_data))
			        {
			          ...
			          $ld_fecmovcol = $io_funcion->uf_convertirfecmostrar($row["fecmovcol"]);
...
f = opener.document.form1;
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_cat_mov_colocacion.php";
	  f.submit();
  }
