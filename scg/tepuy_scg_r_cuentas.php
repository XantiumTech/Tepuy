<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","tepuy_scg_r_cuentas.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
      ...
      <td colspan="4" align="center"><table width="520" border="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="170"><div align="left">
            <input name="txtcuentadesde" type="text" id="txtcuentadesde"  size="22" readonly>
...
function ue_search()
{
	...
	{	
		...
		pagina="reportes/tepuy_scg_rpp_cuentas.php?cuentadesde="+ls_cuentadesde+"&cuentahasta="+ls_cuentahasta;
...
function ue_openexcel()
{
	...
	{	
		ls_cuentadesde  = f.txtcuentadesde.value;
		ls_cuentahasta  = f.txtcuentahasta.value;
		pagina="reportes/tepuy_scg_rpp_cuentas_excel.php?cuentadesde="+ls_cuentadesde+"&cuentahasta="+ls_cuentahasta;
		window.open(pagina,"Reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
   	}
	else
   	{
