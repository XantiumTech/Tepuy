...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_r_reportepartidasobra.php";
...
<input name="txtcodcovpar" type="text" id="txtcodcovpar" value="<? print $ls_codcovpar?>" size="15" maxlength="15"></td>
                ...
                <tr>
                  ...
                  <td colspan="3" ><input name="txtcodcatpar" type="text" id="txtcodcatpar" value="<? print $ls_codcatpar?>" size="4" maxlength="4">
                    <span class="toolbar"><a href="javascript:ue_catcategoriapartida();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"></a></span>
