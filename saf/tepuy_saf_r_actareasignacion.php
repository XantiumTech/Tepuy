...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_actareasignacion.php",$ls_permisos,$la_seguridad,$la_permisos);
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","FORMATO_ACTAREASIGNACION","tepuy_saf_rpp_acta_reasignacion.php","C");
