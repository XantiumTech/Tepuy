...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_p_opd_causapaga.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<!--  <tr>
  ...
  <tr>
    ...
    <td class="toolbar" width="25"><div align="center"><a href="javascript:ue_generar_cmp();"><img src="../shared/imagebank/tools20/ejecutar.png" alt="Generar Comprobante de Retenci&oacute;n IVA" title="Generar Comprobante de Retenci&oacute;n IVA"  width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="25"><div align="center"><a href="javascript:ue_generar_cmp_mun();"><img src="../shared/imagebank/tools20/ejecutar.png" alt="Generar Comprobante de Retenci&oacute;n Municipal" title="Generar Comprobante de Retenci&oacute;n Municipal" width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="25"><div align="center"><a href="javascript:ue_generar_cmp_islr();"><img src="../shared/imagebank/tools20/ejecutar.png" alt="Comprobante ISLR" title="Comprobante ISLR" width="20" height="20" border="0"></a></div></td>
...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr class="titulo-ventana">
      <td colspan="6"> Orden de Pago Directa con Compromiso Previo </td>
    </tr>
    <tr>
      <td colspan="6">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td width="199"><div align="left">
          <input name="txtmonto" type="text" id="txtmonto" style="text-align:right" onBlur="javascript:uf_format(this);uf_montoobjret(this);" value="<?php print number_format($ldec_montomov,2,",",".");?>" size="24" readonly>
      </div></td>
    ...
    <tr>
      ...
      <input name="txtdenftefinanciamiento" type="text" class="sin-borde" id="txtdenftefinanciamiento" value="<?php print $ls_denfuefin; ?>"></td>
...
f.action="tepuy_scb_p_opd_causapaga.php";
f.submit();
}
...
function ue_imprimir()
{
	...
	{*/
		ls_pagina="reportes/tepuy_scb_rpp_ordenpago.php?codban="+ls_codban+"&ctaban="+ls_ctaban+"&numdoc="+ls_numdoc+"&codope="+ls_codope;
			...
			else
			{
				if((lb_valido)&&(ls_provbene!="")&&(ls_descripcion!="")&&(ls_codban!="")&(ls_ctaban!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto>0))
				{
					ls_pagina = "tepuy_w_regdt_cargos_op.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+
									...
									ls_codconmov+"&tip_mov= &opener=tepuy_scb_p_opd_causapaga.php&estdoc="+ls_estdoc+"&tipdocres="+
   ...
   function  uf_agregar_dtpre()
   {
		...
		if((ls_status!='C')&&(ls_status!='O')&&(ls_status!='A'))
		{
			...
			else
			{
				...
				{
					ls_pagina = "tepuy_scb_cat_compromisos_op.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+
									ld_fecha+"&procede="+ls_procede+"&tipo="+ls_tipo+"&provbene="+ls_provbene+"&descripcion="+
									ls_descripcion+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&cuenta_scg="+
									ls_cuenta_scg+"&mov_operacion="+ls_operacion+"&monto="+ldec_monto+"&objret="+ldec_objret+"&retenido="+
									ldec_monret+"&chevau="+ls_chevau+"&estint="+li_estint+"&cobrapaga="+li_cobrapaga+"&afectacion="+
