...
$io_fun_compra->uf_load_seguridad("SOC","tepuy_soc_r_analisis_cotizacion.php",$ls_permisos,&$la_seguridad,$la_permisos);
$ls_reporte = $io_fun_compra->uf_select_config("SOC","REPORTE","LISTADO_ORDCOM","tepuy_soc_rpp_listado_orden_compra.php","C");
