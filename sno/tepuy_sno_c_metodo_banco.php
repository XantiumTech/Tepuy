<?PHP
class tepuy_sno_c_metodo_banco
{
	var $io_metodo1;
	var $io_metodo2;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_sno_c_metodo_banco()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_sno_c_metodo_banco
		//		   Access: public 
		...
		require_once("tepuy_sno_c_metodo_banco_1.php");
		$this->io_metodo1=new tepuy_sno_c_metodo_banco_1();
		require_once("tepuy_sno_c_metodo_banco_2.php");
		$this->io_metodo2=new tepuy_sno_c_metodo_banco_2();
	...
	}// end function tepuy_sno_c_metodo_banco
	//-----------------------------------------------------------------------------------------------------------------------------------
	
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_metodo_banco($as_ruta,$as_archivo,$as_ctaban,$as_metodo,$ac_codperi,$ad_fdesde,$ad_fhasta,$ad_fecproc,$adec_montot,$as_codcueban,
							 $aa_ds_banco,$as_codmetban,$as_desope,$as_quincena,$as_ref,$aa_seguridad)
	{ 	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			case "BANESCO":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_banesco($as_ruta,$aa_ds_banco,$ad_fecproc);
				break;

			case "BANESCO_PAYMUL":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_banesco_paymul($as_ruta,$aa_ds_banco,$ad_fecproc,$adec_montot,
				                                                             $as_codcueban,$as_ref);
				break;

			case "BICENTENARIO":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_banfoandes($as_ruta,$as_archivo,$aa_ds_banco,$ad_fecproc,$as_ctaban,$adec_montot);
				break;
				
			case "BIV VERSION 2":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_biv_version_2($as_ruta,$aa_ds_banco,$as_codmetban);
				break;

			case "BOD NUEVO":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_bod_2016($as_ruta,$as_archivo,$ac_codperi,$ad_fdesde,$ad_fhasta,$aa_ds_banco);
				break;
				
			case "BOD VERSION 3":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_bod_version_3($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codmetban);
				break;

			case "BOD 2016":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_bod_2016($as_ruta,$as_archivo,$aa_ds_banco,$ad_fecproc,$as_codmetban,"",$as_ctaban);
							   //   uf_metodo_banco_bod_2016($as_ruta,$as_archivo,$aa_ds_banco,$ad_fecproc,$as_codmetban,$as_descrip,$as_ctaban)
				break;

			case "CANARIAS":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_canarias($as_ruta,$aa_ds_banco,$ad_fhasta);
				break;

			case "CARACAS":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_caracas($as_ruta,$aa_ds_banco,$adec_montot,$as_codcueban);
				break;

			case "CARIBE":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_caribe($as_ruta,$aa_ds_banco,$adec_montot,$ad_fecproc);
				break;
				
			case "CARONI":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_caroni($as_ruta,$aa_ds_banco);
				break;

			case "CASA PROPIA":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_casapropia($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot);
				break;

			case "CASA PROPIA 2003":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_casa_propia_2003($as_ruta,$aa_ds_banco);
				break;
				
			case "CENTRAL":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_central($as_ruta,$aa_ds_banco,$as_codcueban,$adec_montot);
				break;

			case "CENTRAL VERSION 1":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_central_v1($as_ruta,$aa_ds_banco,$as_codcueban,$adec_montot);
				break;

			case "CONFEDERADO":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_confederado($as_ruta,$aa_ds_banco);
				break;
				
			case "DEL SUR E.A.P.":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_del_sur_eap($as_ruta,$aa_ds_banco,$ad_fhasta,$as_codmetban);
				break;

			case "EAP_MICASA":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_eap_micasa($as_ruta,$aa_ds_banco);
				break;

			case "FONDO COMUN":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_fondo_comun($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$as_codmetban,$as_desope);
				break;

			case "INDUSTRIAL":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_industrial($as_ruta,$aa_ds_banco);
				break;

			case "LARA":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_lara($as_ruta,$aa_ds_banco,$as_codcueban,$adec_montot);
				break;

			case "MERCANTIL":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_mercantil($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot);
				break;

			case "MI CASA":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_mi_casa($as_ruta,$aa_ds_banco);
				break;

			case "e-PROVINCIAL":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_e_provincial($as_ruta,$aa_ds_banco);
				break;
				
			case "e-PROVINCIAL_02":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_e_provincial_02($as_ruta,$aa_ds_banco);
				break;
				
			case "e-PROVINCIAL_03":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_e_provincial_03($as_ruta,$aa_ds_banco);
				break;
			
			case "e-PROVINCIAL_04":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_e_provincial_04($as_ruta,$aa_ds_banco);
				break;

			case "PROVINCIAL GUANARE":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_provincial_guanare($as_ruta,$aa_ds_banco,$ad_fecproc);
				break;

			case "PROVINCIAL NUEVO":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_provincial($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot);
				break;
			...
			case "PROVINCIAL_ALTAMIRA": 
			 	$lb_valido=$this->io_metodo1->uf_metodo_banco_provincial_altamira($as_ruta,$aa_ds_banco,$as_codmetban,$as_codcueban,$adec_montot,$ad_fecproc);
				break;

			case "SOFITASA":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_sofitasa($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codmetban);
				break;

			case "V2_CARONI":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_caroni_v_2($as_ruta,$aa_ds_banco,$ad_fecproc);
				break;

			case "VENEZUELA":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_venezuela($as_ruta,$as_archivo,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot);
				break;

			case "VENEZUELA_SNG":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_venezuela_sng($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot);
				break;

			case "BANPRO":
				$lb_valido=$this->io_metodo2->uf_metodo_banpro($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot);
				break;

			case "BANFOTRAN":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_banfotran($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot,$as_codmetban);
				break;

			case "VENEZUELA PAGO TAQUILLA":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_venezuela_pagotaquilla($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot);
				break;
				
			//case "VENEZUELA_SNG_INGRESO":
				//$lb_valido=$this->io_metodo2->uf_metodo_banco_venezuela_sng_ingreso($aa_ds_banco,$ad_fecproc,$as_codcuenta);
				//break;				

			case "VENEZUELA ESPECIAL":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_venezuelaespecial($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot);
				break;

			case "ONLINE_MERCANTIL":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_mercantilonline($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot,$as_codmetban);
				break;

			case "VENEZUELA TARJETA PREPAGADA Y CUENTA ABONO":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_venezuela_prepagoabono($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$adec_montot);
				break;

			case "BANCO FEDERAL":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_federal($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codcueban,$as_codmetban,$as_desope,
																	  $ad_fdesde,$ad_fhasta,$adec_montot,$as_quincena);
				break;

			case "BANCO AGRICOLA":
				$lb_valido=$this->io_metodo2->uf_metodo_banco_agricola($as_ruta,$aa_ds_banco);
				break;

			case "CORPBANCA":
			    $lb_valido=$this->uf_periodo(&$ls_codperi,&$ls_perides,&$ls_perihas);
				$lb_valido=$this->io_metodo1->uf_metodo_banco_corp_banca($as_ruta,$aa_ds_banco,$adec_montot,
				                                                         $ls_codperi,$ls_perides,$ls_perihas);
				break;
				
			case "BANCO_DEL_TESORO":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_deltesoro($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codmetban);
				break;
				
			case "BANCO_DEL_TESORO_2008":
				$lb_valido=$this->io_metodo1->uf_metodo_banco_deltesoro_2008($as_ruta,$aa_ds_banco,$ad_fecproc,$as_codmetban,
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_listadobanco_gendisk($as_codban,$as_suspendidos,$as_quincena,$as_pagtaqnom)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_listadobanco_gendisk
		//		   Access: public (desde la clase tepuy_sno_r_listadobanco)  
		...
		$ls_sql="SELECT sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.nacper, ".
				"		sno_personalnomina.codcueban, sno_personalnomina.tipcuebanper, ".$ls_monto.", sno_nomina.desnom,sno_nomina.codnom, sno_nomina.tippernom,sno_nomina.despernom,".
	...
	function uf_listadobanco_gendisk_consolidado($as_codban,$as_suspendidos,$as_quincena,$as_codnomdes,$as_codnomhas,
												 $as_codperdes,$as_codperhas,$as_pagtaqnom,$as_anocurnom)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_listadobanco_gendisk_consolidado
		//		   Access: public (desde la clase tepuy_snorh_r_listadobanco)  
		//	    Arguments: as_codban // Código del banco del que se desea busca el personal
		//	    		   as_suspendidos // si se busca a toto del personal ó solo los activos
		//	    		   as_quincena // Quincena para el cual se quiere filtar
		...
		$ls_sql="SELECT sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.nacper, ".
				"		sno_hpersonalnomina.codcueban, sno_hpersonalnomina.tipcuebanper, ".$ls_monto.", sno_hnomina.desnom,sno_hnomina.codnom, sno_hnomina.tippernom ".
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_listadobanco_gendisk_beneficiarios($as_codban,$as_suspendidos,$as_quincena)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_listadobanco_gendisk_beneficiarios
		//		   Access: public (desde la clase tepuy_sno_r_listadobeneficiario)  
		//	    Arguments: as_codban // Código del banco del que se desea busca el personal
		//	    		   as_suspendidos // si se busca a toto del personal ó solo los activos
		//	    		   as_quincena // Quincena para el cual se quiere filtar
		//	      Returns: lb_valido True si se creo el Data stored correctamente ó False si no se creo
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_load_montototal($as_codban,$as_suspendidos,$as_quincena,$as_pagtaqnom,&$ad_monto)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		else
		{
			...
			{
				$ad_monto=$row["total"];
				//$quincena1=floor($row["total"]/2);
				//print "Total en 1:".$ad_monto." quincena 1: ".$quincena1;
			}
			$this->io_sql->free_result($rs_data);
		}		
		return $lb_valido;
	...
	function uf_load_montototal_beneficiarios($as_codban,$as_suspendidos,$as_quincena,&$ad_monto)
	{
		...
		//		   Access: public (desde la clase tepuy_sno_r_listadobeneficiarios)  
		//	    Arguments: as_codban // Código del banco del que se desea busca el personal
		//	    		   as_suspendidos // si se busca a toto del personal ó solo los activos
		//	    		   as_quincena // Quincena para el cual se quiere filtar
		//	    		   ad_monto // monto total a pagar
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_periodo(&$as_codperi,&$as_perides,&$as_perihas)
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_periodo
		//		   Access: public (desde la clase tepuy_sno_r_listadobanco)  
		//	    Arguments: as_codperi // Código del periodo
		//	    		   as_perides // fecha del periodo desde
		//	    		   as_perihas // fecha del periodo hasta		//	    		   
		//	      Returns: lb_valido True si se creo el Data stored correctamente ó False si no se creo
		//    Description: función que busca la fecha desde y hasta del periodo actual
...

	{
	  ...
	  $ls_sql=" SELECT codperi, fecdesper, fechasper  ".
		...
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Report MÉTODO->uf_periodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
		...
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$as_perides=$row["fecdesper"];
				$as_perihas=$row["fechasper"];
			}
			else
			{
			    $as_codperi="";
