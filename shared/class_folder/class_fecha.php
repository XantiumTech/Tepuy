...
class class_fecha
{
	...
	function uf_valida_fecha_periodo($as_fecha,$as_codemp)
	{
	    ...
	    $li_ano_periodo = intval(substr($this->la_emp["periodo"],0,4));
	    $li_mes_periodo = intval(substr($this->la_emp["periodo"],5,2));
    ...
    function uf_valida_fecha_mes($as_codemp,$as_fecha)
 	{ ////////////////////////////////////////////////////////////////////////////////////////////	
	  ...
	  ////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $ls_cadena="SELECT m01,m02,m03,m04,m05,m06,m07,m08,m09,m10,m11,m12 FROM tepuy_empresa WHERE codemp = '".$as_codemp."'";
