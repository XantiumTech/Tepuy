		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					...
					case "replisperche": // el llamado se hace desde  tepuy_sno_r_listadopersonalcheque.php
						print "<tr class=celdas-blancas>";
					...
					case "replisban": // el llamado se hace desde  tepuy_sno_r_listadobanco.php
						print "<tr class=celdas-blancas>";
					...
					case "repconlisban": // el llamado se hace desde  tepuy_snorh_r_listadobanco.php
						print "<tr class=celdas-blancas>";
					...
					case "beneficiario": // el llamado se hace desde  tepuy_snorh_d_beneficiario.php
						print "<tr class=celdas-blancas>";
					...
					case "replisben": // el llamado se hace desde  tepuy_snorh_d_beneficiario.php
						print "<tr class=celdas-blancas>";
					...
					case "depbandes": // el llamado se hace desde  tepuy_snorh_r_listadobanco.php
						print "<tr class=celdas-blancas>";
					...
					case "depbanhas": // el llamado se hace desde  tepuy_snorh_r_listadobanco.php
						print "<tr class=celdas-blancas>";
...
function ue_search(existe)
{
	f=document.form1;
  	...
  	f.action="tepuy_snorh_cat_banco.php?tipo=<?PHP print $ls_tipo;?>";
  	f.submit();
}
</script>
</html>
