...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_p_ganadores_concurso.php";
  f.submit(); 
}
...
function Consultar()
{
     if   ($('txtcodcon').value=="") 		
	 {
	  ...
	  f.operacion.value="CONSULTAR";
  	  f.action="../pantallas/tepuy_srh_p_ganadores_concurso.php";
	  f.existe.value="TRUE";			
	  f.submit();	
	 }
}
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_ganadores_concurso.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=540,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
