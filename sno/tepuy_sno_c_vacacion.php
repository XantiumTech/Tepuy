...
class tepuy_sno_c_vacacion
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_sno_c_vacacion()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_sno_c_vacacion
		//		   Access: public (tepuy_snorh_d_vacacion, tepuy_sno_p_vacacionvencida)
		...
		require_once("tepuy_snorh_c_tablavacacion.php");
		$this->io_tablavacacion=new tepuy_snorh_c_tablavacacion();
		require_once("tepuy_snorh_c_diaferiado.php");
		$this->io_diaferiado=new tepuy_snorh_c_diaferiado();
	...
	}// end function tepuy_sno_c_vacacion
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_load_totalpersonal($as_codperdes,$as_codperhas,&$ai_totper)
	{
		...
		//		   Access: public (tepuy_sno_p_vacacionvencida)
	...
	function uf_insert_vacacion($as_codper,$ai_codvac,$ad_fecvenvac,$ai_diadisvac,$ai_diabonvac,$ai_diaadidisvac,$ai_diaadibonvac,
								$ai_sueintvac,$ai_sueintbonvac,$ai_stavac,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($lb_valido)
		{
			...
			$ls_sql="INSERT INTO sno_vacacpersonal(codemp,codper,codvac,fecvenvac,fecdisvac,fecreivac,diavac,stavac,sueintbonvac,".
					...
					"diafer,sabdom,diapag,pagcan)VALUES('".$this->ls_codemp."','".$as_codper."',".$ai_codvac.",'".$ad_fecvenvac."',".
					...
					"".$li_quireivac.",".$ai_diaadidisvac.",".$ai_diaadibonvac.",".$li_diafer.",".$li_sabdom.",0,0)";
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_load_fechareingreso($ad_fecdisvac,$ai_diadisvac,$ai_diaadidisvac,&$ad_fecreivac,&$ai_sabdom,&$ai_diafer)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ai_diafer=0;
		$li_diahab=1;
		$li_totdia=($ai_diadisvac+$ai_diaadidisvac);
								...
								$aa_seguridad)
	{
		...
		//		   Access: public (tepuy_snorh_d_vacacion, tepuy_sno_p_programarvacaciones)
		//	    Arguments: as_codper  // código del personal                    ai_codvac  // código de vacación
		...
		//				   ai_quireivac // Quincena de Reintegro				aa_seguridad  // arreglo de las variables de seguridad
						...
						if($lb_valido)
						{
							...
							while((strtotime($ld_fecvac)<strtotime($ld_fecha))&&($lb_valido))
							{
								$lb_valido=$this->uf_insert_vacacion($as_codper,$li_codvac,$ld_fecvac,$li_diadisvac,
																	 ...
																	 $li_sueintvac,$li_sueper,$li_stavac,$aa_seguridad);
								if($lb_valido)
								{
									$ld_ultvac=$ld_fecvac;
									$lb_valido=$this->uf_load_vacacion($as_codper,$ld_ultvac,$ld_fecvac,$ld_fecvacproper,$li_codvac,
																	   $li_diadisvac,$li_diabonvac,$li_diaadidisvac,$li_diaadibonvac);
								}
							}
						}					
	...
	function uf_procesar_porvencer($ad_codperdes,$ad_codperhas,$aa_seguridad)
	{
		...
		//		   Access: public (tepuy_sno_c_cierreperiodo)
	...
	function uf_load_vacacion($as_codper,$ad_fecvacant,&$ad_fecvacpro,&$ad_fecvacproper,&$ai_codvac,&$ai_diadisvac,&$ai_diabonvac,
							  &$ai_diaadidisvac,&$ai_diaadibonvac)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$li_diaspermiso=0;
		$lb_valido=$this->io_permiso->uf_load_totaldiaspermiso($as_codper,$ad_fecvacant,$ad_fecvacpro,$li_diaspermiso);
		if($lb_valido)
		{
			$ad_fecvacproper=$this->io_sno->uf_suma_fechas($this->io_funciones->uf_convertirfecmostrar($ad_fecvacpro),$li_diaspermiso);
	...
	{	
		...
		{
			//$ls_mesant="12";
			//$ls_anoant=str_pad((intval(substr($_SESSION["la_nomina"]["fecdesper"],0,4))-1),4,"0",0);
			$ls_codvac=0;
	...
	function uf_reprogramar_vacacion($as_codper,&$ad_fecdisvac,$ai_diadisvac,$ai_diabonvac,$ai_diaadidisvac,$ai_diaadibonvac,$ad_fecvenvac,
									 ...
									 &$ai_quisalvac,&$ai_quireivac,&$ai_sueintvac)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$this->io_mensajes->message("Para este período No se pueden Programar Vacaciones. Ya relizó el calculo de la Nómina. Reverse la Nómina y vuelva a programar"); 
			$lb_correcto=false;
		}
	...
	{	
		...
		//		   Access: public (tepuy_sno_c_calcularprenomina, uf_calcular_vacacion)
		//	    Arguments: as_codper // código de personal
		//	      Returns: lb_valido True si se creo la variable sesion ó False si no se creo
	...
	{	
		...
		//		   Access: public (tepuy_sno_c_calularnomina)
		//	    Arguments: as_codper // código de personal
