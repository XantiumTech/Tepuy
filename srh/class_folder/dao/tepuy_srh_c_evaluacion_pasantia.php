...
class tepuy_srh_c_evaluacion_pasantia
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_evaluacion_pasantia($path)
	{   
...
function uf_srh_guardarEvaluacion_Pasantia($ao_evaluacion,$as_operacion="insertar", $aa_seguridad)
  { 
		...
		//         access: public (tepuy_srh_evaluacion_pasantia)		   											            //
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		else
		{
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ao_object[$ai_totrows][5]="<a href=javascript:uf_delete_dt(".$ai_totrows.",txtres,txtvalor".$ai_totrows.");   align=center><img src=../../../../shared/imagebank/tools15/eliminar.png alt=Eliminar width=15 height=15 border=0 align=center></a>";				
			}
...
}// end   class tepuy_srh_c_evaluacion_pasantia
?>