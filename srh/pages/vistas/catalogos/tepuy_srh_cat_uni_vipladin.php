...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_uni_vipladin.js"></script>
...
<p>&nbsp;</p>
	...
	<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_uni_vipladin.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_uni_vipladin.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_uni_vipladin.php?valor=buscar"+"&txtcodunivi="+coduni+"&txtdenunivi="+denuni);
           setTimeout (terminar_buscar,500);
