...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  <tr> 
    <td height="40" class="cd-logo"><img src="../shared/imagebank/header.jpg" width="778" height="40"></td>
  </tr>
  <tr>
    <td height="30" class="cd-menu">
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
			
          <td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Control de Viaticos--> Transferencia de Personal</td>
...
<!-- ******** END ALLWEBMENUS CODE FOR menu ******** -->
 <!-- <tr>
  ...
  <tr>
    <td height="27" bgcolor="#FFFFFF" class="toolbar">&nbsp;</td>
  </tr>
  <tr> 
...
<?php
require_once("class_folder/tepuy_scv_c_beneficiario.php");
...
$io_beneficiario = new tepuy_scv_c_beneficiario();
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SCV";
	$ls_ventanas = "tepuy_scv_p_transferencia.php";
            ...
            <table width="490"  border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
              ...
              <tr class="formato-blanco">
                ...
                <td height="50"><table width="438" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                  <tr>
                    <td height="26" colspan="4"><strong>Cta. Contable Solicitud (Compromiso)</strong> <label>
                  ...
                  <tr>
                    <td height="26" colspan="4"><strong>Cuenta Contable O. Pago (Causado)</strong> <label>
	    ...
	    if (lb_marcadas)
		   {
			 ...
			 if (ls_cuenta=="")
			    {
				  alert("Debe establecer la Cuenta Contable (Causado) que será asociada al Beneficiario !!!");
				}
			 else
			    {
				...
				if (ls_cuentacomp=="")
			    	{
				  alert("Debe establecer la Cuenta Contable (Compromiso) que será asociada al Beneficiario !!!");
				}
			 	else
			    	{
				  f.operacion.value = "TRANSFERIR";
				  f.action          = "tepuy_scv_p_transferencia.php";
				  f.submit();
				}
			}
		   }
...
function uf_catalogo_personal()
{
  ...
  if (li_leer==1)
	 {
       pagina="tepuy_rpc_cat_personal.php";
