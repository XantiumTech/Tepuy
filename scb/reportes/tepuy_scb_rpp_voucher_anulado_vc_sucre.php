<?php
	...
	function uf_print_cabecera($as_numdoc,$ad_fecmov,$ad_fechaanula,$as_nomban,$as_nomproben,$as_conanu,$adec_total,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->addText(490,665,9,$ad_fechaanula); // Agregar el título
		$io_pdf->EzSetY(385);
		$la_data=array(array('numdoc'=>$as_numdoc,'fecmov'=>$ad_fecmov,'nomban'=>$as_nomban,'monto'=>$adec_total));
		$la_columna=array('numdoc'=>'','fecmov'=>'','nomban'=>'','monto'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'showLines'=>0, // Mostrar Líneas
						 'shaded'=>0, // Sombra entre líneas
						 'shadeCol2'=>array(0.9,0.9,0.9), // Color de la sombra
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('nomproben'=>''),array('nomproben'=>$as_nomproben));
		...
		unset($la_columna);
		unset($la_config);
		$la_data=array(array('conanu'=>''),array('conanu'=>$as_conanu));
