...
<html>
<head>
<title>Catalogo de Programaciones de pago a Beneficiarios</title>
...
print "<td width=70 style=text-align:center>Beneficiario</td>";
print "<td width=265 style=text-align:center>Nombre Beneficiario</td>";
...
if ($ls_operacion=="BUSCAR")
   {
	 ...
	 $ls_sql = "SELECT DISTINCT cxp_solicitudes.ced_bene,rpc_beneficiario.nombene, rpc_beneficiario.apebene, scb_prog_pago.codban,
		 ...
		 while($row=$io_sql->fetch_row($rs_data))
		      {
				...
				print "<td width=70 style=text-align:center><a href=\"javascript: uf_aceptar('$ls_cedben','$ls_nomben','$ls_codban','$ls_nomban','$ls_ctaban','$ls_nomcta','$ls_scgcta','$adec_saldo');\">".$ls_cedben."</a></td>";
				print "<td width=265 style=text-align:left>".$ls_nomben."</td>";
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_cat_prog_beneficiario.php";
	  f.submit();
  }
