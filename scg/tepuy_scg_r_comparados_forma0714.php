<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","tepuy_scg_r_comparados_forma0714.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
?>		  
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">INVERSIONES</td>
    </tr>
  </table>
	...
	{	
		...
		if(txtetiqueta=="Mensual")
		{
			...
			else
			{
				...
				{
				   pagina="reportes/tepuy_scg_rpp_comparados_forma0714.php?combo="+combo
		...
		else
		{
			...
			{
			   pagina="reportes/tepuy_scg_rpp_comparados_forma0714.php?combo="+combo+"&txtetiqueta="+txtetiqueta+"&tiporeporte="+tiporeporte;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
   	}
