var url= "../../php/tepuy_srh_a_requerimiento_cargo.php";
var metodo='get';
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_d_requerimiento_cargo.php";
  f.submit();
}
...
{
      f= document.form1;
      pagina="../catalogos/tepuy_srh_cat_requerimiento.php?valor_cat=0";
...
{
   pagina="../catalogos/tepuy_srh_cat_cargo_rac.php?valor_cat=0&tipo=3";
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_requerimiento_cargo.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
