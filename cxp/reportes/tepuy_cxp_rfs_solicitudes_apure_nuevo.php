...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_nompro,$as_dirpro,$as_estatus,$as_denfuefin,$as_consol,$as_obssol,$as_nomusu,$as_codigo,$as_status,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addText(443,732,11,"Nro.:     ".substr($as_numsol,9,6)); // Número de Orden de compra
...
/*
	// AQuI SE IMPRIME EN EL FORMATO INICIAL O POR DEFECTO QUE TIENE EL SISTEMA
		...
		$io_pdf->addText(42,63,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(157,122,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(145,63,7,"FIRMA / SELLO / FECHA"); // Agregar el título
		$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(278,63,7,"ADMINISTRACIÓN"); // Agregar el título
...
/* 		$io_pdf->Rectangle(15,50,570,87);
		...
		$io_pdf->addText(250,128,9,"<b> CONFORME FUNCIONARIOS </b>"); // Agregar el título
		//$li_tm=$io_pdf->getTextWidth(13,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]);
		$li_tm=$io_pdf->getTextWidth(13,$as_nomusu);
		$tm=100-($li_tm/2);
		$io_pdf->addText(47,118,7,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText($tm,55,7,$as_nomusu); // Agregar el título
//		$io_pdf->addText(157,122,7,"CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(147,55,7,"JEAN CARLOS OROZCO"); // Agregar el título
		$io_pdf->addText(146,118,7,"JEFE DE CONTABILIDAD"); // Agregar el título
//		$io_pdf->addText(275,122,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(270,55,7,"JOSE LUIS RODRIGUEZ"); // Agregar el título
		$io_pdf->addText(280,118,7,"ADMINISTRADOR"); // Agregar el título
//		$io_pdf->addText(440,122,7,"DESPACHO DEL ALCALDE"); // Agregar el título
		$io_pdf->addText(392,55,7,"JOSE ALVARADO"); // Agregar el título
		$io_pdf->addText(408,118,7,"ALCALDE"); // Agregar el título
		$io_pdf->addText(498,55,7,"OMAR BARRIETOS"); // Agregar el título
		$io_pdf->addText(485,118,7,"CONTRALOR MUNICIPAL"); // Agregar el título
*/
...
//FORMATO ALCALDIA DE GUASDUALITO
		...
		$io_pdf->addText(230,175,6,"<b>FIRMAS Y SELLOS PARA LA APROBACIÓN DE LA ORDEN DE PAGO</b>"); // Agregar el título
		//$li_tm=$io_pdf->getTextWidth(13,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]);
		$li_tm=$io_pdf->getTextWidth(13,$as_nomusu);
		$tm=120-($li_tm/2);
		$io_pdf->addText(50,165,6,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText($tm,118,6,$as_nomusu); // Agregar el título
		//$io_pdf->addText(187,104,6,"JEAN CARLOS OROZCO"); // Agregar el título
		$io_pdf->addText(154,118,6,"LCDO. JEAN CARLOS OROZCO"); // Agregar el título
		$io_pdf->addText(165,165,6,"JEFE DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(275,118,6,"LCDA.YURIBETH DAZA"); // Agregar el título
		$io_pdf->addText(290,165,6,"ADMINISTRADORA"); // Agregar el título
//		$io_pdf->addText(440,122,7,"DESPACHO DEL ALCALDE"); // Agregar el título
...
//		$io_pdf->addText(482,118,6,"JOSE ALVARADO"); // Agregar el título
		...
		$io_pdf->addText(406,118,6,""); // Agregar el título
		$io_pdf->addText(408,165,6,"AUDITORIA INTERNA"); // Agregar el título
...
/* 		//$io_pdf->Rectangle(15,60,570,70);
		...
		$io_pdf->line(385,115,385,173);
		$io_pdf->line(490,115,490,173);						
		$io_pdf->addText(230,175,6,"<b>FIRMAS Y SELLOS PARA LA APROBACIÓN DE LA ORDEN DE COMPRA</b>"); // Agregar el título
		//$li_tm=$io_pdf->getTextWidth(13,$_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"]);
		$li_tm=$io_pdf->getTextWidth(13,$as_nomusu);
		$tm=104-($li_tm/2);
		$io_pdf->addText(50,165,6,"ELABORADO POR:"); // Agregar el título
		...
		$io_pdf->addText(154,118,6,"LCDO. JEAN CARLOS OROZCO"); // Agregar el título
		$io_pdf->addText(165,165,6,"JEFE DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(275,118,6,"LCDO. JOSE LUIS RODRIGUEZ"); // Agregar el título
		$io_pdf->addText(290,165,6,"ADMINISTRADOR"); // Agregar el título
//		$io_pdf->addText(440,122,7,"DESPACHO DEL ALCALDE"); // Agregar el título
		$ls_nomrep = $_SESSION["la_empresa"]["nomrep"];
		$ls_cargorep = $_SESSION["la_empresa"]["cargorep"];
		$li_tm=$io_pdf->getTextWidth(6,$ls_nomrep);
...
//		$io_pdf->addText(482,118,6,"JOSE ALVARADO"); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(6,$ls_cargorep);
		$tm=440-($li_tm/2);
//		$io_pdf->addText(492,165,6,"ALCALDE"); // Agregar el título
		$io_pdf->addText($tm,165,6,"ALCALDE"); // Agregar el título
		$io_pdf->addText(505,118,6,"LCDA.YURIBETH DAZA"); // Agregar el título
		$io_pdf->addText(510,165,6,"AUDITORIA INTERNA"); // Agregar el título
	...
	$ls_status      = $io_fun_cxp->uf_obtenervalor_get("status","");
	global $ls_tiporeporte;
	require_once("../../shared/ezpdf/class.ezpdf.php");
	if($ls_tiporeporte==1)
	{
...
//print $ls_numsol;
		...
		else  // Imprimimos el reporte
		{
			...
			$io_pdf->ezSetCmMargins(7.5,7,3.3,3); // Configuración de los margenes en centímetros
...
//			$ls_rifpro=$ls_rifpro." Estatus: ".$ls_status;
...
//print "proveedor: ".$ls_cod_pro." cedula: ".$ls_cedbene;
				...
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_nompro,$ls_dirpro,$ls_estprosol,$ls_denfuefin,$ls_consol,$ls_obssol,$ld_nomusu,$ls_codigo,$ls_status,&$io_pdf);
