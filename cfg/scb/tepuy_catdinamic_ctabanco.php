			...
			else
			{
				if($row=$SQL->fetch_row($rs_cta))
				{
					...
					for($z=1;$z<=$totrow;$z++)
					{
						...
						print "<td><a href=\"javascript: aceptar('$codban','$nomban','$ctaban','$dencta','$ctascg','$denctascg','$fecapertura','$feccierre','$statuscta','$codtipcta','$nomtipcta');\">".$ctaban."</a></td>";
						print "<td>".$dencta."</td>";
						print "<td>".$nomban."</td>";
...
<script language="JavaScript">
  function aceptar(codban,nomban,ctaban,dencta,ctascg,denctascg,fecapertura,feccierre,statuscta,codtipcta,nomtipcta)
  {
  ...
  f.action="tepuy_catdinamic_ctabanco.php";
  f.submit();
  }
</script>
</html>
