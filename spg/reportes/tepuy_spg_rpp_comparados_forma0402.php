...
//-----------------------------------------------------------------------------------------------------------------------------
		...
		global $la_data_tot;
		 if($ls_tipoformato==1)
		 {
			require_once("tepuy_spg_reporte_comparado_0402_bsf.php");
			$io_report = new tepuy_spg_reporte_comparado_0402_bsf();
		 }
		 else
		 {
			require_once("tepuy_spg_reporte_comparado_0402.php");
			$io_report = new tepuy_spg_reporte_comparado_0402();
		 }	
