...
require_once("tepuy_scb_c_tipocta.php");
...
function ue_nuevo()
{
	...
	if (li_incluir==1)
	   {	
         ...
         f.action="tepuy_scb_d_tipocta.php";
		 f.submit();
	   }
	else
	   {
...
function ue_buscar()
{
	...
	if (li_leer==1)
       {
	     window.open("tepuy_scb_cat_tipocta.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
       }
	else
	   {
		 alert("No tiene permiso para realizar esta operación");
