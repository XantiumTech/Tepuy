<?php
	...
	//$ls_numrecdoc=$io_fun_sfa->uf_obtenervalor_get("numrecdoc","");
...
<input name="totrow" type="hidden" id="totrow">
  <table width="580" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td height="20" colspan="2" class="titulo-ventana">Retenciones</td>
    </tr>
  </table>
	<p>
...
function ue_search()
{
	...
	ajax.send("catalogo=RETENCIONES&tipo="+tipo+"&orden="+orden+"&campoorden="+campoorden+"&numrecdoc="+numrecdoc+
