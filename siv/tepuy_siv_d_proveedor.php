...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Ordenes de Compras-->Registro de Proveedores</td>
...
<?php
require_once("class_folder/tepuy_siv_c_proveedor.php");
...
$io_proveedor = new tepuy_siv_c_proveedor();
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SIV";
	$ls_ventanas = "tepuy_siv_d_proveedor.php";
...
function uf_load_tipo($as_codemp)
{
  global $io_sql;
  $ls_tipo = "";
  $ls_sql  = "SELECT value FROM tepuy_config WHERE codemp='".$as_codemp."' AND codsis='RPC' AND seccion='RPC'";
...
global $ls_contable;
global $ls_contablecomp;
global $ls_dencontablecomp;
 ...
 <p>&nbsp;  </p>
   ...
   <table width="770"  border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
    ...
    <tr>
      ...
      <td height="22" colspan="4"><input name="txtcodigo" type="text" id="txtcodigo" onKeyPress="return keyRestrict(event,<?php print $ls_string; ?>); " value="<?php print $ls_codigo; ?>" size="15" maxlength="10"  style="text-align:center" <?php print $ls_readonly ?> onBlur="javascript:rellenar_cadena(this.value,10,this.name);">
    ...
    <tr>
      ...
      <td height="22" colspan="4"><input name="txtnombre" type="text" id="txtnombre" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+',-.;*&?¿!¡+()[]{}%@/'+'´áéíóú');" value="<?php print $ls_nombre ?>" size="100" maxlength="100"></td>
    </tr>
    <tr>
      <td height="22" align="right"><span class="sin-borde" body="bold"><strong>(*)</strong></span> Direcci&oacute;n&nbsp;</td>
      <td height="22" colspan="4"><input name="txtdireccion" type="text" id="txtdireccion" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+',-.;*&?¿!¡+()[]{}%@#/'+'´áéíóú');" value="<?php print $ls_direccion ?>" size="100" maxlength="254"></td>
    </tr>
    <tr>
	  ...
	  ?>
          <select name="cmbtiporg" id="cmbtiporg"  style="width:167px ">
	  <?php
    ...
    <tr>
      ...
      <td height="22" colspan="4"><input name="txttelefono" type="text" id="txttelefono" onKeyPress="return keyRestrict(event,'1234567890'+'()- /');" value="<?php print $ls_telefono ?>" size="60" maxlength="50"></td>
    </tr>
    <tr>
      <td height="22" align="right"><span class="sin-borde"></span>&nbsp;Fax&nbsp;</td>
      <td height="22" colspan="4"><input name="txtfax" type="text" id="txtfax" onKeyPress="return keyRestrict(event,'1234567890'+'()- /');" value="<?php print $ls_fax ?>" size="30" maxlength="30"></td>
    </tr>
    <tr>
      <td height="22" align="right">Nacionalidad&nbsp;</td>
      <td height="22" colspan="4"><select name="cmbnacionalidad" id="cmbnacionalidad">
        <?php 
    ...
    <tr>
      <td height="22" align="right"><span class="sin-borde"><strong>(*)</strong></span> R.I.F&nbsp;</td>
      <td height="22" colspan="4"><input name="txtrif" type="text" id="txtrif" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+'.-'); " value="<?php print $ls_rif ?>" size="15" maxlength="15" style="text-align:right"></td>
    </tr>
    <tr>
      <td height="22" align="right">&nbsp;N.I.T&nbsp;</td>
      <td height="22" colspan="4"><input name="txtnit" type="text" id="txtnit" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+'.-');" value="<?php print $ls_nit ?>" size="15" maxlength="15" style="text-align:right"></td>
    </tr>
    <tr>
      <td height="22" align="right"><span class="sin-borde"><strong>(*)</strong></span>&nbsp;Capital Social&nbsp;</td>
      <td height="22" colspan="4"><input name="txtcapital" type="text" id="txtcapital" onKeyPress="return(ue_formatonumero(this,'.',',',event))" value="<?php print $ld_capital ?>"  style="text-align:right"></td>
    </tr>
    <tr>
      <td height="22" align="right"><span class="sin-borde"><strong>(*)</strong></span>&nbsp;Monto M&aacute;ximo&nbsp;</td>
      <td height="22" colspan="4"><input name="txtmonmax" type="text" id="txtmonmax" onKeyPress="return(ue_formatonumero(this,'.',',',event))" value="<?php print $ld_monmax ?>"  style="text-align:right"></td>
    </tr>
    <tr>
      ...
      <td height="22" colspan="4"><p>
		 ...
		 ?>
         <select name="cmbbanco" id="cmbbanco"  style="width:167px ">
    ...
    <tr>
      ...
      <td height="22" colspan="4"><input name="txtcuenta" type="text" id="txtcuenta" onKeyPress="return keyRestrict(event,'1234567890');" value="<?php print $ls_cuenta ?>" size="29" maxlength="25"  style="text-align:right"></td>
    </tr>
    <tr>
	  ...
	  ?>
        <select name="cmbmoneda" id="cmbmoneda" style="width:120px">
          <?php
		 while($row=$io_sql->fetch_row($rs_pro))
		 {
    ...
    <!--  <td height="22" align="right">&nbsp;
      Banco SIGECOF&nbsp;</td> -->
      <td height="22" colspan="4"><input name="txtcodbancof" type="hidden" id="txtcodbancof" value="<?php print $ls_codbancof ?>" maxlength="3" style="text-align:center" onBlur="javascript:rellenar_cadena(this.value,3,this.name)"  onKeyPress="return keyRestrict(event,'1234567890'); ">
   <!--   <a href="javascript:catalogo_BCOSIGECOF();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0"></a> -->
      <label>
      <input name="txtnombancof" type="hidden" class="sin-borde" id="txtnombancof" value="<?php print $ls_nombancof ?>" size="65" readonly>
      </label>
      <div align="left"></div></td>
    </tr>
    <tr>
      <td height="22" align="right">Grado de la Empresa</td>
      <td height="22" colspan="4"><select name="cmbgraemp" id="cmbgraemp" style="width:120px">
        <?php 
         if ($ls_graemp=="0000")    
            {
              $ls_select="selected";
    ...
    <tr>
	  ...
	  ?>
	  <td height="22" colspan="4"><select name="cmbcontribuyente" class="contorno" id="cmbcontribuyente" style="width:120px">
        <option value="-">---seleccione---</option>
    ...
    <tr>
      <td height="48" colspan="5"><div align="center">
        <table width="691" border="0" class="formato-blanco">
          <tr class="contorno">
            <td colspan="2" align="left" class="titulo-celdanew">Ubicaci&oacute;n Geogr&aacute;fica</td>
          </tr>
          <tr>
            <td width="123" height="22" style="text-align:right"><p align="right">Pa&iacute;s </p>
              </td>
    ...
    <tr>
      <td height="22" align="right">Tipo de Proveedor&nbsp;</td>
      <td colspan="2">
    ...
    <tr>
      <td height="22" align="right"> <span class="sin-borde"><strong>(*)</strong></span> Cuenta Contable (Compromiso)&nbsp;</td>
      <td colspan="4"><input name="txtcontablecomp" type="text" id="txtcontablecomp" onKeyPress="return keyRestrict(event,'1234567890');" value="<?php print $ls_contablecomp ?>"  style="text-align:center" readonly> <a href="javascript:catalogo_cuentas(1);"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a> <input name="txtdencontablecomp" type="text" class="sin-borde" id="txtdencontablecomp" value="<?php print $ls_dencontablecomp ?>" size="80" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn&ntilde;opqrstuvwxyz '+'.,-');"></td>
    </tr>
    <tr>
      <td height="22" align="right"> <span class="sin-borde"><strong>(*)</strong></span> Cuenta Contable (Causado)&nbsp;</td>
      <td colspan="4"><input name="txtcontable" type="text" id="txtcontable" onKeyPress="return keyRestrict(event,'1234567890');" value="<?php print $ls_contable ?>"  style="text-align:center" readonly> <a href="javascript:catalogo_cuentas(2);"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a> <input name="txtdencuenta" type="text" class="sin-borde" id="txtdencuenta" value="<?php print $ls_denocuenta ?>" size="80" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmn&ntilde;opqrstuvwxyz '+'.,-');"></td>
    </tr>
    <tr>
...
<br>
  <table width="770" border="0" cellpadding="0" cellspacing="0" align="center" class="contorno">
    ...
    <tr>
      <td height="22">&nbsp;</td>
      <td height="22"><input name="botsocios" type="hidden" class="boton" id="botsocios" onClick="javascript: uf_socio(document.form1.txtcodigo.value)" value="Socios" <?php print $ls_disabled ?>> 
      <input name="botdocumentos" type="hidden" class="boton" id="botdocumentos" onClick="javascript: uf_documento(document.form1.txtcodigo.value)" value="Documentos"  <?php print $ls_disabled ?>> 
      <input name="botclasificacion" type="hidden" class="boton" id="botclasificacion" onClick="javascript: uf_clasificacion(document.form1.txtcodigo.value)" value="Calificaci&oacute;n" <?php print $ls_disabled ?>>
      <input name="btnespecialidad" type="hidden" class="boton" id="btnespecialidad" onClick="javascript: uf_especialidad(document.form1.txtcodigo.value)" value="Especialidad" <?php print $ls_disabled ?>>
...
function uf_socio(prov)
{
  ...
  if (prov=="")
   ...
   else
      {
		...
		pagina="tepuy_siv_d_socio.php?txtprov="+prov +"&txtnombre="+ls_nomprov;
...
function uf_documento(prov)
{
   ...
   if (prov=="")
      ...
      {
        ls_nomprov=f.txtnombre.value;
		pagina="tepuy_siv_w_proxdoc.php?txtprov="+prov +"&txtnombre="+ls_nomprov;
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=500,resizable=yes,location=no");
	  }	
}
...
function uf_clasificacion(prov)
{
 ...
 if (prov=="")
    ...
    {
      ls_nomprov=f.txtnombre.value;
	  pagina="tepuy_siv_w_proxcla.php?txtprov="+prov +"&txtnombre="+ls_nomprov;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no,dependent=yes");
 	}
}
...
function uf_especialidad(prov)
{
 ...
 if (prov=="")
      ...
      {
 	    ls_nomprov=f.txtnombre.value;
		pagina="tepuy_siv_w_proxesp.php?codprov="+prov +"&nomprov="+ls_nomprov;
			            ...
			            if (valida_null(txtdireccion,"La Dirección del Proveedor esta vacia!!")==false)
			               ...
			               {//9
			                 if (valida_null(txttelefono,"El Telefono del Proveedor esta vacio!!")==false)
			                    ...
			                    {//11		 	
				                  if (valida_null(txtrif,"El RIF del Proveedor esta vacio!!")==false) 
				                     {//12
				                       txtrif.focus();
				                     }//12
				                  else
				                     {//13
				                       //if (valida_null(txtnit,"El NIT del Proveedor esta vacio!!")==false) 
				                       //  {//14
				                       //    txtnit.focus();
				                       //  }//14
				                       //else
				                       //  {//15
				                            if (valida_null(txtcapital,"El Capital esta vacio!!")==false) 
				                               {//16
					                             txtcapital.focus();
				                               }//16
				                            else
				                               {//17
					                             if (valida_null(txtmonmax,"El monto esta vacio!")==false) 
					                                {//18
					                                  txtcapital.focus();
					                                }//18
					                             else
					                                {//19
									if (valida_null(txtcontable,"El Código Contable (Causado) Asociado al Proveedor esta vacio!")==false) 
					                                          {//22
						                                        txtcontable.focus();
					                                          }//22
										  else
											{
											if (valida_null(txtcontablecomp,"El Código Contable (Compromiso) Asociado al Proveedor esta vacio!")==false) 
					                                          {//22
									                                         ...
									                                         {//29
																				if((f.chkestpro.checked==false)&&(f.chkestcon.checked==false))
																				{
																				 ...
																				 {//29
																				   ...
																				   f.action="tepuy_siv_d_proveedor.php";
																				   f.submit();
																				  }		  
										                                     }//29
									                                    }//27
...
/*Function:  ue_buscar()
    ...
    function ue_buscar()
    {
		...
		{
			f.operacion.value="";			
			pagina="tepuy_siv_cat_proveedores.php";
...
function ue_nuevo()
		{
	      ...
	      {			 
				  ...
				  f.txtcuenta.value="";
				  f.txtcontable.value="";
				  f.txtcontablecomp.value="";
				  f.txtdencuenta.value="";
				  f.txtdencontablecomp.value="";
				  f.txtcedula.value="";
				  f.txtnomrep.value="";
				  f.txtcargo.value="";
...
function catalogo_BCOSIGECOF()
{
	f=document.form1;
	f.operacion.value="";			
	pagina="tepuy_siv_cat_bancos_sigecof.php";
