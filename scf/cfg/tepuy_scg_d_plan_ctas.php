...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Contabilidad Fiscal</td>
...
//////////////////////////////////////////////  SEGURIDAD   /////////////////////////////////////////////
	...
	$ls_sistema     = "SCF";
	$ls_ventanas    = "tepuy_scg_d_plan_ctas.php";
					...
					else
					{
						...
						do 
						{
						  ...
						  if(!$int_scg->uf_scg_select_cuenta($is_codemp,$ls_NextCuenta,&$as_status,&$as_denominacion))
						  {
							  ...
							  $ls_PadNextCuenta =$int_scg->uf_pad_cuenta_plan($arre["formcont"] , $ls_NextCuenta)	;				
      ...
      <tr>
        <td height="182">
          ...
          <table width="614" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              ...
              <tr class="formato-blanco">
                <td width="99" height="22"><div align="right" >
                    <p>Codigo Contable</p>
                </div></td>
                <td width="513" height="22"><div align="left" >
                    <input name="txtcuenta" <?php print $disabled ?> type="text" id="txtcuenta" value="<?php print $ls_cuenta ?>" maxlength="<?php print $li_size_form;?>" onKeyPress="return keyRestrict(event,'1234567890');"  onBlur="rellenar_cad(this.value,<?php print $li_size_form;?>)" style="text-align:center ">
                    <a href="javascript: cat();"><img src="../../shared/imagebank/tools15/buscar.png" alt="Catalogo de Cuentas del Plan Unico" width="15" height="15" border="0"></a>
              ...
              <tr class="formato-blanco">
                ...
                <td height="22"><div align="left">
                  <input name="txtdenominacion" type="text" id="txtdenominacion" value="<?php print $ls_denominacion?>" size="95" maxlength="254" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyzñ '+'.,-()*/%$!');">
...
function cat()
{
	...
	window.open("tepuy_cat_ctaspu.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}
...
function ue_nuevo()
{
  ...
  if (li_incluir==1)
	 {	
       ...
       f.action="tepuy_scg_d_plan_ctas.php";
	   f.submit();
	 }
   else
     {
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
	     window.open("tepuy_scg_cat_ctas.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	   }
	else
 	   {
	     alert("No tiene permiso para realizar esta operación");
