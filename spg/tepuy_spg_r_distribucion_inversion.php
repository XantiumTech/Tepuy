...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_distribucion_inversion.php";
      ...
      <td height="40" colspan="3" align="center">      <div align="left">
        <table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="4"><strong class="titulo-celdanew">Tipo de Presupuesto </strong></td>
            </tr>
          <tr>
            ...
            <td width="223" height="23"><select name="cmbnivel" id="cmbnivel">
              ...
              <option value="1">Inversión Presupuesto Ordinario</option>
              <option value="2">Inversión CFG</option>
        <!--      <option value="3">Inversión LAEE</option> -->
              </select></td>
            <td width="223">&nbsp;</td>
            <td width="446">&nbsp;</td>
          </tr>
...
function ue_showouput()
{
	...
	pagina="reportes/tepuy_spg_rpp_distribucion_inversion.php?combo="+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato;
