<?php
	...
	$io_fun_scf->uf_load_seguridad("SCF","tepuy_scf_r_listadocuentas.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
function ue_search()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/tepuy_scf_rpp_listadocuentas.php?cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;
...
function ue_openexcel()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/tepuy_scf_rpp_listadocuentas_excel.php?cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta;
			window.open(pagina,"Reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
   	}
	else
