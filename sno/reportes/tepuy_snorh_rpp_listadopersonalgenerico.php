<?PHP
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte("SNR","tepuy_snorh_r_listadopersonalgenerico.php",$ls_descripcion);
		return $lb_valido;
	}
	//--------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		switch($_SESSION["ls_tiporeporte"])
		{
			...
			case "3":
				...
				$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],60,560,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
				$li_tm=$io_pdf->getTextWidth(11,$as_titulo);
				$tm=504-($li_tm/2);
