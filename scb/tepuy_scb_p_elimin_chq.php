...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_p_elimin_chq.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<!--  <tr>
  ...
  <tr>
    ...
    <td class="toolbar" width="23"><div align="center"><a href="javascript: ue_procesar();"><img src="../shared/imagebank/tools20/ejecutar.png" alt="Procesar" title="Procesar" width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="27"><div align="center"><a href="javascript: ue_cerrar();"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" title="Salir" width="20" height="20" border="0"></a></div></td>
...
<?php
	...
	require_once("tepuy_scb_c_elimin_chq.php");
	$io_cheques=new tepuy_scb_c_elimin_chq($la_seguridad);
	...
	$titleProg[1]="";   $titleProg[2]="Documento";     $titleProg[3]="Concepto";     $titleProg[4]="Monto";   	$titleProg[5]="Fecha";   $titleProg[6]="Proveedor";   $titleProg[7]="Beneficiario"; $titleProg[8]="Nombre Prov./Bene.";
    $gridProg="grid_prog";
				  ...
				  while($row=$io_sql->fetch_row($rs_data))
			           {
						 ...
						 $ld_monmov    = $row["monto"];
				         $ld_fecmov    = $fun->uf_convertirfecmostrar($row["fecmov"]);
...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco" id="tabla">
    ...
    <tr>
      ...
      <td colspan="3"><label>
      <input name="txtdocumento" type="text" id="txtdocumento" value="<?php print $ls_documento;?>" size="24" maxlength="15"  style="text-align:center"> 
...
Beneficiario</label></td>
    ...
    <tr>
      <td height="13">&nbsp;</td>
      <td height="13">&nbsp;</td>
      <td height="13"><a href="javascript:uf_cambiar();" >Cargar Cheques o Pago x Transferencia</a></td>
      <td height="13">&nbsp;</td>
      <td height="13">&nbsp;</td>
      <td height="13">&nbsp;</td>
    </tr>
...
function ue_nuevo()
{
	...
	f.action="tepuy_scb_p_elimin_chq.php";
	f.submit();
}
