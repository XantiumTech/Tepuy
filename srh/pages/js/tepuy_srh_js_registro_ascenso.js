...
var url= "../../php/tepuy_srh_a_registro_ascenso.php";
var metodo='get';
...
function catalogo_personal()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_personal.php?valor_cat=0"+"&tipo=4";
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_registro_ascenso.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=540,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
