...
<title>EJECUCION FINANCIERA ACUMULADO POR CUENTAS</title>
...
<form name="form1" method="post" action="">
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">EJECUCION FINANCIERA ACUMULADO POR CUENTAS </td>
    </tr>
  </table>
...
function ue_showouput()
{
	...
	if(estmodest==1)
	{
		...
		{
		   pagina="reportes/tepuy_spg_rpp_comp_ejec_finan_acum_cuenta.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
		           +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h
		           +"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato+"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas;
	...
	{   codestpro4  = f.codestpro4.value;
		...
		else
		{
		   pagina="reportes/tepuy_spg_rpp_comp_ejec_finan_acum_cuenta.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
		           ...
		           +"&codestpro5h="+codestpro5h+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato+"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas;
		   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}	
}
