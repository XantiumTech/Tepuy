...
$io_fun_viaticos->uf_load_seguridad("SCV","tepuy_scv_d_categorias.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
require_once("class_folder/tepuy_scv_c_categorias.php");
$io_scv= new tepuy_scv_c_categorias($conn);
...
function ue_nuevo()
{
   ...
   {			 
	  ...
	  f.action="tepuy_scv_d_categorias.php";
	  f.submit();
   }
   else
   {
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
		 f.operacion.value="";			
		 pagina="tepuy_scv_cat_categorias.php";
