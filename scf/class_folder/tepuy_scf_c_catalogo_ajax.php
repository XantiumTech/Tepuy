	...
	function uf_print_comprobante()
   	{
		...
		$ls_campoorden=$_POST['campoorden'];
		$ls_tipo=$_POST['tipo'];
		$ls_sql="SELECT tepuy_cmp.procede, tepuy_cmp.comprobante, tepuy_cmp.fecha, tepuy_cmp.descripcion, tepuy_cmp.tipo_destino, ".
				"		tepuy_cmp.cod_pro, tepuy_cmp.ced_bene, tepuy_cmp.codban, tepuy_cmp.ctaban, rpc_beneficiario.nombene, ".
				"		rpc_beneficiario.apebene, rpc_proveedor.nompro ".
				"  FROM tepuy_cmp, rpc_beneficiario, rpc_proveedor ".
				" WHERE tepuy_cmp.codemp='".$ls_codemp."' ".
				"   AND tepuy_cmp.tipo_comp=1 ".
				"   AND tepuy_cmp.comprobante like '".$ls_comprobante."' ".
				"   AND tepuy_cmp.procede like '".$ls_procede."' ".
				"   AND tepuy_cmp.tipo_destino like '".$ls_tipdes."' ".
				"   AND tepuy_cmp.cod_pro like '%".$ls_codpro."%' ".
				"   AND tepuy_cmp.ced_bene like '%".$ls_cedbene."%' ".
				"   AND tepuy_cmp.fecha>='".$ls_fecdes."' ".
				"   AND tepuy_cmp.fecha<='".$ls_fechas."' ".
				...
				"	AND tepuy_cmp.codemp = rpc_proveedor.codemp ".
		...
		else
		{
			...
			print "<tr class=titulo-celda>";
			print "<td width=60 style='cursor:pointer' title='Ordenar por Comprobante'  align='center' onClick=ue_orden('tepuy_cmp.comprobante')>Comprobante</td>";
			print "<td width=60 style='cursor:pointer' title='Ordenar por Procede'      align='center' onClick=ue_orden('tepuy_cmp.procede')>Procede</td>";
			print "<td width=60 style='cursor:pointer' title='Ordenar por Fecha'        align='center' onClick=ue_orden('tepuy_cmp.fecha')>Fecha</td>";
			print "<td width=60 style='cursor:pointer' title='Ordenar por Proveedor'    align='center' onClick=ue_orden('tepuy_cmp.cod_pro')>Proveedor</td>";
			print "<td width=60 style='cursor:pointer' title='Ordenar por Beneficiario' align='center' onClick=ue_orden('tepuy_cmp.ced_bene')>Beneficiario</td>";
