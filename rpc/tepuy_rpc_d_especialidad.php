...
require_once("class_folder/tepuy_rpc_c_especialidad.php");
...
$io_especialidad = new tepuy_rpc_c_especialidad($ls_conect);
$lb_existe       = "";
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="RPC";
	$ls_ventanas="tepuy_rpc_d_especialidad.php";
...
function ue_nuevo()
{
   ...
   if(li_incluir==1)
   {
	  ...
	  f.action="tepuy_rpc_d_especialidad.php";
	  f.submit();
   }
   else
   {
...
function ue_buscar()
{
	...
	{
		f.operacion.value="";			
		pagina="tepuy_rpc_cat_especialidad.php";
