<?php
	...
	require_once("tepuy_scf_c_comprobante.php");
	$io_comprobante=new tepuy_scf_c_comprobante("../../");
	...
	{	
		...
		for($li_fila=1;$li_fila<=$li_totrow;$li_fila++)
		{
			...
			$lo_object[$li_fila][7]="<a href=javascript:ue_delete_scg_cuenta('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>".
