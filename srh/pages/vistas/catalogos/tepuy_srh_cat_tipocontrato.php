...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_tipocontrato.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_tipocontrato.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_tipocontrato.php?valor=buscar"+"&txtcodtipcon="+codtipcon+"&txtdentipcon="+dentipcon);
		   setTimeout (terminar_buscar,500);
