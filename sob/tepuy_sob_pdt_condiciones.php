...
&nbsp;&nbsp;%</td>
    ...
    <tr>
      ...
      <td><a href="javascript:uf_aceptar();"><img src="../shared/imagebank/aprobado.png" alt="Aceptar" width="15" height="15" border="0" onClick="javascript:ue_comparar_intervalo('hidfecha','txtfecha','La fecha de la condicion debe ser mayor o igual a la fecha de inicio del Contrato!!!')"></a><a href="javascript:uf_cancelar();"><img src="../shared/imagebank/eliminar.png" border="0" alt="Cancelar" width="15" height="15" ></a></td>
    </tr>
  </table>
