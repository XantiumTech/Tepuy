<?php
	...
	$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_d_grupo.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<table width="566" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              ...
              <tr class="formato-blanco">
                <td height="20">&nbsp;</td>
                <td height="20" colspan="2" align="left"><input name="botestpro2" type="button" class="boton" id="botestpro2" onClick="javascript: uf_volver();" value="Volver a Seccion" ></td>
              </tr>
              <tr class="formato-blanco">
                <td height="20">&nbsp;</td>
	...
	if (li_leer==1)
   	{
		...
		window.open("tepuy_saf_cat_item.php?txtcodgru="+codgru+"&txtdengru="+dengru+"&txtcodsubgru="+codsubgru+"&txtdensubgru="+densubgru+"&txtcodsec="+codsec+"&txtdensec="+densec+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
   	}
	else
   	{
 		alert("No tiene permiso para realizar esta operacion");
