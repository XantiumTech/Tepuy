<?php
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_srh->uf_load_seguridad_reporte("SRH","tepuy_srh_r_lote_revision.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
   ...
   function uf_print_firmas(&$io_pdf)
	...
	//----------------------------------------------------  Par�metros del encabezado  -----------------------------------------------
	 ...
	 //--------------variable que se toman de tepuy_srh_r_listado_evaluacioneficiencia.php------------------------------------------
	...
	if($lb_valido==false) // Existe alg�n error � no hay registros
	 ...
	 else
	 {
		   ...
		   $lb_valido=$io_report->uf_select_dt_evaluacion_odi($ls_nroeval);
