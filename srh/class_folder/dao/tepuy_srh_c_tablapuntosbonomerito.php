...
class tepuy_srh_c_tablapuntosbonomerito
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_srh_c_tablapuntosbonomerito($path)
...
function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_d_tablapuntosbonomerito)
		//      Argumento: 
...
function uf_srh_guardar_tablapuntosbonomerito ($ao_puntos,$as_operacion="insertar", $aa_seguridad)
  { 
		...
		//         access: public (tepuy_srh_puntosunitri )
...
function uf_srh_guardar_dt_tablapuntosbonomerito($ao_puntos, $aa_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_puntosunitri )														
...
function uf_srh_eliminar_dt_tablapuntosbonomerito($as_codpun, $aa_seguridad)
  {
		...
		//        access:  public (tepuy_srh_dt_tablapuntosbonomerito)														
