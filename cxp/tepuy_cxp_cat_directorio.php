   ...
   function uf_print($as_ruta)
   {
		...
		while ($file = readdir($handle))
		{
			 if(($file != '.') && ($file != '..'))
			 {
				...
				print "<td width='70' height='22'><div align='center'><a href='tepuy_cxp_cat_descarga.php?enlace=".$as_ruta."&file=".$file."'><img src='../shared/imagebank/tools20/download.png' width='20' height='20' border='0'></a></div></td>";
...
function ue_delete(ruta,file)
{
	...
	{
		f=document.form1;
		f.action="tepuy_cxp_cat_directorio.php?ruta="+ruta+"&file="+file+"";
		f.submit();
	}
}
</script>
