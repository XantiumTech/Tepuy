<?php
	...
	$io_fun_nomina->uf_load_seguridad("SNO","tepuy_sno_p_hunidadadmin.php",$ls_permisos,$la_seguridad,$la_permisos);
   ...
   function uf_limpiarvariables()
   {
		...
		global $ls_desnom,$ls_desper,$li_contabilizado;
		...
		require_once("tepuy_sno_c_ajustarcontabilizacion.php");
		$io_ajustar=new tepuy_sno_c_ajustarcontabilizacion();
   ...
   function uf_load_variables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		global $ls_codigo,$ls_denominacion,$ls_codestpro1,$ls_denestpro1,$ls_codestpro2,$ls_denestpro2,$ls_codestpro3;
...
<body>
<?php 
	require_once("tepuy_snorh_c_uni_ad.php");
	$io_unidadadm = new tepuy_snorh_c_uni_ad();
	uf_limpiarvariables();
	...
	if($ld_fechasnom!=$ld_ano)
	{
		...
		print(" location.href='tepuywindow_blank_hnomina.php'");
		print("</script>");
	}	
	switch ($ls_operacion) 
	{
		case "GUARDAR":
			uf_load_variables();
			$lb_valido=$io_unidadadm->uf_update_unidadadministrativa_historico($ls_codigo,$ls_denominacion,$ls_codpro,$la_seguridad);
			if($lb_valido)
			{
				uf_limpiarvariables();
				$ls_existe="FALSE";
		  ...
		  <table width="650" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
              ...
              <tr>
                ...
                <td ><div align="left" >
                  ...
                  <a href="javascript: ue_buscarunidad();"><img id="concepto" src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Concepto"></a></div></td>
              </tr>
              <tr >
	...
	{	
		if(((lb_existe=="TRUE")&&(li_cambiar==1))||(lb_existe=="FALSE")&&(li_incluir==1))
		{
			...
			if ((codigo!="")&&(denominacion!="")&&(codestpro1!="")&&(codestpro2!="")&&(codestpro3!="")&&(codestpro4!="")&&(codestpro5!=""))
			{
				...
				f.action="tepuy_sno_p_hunidadadmin.php";
				f.submit();
			}
			else
			{
...
{
	window.open("tepuy_sno_cat_huni_ad.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=yes");
}
...
function ue_ayuda()
{
	...
	//window.open("../hlp/index.php?sistema=SNO&subsistema=SNR&nomfis=sno/tepuy_hlp_snr_unidadadministrativa.php","Ayuda","menubar=no,toolbar=no,scrollbars=yes,width="+width+",height="+height+",resizable=yes,location=no");
}

function ue_estructura1()
{
	   window.open("tepuy_snorh_cat_estpre1.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,resizable=yes,location=no");
}
...
function ue_estructura2()
{
	...
	{
		pagina="tepuy_snorh_cat_estpre2.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1;
...
function ue_estructura3()
{
	...
	{
    	pagina="tepuy_snorh_cat_estpre3.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2;
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,resizable=yes,location=no");
	}
	else
	{
...
function ue_estructura4()
{
	...
	{
    	pagina="tepuy_snorh_cat_estpre4.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&codestpro3="+codestpro3+"&denestpro3="+denestpro3;
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,resizable=yes,location=no");
	}
	else
	{
...
function ue_estructura5()
{
	...
	{
    	pagina="tepuy_snorh_cat_estpre5.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&codestpro3="+codestpro3+"&denestpro3="+denestpro3+"&codestpro4="+codestpro4+"&denestpro4="+denestpro4;
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,resizable=yes,location=no");
	}
	else
	{
