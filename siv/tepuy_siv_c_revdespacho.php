...
class tepuy_siv_c_revdespacho
{
	...
	function tepuy_siv_c_revdespacho()
	{
		...
		$this->io_art=    new tepuy_siv_c_articuloxalmacen();
	...
	function uf_siv_select_despacho($as_codemp,$as_numorddes)
	{
		...
		//         Access: public (tepuy_siv_p_revdespacho)
	...
	function uf_siv_crear_movimientos($as_codemp,$ad_fecrev,$as_opeinv,$as_codprodoc,$as_numorddes,$as_promov,$as_numoridoc,$ai_candesart,$as_codusu,$aa_seguridad)
	{
		...
		//				   hace el llamado a la funcion de la clase tepuy_siv_c_movimientoinventario que lo inserta.
		//	   Creado Por: Ing. Luis Anibal Lang
		...
		if ($lb_valido)
		{
			$lb_valido=$this->uf_siv_select_dt_despacho($as_codemp,$as_numorddes,$rs_revdes);
			if($lb_valido)
			{
...
}//end  class tepuy_siv_c_revrecepcion
?>
