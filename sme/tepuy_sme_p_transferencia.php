...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Control de Servicios M&eacute;dicos-> Transfrencia de Personal</td>
...
<?php
require_once("class_folder/tepuy_sme_c_beneficiario.php");
...
$io_beneficiario = new tepuy_sme_c_beneficiario();
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SME";
	$ls_ventanas = "tepuy_sme_p_transferencia.php";
	    ...
	    if (lb_marcadas)
		   {
			 ...
			 if (ls_cuenta=="")
				...
				if (ls_cuentacomp=="")
				  ...
				  f.action          = "tepuy_sme_p_transferencia.php";
				  f.submit();
				}
			}
		   }
...
function uf_catalogo_personal()
{
  ...
  if (li_leer==1)
	 {
       pagina="tepuy_sme_cat_personal.php";
