<?php
class tepuy_spg_class_reportes_instructivo_06
{
	var $io_mensajes;
	var $io_fecha;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function  tepuy_spg_class_reportes_instructivo_06()
    {
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
			$this->io_mensajes->message("CLASE->tepuy_spg_class_reportes_instructivo_06 ". 
	 ...
	 {		
		...
		if($li_numrows>=0)
		{
		     while($row=$this->io_sql->fetch_row($rs_data))
			 {
			   ...
			   $ls_codigo=substr($ls_codestpro1,10,10);
