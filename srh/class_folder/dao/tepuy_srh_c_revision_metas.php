...
class tepuy_srh_c_revision_metas
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_revision_metas($path)
	{   
...
function uf_srh_guardarrevision_metas ($ao_revision,$as_operacion="insertar", $ao_seguridad)
  { 
		...
		//         access: public (tepuy_srh_revision_metas)
...
function uf_srh_guardar_dt_revision_metas($ao_revision, $ao_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_revision_metas)														
...
function uf_srh_eliminar_dt_revision_metas($as_nroreg, $as_fecha, $ao_seguridad)
  {
		...
		//        access:  public (tepuy_srh_dt_revision_metas)														
...
function uf_srh_guardar_trabajador ($ao_revision, $ao_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_revisionnestacion)															
...
}// end   class tepuy_srh_c_revision_metas
?>