...
?>
    <table width="800" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="13" colspan="3"><label>
          <textarea name="txtconsolcot" cols="122" id="txtconsolcot" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyzáéíóú '+'¡!:;_°#@/?¿%&$*-,.+(){}[]='); "><?php print $ls_consolcot ?></textarea>
        </label></td>
      </tr>
      <tr>
        <td height="13" style="text-align:right">Unidades Asociadas </td>
        <td height="13" colspan="3"><textarea read name="txtuniejeaso" cols="122" id="txtuniejeaso" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyzáéíóú '+'¡!:;_°#@/?¿%&$*-,.+(){}[]='); "><?php print $ls_uniejeaso ?></textarea>
        </td>
      </tr>
      <tr>
        <td height="22" style="text-align:right">Observaci&oacute;n</td>
        <td height="22" colspan="3"><label>
          <input name="txtobssolcot" type="text" id="txtobssolcot" style="text-align:left" tabindex="2" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyzáéíóú '+'¡!:;_°#@/?¿%&$*-,.+(){}[]='); " value="<?php print $ls_obssolcot ?>" size="125"/>
        </label></td>
      </tr>
      <tr>
        <td height="13">&nbsp;</td>
 	     ...
 	     if (ls_tipsolcot!='-')
	        {
	          if (ls_codunieje=="")
	          ...
	          else
			     {
				   if (li_totrowsep==0)
				      {
				        alert("Si desea procesar Solicitudes de Ejecución Presupuestaria, No indique Unidad Ejecutora ya que estas vienen definidas desde las Solicitudes de Ejecución Presupuestaria !!!");					  
					  }
                   else
				      {
			            pagina="tepuy_soc_cat_sep.php?hidtipsolcot="+ls_tipsolcot+"&tipo=SC";
			  ...
			  if (ls_tipsolcot!='-')
			     {
				   ...
				   if (lb_valido)
					  {
						lb_valido = ue_validarcampo(ls_numsolcot,"El Número de Solicitud no puede estar vacio.",f.txtnumsolcot);
					  }
				   if (lb_valido)
					  {
				   ...
				   if (lb_valido)
					  {
						lb_valido = ue_validarcampo(ls_cedpersol,"La Cédula del Personal solicitante no puede estar vacia.",f.txtcedper);
					  }
				   if (lb_valido)
					  {
						...
						if (ls_tipsolcot=='B' && lb_valido)//Solicitud de Cotización de Tipo Bienes.
						   {
							 if (li_rowbienes>1)
							    ...
							    {
								  alert("La Solicitud de Cotización debe tener al menos un Bien/Material incorporado !!!");
								  lb_valido = false;
							    }
						   }
					     else
...
function ue_reload()
{
	...
	ls_tipsolcot = f.cmbtipsolcot.value;// Para saber si es de bienes, servicios ó conceptos
	if(ls_tipsolcot=="B")
	{
