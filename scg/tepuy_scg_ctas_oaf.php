...
<?php
	...
	require_once("tepuy_scg_c_ctas_oaf.php");
	$io_cta=new tepuy_scg_c_ctas_oaf();
	...
	$ls_sistema="SCG";
	$ls_ventanas="tepuy_scg_ctas_oaf.php";
...
if  (array_key_exists("status",$_POST))
	...
	else
	{
		...
		$title[1]="Cuenta";   $title[2]="Denominación";     $title[3]="Cuenta Res.";		$title[4]="Incremento/Disminucion"; $title[5]='Debe/Haber';
		//$anchos[1]=60.5;   $anchos[2]=152;     $anchos[3]=70;		//$title[4]="Edición";
...
if ((li_cambiar==1)||(li_incluir==1))
   {
	  ...
	  f.action="tepuy_scg_ctas_oaf.php";
	  f.submit();
    }
 else
    {
