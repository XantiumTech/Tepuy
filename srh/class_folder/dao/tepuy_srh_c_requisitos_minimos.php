...
class tepuy_srh_c_requisitos_minimos
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_requisitos_minimos($path)
	{   
...
function getCodPersonal($as_codper, $as_codcon,&$ao_datos="")       
{
  ...
  {  
		...
		//         access: public (tepuy_srh_requisitos_minimos)														         
...
function uf_srh_guardar_dt_requisitos_minimos($ao_requisitos, $aa_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_requisitos_minimos)														
...
function uf_srh_eliminar_dt_requisitos_minimos($as_codper,$as_fecha, $aa_seguridad)
  {
		...
		//        access:  public (tepuy_srh_dt_requisitos_minimos)														
		//      Argumento: $as_codper        // numero de la evaluación de requisitos mínimos
		//                 $aa_seguridad    //  arreglo de registro de seguridad                                                
		//	      Returns: Retorna un Booleano																				    
...
}// end   class tepuy_srh_c_requisitos_minimos
?>