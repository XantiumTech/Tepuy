...
/********************************************************************************************************************************/	
class tepuy_spg_reportes_class_bsf
{
    //conexion	
	var $sqlca;   
	...
	var $io_fecha;
	var $tepuy_int_spg;
	var $tepuy_report_funciones;
	var $li_estmodest;
/********************************************************************************************************************************/	
    function  tepuy_spg_reportes_class_bsf()
    {
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $ls_sql=" SELECT CT.codestpro1 AS codestpro1, CT.codestpro2 AS codestpro2, CT.codestpro3 AS codestpro3, ".
			 ...
			 "        diciembreaux AS diciembre, E.denestpro5 ".
			 ...
			 "        CT.status='C' ".
             " ORDER BY CT.codestpro1,CT.codestpro2,CT.codestpro3,CT.codestpro4,CT.codestpro5,CT.spg_cuenta ";	
...
/********************************************************************************************************************************/	
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    25/09/2006          Fecha última Modificacion :      Hora :
	  ...
	  $adt_fecdes=$this->io_function->uf_convertirdatetobd($adt_fecdes);
	  $adt_fechas=$this->io_function->uf_convertirdatetobd($adt_fechas);
	  $ls_sql=" SELECT  spg_dt_cmp.spg_cuenta,tepuy_cmp.tipo_destino,rpc_beneficiario.apebene,tepuy_cmp.cod_pro, ".
...
/********************************************************************************************************************************/
	...
	function uf_select_dt_comprobante($as_codemp,$as_procede,$as_comprobante,$ad_fecha,&$ai_numrows,&$rs_data)
	{
		 ...
		 $ls_sql = "SELECT spg_dtmp_cmp.codestpro1,
						   ...
						   spg_dtmp_cmp.monto,
						   tepuy_fuentefinanciamiento.denfuefin,
