...
$io_fun_compra->uf_load_seguridad("SOC","tepuy_soc_p_generar_orden_analisis.php",$ls_permisos,&$la_seguridad,$la_permisos);
...
switch ($li_diasem){
  ...
  break;
   ...
   function uf_limpiarvariables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
	    global $ld_fecope,$li_totrows,$io_fun_compra,$ls_operacion,$ls_numanacot,$ls_solcot,$ld_fecope,$ld_fecdes,$ld_fechas,$ls_tipope;
   ...
   function uf_load_variables()
   {
	    ...
	    global $ls_tipope,$li_totrows,$ls_operacion,$ls_numanacot,$ls_solcot,$ld_fecope,$ld_fecdes,$ld_fechas;
...
<?php
require_once("class_folder/tepuy_soc_c_generar_orden_analisis.php");
$io_soc = new tepuy_soc_c_generar_orden_analisis("../");
uf_limpiarvariables();
switch($ls_operacion){
  case 'GUARDAR':
			uf_load_variables();
...
?>
    <table width="595" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
        <td height="22" colspan="6" class="titulo-celdanew">Generaci&oacute;n de &Oacute;rdenes de Compra
          <input name="operacion" type="hidden" id="operacion" value="<?php print $ls_operacion ?>" /></td>
      </tr>
      <tr>
        <td width="79" height="43" style="text-align:right">&nbsp;</td>
        <td height="43" colspan="2" style="text-align:left"><label></label></td>
        <td width="23" height="43">&nbsp;</td>
        <td height="43" colspan="2" style="text-align:right"><strong>Fecha</strong> 
        <input name="txtfecope" type="text" class="sin-borde" id="txtfecope" value="<?php print $ld_fecope ?>" size="15" maxlength="12" read="read" />&nbsp;&nbsp;&nbsp;</td>
      </tr>
      <tr>
        <td height="22" style="text-align:right">N&uacute;mero de Orden de Compra a Asignar</td>
        <td width="161" height="22" style="text-align:left"><input name="txtnumanacot" type="text" id="txtnumanacot" value="<?php print $ls_numanacot ?>" size="20" maxlength="15" style="text-align:center" onKeyPress="return keyRestrict(event,'1234567890'); " onBlur="javascript:rellenar_cad(this.value,15)" /></td>
        <td width="133" height="22" style="text-align:right">Desde 
          <label>
          <input name="txtfecdes" type="text" id="txtfecdes" value="<?php print $ld_fecdes ?>" size="12" maxlength="10" datepicker="true" />
        </label></td>
        <td height="22">&nbsp;</td>
        <td height="22" colspan="2" style="text-align:left">Hasta 
          <label>
          <input name="txtfechas" type="text" id="txtfechas" value="<?php print $ld_fechas ?>" size="12" maxlength="10" datepicker="true" />
        </label></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="22" colspan="6"><div align="right"><a href="javascript: ue_buscar();"><img src="../shared/imagebank/tools20/buscar.png" alt="Ordenes de Compra" width="20" height="20" border="0" onclick="ue_buscar()">Buscar An&aacute;lisis de Cotizaciones</a>&nbsp;&nbsp;</div></td>
      </tr>
      <tr>
        <td height="13">&nbsp;</td>
        <td height="13">&nbsp;</td>
...
function ue_catalogo_solicitudes()
{
	...
	window.open("tepuy_soc_cat_solicitud_cotizacion.php?tipo="+ls_tipo+"&cod_pro="+ls_codpro+"&tipsolcot="+ls_tipsolcot,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=650,height=400,left=50,top=50,location=no,resizable=no");   	
}

function ue_catalogo_analisis()
{
	window.open("tepuy_soc_cat_analisis_cotizacion.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=650,height=400,left=50,top=50,location=no,resizable=no");   	
}
  ...
  if (li_leer==1)
     {
		...
		ajax.open("POST","class_folder/tepuy_soc_c_generar_orden_analisis_ajax.php",true);
