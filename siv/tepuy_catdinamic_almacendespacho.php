...
*/				}
			...
			print  $ls_codart."<br>";
			print  $ls_codalm."<br>";
			print  $li_existencia."<br>";
			print  $li_preuniart."<br>";
			print  $ls_numdocori."<br>";
			...
			print "obj1=eval(opener.document.form1.txtcansol".$li_linea.");";
...
<script language="JavaScript">
	function aceptar(ls_codalm,li_existencia,li_linea)
	{
		...
		//f.txtcansol.value= li_existencia;
		f.operacion.value="BUSCAR";
		f.action="tepuy_catdinamic_almacendespacho.php";
		f.submit();
	}
	...
	function ue_search()
  	{
		f=document.form1;
		f.operacion.value="BUSCAR";
		f.action="tepuy_catdinamic_almacen.php";
		f.submit();
	}
</script>
</html>
