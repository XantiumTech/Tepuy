...
?>
  <table width="550" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td align="center"><div align="left">          <a href="javascript: uf_aceptar();"><img src="../shared/imagebank/tools20/aprobado.png" alt="Aceptar" width="20" height="20" border="0"></a>       
      </div>
    </tr>
  </table>
...
<script language="JavaScript">
  ...
  function uf_aceptar()
  {
	...
	f.action="tepuy_w_regdt_col_deducciones.php";
	f.submit();
  }
