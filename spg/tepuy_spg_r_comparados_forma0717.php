...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_comparados_forma0717.php";
...
function ue_showouput()
{
	...
	if(txtetiqueta=="Mensual")
	{
		...
		else
		{
			...
			{
			   pagina="reportes/tepuy_spg_rpp_comparados_forma0717.php?combo="+combo
	...
	else
	{
		...
		{
		   pagina="reportes/tepuy_spg_rpp_comparados_forma0717.php?combo="+combo+"&txtetiqueta="+txtetiqueta+"&tipoformato="+tipoformato;
		   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}
}
