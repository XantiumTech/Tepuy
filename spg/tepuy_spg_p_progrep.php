...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_p_progrep.php";
...
<?php
	...
	require_once("tepuy_spg_class_progrep.php");
	...
	$io_class_progrep=new tepuy_spg_class_progrep();
 ...
 ?>
  ...
  <table width="798" height="224" border="0" align="center">
    <tr>
      <td width="777"><table width="580" height="258" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
<tr>
  ...
  <?php
	...
	?>
	  ...
	  ?>
              ...
              <td colspan="2">
                <input name="codestpro1" type="text" id="codestpro12" style="text-align:center" value="<?php print $ls_codestpro1 ?>" size="22" maxlength="20" readonly>
            ...
            <tr class="formato-blanco">
              ...
              <td colspan="2"><input name="codestpro2" type="text" id="codestpro2" style="text-align:center" value="<?php print $ls_codestpro2 ?>" size="22" maxlength="6" readonly>
            ...
            <tr class="formato-blanco">
              ...
              <td colspan="2"><input name="codestpro3" type="text" id="codestpro3" style="text-align:center"  value="<?php print $ls_codestpro3 ?>" size="22" maxlength="3" readonly>
	  ...
	  ?>
                  ...
                  <div align="left"></div></td>
              <td colspan="2"><input name="codestpro1" type="text" id="codestpro1" style="text-align:center" value="<?php print $ls_codestpro1 ?>" size="5" maxlength="2" readonly>
              <a href="javascript:catalogo_estpro1();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1">            </a><input name="denestpro1" type="text" class="sin-borde" id="denestpro1" value="<?php print $ls_denestpro1 ?>" size="45" readonly>              </td>
            </tr>
            <tr>
              <td height="20"><div align="right"><?php print $ls_NomEstPro2;?></div></td>
              <td colspan="2"><input name="codestpro2" type="text" id="codestpro2" style="text-align:center" value="<?php print $ls_codestpro2 ?>" size="5" maxlength="2" readonly>
                <a href="javascript:catalogo_estpro2();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 2">              </a><input name="denestpro2" type="text" class="sin-borde" id="denestpro2" value="<?php print $ls_denestpro2 ?>" size="45" readonly>              </td>
            </tr>
            <tr>
              <td height="20"><div align="right"><?php print $ls_NomEstPro3;?></div></td>
              <td colspan="2"><input name="codestpro3" type="text" id="codestpro3" style="text-align:center"  value="<?php print $ls_codestpro3 ?>" size="5" maxlength="2" readonly>
              <a href="javascript:catalogo_estpro3();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 3">              </a><input name="denestpro3" type="text" class="sin-borde" id="denestpro3" value="<?php print $ls_denestpro3 ?>" size="45" readonly>              </td>
            </tr>
            <tr>
              <td height="20"><div align="right"><?php print $ls_NomEstPro4;?></div></td>
              <td colspan="2"><input name="codestpro4" type="text" id="codestpro4" style="text-align:center"  value="<?php print $ls_codestpro4 ?>" size="5" maxlength="2" readonly>
              <a href="javascript:catalogo_estpro4();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 4">              </a><input name="denestpro4" type="text" class="sin-borde" id="denestpro4" value="<?php print $ls_denestpro4 ?>" size="45" readonly>              </td>
            </tr>
            <tr>
              <td height="20"><div align="right"><?php print $ls_NomEstPro5;?></div></td>
              <td colspan="2"><input name="codestpro5" type="text" id="codestpro5" style="text-align:center"  value="<?php print $ls_codestpro5 ?>" size="5" maxlength="2" readonly>
              <a href="javascript:catalogo_estpro5();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 5">              </a><input name="denestpro5" type="text" class="sin-borde" id="denestpro5" value="<?php print $ls_denestpro5 ?>" size="45" readonly>              </td>
			  <?php  
			  }
			  ?>
            </tr>
...
<tr>
 ...
 <?php	
 //Titulos de la tabla
 $title[1]="Cuenta";   $title[2]="Denominaci&oacute;n";  $title[3]="Asignaci&oacute;n"; $title[4]="Distribucion"; $ls_nombre="grid_progrep";
...
if($ls_operacion == "RECARGAR")
{
   ...
   $lb_valido=$io_class_progrep->uf_prog_report_load_original(trim($ls_codrep),$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,$la_seguridad);
...
if($ls_operacion=="CARGAR")
{
     ...
     $ls_modrep=1;
     $rs_load=$io_class_progrep->uf_cargar_reporte($ls_codrep,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5,$ls_modrep);
	 if($row=$io_sql->fetch_row($rs_load))
	 {
		...
		{    
			...
			if($ls_status=="I")
			{
			    ...
			    $object[$i][4] ="<a href=javascript:ue_distribuir(".($i).");><img src=../shared/imagebank/tools15/aprobado.png width=15 height=15 border=0 style=text-align:center alt=Distribucion></a>";
			}
			else
			{
...
function ue_distribuir(li)
{
    ...
    else
    {
			...
			distribuir="distribuir"+li;
		    pagina="tepuy_spg_p_progrep_distribucion.php?fila="+li+"&txtAsignacion="+ld_asignado+"&enero="+ld_enero
...
function catalogo_estpro3()
{
	...
	if(estmodest==1)
	{
		...
		{
			pagina="tepuy_cat_public_estpro.php?tipo=progrep";
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
	}
	else
...
function catalogo_estpro5()
{
	...
	{
			pagina="tepuy_cat_public_estprograma.php?tipo=progrep";
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
}
function ue_cerrar()
