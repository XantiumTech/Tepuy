...
$ls_cadena ="SELECT * FROM spi_cuentas ".
		    "WHERE codemp = '".$as_codemp."' AND spi_cuenta like '".$ls_codigo."%' AND denominacion like '%".$ls_denominacion."%' ".
			"      AND sc_cuenta like '".$ls_codscg."%' ORDER BY spi_cuenta";
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_spi_cat_ctaspi.php";
	  f.submit();
  }
