<?PHP
	...
	//	$io_pdf->add_texto(12,84,11,"<b>$ls_conmov</b>");//Antes 84 para bajar hay que sumar en la segunda columna
		...
		$li_pos=400;//Antes 174 para bajar restar
		$io_pdf->convertir_valor_mm_px($li_pos);		
		$io_pdf->ezSetY($li_pos);
		$io_pdf->ezSetY(490);
		$la_data=array(array('cheque'=>'','banco'=>." xx".''),
					   array('cheque'=>"<b>$ls_numdoc</b>",'banco'=>"    "."<b>$ls_nomban </b>"."<b>".substr($ls_ctaban,-4)."</b>"));
	...
	set_time_limit(1800);
	$io_pdf=new class_pdf('LETTER','portrait'); // Instancia de la clase PDF TAMAÑO CARTA
