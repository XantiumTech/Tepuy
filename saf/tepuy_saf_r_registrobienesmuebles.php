...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_registrobienesmuebles.php",$ls_permisos,$la_seguridad,$la_permisos);
      ...
      <td colspan="3" align="center"><p>&nbsp;</p>
        ...
        <tr>
          ...
          <td height="22"><input name="txtcoddesde" type="text" id="txtcoddesde" size="21" maxlength="20"  style="text-align:center ">
            <a href="javascript:uf_catalogo_activosigecof('txtcoddesde','txtdendesde');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
        ...
        <tr>
          ...
          <td height="22"><a href="javascript: uf_unidad();">
            <input name="txtcoduniadm" type="text" id="txtcoduniadm" style="text-align:center " value="<?php print $ls_coduniadmcede; ?>" size="13" maxlength="10" >
            </a><a href="javascript:ue_buscarunidad();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
        ...
        <tr>
          ...
          <td height="22"><input name="txtcodresced" type="text" id="txtcodresced" value="<?php print $ls_codresced;?>" size="13" maxlength="10" readonly>
        ...
        <tr>
          ...
          <td height="22"><input name="txtcodresrece" type="text" id="txtcodresrece" value="<?php print $ls_codreserec; ?>" size="13" maxlength="10" readonly>
        ...
        <table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="446" height="22"><div align="left">
                ...
                <a href="javascript:uf_catalogo_activo('txtcodactdes','txtdenactdes');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
{
	window.open("tepuy_saf_cat_sigecof.php?coddestino="+ls_coddestino +"&dendestino="+ls_dendestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
}

function uf_catalogo_activo(ls_coddestino,ls_dendestino)
{
	window.open("tepuy_saf_cat_codactivoss.php?coddestino="+ ls_coddestino +"&dendestino="+ ls_dendestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
}	
