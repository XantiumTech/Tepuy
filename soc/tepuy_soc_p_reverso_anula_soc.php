<?php
	...
	$oi_fun_integrador->uf_load_seguridad("SOC","tepuy_soc_p_reverso_anula_soc.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
		...
		case "PROCESAR":
			...
			for($li_i=1;$li_i<=$li_totrows;$li_i++)
			{
				if(array_key_exists("chksel".$li_i,$_POST))
				{
					...
					$tepuy_cmp='0';
			$lb_valido=$in_class->uf_procesar_reverso_anulacion($ls_numordcom,$ls_estcondat,$ld_fechaconta,$ld_fechaanula,$tepuy_cmp,$la_seguridad);
					if($lb_valido)
					{
...
function ue_procesar()
{
	...
	{	
		...
		if(lb_valido)
		{
			...
			f.action="tepuy_soc_p_reverso_anula_soc.php";
			f.submit();
		}
		else
		{
