    ...
    <table width="532" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <td height="22" colspan="5"><div align="left"><input name="txtcuenta" type="text" id="txtcuenta" size="20" maxlength="20" readonly>
          <a href="javascript:cat_scg();"><img src="../../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a>
      ...
      <tr>
        ...
        <td height="22" colspan="4"><div align="right"><a href="javascript:ue_search();"><img src="../../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a> <a href="javascript:aceptar();"><img src="../../shared/imagebank/tools20/aprobado.png" width="20" height="20" border="0">Aceptar</a> </div></td>
      </tr>
    </table>
    <div align="center"><br>
      <?php
...
$ls_cadena="SELECT DISTINCT sig_cuenta,denominacion 
			...
			WHERE not exists (select * from spg_cuentas where spg_cuentas.spg_cuenta ";
			if($_SESSION["ls_gestor"]=="MYSQL")
			{
				 $ls_cadena=$ls_cadena." like concat(tepuy_plan_unico_re.sig_cuenta,'%') ";
			 }
			 if($_SESSION["ls_gestor"]=="POSTGRE") 
			 {
				 $ls_cadena=$ls_cadena." like tepuy_plan_unico_re.sig_cuenta||'%' ";
			 }
			 if($ls_codigo!="")
			 {
				 $ls_cadena=$ls_cadena." AND codestpro1='".$ls_codestpro1."' AND codestpro2='".$ls_codestpro2."' AND codestpro3='".$ls_codestpro3."' AND codestpro4='".$ls_codestpro4."' AND codestpro5='".$ls_codestpro5."') AND sig_cuenta like '".$ls_codigo."%' AND denominacion like '%".$ls_nombre."%'";
			 }
			 else
			 {
				 $ls_cadena=$ls_cadena." AND codestpro1='".$ls_codestpro1."' AND codestpro2='".$ls_codestpro2."' AND codestpro3='".$ls_codestpro3."' AND codestpro4='".$ls_codestpro4."' AND codestpro5='".$ls_codestpro5."') AND sig_cuenta like '".$ls_codigo_gasto."%' AND denominacion like '%".$ls_nombre."%'";			 	
			 }				 
