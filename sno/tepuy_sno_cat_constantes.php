				...
				switch($as_tipo)
				{
					case "":
						if($lb_valido)
						{
							...
							print "<td ><a href=\"javascript: aceptar('$ls_codcons','$ls_nomcon','$ls_unicon','$ls_topcon','$ls_valcon','$ls_reicon','$ls_total','$ls_conespseg');\">".$ls_codcons."</a></td>";
...
function aceptar(codcons,nomcon,unicon,topcon,valcon,reicon,total,conespseg)
{
...
function ue_search()
{
	...
	f.action="tepuy_sno_cat_constantes.php";
	f.submit();
}
</script>
</html>