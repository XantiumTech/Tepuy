...
<br>
      ...
      <tr>
        ...
        <a href="javascript:cat_scg();"><img src="../../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a>        <input name="txtdenominacion" type="text" id="txtdenominacion" size="48"></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        ...
        <td colspan="4"><div align="right"><a href="javascript:ue_search();"><img src="../../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a> <a href="javascript:aceptar();"><img src="../../shared/imagebank/tools15/aprobado.png" width="15" height="15" border="0">Aceptar</a> </div></td>
      </tr>
    </table>
	<?php
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_catdinamic_ctaspg.php";
	  f.submit();
  }
