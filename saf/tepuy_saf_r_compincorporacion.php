...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_compincorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","COMPROBANTE_INC","tepuy_saf_rpp_comincorporacion.php","C");
...
function uf_catalogoincorporacion()
{
	...
	window.open("tepuy_saf_cat_incorporaciones.php?coddestino="+ ls_coddestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=120,top=70,location=no,resizable=yes");
}
