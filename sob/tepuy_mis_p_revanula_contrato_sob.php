<?php
	...
	$oi_fun_integrador->uf_load_seguridad("SOB","tepuy_mis_p_revanula_contrato_sob.php",$ls_permisos,$la_seguridad,$la_permisos);
...
function ue_procesar()
{
	...
	if(li_ejecutar==1)
	{
		...
		if(lb_valido)
		{
			...
			f.action="tepuy_mis_p_revanula_contrato_sob.php";
			f.submit();
		}
		else
		{
