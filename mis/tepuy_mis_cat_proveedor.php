...
<table width="500" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
    ...
    <tr>
	  ...
	  <div align="right"><a href="javascript:ue_search();"><img src="../shared/imagebank/tools20/buscar.png" width="20" height="20" border="0"></a> </div></td>
  </table> 
	<br>
<?php
...
function ue_search()
{
    ...
    f.action="tepuy_mis_cat_proveedor.php";
    f.submit();
}
</script>
</html>