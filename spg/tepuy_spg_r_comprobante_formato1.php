...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
    ...
    $ls_reporte=$io_fun_gasto->uf_select_config("SPG","REPORTE","COMPROBANTE_FORM1","tepuy_spg_rpp_comprobante_formato1.php","C");
    
	$dat=$_SESSION["la_empresa"];
	$ls_empresa=$dat["codemp"];
	$ls_logusr=$_SESSION["la_logusr"];
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_comprobante_formato1.php";
...
<!--  <tr> 
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput('<?php print $ls_reporte ?>');"><img src="../shared/imagebank/tools20/imprimir.png" width="20" height="20" border="0"></a></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a>
...
function ue_showouput(ls_reporte)
{
	...
	if(li_imprimir==1)
	{
		...
		pagina="reportes/"+ls_reporte+"?txtcompdes="+txtcompdes
...
{
	   pagina="tepuy_cat_comprobantesspg.php?tipocat=repcompdes";
	   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
function catalogo_comphas()
{
		pagina="tepuy_cat_comprobantesspg.php?tipocat=repcomphas";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
function catalogo_procdes()
{
	   pagina="tepuy_cat_comprobantesspg.php?tipocat=rep_proc_des";
	   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
function catalogo_prochas()
{
		pagina="tepuy_cat_comprobantesspg.php?tipocat=rep_proc_has";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
