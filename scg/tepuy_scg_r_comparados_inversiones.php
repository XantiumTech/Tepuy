...
<title>Comparado-Inversiones</title>
...
<form name="form1" method="post" action=""> 
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Comparado-Inversiones</td>
    </tr>
  </table>
...
function ue_showouput()
{
	...
	if(txtetiqueta=="Mensual")
	{
		...
		else
		{
			...
			{
			   pagina="reportes/tepuy_scg_rpp_comparado_inversiones.php?combo="+combo
			           +"&combomes="+combomes+"&txtetiqueta="+txtetiqueta;
	...
	else
	{
		...
		{
		   pagina="reportes/tepuy_scg_rpp_comparado_inversiones.php?combo="+combo+"&txtetiqueta="+txtetiqueta;
		   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}
}
