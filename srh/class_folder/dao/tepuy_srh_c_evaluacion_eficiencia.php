...
class tepuy_srh_c_evaluacion_eficiencia
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_evaluacion_eficiencia($path)
	{   
	...
	function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_p_evaluacion_eficiencia)
		//      Argumento: 
...
function uf_srh_buscar_evaluacion_eficiencia($as_nroeval,$as_fecha1,$as_fecha2,$as_tipo,$as_tipo_caja)
{
		...
		//         access: public (tepuy_srh_evaluacion_eficiencia)												
		//      Argumento: $as_nroeval   //  código de la evaluación de eficiencia
...
}// end   class tepuy_srh_c_evaluacion_eficiencia
?>