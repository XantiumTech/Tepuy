          ...
          <table width="450" height="154"  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
            ...
            <tr>
              ...
              <td colspan="2" ><label><input name="txtcodper1" type="text" id="txtcodper1" size="16" maxlength="12">
                  <a href="javascript: ue_buscarpersonal('1');"><img src="../../../shared/imagebank/tools20/buscar.png" alt="Buscar" name="personal" width="20" height="20" border="0" id="personal"> </a>
                  <input name="txtcodper2" type="text" id="txtcodper2" size="16" maxlength="12">
                  <a href="javascript: ue_buscarpersonal('2');"><img src="../../../shared/imagebank/tools20/buscar.png" alt="Buscar" name="personal" width="20" height="20" border="0" id="personal"></a></label></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td colspan="2">&nbsp;</td>
