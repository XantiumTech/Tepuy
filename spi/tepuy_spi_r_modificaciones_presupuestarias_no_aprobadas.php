...
//////////////////////////////////////////////         SEGURIDAD               ///////////////////////////////////////////////////////////////////////
	...
	$io_fun_ingreso->uf_load_seguridad("SPI","tepuy_spi_r_modificaciones_presupuestarias_no_aprobadas.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////////////////////////
?>
...
<!--  <tr> 
  ...
  <tr> 
    <td height="32" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.png" width="20" height="20" border="0"></a></a><a href="../spi/tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a>
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		{
			pagina="reportes/tepuy_spi_rpp_modificaciones_presupuestaria_no_aprobadas.php?ckbaum="+ckbaum+"&txtcomprobante="+txtcomprobante
...
{
	   pagina="tepuy_cat_comprobantes_modificaciones.php?tipocat=rep_ejecucion";
