...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_d_tenencia.php";
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	{
		$lb_valido=$io_tenencia->uf_guardar_tenencia($ls_codten,$ls_nomten,$ls_desten,$la_seguridad);
        ...
        <td width="516" height="161"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr>
              ...
              <td width="334" ><input name="txtcodten" style="text-align:center " type="text" id="txtcodten" value="<? print  $ls_codten?>" size="3" maxlength="3" readonly="true">
            ...
            <tr align="left">
              ...
              <td><input name="txtnomten" id="txtnomten" value="<? print $ls_nomten?>" type="text" size="56" maxlength="50" onKeyPress="return(validaCajas(this,'x',event,50))"></td>
            </tr>
            <tr>
              <td height="4" align="right">Descripci&oacute;n</td>
              <td><textarea name="txtdesten" cols="53" rows="2" id="txtdesten" value="<? print $ls_desten?>"  onKeyDown="textCounter(this,254)"  onKeyUp="textCounter(this,254)" onKeyPress="return(validaCajas(this,'x',event))"><? print $ls_desten?></textarea></td>
            </tr>
            <tr>
              <td height="8">&nbsp;</td>
              <td>&nbsp;</td>
...
function ue_nuevo()
{
	...
	{	
		...
		f.action="tepuy_sob_d_tenencia.php";
		f.submit();
	}
	else
	{
