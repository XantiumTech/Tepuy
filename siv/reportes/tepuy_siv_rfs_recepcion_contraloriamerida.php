<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numconrec,$ad_fecha,&$io_pdf)
	{
		...
		$io_pdf->line(190,40,190,110);		
		$io_pdf->line(380,40,380,110);		
		$io_pdf->addText(95,102,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(70,43,7,"ÁREA DE ALMACÉN Y SERVICIOS"); // Agregar el título
		//$io_pdf->addText(157,102,7,"VERIFICADO POR"); // Agregar el título
		//$io_pdf->addText(160,43,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(250,102,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(200,43,7,"DIRECCIÓN DE ADMINISTRACIÓN Y PRESUPUESTO"); // Agregar el título
