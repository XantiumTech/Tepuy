...
class tepuy_scb_c_report
{
	...
	var $ds_documentos;
	function tepuy_scb_c_report($conn)
	{
	...
	function uf_cargar_disponibilidad($arr_codban,$ld_fecha,$ls_typereport)
	{
		...
		for($li_x=0;$li_x<$li_total_bancos;$li_x++)
		{
			...
			$ls_sql="SELECT a.ctaban as ctaban, a.ctabanext as ctabannext, a.dencta as dencta,c.nomban as nomban,b.codtipcta as codtipcta,b.nomtipcta as nomtipcta,a.fecapr as fecapr,a.sc_cuenta as sc_cuenta
			...
			{			
				while($row=$this->SQL->fetch_row($rs_cuenta))//Recorro los bancos y cuentas
				{
					...
					$this->ds_disponibilidad->insertRow("ctabannext",$ls_ctabannext);
					...
					//print "cuenta ".$ls_ctaban."  saldoanterior ".$ldec_saldoanterior_ant."   debitos ".$ldec_debitosant." creditos ".$ldec_creditosant."<br>";
					//$this->ds_disponibilidad->sortData("ctaban");
	...
	//print "-------------------------------------------------------------------<br>";
			...
			//---------------------Colocaciones---------------------//
			$ls_sql="SELECT a.numcol as numcol,a.ctaban as ctaban, a.ctabanext as ctabannext, a.dencol as dencta,c.nomban as nomban,b.codtipcol as codtipcol,b.nomtipcol as nomtipcol,a.feccol as feccol,a.sc_cuenta as sc_cuenta
