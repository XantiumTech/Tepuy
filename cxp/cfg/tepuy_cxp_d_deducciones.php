...
if ($ls_operacion=="ue_guardar")
   { 
	//print "valor:".$_POST["radiotipodeduccion"];
	...
	if ($lb_existe)
       { 
		 ...
		 elseif($ls_estatus=="GRABADO")
			...
			//print "aqui si".$lb_valfor;
			   if ($lb_valfor>=0)
			      {
					if (array_key_exists("chkcubretotal",$_POST))
					{
						$li_cubretotal          = 1;//$_POST["chkcubretotal"];
						$lr_datos["cubretotal"] = $li_cubretotal;
						$ls_cubretotal          = "checked";
					}
					else
					...
					//print "cubretotal".$ls_cubretotal;
...
?>
		...
		<tr>
                ...
                <td height="22" colspan="6" style="text-align:left"><input name="chkcubretotal" type="checkbox" class="sin-borde" id="chkcubretotal" value="1" checked <?php print $ls_cubretotal; ?>></td> 

         <!--   <td height="22" colspan="6" style="text-align:left"><input name="chkcubretotal" type="checkbox" class="sin-borde" id="chkcubretotal" value="1" <?php if($ls_cubretotal!="0"){print "checked";} ?>> -->
                    </tr>
                    <tr>
...
/*	if(($ls_tipodeduccion=="S")||($ls_tipodeduccion==""))
      ...
      Ret. Municipal</td>
                      <td width="125" height="22"><input name="radiotipodeduccion" type="radio" class="sin-borde" onClick="cambiarestatus()" value="T" <?php print $ls_timbrefiscal ?>>
                       Timbre Fiscal
                      <td width="102"><label>
                        <input name="radiotipodeduccion" type="radio" class="sin-borde" onClick="cambiarestatus()"
