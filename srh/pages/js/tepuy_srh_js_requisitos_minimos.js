...
var url= "../../php/tepuy_srh_a_requisitos_minimos.php";
var metodo='get';
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_p_requisitos_minimos.php";
  f.submit();  
 }
...
function consultar_items () {
	 ...
	 if  ( ($('txtcodeval').value=="") ) 		
	 {
	  ...
	  f.operacion.value="CONSULTAR";
  	  f.action="../pantallas/tepuy_srh_p_requisitos_minimos.php";
	  f.existe.value="TRUE";			
	  f.submit();	
	 }
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_requisitos_minimos.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
...
function ue_imprimir()
{
	...
	{	
		...
		fecha=f.txtfecha.value;
				   	pagina="../../../reporte/tepuy_srh_rpp_resultados_reqmin.php?codeval="+codeval+"&codper="+codper+"&codcon="+codcon+"&fecha="+fecha+"";
