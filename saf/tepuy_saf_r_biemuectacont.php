...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_biemuectacont.php",$ls_permisos,$la_seguridad,$la_permisos);
      ...
      <td height="22" colspan="3" align="center"><div align="left" class="style14">
        ...
        <tr>
          ...
          <td width="418" height="22"><div align="left">
              ...
              <a href="javascript:uf_catalogo_ctasscg('txtctacon1','txtdenctacon1');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a> 
        ...
        <tr>
          ...
          <td height="22"><div align="left">
              ...
              <a href="javascript:uf_catalogo_ctasscg('txtctacon2','txtdenctacon2');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
<script language="JavaScript">
    ...
    {
	window.open("tepuy_cat_ctasscg.php?coddestino="+ ls_coddestino +"&dendestino="+ ls_dendestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,left=120,top=70,location=no,resizable=yes");
    }
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				{
				window.open("reportes/tepuy_saf_rpp_biemuectacont_res.php?ordenact="+li_ordenact+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&tipoformato="+tipoformato+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="tepuy_siv_r_biemuectacont.php";
				}
				else 
				{ 
				 window.open("reportes/tepuy_saf_rpp_biemuectacont_det.php?ordenact="+li_ordenact+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&tipoformato="+tipoformato+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="tepuy_siv_r_biemuectacont.php";
				}
			}
