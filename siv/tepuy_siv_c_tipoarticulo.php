...
class tepuy_siv_c_tipoarticulo
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_siv_c_tipoarticulo()
	{
	...
	function uf_siv_select_tipoarticulo($as_codtipart)
	{
		...
		//         Access: public (tepuy_siv_d_tipoarticulo)
	...
	function  uf_siv_insert_tipoarticulo($as_codtipart,$as_dentipart,$as_obstipart,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_siv_update_tipoarticulo($as_codtipart,$as_dentipart,$as_obstipart,$aa_seguridad) 
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 $lb_valido=true;
		 $ls_sql = "UPDATE siv_tipoarticulo SET   dentipart='". $as_dentipart ."',obstipart='". $as_obstipart ."' ". 
				   " WHERE codtipart='" . $as_codtipart ."' ";
        $this->io_sql->begin_transaction();
		$li_row = $this->io_sql->execute($ls_sql);
		if($li_row===false)
...
}// end   class tepuy_siv_c_tipoarticulo
?>
