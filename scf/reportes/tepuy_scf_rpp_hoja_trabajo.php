<?php
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_scf->uf_load_seguridad_reporte("SCF","tepuy_scf_r_balance_comprobacion.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
		...
		require_once("tepuy_scf_class_bal_general.php");
		$io_report_bal_g = new tepuy_scf_class_bal_general();
		$ls_tiporeporte="0";
		$ls_bolivares="";
		...
		{
			case "0":
				require_once("tepuy_scf_class_report.php");
				$io_report  = new tepuy_scf_class_report();
				$ls_bolivares ="Bs.";
				break;
	
			case "1":
				require_once("tepuy_scf_class_reportbsf.php");
				$io_report  = new tepuy_scf_class_reportbsf();
				$ls_bolivares ="Bs.F.";
				break;
		}
		$ia_niveles_scf[0]="";			
