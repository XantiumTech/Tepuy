...
class tepuy_scb_c_ordenpago
{
	...
	var $la_security;
	var $io_seguridad;
	function tepuy_scb_c_ordenpago($aa_security)
	{
	...
	function uf_guardar_automatico($ls_codban,$ls_ctaban,$ls_numdoc,$ls_codope,$ldt_fecha,$ls_conmov,$ls_codconmov,$ls_codpro,$ls_cedbene,$ls_nomproben,$ldec_monto,$ldec_monobjret,$ldec_monret,$ls_chevau,$ls_estmov,$li_estmovint,$li_cobrapaga,$ls_estbpd,$ls_procede,$ls_estreglib,$ls_estdoc,$ls_tipproben,$ls_tipdocres,$ls_numdocres,$ls_fecdocres,$ls_tipreg,$ls_fte_financiamiento,$ls_origen,$ls_tippag,$ls_mediopago,$ls_modalidad,$ls_coduniadm,$ls_codbansig,$ls_estpro,$ls_codbanbene,$ls_nombanbene,$ls_ctabanbene,$ls_codbanaut,$ls_nombanaut,$ls_ctabanaut,$ls_rifaut,$ls_nomaut,$ls_nrocontrol)
	{								
		////////////////////////////////////////////////////////////////////////////////////////////////
		//
		...
		{
		   //$lb_valid_doc=$this->uf_verificar_documento($ls_codemp,$ls_numdoc,$ldt_fecha);
		   /*if($lb_valid_doc)
		   {*/
			   if(!$this->uf_select_movimiento($ls_numdoc,$ls_codope,$ls_codban,$ls_ctaban,$ls_estmov))
			   {	
				   $this->io_sql->begin_transaction();
				   $lb_valido = $this->uf_insert_movimiento($ls_codemp,$ls_codusu,$ls_codban,$ls_ctaban,$ls_numdoc,$ls_codope,$ldt_fecha,$ls_conmov,$ls_codconmov,$ls_codpro,$ls_cedbene,$ls_nomproben,$ldec_monto,$ldec_monobjret,$ldec_monret,$ls_chevau,$ls_estmov,$li_estmovint,$li_cobrapaga,$ls_estbpd,$ls_procede,$ls_estreglib,$ls_tipproben,$ls_tipdocres,$ls_numdocres,$ls_fecdocres,$ls_tipreg,"--",$ls_origen,$ls_tippag,$ls_mediopago,$ls_modalidad,$ls_coduniadm,$ls_codbansig,$ls_estpro,$ls_nrocontrol);
				   if($lb_valido)
				   {
			   ...
			   elseif($ls_estdoc=='C')
			   {
					...
					$lb_valido=true;
					$lb_valido=$this->uf_update_movimiento($ls_codemp,$ls_codusu,$ls_codban,$ls_ctaban,$ls_numdoc,$ls_codope,$ldt_fecha,$ls_conmov,$ls_codconmov,$ls_codpro,$ls_cedbene,$ls_nomproben,$ldec_monto,$ldec_monobjret,$ldec_monret,$ls_chevau,$ls_estmov,$li_estmovint,$li_cobrapaga,$ls_estbpd,$ls_procede,$ls_estreglib,$ls_coduniadm,$ls_estpro,$ls_tipproben);
				 /*  if($lb_valido)
				   {
						$lb_valido = $this->uf_delete_fuentefinancimiento($ls_codemp,$ls_codban,$ls_ctaban,$ls_numdoc,$ls_codope,$ls_estmov);
				   }
				   if($lb_valido)
				   {
						$lb_valido = $this->uf_insert_fuentefinancimiento($ls_codemp,$ls_codban,$ls_ctaban,$ls_numdoc,$ls_codope,$ls_estmov,$ls_fte_financiamiento);
...
function uf_insert_movimiento($ls_codemp,$ls_codusu,$ls_codban,$ls_ctaban,$ls_numdoc,$ls_codope,$ldt_fecha,$ls_conmov,$ls_codconmov,$ls_codpro,$ls_cedbene,$ls_nomproben,$ldec_monto,$ldec_monobjret,$ldec_monret,$ls_chevau,$ls_estmov,$li_estmovint,$li_cobrapaga,$ls_estbpd,$ls_procede,$ls_estreglib,$ls_tipproben,$ls_tipdocres,$ls_numdocres,$ls_fecdocres,$ls_tipreg,$ls_fte_financiamiento,$ls_origen,$ls_tippag,$ls_mediopago,$ls_modalidad,$ls_coduniadm,$ls_codbansig,$ls_estpro,$ls_nrocontrol)
{
	////////////////////////////////////////////////////////////////////////////////////////////////
	//
	...
	$ls_sql="INSERT INTO scb_movbco(       codemp   ,     codusu   ,       codban   ,       ctaban     ,   numdoc   ,
										   ...
										   estcon   ,     feccon   ,   estreglib    ,     tipo_destino ,   fecha       ,procede,
										   coduniadmsig, codbansig , fecordpagsig   ,     tipdocressig ,   numdocressig, 
										   estmodordpag, codfuefin, forpagsig, medpagsig, codestprosig ,   nrocontrolop )
			 VALUES                ('".$ls_codemp."','".$ls_codusu."','".$ls_codban."','".$ls_ctaban."','".$ls_numdoc."',
									...
									'".$ls_modalidad."','".$ls_fte_financiamiento."','".$ls_tippag."','".$ls_mediopago."','".$ls_estpro."','".$ls_nrocontrol."')";
...
function uf_update_movimiento($ls_codemp,$ls_codusu,$ls_codban,$ls_ctaban,$ls_numdoc,$ls_codope,$ldt_fecha,$ls_conmov,$ls_codconmov,$ls_codpro,$ls_cedbene,$ls_nomproben,$ldec_monto,$ldec_monobjret,$ldec_monret,$ls_chevau,$ls_estmov,$li_estmovint,$li_cobrapaga,$ls_estbpd,$ls_procede,$ls_estreglib,$ls_coduniadm,$ls_codestpro,$ls_tipproben)
{
	...
	///////////////////////////////////////////////////////////////////////////////////////////////
	$ldt_fecha=$this->fun->uf_convertirdatetobd($ldt_fecha);
	$ls_sql="UPDATE scb_movbco SET conmov='".$ls_conmov."',codconmov='".$ls_codconmov."',cod_pro='".$ls_codpro."',ced_bene='".$ls_cedbene."',nomproben='".$ls_nomproben."',monto='".$ldec_monto."',monobjret='".$ldec_monobjret."',monret='".$ldec_monret."',coduniadmsig='".$ls_coduniadm."',codestprosig='".$ls_codestpro."',tipo_destino='$ls_tipproben'
...
function uf_select_dt_contable($arr_movbco,$ls_cuenta,$ls_procede,$ls_descripcion,$ls_documento,$ls_operacioncon,$ldec_monto,$ldec_actual,$ls_codded)
{
	...
	$ls_sql="SELECT * 
			 ...
			 AND codope='".$ls_codope."' AND estmov='".$ls_estmov."' AND scg_cuenta='".$ls_cuenta."' 
			 AND debhab='".$ls_operacioncon."' AND codded='".$ls_codded."' AND documento='".$ls_documento."'";
...
function uf_procesar_dt_gasto($ls_codban,$ls_ctaban,$ls_numdoc,$as_codope,$ls_estmov,$ls_programa,$ls_spgcuenta,$ls_documento,$ls_desmov,$ls_procededoc,$ldec_monto,$ls_operacion,$ls_coduniadm,$ldec_baseimp,$ls_codcar)
{
	////////////////////////////////////////////////////////////////////////////////////////////////
	//
	...
	if(!$lb_existe)
	{
		$ls_sql="INSERT INTO scb_movbco_spgop(codemp,codban,ctaban,numdoc,codope,estmov,codestpro,spg_cuenta,documento,desmov,procede_doc,monto,operacion,coduniadm,baseimp,codcar)
				 VALUES ('".$ls_codemp."','".$ls_codban."','".$ls_ctaban."','".$ls_numdoc."','".$as_codope."','".$ls_estmov."','".$ls_programa."','".$ls_spgcuenta."','".$ls_documento."','".$ls_desmov."','".$ls_procededoc."',".$ldec_monto.",'".$ls_operacion."','".$ls_coduniadm."','".$ldec_baseimp."','".$ls_codcar."')";
		$ls_evento="INSERT";
	  ...
	  if (!$lb_existe)
		   {
			...
			$this->io_rcbsf->io_ds_datos->insertRow("monto",$ldec_baseimp);
			...
			$this->io_rcbsf->io_ds_filtro->insertRow("filtro","coduniadm");
			$this->io_rcbsf->io_ds_filtro->insertRow("valor",$ls_coduniadm);
			$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
		   ...
		   {
		     $this->uf_update_montos_auxiliares_scb_movbco_spgop($ls_codemp,$ls_codban,$ls_ctaban,$ls_numdoc,$ls_codope,$ls_estmov,$ls_programa,$ls_spgcuenta,$ls_documento,$ls_coduniadm);
		   }
		$lb_valido=true;
		///////////////////////////////////Parametros de seguridad/////////////////////////////////////////////////
        $lb_valido = $this->io_seguridad->uf_sss_insert_eventos_ventana($this->la_security["empresa"],$this->la_security["sistema"],$ls_evento,$this->la_security["logusr"],$this->la_security["ventanas"],$ls_descripcion);		////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function uf_cargar_dt($as_numdoc,$as_codban,$as_ctaban,$as_codope,$ls_estmov,$objectScg,$li_row_scg,$ldec_mondeb,$ldec_monhab,$objectSpg,$li_temp_spg,$ldec_monto_spg,$objectSpi,$li_temp_spi,$ldec_monto_spi)
{
		...
		$ls_sql="SELECT   codban,ctaban,estmov,operacion,codestpro,spg_cuenta,documento,desmov,procede_doc,monto,baseimp,coduniadm,codcar
				 FROM     scb_movbco_spgop
		...
		else
		{
			...
			while($row=$this->io_sql->fetch_row($rs_spg))
			{
				...
				{
					$ls_programatica=substr(substr($ls_programatica,0,20),-2)."-".substr(substr($ls_programatica,20,6),-2)."-".substr(substr($ls_programatica,26,3),-2)."-".substr($ls_programatica,29,2)."-".substr($ls_programatica,31,2);	
				}
				else
				{
...
function uf_update_montos_auxiliares_scb_movbco_spgop($as_codemp,$as_codban,$as_ctaban,$as_numdoc,$as_codope,$as_estmov,$as_programa,$as_spgcuenta,$as_documento,$as_coduniadm)
{
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	   ...
	   if ($row=$this->io_sql->fetch_row($rs_data))
	      {
			...
			$this->io_rcbsf->io_ds_filtro->insertRow("filtro","coduniadm");
			$this->io_rcbsf->io_ds_filtro->insertRow("valor",$as_coduniadm);
			$this->io_rcbsf->io_ds_filtro->insertRow("tipo","C");
