...
//Initialization class variables
	require_once("../../class_folder/dao/tepuy_srh_c_tipopersonal.php");
    require_once("../../class_folder/utilidades/class_funciones_srh.php");
	$io_tip=new tepuy_srh_c_tipopersonal('../../../');
	$io_fun_srh=new class_funciones_srh('../../../');
	$io_fun_srh->uf_load_seguridad("SRH","tepuy_srh_d_tipopersonal.php",$ls_permisos,$la_seguridad,$la_permisos);
