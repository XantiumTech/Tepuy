...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_reg_contables.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
      ...
      <td height="75" colspan="4" align="center"><table width="483" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          ...
          <td width="388" height="22" style="text-align:left"><input name="txtcodban" type="text" id="txtcodban" size="8" style="text-align:center">
              <a href="javascript:cat_bancos()"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Bancos" width="15" height="15" border="0"></a><input name="txtdenban" type="text" class="sin-borde" id="txtdenban" size="40" readonly="true" style="text-align:left">          </td>
        </tr>
        <tr>
...
function ue_imprimir()
{
  ...
  if(f.rb_operaciones[5].checked)
  {
   ...
   if (li_imprimir=='1')
      {
        pagina="reportes/tepuy_scb_rpp_reg_contables_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&codope="+ls_codope+"&orden="+ls_orden+"&tiporeporte="+ls_tiporeporte;
