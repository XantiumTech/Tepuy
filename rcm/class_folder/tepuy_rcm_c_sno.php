<?php
class tepuy_rcm_c_sno
{
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_rcm_c_sno()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_convertir_snocestaticket()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snocestaticket ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snoclasificaciondocente()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoclasificaciondocente ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snoconcepto()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoconcepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snoconceptopersonal()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoconceptopersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snoconceptovacacion()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoconceptovacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snoconstante()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoconstante ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snoconstantepersonal()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoconstantepersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snodtscg()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snodtscg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snodtspg()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snodtspg ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snofideiperiodo()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snofideiperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snogrado()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snogrado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snoperiodo()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{  
	...
	function uf_convertir_snopersonal()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snopersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{  
	...
	function uf_convertir_snopersonalnomina()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snopersonalnomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{  
	...
	function uf_convertir_snoprenomina()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoprenomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{  
	...
	function uf_convertir_snoprestamos()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoprestamos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snoprestamosamortizado()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoprestamosamortizado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snoprestamosperiodo()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoprestamosperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snoprimaconcepto()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoprimaconcepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snoprimagrado()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoprimagrado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snoprogramacionreporte()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoprogramacionreporte ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snoresumen()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snoresumen ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snosalida()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snosalida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snotrabajoanterior()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snotrabajoanterior ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ //
	...
	function uf_convertir_snovacacpersonal()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sno MÉTODO->SELECT->uf_convertir_snovacacpersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
