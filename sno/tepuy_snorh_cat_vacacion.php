   ...
   function uf_print($as_codper,$as_codvac,$as_stavac)
   {
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				print "'$li_sabdom','$li_diapag','$li_pagcan');\">".$li_codvac."</a></td>";
...
function aceptar(codvac,fecvenvac,fecdisvac,fecreivac,diavac,stavac,sueintbonvac,sueintvac,diabonvac,obsvac,diapenvac,persalvac,
                peringvac,dianorvac,quisalvac,quireivac,diaadivac,diaadibon,diafer,sabdom,diapag,pagcan)
{
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="tepuy_snorh_cat_vacacion.php";
  	f.submit();
}
</script>
</html>
