...
stm_aix("p1i0","p0i0",[0,"  Registro  ","","",-1,-1,0,"tepuy_sep_p_solicitud.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i0","p0i0",[0,"  Aprobación  ","","",-1,-1,0,"tepuy_sep_p_aprobacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i0","p0i0",[0,"  Anulacion   ","","",-1,-1,0,"tepuy_sep_p_anulacion.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
stm_aix("p0i4","p0i0",[0,"   Reportes   "]);
stm_bpx("p6","p1",[1,4,0,0,2,3,6,7]);
stm_aix("p1i0","p0i0",[0,"  Ejecución Presupuestaria   ","","",-1,-1,0,"tepuy_sep_r_solicitudes.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
