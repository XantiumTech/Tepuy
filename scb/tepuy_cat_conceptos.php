...
print "<td width=50  style=text-align:center>Código </td>";
print "<td width=450 style=text-align:center>Denominación</td>";
print "</tr>";
if ($ls_operacion=="BUSCAR")
   {
	 $ls_sql     = "SELECT codconmov,denconmov 
	                  FROM scb_concepto 
					 WHERE codconmov like '".$ls_codigo."' 
					   AND denconmov like '".$ls_denominacion."' ";
			   ...
			   while ($row=$io_sql->fetch_row($rs_data))
					 {
					   ...
					   print "<td width=50  style=text-align:center><a href=\"javascript: aceptar('$ls_codcon','$ls_dencon');\">".$ls_codcon."</a></td>";
					   print "<td width=450 style=text-align:left>".$ls_dencon."</td>";
					   print "</tr>";			
					 }
			 }
		  else
...
<script language="JavaScript">
  ...
  f.action="tepuy_cat_conceptos.php";
  f.submit();
  }
</script>
</html>
