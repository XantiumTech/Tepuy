...
class tepuy_sob_class_definicionesdocumentos
{
	var  $la_obra;
	var  $la_asignacion;
	var  $la_contrato;
	...
	function tepuy_sob_class_definicionesdocumentos(){}	
	...
	function uf_acta($as_codcon,$as_codact,$as_tipact)
	{
		//----------------Clases y Objetos--------------------------------------//
			...
			$this->io_obra=new tepuy_sob_class_obra();
			require_once("class_folder/tepuy_sob_c_acta.php");
			$this->io_acta=new tepuy_sob_c_acta();
			require_once("class_folder/tepuy_sob_c_supervisores.php");
			$this->io_supervisores=new tepuy_sob_c_supervisores();
