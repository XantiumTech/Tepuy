...
function ue_buscar()
{
	...
	window.open("tepuy_catdinamic_estprog3.php?codigo="+codigo1+"&txtdenestprog1="+deno1+"&codestprog2="+codigo2+"&txtdenestprog2="+deno2,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}
function ue_cerrar()
{
	f=document.form1;
