...
<script language="JavaScript">
        ...
        var loadDataURL = "../../php/tepuy_srh_a_personal.php?valor=createXML_permisos";
	...
	//initialise (from xml) and populate (from xml) grid
		function doOnLoad()
		{
			...
			mygrid.setHeader("Código,Fecha Inicio,Fecha Fin");
			mygrid.setInitWidths("100,205,205")
	...
	function aceptar(ls_numper,ls_feciniper,ls_fecfinper,ls_numdiaper,ls_afevacper,ls_tipper,ls_obsper,ls_remper,
				 ls_numperdestino,ls_feciniperdestino,ls_fecfinperdestino,ls_numdiaperdestino,ls_afevacperdestino,ls_tipperdestino,ls_obsperdestino,ls_remperdestino,ls_ejecucion)
	{
		  ...
		  obj7=eval("opener.document.form1."+ls_remperdestino+"");
		   if (ls_remper=='1')
		  {
		     obj7.checked=true;
		  }
