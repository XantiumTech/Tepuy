...
<table width="358" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  ...
  <tr>
    <td height="22" colspan="4" style="text-align:right"><a href="javascript:uf_procesar_asignacion();"><img src="../../shared/imagebank/tools20/ejecutar.png" alt="Procesar Asignaci&oacute;n..." width="20" height="20" border="0">Procesar Asignaci&oacute;n</a></td>
    </tr>
  <tr>
    <td height="13">&nbsp;</td>
    <td height="13">&nbsp;</td>
...
if ($ls_operacion=="")
   {
     ...
     $io_grid->makegrid($li_totrowche,$title,$object,520,'Asignación de Cheques a Usuarios',$grid);
   }
unset($la_cheques);
unset($la_usuarios);
unset($la_emitidos);
