...
//FORMATO ALCALDIA DE GUASDUALITO
		...
		$io_pdf->addText(184,118,6,"LCDO. JEAN CARLOS OROZCO"); // Agregar el título
		$io_pdf->addText(195,165,6,"JEFE DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(320,118,6,"LCDO. JOSE LUIS RODRIGUEZ"); // Agregar el título
		$io_pdf->addText(335,165,6,"ADMINISTRADOR"); // Agregar el título
//		$io_pdf->addText(440,122,7,"DESPACHO DEL ALCALDE"); // Agregar el título
