  ...
  <p align="center">
    <input name="operacion" type="hidden" id="operacion">
  	 ...
  	 <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    	<tr>
     	 	<td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Conceptos de Movimiento </td>
    	</tr>
	 </table>
	 <br>
...
{
	$ls_sql="SELECT * FROM scb_concepto_mov WHERE codconmov like '".$ls_codigo."' AND denconmov like '".$ls_denominacion."' AND codconmov<>'---'";
