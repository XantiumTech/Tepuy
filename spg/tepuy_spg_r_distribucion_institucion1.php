...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Portada de la Institución </td>
    </tr>
  </table>
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
      ...
      <td colspan="3" align="center"><div align="left">
          ...
          <!--DWLayoutTable-->
		    ...
		    <tr class="formato-blanco">
		      ...
		      <td width="136" height="18"><input name="concejal1" style="text-align:center" type="text" id="concejal1" value="<?php print $ls_concejal1 ?>" size="22" maxlength="20"></td>
	        </tr>
		    <tr class="formato-blanco">
            <td height="14"><div align="right">Vice-Presidente</div></td>
            <td height="22"><input name="concejal2" style="text-align:center" type="text" id="concejal2" value="<?php print $ls_concejal2 ?>" size="22" maxlength="20"></td>
            </tr>
    			<tr class="formato-blanco">
            <td height="14"><div align="right">Concejal</div></td>
            <td height="22"><input name="concejal3" style="text-align:center" type="text" id="concejal3" value="<?php print $ls_concejal3 ?>" size="22" maxlength="20"></td>
            </tr>
    			<tr class="formato-blanco">
            <td height="14"><div align="right">Concejal</div></td>
            <td height="22"><input name="concejal4" style="text-align:center" type="text" id="concejal4" value="<?php print $ls_concejal4 ?>" size="22" maxlength="20"></td>
            </tr>
    			<tr class="formato-blanco">
            <td height="14"><div align="right">Concejal</div></td>
            <td height="22"><input name="concejal5" style="text-align:center" type="text" id="concejal5" value="<?php print $ls_concejal5 ?>" size="22" maxlength="20"></td>
            </tr>
    <tr class="formato-blanco">
            <td height="14"><div align="right">Concejal</div></td>
            <td height="22"><input name="concejal6" style="text-align:center" type="text" id="concejal6" value="<?php print $ls_concejal6 ?>" size="22" maxlength="20"></td>
            </tr>
    <tr class="formato-blanco">
            <td height="14"><div align="right">Concejal</div></td>
            <td height="22"><input name="concejal7" style="text-align:center" type="text" id="concejal7" value="<?php print $ls_concejal7 ?>" size="22" maxlength="20"></td>
            </tr>
        </table>
           <p>
    ...
    <tr>
      <td height="22" colspan="3" align="center"><table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
            <tr class="formato-blanco">
            <td height="14"><div align="right">Director de Administración</div></td>
            <td height="22"><input name="director1" style="text-align:center" type="text" id="director1" value="<?php print $ls_director1 ?>" size="22" maxlength="20"></td>
            </tr>
	<tr class="formato-blanco">
            <td height="14"><div align="right">Director de Presupuesto</div></td>
            <td height="22"><input name="director2" style="text-align:center" type="text" id="director2" value="<?php print $ls_director2 ?>" size="22" maxlength="20"></td>
            </tr>
	<tr class="formato-blanco">
            <td height="14"><div align="right">Director de Personal</div></td>
            <td height="22"><input name="director3" style="text-align:center" type="text" id="director3" value="<?php print $ls_director3 ?>" size="22" maxlength="20"></td>
            </tr>
	<tr class="formato-blanco">
            <td height="14"><div align="right">Director de Des. Social</div></td>
            <td height="22"><input name="director4" style="text-align:center" type="text" id="director4" value="<?php print $ls_director4 ?>" size="22" maxlength="20"></td>
            </tr>
<tr class="formato-blanco">
            <td height="14"><div align="right">Director de Ingenieria</div></td>
            <td height="22"><input name="director5" style="text-align:center" type="text" id="director5" value="<?php print $ls_director5 ?>" size="22" maxlength="20"></td>
            </tr>
<tr class="formato-blanco">
            <td height="14"><div align="right">Director de Catastro</div></td>
            <td height="22"><input name="director6" style="text-align:center" type="text" id="director6" value="<?php print $ls_director6 ?>" size="22" maxlength="20"></td>
            </tr>
<tr class="formato-blanco">
            <td height="14"><div align="right">Director de Protección Civil</div></td>
            <td height="22"><input name="director7" style="text-align:center" type="text" id="director7" value="<?php print $ls_director7 ?>" size="22" maxlength="20"></td>
            </tr>
...
pagina="reportes/tepuy_spg_rpp_distribucio_sector_programa.php?;
		//  pagina="reportes/tepuy_spg_rpp_distribucion_institucion.php?combo="+"&concejal1="+conceja1
