<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_r_retencionesgeneral.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
function ue_print()
{
	...
	if(li_imprimir==1)
	{
		...
		if((fecdes!="")&&(fechas!=""))
		{
			...
			pagina="reportes/tepuy_cxp_rpp_retenciongeneral.php?fecdes="+fecdes+"&fechas="+fechas+"&tiporeporte="+tiporeporte;
