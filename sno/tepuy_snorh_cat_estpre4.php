<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print($as_codestprog1, $as_codestprog2, $as_codestprog3, $as_codestprog4, $as_denominacion, $as_tipo)
   	{
		//////////////////////////////////////////////////////////////////////////////
		//	   Function: uf_print
		...
		//////////////////////////////////////////////////////////////////////////////
		global $io_fun_nomina,$li_len1,$li_len2,$li_len3,$li_len4;
			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch($as_tipo)
				{
					case "":
						...
						print "<td width=30 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro4','$denominacion');\">".trim($ls_codestpro1)."</td>";
					...
					case "asignacioncargo":
						print "<tr class=celdas-blancas>";
						print "<td width=30 align=\"center\"><a href=\"javascript: aceptarasignacion('$ls_codestpro4','$denominacion');\">".trim($ls_codestpro1)."</td>";
						print "<td width=30 align=\"center\">".trim($ls_codestpro2)."</td>";
					...
					case "asignacionaporte":
						print "<tr class=celdas-blancas>";
						print "<td width=30 align=\"center\"><a href=\"javascript: aceptaraporte('$ls_codestpro4','$denominacion');\">".trim($ls_codestpro1)."</td>";
						print "<td width=30 align=\"center\">".trim($ls_codestpro2)."</td>";
						print "<td width=30 align=\"center\">".trim($ls_codestpro3)."</td>";
						print "<td width=30 align=\"center\">".trim($ls_codestpro4)."</a></td>";
						print "<td width=130 align=\"left\">".trim($denominacion)."</td>";
...
<?php
	...
	if($ls_operacion=="BUSCAR")
	{
		...
		uf_print($ls_codestprog1, $ls_codestprog2, $ls_codestprog3, $ls_codigo, $ls_denominacion, $ls_tipo);
	}
	else
	{
		$ls_codigo="%%";
...
function aceptar(codestprog4,deno)
{
...
function aceptarasignacion(codestprog4,deno)
{
	opener.document.form1.txtdenestpro4.value=deno;
	opener.document.form1.txtcodestpro4.value=codestprog4;
	opener.document.form1.txtcodestpro5.value="";
...
function aceptaraaporte(codestprog4,deno)
{
	opener.document.form1.txtdenestpro44.value=deno;
	opener.document.form1.txtcodestpro44.value=codestprog4;
...
function ue_search()
{
	...
	f.action="tepuy_snorh_cat_estpre4.php?tipo=<?PHP print $ls_tipo;?>";
	f.submit();
}
</script>
</html>
