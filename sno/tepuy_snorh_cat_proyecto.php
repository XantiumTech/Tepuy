<?php
   ...
   function uf_print($as_codproy, $as_nomproy, $as_tipo)
   {
		...
		$ls_sql="SELECT codemp, codproy, nomproy, estproproy, ".
				...
				"		    AND spg_ep1.codestpro1=substr(sno_proyecto.estproproy,1,20)) as denestpro1, ".
				"		(SELECT denestpro2 ".
				"		   FROM spg_ep2 ".
				"		  WHERE codemp=sno_proyecto.codemp".
				"		    AND spg_ep2.codestpro1=substr(sno_proyecto.estproproy,1,20) ".
				"		    AND spg_ep2.codestpro2=substr(sno_proyecto.estproproy,21,6)) as denestpro2, ".
				"		(SELECT denestpro3 ".
				"		   FROM spg_ep3 ".
				"		  WHERE codemp=sno_proyecto.codemp".
				"		    AND spg_ep3.codestpro1=substr(sno_proyecto.estproproy,1,20) ".
				"		    AND spg_ep3.codestpro2=substr(sno_proyecto.estproproy,21,6) ".
				"		    AND spg_ep3.codestpro3=substr(sno_proyecto.estproproy,27,3)) as denestpro3, ".
				"		(SELECT denestpro4 ".
				"		   FROM spg_ep4 ".
				"		  WHERE codemp=sno_proyecto.codemp".
				"		    AND spg_ep4.codestpro1=substr(sno_proyecto.estproproy,1,20) ".
				"		    AND spg_ep4.codestpro2=substr(sno_proyecto.estproproy,21,6) ".
				"		    AND spg_ep4.codestpro3=substr(sno_proyecto.estproproy,27,3) ".
				"		    AND spg_ep4.codestpro4=substr(sno_proyecto.estproproy,30,2)) as denestpro4, ".
				"		(SELECT denestpro5 ".
				"		   FROM spg_ep5 ".
				"		  WHERE codemp=sno_proyecto.codemp".
				"		    AND spg_ep5.codestpro1=substr(sno_proyecto.estproproy,1,20) ".
				"		    AND spg_ep5.codestpro2=substr(sno_proyecto.estproproy,21,6) ".
				"		    AND spg_ep5.codestpro3=substr(sno_proyecto.estproproy,27,3) ".
				"		    AND spg_ep5.codestpro4=substr(sno_proyecto.estproproy,30,2) ".
				"		    AND spg_ep5.codestpro5=substr(sno_proyecto.estproproy,32,2)) as denestpro5 ".
				"  FROM sno_proyecto ".
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch($as_tipo)
				{
					case "": // Se hace el llamado desde tepuy_snorh_d_proyecto.php
						...
						print "'$ls_denestpro3','$ls_denestpro4','$ls_denestpro5');\">".$ls_codproy."</a></td>";
						print "<td>".$ls_nomproy."</td>";
						print "<td align=center>".$ls_codest1.$ls_codest2.$ls_codest3.$ls_codest4.$ls_codest5."</td>";
						print "</tr>";			
						break;		
							
					case "personaproyecto": // Se hace el llamado desde tepuy_sno_d_personaproyecto.php
						print "<tr class=celdas-blancas>";
					...
					case "replisproydes": // Se hace el llamado desde tepuy_sno_r_listadoproyecto.php
						print "<tr class=celdas-blancas>";
					...
					case "replisproyhas": // Se hace el llamado desde tepuy_sno_r_listadoproyecto.php
						print "<tr class=celdas-blancas>";
...
function ue_aceptar(codproy,nomproy,codest1,codest2,codest3,codest4,codest5,denestpro1,denestpro2,denestpro3,denestpro4,denestpro5)
{
...
function ue_mostrar(myfield,e)
{
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_snorh_cat_proyecto.php?tipo=<?PHP print $ls_tipo;?>";
	  f.submit();
  }
</script>
</html>
