  ...
  <div align="center">
    <table width="539" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <a href="javascript:cat_scg();"><img src="../../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a>        <input name="txtdenominacion" type="text" class="sin-borde" id="txtdenominacion" size="48"></td>
      </tr>
      <tr>
        <td height="22">&nbsp;</td>
        ...
        <input name="codestpro5" type="hidden" id="codestpro5" value="<?php print $ls_codestpro5;?>"></td>
        <td height="22" colspan="4"><div align="right"><a href="javascript:ue_search();"><img src="../../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a> <a href="javascript:aceptar();"><img src="../../shared/imagebank/tools15/aprobado.png" width="15" height="15" border="0">Aceptar</a> </div></td>
      </tr>
    </table>
<br>
	<?php
...
if ($ls_operacion=="BUSCAR")
   {
	 ...
	 $ls_sql = "SELECT * FROM spg_cuentas                                                               ".
		       " WHERE codemp = '".$as_codemp."' AND spg_cuenta like '".$ls_codestpro."%'           AND ".
			   "       denominacion like '%".$ls_denestpro."%' AND sc_cuenta like '".$ls_codscg."%' AND ".
			   "       codestpro1 = '".$ls_codestpro1."'  AND codestpro2 = '".$ls_codestpro2."'     AND ".
			   "       codestpro3 = '".$ls_codestpro3."' $ls_cadena                                     ".
			   "ORDER BY spg_cuenta	                                                                    ";
	//print $ls_sql;
...
function ue_search()
{
	...
	f.action="tepuy_spg_cat_ctaspg.php";
	f.submit();
}
