...
////////////////////////////////////////////////FIN DE FUNCIONES //////////////////////////////////////////
	...
	$ls_fecsol1=$io_fun_cxp->uf_obtenervalor_get("ls_fecsol","");
	$ls_fecsol1=$io_funciones->uf_formatovalidofecha($ls_fecsol1);
	...
	if($lb_valido)
	{
		...
		else
		{
			...
			for ($li_z=0;($li_z<$li_totrow);$li_z++)
			{
				...
				$lb_valido=$io_report->uf_retenciones_del_proveedor_unificadas($ld_rif,$ls_mes,$ls_anio,$ls_numsol1,$ls_fecsol1);
