				...
				<tr class="formato-blanco">
				  ...
				  <td height="79" colspan="8" align="center" valign="top" class="sin-borde">				  <table width="500" height="78" border="0" cellpadding="0"  cellspacing="0" >
                    <tr class="formato-blanco">
                      ...
                      <td width="218"><input name="txtplacon"  style="text-align:center "  type="text" id="txtfecasi" value="<? print $ls_placon?> <? print $ls_placonuni?>" size="11" maxlength="11" readonly="true">
&nbsp;&nbsp;&nbsp;
                      </td>
                    </tr>
                    <tr class="formato-blanco">
				  ...
				  <tr class="formato-blanco">
					...
					<td height="135" colspan="8" align="center" valign="top" class="sin-borde">					<table width="500" height="110" border="0" cellpadding="0" cellspacing="0" id="detalleasignacion">
                      <tr class="formato-blanco">
                        ...
                        <td width="182"><input name="txtcodobr" id="txtcodobr" value="<? print $ls_codobr?>" readonly="true"  style="text-align:center "  type="text" size="6" ></td>
                        <td width="66"><div align="right"></div></td>
                        <td width="170">&nbsp;</td>
                      </tr>
                      <tr class="formato-blanco">
                        <td height="18"><div align="right">Descripci&oacute;n</div></td>
                        <td height="18" colspan="3"><input name="txtdesobr" type="text" id="txtdesobr" value="<? print $ls_desobr?>" size="70" readonly="true"></td>
                      </tr>
                      <tr class="formato-blanco">
                        <td height="18"><div align="right">Estado</div></td>
                        <td height="18"><input name="txtestobr" id="txtestobr3"   value="<? print $ls_estobr?>" readonly="true" type="text" size="20" maxlength="50" ></td>
                        <td height="18"><div align="right">Municipio</div></td>
                        <td height="18"><input name="txtmunobr" id="txtmunobr" value="<? print $ls_munobr?>"  readonly="true"  type="text" size="20" ></td>
                      </tr>
                      <tr class="formato-blanco">
                        <td height="18" valign="top"><div align="right">Parroquia</div></td>
                        <td height="18" valign="top"><input name="txtparobr" type="text" id="txtparobr"   value="<? print $ls_parobr?>" readonly="true"  size="20" maxlength="50" ></td>
                        <td height="18" valign="top"><div align="right">Comunidad</div></td>
                        <td height="18" valign="top"><input name="txtcomobr" id="txtcomobr"  value="<? print $ls_comobr?>" readonly="true"  type="text" size="20" ></td>
                      </tr>
                      <tr class="formato-blanco">
                        <td height="18" valign="top"><div align="right">Direcci&oacute;n</div></td>
                        <td height="18" colspan="3" valign="top"><input name="txtdirobr" id="txtdirobr"   value="<? print $ls_dirobr?>" readonly="true" type="text" size="70"></td>
                      </tr>
                    </table></td>
					<td height="135" class="sin-borde">&nbsp;</td>
				  </tr>
      ...
      <tr class="formato-blanco">
        ...
        <td width="85" height="39"><input name="txtfecact" type="text" id="txtfecact"  style="text-align:center" value="<? print $ls_fecact ?>" size="10" maxlength="10"  readonly="true"></td>
        <td height="39">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="26">&nbsp;</td>
        ...
        <td height="26"><input name="txtfecfinact"   type="text" id="txtfecfinact"  style="text-align:left" value="<? print $ls_fecfinact ?>" size="11" maxlength="10"   onBlur="javascript:ue_validafechacreacion();" readonly="true" datepicker="true"></td>
        <td height="26" colspan="3"><div align="right">Fecha de Reinicio Estimada</div></td>
        <td height="26"><input name="txtfeciniact"   type="text" id="txtfeciniact"  style="text-align:left" value="<? print $ls_feciniact ?>" size="11" maxlength="10"   onBlur="javascript:ue_validafechacreacion();" readonly="true" datepicker="true"></td>
        <td height="26">&nbsp;</td>
        <td height="26">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        ...
        <td height="25" colspan="6"><input name="txtnominsact" type="text"  style="text-align:right" id="txtmonto2" readonly="true" size="50" value="<? print $ls_nominsact?>" maxlength="50"> 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C&eacute;dula
        <input name="txtcedinsact" type="text" id="txtcedinsact" value="<? print $ls_cedinsact?>" size="10" maxlength="10">      
      ...
      <tr class="formato-blanco">
        ...
        <td height="28" colspan="6"><input name="txtnomsupact" type="text" id="txtnomsupact" value="<? print $ls_nomsupact?> " size="50" maxlength="50">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C&eacute;dula
        <input name="txtcedsupact" type="text" id="txtcedsupact" value="<? print $ls_cedsupact?>" size="10" maxlength="10"></td>
        <td height="28">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="24">&nbsp;</td>
        ...
        <td height="24" colspan="6"><input name="txtresact" type="text" id="txtresact" value="<? print $ls_resact?>" size="50" maxlength="50">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C&eacute;dula
        <input name="txtcedresact" type="text" id="txtcedresact" value="<? print $ls_cedresact?>" size="10" maxlength="10"></td>
        <td height="24">&nbsp;</td>
      </tr>	
      ...
      <tr class="formato-blanco">
        ...
        <td colspan="6"><textarea name="txtmotact" cols="47" rows="1" wrap="VIRTUAL" id="txtmotact"><? print $ls_motact;?></textarea></td>
        <td>&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td colspan="10">&nbsp;</td>
...
function ue_nuevo()
{
  ...
  if (ue_valida_null(f.txtcodcon,"Debe seleccionar un Contrato!!!")==true)
  {
	  ...
	  f.action="tepuy_sob_d_actaparalizacion.php";
	  f.submit();
  }	
}
/*function ue_buscar()
