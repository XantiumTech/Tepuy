<?php
	...
	$oi_fun_integrador->uf_load_seguridad("MIS","tepuy_mis_p_contabiliza_depreciacion_saf.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	if(li_ejecutar==1)
	{
		if((f.cmbmes.value!="00")&&(f.txtano.value!=""))
		{
			...
			if(lb_valido)
			{
				...
				f.action="tepuy_mis_p_contabiliza_depreciacion_saf.php";
				f.submit();
			}
			else
			{
