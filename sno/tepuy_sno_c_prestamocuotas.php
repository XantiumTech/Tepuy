<?php
class tepuy_sno_c_prestamocuotas
{
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_sno_c_prestamocuotas()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_sno_c_prestamocuotas
		//		   Access: public 
	...
	}// end function tepuy_sno_c_prestamocuotas
	//-----------------------------------------------------------------------------------------------------------------------------------
							 ...
							 $aa_seguridad)
	{
		...
		//		   Access : private (tepuy_sno_c_prestamo) 
    ...
    function uf_delete_cuota($as_codper,$as_codtippre,$ai_numpre,$ai_numcuo,$as_tipo,$aa_seguridad)
    {
		...
		//		   Access: public (tepuy_sno_c_prestamo) 
		//	    Arguments: as_codper  // Código del Personal
		//				   as_codtippre  // Código del tipo de Prestamo
		//				   ai_numpre  // Número Correlativo del Prestamo
