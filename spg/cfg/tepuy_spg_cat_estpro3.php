...
if ($ls_operacion=="BUSCAR")
   {
	 ...
	 $ls_sql="SELECT codestpro1,codestpro2,codestpro3,denestpro3,responsable,extordinal,tepuy_fuentefinanciamiento.codfuefin,tepuy_fuentefinanciamiento.denfuefin
				FROM spg_ep3,tepuy_fuentefinanciamiento
				WHERE spg_ep3.codfuefin=tepuy_fuentefinanciamiento.codfuefin ".
			 "AND spg_ep3.codemp='".$ls_codemp."'          AND codestpro1 ='".$ls_codestpro1."'       AND ".
			 "       codestpro2 ='".$ls_codestpro2."' AND codestpro3 like '%".$ls_codestpro3."%' AND ".
			 "       denestpro3 like '%".$ls_denestpro3."%'                                          ".
			 " ORDER BY codestpro3 ASC  
			                                                              ";
		 ...
		 for ($z=1;$z<=$totrow;$z++)
		     {
			   ...
			   $ls_responsable= $data["responsable"][$z];
			   $ls_extordinal= $data["extordinal"][$z];
			   ...
			   print "<td width=150 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3','$ls_responsable','$ls_extordinal','$ls_codfuefin','$ls_denfuefin');\">".trim($ls_codestpro1)."</td>";
			   print "<td width=100 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3','$ls_responsable','$ls_extordinal','$ls_codfuefin','$ls_denfuefin');\">".trim($ls_codestpro2)."</td>";
			   print "<td width=50 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3','$ls_responsable','$ls_extordinal','$ls_codfuefin','$ls_denfuefin');\">".trim($ls_codestpro3)."</a></td>";
...
function aceptar(ls_codestpro3,ls_denestpro3,ls_responsable,ls_extordinal,ls_codfuefin,ls_denfuefin,ls_pantalla)
{
	fop.txtcodestpro3.value    = ls_codestpro3;
	fop.txtcodestpro3.readOnly = true;
	fop.txtdenestpro3.value    = ls_denestpro3;
	fop.txtresponsable.value    = ls_responsable;
	fop.txtextordinal.value	   = ls_extordinal;
	ls_maestro                 = fop.hidmaestro.value; 
	ls_pantalla                = document.form1.txtpantalla.value
	if(ls_pantalla=='d_estprog3')
	{
...
function ue_search()
{
	...
	f.action="tepuy_spg_cat_estpro3.php";
	f.submit();
}
</script>
</html>
