...
///////////
	...
	$xa=$xa-10;
	$io_pdf->addText(55,$xa,10,"   <i><b>5.</b> Debe estar inscrito en el Servicio Nacional de Contratista y demás requisitos exigidos por Waryna C.A.</i>"); // Agregar titulo
	...
	function uf_print_pie($io_pdf)
	{
		...
		$io_pdf->addText(55,175,10,"<i>dia  habil  de  recibirla;   por  ante  la  Administración.    El  criterio  utilizado  para  la  adjudicacion  de  la  contratación </i>"); // Agregar titulo
		$io_pdf->addText(55,165,10,"<i>requerida,  sera  la  que  presenta  mejor  oferta  de  precios,  calidad y tiempo de entrega en cuanto a la totalidad del
 </i>"); // Agregar titulo
		$io_pdf->addText(55,155,10,"<i>material o servicio requerido. </i>"); // Agregar titulo
