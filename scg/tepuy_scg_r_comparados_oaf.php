<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","tepuy_scg_r_comparados_oaf.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<title>Comparado - Origen y Aplicacion de Fondos</title>
...
if(array_key_exists("operacion",$_POST))
{
	...
	$ls_agno=$_POST["cmbagno"];
}
else
{
	$ls_operacion="";
	$ls_agno=substr($_SESSION["la_empresa"]["periodo"],0,4);	
}
...
?>		  
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Comparado - Origen y Aplicacion de Fondos </td>
    </tr>
  </table>
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr style="display:none">
      ...
      <td width="397" height="17" align="center"><div align="left">
    ...
    <tr>
      <td height="17" colspan="3" align="center"><div align="left"><span class="Estilo2"></span>
        <table width="550" height="34" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="4"><strong class="titulo-celdanew">Rango de Emisi&oacute;n </strong></td>
          </tr>
          <tr>
            <td width="102" height="21"><div align="right">Nivel </div>              <div align="right"></div>              <div align="right"></div>              <div align="left"></div>              <div align="left"></div></td>
            ...
            <td width="90"><div align="right">A&ntilde;o</div></td>
            <td width="224"><div align="left">
              <select name="cmbagno" id="cmbagno">
                <option value="2000" <?php print $lb_2000;?>>2000</option>
                <option value="2001" <?php print $lb_2001;?>>2001</option>
                <option value="2002" <?php print $lb_2002;?>>2002</option>
                <option value="2003" <?php print $lb_2003;?>>2003</option>
                <option value="2004" <?php print $lb_2004;?>>2004</option>
                <option value="2005" <?php print $lb_2005;?>>2005</option>
                <option value="2006" <?php print $lb_2006;?>>2006</option>
                <option value="2007" <?php print $lb_2007;?>>2007</option>
                <option value="2008" <?php print $lb_2008;?>>2008</option>
                <option value="2009" <?php print $lb_2009;?>>2009</option>
                <option value="2010" <?php print $lb_2010;?>>2010</option>
              </select>
            </div></td>
          </tr>
        </table>
        ...
        <table width="550" height="84" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="67" height="21"><div align="right">
                <input name="botmensual" type="button" class="boton" id="botmensual" value="Mensual" onClick="uf_cargar_combo('MENSUAL')">
            </div></td>
...
function ue_showouput()
{
	...
	{	
		...
		ls_agno = f.cmbagno.value;
		li_nivel= f.cmbnivel.value;
		...
		if(txtetiqueta=="Mensual")
		{
			...
			else
			{
				...
				{
				   pagina="reportes/tepuy_scg_rpp_comparado_oaf.php?combo="+combo
						   +"&combomes="+combomes+"&txtetiqueta="+txtetiqueta+"&nivel="+li_nivel+"&agno="+ls_agno+"&tiporeporte="+tiporeporte;
		...
		else
		{
			...
			{
			   pagina="reportes/tepuy_scg_rpp_comparado_oaf.php?combo="+combo+"&txtetiqueta="+txtetiqueta+"&nivel="+li_nivel+"&agno="+ls_agno+"&tiporeporte="+tiporeporte;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
   	}
