...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_listadochequeras.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
  ...
  <table width="570" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td height="22" style="text-align:left"><input name="txtchequera" type="text" id="txtchequera" size="24" maxlength="15" style="text-align:center" readonly="true">
        <a href="javascript:cat_cheque();"><img src="../shared/imagebank/tools15/buscar.png" alt="Cat&aacute;logo de Cheques" width="15" height="15" border="0"></a></td>
    </tr>
    <tr>
  ...
  if (li_imprimir==1)
     {
       if ((ls_codban!="")&&(ls_cuenta!="")&&(ls_chequera!=""))
		  {
			pagina="reportes/tepuy_scb_rpp_listado_chequeras_pdf.php?codban="+ls_codban+"&cuenta="+ls_cuenta+"&chequera="+ls_chequera+"&nomban="+ls_nomban+"&tiporeporte="+ls_tiporeporte;
	...
	function cat_cheque()
  	{
	   ...
	   {
	   	   pagina="tepuy_cat_chequera.php?codban="+ls_codban+"&nomban="+ls_nomban+"&cuenta="+ls_ctaban+"&nomcuenta="+ls_nomcta;
