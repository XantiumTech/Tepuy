...
$io_fun_ingreso->uf_load_seguridad("SPI","tepuy_spi_r_listado_apertura.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		{
		   pagina="reportes/tepuy_spi_rpp_listado_apertura.php?txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas+"&tiporeporte="+ls_tiporeporte;
