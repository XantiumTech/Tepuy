...
class tepuy_srh_c_grupomovimiento
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_srh_c_grupomovimiento($path)
...
function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_d_grupomovimiento)
		//      Argumento: 
	...
	function uf_srh_select_grupomovimiento($as_codgrumov)
	{
		...
		//         Access: public (tepuy_srh_d_grupomovimientos)
...
}// end   class tepuy_srh_c_grupomovimiento
?>