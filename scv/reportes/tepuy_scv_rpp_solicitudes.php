	...
	function uf_print_detalle_asignaciones($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('proasi'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
						 			   ...
						 			   'denasi'=>array('justification'=>'left','width'=>260), // Justificación y ancho de la columna
						 			   'monasi'=>array('justification'=>'right','width'=>70), // Justificación y ancho de la columna
...
//			$li_numdia= $io_report->ds->data["numdiavia"][$li_i];
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$li_monasi= $io_report->ds_detalle->data["monto"][$li_s];
					$li_canasi= $io_report->ds_detalle->data["canasi"][$li_s];

					$li_canasi=number_format($li_canasi,2,",",".");
					$li_monasi=number_format($li_monasi,2,",",".");
					$la_data_asig[$li_s]=array('proasi'=>$ls_proasi,'codasi'=>$ls_codasi,'denasi'=>$ls_denasi,'monasi'=>$li_monasi,'canasi'=>$li_canasi);
				}
