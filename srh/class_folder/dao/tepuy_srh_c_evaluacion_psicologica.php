...
class tepuy_srh_c_evaluacion_psicologica
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_evaluacion_psicologica($path)
	{   
...
function uf_srh_guardarevaluacion_psicologica ($ao_evaluacion,$as_operacion="insertar", $aa_seguridad)
  { 
		...
		//         access: public (tepuy_srh_evaluacion_psicologica)	
...
function uf_srh_guardar_dt_evaluacion_psicologica($ao_evaluacion, $aa_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_evaluacion_psicologica)														
...
}// end   class tepuy_srh_c_evaluacion_psicologica
?>
