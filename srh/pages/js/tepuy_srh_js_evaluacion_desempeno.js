...
var url= "../../php/tepuy_srh_a_evaluacion_desempeno.php";
var metodo='get';
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_p_evaluacion_desempeno.php";  
  f.submit(); 
}
...
function Consultar()
{
	 ...
	 else if  (!ue_comparar_fechas($('txtfecini').value,$('txtfecfin').value,$('txtfecfin'))) 
	{
	 ...
	 else 
	 {
		  ...
		  f.action="../pantallas/tepuy_srh_p_evaluacion_desempeno.php";
		  f.existe.value="TRUE";			
		  f.submit();	
	 }
}
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_evaluacion_desempeno.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
