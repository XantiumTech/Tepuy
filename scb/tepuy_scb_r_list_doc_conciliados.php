...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_list_doc_conciliados.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
  ...
  if (li_imprimir=='1')
     {
       if(f.chkcontabili.checked)
		  ...
		  {
			   pagina="reportes/tepuy_scb_rpp_list_doc_conciliados.php?fecdesde="+ls_fecdesde+"&fechasta="+ls_fechasta+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&orden="+ls_orden+"&denban="+ls_denban+"&dencta="+ls_dencta+"&codope="+ls_codope+"&estatus="+ls_estatus+"&tiporeporte="+ls_tiporeporte;
