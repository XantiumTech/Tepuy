<?php
class tepuy_sme_c_proveedor
 {
    var $ls_sql="";
	var $la_emp;
	var $io_msg_error;
	
	function tepuy_sme_c_proveedor()
	{
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		  $lb_valido=false;
	      $this->is_msg_error="CLASE->tepuy_sme_c_proveedor; METODO->uf_select_validar_rif; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);
	   }
	else
	   {
  ...
  if ($this->uf_select_validar_rif($as_codemp,$ls_rif))
	 ...
	 " '".$ls_banco."','".$ls_cuenta."','".$ls_moneda."','".$ls_contable."','".$ls_contablecomp."','".$ls_observacion."',                  ".
	  ...
	  if ($rs_data===false)
	     { 
		   $lb_valido=false;
		   $this->is_msg_error="CLASE->tepuy_sme_c_proveedor; METODO->uf_insert_proveedor; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);
		 }
	  else
	     { 
		   $lb_valido=true;
...
if ($rs_data===false)
   {  
     $lb_valido=false;
     $this->is_msg_error="CLASE->tepuy_sme_c_proveedor; METODO->uf_update_proveedor; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);
   }
else
   {  
	   $lb_valido=true;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {		 
		  $this->is_msg_error="CLASE->tepuy_sme_c_proveedor; METODO->uf_select_proveedor_sep; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);	   
		  $lb_valido=false;
	   }
	else
	   {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		  $this->is_msg_error="CLASE->tepuy_sme_c_proveedor; METODO->uf_select_proveedor_soc; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);	   		 
		  $lb_valido=false;
	   }
	else
	   {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		 $this->is_msg_error="CLASE->tepuy_sme_c_proveedor; METODO->uf_select_proveedor_cxp; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);	   
		 $lb_valido=false;
	   }
	else
	   {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		  $this->is_msg_error="CLASE->tepuy_sme_c_proveedor; METODO->uf_select_proveedor_scb; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);	   		 
		  $lb_valido=false;
	   }
	else
	   {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		  $this->is_msg_error="CLASE->tepuy_sme_c_proveedor; METODO->uf_select_proveedor_sno; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);	   		 
		  $lb_valido=false;
	   }
	else
	   {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   { 
			...
			{ 
				 ...
				 {
					  $lb_valido = false;
					  $this->io_msg->message("CLASE->tepuy_sme_c_proveedor; METODO->uf_delete_proveedor; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
				 }
			}
			else
			{
 ...
 if ($this->uf_select_proveedor($as_codemp,$as_codpro))
    {
      ...
      if ($rs_data===false)
	     { 
           $lb_valido = false;
		   $this->io_msg->message("CLASE->tepuy_sme_c_proveedor; METODO->validar_delete(rpc_docxprov); ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		 }
 	  else
	     {
		   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
      ...
      if ($lb_valido)
	     {
		   ...
		   if ($rs_data===false)
	      	  {  
		        $lb_valido = false;
		        $this->io_msg->message("CLASE->tepuy_sme_c_proveedor; METODO->validar_delete(rpc_clasixprov); ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		      }
 		   else
		      {
		        /////////////////////////////////         SEGURIDAD               /////////////////////////////		
      ...
      if ($lb_valido)
	     {
			...
			{
				$lb_valido=false;
				$this->io_msg->message("CLASE->tepuy_sme_c_proveedor MÉTODO->validar_delete ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message)); 
			}
			else
			{
				/////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		 $lb_valido = false;
		 $this->io_msg->message("CLASE->tepuy_sme_c_proveedor; METODO->uf_select_llenarcombo_banco; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	  {
	   	$li_numrows = $this->io_sql->num_rows($rs_data);	   
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		 $lb_valido = false;
		 $this->io_msg->message("CLASE->tepuy_sme_c_proveedor; METODO->uf_select_llenarcombo_tipoorganizacion; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	  {
	   	$li_numrows = $this->io_sql->num_rows($rs_data);	   
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		 $lb_valido = false;
		 $this->io_msg->message("CLASE->tepuy_sme_c_proveedor; METODO->uf_select_llenarcombo_especialidad; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	  {
	   	$li_numrows = $this->io_sql->num_rows($rs_data);	   
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
		 $lb_valido = false;
		 $this->io_msg->message("CLASE->tepuy_sme_c_proveedor; METODO->uf_select_llenarcombo_moneda; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	  {
	   	$li_numrows = $this->io_sql->num_rows($rs_data);	   
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
	     $lb_valido = false;
	     $this->io_msg->message("CLASE->tepuy_sme_c_proveedor; METODO->uf_load_paises; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
	     $li_numrows = $this->io_sql->num_rows($rs_data);	   
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
	     $lb_valido = false;
	     $this->io_msg->message("CLASE->tepuy_sme_c_proveedor; METODO->uf_load_estados; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
	     $li_numrows = $this->io_sql->num_rows($rs_data);	   
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
	     $lb_valido = false;
	     $this->io_msg->message("CLASE->tepuy_sme_c_proveedor; METODO->uf_load_municipios; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
	     $li_numrows = $this->io_sql->num_rows($rs_data);	   
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
	     $lb_valido = false;
	     $this->io_msg->message("CLASE->tepuy_sme_c_proveedor; METODO->uf_load_parroquias; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
	     $li_numrows = $this->io_sql->num_rows($rs_data);	   
