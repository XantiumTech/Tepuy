...
class tepuy_srh_c_tiporequerimiento
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_srh_c_tiporequerimiento($path)
...
function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_d_tiporequerimiento)
		//      Argumento: 
	...
	function  uf_srh_insert_tiporequerimiento($as_codtipreq,$as_dentipreq,$aa_seguridad)
	{
		...
		//         tipreqess: public (tepuy_siv_d_tipoarticulo)
		//      Argumento: $as_codtipreq   // codigo del tipo de requerimiento
...
}// end   class tepuy_srh_c_tiporequerimiento
?>
