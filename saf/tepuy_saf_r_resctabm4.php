...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_resctabm4.php",$ls_permisos,$la_seguridad,$la_permisos);
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				window.open("reportes/tepuy_saf_rpp_resctabm4.php?coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&coduniadm="+ls_coduniadm+"&denuniadm="+ls_denuniadm+"&tipoformato="+tipoformato+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="tepuy_siv_r_resctabm4.php";
				//f.submit();
			}
			else
