...
class tepuy_srh_c_necesidad_adiestramiento
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_necesidad_adiestramiento($path)
	{  
...
function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_p_necesidad_adiestramiento)
		//      Argumento: 
...
function uf_srh_guardar_necesidad_adiestramiento ($ao_necesidad,$ps_operacion="insertar", $aa_seguridad)
  { 
	...
	{ $this->io_sql->begin_transaction();
	  ...
	  $ls_sql = "INSERT INTO srh_necesidad_adiestramiento (nroreg, fecha, comptec, objadi, estadi, obsadi, areadi, codemp) ".	  
	            "VALUES ('$ao_necesidad->nroreg','$ao_necesidad->fecha','$ao_necesidad->comptec', '$ao_necesidad->obj', '$ao_necesidad->estra', '$ao_necesidad->obs', '$ao_necesidad->area','".$this->ls_codemp."')";
...
function uf_srh_buscar_necesidad_adiestramiento($as_nroreg,$as_fecha1,$as_fecha2)
	{
		...
		//         access: public (tepuy_srh_necesidad_adiestramiento)												
		//      Argumento: $as_nroreg   //  código de la necesidad de adiestramiento
...
}// end   class tepuy_srh_c_necesidad_adiestramiento
?>
