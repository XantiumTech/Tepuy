...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_p_procesar_no_contabilizables.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<!--  <tr>
  ...
  <tr>
    <td class="toolbar" width="21"><a href="javascript:uf_nuevo();"><img src="../shared/imagebank/tools20/nuevo.png" alt="Nuevo" title="Nuevo" width="20" height="20" border="0"></a></td>
    <td class="toolbar" width="24"><div align="center"><a href="javascript: ue_cerrar();"></a><a href="javascript:uf_procesar_documentos();"><img src="../shared/imagebank/tools20/ejecutar.png" alt="Procesar" title="Procesar" width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="29"><div align="center"><a href="tepuywindow_blank"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" title="Salir" width="20" height="20" border="0"></a></div></td>
...
require_once("tepuy_scb_c_procesar_no_contabilizables.php");

$io_msg    = new class_mensajes();
$io_grid   = new grid_param();
$io_banco  = new class_funciones_banco();
$io_noncon = new tepuy_scb_c_procesar_no_contabilizables();
...
?>
<p>&nbsp;</p>
<form name="form1" method="post" action="" id="tepuy_scb_p_procesar_no_contabilizables.php">
<?php
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
  ...
  <table width="496" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td height="22" colspan="3"><label>
        ...
        <a href="javascript:uf_catalogo_banco();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar Banco..." border="0"></a> 
    ...
    <tr>
      ...
      <td height="22" colspan="3"><label>
        ...
        <a href="javascript:uf_catalogo_cuenta_banco();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar Cuenta Bancaria..." width="15" height="15" border="0"></a> 
    ...
    <tr>
      <td height="22" colspan="4"><div align="right"><a href="javascript:ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar Documentos..." width="20" height="20" border="0">Buscar Documentos</a></div></td>
    </tr>
    <tr>
...
function uf_nuevo()
{
  ...
  f.action          = "tepuy_scb_p_procesar_no_contabilizables.php";
  f.submit();
}
