<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_r_retencionesdeclaracionislr.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<html>
<head>
<title>Declaraci&oacute;n Informativa de Retenciones I.S.L.R.</title>
...
<?php
	...
	switch ($ls_operacion) 
	{
		case "GENERARXML":
			...
			$lb_valido=$io_reporte->uf_declaracioninformativaislr($ls_mes,$ls_anio,$la_seguridad,$nombredelarchivoxml);
			if($lb_valido)
			{
				$io_reporte->io_mensajes->message("El Archivo XML fué generado con el nombre: ".$nombredelarchivoxml);
			}
			else
			{
...
<!--  <tr>
  ...
  <tr>
    <td height="20" width="25" class="toolbar"><div align="center"><a href="javascript: ue_imprimir();"><img src="../shared/imagebank/tools20/impresora.gif" alt="Imprimir Libro XML" width="21" height="20" border="0" title="Imprimir Libro XML"></a></div></td>
    <td class="toolbar" width="25"><div align="center"><a href="javascript: ue_generarxml();"><img src="../shared/imagebank/tools20/gendisk.png" alt="Generar XML" width="20" height="20" border="0" title="Generar XML"></a></div></td>
    <td class="toolbar" width="25"><div align="center"><a href="javascript: ue_descargar();"><img src="../shared/imagebank/tools20/download.png" alt="" width="20" height="20" border="0" title="Descargar XML"></a></div></td>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="4" align="center">Declaraci&oacute;n Informativa de Retenciones de ISLR </td>
    </tr>
    <tr>
...
function ue_generarxml()
{
	f=document.formulario;
	f.operacion.value="GENERARXML";
	f.action="tepuy_cxp_r_retencionesdeclaracionislr.php";
	f.submit();	  
}
