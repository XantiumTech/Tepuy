...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Contabilidad Presupuestario de Ingreso -> Configuración</td>
...
<!--  <tr>
    <td height="30" bgcolor="#E7E7E7" class="cd-menu"><script type="text/javascript" language="JavaScript1.2" src="js/menu.js"></script></td>
  </tr> -->
  <tr>
    <td height="30" class="toolbar">&nbsp;</td>
  </tr>
  <tr>
    <td height="32" class="toolbar"><div align="left"><a href="javascript: ue_nuevo();"><img src="../../shared/imagebank/tools20/nuevo.png" alt="Nuevo" width="20" height="20" border="0"></a><a href="javascript: ue_guardar();"><img src="../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0"></a><a href="javascript: ue_buscar();"><img src="../../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"></a><a href="javascript: ue_eliminar();"><img src="../../shared/imagebank/tools20/eliminar.png" alt="Eliminar" width="20" height="20" border="0"></a><a href="javascript: ue_imprimir();"><img src="../../shared/imagebank/tools20/imprimir.png" alt="Imprimir" width="20" height="20"><a href="javascript: ue_cerrar();"><img src="../../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a><img src="../../shared/imagebank/tools20/ayuda.png" alt="Ayuda" width="20" height="20"></div>      <div align="center"></div>      <div align="center"></div>      <div align="center"></div></td>
  </tr>
</table>
<?php
	...
	require_once("class_folder/tepuy_spi_c_planctas.php");
	require_once("../../shared/class_folder/grid_param.php");
	
	$io_grid    = new grid_param();
	$io_fun     = new class_funciones();
	$io_msg     = new class_mensajes();
	$sig_spicta = new tepuy_spi_c_planctas();
	...
	$ls_sistema     = "SPI";
	$ls_ventanas    = "tepuy_spi_d_planctas.php";
...
if  (array_key_exists("status",$_POST))
	...
	$ls_formato    = $dat["formspi"];
	$ls_formatoaux = str_replace( "-", "",$ls_formato);
	$li_size_cta   = strlen(trim($ls_formatoaux));
	  ...
	  for ($i=1;$i<=$total;$i++)
		  {
			...
			$object[$i][1]="<input type=text name=txtcuentaspi".$i." value='' id=txtcuentaspi".$i."  class=sin-borde style=text-align:center size=20 maxlength=".$li_size_cta." onKeyPress=return keyRestrict(event,'1234567890'); onBlur=javascript:uf_rellenar_cuenta('".$li_size_cta."','".$i."');>";		
...
////////////////////////////////////////////////// G U A R D A R///////////////////////////////////////////////////////////////////
	if($ls_operacion=="GUARDAR")
	{
		...
		for($i=1;$i<=$total;$i++)
		{
			...
			$object[$i][1]="<input type=text name=txtcuentaspi".$i." value='".$ls_cuentaspi."' class=sin-borde style=text-align:center size=20 maxlength=".$li_size_cta." onKeyPress=\"return keyRestrict(event,'1234567890');\" onBlur=javascript:uf_rellenar_cuenta('".$li_size_cta."','".$total."');>";		
	...
	if($ls_operacion=="DELETE")
	{
		...
		for($i=1;$i<=$total;$i++)
		{
			...
			{
				$li_temp=$li_temp+1;
				$object[$li_temp][1]="<input type=text name=txtcuentaspi".$li_temp." value='".$ls_cuentaspi."' class=sin-borde style=text-align:center size=20 maxlength=".$li_size_cta." onKeyPress=\"return keyRestrict(event,'1234567890');\" onBlur=javascript:uf_rellenar_cuenta('".$li_size_cta."','".$total."');>";		
		...
		$object[$total][1]="<input type=text name=txtcuentaspi".$total." value='".$ls_cuentaspi."' class=sin-borde style=text-align:center size=20 maxlength=".$li_size_cta." onKeyPress=\"return keyRestrict(event,'1234567890');\" onBlur=javascript:uf_rellenar_cuenta('".$li_size_cta."','".$total."');>";		
  ...
  <tr>
    ...
    <td colspan="2">&nbsp;</td>
            ...
            <tr class="formato-blanco">
              ...
              <div align="left"> &nbsp;<a href="javascript: uf_agregar_cuentas();"><img src="../../shared/imagebank/tools20/nuevo.png" width="20" height="2" border="0">Agregar Cuentas </a><a href="javascript:uf_delete_all();"><img src="../../shared/imagebank/tools20/deshacer.png" alt="Borrar todas las cuentas" width="20" height="2" border="0"></a><a href="javascript:uf_delete_all();">Borrar Todas</a> </div>
                </td>
            </tr>
            <tr class="formato-blanco">
              <td height="20" colspan="2"><p align="center">
...
function ue_nuevo()
{
  ...
  if (li_incluir==1)
	 {	
	   ...
	   f.action="tepuy_spi_d_planctas.php";
	   f.submit();
	 }
  else
     {
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
	      window.open("tepuy_spi_cat_ctaspi.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=50,top=50,location=no,resizable=yes");
       }
    else
 	   {
 	     alert("No tiene permiso para realizar esta operación");
...
function cat_plan(fila)
{
	...
	{
		window.open("tepuy_sel_scg_plancuentaspi.php?fila="+fila,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
...
function ue_imprimir()
{
	...
	if (li_leer==1)
	   {
	      window.open("../../spg/reportes/tepuy_spg_rpp_distribucion_ingresos.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=50,top=50,location=no,resizable=yes");
       }
    else
 	   {
 	     alert("No tiene permiso para realizar esta operación");
...
function  uf_agregar_cuentas()
{
	...
	ls_pagina = "tepuy_sel_ctaspi.php?lastrow="+li_last+"&cuentas="+ls_cuentas;
