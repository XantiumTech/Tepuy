...
<?php 
require_once("class_folder/tepuy_rpc_c_clasificaci.php");
...
$io_clasificacion= new tepuy_rpc_c_clasificaci($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="RPC";
	$ls_ventanas="tepuy_rpc_d_clasificacion.php";
...
function ue_nuevo()
{
   ...
   {			 
	  ...
	  f.action="tepuy_rpc_d_clasificacion.php";
	  f.submit();
   }
   else
   {
...
function ue_buscar()
{
	...
	{
		f.operacion.value="";			
		pagina="tepuy_rpc_cat_clasificacion.php";
