...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_distribucion_proyectos.php";
...
<title>RESUMEN DEL PRESUPUESTO DE GASTOS POR  PARTIDA</title>
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">RELACION GLOBAL DE PROYECTOS<br>
      FINANCIADOS</td>
    </tr>
  </table>
      ...
      <td height="40" colspan="3" align="center">      <div align="left">
        <table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="4"><strong class="titulo-celdanew">Tipo de Financiamiento </strong></td>
            </tr>
          <tr>
            ...
            <td width="223" height="23"><select name="cmbnivel" id="cmbnivel">
              ...
              <option value="1">Proyectos Presupuesto Ordinario</option>
              <option value="2">Proyectos FIDES</option>
              <option value="3">Proyectos LAEE</option>
              </select></td>
            <td width="223">&nbsp;</td>
            <td width="446">&nbsp;</td>
          </tr>
...
function ue_showouput()
{
	...
	pagina="reportes/tepuy_spg_rpp_distribucion_proyectos.php?combo="+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato;
