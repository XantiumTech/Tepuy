<?php
	...
	$oi_fun_integrador->uf_load_seguridad("MIS","tepuy_mis_p_reverso_mp_spi.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
		...
		case "PROCESAR":
			...
			for($li_i=1;$li_i<=$li_totrows;$li_i++)
			{
				if(array_key_exists("chksel".$li_i,$_POST))
				{
					...
					if($lb_valido)
					{
						$in_class->io_msg->message("Modificación  ".$ls_comprobante." fue Reversada la Aprobación.");
					}
					else
					{
						$in_class->io_msg->message("No se pudo Reversar la Aprobación de la modificación ".$ls_comprobante);
					}		
				}
			}
			uf_limpiarvariables();
...
?>		  
    ...
    <table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr class="titulo-ventana">
        <td colspan="2">Reverso de Contabilizaci&oacute;n de Modificaciones Presupuestarias de Ingreso </td>
      </tr>
      <tr>
...
function ue_procesar()
{
	...
	if(li_ejecutar==1)
	{
		...
		if(lb_valido)
		{
			...
			f.action="tepuy_mis_p_reverso_mp_spi.php";
			f.submit();
		}
		else
		{
