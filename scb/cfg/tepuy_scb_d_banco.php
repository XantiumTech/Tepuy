...
?>
          ...
          <table width="566" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              ...
              <tr class="formato-blanco">
                ...
                <td height="22" colspan="2"><div align="left">
                  <input name="txtnombre" type="text" id="txtnombre" style="text-align:left" value="<?php print $ls_nombre?>" size="65" maxlength="60" onKeyPress="return keyRestrict(event,'abcdefghijklmnñopqrstuvwxyz ');">
                </div></td>
              </tr>
              ...
              <tr class="formato-blanco">
                ...
                <td height="22" colspan="2" align="left"><div align="left">
                  <input name="txtdireccion" type="text" id="txtdireccion" value="<?php print $ls_direccion;?>" size="82" maxlength="80" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+'.,-');">
                </div></td>
              </tr>
              <tr class="formato-blanco">
                <td height="22"><div align="right">Gerente</div></td>
                <td height="22" colspan="2" align="left"><div align="left">
                  <input name="txtgerente" type="text" id="txtgerente" value="<?php print $ls_gerente;?>" size="65" maxlength="60" onKeyPress="return keyRestrict(event,'abcdefghijklmnñopqrstuvwxyz '+'.,-');">
                </div></td>
              </tr>
            <tr class="formato-blanco">
