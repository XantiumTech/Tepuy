...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_separador_contenido.php";
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">SEPARADOR DE CONTENIDO<br>
      </td>
    </tr>
  </table>
      ...
      <td height="40" colspan="3" align="center">      <div align="left">
        <table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="4"><strong class="titulo-celdanew">Contenido </strong></td>
            </tr>
          <tr>
            <td width="100"><div align="right"><span class="style1 style14">Información</span></div></td>
            <td width="223" height="23"><select name="cmbnivel" id="cmbnivel">
              <option value="s1">Todas</option>
              <option value="01">Disposiciones Generales</option>
              <option value="02">Presupuesto de Ingresos</option>
              <option value="03">Presupuesto de Egresos</option>
              </select></td>
            <td width="223">&nbsp;</td>
            <td width="446">&nbsp;</td>
          </tr>
...
function ue_showouput()
{
	...
	pagina="reportes/tepuy_spg_rpp_separador_contenido.php?combo="+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato;
