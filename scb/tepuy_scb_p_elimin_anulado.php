...
<html>
<head>
<title>Eliminaci&oacute;n de Cheques Anulados</title>
...
<body>
  ...
  require_once("tepuy_scb_c_elimin_anulado.php");  
  require_once("tepuy_scb_c_movbanco.php");  

  $io_grid = new grid_param();
  $in_class_contabiliza = new tepuy_scb_c_elimin_anulado();
  ...
  $ls_logusr  = $_SESSION["la_logusr"];
	$ls_sistema="SCB";
	$ls_ventanas="tepuy_scb_p_elimin_anulado.php";
  ...
  /* end Scrip Seguridad */
  $in_movbco = new tepuy_scb_c_movbanco($la_security);
...
if (($ls_permisos)||($ls_logusr=="PSEGIS"))
{
	...
	print("<input type=hidden name=leer     id=permisos value='$la_permisos[leer]'>");
	print("<input type=hidden name=incluir  id=permisos value='$la_permisos[incluir]'>");
	print("<input type=hidden name=cambiar  id=permisos value='$la_permisos[cambiar]'>");
	print("<input type=hidden name=eliminar id=permisos value='$la_permisos[eliminar]'>");
	print("<input type=hidden name=imprimir id=permisos value='$la_permisos[imprimir]'>");
	print("<input type=hidden name=anular   id=permisos value='$la_permisos[anular]'>");
	print("<input type=hidden name=ejecutar id=permisos value='$la_permisos[ejecutar]'>");
}
else
{
	print("<script language=JavaScript>");
...
?>	
  ...
  <table width="502" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr class="titulo-ventana">
      <td height="22" colspan="4">Eliminaci&oacute;n de Cheques Anulados</td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    <tr>
      <td width="68"><div align="right">Documento</div></td>
      ...
      <td width="101"><div align="left">
        <input name="txtfecha" type="text" id="txtfecha" style="text-align:center" onKeyPress="currencyDate(this);return keyRestrict(event,'1234567890');" value="<?php print $ld_fecha;?>" size="15" maxlength="10"   datepicker="true">
      </div></td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;
        <div align="left"><img src="../shared/imagebank/tools15/buscar.png" alt="Busqueda" width="15" height="15"><a href="javascript:uf_cambio_operacion();">Buscar</a></div></td>
    </tr>
    <tr>
	...
	if(li_ejecutar==1)
	{
		if(confirm("Está seguro de eliminar este(os) registro(s)?\n  Esta operación no puede reversarse"))
		{
			f.operacion.value ="PROCESAR";
  		    f.action="tepuy_scb_p_elimin_anulado.php";
			f.submit();
		}
	}
	else
