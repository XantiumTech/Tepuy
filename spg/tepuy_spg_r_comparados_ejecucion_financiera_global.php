...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_comparados_ejecucion_financiera_global.php";
...
<title>Reporte  Comparados de Ejecuci&oacute;n F&iacute;sica y Financiera (RESUMEN GLOBAL)</title>
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" height="13" colspan="2" class="titulo-ventana"><p>EJECUCI&Oacute;N F&Iacute;SICA Y FINANCIERA DEL PRESUPUESTO DE GASTOS (RESUMEN GLOBAL)<br>      
        </p></td>
    </tr>
  </table>
...
<input name="botbimensual" type="button" class="boton" id="botbimensual" value="Bi - Mensual" onClick="uf_cargar_combo('BIMENSUAL')">
    ...
    <tr>
      <td height="64" colspan="3" align="center"><table width="542" height="63" border="0" align="center" cellpadding="0" cellspacing="0" class="sin-borde">
        <tr>
          <td height="61"><div align="right"></div>
              
              <div align="left"></div>              <table width="550" height="76" border="0" align="right" class="formato-blanco">
                <tr>
...
function ue_showouput()
{
    ...
    if(estmodest==1)
	{
		if(txtetiqueta=="Mensual")
		{
			...
			{
			 pagina="reportes/tepuy_spg_rpp_comp_ejec_fisica_financiera_global.php?cmbnivel="+cmbnivel+"&ckbctasinmov="+ckbctasinmov+"&ckbominoprog="+ckbominoprog+"&combo="+combo
			 +"&combomes="+combomes+"&ckbformil="+ckbformil+"&txtetiqueta="+txtetiqueta;
		...
		else
		{
			...
			{
		   pagina="reportes/tepuy_spg_rpp_comp_ejec_fisica_financiera_global.php?"+"&cmbnivel="+cmbnivel+"&ckbctasinmov="+ckbctasinmov+"&ckbominoprog="+ckbominoprog+"&combo="+combo
		   +"&ckbformil="+ckbformil+"&txtetiqueta="+txtetiqueta;
		   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
	}
	else
	{
		...
		if(txtetiqueta=="Mensual")
		{
		 ...
		 else
		 {
			...
			{
   pagina="reportes/tepuy_spg_rpp_comp_ejec_fisica_financiera_global.php?cmbnivel="+cmbnivel+"&ckbctasinmov="+ckbctasinmov+"&ckbominoprog="+ckbominoprog
   ...
   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,        location=no");
		...
		else
		{
			...
			{
			   pagina="reportes/tepuy_spg_rpp_comp_ejec_fisica_financiera.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
...
function catalogo_estpro4()
{
	...
	if((codestpro1!="")&&(codestpro2!="")&&(codestpro3!=""))
	{
		pagina="tepuy_cat_public_estpro4.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
