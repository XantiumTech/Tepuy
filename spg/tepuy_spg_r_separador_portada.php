...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_separador_portada.php";
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Separador de Portada<br>
      Distribución - Ordenanza</td>
    </tr>
  </table>
      ...
      <td height="40" colspan="3" align="center">      <div align="left">
        <table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="4"><strong class="titulo-celdanew">Portada </strong></td>
            </tr>
          <tr>
		...
		<option value="s1">Ambas</option>
              <option value="01">Ordenanza</option>
              <option value="02">Distribución</option>
              </select></td>
            <td width="223">&nbsp;</td>
            <td width="446">&nbsp;</td>
          </tr>
...
function ue_showouput()
{
	...
	pagina="reportes/tepuy_spg_rpp_separador_portada.php?combo="+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato;
