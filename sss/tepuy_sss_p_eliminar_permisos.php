...
$io_fun_activo->uf_load_seguridad("SSS","tepuy_sss_p_eliminar_permisos.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<?php
	...
	require_once("tepuy_sss_c_eliminar_permisos.php");
	$io_sss= new tepuy_sss_c_eliminar_permisos();
...
function ue_procesar()
{
	...
	if(li_ejecutar==1)
	{
		...
		if(ls_usuario!="---")
		{
			...
			f.action="tepuy_sss_p_eliminar_permisos.php";
			f.submit();
		}
		else
		{
