...
$io_fun_seguridad->uf_load_seguridad("SSS","tepuy_c_actualizar_ventanas.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<?php
	...
	require_once("tepuy_sss_c_actualizar_ventana.php");
	require_once("../shared/class_folder/tepuy_include.php");
	require_once("../shared/class_folder/class_sql.php");
	$io_sss= new tepuy_sss_c_actualizar_ventana();
	...
	if($ls_operacion=="ACTUALIZAR")
	{
		if($ls_codsis!="")
		{
			...
			if(file_exists("arbol/tepuy_arbol_".$ls_codsisaux.".php"))
			{
				include("arbol/tepuy_arbol_".$ls_codsisaux.".php");
				$li_total=$gi_total;
...
?>		  
  ...
  <div align="center">
    <table width="38%" height="194" border="0" cellpadding="0" cellspacing="0"  class="formato-blanco">
      ...
      <tr>
        <td height="170"  background="imagenes/tepuy.jpg" class="formato-blanco"><p>&nbsp;</p>
...
function ue_aceptar()
{
	...
	if(li_ejecutar==1)
	{
		...
		f.action="tepuy_sss_p_actualizar_ventanas.php";
		f.submit();
	}
	else
	{
