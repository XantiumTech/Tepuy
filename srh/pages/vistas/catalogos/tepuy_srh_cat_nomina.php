...
<p>&nbsp;</p>
	...
	<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_cargo.php?valor=createXML_nomina";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   mygrid.clearAll();
			divResultado = document.getElementById('mostrar');
			divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_cargo.php?valor=buscar_nomina"+"&txtcodnom="+codnom+"&txtdesnom="+desnom);
		   setTimeout (terminar_buscar,500);
