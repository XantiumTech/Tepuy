<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_r_retencionesespecifico.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<!--  <tr>
  ...
  <tr>
    <td height="20" width="25" class="toolbar"><div align="center"><a href="javascript: ue_imprimir();"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" width="20" height="20" border="0" title="Imprimir"></a></div></td>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td height="19" align="center"><div align="left">
        ...
        <a href="javascript: ue_catalogo_deduccion('');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
        <label>
    ...
    <tr>
      ...
      <td height="19" align="center"><div align="left">
        ...
        <a href="javascript: ue_catalogo_deduccion('rephas');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
{
	window.open("tepuy_cxp_cat_deduccion.php?tipo="+ls_destino+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=550,height=400,left=50,top=50,location=no,resizable=yes");
}
...
function ue_imprimir()
{
	...
	if(li_imprimir==1)
	{
		...
		if((fecdes!="")&&(fechas!="")&&(codded!="")&&(coddedhas!=""))
		{
			...
			pagina="reportes/tepuy_cxp_rpp_retencionespecifico.php?tipproben="+tipproben+"&codprobendes="+codprobendes;
