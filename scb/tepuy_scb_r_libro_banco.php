...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_libro_banco.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
function ue_imprimir()
{
  ...
  if (f.chktipdes.checked==true)
     {
	   li_tipdes  = '1'; 
	   ls_reporte = "tepuy_scb_rpp_libro_banco_detallado.php";
	   ls_tiprep  = "D";
	 }
  else
     {
	   li_tipdes  = '0';
	   ls_reporte = "tepuy_scb_rpp_libro_banco_pdf.php";   
	   ls_tiprep  = "C";
	 }
  ...
  if (li_imprimir=='1')
     {
	  if (f.chktipdes.checked==true)
		 {
		   li_tipdes  = '1'; 
		   ls_reporte = "tepuy_scb_rpp_libro_banco_detallado_excel.php";
		   ls_tiprep  = "D";
		 }
	  else
		 {
		   li_tipdes  = '0';
		   ls_reporte = "tepuy_scb_rpp_libro_banco_excel.php";   
		   ls_tiprep  = "C";
		 }       
	 	  if ((ld_fecdesde!="")&&(ld_fechasta!="")&&(ls_codban!="")&&(ls_ctaban!=""))
          {
