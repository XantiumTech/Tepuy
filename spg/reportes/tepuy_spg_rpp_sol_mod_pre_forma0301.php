<?php
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////
       ...
       // $io_pdf->Rectangle(19,80,570,30);
        	...
        	$io_pdf->Rectangle(19,30,570,120);
		$io_pdf->line(19,133,590,133); //LINEA QUE DIVIDE LINEA DE INFORMACION DEL RECTAGULO
		$io_pdf->line(120,90,120,150);		
		$io_pdf->line(230,90,230,150);		
		$io_pdf->line(345,90,345,150);	
		$io_pdf->line(465,90,465,150);	
		//$io_pdf->line(480,50,480,100);
		$io_pdf->line(19,90,590,90); //LINEA QUE DIVIDE LINEA DE INFORMACION DEL RECTAGULO
		$io_pdf->addText(245,80,10,"<b>JUNDA DIRECTIVA</b>");
		$io_pdf->line(19,78,590,78); //LINEA QUE DIVIDE LINEA DE INFORMACION DEL RECTAGULO
		$io_pdf->line(19,55,590,55); //LINEA QUE DIVIDE LINEA DE INFORMACION DEL RECTAGULO
		$io_pdf->line(120,30,120,78);		
		$io_pdf->line(230,30,230,78);		
		$io_pdf->line(345,30,345,78);	
		$io_pdf->line(465,30,465,78);	
		...
		$io_pdf->addText(34,140,7,"ELABORADO POR:"); // Agregar el título
		$io_pdf->addText(143,140,7,"REVISADO POR:"); // Agregar el título
		$io_pdf->addText(250,143,7,"JEFE DE OFICINA DE"); // Agregar el título
		$io_pdf->addText(257,134,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(374,143,7,"APROBADO POR "); // Agregar el título
		$io_pdf->addText(372,134,7,"ADMINISTRACION"); // Agregar el título
		$io_pdf->addText(498,140,7,"PRESIDENTE"); // Agregar el título

		// JUNTA DIRECTIVA PRIMEROS MESES
		//$io_pdf->addText(34,70,7,"ING. ANGEL E. IZARRA"); // Agregar el título
		//$io_pdf->addText(128,70,7,"LICDA. YSMELDA MONTILLA"); // Agregar el título
		//$io_pdf->addText(246,70,7,"LICDA. ROSSANA GARCIA"); // Agregar el título
		//$io_pdf->addText(360,70,7,"LICDA. MARIELY GONZALEZ "); // Agregar el título
		//$io_pdf->addText(466,70,7,"ING. JUAN JOSE ABRIL CONTRERAS"); // Agregar el título

		// JUNTA DIRECTIVA ULTIMOS MESES
/*		$io_pdf->addText(21,70,7,"LICDO. ANTONIO ALBARRAN"); // Agregar el título
		$io_pdf->addText(128,70,7,"LICDO. WALTER QUINTANA"); // Agregar el título
		$io_pdf->addText(242,70,7,"LICDO. GELBIX ALBARRAN"); // Agregar el título
		$io_pdf->addText(357,70,7,"LICDA. MARIELY GONZALEZ"); // Agregar el título
		$io_pdf->addText(466,70,7,"ING JOSE GREGORIO GOICOECHEA"); // Agregar el título


		$io_pdf->addText(29,64,6,"SECRETARIO EJECUTIVO DE "); // Agregar el título
		$io_pdf->addText(130,64,6,"SECRETARIA EJECUTIVA DE "); // Agregar el título
		$io_pdf->addText(246,64,6,"SECRETARIA EJECUTIVA DE "); // Agregar el título
		$io_pdf->addText(360,64,6,"SECRETARIA EJECUTIVA DE "); // Agregar el título
		$io_pdf->addText(493,62,6,"PRESIDENTE DE BARVIALSA"); // Agregar el título

		$io_pdf->addText(24,57,6,"INFRAESTRUC. Y ORD. TERRIT."); // Agregar el título
		$io_pdf->addText(130,57,6,"DESARROLLO ECONOMICO"); // Agregar el título
		$io_pdf->addText(232,57,6,"PLANIF., PROGRAM. Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(360,57,6,"ADM. FINANZAS Y HACIENDA"); // Agregar el título
*/
	 ...
	 // print_r($ia_niveles_scg);
	  ...
	  if ($lb_valido==false)
	   ...
	   else
		 {
			...
			$ls_titulo = "<b>SOLICITUD DE MODIFICACIÓN PRESUPUESTARIA</b>";
			uf_print_encabezado_pagina($ls_titulo,$ls_procede,$io_pdf); // Imprimimos el encabezado de la página
