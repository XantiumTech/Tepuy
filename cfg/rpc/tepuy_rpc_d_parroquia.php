...
require_once("class_folder/tepuy_rpc_c_parroquia.php");
...
$io_parroquia = new tepuy_rpc_c_parroquia($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////////
	...
	$ls_sistema   = "CFG";
	$ls_ventanas  = "tepuy_rpc_d_parroquia.php";
...
if ($ls_operacion=="NUEVO") 
   {
	 $ls_codpar=$io_parroquia->uf_generar_codigo($lb_empresa,$ls_codemp,'tepuy_parroquia','codpar',$ls_codpais,$ls_codest,$ls_codmun);
	 if(empty($ls_codmun))
	   {
      ...
      if ($lb_existe)
	     {
	       ...
	       $lb_tiene     = $io_chkrel->uf_check_relaciones($ls_empresa,$ls_condicion,'tepuy_parroquia',$ls_codpar,$ls_mensaje);//Verifica los movimientos asociados a la cuenta
           if (!$lb_tiene)
		      {
...
function ue_nuevo()
{
  ...
  if (li_incluir==1)
	 {	
	   ...
	   f.action="tepuy_rpc_d_parroquia.php";
	   f.submit();
	 }  
  else
     {
	...
	if (li_leer==1)
	   {
         if (f.cmbpais.value=="s1")
            ...
            {   
	          ...
	          pagina="tepuy_cfg_cat_parroquias.php?hidpais="+ls_pais+"&hidestado="+ls_estado+"&hidmunicipio="+ls_municipio;
