...
<form name="form1" method="post" action="">
  <table width="502" border="0" align="center" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="112"><a href="javascript: ue_agregar();"><img src="../shared/imagebank/tools15/aprobado.png" width="15" height="15" class="sin-borde">Agregar Detalle</a> </td>
...
{
	f=document.form1;
	window.open("tepuy_scv_cat_pais.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
	f.txtcodest.value="";
	f.txtdesest.value="";
	f.txtcodciu.value="";
	f.txtdesciu.value="";
...
function ue_buscarestado()
{
	...
	if(codpai!="")
	{
		window.open("tepuy_scv_cat_estados.php?codpai="+codpai+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
	}
	else
	{
...
function ue_buscarciudad()
{
	...
	if((codpai!="")||(codest!=""))
	{
		window.open("tepuy_scv_cat_ciudades.php?hidpais="+ls_codpai+"&hidestado="+ls_codest+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
	}
	else
	{
