var url= "../../php/tepuy_srh_a_items.php";
var metodo='get';
  ...
  if(lb_valido)
  {
	  ...
	  function onGuardar(respuesta)
	  {
	 	 ...
	 	 if (trim(respuesta.responseText)=="El Item de Evaluacion fue Registrado")
		 {
			   ...
			   f.action="tepuy_srh_d_items.php";		 
			   f.submit();	
		 }
...
function catalogo_aspectos_items()
  {
       f= document.form1;
		...
		else
		{
         ...
         pagina="../catalogos/tepuy_srh_cat_aspectos_items.php?valor_cat=0"+"&codeval="+codeval;
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_items.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
