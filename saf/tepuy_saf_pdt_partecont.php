  ...
  <table width="502" border="0" align="center" class="formato-blanco">
    ...
    <tr>
      ...
      <td height="22" colspan="3"><input name="txtcodpar" type="text" id="txtcodpar" style="text-align:center "  onBlur="javascript: ue_rellenarcampo(this,'15'); ue_verificar();" value="<?php print $ls_codpar ?>">
        <a href="javascript: ue_catapartes();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <a href="javascript: ue_catasccuenta();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
function ue_catapartes()
{
	...
	window.open("tepuy_saf_cat_partes.php?codact="+ ls_codact +"&ideact="+ ls_ideact +"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=50,top=50,location=no,resizable=yes");
}

function  ue_catasccuenta()
{
	window.open("tepuy_cat_ctasscg.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=50,top=50,location=no,resizable=yes");
}
...
function ue_verificar()
{
	...
	if(ls_codpar!="")
	{
		...
		f.action="tepuy_saf_pdt_partecont.php";
		f.submit();
	}
}
