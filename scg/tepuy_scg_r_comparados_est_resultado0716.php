...
<form name="form1" method="post" action=""> 
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Comparado-Estado de Resultado  </td>
    </tr>
  </table>
...
function ue_showouput()
{
	...
	if(txtetiqueta=="Mensual")
	{
		...
		else
		{
			...
			{
			   pagina="reportes/tepuy_scg_rpp_comparado_est_resultado0716.php?combo="+combo
	...
	else
	{
		...
		{
		   pagina="reportes/tepuy_scg_rpp_comparado_est_resultado0716.php?combo="+combo+"&txtetiqueta="+txtetiqueta;
		   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}
}
