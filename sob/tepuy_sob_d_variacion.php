...
<html>
<head>
<title>Variacion de Contrato (Aumento o Disminucion</title>
...
/********************************************         SEGURIDAD       ****************************************************/
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_d_variacion.php";
...
$ls_titulopartidas="Monto Asignado a la Obra";
$li_anchopartidas=600;
$ls_nametable="grid";
$la_columpartidas[1]="";
$la_columpartidas[2]="Código";
$la_columpartidas[3]="Obra";
//$la_columpartidas[4]="Uni. Med.";
//$la_columpartidas[5]="Monto Actual";
//$la_columpartidas[6]="Monto Nuevo";
$la_columpartidas[4]="Monto Actual";
$la_columpartidas[5]="Monto a Incrementar";
$la_columpartidas[6]="Total";
...
if(array_key_exists("operacion",$_POST))
{
	...
	for($li_i=1;$li_i<$li_filaspartidas;$li_i++)
     {
		...
		//$la_objectpartidas[$li_i][6]="<input name=txtpreunimod".$li_i." type=text id=txtpreunimod".$li_i." value='".$ls_preunimod."' class=sin-borde size=15 style= text-align:center onKeyPress=return(currencyFormat(this,'.',',',event)) onBlur=ue_subtotal();>";
	        $la_objectpartidas[$li_i][4]="<input name=txtcanttot".$li_i." type=text id=txtcanttot".$li_i." value='".$ls_canttot."' class=sin-borde size=15 style= text-align:center readonly>";
	        $la_objectpartidas[$li_i][5]="<input name=txtcantpar".$li_i." type=text id=txtcantpar".$li_i." value='".$ls_cantpar."' class=sin-borde size=15 style= text-align:center onKeyPress=return(currencyFormat(this,'.',',',event)) onBlur=ue_subtotal();>";
	        $la_objectpartidas[$li_i][6]="<input name=txttotal".$li_i." type=text id=txttotal".$li_i." value='".$ls_total."' class=sin-borde size=15 style= text-align:center readonly>";	
	 }	
	...
	$la_objectpartidas[$li_filaspartidas][4]="<input name=txtcanttot".$li_filaspartidas." type=text id=txtcanttot".$li_filaspartidas." class=sin-borde size=15 style= text-align:center readonly>";
	$la_objectpartidas[$li_filaspartidas][5]="<input name=txtcantpar".$li_filaspartidas." type=text id=txtcantpar".$li_filaspartidas." class=sin-borde size=15 style= text-align:center readonly>";
	$la_objectpartidas[$li_filaspartidas][6]="<input name=txttotal".$li_filaspartidas." type=text id=txttotal".$li_filaspartidas." class=sin-borde size=15 style= text-align:center readonly>";
  ...
  if ($ls_operacion != "ue_cargarcuenta" && $ls_operacion != "ue_removercuenta")
	{
		...
		$la_objectcuentas[$li_filasfuentes][4]="<input name=txtvacio type=text id=txtvacio class=sin-borde style= text-align:center size=5 readonly>";
	}
...
else
{
	...
	$la_objectcuentas[1][4]="<input name=txtvacio2 type=text id=txtvacio2 class=sin-borde style= text-align:center size=5 readonly>";
   ...
   $lb_validop=$io_variacion->uf_select_partidasasignadas($ls_codcon,&$la_partidas,&$li_totalfilas);
	...
	for($li_i=1;$li_i<=$li_filaspartidas;$li_i++)
	{
		...
		//$la_objectpartidas[$li_i][6]="<input name=txtpreunimod".$li_i." type=text id=txtpreunimod".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_preuni)."' class=sin-borde size=15 style= text-align:center onKeyPress=return(currencyFormat(this,'.',',',event)) onBlur=ue_subtotal();>";
	        $la_objectpartidas[$li_i][4]="<input name=txtcanttot".$li_i." type=text id=txtcanttot".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_canttot)."' class=sin-borde size=15 style= text-align:center readonly>";
	        $la_objectpartidas[$li_i][5]="<input name=txtcantpar".$li_i." type=text id=txtcantpar".$li_i." value='0,00' class=sin-borde size=15 style= text-align:center onKeyPress=return(currencyFormat(this,'.',',',event)) onBlur=ue_subtotal();>";
	        $la_objectpartidas[$li_i][6]="<input name=txttotal".$li_i." type=text id=txttotal".$li_i." class=sin-borde size=15 style= text-align:center readonly>";	
...
elseif($ls_operacion=="ue_cargarcuenta")
{
	...
	$la_objectcuentas[$li_filascuentas][4]="<input name=txtvacio".$li_filascuentas." type=text id=txtvacio class=sin-borde style= text-align:center size=5 readonly>";
}
/***************************************************************************************************************************************************************************/
...
elseif($ls_operacion=="ue_guardar")
{
  ...
  $lb_valido=$io_variacion->uf_guardar_variacion($ls_codvar,$ls_codcon,$ls_tipvar,$ls_motvar,$ld_date,$ls_monto,$la_seguridad);
  if($lb_valido)
  {
    $io_variacion->uf_update_montocontrato($ls_codcon,$ls_monco,$la_seguridad);
   /*************  GUARDANDO PARTIDAS  ********************/
    $li_partidas=1;	
    for ($li_i=1;$li_i<$li_filaspartidas;$li_i++)
     {
	...
	$io_variacion->uf_update_dtpartidas($ls_codvar,$ls_codcon,$la_partidas,$li_partidas,$la_seguridad);
   /***********************************************/
   ...
   /***********  GUARDANDO CUENTAS  ***************/	
	...
	$io_variacion->uf_update_dtcuentas($ls_codvar,$ls_codcon,$la_cuentas,$li_filascuentas,$la_seguridad);
	/***********************************************/
	 print "<script language=javascript>";
...
{   
	...
	if($lb_validop)
	{
	  ...
	  for($li_i=1;$li_i<=$li_filaspartidas;$li_i++)
	  {
		...
		//$la_objectpartidas[$li_i][6]="<input name=txtpreunimod".$li_i." type=text id=txtpreunimod".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_preunimod)."' class=sin-borde size=15 style= text-align:center onKeyPress=return(currencyFormat(this,'.',',',event)) onBlur=ue_subtotal();>";
	        $la_objectpartidas[$li_i][4]="<input name=txtcanttot".$li_i." type=text id=txtcanttot".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ld_ncanttot)."' class=sin-borde size=15 style= text-align:center readonly>";
	        $la_objectpartidas[$li_i][5]="<input name=txtcantpar".$li_i." type=text id=txtcantpar".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_canvalpar)."' class=sin-borde size=15 style= text-align:center onKeyPress=return(currencyFormat(this,'.',',',event)) onBlur=ue_subtotal();>";
	        $la_objectpartidas[$li_i][6]="<input name=txttotal".$li_i." type=text id=txttotal".$li_i." value='".$io_funcsob->uf_convertir_numerocadena($ls_total)."'  class=sin-borde size=15 style= text-align:center readonly>";	
	}
	$li_filaspartidas=$li_filaspartidas+1;	
	$la_objectpartidas[$li_filaspartidas][1]="<input type=checkbox name=flagpar".$li_filaspartidas." value=1 disabled class=sin-borde>";
	$la_objectpartidas[$li_filaspartidas][2]="<input name=txtcodpar".$li_filaspartidas." type=text id=txtcodpar".$li_filaspartidas." class=sin-borde style= text-align:center size=8 readonly><input name=codasi".$li_filaspartidas." type=hidden id=codasi".$li_filaspartidas."><input name=codobr".$li_filaspartidas." type=hidden id=codobr".$li_filaspartidas.">";
	...
	//$la_objectpartidas[$li_filaspartidas][5]="<input name=txtpreuni".$li_filaspartidas." type=text id=txtpreuni".$li_filaspartidas." class=sin-borde size=15 style= text-align:center readonly>";
	//$la_objectpartidas[$li_filaspartidas][6]="<input name=txtpreunimod".$li_filaspartidas." type=text id=txtpreunimod".$li_filaspartidas." class=sin-borde size=15 style= text-align:center readonly>";
	$la_objectpartidas[$li_filaspartidas][4]="<input name=txtcanttot".$li_filaspartidas." type=text id=txtcanttot".$li_filaspartidas." class=sin-borde size=5 style= text-align:center readonly>";
	$la_objectpartidas[$li_filaspartidas][5]="<input name=txtcantpar".$li_filaspartidas." type=text id=txtcantpar".$li_filaspartidas." class=sin-borde size=5 style= text-align:center readonly>";
	$la_objectpartidas[$li_filaspartidas][6]="<input name=txttotal".$li_filaspartidas." type=text id=txttotal".$li_filaspartidas." class=sin-borde size=15 style= text-align:center readonly>";
	}
   /*****************************************************************************************/
...
<!--  <tr>
  ...
  <?php
   ...
   /************************************         SEGURIDAD          ***********************************************/
?>	
  <input name="hidmonco" type="hidden" id="hidmonco" value="<? print $ls_totcon ?>">
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
        ...
        <td height="68" colspan="6" align="center" valign="top" class="sin-borde"><table width="544" height="137" border="0" cellpadding="0" cellspacing="4" class="formato-blanco">
          <tr>
            ...
            <td width="111"><span class="style6">
              <input name="txtestobr" type="text" class="celdas-grises" id="txtestobr"  style="text-align:left" value="<? print $ls_estcon ?>" size="20" maxlength="20" readonly="true">
            </span></td>
          </tr>
          <tr>
            <td width="220"><div align="right"><span class="style6">Descripcion de la Obra</span></div></td>
            <td colspan="3"><span class="style6">
              <textarea name="txtdesobr" cols="55" rows="2" readonly="true" id="txtdesobr" style="text-align:left"><? print $ls_desobr ?></textarea>
            </span><span class="style6"></span></td>
          </tr>
          <tr>
            <td><div align="right">Fecha Contrato </div></td>
            <td><span class="style6">
              <input name="txtfeccon" type="text" id="txtfeccon"  style="text-align: center" value="<? print $ls_feccon ?>" size="10" maxlength="10" readonly="true">
            </span></td>
            <td><div align="right"></div></td>
        
		    <td><span class="style6">
              <input name="txtpuncueasi" type="hidden" id="txtpuncuenasi"  style="text-align: center" value="<? print $ls_puncue  ?>" size="20" maxlength="20" readonly="true">
            </span></td>
          </tr>
          <tr>
            <td><div align="right"><span class="style6">Monto Contrato </span></div></td>
            <td><span class="style6">
              <input name="txtmoncon" type="text" id="txtmoncon"  style="text-align: right" value="<? print $io_funcsob->uf_convertir_numerocadena($ls_moncon) ?>" size="20" maxlength="20" readonly="true">
            </span></td>
            <td><div align="right">Anticipo</div></td>
            <td><span class="style6">
              <input name="txtmonant" type="text" id="txtmonant"  style="text-align: right" value="<? print $io_funcsob->uf_convertir_numerocadena($ls_totant) ?>" size="20" maxlength="20" readonly="true">
            </span></td>
          </tr>
          <tr>
            <td><div align="right">Contrato + Aumentos - Disminuciones </div></td>
            <td><span class="style6">
              <input name="txtmontotcon" type="text" id="txtmontotcon"  style="text-align: right" value="<? print $io_funcsob->uf_convertir_numerocadena($ls_totcon) ?>" size="20" maxlength="20" readonly="true">
            </span></td>
            <td>&nbsp;</td>
      ...
      <tr class="formato-blanco">
		...
		<input name="hidcodasi" type="hidden" id="hidcodasi">        </td>
      </tr>
      <tr class="formato-blanco">
        <td height="22">&nbsp;</td>
        <td>&nbsp;</td>
        ...
        <td width="207"><span class="style6">
          <input name="txtestvar" type="text" class="celdas-grises" id="txtestvar"  style="text-align: center" value="<? print $ls_estvar ?>" size="15" maxlength="15" readonly="true">
        </span></td>
      </tr>
      <tr class="formato-blanco">
        ...
        <td>
          <div align="left">
            <input name="txtcodvar" id="txtcodvar" style="text-align:center " value="<? print $ls_codvar ?>" readonly="true" type="text" size="3" maxlength="3">
          </div>          
      ...
      <tr class="formato-blanco">
        ...
        <td colspan="3"><input name="txtfecvar" type="text" id="txtfecvar"  style="text-align: left" value="<? print $ls_fecvar ?>" size="11" maxlength="11"   onKeyPress="javascript:ue_validafecha();" datepicker="true" readonly="true"></td>
      </tr>
      <tr class="formato-blanco">
        <td height="22"><div align="right"></div></td>
        <td height="22"><div align="right">Concepto</div></td>
        <td colspan="3"><textarea name="txtmotvar" cols="80" rows="2" id="txtmotvar"><? print $ls_motvar ?></textarea></td>
      </tr>
      <tr class="formato-blanco">
        <td colspan="5">&nbsp;</td>
      </tr>
      ...
      <tr class="formato-blanco">
        ...
        <td><input name="txtmonto" type="text" id="txtmonto"  style="text-align: right" value="<? print $ls_monto ?>" size="21" maxlength="21" readonly="true"></td>
      </tr>
      <tr class="formato-blanco">
        <td height="23" colspan="5"><table width="609" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr class="formato-blanco">
            <td width="14" height="11">&nbsp;</td>
            <td width="593"><a href="javascript:ue_catfuentefinanciamiento();"><img src="../shared/imagebank/mas.gif" width="9" height="17" border="0"></a><a href="javascript:ue_catcuentagasto();">Agregar Detalle </a></td>
          </tr>
          <tr align="center" class="formato-blanco">
      ...
      <tr class="formato-blanco">
        ...
        <td><input name="txtmoncon" type="text" id="txtmoncon"  style="text-align: right" value="<? print $ls_monco ?>" size="20" maxlength="20" onKeyPress="return(currencyFormat(this,'.',',',event))" onBlur="uf_validarbasimp();"></td>
      </tr>
      <tr class="formato-blanco">
        <td colspan="5">&nbsp;</td>
      </tr>
...
function ue_buscar()
{
  ...
  if(li_leer==1)
   {
     f.operacion.value="";
     pagina="tepuy_cat_variacion.php?estado=";
...
function ue_cargarvariacion(ls_codvar,ls_codcon,ls_tipvar,ls_motvar,ls_fecha,ls_monto,ls_monco,ls_nomestval,ls_codasi)
{
	...
	f.action="tepuy_sob_d_variacion.php";
	f.submit();
}
