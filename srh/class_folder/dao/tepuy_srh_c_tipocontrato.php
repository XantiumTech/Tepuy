...
class tepuy_srh_c_tipocontrato
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_srh_c_tipocontrato($path)
...
function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_d_tipocontratos)
		//      Argumento: 
	...
	function uf_srh_select_tipocontrato($as_codtipcon)
	{
		...
		//         Access: public (tepuy_srh_d_tipocontrato)
...
}// end   class tepuy_srh_c_tipocontrato
