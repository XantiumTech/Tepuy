...
$io_fun_ingreso->uf_load_seguridad("SPI","tepuy_spi_r_comprobante_formato1.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<!-- ******** END ALLWEBMENUS CODE FOR menu ******** -->
  ...
  <tr> 
    <td height="32" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.png" width="20" height="20" border="0"></a></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a>
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		pagina="reportes/tepuy_spi_rpp_comprobante_formato1.php?txtcompdes="+txtcompdes
...
{
	   pagina="tepuy_cat_comprobantesspi.php?tipocat=repcompdes";
...
{
		pagina="tepuy_cat_comprobantesspi.php?tipocat=repcomphas";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,resizable=yes,location=no");
}
function catalogo_procdes()
{
	   pagina="tepuy_cat_comprobantesspi.php?tipocat=rep_proc_des";
	   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,resizable=yes,location=no");
}
function catalogo_prochas()
{
		pagina="tepuy_cat_comprobantesspi.php?tipocat=rep_proc_has";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,resizable=yes,location=no");
}
