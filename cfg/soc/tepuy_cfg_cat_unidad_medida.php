...
<table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celdanew">Cat&aacute;logo de Unidad de Medida</td>
    </tr>
</table>
  <br>
<?php
...
if ($ls_operacion=="BUSCAR")
   {
		$ls_sql= " SELECT * ".
		         ...
		         " WHERE codunimed like '".$ls_codigo."' order by codunimed"; //print $ls_sql;
			 ...
			 for ($z=1;$z<=$totrow;$z++)
				 {
		           ...
		           $ls_tiposep=$data["tiposep"][$z];
		           print "<td><a href=\"javascript: aceptar('$ls_codunimed','$ls_denunimed','$ls_unidad');\">".$ls_codunimed."</a></td>";
				   print "<td  align=center>".$ls_denunimed."</td>";
				   print "</tr>";			
			     }
		   print "</table>";
...
<script language="JavaScript">
  ...
  {
    opener.document.form1.txtunimed.value=codunimed;
	opener.document.form1.txtdenunimed.value=denunimed;
	
	opener.document.form1.txtunimed.readOnly=true;
  ...
  function ue_search()
  {
    ...
    f.action="tepuy_cfg_cat_unidad_medida.php";
    f.submit();
  }
</script>
</html>