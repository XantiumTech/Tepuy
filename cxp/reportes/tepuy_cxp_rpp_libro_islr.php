<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_seniat.jpg',30,712,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
	...
	/*	$la_data2[1]=array('name1'=>'<b>ORDEN DE PAGO</b>',
		...
		$la_data1[1]=array('nombre'=>'<b>Nombre Contribuyente</b>',
						  'rif'=>'<b>CI / RIF</b>',
						  'factura'=>'<b>Factura</b>',
						  'control'=>'<b>N. Control</b>',
						  'fechafactura'=>'<b>Fecha Operación</b>',
						  'codseniat'=>'<b>Código Concepto</b>',
						  'porded'=>'<b>% de Retención</b>',
						  'montobruto'=>'<b>Monto Operación</b>',
  						  'monimp'=>'<b> Retenido</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 9,  // Tamaño de Letras de los títulos
						 ...
						 'xPos'=>305, // Orientación de la tabla
						 'cols'=>array('nombre'=>array('justification'=>'center','width'=>120),
						 			   'rif'=>array('justification'=>'center','width'=>62), // Justificacion y ancho de la columna
									   'factura'=>array('justification'=>'center','width'=>55), // Justificacion y ancho de
									   'control'=>array('justification'=>'center','width'=>60), // Justificacion y ancho de
									   'fechafactura'=>array('justification'=>'center','width'=>55),
									   'codseniat'=>array('justification'=>'center','width'=>50),
									   'porded'=>array('justification'=>'center','width'=>44),
						 			   'montobruto'=>array('justification'=>'center','width'=>60), // Justificacion y ancho de la columna
									   'monimp'=>array('justification'=>'center','width'=>55))); 
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>540, // Ancho Mínimo de la tabla
						 'xPos'=>305, // Orientación de la tabla
						 'cols'=>array('nombre'=>array('justification'=>'left','width'=>120),
						 			   'rif'=>array('justification'=>'center','width'=>62), // Justificacion y ancho de la columna
									   'factura'=>array('justification'=>'center','width'=>55), // Justificacion y ancho de
									   'control'=>array('justification'=>'center','width'=>60), // Justificacion y ancho de
									   'fechafactura'=>array('justification'=>'center','width'=>55),
									   'codseniat'=>array('justification'=>'center','width'=>50),
									   'porded'=>array('justification'=>'center','width'=>44),
						 			   'montobruto'=>array('justification'=>'right','width'=>60), // Justificacion y ancho de la columna
									   'monimp'=>array('justification'=>'right','width'=>55))); 
...
//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_total($ai_totbasimp,$ai_totmonimp,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>548, // Ancho Mínimo de la tabla
						 'xPos'=>305, // Orientación de la tabla
...
//		$la_data[5]=array('firma1'=>'TESORERO / AGENTE DE RETENCION','firma2'=>'JEFE UNIDAD DE TRIBUTOS INTERNOS');
	...
	$ls_titulo="<b>DATA PARA CREAR ARCHIVO (XML) DE RETENCION DE ISLR</b>";
		...
		//	while (!$rs_data->EOF)
			{
				...
				$ls_numcon=$io_report->DS->data["numref"][$li_i];
				//$ls_numfac=$io_report->DS->data["numfac"][$li_i];
				$ls_numfac=$io_report->DS->data["factura"][$li_i];
				//$ls_numcontrol=$io_report->DS->data["numcon"][$li_i];
				$ls_numcontrol=$io_report->DS->data["control"][$li_i];
				...
				$li_totbase=$io_report->DS->data["totcmp_sin_iva"][$li_i];
				...
				$ls_codseniat=$io_report->DS->data["codseniat"][$li_i];
				$ls_porded=$io_report->DS->data["porded"][$li_i];
				$ls_porimp=$io_report->DS->data["porimp"][$li_i];
				$la_data[$li_i]=array('nombre'=>$ls_nomsujret, 'rif'=>$ls_rif,
									'factura'=>$ls_numfac,
									'control'=>$ls_numcontrol,
									'fechafactura'=>$li_fechaaprosol,	
									'codseniat'=>$ls_codseniat,
									'porded'=>$ls_porimp,	
