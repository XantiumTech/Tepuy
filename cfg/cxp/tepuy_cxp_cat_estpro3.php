		 ...
		 for ($z=1;$z<=$totrow;$z++)
		     {
			   ...
			   print "<td width=150 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3');\">".trim($ls_codestpro1)."</td>";
			   print "<td width=100 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3');\">".trim($ls_codestpro2)."</td>";
			   print "<td width=50 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3');\">".trim($ls_codestpro3)."</a></td>";
...
function ue_search()
{
	...
	f.action="tepuy_cxp_cat_estpro3.php";
	f.submit();
}
</script>
</html>
