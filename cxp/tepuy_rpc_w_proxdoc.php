...
require_once("class_folder/tepuy_rpc_c_proxdoc.php");
require_once("../shared/class_folder/tepuy_include.php");
require_once("../shared/class_folder/class_mensajes.php");
require_once("../shared/class_folder/class_funciones.php");

$io_proxdoc = new tepuy_rpc_c_proxdoc();
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "RPC";
	$ls_ventanas = "tepuy_rpc_w_proxdoc.php";
...
if ($ls_estdoc==0)
   {
     $ls_seldocnoe = "selected";
   }
elseif($ls_estdoc==1)
   {
     $ls_seldocent = "selected";
   }
elseif($ls_estdoc==2)
   {
     $ls_seldoctra = "selected";
   }
elseif($ls_estdoc==3)
   {
     $ls_selnoapli = "selected";
   }
$ls_selestori = "";
$ls_selestcop = "";
if ($ls_estori==0)
   {
     $ls_selestori = "selected";
   }
elseif($ls_estori==1)
   {
     $ls_selestcop = "selected";
   }
?>
<p>&nbsp;</p>
...
<tr class="titulo-celdanew"> 
	<td height="22" class="titulo-celda" style="text-align:left ">&nbsp;&nbsp;Proveedor : <?php print $ls_codprov?> - <?php print $ls_nomprov?></td>
	</tr>
</table>
<br>
  <table width="518" border="0" align="center" class="formato-blanco" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td width="127" height="22" align="right">Codigo</td>
      <td width="207" height="22"><input name="txtcodigo" type="text"  id="txtcodigo" value="<?php print $ls_coddoc ?>" size="6" maxlength="3" readonly style="text-align:center ">
      <a href="javascript:catalogo_documentos();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>        <input name="operacion" type="hidden" id="operacion"></td>
    ...
    <tr>
      <td height="22" align="right">Recepci&oacute;n</td>
    ...
    <tr>
      <td height="22" align="right">Vencimiento</td>
    ...
    <tr>
      ...
      <td height="22"><select name="cmbestdoc" id="select" style="width:140px">
        <option value="0" <?php echo $ls_seldocnoe ?>>No Entregado</option>
        <option value="1" <?php echo $ls_seldocent ?>>Entregado</option>
        <option value="2" <?php echo $ls_seldoctra ?>>En Tramite</option>
        <option value="3" <?php echo $ls_selnoapli ?>>No Aplica al Proveedor</option></select>        </td>
      <td height="22">&nbsp;</td>
    </tr>
    <tr>
      <td height="22" align="right">Original/Copia</td>
      <td height="22"><select name="cmbestori" id="select" style="width:140px">
        <option value="0" <?php echo $ls_selestori ?>>Copia del Documento</option>
        <option value="1" <?php echo $ls_selestcop ?>>Original</option></select>      </td>
      <td height="22">&nbsp;</td>
    </tr>
    <tr>
...
function ue_nuevo()
{
  ...
  f.action="tepuy_rpc_w_proxdoc.php";
  f.submit();
}
	...
	function ue_buscar()
		{
			...
			pagina="tepuy_cat_docxpro.php?txtprov="+ls_prov;
