...
class tepuy_srh_c_cargo
{
	...
	function tepuy_srh_c_cargo($path)
		 ...
		 $num=$this->io_sql->num_rows($rs_data);
		  ...
		  if ($num!=0) {
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ao_object[$ai_totrows][5]="<a href=javascript:catalogo_requerimiento(".$ai_totrows.");    align=center><img src=../../../../shared/imagebank/tools15/buscar.png alt=Buscar width=15 height=15 border=0 align=center></a>";		
...
function uf_srh_guardar_requerimiento_cargo ($po_requerimiento,$as_operacion="insertar", $aa_seguridad)
  { 
		...
		//         access: public (tepuy_srh_d_requerimiento_cargo)
...
function uf_srh_eliminar_dt_cargo($as_codcar, $aa_seguridad)
  {
		...
		//        access:  public (tepuy_srh_dt_cargo)														
