<?php
class tepuy_snorh_c_fideicomiso
{
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_snorh_c_fideicomiso()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_snorh_c_diaferiado
		//		   Access: public (tepuy_snorh_d_fideicomiso)
		...
		require_once("tepuy_snorh_c_fideiconfigurable.php");
		$this->io_fideiconfigurable=new tepuy_snorh_c_fideiconfigurable();
	...
	}// end function tepuy_snorh_c_fideicomiso
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_load_fideicomiso($as_codper,&$as_codfid,&$as_ficfid,&$as_ubifid,&$as_cuefid,&$ad_fecingfid,&$as_capfid,&$as_capantcom)
	{
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="SELECT codfid, ficfid, ubifid, cuefid, fecingfid, capfid, capantcom ".
		...
		else
		{
			...
			{
				$as_codfid=$row["codfid"];
				$as_ficfid=$row["ficfid"];
				$as_ubifid=$row["ubifid"];
				$as_cuefid=$row["cuefid"];
				$ad_fecingfid=$this->io_funciones->uf_convertirfecmostrar($row["fecingfid"]);
				$as_capfid=$row["capfid"];
				$as_capantcom=$row["capantcom"];
			}
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_insert_fideicomiso($as_codper,$as_codfid,$as_ficfid,$as_ubifid,$as_cuefid,$ad_fecingfid,$as_capfid,$as_capantcom,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="INSERT INTO sno_fideicomiso".
				"(codemp,codper,codfid,ficfid,ubifid,cuefid,fecingfid,capfid,capantcom)VALUES".
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_update_fideicomiso($as_codper,$as_codfid,$as_ficfid,$as_ubifid,$as_cuefid,$ad_fecingfid,$as_capfid,$as_capantcom,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_guardar($as_codper,$as_codfid,$as_ficfid,$as_ubifid,$as_cuefid,$ad_fecingfid,$as_capfid,$as_capantcom,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_guardar
		//		   Access: public (tepuy_snorh_d_fideicomiso)
		...
		{
			$lb_valido=$this->uf_insert_fideicomiso($as_codper,$as_codfid,$as_ficfid,$as_ubifid,$as_cuefid,$ad_fecingfid,$as_capfid,$as_capantcom,$aa_seguridad);
		}
		else
		{
			$lb_valido=$this->uf_update_fideicomiso($as_codper,$as_codfid,$as_ficfid,$as_ubifid,$as_cuefid,$ad_fecingfid,$as_capfid,$as_capantcom,$aa_seguridad);
		}
		return $lb_valido;
	...
	function uf_load_nomina(&$aa_nominas)
	{
		...
		//		   Access: public (tepuy_snorh_p_fideicomiso.php)
		...
		else
		{
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				$aa_nominas["codnom"][$li_i]=$row["codnom"];
				$aa_nominas["desnom"][$li_i]=$row["desnom"];
				$li_i=$li_i+1;
			}
			$this->io_sql->free_result($rs_data);		
		}
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_load_fideiperiodo($ai_anocurper,$as_mescurper,$aa_nominas,&$ai_totrows,&$ao_object)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_load_fideiperiodo
		//		   Access: public (tepuy_snorh_d_tablavacacion)
		...
		else
		{
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$li_sueintper=$this->io_fun_nomina->uf_formatonumerico($row["sueintper"]);
				$li_bonvacper=$this->io_fun_nomina->uf_formatonumerico($row["bonvacper"]);
				$li_bonfinper=$this->io_fun_nomina->uf_formatonumerico($row["bonfinper"]);
				$li_apoper=$this->io_fun_nomina->uf_formatonumerico($row["apoper"]);
				$li_bonexpter=$this->io_fun_nomina->uf_formatonumerico($row["bonextper"]);
	...
	function uf_procesar_personal_version2($ai_anocurper,$as_mescurper,$aa_nominas,$ad_fecgen)
	{
		...
		else
		{
			...
			while(($row=$this->io_sql->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$li_bonextper=round(($row["asifidper"]+$row["asifidpat"])/$li_diacal,2);
				$li_capantcom=trim($row["capantcom"]);
				if($li_capantcom=="")
				{
					$li_capantcom="0";
				}
				...
				{
					$ls_fraccion=trim($this->io_sno->uf_select_config("SNO","CONFIG","FRACCION ALICUOTA","0","I"));
					if($ls_fraccion=="1")
					{
	...
	function uf_procesar_personal_version_consejo($ai_anocurper,$as_mescurper,$aa_nominas,$ad_fecgen)
	{
		...
		else
		{
			...
			while(($row=$this->io_sql->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$li_bonextper=round(($row["asifidper"]+$row["asifidpat"])/$li_diacal,2);
				$li_sueintper=$row["sueintper"] + $li_otrasi;
				$li_suediaper=round((($li_sueintper)/$li_diacal),2);
				if($li_integrar=='1')
				{
					$li_suediaper=round($li_suediaper+$li_bonextper,2);
										   ...
										   $as_descripcion,$ai_genrecdoc,$ai_tipdoc,$as_anocurnom)
	{
		...
		$ls_sql="SELECT MAX(sno_fideiperiodo.apoper) AS total, MAX(spg_cuentas.spg_cuenta) AS spg_cuenta, ".
				"       MAX(sno_hunidadadmin.codprouniadm) AS programatica ".
				"  FROM sno_fideiperiodo  ".
		...
		else
		{
			if($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$this->DS->group_by(array('0'=>'programatica','1'=>'spg_cuenta'),array('0'=>'total'),'total');
				...
				for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
				{
					...
					$lb_valido=$this->uf_insert_contabilizacion_spg($as_comprobante,$as_operacion,$as_codpro,$as_codben,$as_tipodestino,
																	$as_descripcion,$ls_programatica,
										   ...
										   $ai_gennotdeb,$ai_genvou,$as_codcomapo,$as_codnom,$as_mescurper)
	{
		...
		$ls_sql="INSERT INTO sno_dt_spg(codemp,codnom,codperi,codcom,tipnom,codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,".
				...
				"estnotdeb,codcomapo) VALUES ('".$this->ls_codemp."','".$as_codnom."','".str_pad($as_mescurper,3,"0",0)."','".$as_codcom."',".
