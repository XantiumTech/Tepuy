...
/*****************************************************************
  Funcion que muestra el div con el nombre que se le pasa 
  por parametro como un mensaje
******************************************************************/
function mostrar_mensaje(id_div)
{
  ...
  {left = arguments[3];}
  $(id_div).innerHTML         = "<p>"+mensaje+"</p><p><img src='../../../kernel/images/tools20/progress_bar.gif'></p>";
  $(id_div).align             = "center";
  ...
  $(id_div).style.background  = "#DAE9F3";
  $(id_div).style.border      = "solid #000000";
...
/*****************************************************************
  ...
  por parametro
******************************************************************/
function ocultar_mensaje(id_div)
{
