    ...
    <input name="operacion" type="hidden" id="operacion">
	 ...
	 <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td height="22">
          <div align="right">
            <input name="obj" type="hidden" id="obj" value="<?php echo $ls_obj;?>">
            <a href="javascript: ue_search();"> <img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a> </div></td></tr>
    </table>
	 <div align="center"><br>
<?php
...
echo "<td width=100 style=text-align:center>RIF</td>";
echo "</tr>";
          ...
          while ($row=$io_sql->fetch_row($rs_data))
	            {
				  ...
				  $ls_rifpro = $row["rifpro"];
		 	      echo "<td width=100 style=text-align:center><a href=\"javascript: aceptar('$ls_codpro','$ls_nompro');\">".$ls_codpro."</a></td>";
			      echo "<td width=300 style=text-align:left>".$ls_nompro."</td>";
				  echo "<td width=100 style=text-align:right>".$ls_rifpro."</td>";
			      echo "</tr>";			
				}		
		}
     else
...
<script language="JavaScript">
  function aceptar(prov,d)
  {
    f=document.form1;
	ls_obj=f.obj.value;
	eval("opener.document.form1."+ls_obj+".value='"+prov+"'");
	close();
  }
  ...
  f.action="tepuy_cat_prov_general.php";
  f.submit();
  }
</script>
</html>