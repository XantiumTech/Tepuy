<?php
   ...
   function uf_print($as_codper,$ad_feciniper,$ad_fecfinper)
   {
		...
		print "<td width=340>Observación</td>";
		print "</tr>";
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				print "<td><a href=\"javascript: aceptar('$li_numper','$ld_feciniper','$ld_fecfinper','$li_numdiaper','$li_afevacper','$li_tipper','$ls_obsper','$ls_remper');\">".$li_numper."</a></td>";
    ...
    <table width="500" border="0" cellpadding="1" cellspacing="0" class="formato-blanco" align="center">
      <tr>
        ...
        <td width="127"><div align="left">
            <input name="txtfeciniper" type="text" id="txtfeciniper" size="13" maxlength="10" onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" datepicker="true"  onKeyUp="javascript: ue_mostrar(this,event);">
        </div></td>
        <td width="62"><div align="right">Fecha Fin</div></td>
        <td width="195"><div align="left">
          <input name="txtfecfinper" type="text" id="txtfecfinper" size="13" maxlength="10" onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" datepicker="true"  onKeyUp="javascript: ue_mostrar(this,event);">
        </div></td>
      </tr>
      <tr>
        <td height="22">&nbsp;</td>
...
function aceptar(numper,feciniper,fecfinper,numdiaper,afevacper,tipper,obsper,remper)
{
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="tepuy_snorh_cat_permiso.php";
  	f.submit();
}
</script>
</html>
