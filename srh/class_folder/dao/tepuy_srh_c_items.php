...
class tepuy_srh_c_items
{
	...
	function tepuy_srh_c_items($path)
		 ...
		 $num=$this->io_sql->num_rows($rs_data);
		  ...
		  if ($num!=0) {
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ao_object[$ai_totrows][4]="<a href=javascript:uf_agregar_dt(".$ai_totrows.");  align=center><img src=../../../../shared/imagebank/tools/grabar.png alt=Aceptar width=15 height=15 border=0 align=center></a>";
