...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_departamento.js"></script>
...
<p>&nbsp;</p>
	...
	<script>
		...
		ls_coduni=document.form1.hidcoduni.value;
		var loadDataURL = "../../php/tepuy_srh_a_departamento.php?valor=createXML&coduni="+ls_coduni;
		var actionURL = "../../php/tepuy_srh_a_departamento.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_departamento.php?valor=buscar"+"&txtcoddep="+coddep+"&txtdendep="+dendep);
           setTimeout (terminar_buscar,500);
			
		}
		
		function aceptar(ls_coddep,ls_dendep,ls_coddestino,ls_dendestino, ls_coduniadm, ls_coduniadmdestino, ls_denuniadm, ls_denuniadmdestino)
		{
