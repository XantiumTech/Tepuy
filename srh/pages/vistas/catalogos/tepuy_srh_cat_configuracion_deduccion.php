...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_configuracion_deduccion.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_configuracion_deduccion.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   mygrid.clearAll();
		    divResultado = document.getElementById('mostrar');
			divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_configuracion_deduccion.php?valor=buscar"+"&txtcodtipded="+codtipded+"&txtdentipded="+dentipded);
           setTimeout (terminar_buscar,500);
		...
		function aceptar(ls_codtipded,ls_dentipded,ls_coddestino,ls_dendestino)
		{
			...
			opener.document.form1.action="../pantallas/tepuy_srh_d_configuracion_deduccion.php";
