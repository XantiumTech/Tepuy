...
<html>
<head>
<title >Sistema de Ejecución Presupuestaria</title>
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="20" bgcolor="#E7E7E7" class="cd-menu"><script language="javascript" src="../js/menupro.js"></script></td>
  </tr>
</table>
<?php
	...
	{
		$col=$arr[$i];
		if(($col!="ls_width")&&($col!="ls_height")&&($col!="ls_logo")&&($col!="ls_hostname")&&($col!="ls_login")&&($col!="ls_password")
		&&($col!="ls_database")&&($col!="ls_gestor")&&($col!="con")&&($col!="gestor")&&($col!="la_empresa")&&($col!="la_logusr")
		&&($col!="la_ususeg")&&($col!="la_sistema")&&($col!="ls_port")&&($col!="la_apeusu")&&($col!="la_nomusu")&&($col!="la_cedusu"))
		{
			unset($_SESSION["$col"]);
		}
	}
