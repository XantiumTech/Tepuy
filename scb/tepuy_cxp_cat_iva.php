    ...
    <tr>
      <td width="532" colspan="6" align="center" bordercolor="#FFFFFF">
        <div align="center" class="Estilo2">
          <p align="right">            &nbsp;&nbsp;&nbsp;<a href="javascript: uf_aceptar(document.form1.total.value);"><img src="../shared/imagebank/tools20/aprobado.png" alt="Aceptar" width="20" height="20" border="0" onClick="ue_search()">Agregar Cr&eacute;dito</a></p>
      </div></td>
    </tr>
  </table>
  <p align="center">&nbsp;</p>
...
<script language="JavaScript">
  function ue_search()
  {
	  ...
	  f.action="tepuy_cxp_cat_iva.php";
	  f.submit();
  }	
