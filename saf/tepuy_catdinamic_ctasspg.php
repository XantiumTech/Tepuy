...
<br>
      ...
      <tr>
        <td>&nbsp;</td>
        <td colspan="3"><div align="right"><a href="javascript: ue_search();"><img src="imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar </a></div></td>
      </tr>
    </table>
	<br>
    <?php 
...
//	opener.document.form1.submit();
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_catdinamic_ctasSPG.php";
	  f.submit();
  }
