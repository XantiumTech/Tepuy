<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","tepuy_scg_r_libro_diario.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<!--  <tr>
  ...
  <tr>
    <td height="20" width="25" class="toolbar"><div align="center"><a href="javascript:ue_imprimir('<? print $ls_codemp; ?>');"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" width="20" height="20" border="0"></a></div></td>
...
?>		  
  <table width="530" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Libro Diario </td>
    </tr>
  </table>
    ...
    <tr>
      <td height="122" colspan="3" align="center"><div align="left"></div>        <div align="left"></div>        <div align="left" class="style14"></div>        <div align="left">
        <table width="480" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr class="titulo-celdanew">
            <td height="13" colspan="7">Tipo de Reporte </td>
            </tr>
          <tr>
            <td height="22">&nbsp;</td>
            <td height="22"><div align="right">Reporte</div></td>
            <td height="22" colspan="2"><div align="left">
              <select name="cmblibro" id="cmblibro">
                <option value="1">Libro Diario General</option>
                <option value="2">Libro Diario Legal</option>
                  </select>
            </div></td>
            <td height="22">&nbsp;</td>
            <td height="22">&nbsp;</td>
...
function ue_imprimir(codemp)
{
	...
	{	
		...
		cmblibro = f.cmblibro.value;
		if(cmblibro==1)
		{
			reporte="tepuy_scg_rpp_libro_diario_general_2017.php";
		}
		else
		{
			reporte="tepuy_scg_rpp_libro_diario_legal.php";
		}
		//alert(reporte);
		...
		if(hidbot==true)
		{
			...
			{
				//pagina="reportes/tepuy_scg_rpp_libro_diario_legal.php?hidcodemp="+codemp+"&cmbmesdes="+cmbmesdes
				pagina="reportes/"+reporte+"?hidcodemp="+codemp+"&cmbmesdes="+cmbmesdes
		...
		if(hidbot==false)
		{
			...
			{
				//pagina="reportes/tepuy_scg_rpp_libro_diario_legal.php?hidcodemp="+codemp+"&txtfecdes="+txtfecdes
				pagina="reportes/"+reporte+"?hidcodemp="+codemp+"&txtfecdes="+txtfecdes
...
function ue_openexcel(codemp)
{
	...
	{	
		...
		if(cmblibro==1)
		{
			reporte="tepuy_scg_rpp_libro_diario_general_excel.php";
		}
		else
		{
			reporte="tepuy_scg_rpp_libro_diario_legal_excel.php";
		}
		if(hidbot==true)
		{
			cmbmesdes  = f.cmbmesdes.value;
			...
			{
				pagina="reportes/tepuy_scg_rpp_libro_diario_legal_excel.php?hidcodemp="+codemp+"&cmbmesdes="+cmbmesdes
						+"&cmbmeshas="+cmbmeshas+"&cmbagnodes="+cmbagnodes+"&cmbagnohas="+cmbagnohas+"&cmbnivel="+cmbnivel
						+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte;
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		...
		if(hidbot==false)
		{
			...
			{
				pagina="reportes/tepuy_scg_rpp_libro_diario_legal_excel.php?hidcodemp="+codemp+"&txtfecdes="+txtfecdes
						+"&txtfechas="+txtfechas+"&cmbnivel="+cmbnivel+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte;
				window.open(pagina,"catalogo","menubar=yes,toolbar=yes,scrollbars=yes,width=800,height=600,resizable=yes,location=yes");
			}
		}	
...
function uf_cambio_meses()
{
	 ...
	 f.action="tepuy_scg_r_libro_diario.php";
	 f.submit();
