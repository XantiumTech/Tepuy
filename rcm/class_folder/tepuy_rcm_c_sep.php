<?php
class tepuy_rcm_c_sep
{
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_rcm_c_sep()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_rcm_c_sef
		//		   Access: public 
	...
	function uf_convertir_sepconceptos()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sep MÉTODO->SELECT->uf_convertir_sepconceptos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_sepcuentagasto()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sep MÉTODO->SELECT->uf_convertir_sepcuentagasto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_sepdtarticulos()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sep MÉTODO->SELECT->uf_convertir_sepdtarticulos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_sepdtconcepto()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sep MÉTODO->SELECT->uf_convertir_sepdtconcepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_sepdtservicio()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sep MÉTODO->SELECT->uf_convertir_sepdtservicio ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_sepdtacargos()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sep MÉTODO->SELECT->uf_convertir_sepdtacargos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_sepdtccargos()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sep MÉTODO->SELECT->uf_convertir_sepdtccargos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_sepdtscargos()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sep MÉTODO->SELECT->uf_convertir_sepdtscargos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_sepsolicitud()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sep MÉTODO->SELECT->uf_convertir_sepsolicitud ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_sepsolicitudcargos()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_sep MÉTODO->SELECT->uf_convertir_sepsolicitudcargos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
