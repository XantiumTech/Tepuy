...
var url= "../../php/tepuy_srh_a_evaluacion_eficiencia.php";
var metodo='get';
...
function ue_guardar()
{
  lb_valido=true;
  lb_correcto=false;
  var la_objetos=new Array ("txtnroeval", "txtcodeval", "txtfecha", "txtcodper", "txtcodeva", "txtfecini1", "txtfecfin1", "txtcomsup", "txtobs");
  
 
  var la_mensajes=new Array ("el número de evaluación", "el tipo de evaluacion", "la fecha de la evaluación", "el código del personal", "el código del evaluador", "la fecha inicial del período de evaluación", "la fecha final el período de evaluación", "el comentario del supervisor", "la observación");
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_p_evaluacion_eficiencia.php";
  f.submit(); 
}
...
{
      f= document.form1;
      pagina="../catalogos/tepuy_srh_cat_personal.php?valor_cat=0"+"&tipo=9";
...
{
      f= document.form1;
      pagina="../catalogos/tepuy_srh_cat_personal.php?valor_cat=0"+"&tipo=3";
      window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
{
     f= document.form1;
     pagina="../catalogos/tepuy_srh_cat_tipoevaluacion.php?valor=0";
	 window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_evaluacion_eficiencia.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
...
function consultar_items () {
	 ...
	 if  ( ($('txtcodeval').value=="") ) 		
	 {
	  ...
	  f.operacion.value="CONSULTAR";
  	  f.action="../pantallas/tepuy_srh_p_evaluacion_eficiencia.php";
	  f.existe.value="TRUE";			
	  f.submit();	
	 }
