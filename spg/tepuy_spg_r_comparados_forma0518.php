...
<form name="form1" method="post" action="">
  <table width="500" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="511" colspan="2" class="titulo-ventana"><div align="center">EJECUCI&Oacute;N FINANCIERA DE LAS ACCIONES<br>
      ...
      <td height="40" colspan="3" align="center">      <div align="left">
        <table width="400" height="65" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          ...
          <tr class="titulo-celda">
            <td height="13" colspan="6" valign="top" class="titulo-celdanew"><strong class="titulo-celdanew">Rango Codigo Programatico </strong></td>
          </tr>
          <tr class="formato-blanco">
            ...
            <td width="38"><a href="javascript:catalogo_estpro2();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 2"></a></td>
            </tr>
          <tr class="formato-blanco">
            ...
            <td><a href="javascript:catalogo_estprohas2();"><img src="../shared/imagebank/tools15/buscar.png" width="14" height="17" border="0" alt="Cat&aacute;logo de Estructura Programatica 2"></a></td>
            </tr>
        </table>
      </div></td>
    </tr>
...
function ue_showouput()
{
	...
	{
	   pagina="reportes/tepuy_spg_rpp_comparados_forma0518.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1+"&codestpro2="+codestpro2
	   +"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&tipoformato="+tipoformato;
...
{
	   pagina="tepuy_cat_public_estpro1.php?tipo=reporte0415";
...
function catalogo_estpro2()
{
	...
	if(codestpro1!="")
	{
		pagina="tepuy_cat_public_estpro2.php?codestpro1="+codestpro1+"&tipo=reporte0415";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
	else
	{
       	pagina="tepuy_cat_public_estprorep.php?tipo=reporte";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
}
function catalogo_estprohas1()
{
	   pagina="tepuy_cat_public_estpro1.php?tipo=rephas0415";
	   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
function catalogo_estprohas2()
{
	...
	if((codestpro1h!=""))
	{
		pagina="tepuy_cat_public_estpro2.php?codestpro1="+codestpro1h+"&tipo=rephas0415";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
	else
	{
    	pagina="tepuy_cat_public_estprorep.php?tipo=rephas";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
}
</script>
