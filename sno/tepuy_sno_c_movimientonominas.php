<?PHP
class tepuy_sno_c_movimientonominas
{
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_sno_c_movimientonominas()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_sno_c_movimientonominas
		//		   Access: public 
	...
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_destructor
		//		   Access: public (tepuy_sno_p_movimientonominas)
	...
	function uf_select_nomina($as_codper,&$aa_nominanormal,&$aa_nominaespecial)
	{
		...
		//		   Access: public (tepuy_sno_p_movimientonominas.php)
	...
	function uf_insert_personalnomina($as_codper,$as_codsubnom,$as_codcar,$as_codasicar,$as_codtab,$as_codpas,$as_codgra,$as_codnom,$ai_sueper,$as_codded,$as_codtipper,$as_coduniadm,$aa_seguridad)
	{
		...
		if ($as_coduniadm=="")
		{
			...
			$ls_sql= " INSERT INTO sno_personalnomina (codemp, codnom, codper,codsubnom, codtab, codasicar,  codgra, codpas, sueper, ".
					 ...
					 "			   codclavia, codunirac, fecascper, pagtaqper, grado ".
					 " 		  FROM sno_personalnomina ".
					 "       WHERE codemp='".$this->ls_codemp."' ".
					 "		   AND codnom='".$this->ls_codnom."' ".
		...
		else
		{
			while(($row=$this->io_sql->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$ls_sql="INSERT INTO sno_constantepersonal(codemp,codnom,codper,codcons,moncon)".
						"VALUES('".$this->ls_codemp."','".$as_codnom."','".$as_codper."','".$ls_codcons."','".$li_valcon."')";
