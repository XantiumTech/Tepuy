  ...
  <div align="center">
	...
	?>
      ...
      <tr>
        ...
        <td width="122" height="22"><div align="left">
...
if($ls_operacion=="BUSCAR")
{
	...
	$ls_sql = " SELECT DISTINCT spg_cuenta, max(denominacion) as denominacion
	              FROM spg_cuentas ".
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  if(estmodest==1)
	  {
		  ...
		  f.action="tepuy_cat_ctasrep.php?codestpro1=<?php print $ls_codestpro1;?>&codestpro2=<?php print $ls_codestpro2;?>&codestpro3=<?php print $ls_codestpro3;?>&codestpro1h=<?php print $ls_codestpro1h;?>&codestpro2h=<?php print $ls_codestpro2h;?>&codestpro3h=<?php print $ls_codestpro3h;?>";
		  f.submit();
	  }
	  else
	  {
		  f.operacion.value="BUSCAR";
		  f.action="tepuy_cat_ctasrep.php?codestpro1=<?php print $ls_codestpro1;?>&codestpro2=<?php print $ls_codestpro2;?>&codestpro3=<?php print $ls_codestpro3;?>&codestpro4=<?php print $ls_codestpro4;?>&codestpro5=<?php print $ls_codestpro5;?>&codestpro1h=<?php print $ls_codestpro1h;?>&codestpro2h=<?php print $ls_codestpro2h;?>&codestpro3h=<?php print $ls_codestpro3h;?>&codestpro4h=<?php print $ls_codestpro4h;?>&codestpro5h=<?php print $ls_codestpro5h;?>";
		  f.submit();
	  }	  
  }
