...
var url= "../../php/tepuy_srh_a_evaluacion_pasantia.php";
var metodo='get';
var img="<img src=\"../../../public/imagenes/progress.gif\"> ";


var loadDataURL = "../../php/tepuy_srh_a_evaluacion_pasantia.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_evaluacion_pasantia.php";
var mygrid;
...
function Buscar()
{
	 ...
	 else
	 {
		  ...
		  mygrid.loadXML("../../php/tepuy_srh_a_evaluacion_pasantia.php?valor=buscar"+"&txtnropas="+nropas+"&txtfecevaldes="+fecevaldes+"&txtfecevalhas="+fecevalhas+"&txtcedpas="+cedpas+"&txtnompas="+nompas+"&txtapepas="+apepas);
...
function aceptar (ls_nropas, ls_cedpas,ls_feceval, ls_apepas, ls_nompas, ls_estado, ls_obs, ls_res, ls_nrodestino ,  ls_ceddestino ,  ls_fecevaldestino ,  ls_apedestino ,  ls_nomdestino , ls_estadodestino, ls_obsdestino, ls_resdestino,ls_fecini, ls_fecinidestino)
	
	{
		...
		obj8.value=ls_fecini;
			...
			opener.document.form1.action="../pantallas/tepuy_srh_p_evaluacion_pasantias.php";
