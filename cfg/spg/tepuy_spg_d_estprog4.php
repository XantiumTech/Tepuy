...
<p>
  <?php
	...
	$ls_sistema  = "CFG";
	$ls_ventanas = "tepuy_spg_d_estprog4.php";
 ...
 if ($ls_operacion == "GUARDAR")
	{
	    ...
	    $lb_encontrado = $io_estpro3->uf_spg_select_estprog3($ls_codemp,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3);
	    if ($lb_encontrado)
	       {
		     $lb_existe = $io_estpro4->uf_spg_select_estprog4($ls_codemp,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4); 
		     if (!$lb_existe)
		        {
		          $lb_valido = $io_estpro4->uf_spg_insert_estprog4($ls_codemp,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_denestpro4,$li_estmodest,$la_seguridad);		
			      if ($lb_valido)
			         {
				       $io_sql->commit();
		        ...
		        {
		          $lb_valido = $io_estpro4->uf_spg_update_estprog4($ls_codemp,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_denestpro4,$la_seguridad);		
			      if ($lb_valido)
				     {
				       $io_sql->commit();
...
if ($ls_operacion == "ELIMINAR")
   {
	 ...
	 $ls_codestpro2 = $io_funcion->uf_cerosizquierda($ls_codestpro2,6);
	 $ls_codestpro3 = $io_funcion->uf_cerosizquierda($ls_codestpro3,3);
	 $lb_valido     = $io_estpro4->uf_spg_delete_estpro4($ls_codemp,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_denestpro4,$la_seguridad);
	 if ($lb_valido)
	    {
		  $io_sql->commit();
...
?>
          ...
          <tr class="formato-blanco">
            ...
            <td height="22" colspan="2"><label>
              <input name="txtcodestpro3"  id="txtcodestpro3" type="text" value="<?php print  $ls_codestpro3 ?>" size="<?php print $li_size ?>" maxlength="<?php print $li_maxlength_3 ?>" style="text-align:center" readonly>
          ...
          <tr class="formato-blanco">
            ...
            <td height="22" colspan="2"><div align="left" >
              <label>
              <input name="txtcodestpro4" type="text" id="txtcodestpro4" value="<?php print $ls_codestpro4 ?>" size="<?php print $li_size ?>" maxlength="2" <?php print $readonly?> style="text-align:center" onBlur="javascript:rellenar_cad(this.value,2,'cod')" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz '+'.,-');">
              </label>
            </div></td>
          </tr>
          <tr class="formato-blanco">
...
function ue_buscar()
{
	...
	window.open("tepuy_spg_cat_estpro4.php?txtcodestpro1="+ls_codestpro1+"&txtdenestpro1="+ls_denestpro1+"&txtcodestpro2="+ls_codestpro2+"&txtdenestpro2="+ls_denestpro2+"&txtcodestpro3="+ls_codestpro3+"&txtdenestpro3="+ls_denestpro3,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=50,top=50,location=no,resizable=yes");
}
