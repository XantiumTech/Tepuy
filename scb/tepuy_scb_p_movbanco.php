...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td align="right"><?php if($ls_mov_operacion!="RE")print "Afectación"; ?></td>
    ...
    <tr>
      ...
      <td colspan="5"><div align="left">
          <input name="txtconcepto" type="text" id="txtconcepto" value="<?php print $ls_desmov;?>" size="129" maxlength="1000" onKeyPress="return keyRestrict(event,'0123456789'+'abcdefghijklmnopqrstuvwxyzñ .,*/-()$%&!ºªáéíóú[]{}<>')">
      </div></td>
    </tr>
    <tr>
