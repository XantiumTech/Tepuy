	...
	function uf_print($as_codper, $as_cedper, $as_nomper, $as_apeper, $as_codnom, $as_tipo)
   	{
		...
		$ls_sql="SELECT sno_personal.codper, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_personal.dirper, ".
				...
				"		sno_personal.codcom, sno_personal.codran, sno_personal.numexpper, sno_personal.codpainac, sno_personal.codestnac, sno_personal.enviorec, sno_personal.talcamper, sno_personal.talzapper, sno_personal.talpanper, ".
				"       sno_personal.anoservprecont, sno_personal.anoservprefijo, ". 
	...
	//print $ls_sql;	
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				$ls_obsegrper=rtrim($row["obsegrper"]);			
				...
				switch ($as_tipo)
				{
					case "":
						...
						print "'$ls_descom','$ls_desran','$ls_numexpper','$ls_codpainac','$ls_codestnac','$ls_despainac','$ls_desestnac','$ls_enviorec','$ls_talcamper','$ls_talpanper','$ls_talzapper','$ls_anoprevcont','$ls_anoprevfijo');\">";
...
function aceptar(codper,cedper,nomper,apeper,dirper,fecnacper,edocivper,telhabper,telmovper,sexper,estaper,pesper,codpro,
			     ...
			     hcmper,tipsanper,codcom,codran,descom,desran,numexpper,codpainac,codestnac,despainac,desestnac, enviorec,
				 talcamper, talpanper, talzapper, anoprevcont, anoprevfijo)
{
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="tepuy_snorh_cat_personal.php?codnom=<?PHP print $ls_codnom;?>&tipo=<?PHP print $ls_tipo;?>";
  	f.submit();
}
