<?php
class tepuy_rpc_c_especialidad
{
var $ls_sql;
var $is_msg_error;
	
	function tepuy_rpc_c_especialidad($conn)
	{
...
//////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {               
		 $lb_valido=false;
         $this->is_msg->message("CLASE->tepuy_RPC_C_ESPECIALIDAD; METODO->uf_insert_especialidad; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
       }
	else
	   {
		 $lb_valido=true;
...
////////////////////////////////////////////////////////////////////////////// 
	...
	if ($rs_data===false)
	   {
		 $lb_valido=false;
         $this->is_msg->message("CLASE->tepuy_RPC_C_ESPECIALIDAD; METODO->uf_update_especialidad; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	   }
	else
	   {
		 $lb_valido=true;
  ...
  if (!$lb_relacion)
	 { 		  
	   ...
	   if ($rs_data===false)
		  {
		    $lb_valido=false;
            $this->is_msg->message("CLASE->tepuy_RPC_C_ESPECIALIDAD; METODO->uf_delete_especialidad; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		  }	
       else
	      {
		    $lb_valido=true;
...
////////////////////////////////////////////////////////////////////////////// 
	...
	if ($rs_data===false)
	   {
          $this->is_msg->message("CLASE->tepuy_RPC_C_ESPECIALIDAD; METODO->uf_select_especialidad; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		  $lb_valido=false;
	   }
	else
	   {
...
//////////////////////////////////////////////////////////////////////////////
	...
	if($rs===false)
	  {
		$lb_valido=false;
 	    $this->io_msg->message("CLASE->tepuy_RPC_C_ESPECIALIDAD; METODO->uf_check_relaciones; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	  }
	else
	  {
