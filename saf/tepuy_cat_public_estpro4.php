...
<script language="JavaScript">
  ...
  function aceptar(codestprog,deno)
  {
	...
	opener.document.form1.txtcodestpro4.value=codestprog;
	close();
  }
  ...
  function aceptar_apertura(codestprog,deno)
  {
	...
	opener.document.form1.codestpro4.value=codestprog;
	close();
  }
  ...
  {
	opener.document.form1.codestpro4h.value=codestprog;
  ...
  f.action="tepuy_cat_public_estpro4.php?tipo=<?php print $ls_tipo; ?>";
  f.submit();
  }
</script>
</html>