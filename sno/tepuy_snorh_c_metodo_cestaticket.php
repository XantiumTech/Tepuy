<?PHP
class tepuy_snorh_c_metodo_cestaticket
{
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_snorh_c_metodo_cestaticket()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_snorh_c_metodobanco
		//		   Access: public (tepuy_snorh_r_cestaticket)
	...
	}// end function tepuy_snorh_c_metodo_cestaticket
	//-----------------------------------------------------------------------------------------------------------------------------------
									 ...
									 $as_conceptocero,$as_orden)
	{
		...
		//		   Access: public (desde la clase tepuy_snorh_r_cestaticket)  
...
//---------------------------------------------------------------------------------------------------------------------------------
													...
													$as_punent,$ad_fecha)
	{
		...
		{	
			...
			$ldec_monto=$this->io_funciones->uf_cerosizquierda(number_format($ld_montototal,0,".",""),13);
