...
class tepuy_sno_c_prestamo
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_sno_c_prestamo()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_sno_c_prestamo
		//		   Access: public (tepuy_sno_p_prestamo)
	...
	}// end function tepuy_sno_c_prestamo
	//-----------------------------------------------------------------------------------------------------------------------------------
				...
				if($lb_valido)
				{
					   ...
					   {	
							$lb_valido=$this->uf_insert_prestamo($as_codper,$as_codtippre,$ai_numpre,$as_codconc,$ai_stapre,
																 $ai_monpre, $ai_numcuopre,$as_perinipre,$ai_monamopre,
																 $ad_fecdesper,$ad_fechasper,$ai_sueper,$ai_moncuo,
																 $as_configuracion,$as_tipcuopre,$aa_seguridad);
					   }
	...
	function uf_select_resumen($as_codper,$as_codconc)
	{
		...
		//		   Access: public (tepuy_sno_p_prestamorecalcular) 
		//	    Arguments: as_codper  // código de Personal
		//				   as_codconc  // Código de concepto
	...
	{		
		...
		//		   Access: public (tepuy_sno_p_prestamosuspender) 
		//	    Arguments: as_codper  // Código del Personal
		//				   as_codtippre  // Código del tipo de Prestamo
		//				   ai_numpre  // Número Correlativo del Prestamo
	...
	{		
		...
		//		   Access: public (tepuy_sno_p_prestamorefinanciar) 
		//	    Arguments: as_codper  // Código del Personal
		//				   as_codtippre  // Código del tipo de Prestamo
		//				   ai_numpre  // Número Correlativo del Prestamo
		//				   ai_numcuofalpre  // Número de Cuotas faltantes
	...
	function uf_calcular_prestamo($as_codper,&$ad_dedres,&$ad_totnom,&$ad_priquires,&$ad_segquires)
	{
		...
		//	       Access: public (tepuy_sno_calcularnomina)
		//	    Arguments: as_codper  // codigo del personal
	   ...
	   {			
			while(($row=$this->io_sql->fetch_row($rs_data))&&($lb_valido))
			{
				...
				$ld_cuopre=$row["moncuo"];
				$ls_codconc=$row["codconc"];
				$ld_monamopre=$row["monamopre"];
	...
	{  
		...
		$lb_valido=true;
		$ls_sql="UPDATE sno_prestamos ".
                "   SET monamopre=(SELECT COALESCE(sum(moncuo),0.00) ".
                "                    FROM sno_prestamosperiodo ".
		...
		{
			$ls_sql="UPDATE sno_prestamos ".
					"   SET monamopre=monamopre+(SELECT COALESCE(sum(monamo),0.00) ".
   ...
   //-----------------------------------------------------------------------------------------------------------------------------------
	...
	{		
		...
		//		   Access: public (tepuy_sno_p_prestamoamortizar) 
		//	    Arguments: as_codper  // Código del Personal
		//				   as_codtippre  // Código del tipo de Prestamo
		//				   ai_numpre  // Número Correlativo del Prestamo
		//				   ai_numcuofalpre  // Número de Cuotas faltantes
