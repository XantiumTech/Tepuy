...
class tepuy_siv_c_cargos
{
	...
	function uf_siv_select_cargos($as_codemp,$as_codart,&$ai_totrows,&$ao_object)
	{
		...
		//           Access:  public (tepuy_siv_d_cargos)
		...
		//	    Description:  Funcion que busca los cargos existentes para la empresa en la tabla tepuy_cargos y se trae el 
