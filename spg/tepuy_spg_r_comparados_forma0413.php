...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_comparados_forma0413.php";
...
function ue_showouput()
{
    ...
    if(estmodest==1)
	{
		...
		{
		   pagina="reportes/tepuy_spg_rpp_comparados_forma0413.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
		   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h
		   +"&codestpro3h="+codestpro3h;
	...
	else
	{
		...
		else
		{
		   ...
		   +"&codestpro4h="+codestpro4h+"&codestpro5h="+codestpro5h;
		   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}	
}
