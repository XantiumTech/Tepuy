<?php
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print($as_codestprog1, $as_codestprog2, $as_codestprog3, $as_denominacion, $as_tipo)
   	{
		//////////////////////////////////////////////////////////////////////////////
		//	   Function: uf_print
		...
		//////////////////////////////////////////////////////////////////////////////
		global $io_fun_nomina,$li_len1,$li_len2,$li_len3;
			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch($as_tipo)
				{
					case "":
						...
						print "<td width=30 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$denominacion');\">".trim($ls_codestpro1)."</td>";
					...
					case "asignacioncargo":
						print "<tr class=celdas-blancas>";
						print "<td width=30 align=\"center\"><a href=\"javascript: aceptarasignacion('$ls_codestpro3','$denominacion');\">".trim($ls_codestpro1)."</td>";
						print "<td width=30 align=\"center\">".trim($ls_codestpro2)."</td>";
					...
					case "asignacionaporte":
						print "<tr class=celdas-blancas>";
						print "<td width=30 align=\"center\"><a href=\"javascript: aceptaraporte('$ls_codestpro3','$denominacion');\">".trim($ls_codestpro1)."</td>";
						print "<td width=30 align=\"center\">".trim($ls_codestpro2)."</td>";
						print "<td width=30 align=\"center\">".trim($ls_codestpro3)."</td>";
						print "<td width=130 align=\"left\">".trim($denominacion)."</td>";
						print "</tr>";			
...
function aceptaraporte(codestprog3,deno)
{
	opener.document.form1.txtdenestpro33.value=deno;
	opener.document.form1.txtcodestpro33.value=codestprog3;
...
function ue_search()
{
	...
	f.action="tepuy_snorh_cat_estpre3.php?tipo=<?PHP print $ls_tipo;?>";
	f.submit();
}
</script>
</html>
