...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_desincorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="547" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="543" colspan="2" class="titulo-ventana">Reporte de Desincorporaci&oacute;n</td>
    </tr>
  </table>
      ...
      <td colspan="3" align="center"><div align="left">
        <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <div align="center"><strong>Comprobante</strong></div></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td height="22"><div align="right"></div>              <div align="right"></div>              
            <div align="right">Ascendente
...
<script language="JavaScript">
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			{
				window.open("reportes/tepuy_saf_rpp_desincorporacion.php?orden="+li_orden+"&desde="+ld_desde+"&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
			}
			else
			{
