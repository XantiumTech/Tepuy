...
if (!array_key_exists("la_logusr",$_SESSION))
   ...
   //////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_operacion_por_banco.php";
      ...
      <td colspan="3" align="center"><div align="left">
        <table width="540" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <a href="javascript:catalogo_banco();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a></div></td>
            ...
            <td width="61"><a href="javascript:catalogo_cuenta_banco();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a></td>
          </tr>
        </table>
      </div>        
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		else
		{
			...
			{
				pagina="reportes/tepuy_spg_rpp_operacion_por_banco.php?txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas
...
function catalogo_cuenta_banco()
{
		...
		{
			pagina="tepuy_cat_ctabanco.php?codigo="+txtcodban+"&denban="+denban;
