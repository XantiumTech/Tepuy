...
<?php
	...
	{
		case "NUEVO":
			//$ls_codact= $io_keygen->uf_generar_numero_nuevo("SAF","saf_activo","codact","SAF",15,"","","");
...
<!--        <a href="javascript: ue_sigecof();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0"></a>
-->        <input name="txtdencatsig" type="text" class="sin-borde" id="txtdencatsig" size="45" readonly value="<?php print $ls_densigecof ?>">
    ...
    <tr class="formato-blanco">
      ...
      <td height="22" align="center"><div align="left">
		...
		<?php
			  	if($li_catalogo!=1)
			{?>
        <a href="javascript: ue_cataspg();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0"></a>
		   <?php
			  }
		?>
    ...
    <tr class="formato-blanco">
      ...
      <td height="22"><div align="right"><a href="javascript: ue_guardar();"><img src="../shared/imagebank/tools20/grabar.png" alt="Guardar" width="20" height="20" border="0"></a><a href="javascript: ue_guardar();">Guardar</a><a href="javascript: ue_cancelar();"><img src="../shared/imagebank/eliminar.png" alt="Cancelar" width="15" height="15" border="0"></a><a href="javascript: ue_cancelar();">Cancelar</a> </div></td>
    </tr>
  </table>
</form>      
</body>
...
function ue_sigecof()
{
	...
	{
		ls_tipo="ACTIVOS";
		window.open("tepuy_siv_cat_sigecof.php?tipo="+ls_tipo+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
    }
	else
	{
...
function ue_cataspg()
{
	...
	window.open("tepuy_siv_cat_ctasspg.php?tipo="+ls_tipo+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}
...
function ue_grupo()
{
	...
	{
		ls_tipo="ACTIVOS";
		window.open("../saf/tepuy_saf_cat_grupo.php?tipo="+ls_tipo+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
		alert("La Configuracion de Activos no permite esta opcion");	
...
function ue_subgrupo()
{
	...
	if(f.rbtipocat[1].checked==true)
	{
		...
		window.open("../saf/tepuy_saf_cat_subgrupo.php?tipo="+ls_tipo+"&txtcodgru="+ls_codgru+"&txtdengru="+ls_dengru+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
		alert("La Configuracion de Activos no permite esta opcion");	
...
function ue_seccion()
{
	...
	if(f.rbtipocat[1].checked==true)
	{
		...
		window.open("../saf/tepuy_saf_cat_seccion.php?tipo="+ls_tipo+"&txtcodgru="+ls_codgru+"&txtdengru="+ls_dengru+"&txtcodsubgru="+ls_codsubgru+"&txtdensubgru="+ls_densubgru+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
		alert("La Configuracion de Activos no permite esta opcion");	
...
function ue_guardar()
{
	...
	if((lb_valido)&&(ls_spgcuenta!=""))
	{
		...
		f.action="tepuy_siv_d_registraractivo.php";
		f.submit();
	}
	else
	{
