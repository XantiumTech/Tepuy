<?php
	...
	//  MODIFICADO POR: ING.Miguel PalenciaN         FECHA DE MODIFICACION : 14/08/2007
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    session_start();   
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
		...
		$io_pdf->addText(252,63,7," GERENCIA DE ADMINISTRACIÓN"); // Agregar el título
		$io_pdf->addText(465,122,7,"PRESIDENTE"); // Agregar el título
