...
var loadDataURL = "../../php/tepuy_srh_a_resultados_evaluacion_aspirante.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_resultados_evaluacion_aspirante.php";
var mygrid;
...
{	
	 ...
	 else
	 {
		 ...
		 mygrid.loadXML("../../php/tepuy_srh_a_resultados_evaluacion_aspirante.php?valor=buscar"+"&txtfechades="+fechades+"&txtcodper="+codper+"&txtfechahas="+fechahas);
