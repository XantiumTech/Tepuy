...
&nbsp;&nbsp;&nbsp;
      ...
      <tr class="formato-blanco">
        ...
        <td height="25" colspan="6"><input name="txtnominsact" type="text"  style="text-align: left" id="txtnominsact" readonly="true" size="50" value="<? print $ls_nominsact?>" maxlength="50">          &nbsp;&nbsp;&nbsp;&nbsp;C.I.
        ...
        <a href="javascript:ue_catinspectores();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"  ></a>          <div align="left"></div>        </td><td height="25">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="24">&nbsp;</td>
        <td height="24">&nbsp;</td>
...
function ue_nuevo()
{
 ...
 else
 {
	  ...
	  f.action="tepuy_sob_d_actainicio.php";
	  f.submit();
 } 
}
