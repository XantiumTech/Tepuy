...
<table width="780" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
  <tr>
    <td><div align="right"><img src="../shared/imagebank/tools15/aprobado.png" width="15" height="15"><a href="javascript: uf_procesar();">Procesar Operaci&oacute;n</a> </div></td>
  </tr>
  <tr>
...
{
	f=document.formulario;
	if(opener.document.form1.tiponota[0].checked)
	{
	    ls_tiponota='NC';
	}
	else
