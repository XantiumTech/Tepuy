    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    28/09/2006          Fecha última Modificacion :      Hora :
	   ...
	   $ls_sql=" SELECT *  ".
		...
		if($rs_data===false)
		{   // error interno sql
			$this->io_msg->message("CLASE->tepuy_spi_reporte
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    28/09/2006          Fecha última Modificacion :                Hora :
	  ...
	  $ls_sql=" SELECT *  ".
			  ...
			  "      ( SELECT DISTINCT tepuy_cmp.procede,tepuy_cmp.comprobante,tepuy_cmp.fecha,tepuy_cmp.descripcion, ".
			  "                        tepuy_cmp.total,tepuy_cmp.tipo_destino,tepuy_cmp.cod_pro,rpc_proveedor.nompro, ".
			  "                        tepuy_cmp.ced_bene, ".$ls_cadena." as nombene ".
			  "        FROM tepuy_cmp , spi_dt_cmp , rpc_proveedor , rpc_beneficiario ".
			  "        WHERE rpc_proveedor.cod_pro=tepuy_cmp.cod_pro AND rpc_beneficiario.ced_bene=tepuy_cmp.ced_bene AND ".
			  "              tepuy_cmp.codemp='".$this->ls_codemp."' AND tepuy_cmp.procede=spi_dt_cmp.procede AND  ".
			  "              tepuy_cmp.comprobante=spi_dt_cmp.comprobante AND tepuy_cmp.fecha=spi_dt_cmp.fecha ) TB ".
...
/********************************************************************************************************************************/	
	...
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //	Description :	Método que mediante la operacion de gasto suma o resta los monto de las operaciones
	  ...
	  $ls_opera=$this->tepuy_int_spi->uf_operacion_codigo_mensaje($as_operacion);
	  $ls_mensaje=strtoupper($ls_opera); // devuelve cadena en MAYUSCULAS
	  $li_pos_i=strpos($ls_mensaje,"I"); 
	  if (!($li_pos_i===false)) 
	  { 
    ...
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    28/11/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT CMP.descripcion as cmp_descripcion, CMP.fecha as fecha, MOV.*, ".
	          ...
	          "        CTA.denominacion ".
			  " FROM   spi_dt_cmp MOV, tepuy_cmp CMP,spi_cuentas CTA ".
    ...
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    01/12/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT CMP.descripcion as cmp_descripcion, CMP.fecha as fecha, MOV.*, ".
	          ...
	          "        CTA.denominacion ".
			  " FROM   spi_dtmp_cmp MOV, tepuy_cmp_md CMP,spi_cuentas CTA ".
              " WHERE  CMP.codemp='".$this->ls_codemp."' AND CMP.codemp=MOV.codemp AND  MOV.codemp=.CTA.codemp AND ".
              "        CMP.procede=MOV.procede AND CMP.comprobante=MOV.comprobante AND CMP.fecha=MOV.fecha AND ".
