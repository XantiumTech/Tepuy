<?php
class tepuy_soc_c_aprobacion_analisis_cotizacion
{
  function tepuy_soc_c_aprobacion_analisis_cotizacion($as_path)
  {
	////////////////////////////////////////////////////////////////////////////////////////////////////
	//	     Function: tepuy_soc_c_aprobacion_analisis_cotizacion
	//		   Access: public 
	...
	function uf_load_analisis_cotizacion($as_numanacot,$ad_fecdes,$ad_fechas,$as_tipanacot,$as_tipope)
	{
		...
		if ($as_tipope=='A')//Aprobacion
		   {  
		     $ls_straux = $ls_straux." AND a.estana='0'";
		   }
		elseif($as_tipope=='R')//Reverso.
		   {
			 $ls_straux = $ls_straux." AND a.estana='1' AND a.numanacot not in (SELECT numanacot FROM soc_ordencompra WHERE codemp='$this->ls_codemp')";
		   }
		$ls_sql ="SELECT a.numanacot,a.obsana,a.fecanacot,a.tipsolcot,a.fecapro,b.nompro
	...
	//////////////////////////////////////////////////////////////////////////////
	  ...
	  if ($rs_data===false)
		 {
		   $lb_valido=false;
		   $this->io_mensajes->message("CLASE->tepuy_soc_c_aprobacion_analisis_cotizacion; METODO->uf_update_estatus_aprobacion;ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));	
		 }
	  else
		 {
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
