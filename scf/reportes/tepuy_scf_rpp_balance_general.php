<?php
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_scf->uf_load_seguridad_reporte("SCF","tepuy_scf_r_balance_general.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	switch($ls_tiporeporte)
	{
		case "0":
			...
			$io_report  = new tepuy_scf_class_bal_general();
			$ls_bolivares ="Bs.";
			break;
