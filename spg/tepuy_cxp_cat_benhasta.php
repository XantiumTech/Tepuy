...
<form name="form1" method="post" action="">
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        ...
        <div align="right"><a href="javascript:ue_search();"><img src="../shared/imagebank/tools20/buscar.png" width="20" height="20" border="0" onClick="ue_search()">Buscar Beneficiario</a>        </div></td>
  </table> 
</form>      
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_cxp_cat_benhasta.php";
	  f.submit();
  }
</script>
</html>