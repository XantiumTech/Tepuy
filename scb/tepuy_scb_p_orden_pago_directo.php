...
<!--  <tr>
  ...
  <tr>
    ...
    <td class="toolbar" width="25"><div align="center"><a href="javascript:ue_imprimir();"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" title="Imprimir" width="20" height="20" border="0"></a></div></td>
    ...
    <td class="toolbar" width="25"><div align="center"><a href="javascript:ue_generar_cmp();"><img src="../shared/imagebank/tools20/ejecutar.png"      title="Generar Comprobante de Retenci&oacute;n IVA" alt="Generar Comprobante de Retenci&oacute;n IVA" width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="25"><div align="center"><a href="javascript:ue_generar_cmp_mun();"><img src="../shared/imagebank/tools20/ejecutar.png"  title="Comprobante de Retenci&oacute;n Municipal"   alt="Comprobante de Retenci&oacute;n Municipal" width="20" height="20" border="0"></a></div></td>
    <td class="toolbar" width="25"><div align="center"><a href="javascript:ue_generar_cmp_islr();"><img src="../shared/imagebank/tools20/ejecutar.png" title="Comprobante ISLR"                            alt="Comprobante ISLR" width="20" height="20" border="0"></a></div></td>
...
<?php
	...
	$in_classmovbco=new tepuy_scb_c_ordenpago($la_seguridad);
	require_once("tepuy_scb_c_config.php");
	$io_config=new tepuy_scb_c_config($la_seguridad);
	...
	function uf_nuevo($ls_config_ordpag)
	{
		...
		$objectScg[$li_row][8] = "<a href=javascript:uf_delete_Scg('".$li_row."');><img src=../shared/imagebank/tools15/eliminar.png alt='Eliminar detalle contable' width=15 height=15 border=0></a>";
	}
	...
	if($ls_operacion=="DELETESPG")
	{
		...
		$ldec_montospg=str_replace(",",".",$ldec_montospg);
		$in_classmovbco->io_sql->begin_transaction();
		$lb_valido=$in_classmovbco->uf_delete_dt_spg($ls_docmov,$ls_codban_tesoreria,$ls_ctaban_tesoreria,$ls_mov_operacion,$ls_estmov,$ls_numdoc,$ls_cuenta_spg,$ls_operacion,$ls_programatica,$ldec_montospg);
		$msg->message($in_classmovbco->is_msg_error);
		if($lb_valido)
		{
			$in_classmovbco->io_sql->commit();
...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr class="titulo-ventana">
      <td colspan="6"> Orden de Pago Directa </td>
    </tr>
    <tr>
      <td colspan="6">&nbsp;</td>
    </tr>
    <tr>
      <td width="96" height="22"><div align="right">Modalidad  </div></td>
    ...
    <tr>
      ...
      <td height="22"><div align="left">
        <input name="txtdocumento" type="text" id="txtdocumento" style="text-align:center" value="<?php print $ls_docmov;?>" size="24" maxlength="<?php print $li_size_numordpag;?>" onBlur="javascript:rellenar_cad(this.value,<?php print $li_size_numordpag;?>,'doc')">
      ...
      <td width="84" height="22"><div align="right">Fecha</div></td>
      <td width="166" height="22"><div align="left">
    ...
    <tr>
      ...
      <td height="22" colspan="5"><div align="left">
        <input name="txtcoduniadm" type="text" id="txtcoduniadm" value="<?php print $ls_unidad;?>" size="8" readonly>
    ...
    <tr>
      ...
      <a href="javascript:catalogo_estpro();"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Estructura Presupuestaria" width="15" height="15" border="0"></a></td>
    </tr>
    <tr>
      <td height="22"><div align="right">Nombre Proyecto</div></td>
      <td height="22" colspan="5"><div align="left">
    ...
    <tr>
      ...
      <td height="22" colspan="2"><input name="txtcodbansig" type="text" id="txtcodbansig" style="text-align:center" value="<?php print $ls_codban_tesoreria?>" size="5" maxlength="3" readonly>
        <a href="javascript:catalogo_bancocuenta();"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Estructura Presupuestaria" width="15" height="15" border="0"></a>
    ...
    <tr>
          ...
          <table width="175" border="0" align="left" cellpadding="0" cellspacing="0" class="formato-blanco">
            <tr>
              <td width="173">
                ...
                <div align="left">
                  <input name="rb_provbene" type="radio" class="sin-borde" id="radio" style="width:10 ; height:10" onClick="javascript:uf_verificar_provbene(this.checked,document.form1.tipo.value);" value="P" checked <?php print $rb_p;?>>
                Proveedor                
      ...
      <td height="22" colspan="3"><input name="txtprovbene" type="text" id="txtprovbene" style="text-align:center" value="<?php print $ls_provbene?>" size="24" readonly>
        <a href="javascript:catprovbene()"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Proveedores/Beneficiarios" name="bot_provbene" width="15" height="15" border="0" id="bot_provbene"></a>
    ...
    <tr>
      ...
      <td><input name="opepre" type="text" id="opepre" value="CCP" readonly size="8" maxlength="3" style="text-align:center" >
        <span class="Estilo1">      Compromete Causa y Paga  </span></td>
      <td><div align="right">
	  </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="199"><div align="left">
          <input name="txtmonto" type="text" id="txtmonto" style="text-align:right" onBlur="javascript:uf_format(this);uf_montoobjret(this);" value="<?php print number_format($ldec_montomov,2,",",".");?>" size="24">
      </div></td>
      <td width="102"><div align="right">M. O. R.</div></td>
    ...
    <tr>
      ...
      <td><div align="left">
        <input name="nocontabili" type="checkbox" class="sin-borde" id="nocontabili" style="width:15px; height:15px" value="checkbox" <?php print $lb_nocontab;?>>
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="15"><div align="right">Nro. Documento </div></td>
      <td height="15"><div align="left">
        <input name="txtnumdocres" type="text" id="txtnumdocres" value="<?php print $ls_numdocressig;?>" size="17" maxlength="15">
      </div></td>
      <td height="15"><div align="right">Fecha de Pago </div></td>
      <td height="15"><div align="left">
        <input name="txtfecdocres" type="text" id="txtfecdocres" style="text-align:center" onKeyPress="currencyDate(this);" value="<?php print $ls_fecordpagsig;?>"  size="24" maxlength="10"  datepicker="true">
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22"><div align="right">Nombre Autorizado</div></td>
      <td height="22"><label>
        <div align="left">
          <input name="nombreaut" type="text" id="nombreaut" value="<?php print $ls_nombreaut;?>" size="30" maxlength="60">
        </div>
      </label></td>
      <td height="22"><div align="right">R.I.F.</div></td>
      <td height="22"><div align="left">
        <input name="rifaut" type="text" id="rifaut" value="<?php print $ls_rifaut;?>" size="15" maxlength="10">
      </div></td>
      <td height="22">&nbsp;</td>
      <td height="22">&nbsp;</td>
    </tr>
    <tr>
      <td height="22"><div align="right">Banco</div></td>
      <td height="22"><div align="left">
        <input name="codbanaut" type="text" id="codbanaut" value="<?php print $ls_codbanaut;?>" size="4" maxlength="3">
        <a href="javascript:catbanaut();"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo de Bancos" name="bot_provbene" width="15" height="15" border="0" id="bot_provbene"></a>  
        <input name="nombanaut" type="text" id="nombanaut" value="<?php print $ls_nombanaut;?>" size="21">
      </div></td>
    ...
    <tr>
      <td height="22" colspan="6">&nbsp;&nbsp;<a href="javascript: uf_agregar_dtpre();"><img src="../shared/imagebank/tools/nuevo.png" width="15" height="15" border="0">Agregar detalle Presupuesto</a> <a href="javascript: uf_agregar_dtcargos();"><img src="../shared/imagebank/tools/nuevo.png" alt="Detalle Deducciones" width="15" height="15" border="0">Agregar detalle Cargos </a></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" colspan="6">&nbsp;&nbsp;<a href="javascript: uf_agregar_dtscg(false);"><img src="../shared/imagebank/tools/nuevo.png" alt="Detalle Contable" width="15" height="15" border="0">Agregar detalle Contable </a><a href="javascript: uf_agregar_dtscg(true);"><img src="../shared/imagebank/tools/nuevo.png" alt="Detalle Deducciones" width="15" height="15" border="0">Agregar detalle Retenciones </a> </td>
    </tr>
    <tr>
...
function ue_nuevo()
{
	...
	f.action="tepuy_scb_p_orden_pago_directo.php";
	f.submit();
}
...
function ue_buscar()
{
	window.open("tepuy_cat_mov_orden_pago.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=583,height=400,left=50,top=50,location=no,resizable=yes");
}
...
function ue_imprimir()
{
	...
	{*/
		ls_pagina="reportes/tepuy_scb_rpp_ordenpago.php?codban="+ls_codban+"&ctaban="+ls_ctaban+"&numdoc="+ls_numdoc+"&codope="+ls_codope+"&numdocres="+ls_numdocres+"&fecdocres="+ls_fecdocres+"&nrocontrol="+ls_nrocontrol+"&desope="+ls_desope;
...
function ue_generar_cmp()
{
	...
	ls_provbene=f.txtprovbene.value;
	ls_pagina="reportes/tepuy_scb_rpp_cmpretiva_op?codban="+ls_codban+"&ctaban="+ls_ctaban+"&numdoc="+ls_numdoc+"&codope="+ls_codope+"&numdocres="+ls_numdocres+"&fecdocres="+ls_fecdocres+"&nrocontrol="+ls_nrocontrol+"&desope="+ls_desope+"&monto="+ldec_monto+"&tipodestino="+ls_tipo+"&codpro="+ls_codpro+"&cedbene="+ls_cedbene+"&fecmov="+ld_fecha;
	window.open(ls_pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
}
...
function ue_generar_cmp_mun()
{
	...
	ls_provbene=f.txtprovbene.value;
	ls_pagina="reportes/tepuy_scb_rpp_comp_ret_mun_op.php?codban="+ls_codban+"&ctaban="+ls_ctaban+"&numdoc="+ls_numdoc+"&codope="+ls_codope+"&numdocres="+ls_numdocres+"&fecdocres="+ls_fecdocres+"&nrocontrol="+ls_nrocontrol+"&desope="+ls_desope+"&monto="+ldec_monto+"&tipodestino="+ls_tipo+"&codpro="+ls_codpro+"&cedbene="+ls_cedbene+"&fecmov="+ld_fecha;
	window.open(ls_pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
}
...
function ue_generar_cmp_islr()
{
	...
	ls_provbene=f.txtprovbene.value;
	ls_pagina="reportes/tepuy_scb_rpp_islr.php?codban="+ls_codban+"&ctaban="+ls_ctaban+"&numdoc="+ls_numdoc+"&codope="+ls_codope+"&numdocres="+ls_numdocres+"&fecdocres="+ls_fecdocres+"&nrocontrol="+ls_nrocontrol+"&desope="+ls_desope+"&monto="+ldec_monto+"&tipodestino="+ls_tipo+"&codpro="+ls_codpro+"&cedbene="+ls_cedbene+"&fecmov="+ld_fecha;
	window.open(ls_pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
}
  ...
  function uf_cat_fte_financia()
  {
	...
	function catalogo_cuentabanco()
	 ...
	 function catalogo_bancocuenta()
	 {
	   ...
	   if((ls_status!='C')&&(ls_status!='O')&&(ls_status!='A'))
	   {
		   	pagina="tepuy_cat_bancos_tesoreria.php";
		   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=516,height=400,resizable=yes,location=no");
	   }
	   else
	   {
...
function catprovbene()
{
	...
	if((ls_status!='C')&&(ls_status!='O')&&(ls_status!='A'))
	{
		if(f.rb_provbene[0].checked==true)
		{
			...
			window.open("tepuy_cat_prov_op.php","Catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
		}
		else if(f.rb_provbene[1].checked==true)
		{
			f.txtprovbene.disabled=false;	
			window.open("tepuy_cat_bene_op.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
		}
	}
	else
	{
   ...
   function  uf_agregar_dtcargos()
   {
		...
		if((ls_status!='C')&&(ls_status!='O')&&(ls_status!='A'))
		{
			...
			else
			{
				...
				{
					ls_pagina = "tepuy_w_regdt_cargos_op.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+
									...
									ls_codconmov+"&tip_mov= &opener=tepuy_scb_p_orden_pago_directo.php&estdoc="+ls_estdoc+"&tipdocres="+
   ...
   function  uf_agregar_dtpre()
   {
		...
		if((ls_status!='C')&&(ls_status!='O')&&(ls_status!='A'))
		{
			...
			else
			{
				if((lb_valido)&&(ls_provbene!="")&&(ls_descripcion!="")&&(ls_codban!="")&(ls_ctaban!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto>0))
				{
					ls_pagina = "tepuy_w_regdt_presupuesto_op.php?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+
									ld_fecha+"&procede="+ls_procede+"&tipo="+ls_tipo+"&provbene="+ls_provbene+"&descripcion="+
									ls_descripcion+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&cuenta_scg="+
									ls_cuenta_scg+"&mov_operacion="+ls_operacion+"&monto="+ldec_monto+"&objret="+ldec_objret+"&retenido="+
									ldec_monret+"&chevau="+ls_chevau+"&estint="+li_estint+"&cobrapaga="+li_cobrapaga+"&afectacion="+
	...
	function  uf_agregar_dtscg(lb_retencion)
    {
		...
		if((ls_status!='C')&&(ls_status!='O')&&(ls_status!='A'))
		{
			...
			if(!lb_retencion)
			{
				ls_opener="tepuy_w_regdt_contable_op.php";
				ls_config="scrollbars=no,width=570,height=180";
			}
			else
			{
				ls_opener="tepuy_w_regdt_deducciones_op.php";
			...
			else
			{
				if((lb_valido)&&(ls_provbene!="")&&(ls_descripcion!="")&&(ls_codban!="")&(ls_ctaban!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto>0))
				{
					ls_pagina = ls_opener+"?txtprocedencia=SCBMOV&mov_document="+ls_documento+"&fecha="+
									...
									"&tippag="+ls_tippag+"&mediopago="+ls_mediopago+"&modalidad="+ls_modalidad+"&coduniadm="+ls_coduniadm+"&estuac="+ls_estuac+"&codestpro1="+ls_codestpro1+"&denestpro1="+ls_denestpro1+"&codbansig="+ls_codbansig+
									"&nombreaut="+ls_nombreaut+"&codbanaut="+ls_codbanaut+"&nombanaut="+ls_nombanaut+"&rifaut="+ls_rifaut+"&ctabanaut="+ls_ctabanaut+
									"&codbanbene="+ls_codbanbene+"&ctabanbene="+ls_ctabanbene+"&nombanbene="+ls_nombanbene+"&totalcargo="+ldec_totalcargo;								
    ...
    function catunidadadm()
  	{
		...
		if((ls_status!="C")&&(ls_status!='O')&&(ls_status!='A'))
		{
			pagina="tepuy_spg_cat_unidad.php";
 ...
 function catalogo_estpro()
{
	...
	if((ls_status!="C")&&(ls_status!='O')&&(ls_status!='A'))
	{
		...
		if((li_totpre==0)&&(li_totcon==0))
		{
			if(ls_coduniadm!="")
			{
				pagina="tepuy_cat_estpro_op.php?coduniadm="+ls_coduniadm+"&estuniadm="+ls_estuniadm;
...
function catbanaut()
{
	pagina="tepuy_cat_bancos.php?procede='OP'"
	window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
</script>
