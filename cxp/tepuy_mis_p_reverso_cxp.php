<?Php
	...
	$oi_fun_integrador->uf_load_seguridad("CXP","tepuy_mis_p_reverso_cxp.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
   ...
   function uf_limpiarvariables()
   {
        ...
        $lo_title[1]="";
		$lo_title[2]="Nº de Orden";
		$lo_title[3]="Fecha de la Orden";
		$lo_title[4]="Concepto";
		$lo_title[5]="Detalle";
		$li_widthtable=700;
...
<html>
<head>
<title>Reverso de Contabilizaci&oacute;n de Cuentas por Pagar</title>
		...
		case "PROCESAR":
			...
			for($li_i=1;$li_i<=$li_totrows;$li_i++)
			{
				if(array_key_exists("chksel".$li_i,$_POST))
				{
					...
					$lb_valido=$in_class->uf_reversar_contabilizacion_solicitud_cxp($ls_numsol,$ld_fechaconta,$la_seguridad);
					if($lb_valido)
					{
						$in_class->io_msg->message("La Solicitud de Pago  ".$ls_numsol." fue reversada.");
					}
					else
					{
						$in_class->io_msg->message("No se pudo reversar la Solicitud de Pago ".$ls_numsol);
					}		
				}
			}
			$li_totrows=1;
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td width="432" height="20" colspan="11" bgcolor="#E7E7E7"><table width="762" border="0" align="center" cellpadding="0" cellspacing="0">
      <td width="432" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Orden de Pago -><i>M&oacute;dulo Integrador</i></td>
...
?>	
  ...
  <table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr class="titulo-ventana">
      <td colspan="2">Reversar Contabilizaci&oacute;n de Ordenes de Pago </td>
    </tr>
    <tr>
      <td width="120"  height="23"><div align="right">N&uacute;mero de Orden </div></td>
...
function ue_procesar()
{
	...
	if(li_ejecutar==1)
	{
		...
		if(lb_valido)
		{
			...
			f.action="tepuy_mis_p_reverso_cxp.php";
			f.submit();
		}
		else
		{
...
function uf_verdetalle(numsol)
{
	...
	window.open("tepuy_mis_pdt_cxp.php?numsol="+numsol+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,left="+Xpos+",top="+Ypos+",location=no,resizable=no");
}
...
function ue_buscardestino()
{
	...
	if(descon!="")
	{
		...
		{
			window.open("tepuy_mis_cat_beneficiario.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
		}	
	}
	else
	{
