<?php
	...
	function uf_print_encabezadosolicitud($io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_datos_proveedor
		//		   Access: private 
	...
	function uf_print_pie($io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$io_pdf->addText(55,180,10,"   <i>Sin más a que hacer referencia y en espera de que los lazos de fraternidad entre la Zona Educativa y sus proveedores</i>"); // Agregar titulo
	    $io_pdf->addText(40,165,10,"   <i>se consoliden cada día más, se despide de Usted.</i>");
		$io_pdf->addText(250,140,10,"   <i>Atentamente,</i>");
		$io_pdf->addText(245,100,10,"   <i>Lic. Ana Castillo</i>");
		$io_pdf->addText(210,90,10,"   <i>Jefe (E) Coordinación de Compras.</i>");
		$io_pdf->addText(200,65,8,"2006, Año del Bicentenario del juramento del Generalísimo");
		$io_pdf->addText(180,55,8,"Francisco de Miranda y de la Participación Protagónica y del poder Popular");
	}// end function uf_print_detalle
	//--------------------------------------------------------------------------------------------------------------------------------
				   ...
				   while (($row=$io_sql->fetch_row($rs_data)) && $lb_valido)
						 {
						   ...
						   uf_print_encabezadosolicitud(&$io_pdf);
