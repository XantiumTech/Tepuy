...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_estado_cta.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
if(array_key_exists("operacion",$_POST))
{
	...
	$ld_tiporeporte=$_POST["txttiporeporte"];
}
else
{
	$ls_operacion="";	
...
?>
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="22" style="text-align:right">Orientacion del Reporte</td>
      <td height="22" style="text-align:left">
        <select name="reporte">
  ...
  if (li_imprimir=='1')
     {
       if ((ld_fecdesde!="")&&(ld_fechasta!="")&&(ls_codban!="")&&(ls_ctaban!=""))
          {
	        pagina="reportes/tepuy_scb_rpp_estado_cta_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&orden="+ls_orden+"&tiporeporte="+ls_tiporeporte+"&reporte="+ls_reporte;
