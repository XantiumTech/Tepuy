	...
	if($ls_operacion=="BUSCAR")
	{
		...
		if($row=$io_sql->fetch_row($rs_cta))
		{
			...
			for($z=1;$z<=$totrow;$z++)
			{
				...
				print "<td><a href=\"javascript: aceptar('$ls_codtipart','$ls_dentipart','$ls_obstipart','$ls_status','$ls_coddestino','$ls_dendestino','$ls_obsdestino');\">".$ls_codtipart."</a></td>";
...
<script language="JavaScript">
	function aceptar(ls_codtipart,ls_dentipart,ls_obstipart,hidstatus,ls_coddestino,ls_dendestino,ls_obsdestino)
	{
	...
	function ue_search()
  	{
		...
		f.action="tepuy_catdinamic_tipoarticulo.php";
		f.submit();
	}
</script>
</html>
