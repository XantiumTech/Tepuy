...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SCV";
	$ls_ventanas = "tepuy_rpc_p_transferencia.php";
            ...
            <table width="490"  border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
              ...
              <tr class="formato-blanco">
                ...
                <td height="50"><table width="438" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                  <tr>
                    <td height="26" colspan="4"><strong>Cuenta Contable</strong> <label>
                      ...
                      <a href="javascript:catalogo_cuentas();"><img src="../shared/imagebank/tools15/buscar.png" name="catalogo" width="15" height="15" border="0" id="catalogo" onMouseOver="xstooltip_show('tooltip_cuentas', 'catalogo',0,95);" onMouseOut="xstooltip_hide('tooltip_cuentas');"></a>
	    ...
	    if (lb_marcadas)
		   {
			 ...
			 if (ls_cuenta=="")
				...
				//alert('transferir');
				  ...
				  f.action          = "tepuy_rpc_p_transferencia.php";
				  f.submit();
				}
		   }
		else
