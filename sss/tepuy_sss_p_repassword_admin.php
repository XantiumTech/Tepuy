...
$io_fun_activo->uf_load_seguridad("SSS","tepuy_c_repassword_admin.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<?php
	...
	$ls_sistema="SSS";
	$ls_ventanas="tepuy_c_repassword_admin.php";
...
?>		  
  ...
  <!--<table width="395" height="197" border="0" align="center" cellpadding="0" cellspacing="0" background="imagenes/tepuy.jpg" class="formato-blanco"> -->
  <table width="395" height="190" border="0" align="center" cellpadding="0" cellspacing="0" background="imagenes/tepuy.jpg" class="formato-blancX">
    <tr>
      <td>&nbsp;</td>
      <td colspan="3">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="3"><div align="left">
          ...
          <a href="javascript: ue_buscar();"><img src="../shared/imagebank/tools20/btn_buscar.png" alt="Catalogo de Usuarios" width="15" height="15" border="0"></a>          </div></td>
    </tr>
    <tr>
...
function ue_aceptar()
{
	...
	if(li_ejecutar==1)
	{
		...
		f.action="tepuy_sss_p_repassword_admin.php";
		f.submit();
	}
	else
	{
...
function ue_buscar()
{
	window.open("tepuy_sss_cat_usuarios.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=50,top=50,location=no,resizable=yes");
}
function ue_cerrar()
{
}
