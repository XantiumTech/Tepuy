...
class tepuy_srh_c_registro_metas
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_registro_metas($path)
	{   
...
function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_p_revision_metas)
		//      Argumento: 
...
function uf_srh_guardarregistro_metas($ao_registro,$as_operacion="insertar", $aa_seguridad)
  { 
		...
		//         access: public (tepuy_srh_registro_metas)		   											            
...
}// end   class tepuy_srh_c_registro_metas
?>