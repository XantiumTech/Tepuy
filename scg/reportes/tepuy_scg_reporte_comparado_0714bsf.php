...
/****************************************************************************************************************************************/	
class tepuy_scg_reporte_comparado_0714bsf
{
    //conexion	
	var $sqlca;   
	...
	var $int_spi;
/**********************************************************************************************************************************/	
    function  tepuy_scg_reporte_comparado_0714bsf()
    {
		...
		$this->tepuy_int=new class_tepuy_int();
...
/********************************************************************************************************************************/
    ...
    { /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  //    Fecha Creación :    03/09/2006                       Fecha última Modificacion :      Hora :
  	  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	$ls_sql="SELECT codemp, sc_cuenta, denominacion, status, distribuir, nivel, referencia, (asignadoaux) as asignado, (eneroaux) as enero, ".
			"		(febreroaux) as febrero, (marzoaux) as marzo, (abrilaux) AS abril, (mayoaux) AS mayo, (junioaux) AS junio, ".
			"		(julioaux) as julio, (agostoaux) as agosto, (septiembreaux) AS septiembre, (octubreaux) AS octubre, ".
			"		(noviembreaux) as noviembre, (diciembreaux) AS diciembre ".
              " FROM   scg_cuentas ".
	  ...
	  if($rs_data===false)
	  {   // error interno sql
		    $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0714  MÉTODO->uf_spg_reportes_llenar_datastore_cuentas  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
			$lb_valido = false;
	  }
	  else
	  {
...
/********************************************************************************************************************************/
    ...
    { /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  //    Fecha Creación :    28/08/2006                       Fecha última Modificacion :      Hora :
  	  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql = "SELECT denominacion   FROM   tepuy_plan_unico   WHERE  sc_cuenta='".$as_sc_cuenta."' ";
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
			$lb_valido=false;
		    $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0714  MÉTODO->uf_scg_reportes_select_denominacion  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
		   if($row=$this->io_sql->fetch_row($rs_data))
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    24/08/2006               Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  $lb_valido = false;
	  $ls_sql=" SELECT sum(asignadoaux) as asignado, sum(eneroaux) as enero,sum(febreroaux) as febrero, sum(marzoaux) as marzo, ".
              "        sum(abrilaux) as abril, sum(mayoaux) as mayo,sum(junioaux) as junio, sum(julioaux) as julio, ".
       		  "		   sum(agostoaux) as agosto, sum(septiembreaux) as septiembre,sum(octubreaux) as octubre, ".
              "        sum(noviembreaux) as noviembre,sum(diciembreaux) as diciembre, nivel, status, denominacion ".
              " FROM   scg_pc_reporte ".
	  ...
	  if($rs_data===false)
	  {   // error interno sql
		  $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0714  MÉTODO->uf_scg_reporte_cargar_programado  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		  $lb_valido = false;
	  }
	  else
	  {
...
/**************************************************************************************************************************************/	
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    04/09/2006          Fecha última Modificacion :      Hora :
	  ...
	  $lb_valido=true;
	  //$ls_cuenta_sin_cero=$this->tepuy_int_scg->uf_scg_sin_ceros($as_sc_cuenta);
	  $ls_cuenta=$this->tepuy_int_scg->uf_pad_scg_cuenta( $_SESSION["la_empresa"]["formcont"], $as_sc_cuenta );
	  $ls_sql=" SELECT COALESCE(sum(debe_mesaux),0) as totdebe, COALESCE(sum(haber_mesaux),0) as tothaber ".
              " FROM   scg_saldos ".
...
//	  print $ls_sql."<br>";
	  if($rs_data===false)
	  {   // error interno sql
		  $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0714  MÉTODO->uf_scg_reporte_calcular_ejecutado  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		  $lb_valido = false;
	  }
	  else
	  {
...
/**********************************************************************************************************************************/	
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    04/09/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT COALESCE(sum(debe_mesaux),0) as debe_mes, COALESCE(sum(haber_mesaux),0) as haber_mes ".
              " FROM   scg_saldos ".
              " WHERE  codemp='".$this->ls_codemp."'  AND  sc_cuenta like '".$ls_cuenta."' AND  ".
			  "        fecsal <='".$adt_feshas."' ";
	  //print $ls_sql."<br>";			  
	  ...
	  if($rs_data===false)
	  {   // error interno sql
		  $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0714  MÉTODO->uf_scg_reporte_calcular_ejecutado_acumulado  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		  $lb_valido = false;
	  }
	  else
	  {
...
/**********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    04/09/2006          Fecha última Modificacion :              Hora :
	  ...
	  $ls_sql=" SELECT sum(asignadoaux) as asignado, sum(eneroaux) as enero, ".
              ...
              "        sum(octubreaux) as octubre, sum(noviembreaux) as noviembre, sum(diciembreaux) as diciembre, nivel, status, denominacion ".
              " FROM   scg_pc_reporte ".
              " WHERE  codemp='".$this->ls_codemp."' AND cod_report='".$as_codrep."'  AND  substr(sc_cuenta,1,9)='".$as_sc_cuenta."'  ".
              " GROUP BY sc_cuenta ";
	 $rs_data=$this->io_sql->select($ls_sql);
	 if($rs_data===false)
	 {   // error interno sql
	     $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0714  MÉTODO->uf_scg_reporte_calcular_programado_prox_mes  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		 $lb_valido = false;
	 }
	 else
	 {
...
/**********************************************************************************************************************************/
    ...
    { /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  $ls_sql=" SELECT codemp, codestpro1, codestpro2, codestpro3, codestpro4, codestpro5, spg_cuenta, denominacion, status, ".
	  		  "        sc_cuenta, distribuir, nivel, referencia, (asignadoaux) as asignado, (precomprometidoaux) as precomprometido, ".
			  "		   (comprometidoaux) as comprometido, (causadoaux) as causado, (pagadoaux) as pagado, (aumentoaux) as aumento, ".
			  "		   (disminucionaux) as disminucion, (eneroaux) as enero, (febreroaux) as febrero, (marzoaux) as marzo, ".
			  "		   (abrilaux) as abril, (mayoaux) as mayo, (junioaux) as junio, (julioaux) as julio, (agostoaux) as agosto, ".
			  "		   (septiembreaux) as septiembre, (octubreaux) as octubre, (noviembreaux) as noviembre, (diciembreaux) as diciembre ".
              " FROM   spg_cuentas ".
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 /*$ls_sql=" SELECT DT.fecha, DT.monto, OP.aumento, OP.disminucion, OP.precomprometer,OP.comprometer, OP.causar, OP.pagar ".
	  ...
	  if($rs_data===false)
	  { // error interno sql
		$this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0714  MÉTODO->uf_spg_reporte_calcular_ejecutado  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		$lb_valido = false;
 	  }
	  else
	  {
...
/**********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	     $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0714  MÉTODO->uf_spg_reporte_calcular_programado_prox_mes  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		 $lb_valido = false;
	 }
	 else
	 {
...
/**********************************************************************************************************************************/
    ...
    { /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  $ls_sql=" SELECT codemp, spi_cuenta, denominacion, status, sc_cuenta, distribuir, nivel, referencia, ".
	  		  "        (previstoaux) as previsto, (devengadoaux) as devengado, (cobradoaux) as cobrado, ".
			  "		   (cobrado_anticipadoaux) as cobrado_anticipado, (aumentoaux) as aumento, (disminucionaux) as disminucion, ".
			  "		   (eneroaux) as enero, (febreroaux) as febrero, (marzoaux) as marzo, (abrilaux) as abril, (mayoaux) as mayo, ".
			  "		   (junioaux) as junio, (julioaux) as julio, (agostoaux) as agosto, (septiembreaux) as septiembre, ".
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    25/08/2006         Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT codemp, procede, comprobante, fecha, codban, ctaban, spi_cuenta, procede_doc, documento, operacion, descripcion, orden, (montoaux) AS monto ".
			  " FROM   spi_dt_cmp ".
			  " WHERE  codemp='".$this->ls_codemp."'  AND  spi_cuenta like '".$as_spi_cuenta."'";
	  $rs_data=$this->io_sql->select($ls_sql);
	  if($rs_data===false)
	  { // error interno sql
		$this->io_msg->message("CLASE->tepuy_scg_reporte_comparado_0714bsf  MÉTODO->uf_spi_reporte_calcular_ejecutado  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		$lb_valido = false;
 	  }
	  else
	  {
...
/****************************************************************************************************************************************/
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    04/09/2006          Fecha última Modificacion :              Hora :
	  ...
	  $lb_valido = true;	
	  $ad_monto_programado=0; 
	  $ls_sql=" SELECT sum(eneroaux) as enero,sum(febreroaux) as febrero, sum(marzoaux) as marzo, ".
              "        sum(abrilaux) as abril, sum(mayoaux) as mayo,sum(junioaux) as junio, sum(julioaux) as julio, ".
       		  "		   sum(agostoaux) as agosto, sum(septiembreaux) as septiembre,sum(octubreaux) as octubre, ".
              "        sum(noviembreaux) as noviembre,sum(diciembreaux) as diciembre, nivel, status, denominacion ".
	 ...
	 if($rs_data===false)
	 {   // error interno sql
	     $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0714  MÉTODO->uf_spi_reporte_calcular_programado_prox_mes  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		 $lb_valido = false;
	 }
	 else
	 {
