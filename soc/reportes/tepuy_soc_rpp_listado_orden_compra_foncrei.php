<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_estcondat,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$as_titulo=$as_titulo."".$as_titulo2;
	...
	$ls_titulo ="LISTADO DE LAS ORDENES DE COMPRAS DE ";	
	...
	else // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			uf_print_encabezado_pagina($ls_titulo,$ls_estcondat,$io_pdf); // Imprimimos el encabezado de la página
