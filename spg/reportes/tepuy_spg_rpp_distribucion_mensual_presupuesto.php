...
//--------------------------------------------------  Parámetros para Filtar el Reporte  ------------------------------------
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","tepuy_spg_r_distribucion_mensual_presupuesto.php",$ls_desc_event);
	////////////////////////////////         SEGURIDAD               ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//--------------------------------------------------------------------------------------------------------------------------------
	...
	//	print(" close();");
	 ...
	 else // Imprimimos el reporte
	 {
		...
		$io_pdf->ezSetCmMargins(4.9,3,3,3); // Configuración de los margenes en centímetros
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			if (!empty($ls_programatica_next))
			{
				...
				if($ls_tipoformato==1)
				{
					...
					$ld_total_enero=str_replace('.','',$ld_total_enero);
					$ld_total_enero=str_replace(',','.',$ld_total_enero);		
					$ld_total_febrero=str_replace('.','',$ld_total_febrero);
					$ld_total_febrero=str_replace(',','.',$ld_total_febrero);
					$ld_total_marzo=str_replace('.','',$ld_total_marzo);
					$ld_total_marzo=str_replace(',','.',$ld_total_marzo);		
					$ld_total_abril=str_replace('.','',$ld_total_abril);
					$ld_total_abril=str_replace(',','.',$ld_total_abril);
					$ld_total_mayo=str_replace('.','',$ld_total_mayo);
					$ld_total_mayo=str_replace(',','.',$ld_total_mayo);		
					$ld_total_junio=str_replace('.','',$ld_total_junio);
					$ld_total_junio=str_replace(',','.',$ld_total_junio);
					$ld_total_julio=str_replace('.','',$ld_total_julio);
					$ld_total_julio=str_replace(',','.',$ld_total_julio);		
					$ld_total_agosto=str_replace('.','',$ld_total_agosto);
					$ld_total_agosto=str_replace(',','.',$ld_total_agosto);
					$ld_total_septiembre=str_replace('.','',$ld_total_septiembre);
					$ld_total_septiembre=str_replace(',','.',$ld_total_septiembre);		
					$ld_total_octubre=str_replace('.','',$ld_total_octubre);
					$ld_total_octubre=str_replace(',','.',$ld_total_octubre);
					$ld_total_noviembre=str_replace('.','',$ld_total_noviembre);
					$ld_total_noviembre=str_replace(',','.',$ld_total_noviembre);		
					$ld_total_diciembre=str_replace('.','',$ld_total_diciembre);
					$ld_total_diciembre=str_replace(',','.',$ld_total_diciembre);
					$ld_total_general_cuenta=str_replace('.','',$ld_total_general_cuenta);
					$ld_total_general_cuenta=str_replace(',','.',$ld_total_general_cuenta);
				}
