<?php
	...
	$io_fun_nomina->uf_load_seguridad_nomina("SNO","tepuy_sno_p_abrir_periodo.php",$ls_codnom,$ls_permisos,$la_seguridad,$la_permisos);
	...
	if (li_ejecutar==1)
   	{
		...
		if((contabilizada=="0")&&(aporte=="0")&&(ingreso=="0")&&(fideicomiso=="0"))
		{
			...
			f.action="tepuy_sno_p_abrir_periodo.php";
			f.submit();
		}
		else
		{
