...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_cargo.js"></script>
...
<table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
  ...
  <tr>
    ...
    <td width="202"><div align="right"><a href="javascript: Limpiar_busqueda();"> <img src="../../../public/imagenes/nuevo.png" alt="Limpiar" width="15" height="15" border="0">Limpiar</a></div></td> 
    <td width="197"><div align="right"><a href="javascript: Buscar()"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Haga click aqu&iacute; para Buscar</a></div></td>
...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_cargo.php?valor=createXML_rac";
		var actionURL = "../../php/tepuy_srh_a_cargo.php";
		var mygrid;
	...
	//initialise (from xml) and populate (from xml) grid
		function doOnLoad()
		{
			...
			mygrid.setHeader("Codigo,Denominacion,Disponibilidad");
			mygrid.setInitWidths("110,310,80")
		...
		function Buscar()
		{
		   ...
		   mygrid.loadXML("../../php/tepuy_srh_a_cargo.php?valor=buscar_rac"+"&txtcodcar="+codcar+"&txtdescar="+descar);
