...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_comparados_forma0405.php";
...
<title>EJECUCI&Oacute;N FINANCIERA DE LOS PROYECTOS / ACCIONES CENTRALIZADAS DEL ENTE</title>
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">EJECUCI&Oacute;N FINANCIERA DE LOS<br>
PROYECTOS / ACCIONES CENTRALIZADAS DEL ENTE</td>
    </tr>
  </table>
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td height="18" colspan="3" align="center">      <div align="left">
	   ...
	   ?>
        ...
        <table width="300" height="65" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          <!--DWLayoutTable-->
        ...
        <table width="300" height="65" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
          ...
          <tr class="formato-blanco">
            ...
            <td width="24"><a href="javascript:catalogo_estpro3();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 3"></a></td>
            <td width="20"></td>
            <td width="136"><input name="codestpro4" type="text" id="codestpro4" value="<?php print $ls_codestpro3 ?>" size="22" maxlength="3"></td>
            <td width="24"><a href="javascript:catalogo_estpro3();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 3"></a></td>
            <td width="20"></td>
            <td width="136"><input name="codestpro5" type="text" id="codestpro5" value="<?php print $ls_codestpro3 ?>" size="22" maxlength="3"></td>
            <td width="24"><a href="javascript:catalogo_estpro3();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 3"></a></td>
          </tr>
          <tr class="formato-blanco">
            <td height="29"><div align="right">Hasta</div></td>
            ...
            <td><a href="javascript:catalogo_estprohas3();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 3"></a></td>
            <td></td>
            <td><input name="codestpro4h" type="text" id="codestpro4h" value="<?php print $ls_codestpro3h ?>" size="22" maxlength="3"></td>
            <td><a href="javascript:catalogo_estprohas3();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 3"></a></td>
            <td></td>
            <td><input name="codestpro5h" type="text" id="codestpro5h" value="<?php print $ls_codestpro3h ?>" size="22" maxlength="3"></td>
            <td><a href="javascript:catalogo_estprohas3();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 3"></a></td>
          </tr>
        </table>
       </div>
    ...
    <tr style="display:none">
      <td height="19" colspan="3" align="center"><div align="left"><strong> Reporte en</strong>
    ...
    <tr>
      <td height="22" colspan="3" align="left"><table width="550" height="40" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          <td width="218" height="21"><div align="right">Mes</div></td>
          <td width="330" height="21" ><select name="cmbmes" id="cmbmes">
...
function ue_showouput()
{
    ...
    if(estmodest==1)
	{
		...
		{
		   pagina="reportes/tepuy_spg_rpp_comparados_forma0405.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
		   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h
		   +"&codestpro3h="+codestpro3h+"&tipoformato="+tipoformato;
	...
	else
	{
		...
		else
		{
		   ...
		   +"&codestpro4h="+codestpro4h+"&codestpro5h="+codestpro5h+"&tipoformato="+tipoformato;
		   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}	
}
...
function catalogo_estpro4()
{
	...
	if((codestpro1!="")&&(codestpro2!="")&&(codestpro3!=""))
	{
		pagina="tepuy_cat_public_estpro4.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3
		+"&tipo=reporte";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
	else
...
function catalogo_estpro5()
{
	...
	{
			pagina="tepuy_cat_public_estprograma.php?tipo=reporte";
		    window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
}
...
function catalogo_estprohas4()
{
	...
	if((codestpro1h!="")&&(codestpro2h!="")&&(codestpro3h!=""))
	{
		pagina="tepuy_cat_public_estpro4.php?codestpro1="+codestpro1h+"&codestpro2="+codestpro2h
...
function catalogo_estprohas5()
{
	...
	{
		pagina="tepuy_cat_public_estpro5.php?codestpro1="+codestpro1h+"&codestpro2="+codestpro2h
	...
	{
		pagina="tepuy_cat_public_estprograma.php?tipo=rephas";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
}
</script>
