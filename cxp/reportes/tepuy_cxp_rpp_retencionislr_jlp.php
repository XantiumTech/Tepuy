<?php
	...
	function uf_print_encabezado_pagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->rectangle(25,40,553,620);
		$io_pdf->setStrokeColor(0,0,0);
		$io_pdf->addText(30,710,7,"República Bolivariana de Venezuela"); // Agregar el título
		$io_pdf->addText(30,700,7,"Ministerio de Educación Superior"); // Agregar el título
		$io_pdf->addText(30,690,7,"Colegio Universitario 'Profresor José Lorenzo Perez Rodriguez'"); // Agregar el título
		$io_pdf->addText(30,680,7,"RIF. ".$ls_rif); // Agregar el título
		...
		$li_tm=$io_pdf->getTextWidth(11,$ls_direccion);
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,30,9,$ls_direccion); // Agregar el título
