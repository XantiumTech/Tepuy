...
var url= "../../php/tepuy_srh_a_evaluacion_adiestramiento.php";
var metodo='get';
var img="<img src=\"../../../public/imagenes/progress.gif\"> ";


var loadDataURL = "../../php/tepuy_srh_a_evaluacion_adiestramiento.php?valor=createXML";
...
function Buscar()
		{
		 ...
		 else
		 {
			  ...
			  mygrid.loadXML("../../php/tepuy_srh_a_evaluacion_adiestramiento.php?valor=buscar"+"&txtnroreg="+nroreg+"&txtfechades="+fechades+"&txtfechahas="+fechahas);
		...
		obj15.value=ls_codprov;	
		  ...
		  if(ls_ejecucion=="1")
		   ...
		   opener.document.form1.hidguardar.value = "insertar";	
			...
			opener.document.form1.action="../pantallas/tepuy_srh_p_evaluacion_adiestramiento.php";
...
function catalogo_solicitud_adiestramiento()
{
	...
	window.open("../catalogos/tepuy_srh_cat_solicitud_adiestramiento.php?valor_cat=0"+"&tipo=cat","catalogo2","menubar=no,toolbar=no,scrollbars=yes,width=680,height=500,left=50,top=50,location=no,resizable=yes");
}
