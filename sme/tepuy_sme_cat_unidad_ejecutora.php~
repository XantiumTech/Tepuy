    ...
    <table width="500" border="0" cellpadding="1" cellspacing="0" class="formato-blanco" align="center">
      <tr>
        ...
        <td width="431"><div align="left">
          <input name="txtcoduniadm" type="text" id="txtcoduniadm" size="30" maxlength="3" onKeyPress="javascript: ue_mostrar(this,event);">        
        </div></td>
      </tr>
      <tr>
...
function aceptar_catalogo_sme(coduniadm,denuniadm)
{
	opener.document.formulario.txtcoduniadm.value=coduniadm;
    opener.document.formulario.txtdenuniadm.value=denuniadm;
	close();
