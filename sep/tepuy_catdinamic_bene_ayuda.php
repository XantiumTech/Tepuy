...
$io_classben = new tepuy_sep_c_beneficiario();
...
if ($ls_operacion=="BUSCAR")
   {
     ...
     $ls_sql = "SELECT rpc_beneficiario.codemp, rpc_beneficiario.ced_bene, rpc_beneficiario.codpai, rpc_beneficiario.codest,
					   ...
					   rpc_beneficiario.codban, rpc_beneficiario.ctaban, rpc_beneficiario.fecregben, rpc_beneficiario.nacben, rpc_beneficiario.sc_cuenta_comp,
...
echo "<td  style=text-align:center width=100><a href=\"javascript: aceptar('$ls_cedbene','$ls_nombene','$ls_apebene','$ls_dirbene','$ls_telbene','$ls_celbene','$ls_email','$ls_contable','$ls_denocontable','$ls_contablecomp','$ls_dencontablecomp','$ls_pais','$ls_estado','$ls_municipio','$ls_parroquia','$ls_rifbene','$ls_fecregben','$ls_nacben');\">".$ls_cedbene."</a></td>";
...
function aceptar(cedula,nombre,apellido,direccion,telefono,celular,email,contable,denocontable,contablecomp,dencontablecomp,pais,estado,municipio,parroquia,rifben,ls_fecregben,ls_nacben)
{
	...
	fop.txtcontablecomp.value  = contablecomp;
	fop.txtdencontablecomp.value = dencontablecomp;
...
function ue_search()
{
	...
	f.action="tepuy_catdinamic_bene_ayuda.php";
	f.submit();
}
</script>
</html>
