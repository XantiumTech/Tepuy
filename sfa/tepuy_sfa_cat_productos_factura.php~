...
<html>
<head>
<title>Listado de Productos a Facturar </title>
...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Productos a Facturar</td>
    </tr>
  </table>
<br>
...
<script language="JavaScript">
	function aceptar(ls_codart,ls_denart,li_unidad,li_exipro,ls_coddestino,ls_dendestino,li_linea,combo,li_k)
	{
		...
		if(li_linea>1)
		{
			...
			{
				ls_codartant= eval("opener.document.form1.txtcodart"+li_i+".value");
				//alert(ls_codartant);
				if(ls_codart==ls_codartant)
				{
	...
	function ue_search()
  	{
		...
		f.action="tepuy_sfa_cat_productos_factura.php";
		f.submit();
	}
</script>
</html>
