...
$con=$in->uf_conectar();
require_once("../shared/class_folder/class_tepuy_spgre.php");
$int_spg=new class_tepuy_spgre();
...
{
	$ls_sql="SELECT sig_cuenta,denominacion FROM tepuy_plan_unico_re ".
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_catdinamic_ctaspure.php";
	  f.submit();
  }
