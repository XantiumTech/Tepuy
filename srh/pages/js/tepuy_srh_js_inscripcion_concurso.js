...
var url= "../../php/tepuy_srh_a_inscripcion_concurso.php";
var metodo='get';
...
function ue_buscar()
{
	window.open("../catalogos/tepuy_srh_cat_inscripcion_concurso.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
...
{
  f= document.form1;
  pagina="../catalogos/tepuy_srh_cat_personal.php?valor_cat=0"+"&tipo=14";
  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
function ue_buscar_estudios () 
{
	...
	{ 
	  ...
	  window.open("../catalogos/tepuy_srh_cat_estudios_concursante.php?codper="+codper+"&codcon="+codcon,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
...
function ue_buscar_cursos () 
{
	...
	{ 
	  codper= $('txtcodper').value;
	  codcon= $('txtcodcon').value;
	  window.open("../catalogos/tepuy_srh_cat_cursos_concursante.php?codper="+codper+"&codcon="+codcon,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
...
function ue_buscar_trabajos () 
{
	...
	{ 
	  codper= $('txtcodper').value;
	  codcon= $('txtcodcon').value;
	  window.open("../catalogos/tepuy_srh_cat_trabajos_concursante.php?codper="+codper+"&codcon="+codcon,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
...
function ue_buscar_familiares () 
{
	...
	{ 
	  codper= $('txtcodper').value;
	  codcon= $('txtcodcon').value;
	  window.open("../catalogos/tepuy_srh_cat_familiares_concursante.php?codper="+codper+"&codcon="+codcon,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
...
function ue_buscar_requisitos()
{
	 ...
	 if ((codcon=="") || (codper==""))
	 {
		 alert ('El código del concurso y el código del concurso no pueden estar vacíos. Guarde primero los datos básicos');
	 }
	 else
	 {
	 	window.open("tepuy_srh_p_requitos_concursante.php?codper="+codper+"&codcon="+codcon+"&operacion="+operacion,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=700,height=570,left=50,top=50,location=no,resizable=yes");
	 }
}
