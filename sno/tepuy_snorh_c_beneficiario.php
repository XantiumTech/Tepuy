<?PHP
class tepuy_snorh_c_beneficiario
{
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_snorh_c_beneficiario()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_snorh_c_beneficiario
		//		   Access: public (tepuy_snorh_d_beneficiario)
	...
	}// end function tepuy_snorh_c_beneficiario
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_select_beneficiario($as_codper,$as_codben)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_insert_beneficiario($as_codper,$as_codben,$as_cedben,$as_nomben,$as_apeben,$as_dirben,$as_telben,$as_tipben,
									$as_nomcheben,$ai_porpagben,$ai_monpagben,$as_codban,$as_ctaban,$as_forpagben,$as_nacben,$as_tipcueben,$as_nexben,$as_cedaut,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql="INSERT INTO sno_beneficiario (codemp, codper, codben, cedben, nomben, apeben, dirben, telben, tipben, nomcheben, ".
				"porpagben, monpagben, codban, ctaban, sc_cuenta, forpagben, nacben, tipcueben, nexben,  cedaut) VALUES ('".$this->ls_codemp."','".$as_codper."','".$as_codben."',".
				"'".$as_cedben."','".$as_nomben."','".$as_apeben."','".$as_dirben."','".$as_telben."','".$as_tipben."','".$as_nomcheben."',".$ai_porpagben.",".
				"".$ai_monpagben.",'".$as_codban."','".$as_ctaban."','','".$as_forpagben."','".$as_nacben."','".$as_tipcueben."','".$as_nexben."','".$as_cedaut."')";
	...
	{	
		...
		{
			case "FALSE":
				if($this->uf_select_beneficiario($as_codper,$as_codben)===false)
				{
					$lb_valido=$this->uf_insert_beneficiario($as_codper,$as_codben,$as_cedben,$as_nomben,$as_apeben,$as_dirben,
															 ...
															 $as_codban,$as_ctaban,$as_forpagben,$as_nacben,$as_tipcueben,$as_nexben,$as_cedaut,$aa_seguridad);
				}
				else
				{
			...
			case "TRUE":
				if(($this->uf_select_beneficiario($as_codper,$as_codben)))
				{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_delete_beneficiario($as_codper,$as_codben,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
