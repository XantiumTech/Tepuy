<?php 
class tepuy_sss_c_derechousuarios
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_sss_c_derechousuarios()
	{
	...
	function  uf_sss_insert_permisos_internos($as_codemp,$as_codusu,$as_codsis,$as_codintper,$aa_seguridad)
	{
		...
		$lb_existe=$this->uf_select_permisos_internos($as_codemp,$as_codsis,$as_codusu,$ls_auxcodintper);
		if(!$lb_existe)
		{
			$this->io_sql->begin_transaction();
...
}  // end  class tepuy_sss_c_derecho_usuarios
?>
