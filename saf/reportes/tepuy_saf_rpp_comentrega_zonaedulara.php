<?php
	...
	function uf_print_cabecera($as_codemp,$as_nomemp,$as_coduniadm,$as_denuniadm,$as_codunisol,$as_denunisol,$as_cedres,$as_nomres,&$io_pdf)
	{
		...
		$io_pdf->addText(30,495,9,"Codigo: 010"); // Agregar texto
		$io_pdf->addText(135,495,9,"Denominacion: MINISTERIO DEL PODER POPULAR PARA LA EDUCACION "); // Agregar texto
		...
		$io_pdf->addText(30,461,9,"Codigo: 020 "); // Agregar texto
		$io_pdf->addText(135,461,9,"Denominacion: ".$as_nomemp); // Agregar texto
		...
		$io_pdf->addText(30,430,9,"Codigo: "); // Agregar texto
		$io_pdf->addText(135,427,9,"Denominacion:"); // Agregar texto
	...
	else // Imprimimos el reporte
	{
		...
		$io_fun_activos->uf_load_seguridad_reporte("SAF","tepuy_saf_p_entrega.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////////
