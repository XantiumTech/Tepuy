  ...
  <br>
    <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td height="22"><div align="left">
            <input name="apellido" type="text" id="apellido" size="70" maxlength="254" style="text-align:left">
        </div></td>
      </tr>
      <tr>
        <td height="22">&nbsp;</td>
...
if($ls_operacion=="BUSCAR")
{
	$ls_sql = "SELECT ced_bene,nombene, apebene ".
			  ...
			  " WHERE ced_bene like '".$ls_codigo."' AND nombene like '".$ls_nombre."' AND apebene like '".$ls_apellido."'".
		  ...
		  while ($row=$io_sql->fetch_row($rs_data))
		        {
				  ...
				  print "<td style=text-align:center  width=100><a href=\"javascript: aceptar('$ls_cedben','$ls_nomben'+' '+'$ls_apeben');\">".$ls_cedben."</a></td>";
				  print "<td style=text-align:left  width=400>".$ls_nomben." ".$ls_apeben."</td>";
				  print "</tr>";			
				}
		} 
	 else
