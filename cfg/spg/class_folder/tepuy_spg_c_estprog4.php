<?php
class tepuy_spg_c_estprog4
{
var $is_msg_error;
	
		function tepuy_spg_c_estprog4($conn)
		{
		  require_once("../../shared/class_folder/tepuy_c_seguridad.php");
	      require_once("../../shared/class_folder/class_funciones.php");
          require_once("../../shared/class_folder/class_mensajes.php");
		  require_once("class_folder/tepuy_spg_c_estprog5.php");
		  $this->io_estpro5    = new tepuy_spg_c_estprog5($conn);
...
function uf_spg_select_estprog4($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4)
{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
	 {
 	   $lb_valido=false;
 	   $this->io_msg->message("CLASE->tepuy_SPG_C_ESTPROG4; METODO->uf_spg_select_estprog4; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
...
function uf_spg_insert_estprog4($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_denestpro4,$ai_estmodest,$aa_seguridad)
{
//////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $ls_sql = "INSERT INTO spg_ep4 (codemp,codestpro1,codestpro2,codestpro3,codestpro4,denestpro4) VALUES ('".$as_codemp."','".$as_codestpro1."','".$as_codestpro2."','".$as_codestpro3."','".$as_codestpro4."','".$as_denestpro4."') ";
	 $rs_data = $this->io_sql->execute($ls_sql);
	 if ($rs_data===false)		     
	    {
		  $lb_valido          = false;
 	      $this->is_msg_error = "CLASE->tepuy_SPG_C_ESTPROG4; METODO->uf_spg_insert_estprog4; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);
		 }
	 else
		 {
		   $lb_valido      = true;
		   if ($ai_estmodest=='1')
		      {
			    $lb_valido = $this->io_estpro5->uf_spg_insert_estprog5($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,'00','NINGUNO','--',$ai_estmodest,$aa_seguridad);
			    if (!$lb_valido)
				   {
				     $lb_valido = false;
				     $this->is_msg_error = "CLASE->tepuy_SPG_C_ESTPROG5; METODO->uf_spg_insert_estprog5(Insert Nivel 5 Default); ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);
				   }
			  }
		   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
		   $ls_evento      = "INSERT";
...
function uf_spg_update_estprog4($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_denestpro4,$aa_seguridad)
{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
	 {
	   $lb_valido=false;
 	   $this->io_msg->message("CLASE->tepuy_SPG_C_ESTPROG4; METODO->uf_spg_update_estprog4; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
	   $lb_valido = true;
...
function uf_spg_delete_estpro4($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_denestpro4,$aa_seguridad)
{
  $lb_tiene  = $this->uf_check_relaciones($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4);
  $lb_existe = $this->uf_spg_select_estprog4($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4);
  $lb_valido = false;
  if (($lb_existe) && (!$lb_tiene))
     {
	   ...
	   if ($rs_data===false)
	      {
		    $lb_valido = false;
			$this->is_msg->message("CLASE->tepuy_SPG_C_ESTPROG; METODO->uf_delete_estpro4; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		  }
	   else
	      {
...
function uf_check_relaciones($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4)
{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
	  {
		$lb_valido=false;
        $this->io_msg->message("CLASE->tepuy_SPG_C_ESTPROG4; METODO->uf_check_relaciones; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	  }
	else
	  {
