<?php
	...
	function uf_print_cabecera_detalle($io_encabezado,$as_descripcion,$as_numdoc,$as_fecmov,$as_fecaprmod,$as_tipmodpre,&$io_pdf)
	{
		...
		$ls_texto_2 = "<b>PRESUPUESTARIAS APROBADAS</b>";
		...
		$io_pdf->addText(463,690,10,$ls_texto_1);
		$io_pdf->addText(420,680,10,$ls_texto_2);
		$io_pdf->addText(45,665,10,$ls_texto_3);
		$io_pdf->addText(415,660,10,'N°: '.substr($as_numdoc,8,7));
		$io_pdf->addText(415,640,10,'Fecha Registro     : '.$as_fecaprmod);
		$io_pdf->addText(415,630,10,'Fecha Aprobación: '.$as_fecmov);
	    ...
	    $io_pdf->ezSetY(626.8);
	    $la_datatitulos= array(array('estructura'=>"<b>Est. Presupuestaria</b>",'especifica'=>"<b>Cuenta</b>",
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('estructura'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'especifica'=>array('justification'=>'center','width'=>85), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'center','width'=>185), // Justificación y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('estructura'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'especifica'=>array('justification'=>'center','width'=>85), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>185),
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  -----------------------------------------
		...
		$io_function_report->uf_load_seguridad_reporte("SPG","tepuy_spg_r_modificaciones_presupuestarias_aprobadas.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               ///////////////////////////////////
	...
	/*			    $ls_codestpro1 = substr($ls_codestpro,0,20);
			...
			// ESTA MODIFICACION ME PERMITE VISUALIZAR MEJOR EL CODIGO PRESUPUESTARIO //
				$ls_spg_anterior=$ls_especifica;
				$ls_spgcuenta=substr($ls_especifica,0,7);
