<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_cmpmov,$ad_fecha,&$io_pdf)
	{
		...
		$io_pdf->addText(55,542,8,"<b>Coordinación de Bienes Nacionales</b>"); // Agregar la Fecha
		$io_pdf->addText(75,532,8,"<b>Ministerio de Finanzas</b>"); // Agregar la Fecha
		$io_pdf->addText(78,523,8,"<b>Sistema SIGECOF</b>"); // Agregar la Fecha
	...
	function uf_print_cabecera($as_codemp,$as_nomemp,$ls_coduniadm,$ls_denuniadm,&$io_pdf)
	{
		...
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);
		$io_pdf->rectangle(16,400,966,120);
		...
		$io_pdf->line(17,455,982,455);  // linea horizontal
		$io_pdf->addText(45,445,9,"<b>Dependencia Usuaria (Unidad Solicitante)</b>"); // Agregar texto
		$io_pdf->line(17,440,982,440);  // linea horizontal
		$io_pdf->line(95,420,95,440);   //linea vertical
		$io_pdf->addText(30,430,9,''); // Agregar texto
		$io_pdf->addText(100,430,9,''); // Agregar texto
		$io_pdf->line(17,420,982,420);  // linea horizontal
		$io_pdf->addText(45,410,9,"<b>Almacén Responsable</b>"); // Agregar texto
		$io_pdf->ezSetY(402);
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_columna=array('cantidad'=>'<b>Cantidad</b>',
						  ...
						  'codcau'=>'<b>                                                  Reasignación                                                                            Código                      Descripción</b>',
...
///////////////////////////////////////////         Cuadro Inferior        /////////////////////////////////////////////////////////
		...
		$io_pdf->addText(700,58,9,"<b>Fecha de Recepción</b>"); // Agregar texto
	...
	else // Imprimimos el reporte
	{
		...
		if($lb_valido)
		{
			...
			for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
			{
				...
				//if(($ls_codpai!="")&&($ls_codest!="")&&($ls_codmun!=""))
				{ 
