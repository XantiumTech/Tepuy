<?PHP
	...
	switch($ls_tiporeporte)
	{
		...
		case "1":
			if($_SESSION["la_nomina"]["tiponomina"]=="NORMAL")
			{
				require_once("tepuy_sno_class_report_contablesbsf.php");
				$io_report=new tepuy_sno_class_report_contablesbsf();
				$li_tipo=1;
			}
			if($_SESSION["la_nomina"]["tiponomina"]=="HISTORICA")
			{
				require_once("tepuy_sno_class_report_historico_contablesbsf.php");
				$io_report=new tepuy_sno_class_report_historico_contablesbsf();
				$li_tipo=2;
			}	
			$ls_bolivares ="Bs.F.";
			break;
	...
	else // Imprimimos el reporte
	{
		...
		{
			$ls_programatica=rtrim($io_report->DS->data["programatica"][$li_i]);
			switch($ls_modalidad)
			{
