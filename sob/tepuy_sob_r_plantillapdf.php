...
//-------------------------------------------------------------------------------------------------------------//
		/////////////////////////////////////////////////////////////////////////////////
		//       Function: tepuy_sob_r_plantillapdf                    			   // 													   //
		//    Description: Llamadas a funciones de la clase tepuy_sob_r_plantillapdf  //
	...
	require_once("class_folder/tepuy_sob_c_plantillapdf.php");
	...
	if(isset($_SESSION["tituloscabecera"]))//Esto sucede solo si el reporte es estilo cabecera-detalle
	{
		...
		$io_classpdf=new tepuy_sob_c_plantillapdf($la_data,$la_tituloscabecera,$la_titulosdetalle,$ls_tituloencabezado,
													$ls_fechadesde,$ls_fechahasta,
													"C:/sitioweb/tepuy_php/SOB/Imagenes/LogoGobOficial8estrellas.jpg"
	...
	{
		$io_classpdf=new tepuy_sob_c_plantillapdf($la_data,"",$la_titulosdetalle,$ls_tituloencabezado,$ls_fechadesde,
													$ls_fechahasta,"C:/sitioweb/tepuy_php/SOB/Imagenes/LogoGobOficial8estrellas.jpg",
