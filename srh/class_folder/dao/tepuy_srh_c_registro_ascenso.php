...
class tepuy_srh_c_registro_ascenso
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_registro_ascenso($path)
	{   
	 ...
	 function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_p_registro_ascenso)
		//      Argumento: 
...
function uf_srh_guardarregistro_ascenso ($po_postulacion,$ps_operacion="insertar", $aa_seguridad)
  { 
		...
		//         access: public (tepuy_srh_registro_ascenso)														
...
function uf_srh_guardar_trabajador ($po_postulacion, $aa_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_registro_ascenso)															
...
}// end   class tepuy_srh_c_registro_ascenso
?>