...
<form name="form1" method="post" action="">
  <p align="center">
	...
	if($ls_operacion=="BUSCAR")
	{
	    ...
	    $ls_codestprog2=$io_function->uf_cerosizquierda($ls_codestprog2,6);
	    $ls_codestprog3=$io_function->uf_cerosizquierda($ls_codestprog3,3);
	    $ls_codestprog4=$io_function->uf_cerosizquierda($ls_codestprog4,2);
		$ls_sql=" SELECT codestpro1,codestpro2,codestpro3,codestpro4,codestpro5,denestpro5 ".
				...
				"        codestpro2 ='".$ls_codestprog2."' AND  codestpro3 ='".$ls_codestprog3."' AND ".
                "        codestpro4 ='".$ls_codestprog4."' AND  codestpro5 like '".$ls_codigo."'  AND  ".               
			    "        denestpro5 like '".$ls_denominacion."' ";
		...
		if($row=$io_sql->fetch_row($rs_data))
		{
			...
			for($z=1;$z<=$li_totrow;$z++)
			{
				...
				if($ls_tipo=="reporte")		
				{
					...
					print "<td width=30 align=\"center\"><a href=\"javascript: aceptar_rep('$codigo');\">".
					trim($codestprog2)."</td>";
					print "<td width=30 align=\"center\"><a href=\"javascript: aceptar('$codigo');\">".
					trim($codestprog3)."</td>";
					print "<td width=30 align=\"center\"><a href=\"javascript: aceptar('$codigo');\">".
					trim($codestprog4)."</td>";
					print "<td width=30 align=\"center\"><a href=\"javascript: aceptar_rep('$codigo');\">".
...
<script language="JavaScript">
  ...
  f.action="tepuy_cat_public_estpro5.php?tipo=<?php print $ls_tipo; ?>";
  f.submit();
  }
</script>
</html>