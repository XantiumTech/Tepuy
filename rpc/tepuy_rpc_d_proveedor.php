...
?>  
 <p>&nbsp;  </p>
   ...
   <table width="770"  border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
    ...
    <tr>
      <td height="22" align="right"> <span class="sin-borde"><strong>(*)</strong></span> Cuenta Contable&nbsp;</td>
				                            ...
				                            if (valida_null(txtcapital,"El Capital esta vacio!!")==false) 
				                               ...
				                               {//17
					                             if (valida_null(txtmonmax,"El monto esta vacio!")==false) 
					                                ...
					                                {//19
													       if (valida_null(txtcontable,"El Código Contable Asociado al Proveedor esta vacio!")==false) 
					                                          {//22
						                                        txtcontable.focus();
					                                          }//22
					                                       else
