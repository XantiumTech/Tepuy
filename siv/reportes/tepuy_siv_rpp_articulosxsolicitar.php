<?php
	...
	else // Imprimimos el reporte
	{
		...
		$io_fun_inventario->uf_load_seguridad_reporte("SIV","tepuy_siv_r_articuloxsolicitar.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               ///////////////////////////////////////////////////
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$li_exiart= $io_report->ds->data["exiart"][$li_i];
			$li_minart= $io_report->ds->data["minart"][$li_i];
			$li_reoart= $io_report->ds->data["reoart"][$li_i];
