...
class tepuy_becas_c_nominas
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_becas_c_nominas()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		require_once("tepuy_becas_c_dedicacion.php");
		$this->io_dedicacion=new tepuy_becas_c_dedicacion();		
		require_once("tepuy_becas_c_tipopersonal.php");
		$this->io_tipopersonal=new tepuy_becas_c_tipopersonal();		
		require_once("tepuy_becas_c_escaladocente.php");
		$this->io_escaladocente=new tepuy_becas_c_escaladocente();		
		require_once("tepuy_becas_c_clasifidocente.php");
		$this->io_clasificaciondocente=new tepuy_becas_c_clasifidocente();		
		require_once("tepuy_becas_c_ubicacionfisica.php");
		$this->io_ubicacion=new tepuy_becas_c_ubicacionfisica();		
		require_once("tepuy_becas_c_clasificacionobreros.php");
		$this->io_obreros=new tepuy_becas_c_clasificacionobreros();		
	...
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_destructor
		//		   Access: public (tepuy_becas_d_nominas)
	...
	function uf_load_periodo($as_codnom,&$ai_totrows,&$ao_object)
	{
		...
		//		   Access: public (tepuy_becas_d_tablavacacion)
	...
	function uf_load_periodo_establecer($as_codnom,&$ai_totrows,&$ao_object)
	{
		...
		//		   Access: public (tepuy_becas_d_establecer_periodo)
		//	    Arguments: as_codnom  //  código de la nómina
		//	    		   ai_totrows  // total de filas del detalle
		//				   ao_object  // objetos del detalle
		//	      Returns: lb_valido True si se ejecuto el buscar ó False si hubo error en el buscar
	...
	function uf_load_nominas_reportar(&$ai_totrows,&$ao_object)
	{
		...
		//		   Access: public (tepuy_becas_r_retencion_arc)
