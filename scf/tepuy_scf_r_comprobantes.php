<?php
	...
	$io_fun_scf->uf_load_seguridad("SCF","tepuy_scf_r_comprobantes.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<?php
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	$io_fun_scf->uf_print_permisos($ls_permisos,$la_permisos,$ls_logusr,"location.href='tepuywindow_blank.php'");
	unset($io_fun_scf);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>		  
      ...
      <td height="136"><p>&nbsp;</p>
          <table width="600" height="22" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
            ...
            <tr>
              ...
              <a href="javascript:ue_buscarcomprobante('REPDES')"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Cuentas" width="15" height="15" border="0"></a></div></td>
              <td align="center"><div align="right">Hasta</div></td>
              <td align="center"><div align="left">
                  <input name="txtcomprobantehasta" type="text" id="txtcomprobantehasta" size="22">
              <a href="javascript:ue_buscarcomprobante('REPHAS')"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Cuentas" width="15" height="15" border="0"></a></div></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td align="center"><div align="left">
                ...
                <a href="javascript:ue_buscarprocede('REPDES')"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Cuentas" width="15" height="15" border="0"></a></div></td>
              <td align="center"><div align="right">Hasta</div></td>
              <td align="center"><div align="left">
                <input name="txtprocedehasta" type="text" id="txtprocedehasta" size="22" maxlength="6">
                <a href="javascript:ue_buscarprocede('REPHAS')"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Cuentas" width="15" height="15" border="0"></a></div></td>
            </tr>
            <tr class="titulo-celdanew">
...
function ue_search()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/tepuy_scf_rpp_comprobantes.php?fecdes="+fecdes+"&fechas="+fechas+"&orden="+orden;
...
function ue_openexcel()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/tepuy_scf_rpp_comprobantes_excel.php?fecdes="+fecdes+"&fechas="+fechas+"&orden="+orden;
			pagina=pagina+"&comprobantedesde="+comprobantedesde+"&comprobantehasta="+comprobantehasta;
			pagina=pagina+"&procededesde="+procededesde+"&procedehasta="+procedehasta+"&tiporeporte="+tiporeporte;
			window.open(pagina,"Reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
...
{
	window.open("tepuy_scf_cat_comprobante.php?tipo="+tipo,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=620,height=400,resizable=yes,location=no");
}

function ue_buscarprocede(tipo)
{
	window.open("tepuy_scf_cat_procede.php?tipo="+tipo,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,resizable=yes,location=no");
}
</script>
