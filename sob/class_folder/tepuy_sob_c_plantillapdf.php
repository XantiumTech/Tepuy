<?PHP
class tepuy_sob_c_plantillapdf
{
	...
	function tepuy_sob_c_plantillapdf($aa_data,$aa_tituloscabecera,$aa_titulosdetalle,$as_tituloencabezado,$as_fechadesde,$as_fechahasta,$as_imagen="",$ai_anchoimagen=0,$ai_altoimagen=0,
										$ai_margenderecho,$ai_margenizquierdo,$ai_margensuperior,
										$ai_margeninferior,$as_orientacion="landscape")
	{
		////////////////////////////////////////////////////////
		//       Function: tepuy_sob_c_plantillapdf
		//		    Acess: private 
