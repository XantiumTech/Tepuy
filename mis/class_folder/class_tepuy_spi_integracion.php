<?php
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////////////////
class class_tepuy_spi_integracion
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function class_tepuy_spi_integracion()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: class_tepuy_spi_integracion
		//		   Access: public 
		...
		$this->io_tepuy_spi=new class_tepuy_int_spi();
		...
		$this->as_codban="";
		$this->as_ctaban="";
	}// end function class_tepuy_spi_integracion
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_destroy_objects()
	{
		...
		if( is_object($this->io_tepuy_spg) ) { unset($this->io_tepuy_spg);  }
		if( is_object($this->io_tepuy_spi) ) { unset($this->io_tepuy_spi);  }
														  ...
														  $ld_fecaprob,$aa_seguridad)
	{
		...
		$lb_valido=$this->io_tepuy_int->uf_int_init($ls_codemp,$ls_procede,$ls_comprobante,$ld_fecaprob,$ls_descripcion,
		...
		$this->io_tepuy_int->uf_int_init_transaction_begin(); // inicia transacción SQL
											   ...
											   $ls_codigo_destino)
	{
		...
		{           
			while($row=$this->io_sql->fetch_row($rs_data) and ($lb_valido))
			{
				...
				$lb_valido=$this->io_tepuy_int->uf_scg_insert_datastore($ls_codemp,$ls_scg_cuenta,$ls_debhab,$ldec_monto,$ls_documento,$ls_procede,$ls_descripcion);								
				if ($lb_valido===false)
				{  
					$this->io_msg->message("ERROR -> ".$this->io_tepuy_int->is_msg_error);
					break;
	...
	function uf_procesar_detalles_ingreso_spi($as_codemp,$as_procede,$as_comprobante,$ad_fecha,$as_descripcion,$as_tipo_destino,$as_codigo_destino)
	{
		...
		{           
   	       while($row=$this->io_sql->fetch_row($rs_data) and ($lb_valido))
		   {
				...
				$ls_mensaje=$this->io_tepuy_spi->uf_operacion_codigo_mensaje($row["operacion"]);
				$ls_spi_cuenta=$this->io_tepuy_spi->uf_spi_pad_cuenta($ls_spi_cuenta);
				$lb_valido=$this->io_tepuy_int->uf_spi_insert_datastore($as_codemp,$ls_spi_cuenta,$ls_operacion,
    ...
    function uf_reversar_contabilizacion_modpre_spi($as_comprobante,$ad_fecha,$as_procede,$as_descripcion,$ad_fechaconta,$aa_seguridad)	
	{
		...
		//		   Access: public (tepuy_mis_p_reverso_mp_spi.php)
		//	    Arguments: as_comprobante  // Código de Comprobante
		//				   ad_fecha  // Fecha de contabilización
		//				   as_procede  // Procede del Documento
		//				   as_descripcion  // Descripción del Documento
