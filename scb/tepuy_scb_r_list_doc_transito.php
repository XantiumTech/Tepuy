...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_list_doc_transito.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<html>
<head>
<title>Documentos en Tr&aacute;nsito</title>
  ...
  if (li_imprimir=='1')
     {
       if ((ls_periodo!="")&&(ls_codban!="")&&(ls_ctaban!=""))
          {
	        pagina="reportes/tepuy_scb_rpp_list_doc_transito.php?periodo="+ls_periodo+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&orden="+ls_orden+"&denban="+ls_denban+"&dencta="+ls_dencta+"&tiporeporte="+ls_tiporeporte;
