<?php 
class tepuy_sss_c_usuariosnominas
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_sss_c_usuariosnominas()
	{
	...
	function  uf_sss_select_usuario_nomina($as_codemp,$as_codnom,$as_codusu)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->usuariosnominas MÉTODO->uf_sss_select_usuario_nomina ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function  uf_sss_load_usuarios($as_codemp,&$aa_usuarios)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->usuariosnominas MÉTODO->uf_sss_load_usuarios ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$li_pos=0;
	...
	//---------------------------------------------------------------------------------------------------------------------------
	function  uf_sss_load_nominasdisponibles($as_codemp,$as_codusu,&$aa_disponibles)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->usuariosnominas MÉTODO->uf_sss_load_nominasdisponibles ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$li_pos=0;
	...
	//---------------------------------------------------------------------------------------------------------------------------
	function  uf_sss_load_nominasasignadas($as_codemp,$as_codusu,&$aa_asignados)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql= "SELECT codintper,".
				 ...
				 "   WHERE sno_nomina.codemp=sss_permisos_internos.codemp".
				 "     AND sno_nomina.codnom=sss_permisos_internos.codintper )as desnom".
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->usuariosnominas MÉTODO->uf_sss_load_nominasasignadas ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$li_pos=0;
	...
	function  uf_sss_insert_usuario_nomina($as_codemp,$as_codnom,$as_codusu,$aa_seguridad)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->usuariosnominas MÉTODO->uf_sss_insert_usuario_nomina ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$lb_valido=true;
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
			$ls_evento="INSERT";
			$ls_descripcion ="Relacionó la Nomina ".$as_codnom." al usuario ".$as_codusu." Asociado a la empresa ".$as_codemp;
	...
	function uf_sss_delete_usuario_nomina($as_codemp,$as_codnom,$as_codusu,$aa_seguridad)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->usuariosnominas MÉTODO->uf_sss_delete_usuario_nomina ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{ 
											...
											$ai_ejecutar,$as_codintper)
	{
		...
		if($li_row===false)
		{
			$this->io_msg->message("CLASE->usuariosnominas MÉTODO->uf_sss_insert_derecho_usuario ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$lb_valido=true;
	...
	function  uf_sss_delete_permisos($as_codemp,$as_codnom,$as_codusu,$aa_seguridad)
	{
		...
		if($rs_data===false)
		{
			$this->io_msg->message("CLASE->usuariosnominas MÉTODO->uf_sss_delete_permisos ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
}//  end  class tepuy_sss_c_usuarios_grupos
