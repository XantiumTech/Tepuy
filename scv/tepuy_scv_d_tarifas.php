...
$io_fun_viaticos->uf_load_seguridad("SCV","tepuy_scv_d_tarifas.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
   function uf_limpiarvariables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		...
   		global $li_monpas,$li_monhos,$li_monali,$li_monmov,$ls_codnom,$ls_desnom,$ls_codcat,$ls_dencat,$ls_readonly;
...
<!--  <tr>
  ...
  <tr>
    <td height="42" colspan="7" bgcolor="#FFFFFF" class="toolbar">&nbsp;</td>
  </tr>
  <tr> 
    <td width="20" height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_nuevo();"><img src="../shared/imagebank/tools20/nuevo.png" alt="Nuevo" width="20" height="20" border="0"></a></td>
    <td width="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_guardar();"><img src="../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0"></a></td>
    <td width="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_buscar();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"></a></td>
    <td width="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_eliminar();"><img src="../shared/imagebank/tools20/eliminar.png" alt="Eliminar" width="20" height="20" border="0"></a></td>
    <td width="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_cerrar();"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a></td>
    <td width="20" bgcolor="#FFFFFF" class="toolbar"><img src="../shared/imagebank/tools20/ayuda.png" alt="Ayuda" width="20" height="20"></td>
...
<?php 
	...
	require_once("class_folder/tepuy_scv_c_tarifas.php");
	$io_scv= new tepuy_scv_c_tarifas();
	...
	switch($ls_operacion)
	{
		...
		case "GUARDAR":
			...
			else
			{
				...
				{
					$io_msg->message("La tarifa de viáticos ya esta encuentra registrada");
				}
			}
        ...
        <table width="563"  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td height="22"><input name="txtcodcat" type="text" id="txtcodcat" style="text-align:center" value="<?php print $ls_codcat;  ?>" size="5" readonly>
                <a href="javascript:ue_catanomina();"></a><a href="javascript:ue_catacategorias();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
          ...
          <tr>
            ...
            <td height="22"><input name="txtcodnom" type="text" id="txtcodnom" style="text-align:center" value="<?php print $ls_codnom;  ?>" size="8" readonly>
                <a href="javascript:ue_catanomina();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a> <a href="javascript:ue_catacategorias();"></a>
...
//			{
			?>
			  <a href="javascript:ue_catapais();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
			<?php
//			}
			?>             
          ...
          <tr>
            ...
            <td height="22"><input name="txtcodreg" type="text" id="txtcodreg" value="<?php print $ls_codreg  ?>" size="10" style="text-align:center" readonly>
              <a href="javascript:ue_cataregion();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
              <label>
          ...
          <tr>
            <td height="22"><div align="right">Monto Alimentaci&oacute;n s/Pernota </div></td>
          ...
          <tr>
            <td height="22"><div align="right">Monto Alimentaci&oacute;n c/Pernota</div></td>
...
{
	window.open("tepuy_scv_cat_nominas.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}

function ue_catacategorias()
{
	window.open("tepuy_scv_cat_categorias.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}

function ue_catapais()
{
	window.open("tepuy_scv_cat_pais.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}
...
function ue_cataregion()
{
	...
	window.open("tepuy_scv_cat_regiones.php?catalogo=1&hidpais="+codpai+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}
function ue_nuevo()
{
	f=document.form1;
	...
	{			 
		...
		f.action="tepuy_scv_d_tarifas.php";
		f.submit();
	}
	else
	{
...
function ue_buscar()
{
	...
	if (li_leer==1)
	{
		...
		pagina="tepuy_scv_cat_tarifas.php?destino="+ls_destino+"";
