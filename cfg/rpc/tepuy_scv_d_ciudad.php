...
$io_fun_viaticos->uf_load_seguridad("CFG","tepuy_scv_d_ciudad.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td width="21" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_nuevo();"><img src="../../shared/imagebank/tools20/nuevo.png" alt="Nuevo" width="20" height="20" border="0"></a></td>
    ...
    <td width="20" bgcolor="#FFFFFF" class="toolbar"><a href="../rpc/tepuywindow_blank.php"><img src="../../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a></td>
...
require_once("class_folder/tepuy_scv_c_ciudad.php");
...
$io_scv       = new tepuy_scv_c_ciudad($conn);
...
function ue_nuevo()
{
	...
	{	
		...
		f.action="tepuy_scv_d_ciudad.php";
		f.submit();
	}
	else
	{
	...
	if (li_leer==1)
	{
		...
		else
		{
			...
			{   
				...
				pagina="tepuy_scv_cat_ciudades.php?hidestado="+ls_estado+"&hidpais="+ls_pais;
