<?php
class tepuy_cxp_c_clasificaci
{
var $ls_sql;
var $is_msg_error;
	
	function tepuy_cxp_c_clasificaci($conn)
	{
...
function uf_insert_clasificador($as_codclas,$as_denclas,$aa_seguridad) 
{
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////  
  $ls_sql  = " INSERT INTO cxp_clasificador_rd (codcla,dencla) VALUES ('".$as_codclas."','".$as_denclas."')";
  $rs_data = $this->io_sql->execute($ls_sql);
  if ($rs_data===false)
	 {
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->tepuy_CXP_C_CLASIFICACI; METODO->uf_insert_clasificador; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 } 
  else
	 {
	   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
function uf_update_clasificador($as_codclas,$as_denclas,$aa_seguridad) 
{
//////////////////////////////////////////////////////////////////////////////
...
// Fecha de Creación:  20/02/2006       Fecha Última Actualización:28/03/2006.	 
//////////////////////////////////////////////////////////////////////////////  
  $ls_sql=" UPDATE cxp_clasificador_rd SET dencla='".$as_denclas."' WHERE codcla='" .$as_codclas. "'";
  $this->io_sql->begin_transaction();
  $rs_data=$this->io_sql->execute($ls_sql);
  if ($rs_data===false)
	 {
       $lb_valido=false;
	   $this->io_msg->message("CLASE->tepuy_CXP_C_CLASIFICACI; METODO->uf_update_clasificador; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
	   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
//////////////////////////////////////////////////////////////////////////////  
  ...
  if ($rs_data===false)
     {
	   $lb_valido=false;
	   $this->io_msg->message("CLASE->tepuy_CXP_C_CLASIFICACI; METODO->uf_delete_clasificador; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
     {
	   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
	 {
	   $lb_valido=false;
  	   $this->io_msg->message("CLASE->tepuy_CXP_C_CLASIFICACI; METODO->uf_select_clasificador; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
