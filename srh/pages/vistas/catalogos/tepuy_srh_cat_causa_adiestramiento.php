...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_causa_adiestramiento.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_causa_adiestramiento.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_causa_adiestramiento.php?valor=buscar"+"&txtcodcauadi="+codcauadi+"&txtdencauadi="+dencauadi);
           setTimeout (terminar_buscar,500);
