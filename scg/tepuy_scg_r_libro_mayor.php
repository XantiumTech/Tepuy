<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","tepuy_scg_r_libro_mayor.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
?>		  
  <table width="530" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Libro Mayor </td>
    </tr>
  </table>
...
function ue_imprimir(codemp)
{
	...
	{	
		...
		reporte="tepuy_scg_rpp_libro_mayor.php";
		//alert(reporte);
		...
		if(hidbot==false)
		{
			...
			{
				//pagina="reportes/tepuy_scg_rpp_libro_mayor_legal.php?hidcodemp="+codemp+"&txtfecdes="+txtfecdes
...
function ue_openexcel(codemp)
{
	...
	{	
		hidbot = f.hidbot.value;
		cmbnivel = f.cmbnivel.value;
		reporte="tepuy_scg_rpp_libro_mayor_excel.php";
		//alert(reporte);
		tiporeporte=f.cmbbsf.value;
		if(hidbot==true)
		{
...
function uf_cambio_meses()
{
	 ...
	 f.action="tepuy_scg_r_libro_mayor.php";
	 f.submit();
