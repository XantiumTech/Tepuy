...
class tepuy_srh_c_llamada_atencion
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_llamada_atencion($path)
	{   
   ...
   function uf_srh_getProximoCodigo()
	  {
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			//	     Function: uf_srh_getProximoCodigo
			//         Access: public (tepuy_srh_p_llamada_atencion)
			//      Argumento: 
  ...
  {  
		...
		//         access: public (tepuy_srh_llamada_atencion)														            //
...
function uf_srh_guardar_dt_llamada_atencion($ao_llamada, $aa_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_llamada_atencion)														        //
...
function uf_srh_eliminar_dt_llamada_atencion($as_nrollam, $aa_seguridad)
  {
		...
		//        access:  public (tepuy_srh_dt_llamada_atencion)														        //
		//      Argumento: $as_nrollam        // numero de la llamada de atencion                                               //
		//                 $aa_seguridad    //  arreglo de registro de seguridad                                                //
		//	      Returns: Retorna un Booleano																				    //
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		else
		{
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ao_object[$ai_totrows][3]="<a href=javascript:catalogo_causas(".$ai_totrows.")    align=center><img src=../../../../shared/imagebank/tools15/buscar.png alt=Buscar width=15 height=15 border=0 align=center></a>";		
				$ao_object[$ai_totrows][4]="<a href=javascript:uf_agregar_dt(".$ai_totrows.");  align=center><img src=../../../../shared/imagebank/tools15/aprobado.png alt=Aceptar width=15 height=15 border=0 align=center></a>";
				$ao_object[$ai_totrows][5]="<a href=javascript:uf_delete_dt(".$ai_totrows.");    align=center><img src=../../../../shared/imagebank/tools15/eliminar.png alt=Eliminar width=15 height=15 border=0 align=center></a>";		
...
}// end   class tepuy_srh_c_llamada_atencion
?>
