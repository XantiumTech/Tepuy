<?PHP
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_ins->uf_load_seguridad_reporte("INS","tepuy_ins_r_solicitudpago.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle_cxp($aa_data,&$io_pdf)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//       Function: uf_print_detalle
		//		   Access: private 
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_pdf->ezSetDy(-2);
		$la_data[1]=array('procede'=>"<b>Procede</b>",'comprobante'=>"<b>Comprobante</b>",'recepcion'=>"<b>Recepcion</b>",'fecha'=>"<b>Fecha</b>",'debe'=>"<b>Debe</b>",'haber'=>"<b>Haber</b>");
		$la_columnas=array('procede'=>'<b>Solicitud</b>',
						   'comprobante'=>'<b>Proveedor / Beneficiario</b>',
						   'recepcion'=>'<b>Documento</b>',
						   'fecha'=>'<b>Fecha Emisión</b>',
						   'debe'=>'<b>Fecha Emisión</b>',
						   'haber'=>'<b>Monto</b>');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('procede'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'comprobante'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'recepcion'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'innerLineThickness' =>0.5,
						 'cols'=>array('procede'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'comprobante'=>array('justification'=>'left','width'=>100), // Justificación y ancho de la columna
						 			   'recepcion'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'fecha'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'debe'=>array('justification'=>'right','width'=>100), // Justificación y ancho de la columna
						 			   'haber'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la columna
		$io_pdf->ezTable($aa_data,$la_columnas,'',$la_config);
	}// end function uf_print_detalle_cxp
	//-----------------------------------------------------------------------------------------------------------------------------------

	//-----------------------------------------------------  Instancia de las clases  ------------------------------------------------
	require_once("../../shared/ezpdf/class.ezpdf.php");
	require_once("tepuy_ins_class_report.php");
	$io_report=new tepuy_ins_class_report();
	...
	else  // Imprimimos el reporte
	{
		...
		for($li_i=1;(($li_i<=$li_totrow)&&($lb_valido));$li_i++)
		{
			...
			{ 
				...
				if($li_montodeb!=$li_montohab)
				{
					...
					if($ll_procede=="CXP")
					{
						$la_data[$li_z]=array('procede'=>$ls_procede,'comprobante'=>$ls_comprobante,'recepcion'=>$ls_numrecdoc,'fecha'=>$ld_fecha,
		...
		if ($li_z>0)
		{
		 	 if($ll_procede=="CXP")
			 {
				uf_print_detalle_cxp($la_data,$io_pdf); // Imprimimos el detalle cuando es cxp
			 }
			 else
			 {
