...
if (!array_key_exists("la_logusr",$_SESSION))
   ...
   //////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_resumen_fideicomiso.php";
      ...
      <td colspan="3" align="center"><table width="580" height="47" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="2400" height="20" colspan="5"><div align="left">
            ...
            &nbsp;<a href="javascript:catalogo_fuentefinanciamientodes();"><img src="../shared/imagebank/tools15/buscar.png" alt="Cat&aacute;logo Fuente Financiamiento" width="15" height="15" border="0"></a>
...
function ue_imprimir()
{
	...
	if(li_imprimir==1)
	{
		...
		{
			pagina="reportes/tepuy_spg_rpp_resumen_fideicomiso.php?txtcodfuefindes="+ls_codfuefindes;
...
function catalogo_fuentefinanciamientodes()
{
	f=document.form1;
	tipo="DESDE";			
	pagina="tepuy_spg_cat_fuente.php?tipo="+tipo;
