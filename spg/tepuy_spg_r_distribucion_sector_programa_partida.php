...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_sector_programa_partida.php";
...
<!--  <tr> 
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.png" width="20" height="20" border="0"></a></a></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a>
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">Creditos Presupuestarios a Nivel de Sectores, Programas y Partidas </td>
    </tr>
  </table>
      ...
      <td colspan="3" align="center"><div align="left">
	   ...
	   ?>
          ...
          <!--DWLayoutTable-->
			...
			<td height="13" colspan="9" valign="top"><strong>Rango Codigo Programatico 
			</strong></td>
            </tr>
		    <tr class="formato-blanco">
		      <td width="38" height="18"><div align="right">Desde</div></td>
		      <td width="136" height="18"><input name="codestpro1" style="text-align:center" type="text" id="codestpro1" value="<?php print $ls_codestpro1 ?>" size="22" maxlength="20"></td>
		      ...
		      <td width="20"></td>
		      <td width="135"><input name="codestpro2" style="text-align:center" type="text" id="codestpro2" value="<?php print $ls_codestpro2 ?>" size="22" maxlength="6"></td>
            ...
            <td height="22"><input name="codestpro1h" style="text-align:center" type="text" id="codestpro1h" value="<?php print $ls_codestpro1h ?>" size="22" maxlength="20"></td>
            ...
            <td></td>
            <td><input name="codestpro2h" style="text-align:center" type="text" id="codestpro2h" value="<?php print $ls_codestpro2h  ?>" size="22" maxlength="6"></td>
...
function uf_cambio_MESES()
{
     ...
     if(f.ckbhasfec.checked==true)
	 {
		 ...
		 f.action="tepuy_spg_r_disponibilidad.php";
		 f.submit();
	 }	
	 else
	 {
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			 pagina="reportes/tepuy_spg_rpp_sector_programa_partida.php?codestpro1="+codestpro1
							+"&codestpro2="+codestpro2+"&codestpro1h="+codestpro1h
							+"&codestpro2h="+codestpro2h;
		...
		{
			pagina="reportes/tepuy_spg_rpp_sector_programa_partida.php?codestpro1="+codestpro1
							+"&codestpro2="+codestpro2+"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h;
				  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}
	else
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			else
			{
				...
				{
				  pagina="reportes/tepuy_spg_rpp_disponibilidad_presup_excel.php?codestpro1="+codestpro1
		...
		else
		{
			...
			else
			{
				...
				{
				  pagina="reportes/tepuy_spg_rpp_disponibilidad_presup_pdf.php?codestpro1="+codestpro1
...
{
	   pagina="tepuy_catalogo_sector.php?tipo=reporte";
	   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
function catalogo_estpro2()
{
	...
	if(estmodest==1)
	{
		if(codestpro1!="")
		{
			pagina="tepuy_catalogo_programa.php?codestpro1="+codestpro1+"&tipo=reporte";
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
		else
		{
	...
	else
	{
		...
		if(codestpro1=='**')
		{
			pagina="tepuy_catalogo_programa.php?tipo=reporte";
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
		else
		{
...
{
	   pagina="tepuy_catalogo_sector.php?tipo=rephas";
	   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
}
function catalogo_estprohas2()
{
	...
	if(estmodest==1)
	{
		if(codestpro1!="")
		{
			pagina="tepuy_catalogo_programa.php?codestpro1="+codestpro1+"&tipo=rephas";
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
		else
		{
	...
	else
	{
		if(codestpro1=='**')
		{
			pagina="tepuy_catalogo_programa.php?tipo=rephas";
			window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
		}
		else
		{
