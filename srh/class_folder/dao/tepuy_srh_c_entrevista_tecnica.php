...
class tepuy_srh_c_entrevista_tecnica
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_entrevista_tecnica($path)
	{   
...
function getCodPersonal($as_codper, $as_codcon,&$ao_datos="")       
{
  ...
  {  
		...
		//         access: public (tepuy_srh_entrevista_tecnica)														         
...
function uf_srh_guardar_dt_entrevista_tecnica($ao_entrevista, $aa_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_entrevista_tecnica)														
...
function uf_srh_eliminar_dt_entrevista_tecnica($as_codper,$as_fecha, $aa_seguridad)
  {
		...
		//        access:  public (tepuy_srh_dt_entrevista_tecnica)														
		//      Argumento: $as_codper        // numero de la entrevista tecnica
		//                 $aa_seguridad    //  arreglo de registro de seguridad                                                
		//	      Returns: Retorna un Booleano																				    
...
}// end   class tepuy_srh_c_entrevista_tecnica
?>
