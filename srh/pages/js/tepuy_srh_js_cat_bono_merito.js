...
var loadDataURL = "../../php/tepuy_srh_a_bono_merito.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_bono_merito.php";
var mygrid;
...
function Buscar()
{
 ...
 valfec= ue_comparar_fechas(fechades,fechahas);
  ...
  else
  {
	 ...
	 mygrid.loadXML("../../php/tepuy_srh_a_bono_merito.php?valor=buscar"+"&txtfechades="+fechades+"&txtfechahas="+fechahas+"&txtcodper="+codper+"&txtnomper="+nomper+"&txtapeper="+apeper);
...
function aceptar ( ls_codper, ls_fecha, ls_apeper, ls_nomper,  ls_total,ls_codperdestino, ls_fechadestino,  ls_nomdestino, 	 ls_totaldestino,ls_dentippersss,ls_tipperdestino,ls_codtipper,ls_codtipperdestino,ls_dentipper,ls_dentipperdestino,ls_codpun,ls_codpundestino,ls_denpun,ls_denpundestino)
	{
		...
		ls_ejecucion=document.form1.hidstatus.value;
	      ...
	      if(ls_ejecucion=="1")
			...
			opener.document.form1.action="../pantallas/tepuy_srh_p_bono_merito.php";
