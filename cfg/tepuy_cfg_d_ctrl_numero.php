...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_nuevo();"><img src="../shared/imagebank/tools20/nuevo.png" alt="Nuevo" width="20" height="20" border="0"></a><a href="javascript:uf_confirmacion();"><img src="../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0"></a><a href="javascript:ue_buscar();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" width="20" height="20"><a href="javascript:ue_eliminar();"><img src="../shared/imagebank/tools20/eliminar.png" alt="Eliminar" width="20" height="20" border="0"></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a></td>
  </tr>
</table>

<?php
require_once("class_folder/tepuy_cfg_c_ctrl_numero.php");
...
$io_ctrl_numero = new tepuy_cfg_c_ctrl_numero();
...
$lb_valido       = "";
$io_chkrel       = new tepuy_c_check_relaciones($con);
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "CFG";
	$ls_ventanas = "tepuy_cfg_d_ctrl_numero.php";
 ...
 function uf_limpiarvariables()
   {
		...
		global $la_disponibles,$ls_operacion,$ls_read,$ls_activo,$la_asignados,$ls_nunasig;
...
{
	 uf_limpiarvariables();  
     $ls_codigo   = $fun_db->uf_generar_codigo(false,"","tepuy_ctrl_numero","id");
		...
		if(!empty($la_estasig))
			{
				...
				{ 
					 ...
					 list($lb_valido,$ls_codsis)=$io_ctrl_numero->uf_buscar_campo("tepuy_procedencias","codsis"," procede='".$ls_codproc."'");
		 ...
		 //$lb_valido = $io_ctrl_numero->uf_guardar_ctrl_numero($lr_datos,$ls_codusu,$la_seguridad);;
      ...
      if ($lb_existe)
	     {
	       ...
	       $lb_tiene     = $io_chkrel->uf_check_relaciones($ls_empresa,$ls_condicion,'tepuy_procedencias',$ls_codigo,$ls_mensaje);//Verifica los movimientos asociados a la cuenta
	       if (!$lb_tiene)
	          {
...
if ($ls_operacion=="buscar")
{
 ...
 $ls_read="readonly";
 $ls_activo="readonly";
 $lb_valido=$io_ctrl_numero->uf_sss_buscar_usuarios_disponibles($ls_empresa,$ls_codsis,$ls_prefijo,$la_disponibles);
 $ls_nunasig=$io_ctrl_numero->uf_sss_buscar_usuarios_asignados($ls_empresa,$ls_codsis,$ls_prefijo,$la_asignados);
...
<table width="611" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr>
      <td width="616" height="283"><table width="564"  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          <td width="133" height="22" align="right">C&oacute;digo</td>
          <td width="117" height="22"><input name="txtcodigo" type="text" id="txtcodigo" size="8" maxlength="4" onKeyUp="" onBlur="javascript:rellenar_cad(this.value,4,'cod');" onKeyPress="" value="<?php print $ls_codigo ?>"  style="text-align:center " readonly></td>
        </tr>
        <tr>
          ...
          <td height="22" colspan="3"><label>
            <select name="cmbsis" id="cmbsis" <? print $ls_activo;?> >
			  ...
			  <option value="SEPSPC">Solicitud de Ejecucion Presupueatria</option>
              <?
              }
              elseif($ls_codsis=='SEPSPC') 
              {
              ?>
               ...
               <option value="SEPSPC" selected>Solicitud de Ejecucion Presupueatria</option>
              <?
              }else 
              {
              ?>
        ...
        <tr style="display:none">
          ...
          <td height="22" colspan="2"><input name="txtlong" type="text" id="txtlong" size="6" maxlength="2" onKeyPress="return keyRestrict(event,'0123456789');" value="15"  style="text-align:center "></td>
        </tr>
	    <tr>
          <td height="22" align="right">Prefijo</td>
          <td height="22" colspan="2"><input name="txtprefi" type="text" id="txtprefi" size="10" maxlength="6" onBlur="llenargrid()" onKeyup="calcularnumeroactual();" value="<?php print $ls_prefijo ?>" "<?php if($ls_operacion=='buscar'){print $ls_activo;}?>"style="text-align:center"></td>
        </tr>
        <tr style="display:none">
          <td height="22" align="right">Numero Inicial</td>
          <td height="22" colspan="2"><input name="txtnumini" type="text" id="txtnumini" size="10" maxlength="6" onKeyPress="return keyRestrict(event,'0123456789');" value="1"  style="text-align:center "></td>
        </tr>
        <tr style="display:none">
          <td height="22" align="right">N&uacute;mero Final</td>
          <td height="22" colspan="2"><input name="txtnumfin" type="text" id="txtnumfin" size="10" maxlength="6"  onKeyPress="return keyRestrict(event,'0123456789');" onChange=""  onkeyup="" onBlur="" value="999999"  style="text-align:center "></td>
        </tr>
        <tr>
          <td height="22" align="right">Numero Actual</td>
          <td height="22" colspan="2"><input name="txtnumact" type="text" id="txtnumact" size="20" maxlength="15"  onBlur="calcularnumeroactual()" value="<?php print $ls_numact ?>"  style="text-align:center " readonly></td>
        </tr>
        <tr>
        ...
        <td colspan="2" rowspan="6"><div align="center" class="titulo-celdanew"><span class="Estilo1">Disponibles</span>
          ...
          <td width="244" rowspan="6"><div align="center" class="titulo-celdanew"><span class="Estilo1">Asignados </span> <span> </span>
        ...
        <tr>
          ...
          <td height="22" colspan="2">&nbsp;<input name="txtcodusu" type="hidden" id="txtcodusu"  value="<?php print $_SESSION["la_logusr"]; ?>"  style="text-align:center "></td>
        </tr>
      </table></td>
    </tr>
  </table>
	             ...
	             else  
	                {
                      ...
                      if (valida_null(txtprefi,"El Prefijo  esta vacio !!!")==false)
		              ...
		              else
		                 {
				           ...
				           else var mystring  =new String(ls_prefijo);
				              {
							   	  ...
							   	  else
								  {
								  	          ...
								  	          if (lenprefijo<6)
											  {
													alert('El Prefijo debe ser de 6 caractares alfanumericos');
											  }
										   	  ...
										   	  else
											  {
												...
												f.action="tepuy_cfg_d_ctrl_numero.php";
												f.submit();
											  }		
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
	     f.operacion.value="";			
	     pagina="tepuy_cfg_cat_ctrl_numero.php?txtcodusu="+ls_usuario;
...
{
	ls_prefijo=txtprefi.value;
	ls_inicial=txtnumini.value;
	ls_logitud=txtlong.value;
	var mystring  =new String(ls_prefijo);
