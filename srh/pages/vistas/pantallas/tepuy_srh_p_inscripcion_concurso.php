<?php
	...
	$io_fun_srh->uf_load_seguridad("SRH","tepuy_srh_p_inscripcion_concurso.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_reporte=$io_class_srh->uf_select_config("SRH","REPORTE","CONSTANCIA_INSCRIPCION_CONCURSO","tepuy_srh_rpp_inscripcion_concurso.php","C");
	//--------------------------------------------------------------------------------------------------------------
...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_inscripcion_concurso.js"></script>
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<td class="toolbar" width="25"><div align="center"><a href="javascript: ue_eliminar();"><img src="../../../../shared/imagebank/tools20/eliminar.png" alt="Buscar" width="20" height="20" border="0"></a></div></td>
	
	<td class="toolbar" width="25"><div align="center"><a href="javascript: ue_imprimir('<?php print $ls_reporte ?>');"><img src="../../../../shared/imagebank/tools20/imprimir.png" alt="Buscar" width="20" height="20" border="0"></a></div></td>
  ...
  <td height="22" valign="middle"> <input name="txtfechacie" type="text" id="txtfechacie" size="16"    style="text-align:center"  readonly >  </td>           
  	...
  	<tr class="titulo-nuevo">
       ...
       <tr>
          ...
          <td width="338" height="22" colspan="2"><div id="personal" style="display:none"><a href="javascript:catalogo_personal();"> <img src="../../../../shared/imagebank/tools15/buscar.png" alt="Cat&aacute;logo Personal" name="buscartip" width="15" height="15" border="0" id="buscartip">Buscar Registro de Personal </a></div></td>
        </tr>
        <tr>
		...
		<td height="22"><div align="right">Profesi&oacute;n </div></td>
          ...
          <a href="javascript:catalogo_profesion();"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Cat&aacute;logo Profesion" name="buscartip" width="15" height="15" border="0" id="buscartip"></a>
       ...
       <tr class="titulo-ventana">
        ...
        <td width="136">
          ...
          <td width="274"><span class="toolbar"><a href="javascript: ue_buscar_estudios();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Estudios</a></span></td>
      </tr>
      </table>
          <p>&nbsp;</p>
          </p></div>
       ...
       <tr class="titulo-ventana">
        ...
        <tr>
		 ...
		 <tr>
        <td height="22"><div align="left"><a href="javascript: ue_limpiar_cursos();ue_nuevo_codcurso();"><img src="../../../../shared/imagebank/tools20/nuevo.png" alt="Grabar" width="20" height="20" border="0">Nuevo Curso </a></div></td>

        <td width="136">
			<a href="javascript: ue_guardar_cursos();"><img src="../../../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Guardar Curso</a></td>
		  <td width="141">
			<a href="javascript: ue_eliminar_cursos();"><img src="../../../../shared/imagebank/tools20/eliminar.png" alt="Grabar" width="20" height="20" border="0">Eliminar Curso</a></td>
          <td width="274"><span class="toolbar"><a href="javascript: ue_buscar_cursos();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Cursos </a></span></td>
      </tr>
      </table>
          <p>&nbsp;</p>
          </p></div>
        ...
        <td width="152">
          ...
          <td width="216"><span class="toolbar"><a href="javascript: ue_buscar_trabajos();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Experiencia</a></span></td>
		...
		<tr>
        <td height="22"><div align="center"><a href="javascript:ue_limpiar_familiar(); ue_nuevo_familiar(); "><img src="../../../../shared/imagebank/tools20/nuevo.png" alt="Grabar" width="20" height="20" border="0">Nuevo Familiar</a></div></td>
        ...
        <td width="178">
          ...
          <td width="216"><span class="toolbar"><a href="javascript: ue_buscar_familiares();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Grabar" width="20" height="20" border="0">Buscar Familiares</a></span></td>
       ...
       <tr class="titulo-ventana">
        ...
        <td width="103" height="22">&nbsp;</td>
         ...
         <td width="279">
			<a href="javascript: ue_guardar_requisitos();"><img src="../../../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Guardar Requisitos de Concursante</a></td>
          
		  <td width="275">
			<a href="javascript: ue_buscar_requisitos();"><img src="../../../../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0">Consultar Requisitos de Concursante</a></td>
          <td width="35">&nbsp;</td>
      </tr>
	   <tr>
             <td colspan="3">&nbsp;</td>
