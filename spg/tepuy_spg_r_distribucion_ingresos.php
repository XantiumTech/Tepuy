...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_distribucion_ingresos.php";
...
<title>RESUMEN DEL PRESUPUESTO DE INGRESOS POR  PARTIDA</title>
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">RESUMEN DEL PRESUPUESTO DE INGRESOS<br>
      POR PARTIDAS</td>
    </tr>
  </table>
        ...
        <table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="223" height="23"><select name="cmbnivel" id="cmbnivel">
              <option value="4">Seleccione un Nivel </option>
              <option value="1">Ramo</option>
              <option value="2">Sub-Ramo</option>
              <option value="3">Especifica</option>
              <option value="4">Sub-Especifica</option>
              </select></td>
            <td width="223">&nbsp;</td>
            <td width="446">&nbsp;</td>
          </tr>
...
function ue_showouput()
{
	...
	pagina="reportes/tepuy_spg_rpp_distribucion_ingresos.php?cmbnivel="+cmbnivel+"&tipoformato="+tipoformato;
