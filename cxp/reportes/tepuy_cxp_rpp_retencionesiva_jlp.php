<?PHP
	...
	function uf_print_encabezadopagina($as_titulo,&$io_pdf)
	{
		...
		$io_pdf->addText(50,530,7,"Republica Bolivariana de Venezuela"); // Agregar el título
		$io_pdf->addText(50,520,7,"Ministerio de Educacion Superior"); // Agregar el título
		$io_pdf->addText(50,510,7,"Colegio Universitario 'Profresor Jose Lorenzo Perez Rodriguez'"); // Agregar el título
		...
		$io_pdf->addText(50,498,9,"<b>".$as_ley."</b>");
		$io_pdf->addText(50,488,9,"<b>".$as_ley2."</b>");
		$io_pdf->addText(50,478,9,"<b>".$as_ley3."</b>");
		//    CUADRO INFERIOR
        $io_pdf->Rectangle(50,50,910,60);	
		$io_pdf->line(277,50,277,110);		
		$io_pdf->line(505,50,505,110);		
		$io_pdf->line(732,50,732,110);		
		$io_pdf->line(50,65,960,65);
		$io_pdf->addText(100,55,7,"ELABORADO POR: HABILITADURIA"); 
		$io_pdf->addText(360,55,7,"CONTROL INTERNO"); 
		$io_pdf->addText(560,55,7,"SUB-DIRECCION ADMINISTRATIVA"); 
		$io_pdf->addText(830,55,7,"CLIENTE"); 
