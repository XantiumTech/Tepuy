<?php
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_columna=array('codart'=>'<b>Código </b>',
						  'denart'=>'<b>Artículo</b>',
						  'unidadmed'=>'<b>Unidad Medida</b>',
						  'valorunidad'=>'<b>Valor Unidad</b>',
						  'dentipart'=>'<b>Cuenta Presupuestaria</b>',
						  'contable'=>'<b>Cuenta Contable</b>',
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('codart'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la columna
						 			   'denart'=>array('justification'=>'left','width'=>150),
									   'unidadmed'=>array('justification'=>'left','width'=>50),
									   'valorunidad'=>array('justification'=>'left','width'=>50), // Justificación y ancho de la columna
						 			   'dentipart'=>array('justification'=>'left','width'=>80),
									   'contable'=>array('justification'=>'left','width'=>70), // Justificación y ancho de la columna
						 			   'nomfisalm'=>array('justification'=>'left','width'=>180))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
...
/*	if($ls_coddesde!="")
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	$lb_valido=$io_report->uf_select_impu_presupuestariaarticulo($ls_codemp,$ls_coddesde,$ls_codhasta,$li_orden); // Cargar el DS con los datos de la cabecera del reporte
	...
	else // Imprimimos el reporte
	{
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			$la_data[$li_i]=array('codart'=>$ls_codart,'denart'=>$ls_denart,'unidadmed'=>$ls_denunimed,'valorunidad'=>$ls_valorunidad,
			                      'dentipart'=>$ls_cuenta,'contable'=>$ls_contable,'nomfisalm'=>$ls_descrip);
