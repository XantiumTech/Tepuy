...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_ejecucion_trimestral.php";
...
<?php 
	...
	//////////////////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////
?>
  <table width="419" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana"><p>EJECUCION  TRIMESTRAL DE GASTOS Y <br>
...
function ue_showouput()
{
    ...
    if(estmodest==1)
	{
		...
		{
		   pagina="reportes/tepuy_spg_rpp_ejecucion_trimestral_inst_07.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
				  +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
				  +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas;
	...
	else
	{
		...
		else
		{
		   ...
		   +"&txtcodfuefinhas="+txtcodfuefinhas;
		   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}	
}
