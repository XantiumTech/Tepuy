...
$io_fun_seguridad->uf_load_seguridad("SSS","tepuy_sss_r_permisos.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<!--  <tr>
  ...
  <tr> 
    <td height="20" colspan="4" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_mostrar_reporte();"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" width="20" height="20" border="0"></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"><img src="../shared/imagebank/tools20/ayuda.png" alt="Ayuda" width="20" height="20"></a><a href="tepuywindow_blank.php"></a></td>
  </tr>
</table>
<?php
        ...
        <table width="487" border="0" align="center" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="389"><input name="txtcodusu" type="text" id="txtcodusu" size="15" style="text-align:center" readonly>
              <a href="javascript: ue_catausuario('Reporte');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0"></a>
              <label>
          ...
          <tr>
            ...
            <td><label>
              ...
              <a href="javascript: ue_catasistema('Reporte');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0"></a>
...
<script language="JavaScript">
	...
	{
		window.open("tepuy_sss_cat_usuarios.php?destino="+ destino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
	}

	function ue_catasistema(destino)
	{
		window.open("tepuy_sss_cat_sistemas.php?destino="+ destino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
	}
	...
	function ue_mostrar_reporte()
	{
		...
		if(li_imprimir)
		{
			...
			else
			{
				...
				window.open("reportes/tepuy_sss_rpp_permisos.php?codusu="+ls_codusu+"&codsis="+ls_codsis+"&orden="+li_orden+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
