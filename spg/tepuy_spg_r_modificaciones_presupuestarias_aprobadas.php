...
$ls_reporte = $io_fungas->uf_select_config("SPG","REPORTE","MODIFICACION_PRESUPUESTARIA_APROBADA","tepuy_spg_rpp_modificaciones_presupuestarias_aprobadas.php","C");
unset($io_fungas);
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SPG";
	$ls_ventanas = "tepuy_spg_r_modificaciones_presupuestarias_aprobadas.php";
...
<!--  <tr> 
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_imprimir();"><img src="../shared/imagebank/tools20/imprimir.png" width="20" height="20" border="0"></a></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a>
...
if(array_key_exists("ckbreporte",$_POST))
{
	if($_POST["ckbreporte"]==1)
	{
		$ckbreporte   = "checked" ;	
		$ls_ckbreporte = 1;
	}
  ...
  <table width="540" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><div align="left"></div>        <div align="left"></div>        <div align="left" class="style14"></div>        <div align="left">
        <table width="480" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="6"><strong>Formato del Reporte </strong></td>
            </tr>
			<tr>
			  <td height="19" colspan="2"><div align="right">
			    <input name="ckbreporte" type="checkbox" id="ckbreporte" value="1" checked <?php print $ckbreporte ?>>
			  </div></td>
			  <td width="123" height="19"><div align="left">Resumido</div></td>
			  <td height="19" colspan="2"></td>
			  <td width="61" height="19"><div align="right">
			    
			  </div></td>
			  <td width="169" height="19" colspan="2"><div align="left"></div></td>
		     </tr>
        </table>
        </div></td>
    </tr>
    ...
    <tr>
      <td height="22" colspan="3" align="center"><table width="480" height="52" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco"  va>
        ...
        <tr class="formato-blanco">
          ...
          <td width="39"><div align="left"><a href="javascript:catalogo_comprobante();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a></div></td>
        </tr>
      </table></td>
    </tr>
    <tr><?php
...
function ue_imprimir()
{
	...
	if(li_imprimir==1)
	{
		...
		if(f.ckbreporte.checked==true)
		{
		  	ls_reporte="tepuy_spg_rpp_modificaciones_presupuestaria_aprobadas_waryna.php";
		}
		else
		{
		 	ls_reporte="tepuy_spg_rpp_modificaciones_presupuestarias_aprobadas.php";
		}
...
{
	   pagina="tepuy_cat_comprobantes_modificaciones.php?";
