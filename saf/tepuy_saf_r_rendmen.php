...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_rendmen.php",$ls_permisos,$la_seguridad,$la_permisos);
	  ...
	  <table width="497" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
                ...
                <tr>
                  ...
                  <td height="22"><input name="txtcoduni1" type="text" id="txtcoduni1" size="15"  style="text-align:center" readonly>
                      <a href="javascript: uf_unidad('txtcoduni1','txtdenuni1');"><img src="../shared/imagebank/tools15/buscar.png" alt="BUSCAR" width="15" height="15" border="0"></a>
                  ...
                  <td height="22"><input name="txtcoduni2" type="text" id="txtcoduni2" size="15"  style="text-align:center" readonly>
                      <a href="javascript: uf_unidad('txtcoduni2','txtdenuni2');"><img src="../shared/imagebank/tools15/buscar.png" alt="BUSCAR" width="15" height="15" border="0"></a>
...
<script language="JavaScript">
	...
	{
		window.open("tepuy_saf_cat_unidad.php?coddestino="+ ls_coddestino +"&dendestino="+ ls_dendestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=400,left=120,top=70,location=no,resizable=yes");
	}
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				window.open("reportes/tepuy_saf_rpp_rendmen.php?desde="+ls_desde+"&hasta="+ls_hasta+"&coduniadm_desde="+ls_coduniadm_desde+"&coduniadm_hasta="+ls_coduniadm_hasta+"&tipoformato="+tipoformato+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="tepuy_siv_r_rendmen.php";
				//f.submit();
			}
			else
