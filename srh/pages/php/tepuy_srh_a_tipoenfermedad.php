<?
	session_start();
	require_once("../../class_folder/dao/tepuy_srh_c_tipoenfermedad.php");
    require_once("../../class_folder/utilidades/class_funciones_srh.php");
	$io_enf=new tepuy_srh_c_tipoenfermedad('../../../');
	$io_fun_srh=new class_funciones_srh('../../../');
	$io_fun_srh->uf_load_seguridad("SRH","tepuy_srh_d_tipoenfermedad.php",$ls_permisos,$la_seguridad,$la_permisos);
