<?PHP
	...
	function uf_print_encabezado_pagina($ls_banco,$ls_mes,$ls_anio,&$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $li_ancho=$_SESSION["ls_width"];
		 $io_pdf->convertir_valor_px_mm($li_ancho);         
		// $io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],405,$li_alto_usado+46,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		 $io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],28,700,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		 //------------Fecha--------------------------------//
		 $la_data=array();
		 $la_anchos_col=array();
		 $la_justificaciones=array();
...
/*
		$io_pdf->ezSetY(105);
		$la_data[0]=array('elaborado'=>'<b>Elaborado por:</b>','revisado'=>'<b>Revisado por:</b>','aprobado'=>'<b>Aprobado Por:</b>');
		$la_data[1]=array('elaborado'=>'','revisado'=>'','aprobado'=>'');
		$la_data[2]=array('elaborado'=>'','revisado'=>'','aprobado'=>'');
		$la_data[3]=array('elaborado'=>'','revisado'=>'','aprobado'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('elaborado'=>array('justification'=>'left','width'=>190),
			 						   'revisado'=>array('justification'=>'left','width'=>190),
									   'aprobado'=>array('justification'=>'left','width'=>200))); // Justificación y ancho de la columna
		$la_columnas=array('elaborado'=>'','revisado'=>'','aprobado'=>'');
