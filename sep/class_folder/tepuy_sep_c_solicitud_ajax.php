<?php
	...
	$ls_codivasel = $io_funciones_sep->uf_obtenervalor("codivasel","");
		...
		case "LIMPIAR":
			switch(substr($ls_tipo,3,1))
			{
				case "B": // Bienes
					...
					if ($ls_tipafeiva=='P')
					{
					uf_print_cuentas_cargo($li_totalcuentascargo,$ls_cargarcargos,"B");
					}
				...
				case "S": // Servicios
					...
					if ($ls_tipafeiva=='P')
					{
					uf_print_cuentas_cargo($li_totalcuentascargo,$ls_cargarcargos,"S");
					}
					uf_print_total($li_subtotal,$li_cargos,$li_total);
					break;
	...
	{	
		...
		{
			$ls_codart=$io_funciones_sep->uf_obtenervalor("txtcodart".$li_fila,"");
			...
			$ls_unimed=$io_funciones_sep->uf_obtenervalor("txtdenunimed".$li_fila,"");
	...
	{	
		...
		{	// Si se deben cargar los cargos Buscamos el Código del último Bien cargado 
			...
			require_once("tepuy_sep_c_solicitud.php");
			$io_solicitud=new tepuy_sep_c_solicitud("../../");
