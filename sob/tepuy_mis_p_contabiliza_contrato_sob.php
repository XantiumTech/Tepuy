<?php
	...
	$oi_fun_integrador->uf_load_seguridad("SOB","tepuy_mis_p_contabiliza_contrato_sob.php",$ls_permisos,$la_seguridad,$la_permisos);
   ...
   function uf_limpiarvariables()
   {
		...
		$li_feccontcon=trim($oi_fun_integrador->uf_select_config("SOB","OBRAS","FECHA_CONT_CONTRATOS","0","C"));
   }
   //--------------------------------------------------------------
...
function ue_procesar()
{
	...
	if(li_ejecutar==1)
	{
		...
		if(lb_valido)
		{
			...
			f.action="tepuy_mis_p_contabiliza_contrato_sob.php";
			f.submit();
		}
		else
		{
