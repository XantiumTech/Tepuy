<?php
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////
class class_tepuy_spg_integracion
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function class_tepuy_spg_integracion()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$this->as_codban="";
		$this->as_ctaban="";
	}// end function class_tepuy_spg_integracion
	//-----------------------------------------------------------------------------------------------------------------------------------
													  ...
													  $aa_seguridad)
	{
		...
		// Modificado Por: Ing. Miguel Palencia									Fecha Última Modificación : 
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=false;
	...
	function uf_procesar_detalles_gasto($as_codemp,$as_procede,$as_comprobante,$ad_fecha,$as_descripcion,$as_tipo_destino,$as_codigo_destino)
	{
		...
		{           
			while($row=$this->io_sql->fetch_row($rs_data) and ($lb_valido))
			{
				...
				$ls_mensaje=$this->io_tepuy_spg->uf_operacion_codigo_mensaje($ls_operacion);				
				$lb_valido=$this->io_tepuy_int->uf_spg_insert_datastore($as_codemp,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,
								  										 ...
								  										 $ldec_monto,$ls_documento,$as_procede,$ls_descripcion);
				if ($lb_valido===false)
				{  
					$this->io_msg->message("".$this->io_tepuy_int->is_msg_error);
					break;
