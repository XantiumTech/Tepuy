...
var img="<img src=\"../../../public/imagenes/progress.gif\"> ";
		...
		var loadDataURL = "../../php/tepuy_srh_a_registro_ascenso.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_registro_ascenso.php";
		var mygrid;
...
function Buscar()
{
		 ...
		 codcon=document.form1.txtcodcon.value;
		  ...
		  mygrid.loadXML("../../php/tepuy_srh_a_registro_ascenso.php?valor=buscar"+"&txtcodcon="+codcon+"&txtnroreg="+nroreg);
