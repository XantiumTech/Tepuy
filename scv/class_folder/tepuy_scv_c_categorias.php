<?php
class tepuy_scv_c_categorias
{
	var $ls_sql;
	var $is_msg_error;
		
	function tepuy_scv_c_categorias($conn)
	{
	...
	function uf_scv_select_categoria($as_codemp,$as_codcat) 
	{
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->tepuy_scv_c_categorias METODO->uf_scv_select_categoria ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
	...
	function uf_scv_insert_categoria($as_codemp,$as_codcat,$as_dencat,$aa_seguridad) 
	{
		...
		if ($rs_data===false)		     
		{
			...
			$this->io_msg->message("CLASE->tepuy_scv_c_categorias METODO->uf_scv_insert_categoria ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	function uf_scv_update_categoria($as_codemp,$as_codcat,$as_dencat,$aa_seguridad) 
	{
		...
		{
			$this->io_sql->rollback();
			$this->io_msg->message("CLASE->tepuy_scv_c_categorias METODO->uf_scv_update_categoria; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
			$lb_valido=true;
	...
	function uf_scv_delete_categoria($as_codemp,$as_codcat,$aa_seguridad)
	{
		...
		if (!$lb_relacion)
		{
			...
			if (!$lb_relacion)
			{
				...
				{
					$this->io_sql->rollback();
					$this->io_msg->message("CLASE->tepuy_scv_c_categoria METODO->uf_scv_delete_categoria; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
				}
				else
				{
					$lb_valido=true;
	...
	function uf_scv_check_relaciones($as_codemp,$as_codcat,$as_tabla)
	{
		...
		{
			$lb_valido=false;
			$this->io_msg->message("CLASE->tepuy_scv_c_categorias METODO->uf_scv_check_relaciones ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		}
		else
		{
