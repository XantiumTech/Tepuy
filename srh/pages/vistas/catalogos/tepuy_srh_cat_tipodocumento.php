...
<p>&nbsp;</p>
	...
	<script>
		var mygrid;
		var loadDataURL = "../../php/tepuy_srh_a_tipodocumento.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_tipodocumento.php";	
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_tipodocumento.php?valor=buscar"+"&txtcodtipdoc="+codtipdoc+"&txtdentipdoc="+dentipdoc);
 		   setTimeout (terminar_buscar,500);
