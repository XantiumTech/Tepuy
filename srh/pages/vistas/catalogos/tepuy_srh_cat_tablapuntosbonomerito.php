...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_tablapuntosbonomerito.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_tablapuntosbonomerito.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img;
		   mygrid.loadXML("../../php/tepuy_srh_a_tablapuntosbonomerito.php?valor=buscar"+"&txtcodesc="+codesc+"&txtdenesc="+denesc);
           setTimeout (terminar_buscar,500);
		...
		function aceptar(ls_codpun,ls_denpun,ls_codpundestino,ls_denpundestino,ls_codtipper,ls_dentipper,ls_valunitri, ls_codtipperdestino, ls_dentipperdestino, ls_valunitridestino)
		{
				...
				else
				{
					...
					opener.document.form1.action="../pantallas/tepuy_srh_d_tablapuntosbonomerito.php";
