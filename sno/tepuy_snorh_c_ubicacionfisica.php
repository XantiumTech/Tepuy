<?PHP
class tepuy_snorh_c_ubicacionfisica
{
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_snorh_c_ubicacionfisica()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_snorh_c_ubicacionfisica
		//		   Access: public (tepuy_snorh_d_ubicacionfisica)
	...
	}// end function tepuy_snorh_c_ubicacionfisica
	//-----------------------------------------------------------------------------------------------------------------------------------
