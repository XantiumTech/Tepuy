...
var loadDataURL = "../../php/tepuy_srh_a_evaluacion_ascenso.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_evaluacion_ascenso.php";
var mygrid;
...
function Buscar()
{
	...
	valfec= ue_comparar_fechas(fechades,fechahas);
	 ...
	 else
	 {
		 ...
		 mygrid.loadXML("../../php/tepuy_srh_a_evaluacion_ascenso.php?valor=buscar"+"&txtfechades="+fechades+"&txtfechahas="+fechahas+"&txtnroreg="+nroreg);
...
function aceptar ( ls_codper, ls_fecha, ls_apeper, ls_nomper, ls_caract, ls_carasc, li_res,ls_obs ,ls_codperdestino, ls_fechadestino,  ls_nomdestino, 	 ls_caractdestino, ls_carascdestino, ls_resdestino, ls_obsdestino,ls_nroreg,ls_fecreg,ls_nroregdestino,ls_fecregdestino, ls_codeval, ls_deneval, ls_denevaldestino, ls_codevaldestino, ls_ejecucion)
	{
		...
		if(ls_ejecucion=="1")
		{
		 ...
		 opener.document.form1.hidstatus.value="";
			...
			opener.document.form1.action="../pantallas/tepuy_srh_p_evaluacion_ascenso.php";
...
function cat_registro_ascenso()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_registro_ascenso.php?valor_cat=0"+"&tipo=cat";
