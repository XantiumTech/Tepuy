...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
  ...
  <input name="operacion" type="hidden" id="operacion"> 
    ...
    <tr>
        <td height="22" colspan="4"><div align="right"><a href="javascript:ue_search();"><img src="../shared/imagebank/tools20/buscar.png" width="20" height="20" border="0">Buscar Proveedor</a> </div></td>
  </table> 
</form>      
<?php
...
function aceptar(codpro,nompro)
  ...
  function ue_search()
  {
    ...
    f.action="tepuy_cxp_cat_prohasta.php";
    f.submit();
  }
</script>
</html>