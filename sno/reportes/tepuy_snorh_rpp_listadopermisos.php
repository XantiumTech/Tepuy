<?PHP
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte("SNR","tepuy_snorh_r_listadopermisos.php",$ls_descripcion);
		if($lb_valido==false)
		{
			print("<script language=JavaScript>");
			print(" close();");
							   ...
							   &$io_cabecera,&$io_pdf)
	{
		...
		unset($la_columna);
		unset($la_config);
		$la_datos[1]=array('numper'=>'<b>Nro</b>','feciniper'=>'<b>Inicio</b>','fecfinper'=>'<b>Fin</b>','numdiaper'=>'<b>Nro de Días</b>',
