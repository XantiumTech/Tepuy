    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    19/04/2006          Fecha última Modificacion :      Hora :
	   ...
	   else
	   {
	     ...
	     $ls_sql=" SELECT MV.*, CC.denominacion as dencuenta, OP.denominacion as denoperacion,".
			   ...
			   " FROM  spg_dt_cmp MV, spg_cuentas CC, spg_operaciones OP, spg_ep5 PR, tepuy_cmp CMP ".
               ...
               "       MV.operacion=OP.operacion   AND MV.codestpro1=PR.codestpro1 AND   ".
      		   ...
      		   "	   MV.procede=CMP.procede AND MV.comprobante=CMP.comprobante AND MV.fecha=CMP.fecha AND ".
	 ...
	 /*  $ls_sql=" SELECT MV.*, CC.denominacion as dencuenta, OP.denominacion as denoperacion,".
               ...
               "       MV.operacion=OP.operacion   AND MV.codestpro1=PR.codestpro1 AND   ".
      		   "	   MV.codestpro2=PR.codestpro2 AND MV.codestpro3=PR.codestpro3 AND   ".
      		   "	   MV.codestpro4=PR.codestpro4 AND MV.codestpro5=PR.codestpro5 AND   ".
      		   "	   MV.procede=CMP.procede AND MV.comprobante=CMP.comprobante AND     ".
      		   "       MV.fecha=CMP.fecha AND MV.codban=CMP.codban AND MV.ctaban=CMP.ctaban ";  */
	 // print  $ls_sql."<br>";
	  /*$ls_sql=" SELECT * ".
              " FROM ".
	          ...
	          " FROM 	tepuy_cmp CMP, rpc_proveedor PRV,rpc_beneficiario BEN ".
...
/****************************************************************************************************************************************/
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    19/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  /* $ls_sql=" SELECT distinct MV.comprobante,MV.*, CC.denominacion as dencuenta, OP.denominacion as denoperacion, ".
			  "         PR.denestpro5, CMP.tipo_destino, CMP.cod_pro, CMP.ced_bene, ".
      		   "	    (SELECT nompro  ".
               "		 FROM rpc_proveedor  ".
       		   "	     WHERE rpc_proveedor.codemp=CMP.codemp AND rpc_proveedor.cod_pro=CMP.cod_pro) AS nompro, ".
	 ...
	 // Fecha Creación :    19/04/2006          Fecha última Modificacion :      Hora :
      ...
      if (!empty($as_spg_cuenta_ori) && (!empty($as_spg_cuenta_des)))
	  {
         $ls_cad_filtro1=" , (SELECT cmp.comprobante,cmp.fecha,cmp.procede ".
                         "    FROM   tepuy_cmp cmp, spg_dt_cmp MOV ".
...
/********************************************************************************************************************************/	
	...
	////////////////////////////////////////////////////////////
    function uf_spg_reporte_apertura( $as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,                                     
			 ...
			 if($li_estmodest==1)
			  {
				 ...
				 $ls_cad_DM_SC="CONCAT(DM.codestpro1,DM.codestpro2,DM.codestpro3)";
				 $ls_cad_EP="CONCAT(EP.codestpro1,EP.codestpro2,EP.codestpro3)";	
	...
	if($li_estmodest==1)
			  {
				 ...
				 $ls_cad_DM="DM.codestpro1||DM.codestpro2||DM.codestpro3||DM.codestpro4||DM.codestpro5||DM.spg_cuenta";
				 $ls_cad_GC="GC.codestpro1||GC.codestpro2||GC.codestpro3||GC.codestpro4||GC.codestpro5||GC.spg_cuenta";
				 $ls_cad_DM_SC="DM.codestpro1||DM.codestpro2||DM.codestpro3";
				 $ls_cad_EP="EP.codestpro1||EP.codestpro2||EP.codestpro3";
	  ...
	  /*$ls_sql=" SELECT DM.*, GC.denominacion,EP.denestpro5,GC.asignado ".
			  ...
			  "        DM.procede = '".$ls_procede."' AND ".
		   	  "        DM.fecha between '".$adt_fecini."' AND '".$adt_fecfin."' AND ".
		 	  "        ".$ls_cad_DM_SC."  between '".$ls_estructura_origen."' AND '".$ls_estructura_dstino."' AND ".
	 ...
	 {
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->tepuy_spg_class_report MÉTODO->uf_spg_reporte_apertura ERROR->".
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    09/05/2006          Fecha última Modificacion :      Hora :
	  ...
	  $li_estmodest=$_SESSION["la_empresa"]["estmodest"];
	  $ls_seguridad="";
	  $this->io_spg_report_funciones->uf_filtro_seguridad_programatica('GC',$ls_seguridad);
	  if(strtoupper($ls_gestor)=="MYSQL")
	  {
     ...
     $ls_sql=" SELECT distinct ".$ls_programatica." as programatica". 
              ...
              "       EP.codfuefin BETWEEN '".$as_codfuefindes."' AND '".$as_codfuefinhas."' AND  ".
              "       DM.codemp=GC.codemp AND GC.codemp=EP.codemp AND ".
			  "       ".$ls_cad_DM." = ".$ls_cad_GC." AND  ".$ls_cad_DM_SC." = ".$ls_cad_EP."  ".$ls_seguridad." ".
	 ...
	 /* $ls_sql=" SELECT distinct ".$ls_programatica." as programatica,  EP.denestpro5 ".
				  ...
				  "        DM.procede = '".$ls_procede."' AND ".
				  "        DM.fecha between '".$adt_fecini."' AND '".$adt_fecfin."' AND ".
				  "        ".$ls_cad_DM_SC."  between '".$ls_estructura_origen."' AND '".$ls_estructura_destino."' AND ".
				  "       EP.codfuefin BETWEEN '".$as_codfuefindes."' AND '".$as_codfuefinhas." ".
	 ...
	 {
		 $lb_valido=false;
		  $this->io_msg->message("CLASE->tepuy_spg_class_report 
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    01/02/2006          Fecha última Modificacion : 01/02/2006 Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_Sql_Where = trim($ls_Sql_Where);  ////print $ls_Sql_Where;
			   ...
			   if ($lb_si_va==true)
			   {
				  ...
				  // Calculo lo Ejecutado y acumulado
					...
					else
					{
					    ...
					    print "ASIGNADO UPDATE:::::".$ldec_monto."<br>";
     ...
     //                 para luego concatenar en una variables de origen y una de destino 
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
         ...
         if (!(empty($ls_str_w1) and empty($ls_str_w2) and empty($ls_str_w3) and empty($ls_str_w4) and empty($ls_str_w5)))
         {
			 ...
			 if ($as_str_estructura_from<$as_str_estructura_to)
			 {
               $as_Sql_Where=$ls_str_estructura." between '".$as_str_estructura_from."' AND '".$as_str_estructura_to."' ";
			 }
			 else
			 {
			  $as_Sql_Where=$ls_str_estructura." between '".$as_str_estructura_to."' AND '".$as_str_estructura_from."' ";
			 }
         } 
         else
		 {
...
/********************************************************************************************************************************/	
	function uf_calcular_acumulado_operaciones_por_cuenta($as_str_sql_where,$as_str_estructura_from,$as_str_estructura_to, 
								...
								&$adec_monto_compromiso_a,& $adec_monto_causado_a,&$adec_monto_pagado_a,
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($li_estmodest==1)
	 {
	    ...
	    $ls_cadena_fuefin="AND MV.codestpro1=".$ls_tabla.".codestpro1 AND MV.codestpro2=".$ls_tabla.".codestpro2 AND ".
						  "    MV.codestpro3=".$ls_tabla.".codestpro3";
	 }
	 elseif($li_estmodest==2)
	 {
	    $ls_tabla="spg_ep5";
	    $ls_cadena_fuefin="AND MV.codestpro1=".$ls_tabla.".codestpro1 AND MV.codestpro2=".$ls_tabla.".codestpro2 AND ".
						  ...
						  "    MV.codestpro5=".$ls_tabla.".codestpro5";
	 }
		...
		else
		{
			...
			$ls_sql=" SELECT distinct (".$ls_str_sql_2.") as programatica ".
					...
					"       (".$ls_str_sql_2." BETWEEN '".$ls_estructura_desde."' AND '".$ls_estructura_hasta."') AND ".
					"       ".$ls_tabla.".codfuefin BETWEEN '".trim($as_codfuefindes)."' AND '".trim($as_codfuefinhas)."'  ".
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    01/02/2006          Fecha última Modificacion : 01/02/2006 Hora :
      ...
      $ls_mysql=" SELECT  MV.* , C.denominacion,MV.monto as monto_mov ". 
                "         FROM spg_dt_cmp MV,spg_operaciones OPE,spg_cuentas C ".
                "         WHERE MV.codemp='".$ls_codemp."' AND (MV.operacion=OPE.operacion) AND ".
                "               MV.codestpro1=C.codestpro1 AND MV.codestpro2=C.codestpro2 AND ".
				"               MV.codestpro3=C.codestpro3 AND MV.codestpro4=C.codestpro4 AND ".
...
/********************************************************************************************************************************/	
	...
	// print $$ls_sql."<br>"; 
	 ...
	 {
		$lb_valido=false;
		$this->io_msg->message("CLASE->tepuy_spg_class_report MÉTODO->uf_spg_reporte_select_cuenta ERROR->".$this->fun->uf_convertirmsg($this->SQL->message));
   	 }
	return $lb_valido; 
	}//fin
/********************************************************************************************************************************/	
	 ...
	 // Fecha Creación :    17/04/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{ 
			...
			{
			  $ls_tabla="spg_ep3"; 
			  $ls_cadena_fuefin=" AND PCT.codestpro1=EP.codestpro1 AND PCT.codestpro2=EP.codestpro2 AND PCT.codestpro3=EP.codestpro3";
			}
			elseif($li_estmodest==2)
			{
			  $ls_tabla="spg_ep5";
			  $ls_cadena_fuefin=" AND PCT.codestpro1=EP.codestpro1 AND PCT.codestpro2=EP.codestpro2 AND PCT.codestpro3=EP.codestpro3 AND PCT.codestpro4=EP.codestpro4 AND PCT.codestpro5=EP.codestpro5";
			}
			
			
			$ls_sql=" SELECT  ".$ls_concat." AS programatica, PCT.codestpro1, PCT.codestpro2, PCT.codestpro3, ". 
                    "         PCT.codestpro4, PCT.codestpro5, PCT.spg_cuenta, PCT.denominacion, PCT.status". 
		   ...
		   {
			  $lb_valido=false;
			  $this->io_msg->message("CLASE->tepuy_spg_class_report MÉTODO->uf_spg_reporte_disponibilidad_presupuestaria ERROR->".$this->fun->uf_convertirmsg($this->SQL->message));
		   }
		   else
		   {
			   /*if($row=$this->SQL->fetch_row($rs_data))
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    26/01/2007          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql=" SELECT ".$ls_concat." AS programatica, PCT.codestpro1, PCT.codestpro2, PCT.codestpro3, PCT.codestpro4, ".
				"        PCT.codestpro5, PCT.spg_cuenta, PCT.denominacion, PCT.status ".
				" FROM   spg_cuentas PCT, ".$ls_tabla." EP ".
				" WHERE  PCT.codemp='".$ls_codemp."' AND ".$ls_str_sql_where."  ".
				"        PCT.spg_cuenta between '".trim($as_cuenta_from)."' AND  '".trim($as_cuenta_to)."' AND ".
                "        EP.codfuefin BETWEEN '".$as_codfuefindes."' AND '".$as_codfuefinhas."' AND  ".
			   ...
			   if(!$this->uf_calcular_disponible_operacion_por_cuenta($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,
				...
				{	
					...
					$lb_valido=$this->uf_spg_reporte_calcular_ejecutado($ls_spg_cuenta,$ls_programatica,$ls_programatica,
					                                                    $adt_fecini,$adt_fecfin,$ld_monto_ejecutado,$ld_monto_acumulado,
																		$as_codfuefindes,$as_codfuefinhas);														
					$this->dts_reporte->insertRow("programatica",$ls_programatica);
					$this->dts_reporte->insertRow("spg_cuenta",$ls_spg_cuenta);
					$this->dts_reporte->insertRow("denominacion",$ls_denominacion);
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    26/01/2007          Fecha última Modificacion :      Hora :
	  ...
	  if (strtoupper($ls_gestor)=="MYSQL")
	  {
		   $ls_cadena="CONCAT(DT.codestpro1,DT.codestpro2,DT.codestpro3,DT.codestpro4,DT.codestpro5)";
	  }
	  else
	  {
		   $ls_cadena="DT.codestpro1||DT.codestpro2||DT.codestpro3||DT.codestpro4||DT.codestpro5";
	  }
	  ...
	  {
	    $ls_tabla="spg_ep5";
	    $ls_cadena_fuefin=" AND DT.codestpro1=EP.codestpro1 AND DT.codestpro2=EP.codestpro2 AND DT.codestpro3=EP.codestpro3 AND DT.codestpro4=EP.codestpro4 AND DT.codestpro5=EP.codestpro5";
	  }
...
/****************************************************************************************************************************************/	
	function uf_calcular_disponible_operacion_por_cuenta($as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,
														 ...
														 &$adec_monto_compromiso,&$adec_monto_causado,&$adec_monto_pagado,
														 &$adec_monto_aumento_a,&$adec_monto_disminucion_a,&$adec_monto_precompromiso_a,
														 &$adec_monto_compromiso_a,$as_codfuefindes,$as_codfuefinhas)
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //	Description :	Método  que ejecuta todas funciones de acumulado para asi sacar el acumulado por cuentas
       ...
       $lb_valido=$this->uf_calcular_disponible_asignacion($as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,
	                                                       $as_spg_cuenta,&$adec_monto_asignado,$as_codfuefindes,$as_codfuefinhas);
	   // acumulado Anteriores
       if ($lb_valido)
  	   { 
	      $ls_operacion="aumento";
...
/********************************************************************************************************************************/	
	function uf_calcular_disponible_asignacion($as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,
	                                           $as_spg_cuenta,&$adec_monto,$as_codfuefindes,$as_codfuefinhas)
	{//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 //	Description :	Método que consulta y suma dependiando de la operacion(aumento,disminucion,precompromiso,compromiso)
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_sql  = " SELECT COALESCE(SUM(monto),0) As monto ".
					 ...
					 "       PCT.codestpro5='".$as_codestpro5."' AND  ".
					 "       EP.codfuefin  BETWEEN '".$as_codfuefindes."' AND '".$as_codfuefinhas."' AND ".
					 "       PCT.codemp=EP.codemp  ".$ls_cadena_fuefin."  ";
		//print $ls_sql;
	/*	$ls_mysql  = " SELECT COALESCE(SUM(monto),0) As monto ".
...
/********************************************************************************************************************************/	
    ...
    function uf_spg_reporte_modificaciones_presupuestarias($ai_rect,$ai_trans,$ai_insub,$ai_cred,$adt_fecini,$adt_fecfin,
	                                                       $as_comprobante,$as_procede,$adt_fecha, $estapro)
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    15/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT DISTINCT CMP.descripcion as cmp_descripcion, CMP.fecha as fecaprmod, MOV.*,              ".
	          "        MP.fecha as fecha, CTA.denominacion                                                      ".
              "   FROM spg_dt_cmp MOV, tepuy_cmp CMP,spg_cuentas CTA ,spg_dtmp_cmp MP, tepuy_cmp_md c		    ".
			...
			//  "    AND MOV.fecha       = MP.fecha 																".
			  ...
			  "    AND c.estapro='".$estapro."'                                                                 ".
			  "    AND c.codemp=CMP.codemp																		".
			  "    AND c.procede=CMP.procede																	".
			  "    AND c.comprobante=CMP.comprobante                                                            ".
			  "    AND c.fecha=CMP.fecha														                ".			  
    ...
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    15/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT CMP.descripcion as cmp_descripcion, CMP.fecha as fecha, MOV.*,CTA.denominacion".
              "   FROM spg_dtmp_cmp MOV, tepuy_cmp_md CMP,spg_cuentas CTA ".
              "  WHERE CMP.codemp='".$ls_codemp."' ".
			  "    AND (".$ls_cadena.")  ".
			  "    AND MOV.fecha between '".$adt_fecini."' ".
			  "    AND '".$adt_fecfin."' ".
	 ...
	 {
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->tepuy_spg_class_report MÉTODO->uf_spg_reporte_modificaciones_presupuestarias_no_aprobadas ERROR->".$this->fun->uf_convertirmsg($this->SQL->message));
	 } 
	 else 
	 {
			while($row=$this->SQL->fetch_row($rs_data))
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     $ls_operacion = $this->tepuy_int_spg->uf_operacion_codigo_mensaje($as_operacion);
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 {
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->tepuy_spg_class_report MÉTODO->uf_spg_reporte_chequear_autorizacion_traspaso ERROR->".$this->fun->uf_convertirmsg($this->SQL->message));
	 } 
	 else
	 {
...
function uf_spg_reporte_mayor_analitico2($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,$as_codestpro5_ori,
	                                        $as_codestpro1_des,$as_codestpro2_des,$as_codestpro3_des,$as_codestpro4_des,$as_codestpro5_des,
	                                        $adt_fecini,$adt_fecfin,$as_cuenta_from,$as_cuenta_to,$as_orden,&$rs_mov_spg)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reporte_mayor_analitico
	 //         Access :	private
	 //     Argumentos :    as_codestpro1_ori ... $as_codestpro5_ori //rango nivel estructura presupuestaria origen
	 ...
	 // Fecha Creación :    01/02/2006          Fecha última Modificacion : 01/02/2006 Hora :
      ...
      $ls_mysql=" SELECT MV.procede, MV.comprobante, MV.fecha,MV.codestpro1, MV.codestpro2,MV.codestpro3, ".
                ...
                " 	    (".$ls_str_sql_2." BETWEEN '".$ls_estructura_desde."' AND '".$ls_estructura_hasta."'".
				"   	  AND MV.spg_cuenta between '".$as_cuenta_from."' AND '".$as_cuenta_to."') ".		//Agregado el rango de cuentas por Ing. Nelson Barraez 20-12-2006		  
                "      AND  MV.fecha >= '".$adt_fecini."' AND  MV.fecha <= '".$adt_fecfin."'".
				" GROUP BY MV.fecha, MV.procede, MV.comprobante,MV.codestpro1, MV.codestpro2,MV.codestpro3, ".
...
function uf_spg_calcular_saldo_anterior ($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,$as_codestpro5_ori,
	                                        $as_codestpro1_des,$as_codestpro2_des,$as_codestpro3_des,$as_codestpro4_des,$as_codestpro5_des,
	                                       $adt_fecdes,$adt_fecfin,$as_cuenta_from,$as_cuenta_to,&$rs_mov_spg)
...
function uf_spg_reporte_acumulado_cuentas2($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,
											  ...
											  $as_codestpro4_des,$as_codestpro5_des,$adt_fecini,$adt_fecfin,$ai_nivel,
											  $ab_subniveles,&$ai_MenorNivel,$as_cuentades,$as_cuentahas,$as_codfuefindes,
											  $as_codfuefinhas,&$rs_cuentas,&$as_rango)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $li_estmodest=$_SESSION["la_empresa"]["estmodest"];
		...
		$as_rango = str_replace("PCT","MV",$ls_str_sql_where);	
		if($li_estmodest==1)
		{
		  $ls_tabla="spg_ep3"; 
		  $ls_cadena_fuefin="AND PCT.codestpro1=spg_ep3.codestpro1 AND PCT.codestpro2=spg_ep3.codestpro2 AND PCT.codestpro3=spg_ep3.codestpro3";
        ...
        $ls_mysql=" SELECT DISTINCT PCT.spg_cuenta, PCT.nivel, min(PCT.denominacion) as denominacion,   ".
...
function uf_spg_reporte_detalle_acumulado_cuentas($as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,
	                                              ...
	                                              $as_codestpro5h,$as_spg_cuenta,$adt_fecfin,&$rs_data2)
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    13/08/08          Fecha última Modificacion :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			$criterio=" AND (CONCAT(MV.codestpro1,MV.codestpro2,MV.codestpro3,MV.codestpro4,MV.codestpro5) 
                       	BETWEEN '$as_codestpro1$as_codestpro2$as_codestpro3$as_codestpro4$as_codestpro5' 
						AND     '$as_codestpro1h$as_codestpro2h$as_codestpro3h$as_codestpro4h$as_codestpro5h') ";
		}
		if ($_SESSION["ls_gestor"]=="POSTGRE")
		{
			$criterio=" AND (MV.codestpro1||MV.codestpro2||MV.codestpro3||MV.codestpro4||MV.codestpro5 
                       	BETWEEN '$as_codestpro1$as_codestpro2$as_codestpro3$as_codestpro4$as_codestpro5' 
						AND     '$as_codestpro1h$as_codestpro2h$as_codestpro3h$as_codestpro4h$as_codestpro5h') ";
		}
	    //$this->dts_reporte->resetds("spg_cuenta");								 
	 ...
	 return $lb_valido;
   } // fin function uf_spg_reporte_detalle_acumulado_cuentas
