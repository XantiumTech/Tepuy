<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_moneda,$as_trimestre,&$io_pdf)
	{
		...
		$io_pdf->addText(37,384,7,"UB-RAMO",270);
...
//-----------------------------------------------------------------------------------------------------------------------------
		global $la_data_tot;
		require_once("tepuy_spi_class_reportes_instructivos.php");
		$io_report = new tepuy_spi_class_reportes_instructivos();
...
//--------------------------------------------------------------------------------------------------------------------------------
     ...
     $lb_valido=$io_report->uf_spi_reportes_ejecucion_trimestral($ldt_fecdes,$ldt_fechas);
		...
		{		
			...
			$ls_status="";
				  ...
				  if($ls_status == "C")
				  {
		           ...
		           $ld_total_liquidado        = $ld_total_liquidado + $ld_liquidado;
		           $ld_total_recaudado        = $ld_total_recaudado + $ld_recaudado;
		           $ld_total_programado_acum  = $ld_total_programado_acum + $ld_programado_acum;
		           $ld_total_devengado_acum   = $ld_total_devengado_acum + $ld_devengado_acum;
		           $ld_total_liquidado_acum   = $ld_total_liquidado_acum + $ld_liquidado_acum;
		           $ld_total_recaudado_acum   = $ld_total_recaudado_acum + $ld_recaudado_acum;
		           $ld_total_ingresos_recibir = $ld_total_ingresos_recibir + $ld_ingresos_recibir;
				  } 
		    ...
		    $ld_total_liquidado        = number_format($ld_total_liquidado,2,",",".");
		    $ld_total_recaudado        = number_format($ld_total_recaudado,2,",",".");
		    $ld_total_programado_acum  = number_format($ld_total_programado_acum,2,",",".");
		    $ld_total_devengado_acum   = number_format($ld_total_devengado_acum,2,",",".");
		    $ld_total_liquidado_acum   = number_format($ld_total_liquidado_acum,2,",",".");
		    $ld_total_recaudado_acum   = number_format($ld_total_recaudado_acum,2,",",".");
		    $ld_total_ingresos_recibir = number_format($ld_total_ingresos_recibir,2,",",".");
			...
			$la_data_tot[1]=array('totales'=>"TOTALES",
								  ...
								  'liquidado'=>$ld_total_liquidado,
								  'recaudado'=>$ld_total_recaudado,
								  'programado_acum'=>$ld_total_programado_acum,
								  'devengado_acum'=>$ld_total_devengado_acum,
								  'liquidado_acum'=>$ld_total_liquidado_acum,
								  'recaudado_acum'=>$ld_total_recaudado_acum,
								  'ingresos_recibir'=>$ld_total_ingresos_recibir);
