...
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
// Edición - Opciones de Tercer Nivel
stm_aix("p3i0","p1i0",[0," Mensual ","","",-1,-1,0,"tepuy_spg_p_apertura.php","_self"]);
stm_aix("p3i0","p1i0",[0," Trimestral ","","",-1,-1,0,"tepuy_spg_p_apertura_trim.php","_self"]);
stm_ep();
stm_aix("p1i2","p1i0",[0,"Comprobantes ","","",-1,-1,0,"","","","","","",6,0,0,"../shared/imagebank/arrow.gif","../shared/imagebank/arrow.gif",0,0,0,0,1,"#ffffff"]);
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
// Edición - Opciones de Tercer Nivel
stm_aix("p3i0","p1i0",[0,"  Ejecución Financiera  ","","",-1,-1,0,"tepuy_spg_p_comprobante.php","_self"]);
stm_ep();
...
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
// Edición - Opciones de Tercer Nivel
stm_aix("p3i0","p1i0",[0,"  Rectificaciones  ","","",-1,-1,0,"tepuy_spg_p_rectificaciones.php","_self"]);
stm_aix("p3i0","p1i0",[0,"  Insubsistencias ","","",-1,-1,0,"tepuy_spg_p_insubsistencias.php","_self"]);
stm_aix("p3i0","p1i0",[0,"  Traspasos  ","","",-1,-1,0,"tepuy_spg_p_traspaso.php","_self"]);
stm_aix("p3i0","p1i0",[0,"  Credito/Ingreso Adicional  ","","",-1,-1,0,"tepuy_spg_p_adicional.php","_self"]);
stm_ep();
stm_ai("p1i1",[6,1,"#e6e6e6","",0,0,0]);
...
stm_bpx("p3","p1",[1,2,0,0,2,3,0]);
// Edición - Opciones de Tercer Nivel
stm_aix("p3i0","p1i0",[0," Mensual ","","",-1,-1,0,"tepuy_spg_p_progrep.php","_self"]);
stm_aix("p3i0","p1i0",[0," Trimestral ","","",-1,-1,0,"tepuy_spg_p_progrep_trim.php","_self"]);
stm_ep();
stm_ep();
