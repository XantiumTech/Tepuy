...
$io_ctabanco = new tepuy_c_cuentas_banco();
...
if (array_key_exists("operacion",$_POST))
   {
	 ...
	 if ($ls_opener!='tepuy_scb_p_pago_directo.php')
	    {
...
<form name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="900" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
	  	<?php if($ls_opener!='tepuy_scb_p_pago_directo.php'){?>
        ...
        <td height="22" colspan="3" align="left" ><select name="codope" id="select">
          ...
          <option value="TR">Pago de Orden por Transferencia</option>
         </select></td>
		 <?php } ?>
      ...
      <tr>
        <td height="22" colspan="6" style="text-align:left"><div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar..." width="20" height="20" border="0">Buscar</a></div></td>
      </tr>
    </table>
	<br>
    <p>&nbsp;</p>
...
<script language="JavaScript">
  ...
  function uf_aceptar(ls_documento,ls_codope,ls_fecha,ls_descripcion,ldec_monto,ldec_monobjret,ldec_monret,ls_tipo_destino,ls_prov,ls_bene,ls_provbene,ls_codban,
					  ...
					  ls_codfuefin,ls_numchequera,as_numchevau)
  {
	...
	if (document.form1.opener.value=='tepuy_scb_p_movbanco.php')
	   {
	     f.txtnumcarord.value = ls_numcarord;	
	     f.estimpche.value    = li_estimpche;		 
	   }
	if (document.form1.opener.value=='tepuy_scb_p_pago_directo.php')
 	   {
	     f.txtchequera.value = ls_numchequera;
	     f.txtchevau.value   = as_numchevau;	
 	   }
  ...
  function ue_search()
  {
	  ...
	  if((ls_fecdesde!="")&&(ls_fechasta!=""))
	  {
		  ...
		  f.action="tepuy_cat_mov_bancario.php";
		  f.submit();
	  }
	  else
	  {
