<?php
	...
	else // Imprimimos el reporte
	{
		...
		$io_fun_activos->uf_load_seguridad_reporte("SAF","tepuy_saf_r_activo.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////
		...
		for($li_i=1;$li_i<=$li_totrow;$li_i++)
		{
			...
			if($lb_valido)
			{
				...
				for($li_s=1;$li_s<=$li_totrow_det;$li_s++)
				{
					...
					$la_data[$li_s]=array('seract'=>$ls_seract,'ideact'=>$ls_chapa,'idchapa'=>$ls_chapa,'nomrespri'=>$ls_nomrespri,
