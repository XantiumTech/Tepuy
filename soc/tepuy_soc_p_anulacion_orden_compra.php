...
$io_fun_compra->uf_load_seguridad("SOC","tepuy_soc_p_anulacion_orden_compra.php",$ls_permisos,&$la_seguridad,$la_permisos);
...
switch ($li_diasem){
  ...
  break;
   ...
   function uf_limpiarvariables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		global $io_fun_compra,$ld_fecope,$ld_fecdes,$ld_fechas,$ls_numordcom,$ls_codpro,$ls_nompro,$ls_operacion,$li_totrows;
   ...
   function uf_load_variables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		...
   		global $ld_fecope,$ld_fecdes,$ld_fechas,$ls_numordcom,$ls_codpro,$ls_nompro,$ls_operacion,$li_totrows;
...
<?php
require_once("class_folder/tepuy_soc_c_anulacion_orden_compra.php");
$io_soc=new tepuy_soc_c_anulacion_orden_compra("../");
uf_limpiarvariables();
switch($ls_operacion){
  case 'GUARDAR':
	 uf_load_variables();
        ...
        <td width="697" height="168"><div align="center">
          <table width="590" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
            ...
            <tr>
              ...
              <td height="22">&nbsp;</td>
              <td height="22">Desde
                <input name="txtfecdes" type="text" id="txtfecdes" value="<?php print $ld_fecdes ?>" size="12" maxlength="10" datepicker="true"/></td>
              <td height="22">&nbsp;</td>
            ...
            <tr>
              ...
              <td height="22" colspan="7"><label>
                ...
                <a href="javascript:ue_catalogo_proveedores();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar..." width="15" height="15" border="0" /></a></label>
                  <label>
            ...
            <tr>
              <td height="22" colspan="8" style="text-align:right"><a href="javascript:ue_buscar();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar..." width="20" height="20" border="0" /></a><a href="javascript:ue_buscar();">Buscar Ordenes de Compra</a></td>
            </tr>
            <tr>
...
function ue_buscar()
{
  ...
  if (li_leer==1)
	 {  
	   ...
	   ajax.open("POST","class_folder/tepuy_soc_c_anulacion_orden_compra_ajax.php",true);
  ...
  function ue_guardar()
  {
	  ...
	  if ((li_incluir==1) || (li_cambiar==1))
	     {    	 	 
		   ...
		   f.action="tepuy_soc_p_anulacion_orden_compra.php";
		   f.submit(); 
	     }
	  else
	     {
