...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 {
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->tepuy_spg_class_report MÉTODO->uf_spg_reporte_apertura ERROR->".$this->fun->uf_convertirmsg($this->SQL->message));
	 }
     else
	 {
			while($row=$this->SQL->fetch_row($rs_data))
...
/****************************************************************************************************************************************/	
    function uf_spg_reporte_select_apertura( $as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,$as_codestpro5_ori,
	                                         $as_codestpro1_des,$as_codestpro2_des,$as_codestpro3_des,$as_codestpro4_des,$as_codestpro5_des,
	                                         $adt_fecini,$adt_fecfin )
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reporte_apertura
	 ...
	 // Fecha Creación :    09/05/2006          Fecha última Modificacion :      Hora :
	  ...
	  if(strtoupper($ls_gestor)=="MYSQL")
	  {	  
		  $ls_sql=" SELECT distinct CONCAT(DM.codestpro1,DM.codestpro2,DM.codestpro3,DM.codestpro4,DM.codestpro5) as programatica, ".
				  "        EP.denestpro5 ".
				  " FROM   spg_dt_cmp DM, spg_cuentas GC, spg_ep5 EP ".
				  " WHERE  DM.codemp='".$ls_codemp."' AND DM.codemp=GC.codemp AND GC.codemp=EP.codemp AND ".
				  "        ".$ls_cad_DM." = ".$ls_cad_GC." AND  ".$ls_cad_DM_SC." = ".$ls_cad_EP." AND ".
	  ...
	  if(strtoupper($ls_gestor)=="POSTGRE")
	  {	  
		  $ls_sql=" SELECT distinct (DM.codestpro1||DM.codestpro2||DM.codestpro3||DM.codestpro4||DM.codestpro5) as programatica, ".
				  "        EP.denestpro5 ".
				  " FROM   spg_dt_cmp DM, spg_cuentas GC, spg_ep5 EP ".
				  " WHERE  DM.codemp='".$ls_codemp."' AND DM.codemp=GC.codemp AND GC.codemp=EP.codemp AND ".
				  "        ".$ls_cad_DM." = ".$ls_cad_GC." AND  ".$ls_cad_DM_SC." = ".$ls_cad_EP." AND ".
	 ...
	 {
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->tepuy_spg_class_report MÉTODO->uf_spg_reporte_select_apertura ERROR->".$this->fun->uf_convertirmsg($this->SQL->message));
	 }
	else
	{
		if($row=$this->SQL->fetch_row($rs_data))
...
/****************************************************************************************************************************************/	
	...
	////////////////////////////////////////////////////////
	function uf_spg_reporte_select_mayor_analitico( $as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,$as_codestpro5_ori,
	                                                $as_codestpro1_des,$as_codestpro2_des,$as_codestpro3_des,$as_codestpro4_des,$as_codestpro5_des,
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    16/05/2006          Fecha última Modificacion :         Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (strtoupper($ls_gestor)=="MYSQL")
		{
			$ls_sql=" SELECT distinct CONCAT(MV.codestpro1,MV.codestpro2,MV.codestpro3,MV.codestpro4,MV.codestpro5) as programatica ".
					...
					"       MV.fecha,OPE.asignar DESC, OPE.aumento DESC, OPE.disminucion DESC, ".
					"       OPE.comprometer DESC, OPE.causar DESC, OPE.pagar DESC, MV.Documento "; 	
		}
		if (strtoupper($ls_gestor)=="POSTGRE")
		{
			$ls_sql=" SELECT distinct (MV.codestpro1||MV.codestpro2||MV.codestpro3||MV.codestpro4||MV.codestpro5) as programatica ".
					" FROM spg_dt_cmp MV,spg_operaciones OPE,spg_cuentas C ".
					" WHERE MV.codemp='".$ls_codemp."' AND (MV.operacion=OPE.operacion) AND MV.codestpro1=C.codestpro1 AND ".
					"       MV.codestpro2=C.codestpro2 AND MV.codestpro3=C.codestpro3 AND ".
					"       MV.codestpro4=C.codestpro4 AND MV.codestpro5=C.codestpro5 AND ".
	 ...
	 // Fecha Creación :    17/04/2006          Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		else
		{
			...
			{
				$ls_sql=" SELECT CONCAT(PCT.codestpro1, PCT.codestpro2, PCT.codestpro3, PCT.codestpro4,PCT.codestpro5) AS programatica, ".
						"        PCT.codestpro1, PCT.codestpro2, PCT.codestpro3, PCT.codestpro4,PCT.codestpro5, PCT.spg_cuenta,  ".
			...
			{
				$ls_sql=" SELECT (PCT.codestpro1||PCT.codestpro2||PCT.codestpro3||PCT.codestpro4||PCT.codestpro5) AS programatica, ".
						"        PCT.codestpro1, PCT.codestpro2, PCT.codestpro3, PCT.codestpro4,PCT.codestpro5, PCT.spg_cuenta,  ".
						"        PCT.denominacion, PCT.status, EP.denestpro5 ".
						" FROM   spg_cuentas PCT, spg_ep5 EP ".
						" WHERE  PCT.codemp='".$ls_codemp."' AND PCT.codemp=EP.codemp AND  PCT.codestpro1=EP.codestpro1 AND ".
		   ...
		   else
		   {
			   ...
			   {   
				   ...
				   if(!$this->uf_calcular_disponible_operacion_por_cuenta($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,
					...
					$ld_asignado=$ld_monto_asignado+$ld_monto_aumento_a+$ld_monto_aumento-$ld_monto_disminucion_a-$ld_monto_disminucion;
					$ld_disponible=$ld_monto_asignado-($ld_monto_compromiso+$ld_monto_precompromiso)+$ld_monto_aumento-$ld_monto_disminucion;
...
/****************************************************************************************************************************************/	
    ...
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    15/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT CMP.descripcion as cmp_descripcion, CMP.fecha as fecha, MOV.*, (monto-monto) as aumento, (monto-monto) as disminucion, ".
              ...
              " FROM   spg_dt_cmp MOV, tepuy_cmp CMP,spg_cuentas CTA ".
	 ...
	 {
		  $lb_valido=false;
		  $this->io_msg->message("CLASE->tepuy_spg_class_report MÉTODO->uf_spg_reporte_modificaciones_presupuestarias ERROR->".$this->fun->uf_convertirmsg($this->SQL->message));
	 } 
	 else 
	 {
			while($row=$this->SQL->fetch_row($rs_data))
