...
var url    = '../../php/tepuy_srh_a_configuracion_deduccion.php';
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_d_configuracion_deduccion.php";
  f.submit(); 
}
...
{
	window.open("../catalogos/tepuy_srh_cat_tipodeduccion.php?valor_cat=0","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
}


function ue_buscar()
{
	window.open("../catalogos/tepuy_srh_cat_configuracion_deduccion.php?valor_cat=1&tipo=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
