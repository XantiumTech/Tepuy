...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SIV";
	$ls_ventanas="tepuy_siv_r_inventario.php";
...
<script language="JavaScript">
	...
	{
		window.open("tepuy_saf_cat_codactivoss.php?coddestino="+ ls_coddestino +"&dendestino="+ ls_dendestino +"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
	}
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				if ((ld_desde!="")&&(ld_hasta!=""))
				{
					...
					window.open("reportes/tepuy_saf_rpp_activo.php?ordenact="+li_ordenact+"&desde="+ld_desde+"&hasta="+ld_hasta+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&status="+ls_estatus+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
