...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_ordenpago.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
?>
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr class="titulo-ventana">
      <td height="22" colspan="4" align="center">Listado de Ordenes de Pago <span style="text-align:left"><span class="Estilo1">
  ...
  if (li_imprimir=='1')
     {
	   if (f.tipo[0].checked)
	      {
		    pagina="reportes/tepuy_scb_rpp_listado_op.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codope="+ls_codope+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&codconcep="+ls_concepto+"&orden="+ls_orden+"&tiporeporte="+ls_tiporeporte;	
	      }
	   else
	      {
		    pagina="reportes/tepuy_scb_rpp_listado_detalle_op.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codope="+ls_codope+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&codconcep="+ls_concepto+"&orden="+ls_orden+"&tiporeporte="+ls_tiporeporte;
	      }
...
//Catalogo de cuentas contables
	...
	function cat_conceptos()
	{
	   ...
	   pagina="tepuy_cat_conceptos.php?codope=OP";
	   window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=516,height=400,resizable=yes,location=no");
	}
</script>
