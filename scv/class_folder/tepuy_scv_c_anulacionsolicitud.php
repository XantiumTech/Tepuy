<?php
class tepuy_scv_c_anulacionsolicitud
 {
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_scv_c_anulacionsolicitud($as_path)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_scv_c_anulacionsolicitud
		//		   Access: public 
	...
	}// end function tepuy_scv_c_anulacionsolicitud
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_load_solicitudes($as_codsolvia,$ad_fecregdes,$ad_fecreghas,$as_tipooperacion)
	{
		...
		//////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql="SELECT scv_solicitudviatico.*,scv_rutas.desrut,scv_misiones.denmis".
				"  FROM scv_solicitudviatico,scv_rutas,scv_misiones".
				" WHERE scv_solicitudviatico.codemp='".$this->ls_codemp."'".
				"   AND CONCAT('SCV-000',scv_solicitudviatico.codsolvia)".
				"    IN (SELECT numrecdoc".
				...
				" UNION ".
				"SELECT scv_solicitudviatico.*,scv_rutas.desrut,scv_misiones.denmis".
				"  FROM scv_solicitudviatico,scv_rutas,scv_misiones".
				" WHERE scv_solicitudviatico.codemp='".$this->ls_codemp."'".
				"   AND estsolvia='R'".
				"   AND fecsolvia>='".$ad_fecregdes."'".
