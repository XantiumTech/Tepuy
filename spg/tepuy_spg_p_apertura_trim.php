...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_p_apertura_trim.php";
  ...
  <tr>
	...
	<table width="570" height="171" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr class="formato-blanco">
        ...
        <td colspan="3"><input name="codestpro2" type="text" id="codestpro22" style="text-align:center" value="<?php print $ls_codestpro2 ?>" size="22" maxlength="6" readonly>
...
Manual </td>
        <td width="262"><a href="javascript:ue_distribuir();"><img src="../shared/imagebank/tools15/aprobado.png" alt="Aceptar" width="15" height="15" border="0"></a></td>
      </tr>
      <tr>
        <td height="22">&nbsp;</td>
        <td colspan="3">&nbsp;</td>
...
if ($ls_operacion=="CARGAR" )
{
   ...
   $ls_codestpro4="00";
   $ls_codestpro5="00";
   $rs_load=$io_class_aper->uf_spg_load_cuentas_apertura($ls_codemp,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,$ls_codestpro5);
   if($row=$io_sql->fetch_row($rs_load))
   {
	   ...
	   {    
			...
			$object[$i][4]="<input type=text name=txtMarzo".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)'  value=$ld_marzo class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>";
			$object[$i][5]="<input type=text name=txtJunio".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' value=$ld_junio class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>";
			$object[$i][6]="<input type=text name=txtSeptiembre".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' value=$ld_septiembre class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>";
			$object[$i][7]="<input type=text name=txtDiciembre".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' value=$ld_diciembre class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>";
	   }//for    
  ...
  else
  {
	 ...
	 ?>
		...
		f=document.form1;
		f.action="tepuy_spg_p_apertura_trim.php";
		f.codestpro1.value="";
		f.codestpro2.value="";
		f.codestpro3.value="";
		f.denestpro1.value="";
...
if ($ls_operacion=="GUARDAR")
{
   ...
   { 
		...
		$object[$i][1]="<input type=text name=txtCuenta".$i." value=$ls_cuenta class=sin-borde readonly><input name=cuenta".$i." type=hidden id=cuenta value='$ls_cuenta'><input name=distribuir".$i." type=hidden id=distribuir value='$ls_distribuir'>";
		$object[$i][2]="<input type=text name=txtDenominacion".$i." value='$ls_denominacion' size=50 class=sin-borde readonly >";
		$object[$i][3]="<input type=text name=txtAsignacion".$i." class=sin-borde onBlur='uf_formato(this)' onKeyPress='return keyRestrictgrid(event)' value=".number_format($ld_asignado,2,",",".")."  onFocus= uf_fila(".$i.") style=text-align:right>";
		$object[$i][4]="<input type=text name=txtMarzo".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)'  value=".number_format($ld_marzo,2,",",".")."  class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>";
		$object[$i][5]="<input type=text name=txtJunio".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' value=".number_format($ld_junio,2,",",".")." class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>";
		$object[$i][6]="<input type=text name=txtSeptiembre".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)' value=".number_format($ld_septiembre,2,",",".")." class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>";
		$object[$i][7]="<input type=text name=txtDiciembre".$i." onBlur=uf_format(this) onKeyPress='return keyRestrictgrid(event)'  value=".number_format($ld_diciembre,2,",",".")." class=sin-borde onFocus= uf_fila(".$i.") style=text-align:right>";
...
function catalogo_estpro3()
{
	...
	{
    	pagina="tepuy_cat_public_estpro3.php?codestpro1="+codestpro1+"&denestpro1="+denestpro1+"&codestpro2="+codestpro2+"&denestpro2="+denestpro2+"&tipo=apertura";
		window.open(pagina,"_blank","menubar=no,toolbar=no,scrollbars=yes,width=568,height=400,resizable=yes,location=no");
	}
	else
	{
