<?php
	...
	$io_fun_scf->uf_load_seguridad("SCF","tepuy_scf_r_mayor_analitico.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
      ...
      <table width="600" height="22" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td align="center"><div align="left">
            ...
            <a href="javascript:ue_buscarcuenta('REPDESTOD')"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Cuentas" width="15" height="15" border="0"></a></div></td>
          <td align="center"><div align="right">Hasta</div></td>
          <td align="center"><div align="left">
            <input name="txtcuentahasta" type="text" id="txtcuentahasta" size="22">
            <a href="javascript:ue_buscarcuenta('REPHASTOD')"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Cuentas" width="15" height="15" border="0"></a></div></td>
        </tr>
        <tr class="titulo-celdanew">
...
function ue_imprimir()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/tepuy_scf_rpp_mayor_analitico.php?fecdes="+fecdes+"&fechas="+fechas+"&orden="+orden;
...
function ue_openexcel()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/tepuy_scf_rpp_mayor_analitico_excel.php?fecdes="+fecdes+"&fechas="+fechas+"&orden="+orden;
			pagina=pagina+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta+"&tiporeporte="+tiporeporte;
			window.open(pagina,"Reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
   	}
...
{
	window.open("tepuy_scf_cat_cuentasscg.php?tipo="+tipo,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=50,top=50,location=no,resizable=yes");
}
</script>
