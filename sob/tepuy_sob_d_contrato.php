...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_d_contrato.php";
...
if(array_key_exists("operacion",$_POST))
{
	...
	$li_filascondiciones=$_POST["hidfilascondiciones"];
	$li_filasgarantias=$_POST["hidfilasgarantias"];
	...
	if ($ls_operacion != "ue_cargarcondiciones" && $ls_operacion != "ue_removercondiciones" && $ls_operacion != "ue_cargarcontrato")
	{
		...
		{		
			...
			$la_objectcondiciones[$li_i][1]="<input name=txtnumcon".$li_i."  type=text id=txtnumcon".$li_i."  class=sin-borde style= text-align:center value='".$ls_numero."' size=5 readonly>";
			...
			$la_objectcondiciones[$li_i][4]="<input name=txtporcon".$li_i."  type=text id=txtporcon".$li_i."  class=sin-borde style= text-align:center value='".$ls_porcentaje."' size=11 >";
			$la_objectcondiciones[$li_i][5]="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removercondiciones(".$li_i.");>&nbsp;&nbsp;<img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
		}	
	...
	if ($ls_operacion != "ue_cargargarantias" && $ls_operacion != "ue_removergarantias" && $ls_operacion != "ue_cargarcontrato")
	{
		for($li_i=1;$li_i<$li_filasgarantias;$li_i++)
		{		
			$ls_numero=$_POST["txtnumgar".$li_i];
			$ls_descripcion=$_POST["txtdesgar".$li_i];
			$la_objectgarantias[$li_i][1]="<input name=txtnumgar".$li_i."  type=text id=txtnumgar".$li_i."  class=sin-borde value='".$ls_numero."' style= text-align:center size=5 readonly>";
			...
			$la_objectgarantias[$li_i][3]="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removergarantias(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
		}	
...
if	(array_key_exists("txtnrocon",$_POST)){	$ls_nrocon=$_POST["txtnrocon"]; }
else{$ls_nrocon="";}
...
elseif($ls_operacion=="ue_removerretenciones")
{
	...
	for($li_i=1;$li_i<=$li_filasretenciones;$li_i++)
	{
		...
		{		
			...
			$la_objectretenciones[$li_temp][5]="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removerretenciones(".$li_temp.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
		}
	}
	$la_objectretenciones[$li_filasretenciones][1]="<input name=txtcodret".$li_filasretenciones." type=text id=txtcodret".$li_filasretenciones." class=sin-borde style= text-align:center size=5 readonly>";
	$la_objectretenciones[$li_filasretenciones][2]="<input name=txtdesret".$li_filasretenciones." type=text id=txtdesret".$li_filasretenciones." class=sin-borde style= text-align:left size=35 readonly>";
...
elseif($ls_operacion=="ue_removercondiciones")
{
	...
	for($li_i=1;$li_i<=$li_filascondiciones;$li_i++)
	{
		...
		{		
			...
			$la_objectcondiciones[$li_temp][5]="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removercondiciones(".$li_i.");>&nbsp;&nbsp;<img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
		}		
	}
	$la_objectcondiciones[$li_filascondiciones][1]="<input name=txtnumcon".$li_filascondiciones."  type=text id=txtnumcon".$li_filascondiciones."  class=sin-borde style= text-align:center  size=5 readonly>";
	$la_objectcondiciones[$li_filascondiciones][2]="<input name=txtfeccon".$li_filascondiciones."  type=text id=txtfeccon".$li_filascondiciones."  class=sin-borde style= text-align:center  size=10 readonly>";
...
elseif($ls_operacion=="ue_removergarantias")
{
	...
	for($li_i=1;$li_i<=$li_filasgarantias;$li_i++)
	{
		...
		{		
			...
			$la_objectgarantias[$li_temp][3]="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removergarantias(".$li_temp.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
		}		
	}
	$la_objectgarantias[$li_filasgarantias][1]="<input name=txtnumgar".$li_filasgarantias."  type=text id=txtnumgar".$li_filasgarantias."  class=sin-borde  style= text-align:center size=5 readonly>";
	$la_objectgarantias[$li_filasgarantias][2]="<input name=txtdesgar".$li_filasgarantias."  type=text id=txtdesgar".$li_filasgarantias."  class=sin-borde  style= text-align:left size=90 readonly>";
...
elseif($ls_operacion=="ue_guardar")
{
	...
	if(!$lb_existe)
	{
		...
		//$ls_precon=$_POST["txtnrocon"];
		//print "prefijo: ".$ls_nrocon;
		$lb_valido = $io_contrato->uf_guardar_contrato($ls_codcon,$ls_nrocon,$ls_codasi,$ls_monto,$ls_feccon,$ls_fecinicon,$li_placon,
		...
		{		
			...
			for($li_i=1;$li_i<$li_filascondiciones;$li_i++)
			{
				$ls_numero=$_POST["txtnumcon".$li_i];
				$ls_fecha=$_POST["txtfeccon".$li_i];
				$ls_fecha=$io_function->uf_convertirdatetobd($ls_fecha);
				$ld_monto=$_POST["txtmoncon".$li_i];
				$ld_porcentaje=$_POST["txtporcon".$li_i];
				$lb_validocondiciones=$io_contrato->uf_guardar_condiciones($ls_codcon ,$ls_numero,$ls_fecha,$ld_monto,$ld_porcentaje,$la_seguridad);
				if(!$lb_validocondiciones)
				{
					print "Hubo un error al intentar insertar la condicion $li_i";
					$lb_valido=false;
					break;
				}
			}
			...
			for($li_i=1;$li_i<$li_filasgarantias;$li_i++)
			{
				$ls_numero=$_POST["txtnumgar".$li_i];
				$ls_descripcion=$_POST["txtdesgar".$li_i];
				$lb_validogarantias=$io_contrato->uf_guardar_garantias($ls_codcon ,$ls_numero,$ls_descripcion,$la_seguridad);
				if(!$lb_validogarantias)
				{
					   print "Hubo un error al intentar insertar la garantia $li_i";
					   $lb_valido=false;
					   break;
				}
			}
		...
		if($ls_imprimir=="IMPRIMIR")
		{
			 $ls_documento="CONTRATO";
			  $ls_pagina="tepuy_sob_d_filechooser.php?codcon=".$ls_codcon."&documento=".$ls_documento;
			  print "<script language=JavaScript>";
		...
		if($lb_valido)
		{
			if($li_estado==1 && $li_estadocontabilizacion==0)
			{
				...
				if($ls_lapgarcon=="" || $ls_lapgarcon=="0")
					$ls_codunigarantia="---";
				//print "prefijo: ".$ls_nrocon;				
				$lb_valido=$io_contrato->uf_update_contrato($ls_codcon,$ls_nrocon,$ls_codasi,$ls_monto,$ls_feccon,$ls_fecinicon,$li_placon,
									$ls_coduniduracion,$ls_mulcon,$ls_lapmulcon,$ls_coduniretraso,$ls_lapgarcon,$ls_codunigarantia,
									$ls_codtco ,$ls_monmaxcon,$ls_pormaxcon,$ls_estcon,$ls_obscon,$ls_fecfincon,$ls_hidprefijo,$la_seguridad);
				if($lb_valido)
				{
					...
					$la_condiciones["codconpag"][1]="";
					$la_condiciones["fecconpag"][1]="";		
					$la_condiciones["monconpag"][1]="";		
					$la_condiciones["porconpag"][1]="";		
					for($li_i=1;$li_i<$li_filascondiciones;$li_i++)
					{
						$la_condiciones["codconpag"][$li_i]=$_POST["txtnumcon".$li_i];		
						$la_condiciones["fecconpag"][$li_i]=$io_function->uf_convertirdatetobd($_POST["txtfeccon".$li_i]);		
						$la_condiciones["monconpag"][$li_i]=$_POST["txtmoncon".$li_i];		
						$la_condiciones["porconpag"][$li_i]=$_POST["txtporcon".$li_i];		
					}
					$lb_validocondiciones=$io_contrato->uf_update_condiciones($ls_codcon,$la_condiciones,$li_filascondiciones,$la_seguridad);
					
					$la_garantias["codgar"][1]="";
					$la_garantias["desgar"][1]="";
					for($li_i=1;$li_i<$li_filasgarantias;$li_i++)
					{
						$la_garantias["codgar"][$li_i]=$_POST["txtnumgar".$li_i];
						$la_garantias["desgar"][$li_i]=$_POST["txtdesgar".$li_i];
					}
					$lb_validogarantias=$io_contrato->uf_update_garantias($ls_codcon ,$la_garantias,$li_filasgarantias,$la_seguridad);
...
elseif($ls_operacion=="ue_cargarcontrato")
{
	...
	$lb_validocondiciones=$io_contrato->uf_select_condiciones($ls_codcon,$la_data,$filas);
	if($lb_validocondiciones)
	{
		$li_filascondiciones=$filas+1;
	}
	else
	{
		$li_filascondiciones=1;
	...
	for($li_i=1;$li_i<$li_filascondiciones;$li_i++)
	{		
		$ls_moncon=$io_funnum->uf_convertir_numerocadena($la_data["monto"][$li_i]);
		$ls_porcentaje=$io_funnum->uf_convertir_numerocadena($la_data["porconpag"][$li_i]);
		$ls_fecha=$io_function->uf_convertirfecmostrar($la_data["fecconpag"][$li_i]);
		$la_objectcondiciones[$li_i][1]="<input name=txtnumcon".$li_i."  type=text id=txtnumcon".$li_i."  class=sin-borde style= text-align:center value='".$li_i."' size=5 readonly>";
		$la_objectcondiciones[$li_i][2]="<input name=txtfeccon".$li_i."  type=text id=txtfeccon".$li_i."  class=sin-borde style= text-align:center value='".$ls_fecha."' size=10 readonly>";
		$la_objectcondiciones[$li_i][3]="<input name=txtmoncon".$li_i."  type=text id=txtmoncon".$li_i."  class=sin-borde style= text-align:center value='".$ls_moncon."' size=30 readonly>";
		$la_objectcondiciones[$li_i][4]="<input name=txtporcon".$li_i."  type=text id=txtporcon".$li_i."  class=sin-borde style= text-align:center value='".$ls_porcentaje."'  size=11 readonly>";
	...
	$lb_validogarantias=$io_contrato->uf_select_garantias($ls_codcon,$la_data,$filas);
	if($lb_validocondiciones)
	{
		$li_filasgarantias=$filas+1;
	}
	else
	{
		$li_filasgarantias=1;
	...
	for($li_i=1;$li_i<$li_filasgarantias;$li_i++)
		{		
			$ls_descripcion=$la_data["desgar"][$li_i];
			$ls_numero=$io_funnum->uf_convertir_numerocadena($la_data["codgar"][$li_i]);
			$la_objectgarantias[$li_i][1]="<input name=txtnumgar".$li_i."  type=text id=txtnumgar".$li_i."  class=sin-borde value='".$li_i."' style= text-align:center size=5 readonly>";
			$la_objectgarantias[$li_i][2]="<input name=txtdesgar".$li_i."  type=text id=txtdesgar".$li_i."  class=sin-borde value='".$ls_descripcion."' style= text-align:left size=90 >";
			$la_objectgarantias[$li_i][3]="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=javascript:ue_removergarantias(".$li_i.");><img src=../shared/imagebank/tools15/eliminar.png alt=Aceptar width=15 height=15 border=0 style= text-align:center></a>";
		}	
...
elseif($ls_operacion=="ue_eliminar")///Esto es una eliminacion fisica!
{
	$lb_existe=$io_contrato->uf_select_contrato($ls_codcon,$la_data);	
	if ($lb_existe)
	{
		$lb_valido=$io_asignacion->uf_update_estado($ls_codasi,5,$la_seguridad);
		$lb_valido=$io_contrato->uf_select_estado($ls_codcon,$li_estado);
		$li_estadocontabilizacion=$io_obra->uf_contabilizado("SELECT estspgscg FROM sob_contrato WHERE codemp='0001' AND codcon='".$ls_codcon."'");
		//print "estado:".$li_estadocontabilizacion;
		if($lb_valido)
		{
			if($li_estado==1 && $li_estadocontabilizacion==0)
			{
				//$lb_valido=$io_contrato->uf_update_estado($ls_codcon,3,$la_seguridad);
				$lb_valido=$io_contrato->uf_delete_condicionpago_contrato($ls_codcon,$la_seguridad);
				$lb_valido=$io_contrato->uf_delete_retencion_contrato($ls_codcon,$la_seguridad);
				$lb_valido=$io_contrato->uf_delete_contrato($ls_codcon,$la_seguridad);
				if($lb_valido)
				{
					$io_msg->message("El Contrato Nro.".$ls_codcon."ha sido eliminado ");
					//$io_mensaje->anular();
				}
			}
			else
			{
				if($li_estadocontabilizacion==0)
				{
					...
					if ($ls_estado=="ANULADO")
						$io_msg->message("Este Contrato se encuentra Anulado!!!");
				}
				else
				{
					$io_msg->message("Este Contrato no puede ser Eliminado, se encuentra Contabilizado");
				}
			}
		} 
	}
	...
	{
		$io_msg->message("Debe seleccionar un Contrato!!!");
	}
	$ls_datosasignacion="OCULTAR";
	$ls_datosobra="OCULTAR";
	$ls_datoscontrato="OCULTAR";
...
?>	
  ...
  <table width="743" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      ...
      <tr class="formato-blanco">
        ...
        <td colspan="2">		          <input name="txtcodasi" type="text" id="txtcodasi" style="text-align:center " value="<? print $ls_codasi ?>" size="8" maxlength="8"  readonly="true">
        <input name="operacion" type="hidden" id="operacion">
		 <input name="hidstatus" type="hidden" id="hidstatus">
        <a href="javascript:ue_catasignacion();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a> <input name="hidfecasi" type="hidden" id="hidfecasi" value="<? print $ls_fecasiaux?>"></td>
        <td colspan="2">&nbsp;</td>
      ...
      <tr class="formato-blanco">
		...
		<?Php
            ...
            <!--        <tr>
                      ...
                      <td width="10" >&nbsp;</td>
                      <td width="371">
<input name="txtpuncueasi" type="text" id="txtpuncueasi" readonly="true" value="<? print $ls_puncueasi?>" size="6" maxlength="6">                        
<div align="right"></div></td>-->
                    </tr>
                    <tr>
                      <td height="20"><div align="right">Fecha de Asignaci&oacute;n</div></td>
                      <td height="20">&nbsp;</td>
                      <td width="371"><input name="txtfecasi"   type="text" id="fecasi" value="<? print $ls_fecasi?>" size="11" maxlength="11" readonly="true"></td>
                    </tr>
                    <tr>
                      <td height="20"><div align="right">Empresa Contratista</div></td>
                      <td height="20">&nbsp;</td>
                      <td height="20">
                        <input name="txtcontasi" id="txtcontasi3" value="<? print $ls_contasi?>" size="70" maxlength="254" readonly="true"></td>
                    </tr>
                    <tr>
                      <td height="20" valign="top" class="navigation"><div align="right">Monto Parcial</div></td>
                      <td height="20" valign="top" class="navigation">&nbsp;</td>
                      <td height="20" valign="top"><input name="txtmonasi" type="text"  readonly="true" id="txtmonasi3" value="<? print $ls_monasi?>" size="21" maxlength="21"></td>
                    </tr>
                    <tr>
                      <td height="20" valign="top" class="navigation"><div align="right">Cargos Asociados</div></td>
                      <td height="20" valign="top" class="navigation">&nbsp;</td>
                      <td height="20" valign="top"><input name="txtcarasi" type="text" id="txtcarasi" value="<? print $ls_carasi?>" size="70" maxlength="254" readonly="true"></td>
                    </tr>
                    <tr>
                      <td height="20" valign="top" class="navigation"><div align="right">Monto Total</div></td>
                      <td height="20" valign="top" class="navigation">&nbsp;</td>
                      <td height="20" valign="top"><input name="txtmontotasi" type="text" readonly="true" id="txtmontotasi" value="<? print $ls_montotasi?>" size="21" maxlength="21"></td>
                    </tr>
                    <tr>
                      <td height="20" valign="top" class="navigation"><div align="right">C&oacute;digo de la Obra </div></td>
                      <td height="20" valign="top" class="navigation">&nbsp;</td>
                      <td height="20" valign="top"><input name="txtcodobr" type="text" id="txtcodobr"   value="<? print $ls_codobr?>" size="6" maxlength="6" readonly="true"></td>
                    </tr>
                    <tr>
                      ...
                      <td height="33" valign="top"><textarea name="txtdesobr" cols="67" rows="1" readonly="true" id="txtdesobr"><? print $ls_desobr?></textarea></td>
                    </tr>
                  </table></td>
				  <td height="79" class="sin-borde">&nbsp;</td>
    			</tr>
			...
			?>		
			 ...
			 ?>
				 ...
				 ?>
					...
					<td height="10" colspan="9" align="center" valign="top" class="sin-borde">
					</td>
					<td height="10" class="sin-borde">&nbsp;</td>
				  	</tr>				 
				 <?Php
      ...
      <tr class="formato-blanco">
        <td height="39">&nbsp;</td>
        <td height="39"><div align="right">Numero de Contrato:</div></td>
        <td height="39" colspan="6" align="left" valign="middle" id="tbcombo" >
	<input name="txtnrocon" id="txtnrocon"    read="true" style="text-align:center " value="<? print $ls_nrocon?>" type="text" size="18" maxlength="18">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			Código 
			<input name="txtcodcon" id="txtcodcon"    readonly="true" style="text-align:center " value="<? print $ls_codcon?>" type="text" size="12" maxlength="12">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <td height="39"><div align="right">Fecha</div></td>
        <td width="173" height="39"><input name="txtfeccon" type="text" id="txtfeccon"  style="text-align:center" datepicker="true" value="<? print $ls_feccon ?>" size="12" maxlength="15"  readonly="true" ></td>
        <td height="39">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="26">&nbsp;</td>
        ...
        <td height="26" colspan="6" align="left" valign="middle"><input name="hidtipocontrato" type="hidden" id="hidtipocontrato3" value="<? print $ls_codtco ?>">
&nbsp;&nbsp;&nbsp;
<input name="txtdestipcon" type="text" class="sin-borde" value="<? print $ls_destipcon ?>" readonly="true"></td>
        <td height="26">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="26" rowspan="2">&nbsp;</td>
        <td height="26" rowspan="2">&nbsp;</td>
        <td height="24" colspan="2" align="right">Fecha de Inicio     <input name="txtfecinicon"   type="text" id="txtfecinicon"  style="text-align:left" value="<? print $ls_fecinicon ?>" size="11" maxlength="10"   onBlur="javascript: ue_comparar_intervalo('txtfeccon','txtfecinicon','La fecha de inicio debe ser mayor o igual a la fecha del contrato');" readonly="true" datepicker="true"></td>

	    <!--<td height="24" colspan="2" align="right">Fecha de Inicio     <input name="txtfecinicon"   type="text" id="txtfecinicon"  style="text-align:left" value="<? print $ls_fecinicon ?>" size="11" maxlength="10"   readonly="true" ></td>-->
        <!--<td height="26" colspan="2" rowspan="2"> <div align="right">Duraci&oacute;n (Aprox.) </div></td>
        <td height="26" rowspan="2"><input name="txtplacon" type="text" id="txtplacon" onKeyUp="javascript:ue_activar_unidad(this)"    onKeyPress="return validaCajas(this,'i',event)"  onBlur="javascript: ue_calcularperiodo(this);" style="text-align:right" value="<? print $li_placon ?>" size="6" maxlength="6" ></td>
        <td height="26" colspan="4" rowspan="2">
		<?Php
		 if ($li_placon!="" && $li_placon!="0")
		{
		  print ("<select name=cmbduracion size=1 id=cmbduracion onChange=javascript: ue_calcularperiodo(this);>");
		}
		else
		{
		 print ("<select name=cmbduracion size='1' id='cmbduracion' onChange='javascript: ue_calcularperiodo(this);' disabled='true'>");
		}
		?>
          <option value="---">Seleccione</option>
          <?Php
		  			$la_textos = array("Días","Meses","Anos");
		  			$la_valores = array("d","m","a");
					for($li_i=0;$li_i< count($la_textos);$li_i++)
					{
					 $ls_codigo=$la_valores[$li_i];
					 $ls_descripcion=$la_textos[$li_i];
					 if ($ls_codigo==$ls_coduniduracion)
					 {
        ...
        <input name="hidduracion" type="hidden" id="hidduracion" value="<? print $ls_coduniduracion ?>">		</td>
      </tr>-->
    <!--  <tr class="formato-blanco">
	<td height="26" rowspan="2">&nbsp;</td>-->
        <td height="13" colspan="2" align="right">Fecha de Finaliz.         <input name="txtfecfincon" type="text" id="txtfecfincon"  style="text-align:left" value="<? print $ls_fecfincon ?>" size="11" maxlength="10"   onBlur="javascript: ue_calcularperiodo(this);" datepicker="true" readonly="true"></td>
       <td height="26" rowspan="2">&nbsp;</td>
       <!-- <td height="24" colspan="2" align="right">Fecha de Finaliz.         <input name="txtfecfincon" type="text" id="txtfecfincon"  style="text-align:left" value="<? print $ls_fecfincon ?>" size="11" maxlength="10" readonly="true"></td>-->

      </tr>
      <tr class="formato-blanco">
        <td height="24" colspan="2" align="right">Monto Bs. <input name="txtmonto" type="text"  style="text-align:right" id="txtmonto" readonly="true" size="21" value="<? print $ls_monto?>" maxlength="21">
        </td>
        <!--<td width="16" height="34"><div align="right">Bs.</div></td>
        <td width="107" align="right">Monto L&iacute;mite</td>
        <td height="34" colspan="4"><input name="txtmonmaxcon"  style="text-align:right "type="text" id="txtmonmaxcon" onKeyPress="return(validaCajas(this,'d',event,21)) "  onBlur="javascript:uf_procesarporcentaje(this)" value="<? print $ls_monmaxcon?>" size="21" maxlength="21" onFocus="javascript:ue_guardarvalor()" >
        Bs.&nbsp;
        <input name="txtpormaxcon" type="text" id="txtpormaxcon" value="<? print $ls_pormaxcon?>" size="14" style="text-align:right " maxlength="15"  onKeyPress="return(validaCajas(this,'d',event,21)) "    onBlur="javascript:uf_procesarporcentaje(this)" onFocus="javascript:ue_guardarvalor()">
        %</td>
        <td height="34">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <!--<td height="32">&nbsp;</td>
        <td height="32">&nbsp;</td>
        <td height="32" colspan="2" align="right">Multa por retraso       <input name="txtmulcon" type="text" id="txtmulcon" value="<? print $ls_mulcon?>"  onKeyPress="return(validaCajas(this,'d',event,21)) "  onBlur="javascript:ue_getformat(this)" size="21" style="text-align: right "maxlength="21">        </td>
        <td height="32"><div align="right">Bs.</div></td>
        <td height="32" align="right">Por Cada</td>
        <td height="32"><input name="txtlapmulcon" onKeyPress="return validaCajas(this,'i',event)" type="text" id="txtlapmulcon"   style="text-align:right "  value="<? print $ls_lapmulcon ?>" size="6" maxlength="6" onKeyUp="javascript:ue_activar_unidad(this)"    ></td>
		...
		<?Php
			  ...
			  {
			  ?>
			  <select name="cmbretraso" size="1" id="cmbretraso" disabled>
                <option value="---">Seleccione</option>               
				  <?Php
					for($li_i=1;$li_i<=$li_totalfilas;$li_i++)
					{
              ...
              <input name="hidretraso" type="hidden" id="hidretraso" value="<? print $ls_coduniretraso ?>">
		</td>
      </tr>
      <tr class="formato-blanco">
        <!--<td height="28">&nbsp;</td>
        <td height="28">&nbsp;</td>
        <td height="28" colspan="8">Lapso de Garant&iacute;a de la Obra 
          <input name="txtlapgarcon" type="text" id="txtlapgarcon" onKeyPress="return validaCajas(this,'i',event)" value="<? print $ls_lapgarcon?>" size="9" maxlength="10"  onKeyUp="javascript:ue_activar_unidad(this)"  style="text-align:right ">
		<?Php
				//if($ls_codobr=="")
					//$lb_valido=false;
				//else
					$lb_valido=$io_contrato->uf_llenarcombo_unidadtiempo(&$la_datos);
				...
				{
				?>&nbsp;&nbsp;&nbsp;
        <select name="cmbgarantia" size="1"  id="cmbgarantia">
          <option value="---">Seleccione</option>
          <?Php
					for($li_i=1;$li_i<=$li_totalfilas;$li_i++)
					{
					 $ls_codigo=$io_datastore->getValue("coduni",$li_i);
					 $ls_descripcion=$io_datastore->getValue("nomuni",$li_i);
					 if ($ls_codigo==$ls_codunigarantia)
					 {
						  print "<option value='$ls_codigo' selected>$ls_descripcion</option>";
					 }
					 else
        ...
        <?			  
			  ...
			  ?>
			  &nbsp;&nbsp;&nbsp;
			<select name="cmbgarantia" size="1" id="cmbgarantia" disabled>
			  <option value="---">Seleccione</option>	
			  <?Php
					for($li_i=1;$li_i<=$li_totalfilas;$li_i++)
					{
			  ...
			  ?>			  
        <input name="hidgarantia" type="hidden" id="hidgarantia" value="<? print $ls_codunigarantia ?>">		</td>
        <td height="28">&nbsp;</td>
      </tr>-->
      <tr class="formato-blanco">
        <td height="61">&nbsp;</td>
        ...
        <td height="61" colspan="7"><textarea name="txtobscon" cols="70" rows="2" id="txtobscon"  onKeyDown="textCounter(this,254)"  onKeyUp="textCounter(this,254)" onKeyPress="return(validaCajas(this,'x',event,254))"><? print $ls_obscon?></textarea></td>
        <td height="61">&nbsp;</td>
      </tr>
      <!--tr class="formato-blanco">
        <td height="31">&nbsp;</td>
        <td height="31">&nbsp;</td>
        <td height="31" colspan="8" valign="top"><div align="right"><a href="javascript:uf_mostrar_ocultar_contrato();"><img src="../shared/imagebank/mas.gif" width="9" height="17" border="0"></a><a href="javascript:uf_mostrar_ocultar_contrato();">Estado Actual del Contrato</a></div></td>
        <td height="31">&nbsp;</td>
      </tr>
			...
			<?Php
				...
				?>				 
				  <tr class="formato-blanco">
					<td height="18">&nbsp;</td>
					<td height="18">&nbsp;</td>
					<td colspan="8" rowspan="2" align="center" valign="top">
					  <table width="277" height="87" border="0" cellpadding="1" cellspacing="1" class="letras-peque&ntilde;as" id="detalleasignacion">
                        <tr>
                          <td height="20"><div align="right">Estado</div></td>
                          <td height="20"><input name="txtestcon" id="txtestcon" style="text-align:center " type="text" readonly="true" value="<? print $ls_estado;?>" size="20" maxlength="20"></td>
                        </tr>
                        <tr>
                          <td width="134" height="20"><div align="right">% Ejecuci&oacute;n F&iacute;sica</div></td>
                          <td width="136" height="20"><input name="txtporejefiscon" type="text"  style="text-align:right " id="txtporejefiscon"  value="<? print $ls_porejefiscon?>" size="21" maxlength="21" readonly="true"></td>
                        </tr>
                        <tr>
                          <td height="22"><div align="right">% Ejecuci&oacute;n Financiera</div></td>
                          <td height="22"><input name="txtporejefincon" id="txtporejefincon"   style="text-align:right " value="<? print $ls_porejefincon?>" readonly="true" type="text" size="21" maxlength="21" >                          </td>
                        </tr>
                        <tr>
                          <td height="20" valign="top"><div align="right">Total Ejecuci&oacute;n Financiera</div></td>
                          <td valign="top"><input name="txtmonejefincon" type="text" id="txtmonejefincon"   style="text-align:right " value="<? print $ls_monejefincon?>" readonly="true"  size="21" maxlength="21" ></td>
                        </tr>
                      </table></td>
					<td height="18">&nbsp;</td>
				  </tr>
        ...
        <td colspan="11"><div align="center">
          <table width="609" border="0" align="center" cellpadding="0" cellspacing="0"  class="sin-borde">
            <tr class="formato-blanco">
              ...
              <td colspan="2"><a href="javascript:ue_detcondiciones();"><img src="../shared/imagebank/mas.gif" width="9" height="17" border="0"></a><a href="javascript:ue_detcondiciones();">Agregar Detalle </a></td>
            </tr>
            <tr align="center" class="formato-blanco">
              <td height="11" colspan="3">			    <?php $io_grid->makegrid($li_filascondiciones,$la_columcondiciones,$la_objectcondiciones,$li_anchocondiciones,$ls_titulocondiciones,$ls_nametable);?></td>
	        </tr>
            <tr class="formato-blanco">
              <td>&nbsp;</td>
              <td width="403"><div align="right"></div></td>
              <td width="190">&nbsp;</td>
            </tr>
          </table>
        </div></td>
      ...
      <tr class="formato-blanco">
        <td colspan="11"><table width="609" border="0" align="center" cellpadding="0" cellspacing="0"  class="sin-borde">
          <tr class="formato-blanco">
            <td width="14" height="11">&nbsp;</td>
            <td colspan="2"><a href="javascript:ue_detgarantias();"><img src="../shared/imagebank/mas.gif" width="9" height="17" border="0"></a><a href="javascript:ue_detgarantias();">Agregar Detalle </a></td>
          </tr>
          <tr align="center" class="formato-blanco">
            <td height="11" colspan="3">
              <?php $io_grid->makegrid($li_filasgarantias,$la_columgarantias,$la_objectgarantias,$li_anchogarantias,$ls_titulogarantias,$ls_nametable);?>
            </td></tr>
          <tr class="formato-blanco">
            <td>&nbsp;</td>
            <td width="403">&nbsp;</td>
...
<input name="hiddatosasignacion" type="hidden" id="hiddatosasignacion" value="<? print $ls_datosasignacion;?>">
...
<input name="hidfilascondiciones" type="hidden" id="hidfilascondiciones" value="<? print $li_filascondiciones;?>">
<input name="hidfilasgarantias" type="hidden" id="hidfilasgarantias" value="<? print $li_filasgarantias;?>">
<input name="hidremoverretenciones" type="hidden" id="hidremoverretenciones" value="<? print $li_removerretenciones;?>">
<input name="hidremovercondiciones" type="hidden" id="hidremovercondiciones" value="<? print $li_removercondiciones;?>">
<input name="hidremovergarantias" type="hidden" id="hidremovergarantias" value="<? print $li_removergarantias;?>">
...
<input type="hidden" name="hidprefijo" id="hidprefijo" value="<? print $ls_hidprefijo;?>" >
<?Php
...
function ue_catasignacion()
{
	f=document.form1;	
	var estado=3;
	pagina="tepuy_cat_asignacion.php?estado="+estado+"&hidorigen=DC";
...
function ue_detcondiciones()
{
	...
	else
	{
		if(f.txtfecinicon.value!="")
		{
			...
			{
				pagina="tepuy_sob_pdt_condiciones.php?monto="+monto+"&fecha="+fecha+"&porcentaje="+totalporcentaje;
...
function ue_detgarantias()
{
	...
	{
		f.operacion.value="";		
		pagina="tepuy_sob_pdt_garantias.php";
...
function ue_cargarcondiciones(monto,porcentaje,fecha)
{
	f=document.form1;
	f.operacion.value="ue_cargarcondiciones";
	eval("f.txtmoncon"+f.hidfilascondiciones.value+".value='"+monto+"'");
	eval("f.txtporcon"+f.hidfilascondiciones.value+".value='"+porcentaje+"'");
	eval("f.txtfeccon"+f.hidfilascondiciones.value+".value='"+fecha+"'");
	f.action="tepuy_sob_d_contrato.php";
	//ue_agregarprefijo();
	f.submit();
}

function ue_cargargarantias(descripcion)
{
	f=document.form1;
	f.operacion.value="ue_cargargarantias";
	eval("f.txtdesgar"+f.hidfilasgarantias.value+".value='"+descripcion+"'");
	f.action="tepuy_sob_d_contrato.php";
	//ue_agregarprefijo();
	f.submit();
}
						...
						ls_fecinicon,ls_nomtco,ls_codobr,ls_codpro,ls_codproins,ls_fecfincon,ls_precon,ls_baseimp)
{
	...
	//f.txtmulcon.value=uf_convertir(ls_mulcon);
	//f.txtlapgarcon.value=parseInt(ls_lapgarcon);
	f.hidtipocontrato.value=ls_codtco;
	f.txtobscon.value=ls_obscon;

	//f.txtplacon.value=parseInt(ls_placon);
	//f.txtlapmulcon.value=parseInt(ls_tiemulcon);
	//f.hidgarantia.value=ls_lapgaruni;
	//f.hidduracion.value=ls_placonuni;
	//f.hidretraso.value=ls_mulreuni;
	...
	f.txtnrocon.value=ls_precon;
	//alert(f.txtnrocon.value);
...
function ue_buscar()
{
	...
	{
		var estado="";
		pagina="tepuy_cat_contrato.php?estado="+estado;
		popupWin(pagina,"catalogo",850,400);
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						{
						//alert(f.txtnrocon.value);
						if(f.txtnrocon.value==="")
						{
						lb_valido=confirm("El campo Nro. de Cotrato Interno está vacío,\n ¿Desea guardar de todas maneras?");
						}
						...
						/*	if(parseInt(txtplacon.value)==0 || txtplacon.value=="")
							...
							{
								if(ue_valida_null(cmbduracion,"Unidad para el Plazo de Duración del Contrato")==false)
								{
									cmbduracion.focus();
									lb_valido=false;
								}
								...
								{
									if(parseFloat(txtmulcon.value)!=0)
									{
										if(parseInt(txtlapmulcon.value)==0 || txtlapmulcon.value=="")
										{
											alert("El Campo Duración de la Multa está vacío!!!");
											txtlapmulcon.focus();
											lb_valido=false;
										}
										else
										{
											if(ue_valida_null(cmbretraso,"Unidad para el Lapso de Tiempo de la Multa")==false)
											{
												cmbretraso.focus();
												lb_valido=false;
											}
									...
									if( txtlapgarcon.value!="")
									{
										if(parseInt(txtlapgarcon.value)!=0)
										{
											if(ue_valida_null(cmbgarantia,"Unidad para el Lapso de Garantía")==false)
											{
												cmbgarantia.focus();
												lb_valido=false;
											}
...
function ue_calcularperiodo(caja)
{
	...
	{
		if ((f.txtplacon.value != "") && (f.cmbduracion.value != "---"))
		{
		  var time;
