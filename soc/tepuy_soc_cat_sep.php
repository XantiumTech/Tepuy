...
<input name="txtfechas" type="text" id="txtfechas" value="<?php print $ls_fechas ?>" size="13" maxlength="10" datepicker="true" onkeypress="currencyDate(this);" style="text-align:left"></td>
    ...
    <tr>
      <td width="104" height="22"><div align="right">Tipo Destino </div></td>
    ...
    <tr>
      ...
      <td height="22"><label>
        ...
        <img src="../shared/imagebank/tools15/buscar.png" name="buscar" width="15" height="15" id="buscar" style="visibility:hidden" onclick="javascript:uf_catalogo_proben();" /></label></td>
    ...
    <tr>
      ...
      <td height="22"><input name="txtcoduniadm" type="text" id="nombre" onkeypress="javascript: ue_mostrar(this,event);" value="<?php print $ls_coduniadm;?>" size="20" readonly="readonly" style="text-align:center" />
      <a href="javascript: ue_catalogo_unidad_ejecutora();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0" /></a></td>
      <td height="22" colspan="2"><input name="txtdenuniadm" type="text" class="sin-borde" id="txtdenuniadm" value="<?php print $ls_denuniadm;?>" size="60" readonly="readonly" /></td>
    </tr>
    <tr>
      <td height="13">&nbsp;</td>
      <td height="13">&nbsp;</td>
    ...
    <tr>
      ...
      <td height="13">&nbsp;</td>
      <td height="13">&nbsp;</td>
      <td height="13"><div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0" onclick="ue_search()" />Buscar Solicitud</a></div></td>
    </tr>
  </table>
  <p>&nbsp;</p>
...
function ue_search()
{
	...
	if((ls_fecregdes!="")&&(ls_fecreghas!=""))
	{
		...
		ajax.send("catalogo=PRESUPUESTARIA-SOLICITUD&numsep="+ls_numsep+"&coduniadm="+ls_coduniadm+"&fecregdes="+ls_fecregdes+"&tipo="+ls_tipo+
				  "&fecreghas="+ls_fecreghas+"&hidtipsolcot="+ls_tipsolcot+"&tipord="+tipord+"&orden="+orden+"&campoorden="+campoorden+"&tipdes="+ls_tipdes);
	}
	else
	{
...
function ue_aceptar(ls_numsep,ls_consep,ld_monsep,ls_unieje,ls_denuni,ls_codigo,ls_nombre,ls_direccion,ls_telefono,ls_codestpro1,ls_codestpro2,ls_codestpro3,ls_codestpro4,ls_codestpro5)
{
	...
	if (li_totrowsep==0)
	   {
		 fop.txtcoduniadm.value = ls_unieje;
		 fop.txtdenuniadm.value = ls_denuni;
		 ...
		 parametros = parametros+"&txtnumsep1="+ls_numsep+"&txtdensep1="+ls_consep+"&txtmonsep1="+ld_monsep+"&txtunieje1="+ls_unieje+"&txtdenuni1="+ls_denuni;
	     parametros = parametros+"&txtnumsep2="+""+"&txtdensep2="+""+"&txtmonsep2="+""+"&txtunieje2="+"";
		 ...
		 for (i=1;i<li_totrowsep;i++)
		     {
			   ...
			   parametros   = parametros+"&txtnumsep"+i+"="+ls_numsol+"&txtdensep"+i+"="+ls_densep+"&txtmonsep"+i+"="+ld_totsep+"&txtunieje"+i+"="+ls_codunieje+"&txtdenuni"+i+"="+ls_denunieje;
			 }
	     if (!lb_existe_sol)
		    {
		      ls_codunieje = fop.txtcoduniadm.value;
			  if (ls_codunieje!=ls_unieje)
			     {
       		       fop.txtcoduniadm.value = '----------';
		           fop.txtdenuniadm.value = 'NINGUNA';
				 }
			  ls_uniejeaso = fop.txtuniejeaso.value;
			  ls_uniejeaso = ls_uniejeaso+" - "+"Nro. SEP = "+ls_numsep+". Unidad Ejecutora :"+ls_unieje+" - "+ls_denuni+";";
			  fop.txtuniejeaso.value = ls_uniejeaso;
			  parametros = parametros+"&txtnumsep"+i+"="+ls_numsep+"&txtdensep"+i+"="+ls_consep+"&txtmonsep"+i+"="+ld_monsep+"&txtunieje"+i+"="+ls_unieje+"&txtdenuni"+i+"="+ls_denuni; 
					  ...
					  { 
					    for (j=1;(j<=li_totrowbienes)&&(valido);j++)
						    {  
							  ...
							  parametros = parametros+"&txtcodart"+j+"="+ls_codart+"&txtdenart"+j+"="+ls_denart+"&txtcanart"+j+"="+ls_canart+"&hidnumsep"+j+"="+ls_numsol;		   
						    }
							 ...
							 for (j=1;(j<=li_totrowservicios)&&(valido);j++)
								 {
								   ...
								   ls_numsol  = eval("fop.hidnumsep"+j+".value");
								   parametros = parametros+"&txtcodser"+j+"="+ls_codser+"&txtdenser"+j+"="+ls_denser+"&txtcanser"+j+"="+ld_canser+"&hidnumsep"+j+"="+ls_numsol;
								 }
...
function uf_catalogo_proben()
{
  ...
  if (ls_tipdes=='P')
     {   //Abrir el Catálogo de Proveedores.
	     pagina="tepuy_soc_cat_proveedor.php?tipo="+"BASICO";
	 }
  else
     {
	   if (ls_tipdes=='B')//Abrir el Catálogo de Beneficiarios.
	      {
	        pagina="tepuy_soc_cat_sep.php?hidtipsolcot="+ls_tipsolcot;
		  }
	 }
