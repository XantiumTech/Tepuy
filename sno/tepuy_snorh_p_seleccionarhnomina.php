<?php
	...
	$io_fun_nomina->uf_load_seguridad("SNR","tepuy_snorh_p_seleccionarhnomina.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<body>
<?php 
	require_once("tepuy_snorh_c_seleccionarhnomina.php");
	$io_hnomina=new tepuy_snorh_c_seleccionarhnomina();
	uf_limpiarvariables();
	switch ($ls_operacion) 
	{
		case "CARGARDATOS":
			...
			{  
				print "<script language=JavaScript>";
				print "		opener.document.form1.action='tepuywindow_blank_hnomina.php?codnom=".$ls_codnom."&anocurnom=".$li_anocurnom."&peractnom=".$ls_peractnom."';";
				print "		opener.document.form1.submit();";
				print "		close();";
				print "</script>";		
			}
    ...
    <table width="479" border="0" cellpadding="1" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td><div align="left">
          ...
          <a href="javascript: ue_buscarperiodo();"><img id="periodo" src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="15" height="15" border="0"></a>
...
<input name="txtfechasper" type="text" id="txtfechasper" value="<?php print $ld_fechasper;?>" size="13" maxlength="10" readonly>
      ...
      <tr>
        <td colspan="2"><div align="center"><a href="javascript: ue_aceptar();"><img src="imagenes/Aceptar2.png" width="25" height="22" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript: ue_cancelar();"><img src="imagenes/Cancelar2.png" width="25" height="22" border="0"></a></div></td>
      </tr>
  </table>
</form>
</body>
...
function ue_aceptar()
{
	...
	if((nomina!="")&&(anocurnom!="")&&(peractnom!=""))
	{
		...
		f.action="tepuy_snorh_p_seleccionarhnomina.php";
		f.submit();
	}
	else
	{
...
function ue_buscarperiodo()
{
	...
	{
		window.open("tepuy_sno_cat_hperiodo.php?codnom="+f.cmbnomina.value+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=200,top=200,location=no,resizable=no");
	}
	else
	{
