<?php
class tepuy_spg_c_estprog1
{
var $is_msg_error;
	
		function tepuy_spg_c_estprog1($conn)
		{
...
function uf_spg_select_estprog1($as_codemp,$as_codestpro1)
{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
  ...
  $lb_valido = false; 
  $ls_sql    = "SELECT codestpro1 FROM spg_ep1 WHERE codemp='".$as_codemp."' AND codestpro1='".$as_codestpro1."'";
  $rs_data   = $this->io_sql->select($ls_sql);
  if ($rs_data===false)
	 {
 	   $lb_valido=false;
 	   $this->io_msg->message("CLASE->tepuy_SPG_C_ESTPROG1; METODO->uf_spg_select_estprog1; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
...
function uf_spg_insert_estprog1($as_codemp,$as_codestpro1,$as_denestpro1,$as_clasificacion,$aa_seguridad)
{
//////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $ls_sql = "INSERT INTO spg_ep1 (codemp, codestpro1, denestpro1, estcla) VALUES ('".$as_codemp."','".$as_codestpro1."','".$as_denestpro1."','".$as_clasificacion."') ";
	 $this->io_sql->begin_transaction();
	 $rs_data = $this->io_sql->execute($ls_sql);
	 if ($rs_data===false)		     
	    {
		  $lb_valido          = false;
 	      $this->is_msg_error = "CLASE->tepuy_SPG_C_ESTPROG1; METODO->uf_spg_insert_estprog1; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);
		 }
	 else
		 {
		   $lb_valido      = true;
		   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
		   $ls_evento      = "INSERT";
		   $ls_descripcion = "Insertó en SPG Nuevo Estructura Presupuestaria/programatica ".$as_denestpro1." asociado al Nivel 1 con ".$as_codestpro1;
...
function uf_spg_update_estprog1($as_codemp,$as_codestpro1,$as_denestpro1,$as_clasificacion,$aa_seguridad)
{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
  ...
  $ls_sql = "UPDATE spg_ep1 SET denestpro1='".$as_denestpro1."',estcla='".$as_clasificacion."' WHERE codemp='".$as_codemp."' AND codestpro1='".$as_codestpro1."' ";
  $this->io_sql->begin_transaction();
  $rs_data=$this->io_sql->execute($ls_sql);
  if ($rs_data===false)
	 {
	   $lb_valido=false;
 	   $this->io_msg->message("CLASE->tepuy_SPG_C_ESTPROG1; METODO->uf_spg_update_estprog1; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
	   $lb_valido = true;
	   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
	   $ls_evento      = "UPDATE";
	   $ls_descripcion = " Actualizo la denominacion el Nivel 1 con codigo ".$as_codestpro1;
	   $ls_variable    = $this->io_seguridad->uf_sss_insert_eventos_ventana($aa_seguridad["empresa"],
	   $aa_seguridad["sistema"],$ls_evento,$aa_seguridad["logusr"],
	   $aa_seguridad["ventanas"],$ls_descripcion);
	   /////////////////////////////////         SEGURIDAD               /////////////////////////////		     
...
function uf_spg_delete_estpro1($as_codemp,$as_codestpro1,$as_denestpro1,$aa_seguridad)
{
  $lb_tiene  = $this->uf_check_relaciones($as_codemp,$as_codestpro1);
  $lb_existe = $this->uf_spg_select_estprog1($as_codemp,$as_codestpro1);
  $lb_valido = false;
  if (($lb_existe) && (!$lb_tiene))
     {
	   ...
	   if ($rs_data===false)
	      {
		    $lb_valido = false;
			$this->is_msg->message("CLASE->tepuy_SPG_C_ESTPROG1; METODO->uf_delete_estpro1; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		  }
	   else
	      {
			 /////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
	  {
		$lb_valido=false;
        $this->io_msg->message("CLASE->tepuy_SPG_C_ESTPROG1; METODO->uf_check_relaciones; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	  }
	else
	  {
