...
if (!array_key_exists("la_logusr",$_SESSION))
   {
	...
	$ls_fichaproveedor=$io_rpc->uf_select_config("RPC","REPORTE","FICHA_PROVEEDOR","tepuy_rpc_rpp_ficha_proveedor.php","C");
	$ls_fichabeneficiario=$io_rpc->uf_select_config("RPC","REPORTE","FICHA_BENEFICIARIO","tepuy_rpc_rpp_ficha_beneficiario.php","C");
	unset($io_rpc);
?>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/ayuda.png" alt="Eliminar" width="20" height="20" border="0"><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a></td>
  </tr>
  </table>
  <?php
...
require_once("class_folder/tepuy_rpc_c_documento.php");
$io_documento=new tepuy_rpc_c_documento($con); 
      ...
      <td height="22" colspan="3" align="center"><table width="450" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td width="103"><div align="left">
            ...
            <a href="javascript:uf_catalogoprov();"><img src="../shared/imagebank/tools15/buscar.png" alt="C&oacute;digos Desde..." width="15" height="15" border="0"  onClick="document.form1.hidrangocodigos.value=1"></a></div></td>
          ...
          <td width="133"><div align="left">
            ...
            <a href="javascript:uf_catalogoprov();"><img src="../shared/imagebank/tools15/buscar.png" alt="C&oacute;digos Hasta..." width="15" height="15" border="0"  onClick="document.form1.hidrangocodigos.value=2"></a></div></td>
        </tr>
      </table></td>
    </tr>
    <tr>
...
function uf_catalogoprov()
{
    ...
    if (f.radiocategoria[0].checked==true)
	   {
	     pagina="tepuy_cxp_cat_proveedores.php";
    ...
    if (f.radiocategoria[1].checked==true)
	   {
	     pagina="tepuy_cxp_cat_beneficiarios.php";
         window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no");
	   }   
}
