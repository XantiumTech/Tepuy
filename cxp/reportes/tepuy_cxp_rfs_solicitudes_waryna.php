...
//  ORGANISMO: MATADERO WARYNA C.A. BARINAS
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    session_start();   
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,$as_nompro,$as_dirpro,$as_estatus,$as_denfuefin,$as_consol,$as_obssol,$as_nomusu,$as_codigo,$as_monto,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// INVERTIDO LOS QUE APRUEBA Y QUIEN RECIBE //
		...
		$io_pdf->addText(164,118,6, ""); // Agregar el título
		$io_pdf->addText(165,165,6,"JEFE DE CONTABILIDAD"); // Agregar el título
		$io_pdf->addText(286,118,6," "); // Agregar el título
...
//		$io_pdf->addText(440,122,7,"DESPACHO DEL ALCALDE"); // Agregar el título
		...
		$io_pdf->addText(418,118,6," "); // Agregar el título
...
//print "proveedor: ".$ls_cod_pro." cedula: ".$ls_cedbene;
				...
				//print "Monto :".$ls_monto;die();
				uf_print_encabezado_pagina($ls_titulo,$ls_numsol,$ld_fecemisol,$ls_nompro,$ls_dirpro,$ls_estprosol,$ls_denfuefin,$ls_consol,$ls_obssol,$ld_nomusu,$ls_codigo,$ls_monto,&$io_pdf);
