...
$arbol["nombre_fisico"][$li_i]="tepuywindow_sss_sistemas.php";
$arbol["id"][$li_i]=$li_i;
...
$arbol["nombre_fisico"][$li_i]="tepuywindow_sss_grupos.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="001";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuywindow_sss_usuarios.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="001";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuywindow_sss_usuarios_grupos.php";
$arbol["id"][$li_i]=$li_i;
...
$arbol["nombre_fisico"][$li_i]="tepuy_sss_p_usuariosnominas.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="002";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuy_sss_p_usuariospresupuesto.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="002";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuy_sss_p_usuariosconstantes.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="002";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuy_sss_p_usuariosunidad.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="002";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuywindow_sss_derecho_grupo.php";
$arbol["id"][$li_i]=$li_i;
...
$arbol["nombre_fisico"][$li_i]="tepuy_c_actualizar_ventanas.php";
$arbol["id"][$li_i]=$li_i;
...
$arbol["nombre_fisico"][$li_i]="tepuy_c_repassword_admin.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="004";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuy_c_permisos_globales.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="004";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuy_sss_p_eliminar_permisos.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="004";
$arbol["numero_hijos"][$li_i]=0;
...
$arbol["nombre_fisico"][$li_i]="tepuywindow_sss_auditoria.php";
$arbol["id"][$li_i]=$li_i;
...
$arbol["nombre_fisico"][$li_i]="tepuy_sss_r_permisos.php";
$arbol["id"][$li_i]=$li_i;
$arbol["padre"][$li_i]="005";
$arbol["numero_hijos"][$li_i]=0;
