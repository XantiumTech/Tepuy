<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_cmpmov,$ad_fecha,&$io_pdf)
	{
		...
		// Fecha Creación: 26/04/2006                             Fecha de Modificación: 14/04/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],24,540,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$io_pdf->addText(571,585,8,"<b>REPÚBLICA BOLIVARIANA DE VENEZUELA</b>"); // Agregar la Fecha
		$io_pdf->addText(585,575,8,"<b>MINISTERIO DE EDUCACIÓN SUPERIOR</b>"); // Agregar la Fecha
		$io_pdf->addText(630,565,8,"<b>DIRECCIÓN DEL DESPACHO</b>"); // Agregar la Fecha
		$io_pdf->addText(568,555,8,"<b>OFICINA DE ADMINISTRACIÓN Y SERVICIOS</b>"); // Agregar la Fecha
		$io_pdf->addText(576,545,8,"<b>COORDINACIÓN DE BIENES NACIONALES</b>"); // Agregar la Fecha
		...
		$io_pdf->addText(650,525,8,"No.:  ".$as_cmpmov); // Agregar la Fecha
		$io_pdf->addText(650,505,8,"Fecha:  ".date("d/m/Y")); // Agregar la Fecha
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_codemp,$as_nomemp,$ls_coduniadm,$ls_denuniadm,&$io_pdf)
	{
		...
		// Fecha Creación: 21/04/2006                             Fecha de Modificación: 14/04/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);
		$io_pdf->rectangle(17,380,748,120);
		$io_pdf->addText(45,492,9,"<b>Organismo</b>"); // Agregar texto
		$io_pdf->addText(50,481,9,$as_codemp); // Agregar texto
		$io_pdf->addText(100,481,9,$as_nomemp); // Agregar texto
		$io_pdf->line(95,470,95,490);   // linea vertical
		...
		$io_pdf->addText(30,441,9,$ls_coduniadm); // Agregar texto
		$io_pdf->addText(100,441,9,$ls_denuniadm); // Agregar texto
		$io_pdf->line(95,435,95,455);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cantidad'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'catalogo'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   ...
						 			   'codcau'=>array('justification'=>'center','width'=>150))); // Justificación y ancho de la columna
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>760, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('canti'=>array('justification'=>'center','width'=>100), // Justificación y ancho de la columna
						 			   'cata'=>array('justification'=>'center','width'=>120), // Justificación y ancho de la columna
						 			   'coda'=>array('justification'=>'center','width'=>80), // Justificación y ancho de la columna
						 			   'dena'=>array('justification'=>'center','width'=>298), // Justificación y ancho de la columna
						 			   'codca'=>array('justification'=>'center','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		$io_pdf->addObject($io_encabezado,'all');
	...
	else // Imprimimos el reporte
	{
		...
		$io_fun_activos->uf_load_seguridad_reporte("SAF","tepuy_saf_r_compdesincorporacion.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////////
