...
require_once("../shared/class_folder/class_tepuy_int_xspg.php");
require_once("../shared/class_folder/class_tepuy_int_spgctas.php");
require_once("../shared/class_folder/class_fecha.php");
class tepuy_spg_class_progrep_trim
{

   function tepuy_spg_class_progrep_trim()
   {
     $con=new tepuy_include();
   	 $this->conn=$con->uf_conectar();
	 $this->SQL=new class_sql($this->conn);
	 $this->msg=new class_mensajes();
	 $this->int_spg=new class_tepuy_int_spg();
	 $this->int_xspg=new class_tepuy_int_xspg();
	 $this->fun=new class_funciones();	
	 $this->sig_int=new class_tepuy_int();
	 $this->int_spgctas=new class_tepuy_int_spgctas();
