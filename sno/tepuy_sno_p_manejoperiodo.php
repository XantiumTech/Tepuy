<?php
	...
	$io_fun_nomina->uf_load_seguridad_nomina("SNO","tepuy_sno_p_manejoperiodo.php",$ls_codnom,$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<body>
<?php 
	require_once("tepuy_sno_c_cierre_periodo.php");
	$io_cierreperiodo = new tepuy_sno_c_cierre_periodo();
	uf_limpiarvariables();
	switch ($ls_operacion) 
	{
		case "CERRAR_PERIODO":
	...
	if (li_ejecutar==1)
   	{
		...
		if(valido)
		{
			...
			f.action="tepuy_sno_p_manejoperiodo.php";
			f.submit();
		}
   	}
	else
...
{
	window.open("tepuy_sno_p_abrir_periodo.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=250,left=200,top=300,resizable=no,location=no");
}
