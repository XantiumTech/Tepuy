...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_distribucion_sector.php";
  ...
  <tr> 
    ...
    <td width="432" height="20" colspan="11" bgcolor="#E7E7E7">
		<table width="762" border="0" align="center" cellpadding="0" cellspacing="0">
			  <td width="432" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Contabilidad Presupuestaria de Gastos</td>
		...
		else
		{
			...
			if($li_numrows>0)
			{
				$combobit = " <option value='s1'>Todos</option>"; //Valor Inicial
    				...
    				{
        			$combobit .=" <option value='".substr($row['codestpro1'],18,2)."'>".$row['denestpro1']."</option>"; //concatenamos el los options para luego ser insertado en el HTML
    				}
			}
		}
?>
...
function ue_showouput()
{
	...
	pagina="reportes/tepuy_spg_rpp_distribucion_sector_programa.php?combo="+"&cmbnivel="+cmbnivel+"&tipoformato="+tipoformato;
