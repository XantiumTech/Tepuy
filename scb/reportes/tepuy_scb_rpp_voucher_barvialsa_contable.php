<?PHP
	...
	function uf_print_cabecera($ls_numdoc,$ls_nomban,$ls_ctaban,$ls_nomproben,$ls_fecmov,$ls_conmov,$as_chevau,&$io_pdf)
	{
		...
		$io_pdf->add_texto(12,88,11,"<b>$ls_conmov</b>");//108 //Antes 84
		...
		$la_data=array(array('cheque'=>'','banco'=>''),
					   array('cheque'=>"<b>$ls_numdoc</b>",'banco'=>"    "."<b>$ls_nomban</b>"));
		...
		$io_pdf->add_texto(8,245,10,'<b>'.substr($as_chevau,-8).'</b>');//108
	...
	function uf_print_detalle($la_data,&$io_pdf,$x_pos)
	{
		...
		//$io_pdf->ezSety(435);
		$io_pdf->ezSety(420); //mas 442 antes 435
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
	...
	function uf_print_totales($ad_montotdeb,$ad_montothab,$io_pdf)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $io_pdf->add_texto(128,80,12,'<b>'.number_format($ad_montotdeb,2,',','.').'</b>'); //antes 76 ahora 72
		 $io_pdf->add_texto(160,81,12,'<b>'.number_format($ad_montothab,2,',','.').'</b>'); //antes 77 ahora 73
	}
	...
	function uf_print_firmas($ad_usuario,$ad_contabilidad,$ad_gerente,$ad_presidente,$io_pdf)
	{
		...
		$io_pdf->add_texto(3,84,10,'<b>'.$ad_usuario.'</b>');
		$io_pdf->add_texto(26,94,10,'<b>'.$ad_gerente.'</b>');
		$io_pdf->add_texto(65,84,10,'<b>'.$ad_presidente.'</b>');
		 $io_pdf->add_texto(29,106,10,'<b>'.$ad_contabilidad.'</b>');
	...
	$ls_usuario="";
	$ls_gerente="Licda. Liliana Montilla";
	$ls_contabilidad="Licda. Inghaid Garcia";
	...
	for($li_i=1;$li_i<=$li_totrow;$li_i++)
	{
		...
		//uf_print_encabezado_pagina(number_format($ldec_total,2,",","."),$ls_nomproben,$ls_monto,$_SESSION["la_empresa"]["ciuemp"].", ".$ld_fecmov,$io_pdf,$y_pos,$ls_impcheque); // Imprimimos el encabezado de la página
		...
		$ds_dt_scg->data=$class_report->uf_cargar_dt_scg($ls_numdoc,$ls_codban,$ls_ctaban,$ls_codope,$ls_tipodestino); // Obtenemos el detalle del reporte
