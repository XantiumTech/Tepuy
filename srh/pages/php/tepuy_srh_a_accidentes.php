<?
	session_start();
	require_once("../../class_folder/dao/tepuy_srh_c_accidentes.php");
	require_once("../../class_folder/utilidades/class_funciones_srh.php");
	$io_accidentes= new tepuy_srh_c_accidentes('../../../');
    $io_fun_srh=new class_funciones_srh('../../../');
	$io_fun_srh->uf_load_seguridad("SRH","tepuy_srh_p_accidentes.php",$ls_permisos,$la_seguridad,$la_permisos);
