<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_r_relacionfacturas.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
var patron2 = new Array(1,3,3,3,3)
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/tepuy_cxp_rpp_relacionfacturas.php?tipproben="+tipproben+"&codprobendes="+codprobendes+"&codprobenhas="+codprobenhas+"&fecregdes="+fecregdes+"&fecreghas="+fecreghas+"&ordendoc="+ordendoc+"&ordenfec="+ordenfec+"&ordencod="+ordencod+"&tiporeporte="+tiporeporte+"";
