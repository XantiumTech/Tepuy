...
//////////////////////////////////////////////         SEGURIDAD               ///////////////////////////////////////////////////////////////////////
	...
	$io_fun_ingreso->uf_load_seguridad("SPI","tepuy_spi_r_modificaciones_presupuestarias_aprobadas.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               //////////////////////////////////////////////////////////////////////
?>
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		{
			pagina="reportes/tepuy_spi_rpp_modificaciones_presupuestaria_aprobadas.php?ckbaum="+ckbaum+"&txtcomprobante="+txtcomprobante
