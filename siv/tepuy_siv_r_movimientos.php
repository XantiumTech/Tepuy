...
$io_fun_activo->uf_load_seguridad("SIV","tepuy_siv_r_movimientos.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
        ...
        <table width="415" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td height="22"><div align="left">
              ...
              <a href="javascript:uf_catalogoarticulo();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
          ...
          <tr>
            ...
            <td height="22"><div align="left">
              ...
              <a href="javascript:uf_catalogoalmacen();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
<script language="JavaScript">
	function ue_search()
	{
	  ...
	  f.action="tepuy_rpc_r_provxespecia.php";
	  f.submit();
	}

	function uf_catalogoarticulo()
	{
		window.open("tepuy_catdinamic_articulom.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
	}
	
	function uf_catalogoalmacen()
	{
		window.open("tepuy_catdinamic_almacen.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=120,top=70,location=no,resizable=yes");
	}
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir)
			{
				...
				window.open("reportes/tepuy_siv_rpp_movimientos.php?codart="+ls_codart+"&codalm="+ls_codalm+"&ordenfec="+li_ordenfec+"&ordenart="+li_ordenart+"&desde="+ld_desde+"&hasta="+ld_hasta+"&tipoformato="+tipoformato,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.action="tepuy_siv_r_movimientos.php";
			}
		}
		else
		{
