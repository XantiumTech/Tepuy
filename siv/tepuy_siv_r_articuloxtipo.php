...
$io_fun_activo->uf_load_seguridad("SIV","tepuy_siv_r_articuloxtipo.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<!-- ******** END ALLWEBMENUS CODE FOR menu ******** -->
  <tr>
    <td height="42" colspan="4" class="toolbar">&nbsp;</td>
  </tr>
  <tr> 
        ...
        <table width="427" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="370" height="22"><div align="left">
              ...
              <a href="javascript:uf_catalogotipoarticulo('txtcoddesde','txtdendesde');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
          ...
          <tr>
            ...
            <td height="22"><div align="left">
              ...
              <a href="javascript:uf_catalogotipoarticulo('txtcodhasta','txtdenhasta');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
	...
	function uf_mostrar_reporte()
	{
		...
		if(li_imprimir==1)
		{
			...
			if((ls_coddesde!="")&&(ls_codhasta!=""))
			{
				...
				window.open("reportes/tepuy_siv_rpp_articuloxtipo.php?coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&ordenart="+li_ordenart+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="tepuy_siv_r_articuloxtipo.php";
				//f.submit();
			}
			else
			{
