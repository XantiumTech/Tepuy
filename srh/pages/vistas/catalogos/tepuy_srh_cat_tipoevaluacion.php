...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_tipoevaluacion.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_tipoevaluacion.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_tipoevaluacion.php?valor=buscar"+"&txtcodeval="+codeval+"&txtdeneval="+deneval);
           setTimeout (terminar_buscar,500);
