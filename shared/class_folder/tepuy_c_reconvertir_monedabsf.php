<?php
class tepuy_c_reconvertir_monedabsf
{
	var $io_sql;
	var $io_mensajes;
	var $io_funciones;
	...
	//---------------------------------------------------------------------------------------------------------------------------
	function tepuy_c_reconvertir_monedabsf()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_c_reconvertir_monedabsf
		//		   Access: public 
	...
	}// end function tepuy_c_reconvertir_monedabsf
	//---------------------------------------------------------------------------------------------------------------------------
	...
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_reconvertir_datos
		//		   Access: public 
...
// AQUI LO QUE HAGO ES ELIMINAR LA RECONVERSION
			$li_montobsf= $li_montobs;
//			$li_montobsf= $this->uf_convertir_monedabsf($li_montobs,$ai_decimales,$ai_operando,1,$ab_redmon);
//			print $li_montobs." aqui bsf.".$li_montobsf;
			$ls_criterio="";
