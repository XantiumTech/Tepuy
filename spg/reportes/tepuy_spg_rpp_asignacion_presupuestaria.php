<?php
	...
	/*	$io_encabezado=$io_pdf->openObject();
		...
		$io_pdf->addText(22,584,7,"PARTIDA",270); // Columna, Altura,Tamaño, Texto, Giro
		$io_pdf->restoreState();
		$io_pdf->closeObject();
		...
		$io_pdf->addText(33,594,7,"PARTIDA",270); // Columna, Altura,Tamaño, Texto, Giro
		$io_pdf->addText(52,594,7,"GENÉRICA",270);
		$io_pdf->addText(70,594,7,"ESPECIFICA",270);
		$io_pdf->addText(88,594,7,"SUB-ESPECÍFICA",270);
		...
		$tm=300-($li_tm/2);
		$io_pdf->addText($tm,694,13,$as_titulo); // Agregar el título
		$li_tm=$io_pdf->getTextWidth(10,$as_fecha);

		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,686,10,$as_fecha); // Agregar el títul
...
/*	function uf_print_detalle($la_data,&$io_pdf)
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>299, // Orientación de la tabla
						// 'yPos'=>300, // Orientación de la tabla
						 'cols'=>array('par'=>array('justification'=>'left','width'=>22), // Justificación y ancho de la columna
									'gen'=>array('justification'=>'left','width'=>18), // Justificación y ancho de la columna
									'esp'=>array('justification'=>'left','width'=>18), // Justificación y ancho de la columna
								'subesp'=>array('justification'=>'left','width'=>18), // Justificación y ancho de la columna
									'aux'=>array('justification'=>'left','width'=>30), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>354), // Justificación y ancho de la 
						 			   'asignado'=>array('justification'=>'right','width'=>99))); // Justificación y ancho de
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'colGap'=>1,
				 		 'cols'=>array('total'=>array('justification'=>'right','width'=>460), // Justificación y ancho de la columna
						 	           'asignado'=>array('justification'=>'right','width'=>99)));//, // Justificación y ancho de la 
   ...
   //----------------------------------------------------  Parámetros del encabezado  ----------------------------------------------------------------------------------------------------------------------------------------
		...
		$ls_titulo="<b>  CRÉDITOS PRESUPUESTARIOS  </b> ";
		$ls_fecha1=$_SESSION["la_empresa"]["periodo"];
		$ls_fecha1=substr($ls_fecha1,0,4);
		$ls_fecha="<b> Ejercicio Económico - Financiero ".$ls_fecha1." </b>";      
		$ld_titulo="<b> Total </b>";
  ...
  //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	 ...
	 else // Imprimimos el reporte
	 {
		...
		$io_pdf->ezSetCmMargins(7,3,3,3); // La modificacion a 7 antes 5. me resolvio el montaje de datos,margen inferiorConfiguración de los margenes en centímetros
