...
$io_cliente = new tepuy_sfa_c_cliente();
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SFA";
	$ls_ventanas = "tepuy_sfa_d_clientes.php";
...
$lr_datos["tipconcli"] = $ls_tipconben;
...
if (array_key_exists("txtcedula",$_POST))
...
else
   {
	 ...
	 $ls_cedula= $io_keygen->uf_generar_numero_nuevo("SFA","sfa_cliente","cedcli","SFACLI",10,"","","");
   }
 if (array_key_exists("cmbtipcuebanben",$_POST))
   {
...
if  (array_key_exists("txtfecregcli",$_POST))
	{
  	  $ls_fecregben          = $_POST["txtfecregcli"];
	  $lr_datos["fecregcli"] = $ls_fecregben;
	}
else
	{
	  $arr_date     = getdate();
...
$ls_readonly="";	
 ...
 if ($ls_operacion=="GUARDAR")
	{ 
      ...
      $lb_existe=$io_cliente->uf_select_cliente($ls_codemp,$ls_cedula);
	  if ($lb_existe)
         {           
	       if ($ls_estatus=="NUEVO")
		      {
			    $io_msg->message("Este Cliente ya existe !!!");  
			    $lb_valido=false;
			  }
		   elseif($ls_estatus=="GRABADO")
		      {
			    $arre=$_SESSION["la_empresa"];
	            $ls_empresa=$arre["codemp"];
		        $lb_valido=$io_cliente->uf_update_cliente($ls_codemp,$lr_datos,$la_seguridad);
		        if ($lb_valido)
		           {
				...
				/*	 $ls_estatus="NUEVO";
		           ...
		           {
			         $io_msg->message($io_cliente->is_msg_error);
			       }
		      }
	     }
	  else
	     {
		   $lb_valido=$io_cliente->uf_insert_clientes($ls_codemp,$lr_datos,$la_seguridad);
		   if ($lb_valido)
		      {
...
if ($ls_operacion=="ELIMINAR")
   { 
     ...
     if ($lb_existe)
	    {
		  $lb_valido=$io_cliente->uf_delete_cliente($ls_codemp,$ls_cedula,$la_seguridad);
		  if ($lb_valido)
			 { 
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
  <table width="776" height="415" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr>
      <td width="774" height="413"><div align="center">
        <table width="723"  border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
          <tr class="titulo-celdanew">
            <td height="22" colspan="3" class="titulo-ventana">Registro de Clientes</td>
          </tr>
          <tr class="formato-blanco">
            <td height="22">&nbsp;</td>
            <td width="533" height="22"><div align="right"><strong>Fecha de Registro</strong>
              <label>
              <input name="txtfecregcli" type="text" class="sin-borde" id="txtfecregcli" style="text-align:center" value="<?php print $ls_fecregben ?>" size="12" maxlength="12" readonly>
              </label>
</div></td>
            <td width="19">&nbsp;</td>
          <tr class="formato-blanco">
...
Venezolano            </label>
              ...
              Extranjero</label></td>
          <tr class="formato-blanco">
            <td width="169" height="22" align="right"><span class="sin-borde"><strong>(*)</strong></span> C&oacute;digo&nbsp;</td>
            ...
            <!--  Pasaporte -->
              <label>
         <!--     <input name="txtnumpasben" type="text" id="txtnumpasben" value="<?php print $ls_numpasben ?>" maxlength="10" style="text-align:right" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz ');"> -->
              </label></td>
          <tr class="formato-blanco">
            <td height="22" align="right"><span class="sin-borde"><strong>(*)</strong></span>&nbsp;RIF&nbsp;</td>
            <td height="22" colspan="3"><input name="txtrif" type="text" id="txtrif" size="15" maxlength="12" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+'.-');" value="<?php print $ls_rif ?>" style="text-align:center "></td>
          </tr>
          <tr class="formato-blanco">
            <td height="22" align="right"><span class="sin-borde"><strong>(*)</strong></span>&nbsp;Nombre&nbsp;</td>
            <td height="22" colspan="3"><input name="txtnombre" type="text" id="txtnombre" size="70" maxlength="50" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+',-.;*&?¿!¡+()[]{}%@/'+'´áéíóú');" value="<?php print $ls_nombre ?>"></td>
          </tr>
          <tr class="formato-blanco">
            <td height="22" align="right"><span class="sin-borde"><strong>(*)</strong></span>&nbsp;Apellido&nbsp;</td>
            <td height="22" colspan="3"><input name="txtapellido" type="text" id="txtapellido" size="70" maxlength="50" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+',-.;*&?¿!¡+()[]{}%@/'+'´áéíóú');" value="<?php print $ls_apellido ?>"></td>
          </tr>
          <tr class="formato-blanco">
            <td height="22" align="right"><span class="sin-borde"><strong>(*)</strong></span>&nbsp;Direcci&oacute;n&nbsp;</td>
            <td height="22" colspan="3"><input name="txtdireccion" type="text" id="txtdireccion" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+',-.;*&?¿!¡+()[]{}%@/#'+'´áéíóú');" value="<?php print $ls_direccion ?>" size="95" maxlength="254"></td>
          </tr>
          <tr class="formato-blanco">
          ...
          <tr class="formato-blanco">
            ...
            <td height="22" colspan="3"><input name="txtemail" type="text" id="txtemail" size="60" maxlength="100" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+'._-@'); " value="<?php print $ls_email ?>"></td>
          </tr>
<!--          <tr class="formato-blanco">
            <td height="22" align="right"><span class="sin-borde"><strong>(*)</strong></span>&nbsp;C&oacute;digo Contable (Ctas.x Cobrar)&nbsp;</td>
          ...
          <tr class="formato-blanco">
            <td height="22" align="right"><span class="sin-borde"><strong>(*)</strong></span>&nbsp;C&oacute;digo Contable (Cta. x Cobrar)&nbsp;</td>
    ...
    <!--      <tr class="formato-blanco">
			...
			//Llenar Combo Banco
			$ls_codemp=$la_emp["codemp"];
			$rs_ben=$io_cliente->uf_select_banco($ls_codemp);
        ?>
	  ...
	  ?>
          ...
          <tr class="formato-blanco">
			...
			$ls_codemp=$la_emp["codemp"];
			$rs_ben=$io_cliente->uf_select_tipo_cuenta();
        ?>
	...
	?>
              ...
              <table width="449" border="0" class="contorno">
                ...
                <tr class="formato-blanco">
                  ...
                  <td width="320" align="left" scope="col">
                    <?php
            //Llenar Combo Pais
            $rs_ben=$io_cliente->uf_select_pais();
          ?>
	     ...
	     ?>
                ...
                <tr class="formato-blanco">
                  ...
                  <td>
                    <?php
          //Llenar Combo Estado
		  $rs_ben=$io_cliente->uf_select_estado($ls_pais);
		 ?>
	     ...
	     ?>
		  ...
		  $rs_ben=$io_cliente->uf_select_municipio($ls_pais,$ls_estado);
         ?>
	    ...
	    ?>
		  ...
		  $rs_ben=$io_cliente->uf_select_parroquia($ls_pais,$ls_estado,$ls_municipio);
        ?>
       ...
       with (document.form1)
            {
              if (valida_null(txtcedula,"La Cédula esta vacia!!")==false)
                 ...
                 {
                 	if(valida_null(txtrif,"El Rif esta vacio!!")==false)
                 	{
                 		txtrif.focus();
	                }
	                else
	               		...
	               		else
	                  	{
                        	if (valida_null(txtapellido,"El Apellido esta vacio!!")==false)
		                	...
		                	else
		                   	{
		                         ...
		                         {
		                         	if (valida_null(txtcontable,"El Código Contable (Cuentas x Cobrar) esta vacio!!")==false) 
	   		                         {
	   	                               txtcontable.focus();
		                             }
			                      	else
									   ...
									   else
										{
										    ...
										    else
											{
												...
												else
												{
													  ...
													  f.action="tepuy_sfa_d_clientes.php";
													  f.submit();
												}
											} 
										}
...
function ue_buscar()
{
	...
	{
		f.operacion.value="";			
		pagina="tepuy_catdinamic_cliente.php";
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=550,height=400,resizable=yes,location=no");
	}
	else
	{
...
{
	f.operacion.value="";			
	pagina="tepuy_sep_cat_bancos_sigecof.php";
