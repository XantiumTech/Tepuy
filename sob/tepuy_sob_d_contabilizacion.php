...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_d_contabilizacion.php";
...
require_once("class_folder/tepuy_sob_c_contabilizacion.php");
$io_contabilizacion=new tepuy_sob_c_contabilizacion();
...
$la_columcontrato[1]="    ";
$la_columcontrato[2]="<a href=javascript:ue_ordenar('c.codcon');><font color=#FFFFFF>Código</font></a>";
$la_columcontrato[3]="<a href=javascript:ue_ordenar('o.desobr');><font color=#FFFFFF>Descripción de la Obra</a>";
...
$la_columaumento[1]="    ";
$la_columaumento[2]="<a href=javascript:ue_ordenar('v.numvar');><font color=#FFFFFF>Cód. Aum.</a>";
$la_columaumento[3]="<a href=javascript:ue_ordenar('c.codcon');><font color=#FFFFFF>Cód. Cont.</a>";
$la_columaumento[4]="<a href=javascript:ue_ordenar('o.desobr');><font color=#FFFFFF>Descripción de la Obra</a>";
...
$la_columdisminucion[2]="<a href=javascript:ue_ordenar('v.numvar');><font color=#FFFFFF>Cód. Dism.</a>";
$la_columdisminucion[3]="<a href=javascript:ue_ordenar('c.codcon');><font color=#FFFFFF>Cód. Cont.</a>";
$la_columdisminucion[4]="<a href=javascript:ue_ordenar('o.desobr');><font color=#FFFFFF>Descripción de la Obra</a>";
...
?>	
  ...
  <table width="695" border="0" align="center" cellpadding="0" cellspacing="0"  class="contorno">
      <tr class="formato-blanco">
        <td width="20">&nbsp;</td>
        <td colspan="10" class="titulo-celdanew">Contabilización de Documentos</td>
        <td width="21">&nbsp;</td>
      </tr>
      <tr class="formato-blanco">
        <td height="29">&nbsp;</td>
        ...
        <td width="174" align="left">
		  ...
		  <select name="cmbdocumento" onChange="javascript:ue_refrescar()">
            ...
            <?Php
		  			$la_textos = array("Contrato","Aumento de Contrato","Disminución de Contrato");
		  ...
		  <input type="hidden" name="hiddocumento" id="hiddocumento" value="<? print $ls_documento?>">
		    </div></td>
        <td width="375">&nbsp;</td>
        <td colspan="2">&nbsp;</td>
        <td colspan="4">&nbsp;</td>
...
<input type="hidden" name="filas" id="filas" value="<? print $li_filas;?>">
