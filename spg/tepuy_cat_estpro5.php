...
<form name="form1" method="post" action="">
  <p align="center">
	...
	if($ls_operacion=="BUSCAR")
	{
		...
		{
		 $ls_sql_seguridad = " AND CONCAT('".$ls_codemp."','SPG','".$ls_logusr."',codestpro1,codestpro2,codestpro3,codestpro4,codestpro4) IN (SELECT CONCAT(codemp,codsis,codusu,codintper) 
...
<script language="JavaScript">
  ...
  f.action="tepuy_cat_estpro5.php?tipo=<?php print $ls_tipo; ?>";
  f.submit();
  }
</script>
</html>