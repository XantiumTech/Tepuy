...
/********************************************************************************************************************************/	
    function uf_spg_reporte_select_denestpro3($as_codestpro1,$as_codestpro2,$as_codestpro3,&$as_denestpro3,&$as_proyecto)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $ls_codemp = $this->dts_empresa["codemp"];
	 $lb_valido=true;
	// $ls_sql=" SELECT denestpro3, proyecto ".
...
/********************************************************************************************************************************/	
    ...
    function uf_spg_reporte_acumulado_cuentas( $as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,
	                                           $as_codestpro5_ori,$as_codestpro1_des,$as_codestpro2_des,$as_codestpro3_des,		                                               $as_codestpro4_des,$as_codestpro5_des,$adt_fecini,$adt_fecfin,$ai_nivel,                                               $ab_subniveles,&$ai_MenorNivel)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    01/02/2006          Fecha última Modificacion : 01/02/2006 Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        $ls_mysql = " SELECT DISTINCT spg_cuenta,nivel,denominacion,asignado,status FROM spg_cuentas PCT ".$ls_str_sql_where." AND 
		                              (nivel<='".$ai_nivel."') ORDER BY spg_cuenta ";
		...
		else
        {
		   ...
		   for ($li_i=1;$li_i<=$li_total_row;$li_i++)
  	       {   
			   ...
			   $ls_asignado = $dts_cuentas->getValue("asignado",$li_i);
...
/********************************************************************************************************************************/	
	...
	////////////////////////////////////////////////////////
	function uf_spg_reporte_select_mayor_analitico( $as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,$as_codestpro4_ori,$as_codestpro5_ori,$as_codestpro1_des,$as_codestpro2_des,$as_codestpro3_des,$as_codestpro4_des,$as_codestpro5_des,$adt_fecini,$adt_fecfin,$as_cuenta_from,$as_cuenta_to,$as_orden)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    01/02/2006          Fecha última Modificacion : 01/02/2006 Hora :
	  ...
	  if (strtoupper($ls_gestor)=="MYSQL")
	  {
	     $ls_str_sql_1 = "CONCAT(RTRIM(BEN.nombene),' ',BEN.apebene) ";
	     //$ls_str_sql_0 = "PROV.nompro ";
	     $ls_str_sql_2 = "CONCAT(MV.codestpro1,MV.codestpro2,MV.codestpro3,MV.codestpro4,MV.codestpro5)";
		 $ls_str_sql_3 = "CONCAT(MOV.codestpro1,MOV.codestpro2,MOV.codestpro3,MOV.codestpro4,MOV.codestpro5)";
	  }
	  else
	  {
	     $ls_str_sql_1 = "RTRIM(BEN.nombene)||', '||BEN.apebene ";	  
	     //$ls_str_sql_0 = "PROV.nompro ";
	     $ls_str_sql_2 = "MV.codestpro1||MV.codestpro2||MV.codestpro3||MV.codestpro4||MV.codestpro5";
	     $ls_str_sql_3 = "MOV.codestpro1||MOV.codestpro2||MOV.codestpro3||MOV.codestpro4||MOV.codestpro5";
	  }
/*	  $ls_mysql=" SELECT  MV.* , C.denominacion,MV.monto as monto_mov ". 
                ...
                " 	    (".$ls_str_sql_2." BETWEEN '".$ls_estructura_desde."' AND '".$ls_estructura_hasta."'
				    	  AND MV.spg_cuenta between '".$as_cuenta_from."' AND '".$as_cuenta_to."') ".		//Agregado el rango de cuentas por Ing. Miguel Palencia 20-12-2006		  
	  ...
	  $ls_mysql = " SELECT * ".
                  ...
                  "    FROM tepuy_cmp SPG,spg_dt_cmp MOV,rpc_proveedor PROV,rpc_beneficiario BEN ".
				  ...
				  " 	    (".$ls_str_sql_3." BETWEEN '".$ls_estructura_desde."' AND '".$ls_estructura_hasta."'
				 			   AND MOV.spg_cuenta between '".$as_cuenta_from."' AND '".$as_cuenta_to."'))  TB ".    //Agregado el rango de cuentas por Ing. Nelson Barraez 20-12-2006
                  " WHERE TA.procede=TB.procede AND TA.comprobante=TB.comprobante AND TA.fecha=TB.fecha ".
	//	" ORDER BY TA.spg_cuenta,TA.codestpro1,TA.codestpro2,TA.codestpro3,TA.codestpro4,TA.codestpro5 ";
          //      "          TA.fecha,TA.asignar DESC, TA.aumento DESC, TA.disminucion DESC, TA.comprometer DESC, ".
            //    "          TA.causar DESC, TA.pagar DESC, TA.Documento";
		  " ORDER BY TA.spg_cuenta, TA.codestpro1,TA.codestpro2,TA.codestpro3,TA.codestpro4,TA.codestpro5, ".
		  "          TA.fecha, TA.Documento, TA.comprobante ";
	//  " ORDER BY TA.spg_cuenta, ".$ls_ordenar." ";
	  ...
	  else
	  {
	  	  ...
	  	  while($row=$this->SQL->fetch_row($rs_mov_spg))
		  {
			  ...
			  $ls_NomPro=$row["nompro"];			
			//if(empty($ls_BEN_Nombre)){$ls_BEN_Nombre="vacio";}
			//if(empty($ls_NomPro)){$ls_NomPro="vacio";}
			  $ldt_fecha=$row["fecha"];
			  $ls_cod_pro=$row["cod_pro"];
			      ...
			      ($ls_spg_cuenta>=$as_cuenta_from) and ($ls_spg_cuenta<=$as_cuenta_to))
			  {
				  ...
				  $this->uf_calcular_monto_operaciones($ls_operacion,$ldec_monto_operacion,$ldec_monto_asignado,$ldec_monto_aumento,$ldec_monto_disminucion,
									                   $ldec_monto_precompromiso,$ldec_monto_compromiso,$ldec_monto_causado,$ldec_monto_pagado);				  
			// condicion nueva para buscar el monto real del pagado, desde el cheque //			
				  if ($ldec_monto_pagado>0)
				  {
				$ls_mysql1=" SELECT  MK.*  FROM scb_movbco MK WHERE MK.numdoc='".$ls_comprobante."' ";
					$rs_pago=$this->SQL->select($ls_mysql1);
					if($rs_pago!=false)
					{
						while($row=$this->SQL->fetch_row($rs_pago))
						{
						$antes=$row["monto"];
						if($antes<=$ldec_monto_pagado)
						{
							$ldec_monto_pagado=$row["monto"];
						}
						}
					}
				  }
			...
			if($lb_valido)
			{
		     ...
		     else
		     {
			   while($row=$this->SQL->fetch_row($rs_data))
			   {
					 ...
					 $ld_disponible=$ld_monto_asignado+$ld_monto_aumento-$ld_monto_disminucion-$ld_monto_compromisos;//-$ld_monto_precomprometido;
					 $this->dts_reporte->insertRow("programatica",$ls_programatica);
				     $this->dts_reporte->insertRow("spg_cuenta",$ls_spg_cuenta);
				     $this->dts_reporte->insertRow("denominacion",$ls_denominacion);
				     $this->dts_reporte->insertRow("status",$ls_status);
		   ...
		   else
		   {
			   ...
			   {   
				   ...
				   if(!$this->uf_calcular_disponible_operacion_por_cuenta($ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_codestpro4,
					...
					//+$ld_monto_aumento_a+$ld_monto_aumento-$ld_monto_disminucion_a-$ld_monto_disminucion;
    ...
    {////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    15/04/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT CMP.descripcion as cmp_descripcion, CMP.fecha as fecha, MOV.*,                           ".
	          "        MP.fecha as fecaprmod, CTA.denominacion                                                  ".
              "   FROM spg_dt_cmp MOV, tepuy_cmp CMP,spg_cuentas CTA ,spg_dtmp_cmp MP							".
