    ...
    <table width="519" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td height="22" colspan="2"><div align="right">
         <a href="javascript: ue_guardar_foto();"><img src="../../../../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0">Cargar Foto</a>
        </div></td>
      </tr>
...
function ue_guardar_foto()
{
	...
	else
	{
		...
		f.action="tepuy_srh_cargar_foto.php";
		f.submit();
	}   	
