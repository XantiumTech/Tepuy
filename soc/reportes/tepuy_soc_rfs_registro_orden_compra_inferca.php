...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $ls_forpagcom,&$io_pdf)
	{
		...
		$io_pdf->addText(25,170,7,"UNIDAD DE COMPRAS"); // Agregar el título
		$io_pdf->line(115,130,115,180);	//VERTICAL	
		$io_pdf->addText(123,170,7,"COORDINACIÓN DE BIENES Y SERVICIOS"); // Agregar el título
		$io_pdf->line(270,130,270,180);	//VERTICAL		
		$io_pdf->addText(280,170,7,"COORDINACIÓN DE PRESUPUESTO"); // Agregar el título
		$io_pdf->line(410,130,410,180);	//VERTICAL		
		$io_pdf->addText(420,170,7,"GERENCIA DE ADMINISTRACIÓN Y FINANZAS"); // Agregar el título
		//$io_pdf->line(15,73,585,73); //HORIZONTAL		
		$io_pdf->Rectangle(15,60,570,70); 
		$io_pdf->addText(235,123,7,"RECEPCIÓN DE LA ORDEN POR EL PROVEEDOR");
		$io_pdf->addText(25,110,7,"APELLIDOS Y NOMBRES");
		$io_pdf->line(115,60,115,120);	//VERTICAL
		$io_pdf->addText(140,110,7,"CÉDULA DE IDENTIDAD Nº");
		$io_pdf->line(270,60,270,120);	//VERTICAL
		$io_pdf->addText(380,110,7,"FIRMA RECIBIDO CONFORME");
		$io_pdf->addText(235,123,7,"RECEPCIÓN DE LA ORDEN POR EL PROVEEDOR");
		$io_pdf->ezSetY(695);
	...
	else  // Imprimimos el reporte
	{
		...
		if($lb_valido)	
		{
			...
			$io_pdf->ezSetCmMargins(6.5,9,3,3); // Configuración de los margenes en centímetros
