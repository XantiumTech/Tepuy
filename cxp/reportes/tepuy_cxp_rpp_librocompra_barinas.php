...
//	ini_set('display_errors', 1);
	...
	function uf_insert_seguridad($as_periodo)
	{
		...
		$lb_valido=$io_fun_cxp->uf_load_seguridad_reporte("CXP","tepuy_cxp_r_librocompra.php",$ls_descripcion);
		return $lb_valido;
	}
	...
	/*	$io_pdf->ezSetDy(+10);
		$la_data1   =array(array('name1'=>'<b>Compras Internas o Importaciones</b>'));
		$la_columna1=array('name1'=>'<b>Compras Internas o Importaciones</b>');
	...
	/*	$la_data=array(array('name1'=>'<b>Nro Oper</b>',
		...
		/*$la_data=array(array('name1'=>'<b>Nro Oper</b>',
							 'name2'=>'<b>Fecha Factura</b>','name3'=>'<b>RIF</b>',
							 'name4'=>'<b>Nombre o Razn Social</b>','name51'=>'<b>Tipo Prov.</b>','name8'=>'<b>Nro de Factura</b>','name9'=>'<b>Nro de Control</b>','name10'=>'<b>Nro Nota Dbito</b>','name11'=>'<b>Nro Nota Crdito</b>','name12'=>'<b>Tipo de Transacc.</b>','name13'=>'<b>Nro de Factura Afectada</b>','name14'=>'<b>Total de Compra Incluyendo IVA</b>','name15'=>'<b>Compra sin Derecho a Crdito IVA</b>','name16'=>'<b>Base Imponible</b>','name17'=>'<b>%</b>','name18'=>'<b>Impuesto Iva</b>','name19'=>'<b>IVA Retenido (Vendedor)</b>','name30'=>'<b>Nro Compr.</b>','name31'=>'<b>Fecha del Compr.</b>',));*/
		$la_data=array(array('name1'=>'<b>Nro Oper</b>',
							 'name2'=>'<b>Fecha Factura</b>','name3'=>'<b>RIF</b>',
							 'name4'=>'<b>Nombre o Razn Social</b>','name51'=>'<b>Tipo Prov.</b>','name30'=>'<b>Nro Compr.</b>','name8'=>'<b>Nro de Factura</b>','name9'=>'<b>Nro de Control</b>','name10'=>'<b>Nro Nota Dbito</b>','name11'=>'<b>Nro Nota Crdito</b>','name12'=>'<b>Tipo de Transacc.</b>','name13'=>'<b>Nro de Factura Afectada</b>','name14'=>'<b>Total de Compra Incluyendo IVA</b>','name15'=>'<b>Compra sin Derecho a Crdito IVA</b>','name16'=>'<b>Base Imponible</b>','name17'=>'<b>%</b>','name18'=>'<b>Impuesto Iva</b>','name19'=>'<b>IVA Retenido (Vendedor)</b>','name31'=>'<b>Ficha</b>',));
 ...
 // Justificacin y ancho de la columna
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		// Fecha Creacin: 21/04/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_columna=array('name1'=>'<b>Nro Oper</b>','name2'=>'<b>Fecha Factura</b>','name3'=>'<b>RIF</b>',
				'name4'=>'<b>Nombre o Razn Social</b>','name51'=>'<b>Tipo Prov.</b>','name30'=>'<b>Nro Compr.</b>',
				'name8'=>'<b>Nro de Factura</b>','name9'=>'<b>Nro de Control</b>','name10'=>'<b>Nro Nota Dbito</b>',
				'name11'=>'<b>Nro Nota Crdito</b>','name12'=>'<b>Tipo de Transacc.</b>','name13'=>'<b>Nro de Factura Afectada</b>',
				'name14'=>'<b>Total de Compra Incluyendo IVA</b>','name15'=>'<b>Compra sin Derecho a Crdito IVA</b>',
				'name16'=>'<b>Base Imponible</b>','name17'=>'<b>%</b>','name18'=>'<b>Impuesto Iva</b>',
				'name19'=>'<b>IVA Retenido (Vendedor)</b>','name31'=>'<b>Ficha</b>');
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('name1'=>array('justification'=>'center','width'=>15), // Justificacin y ancho de la columna Nro de Operacion.
						 			   ...
						 			   'name4'=>array('justification'=>'left','width'=>120), // Justificacin y ancho de la columna Nombre o Razn Social.
									   'name51'=>array('justification'=>'center','width'=>20), // Justificacin y ancho de la columna Nro de Comprobante.
									   'name30'=>array('justification'=>'center','width'=>45), // Justificacin y ancho de la columna
						 			   'name8'=>array('justification'=>'center','width'=>45), // Justificacin y ancho de la columna Nro de Factura.   
									   'name9'=>array('justification'=>'center','width'=>45), // Justificacin y ancho de la columna Nro de Control.
						 			   'name10'=>array('justification'=>'center','width'=>40), // Justificacin y ancho de la columna
						 			   'name11'=>array('justification'=>'center','width'=>45), // Justificacin y ancho de la columna
									   ...
									   'name31'=>array('justification'=>'center','width'=>30))); // Justificacin y ancho de la columna Nro de Comprobante. Nro de Comprobante.
		$io_pdf->ezTable($la_data,$la_columna,'',$la_config);
		unset($la_data);
	...
	$io_pdf->ezSetCmMargins(3.5,2.5,2.5,2.5); // Configuracin de los margenes en centmetros
	...
	if($lb_valido)
	{
		...
		// es necesario buscar el monto del iva retenido en caso de existir //
			...
			$filtrar= "SELECT monret,MAX(DED.iva) AS iva FROM tepuy_deducciones DED,cxp_rd RD ".
				...
				" ON RD.numrecdoc='".$ls_numrecdoc."' AND RD.codtipdoc='".$ls_codtipdoc."' AND RDDED.numrecdoc='".$ls_numrecdoc.
				...
				if($ldec_moncardoc==$ldec_montoret)
				{
			...
			$ls_cheque=$io_report->uf_select_data($io_sql,"SELECT distinct cxp_sol_banco.numdoc AS numdoc".
														  ...
														  "   AND cxp_dt_solicitudes.codtipdoc='".$ls_codtipdoc."'".
	...
	$a="SELECT DISTINCT max(a.numrecdoc) as numrecdoc,max(a.monobjret) as monobjret,SUM(a.monret) as monret,max(a.porded) as porded,max(b.codret) as codret,max(b.numcom) as numcom,max(b.iva_ret) as iva_ret,max(tiptrans) as tiptrans, max(c.numcom) as numcom, max(c.fecrep) as fecharet".
															  "   FROM cxp_rd_deducciones a,scb_dt_cmp_ret b, scb_cmp_ret c                                                                         ".
															  "  WHERE a.codemp=b.codemp AND a.numrecdoc=b.numfac AND b.numcom=c.numcom AND a.codemp='".$ls_codemp."' AND a.numrecdoc='".$ls_numrecdoc."' AND a.codtipdoc='".$ls_codtipdoc."' AND ".
															  "        a.cod_pro='".$ls_codpro."' AND a.ced_bene='".$ls_cedben."'                                              ".
															  " GROUP BY a.numrecdoc ";
	...
	//die();
			if(count($la_cmpret)>0)
			{
				...
				if ($ls_codret=='01' || $ls_codret=='04')
				{
					 $ldec_monret    = $la_cmpret["monret"];  
					 $ls_cmpret      = $la_cmpret["numcom"];
					 if(strlen($ls_cmpret )==15)
					 {
					 	$ls_cmpret=substr($ls_cmpret,0,6).substr($ls_cmpret,7,8);
					 }
			...
			$la_data[$li]=array('name1'=>$li,
							 'name2'=>$io_report->io_funciones->uf_convertirfecmostrar($row["fecemidoc"]),'name3'=>$ls_rif,
							 'name4'=>$ls_nombre,'name51'=>$ls_tipproben,'name30'=>$ls_cmpret,
							 'name8'=>$ls_factura,'name9'=>$row["numref"], 'name10'=>$ls_numnd,'name11'=>$ls_numnc,
							 'name12'=>$ls_tiptrans,'name13'=>$ls_facturas_afectadas, 'name14'=>number_format($ldec_montodoc,2,",","."),
							 'name15'=>number_format($ldec_sinderiva,2,",","."),'name16'=>number_format($ldec_baseimp,2,",","."),
							 'name17'=>$ldec_porcar,'name18'=>number_format($ldec_monimp,2,",","."),
							 'name19'=>number_format($ldec_montoret,2,",","."),'name31'=>$ls_numrecdoc);	
