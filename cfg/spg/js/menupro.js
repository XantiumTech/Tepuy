...
stm_aix("p1i0","p0i0",[0,"Comprobante ","","",-1,-1,0,"tepuy_cxp_w_recep_docume.php","","","","","",0,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i2","p1i0",[0,"Aprobación de Recepción de Documentos    ","","",-1,-1,0,"tepuy_cxp_w_aprob_rd.php","","","","","",0,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();
...
stm_aix("p1i0","p0i0",[0,"Comprobante ","","",-1,-1,0,"tepuy_cxp_w_proc_sol.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_aix("p1i2","p1i0",[0,"Aprobación de Solicitudes de Pago ","","",-1,-1,0,"tepuy_cxp_w_aprob_sol.php","","","","","",6,0,0,"","",0,0,0,0,1,"#ffffff"]);
stm_ep();

// Menú Principal - Notas de Credito / Debito
stm_aix("p0i4","p0i0",[0,"   Notas de Crédito/Débito     ","","",-1,-1,0,"tepuy_cxp_w_NC.php","","","","","",6,0,0,"","",0,0,0,0,1,"#f4f4f4"]);
stm_bpx("p5","p1",[1,4,0,0,2,3,6,7]);
stm_ep();
stm_em();