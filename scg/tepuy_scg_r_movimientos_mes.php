<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","tepuy_scg_r_movimientos_mes.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
function ue_search()
{
	...
	{	
		...
		{
			pagina="reportes/tepuy_scg_rpp_movimientos_mes.php?fecha="+ls_periodo+"&cuentadesde="+ls_cuentadesde+
...
function ue_openexcel()
{
	...
	{	
		...
		{
			pagina="reportes/tepuy_scg_rpp_movimientos_mes_excel.php?fecha="+ls_periodo+"&cuentadesde="+ls_cuentadesde+
