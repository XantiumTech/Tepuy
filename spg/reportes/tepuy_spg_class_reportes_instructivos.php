<?php
class tepuy_spg_class_reportes_instructivos
{
	var $io_mensajes;
	var $io_fecha;
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function  tepuy_spg_class_reportes_instructivos()
    {
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
			$this->io_mensajes->message("CLASE->tepuy_spg_class_reportes_instructivos ". 
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $as_spg_cuenta = $this->io_tepuy_int_spg->uf_spg_cuenta_sin_cero($as_spg_cuenta)."%";
  	 ...
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		else
		{
			while($row=$this->io_sql->fetch_row($rs_data))
			{
               ...
               $lb_valido=$this->uf_spg_reporte_calcular_ejecutado_trimestre($ls_spg_cuenta,$ls_estructura_desde,
...
function uf_spg_reporte_calcular_ejecutado_trimestre($as_spg_cuenta,$as_estructura_desde,$as_estructura_hasta,$ai_mesdes,
													 ...
													 &$ad_comacutri,&$ad_cauacutri,&$ad_pagacutri)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    18/05/2008          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT DT.fecha, DT.monto, OP.aumento, OP.disminucion, OP.precomprometer,OP.comprometer, OP.causar, OP.pagar ".
              ...
              "        spg_cuenta like '".$as_spg_cuenta."' AND DT.fecha <= '".$ai_meshas."'".
			  " ORDER BY DT.fecha";
...
//-----------------------------------------------------------------------------------------------------------------------------------
    ...
    {////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($lb_valido)
	 {
		...
		$la_cuenta[1]='305000000';
		$la_cuenta[2]='305010000';
		$la_cuenta[3]='305010100';
		$la_cuenta[4]='305010200';
		$la_cuenta[5]='305010300';
		$la_cuenta[6]='305010301';
		$la_cuenta[7]='305010302';
		$la_cuenta[8]='305010303';
		$la_cuenta[9]='305010304';
		$la_cuenta[10]='305010305';
		$la_cuenta[11]='305010306';
		$la_cuenta[12]='305010307';
		$la_cuenta[13]='305010308';
		$la_cuenta[14]='305010309';
		$la_cuenta[15]='305010400';
		$la_cuenta[16]='305010401';
		$la_cuenta[17]='305010402';
		$la_cuenta[18]='305010403';
		$la_cuenta[19]='305010404';
		$la_cuenta[20]='305010405';
		$la_cuenta[21]='305010406';
		$la_cuenta[22]='305010407';
		$la_cuenta[23]='305010408';
		$la_cuenta[24]='305010409';
		$la_cuenta[25]='305010500';
		$la_cuenta[26]='305010600';
		// ---> b. Ingresos por Actividades Propias
		$la_cuenta[27]='301090000';
		$la_cuenta[28]='301090100';
		$la_cuenta[29]='301090200';
		$la_cuenta[30]='301099900';
		$la_cuenta[31]='408070000'; // ---> Menos Descuentos, Bonificaciones y Devoluciones
        // ---> Ventas Netas
		$la_cuenta[32]='301030000';
		$la_cuenta[33]='303990000';
        // ---> c. Otros Ingresos Corrientes
		$la_cuenta[34]='301040000';
		$la_cuenta[35]='301050000';
		$la_cuenta[36]='301100000';
		$la_cuenta[37]='302030000';
		$la_cuenta[38]='302040000';
		$la_cuenta[39]='302050000';
		// ---> 2. GASTOS CORRIENTES
		// ---> a. Gastos de Consumo
		$la_cuenta[40]='401000000';
		$la_cuenta[41]='402000000';
		$la_cuenta[42]='403000000';
		// ---> Variación de Inventarios (Detallar)
		$la_cuenta[43]='408000000';
		$la_cuenta[44]='408010000';
		$la_cuenta[45]='408010100';
		$la_cuenta[46]='408010200';
		// ---> b. Otros Gastos Corrientes
		$la_cuenta[47]='407000000';
		$la_cuenta[48]='407010000';
		$la_cuenta[49]='407010100';
		$la_cuenta[50]='407010300';
		$la_cuenta[51]='407020000';
		$la_cuenta[52]='408020000';
		$la_cuenta[53]='408050000';
		$la_cuenta[54]='408060000';
		$la_cuenta[55]='408080000';
		...
		$li_pos_a=$this->dts_reporte->find("cuenta","305000000");
		if($li_pos_a>0)
		{
    ...
    {////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación : 18/06/2008                       Fecha última Modificacion :      Hora :
	   ...
	   $ls_sql=" SELECT spi_cuenta, max(denominacion) as denominacion,                  ".
			  ...
			  "        spi_cuenta = '305000000' OR spi_cuenta = '305010000' OR spi_cuenta = '305010100' OR ".
              "        spi_cuenta = '305010200' OR spi_cuenta = '305010300' OR spi_cuenta = '305010301' OR ".
			  "        spi_cuenta = '305010302' OR spi_cuenta = '305010303' OR spi_cuenta = '305010304' OR ".
			  "        spi_cuenta = '305010305' OR spi_cuenta = '305010306' OR spi_cuenta = '305010307' OR ".
			  "        spi_cuenta = '305010308' OR spi_cuenta = '305010309' OR spi_cuenta = '305010400' OR ".
			  "        spi_cuenta = '305010401' OR spi_cuenta = '305010402' OR spi_cuenta = '305010403' OR ".
			  "        spi_cuenta = '305010404' OR spi_cuenta = '305010405' OR spi_cuenta = '305010406' OR ".
			  "        spi_cuenta = '305010407' OR spi_cuenta = '305010408' OR spi_cuenta = '305010409' OR ".
			  "        spi_cuenta = '305010500' OR spi_cuenta = '305010600'  ".
			  " GROUP BY spi_cuenta ".
			  " ORDER BY spi_cuenta ";
	 ...
	 // Fecha Creación : 18/06/2008                       Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT spi_cuenta, max(denominacion) as denominacion,                  ".
			  ...
			  "        sum(octubre+noviembre+diciembre) as trimetreIV                                    ".
	  	      " FROM   spi_cuentas ".
			  " WHERE  codemp='".$this->ls_codemp."' AND ".
			  "        spi_cuenta = '301090000' OR spi_cuenta = '301090100' OR spi_cuenta = '301090200' OR ".
	          "        spi_cuenta = '301099900' OR spi_cuenta = '301030000' OR spi_cuenta = '303990000'    ".
			  " GROUP BY spi_cuenta ".
			  " ORDER BY spi_cuenta ";
	 ...
	 // Fecha Creación : 18/06/2008                       Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT spi_cuenta, max(denominacion) as denominacion,                  ".
			  ...
			  "        sum(octubre+noviembre+diciembre) as trimetreIV                                    ".
	  	      " FROM   spi_cuentas ".
			  " WHERE  codemp='".$this->ls_codemp."' AND ".
			  "        spi_cuenta = '301040000' OR spi_cuenta = '301050000' OR spi_cuenta = '301100000' OR ".
			  "        spi_cuenta = '302030000' OR spi_cuenta = '302040000' OR spi_cuenta = '302050000'    ".
			  " GROUP BY spi_cuenta ".
			  " ORDER BY spi_cuenta ";
	 ...
	 // Fecha Creación : 18/06/2008                       Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT spg_cuenta, max(denominacion) as denominacion, sum(asignado) as asignado, ".
			  ...
			  "        sum(octubre+noviembre+diciembre) as trimetreIV                                    ".
	  	      " FROM   spg_cuentas ".
			  " WHERE  codemp='".$this->ls_codemp."' AND ".
			  "        spg_cuenta = '401000000' OR spg_cuenta = '402000000' OR spg_cuenta = '403000000' OR ".
			  "        spg_cuenta = '408000000' OR spg_cuenta = '408010000' OR spg_cuenta = '408010100' OR ".
			  "        spg_cuenta = '408010200'   ".
			  " GROUP BY spg_cuenta".
			  " ORDER BY spg_cuenta ";
	  $rs_data=$this->io_sql->select($ls_sql);
	  if($rs_data===false)
	 ...
	 // Fecha Creación : 18/06/2008                       Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT spg_cuenta, max(denominacion) as denominacion, sum(asignado) as asignado, ".
			  ...
			  "        sum(octubre+noviembre+diciembre) as trimetreIV                                    ".
	  	      " FROM   spg_cuentas ".
			  " WHERE  codemp='".$this->ls_codemp."' AND ".
			  "        spg_cuenta = '407000000' OR spg_cuenta = '407010000' OR spg_cuenta = '407010100' OR ".
			  "        spg_cuenta = '407010300' OR spg_cuenta = '407020000' OR spg_cuenta = '408020000' OR ".
			  "        spg_cuenta = '408050000' OR spg_cuenta = '408060000' OR spg_cuenta = '408080000'    ".
			  " GROUP BY spg_cuenta ".
			  " ORDER BY spg_cuenta ";
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($as_detallar==true)
	 {
	   $as_spi_cuenta = $this->io_tepuy_int_spi->uf_spi_cuenta_sin_cero($as_spi_cuenta)."%";
	 ...
	 $ls_sql = " SELECT DT.fecha, DT.monto, OP.aumento, OP.disminucion, ".
	  ...
	  if($rs_ejecutado===false)
	  { // error interno sql
			$this->io_mensajes->message("CLASE->tepuy_spi_class_reportes_instructivos ". 
