...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_activo.php",$ls_permisos,$la_seguridad,$la_permisos);
...
?>	
  ...
  <table width="578" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="561" colspan="2" class="titulo-ventana">Reporte de Activos Registrados </td>
    </tr>
  </table>
  <table width="575" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><table width="511" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
          <td height="19" colspan="2" style="display:none"><strong>Reporte en</strong>
      ...
      <td height="22" colspan="3" align="center"><table width="511" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td height="22"><input name="txtcodrespri" type="text" id="txtcodrespri" size="15" style="text-align:center" readonly>
              <a href="javascript: uf_resprimario('repasignadospri');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
        ...
        <tr>
          ...
          <td height="22"><input name="txtcodresuso" type="text" id="txtcodresuso" size="15" style="text-align:center" readonly>
              <a href="javascript: uf_resprimario('repasignadosuso');"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/tepuy_saf_rpp_activo.php?ordenact="+li_ordenact+"&desde="+ld_desde+
