  ...
  <p align="center">
    <input name="operacion" type="hidden" id="operacion">
	 ...
	 <table width="800" border="0" cellpadding="0" cellspacing="3" class="formato-blanco" align="center">
      ...
      <tr>
        <td height="21">&nbsp;</td>
        <td height="21"><div align="right">Estado</div></td>
        <td><?Php
          ...
          <input name="hidestado2" type="hidden" id="hidestado2"  value="<? print $ls_codigoestado ?>"></td>
        <td></td>
      ...
      <tr>
        ...
        <td width="62" height="21"><div align="right"><!--Pa&iacute;s</div></td>
        <td><div align="left">
          <?Php
          ...
          <select name="cmbpais" id="cmbpais" onChange="javascript:document.form1.submit();">
            <option value="" >Seleccione...</option>
            <option value="058" >VENEZUELA</option>            <?Php
			for($li_i=1;$li_i<=$li_totalfilas;$li_i++)
			 {
        ...
        <td width="292"><div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a></div></td>
      </tr>
    </table>
	<br>
...
/*	$ls_sql="SELECT o.codemp,o.codobr,o.codten,o.codtipest,o.codpai,o.codest,o.codmun,o.codpar,o.codcom,o.codsiscon,o.codpro,o.codtob,
			...
			FROM sob_obra o,sob_tenencia t,sob_tipoestructura te, sob_sistemaconstructivo sc,sob_propietario pr,sob_tipoobra ti,tepuy_estados es
			WHERE o.codemp='".$ls_codemp."' AND o.codobr like '".$ls_codobr."' AND o.desobr like '".$ls_desobr."' AND o.codest like '".$ls_codest."'
	...
	$ls_sql="SELECT o.codemp,o.codobr,o.codten,o.codtipest,o.codpai,o.codest,o.codmun,o.codpar,o.codcom,o.codsiscon,o.codpro,o.codtob,
			o.desobr,o.dirobr,o.obsobr,o.resobr,o.feciniobr,o.fecfinobr,o.cantobr,o.monto,o.feccreobr,es.desest as desest ,o.staobr,o.codpai,ti.nomtob
			FROM sob_obra o,sob_tipoobra ti,tepuy_estados es
			WHERE o.codemp='".$ls_codemp."' AND o.codobr like '".$ls_codobr."' AND o.desobr like '".$ls_desobr."' AND o.codest like '".$ls_codest."'
			AND o.codtob=ti.codtob AND es.codpai=o.codpai AND o.codest=es.codest AND o.staobr<>3 ";
			//print $ls_sql;
	if($ls_estobr!="")
	{
...
<script language="JavaScript">
  ...
  {
	//alert("aqui");
    opener.ue_montarobra(ls_codigo,ls_descripcion,ls_estado,ls_codest,ls_codten,ls_codtipest,ls_codpai,ls_codmun,ls_codpar,ls_codcom,
  				         ls_codsiscon,ls_codpro,ls_codtob,ls_dirobr,ls_obsobr,ls_resobr,ld_monto,ls_feccreobr,ls_nompro,
				         ls_fechainicio,ls_fechafin,ls_nomten,ls_nomtipest,ls_nomsiscon,ls_nomtob,ls_estado,ls_codpais);
	close();
  }
