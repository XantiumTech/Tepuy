...
function guardarDetalles_ODI ($ao_objetivo, $aa_seguridad)
  {
	...
	$lb_guardo = true;
	$li_obj = 0;
	while (($li_obj < count($ao_objetivo->odi)) &&
	       ($lb_guardo))
	{
...
function uf_srh_guardar_dt_odi($ao_objetivo, $aa_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_odi)														
	 ...
	 $ls_sql = "INSERT INTO srh_dt_odi (nroreg,odi, valor, codemp) ".	  
	            " VALUES ('$ao_objetivo->nroreg','$ao_objetivo->odi','$ao_objetivo->valor','".$this->ls_codemp."')";
...
function uf_srh_eliminar_dt_odi($as_nroreg, $aa_seguridad)
  {
		...
		//        access:  public (tepuy_srh_dt_odi)														
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		else
		{
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$ao_object[$ai_totrows][1]="<textarea name=txtodi".$ai_totrows."  cols=60 rows=3 id=txtodi".$ai_totrows." class=sin-borde>".$ls_odi."</textarea>";
				...
				$ao_object[$ai_totrows][3]="<a href=javascript:uf_agregar_dt(".$ai_totrows.");  align=center><img src=../../../../shared/imagebank/tools15/aprobado.png alt=Aceptar width=15 height=15 border=0 align=center></a>";
				$ao_object[$ai_totrows][4]="<a href=javascript:uf_delete_dt(".$ai_totrows.",txttotal,txtvalor".$ai_totrows.");     align=center><img src=../../../../shared/imagebank/tools15/eliminar.png alt=Eliminar width=15 height=15 border=0 align=center></a>";				
