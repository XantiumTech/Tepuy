...
var url= "../../php/tepuy_srh_a_entrevista_tecnica.php";
var metodo='get';
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_p_entrevista_tecnica.php";
  f.submit(); 
}
...
function catalogo_persona_concurso()
{
  ...
  if (codcon=="") { alert ('Debe seleccionar un Concurso');}
	  ...
	  pagina="../catalogos/tepuy_srh_cat_persona_concurso.php?valor_cat=0"+"&codcon="+codcon;
	  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
  }
...
{
   pagina="../catalogos/tepuy_srh_cat_concurso.php?valor_cat=0"; 
  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_entrevista_tecnica.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
...
function consultar_items () {
	 ...
	 if  ( ($('txtcodeval').value=="") ) 		
	 {
	  ...
	  f.operacion.value="CONSULTAR";
  	  f.action="../pantallas/tepuy_srh_p_entrevista_tecnica.php";
	  f.existe.value="TRUE";			
	  f.submit();	
	 }
...
function ue_print()
{
    ...
    if ((codper=='')||(codcon=='') || (tipoeval=='')) {
		...
		{	
				 ...
				 pagina="../../../reporte/tepuy_srh_rpp_registro_entrevista_tecnica.php?codper="+codper+"&fecha="+fecha+"&tipoeval="+tipoeval+"&codcon="+codcon;
