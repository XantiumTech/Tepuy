...
<script type="text/javascript">var MenuLinkedBy="AllWebMenus [4]",awmMenuName="menu",awmBN="848";awmAltUrl="";</script><script charset="UTF-8" src="../js/menu_sps.js" type="text/javascript"></script><script type="text/javascript">awmBuildMenu();</script>
						...
						<div>
						  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="formato-blanco" style="border-color:#FFFFFF">
							<tr>
							  ...
							  <td width="334" >  
								<input name="txtid_art" type="text" id="txtid_art" style="text-align:center" value="" size="8" maxlength="4" ></td>
							</tr>
							<tr>
							  <td>&nbsp;</td>
							  <td>&nbsp;</td>
