...
class configuration {
	...
	function upTables()
	{
		...
		$this->table['tepuy_cmp'][1] = "procede = 'SCGCIE'";
...
//
		...
		$this->table['sno_nomina'][0] = "anocurnom+1 AS anocurnom, DATE_ADD(fecininom, INTERVAL 1 YEAR) AS fecininom";
...
//		
///		$this->table[11][65] = "sno_prenomina";
//
