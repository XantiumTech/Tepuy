...
if (!array_key_exists("la_logusr",$_SESSION))
   ...
   //////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_operacion_por_especifica.php";
    ...
    <tr>
      <td colspan="3" align="center"><div align="left">
        <table width="542" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr class="titulo-celdanew">
            <td height="13" colspan="7" class="titulo-celdanew">Estado Presupuestario </td>
          </tr>
          <tr>
            <td width="98" height="22"><div align="right">
                <?php 	
		  ...
		  ?>
            ...
            <td width="43">Causar</td>
            <td width="78"><div align="right">
                <input name="rborden" type="radio" value="PG" <?php print $ls_pagar ?>>
            </div></td>
            <td width="152"><div align="left">Pagar</div></td>
          </tr>
        </table>
...
function ue_showouput()
{
	...
	if(li_imprimir==1)
	{
		...
		else
		{
			...
			{
				pagina="reportes/tepuy_spg_rpp_operacion_por_especifica.php?txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas
