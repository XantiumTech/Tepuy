  ...
  with (form1)
  {
    ...
    else
    {
	  ...
	  else
	  {
		...
		f.action="tepuy_scg_plan_unico.php";
		f.submit();
	  }
	} 
  }
...
{
   f=document.form1;
   pagina="tepuy_catdinamic_ctaspu.php?";
