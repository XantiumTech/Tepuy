...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" background="imagebank/header.jpg" class="contorno">
  ...
  <tr>
	...
	<table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Presupuesto de Gastos <b>-> Ingresos y Egresos </b></td>
...
require_once("tepuy_spg_class_definicion.php");
...
//////////////////////////////////////////////  SEGURIDAD   /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_scg_d_plan_unicore.php";
            ...
            else
               {
	             if (valida_null(txtdenominacion,"La denominación esta vacia!!")==false)
	             ...
	             else
	                {
		              ...
		              f.action="tepuy_scg_d_plan_unicore.php";
		              f.submit();
	                }
	           } 
          }
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
         pagina="tepuy_scg_cat_ctaspure.php?";
