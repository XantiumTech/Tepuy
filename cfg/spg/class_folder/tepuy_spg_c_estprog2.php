<?php
class tepuy_spg_c_estprog2
{
var $is_msg_error;
	
		function tepuy_spg_c_estprog2($conn)
		{
		  require_once("../../shared/class_folder/tepuy_c_seguridad.php");
	      require_once("../../shared/class_folder/class_funciones.php");
          require_once("../../shared/class_folder/class_mensajes.php");
		  require_once("class_folder/tepuy_spg_c_estprog3.php");
		  $this->io_estpro3   = new tepuy_spg_c_estprog3($conn);
...
function uf_spg_select_estprog2($as_codemp,$as_codestpro1,$as_codestpro2)
{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
  ...
  if ($rs_data===false)
	 {
 	   $lb_valido=false;
 	   $this->io_msg->message("CLASE->tepuy_SPG_C_ESTPROG2; METODO->uf_spg_select_estprog2; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
...
function uf_spg_insert_estprog2($as_codemp,$as_codestpro1,$as_codestpro2,$as_denestpro2,$ai_estmodest,$aa_seguridad)
{
//////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 $ls_sql = "INSERT INTO spg_ep2 (codemp,codestpro1,codestpro2,denestpro2) VALUES ('".$as_codemp."','".$as_codestpro1."','".$as_codestpro2."','".$as_denestpro2."') ";
	 $this->io_sql->begin_transaction();
	 $rs_data = $this->io_sql->execute($ls_sql);
	 if ($rs_data===false)		     
	    {
		  $lb_valido          = false;
 	      $this->is_msg_error = "CLASE->tepuy_SPG_C_ESTPROG2; METODO->uf_spg_insert_estprog2; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);
		 }
	 else
		 {
		   $lb_valido      = true;
		   if ($ai_estmodest=='1')
		      {
			    $lb_valido = $this->io_estpro3->uf_spg_insert_estprog3($as_codemp,$as_codestpro1,$as_codestpro2,'000','NINGUNO','--',$ai_estmodest,$aa_seguridad);
			    if (!$lb_valido)
				   {
				     $lb_valido = false;
		      	     $this->is_msg_error = "CLASE->tepuy_SPG_C_ESTPROG3; METODO->uf_spg_insert_estprog3(Insert Nivel 3 Default); ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message);
				   }
			  }
		   /////////////////////////////////         SEGURIDAD               /////////////////////////////		
		   $ls_evento      = "INSERT";
...
function uf_spg_update_estprog2($as_codemp,$as_codestpro1,$as_codestpro2,$as_denestpro2,$aa_seguridad)
{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
  ...
  $ls_sql=" UPDATE spg_ep2 SET denestpro2='".$as_denestpro2."' WHERE codemp='".$as_codemp."' AND codestpro1='".$as_codestpro1."' AND codestpro2='".$as_codestpro2."'";
  $this->io_sql->begin_transaction();
  $rs_data=$this->io_sql->execute($ls_sql);
  if ($rs_data===false)
	 {
	   $lb_valido=false;
 	   $this->io_msg->message("CLASE->tepuy_SPG_C_ESTPROG2; METODO->uf_spg_update_estprog2; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	 }
  else
	 {
	   $lb_valido = true;
...
function uf_spg_delete_estpro2($as_codemp,$as_codestpro1,$as_codestpro2,$as_denestpro2,$aa_seguridad)
{
  $lb_tiene  = $this->uf_check_relaciones($as_codemp,$as_codestpro1,$as_codestpro2);
  $lb_existe = $this->uf_spg_select_estprog2($as_codemp,$as_codestpro1,$as_codestpro2);
  $lb_valido = false;
  if (($lb_existe) && (!$lb_tiene))
     {
	   $ls_sql  = "DELETE FROM spg_ep2 WHERE codemp='".$as_codemp."' AND codestpro1='".$as_codestpro1."' AND codestpro2='".$as_codestpro2."'";
	   $rs_data = $this->io_sql->execute($ls_sql);
	   if ($rs_data===false)
	      {
		    $lb_valido = false;
			$this->is_msg->message("CLASE->tepuy_SPG_C_ESTPROG2; METODO->uf_delete_estpro2; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
		  }
	   else
	      {
			 /////////////////////////////////         SEGURIDAD               /////////////////////////////		
...
function uf_check_relaciones($as_codemp,$as_codestpro1,$as_codestpro2)
{
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  if ($rs_data===false)
	  {
		$lb_valido=false;
        $this->io_msg->message("CLASE->tepuy_SPG_C_ESTPROG2; METODO->uf_check_relaciones; ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));
	  }
	else
	  {
		if ($row=$this->io_sql->fetch_row($rs_data))
		   ...
		   {
			 $ls_sql = "SELECT codestpro2 FROM spg_ep3 WHERE codemp='".$as_codemp."' AND codestpro1='".$as_codestpro1."' AND codestpro2='".$as_codestpro2."'";
			 $rs_data = $this->io_sql->select($ls_sql);
             if ($rs_data===false)
	            {
		          $lb_valido=false;
