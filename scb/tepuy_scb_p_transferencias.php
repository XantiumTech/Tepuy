...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_p_transferencias.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<?php
	...
	require_once("tepuy_scb_c_transferencias.php");
	...
	$in_classtrans=new tepuy_scb_c_transferencias($la_seguridad);
	...
	{			
		...
		$lb_valido=$in_classtrans->uf_procesar_transferencia($arr_data,$arr_datadestino);
...
?>
  ...
  <table width="722" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr class="titulo-ventana">
      <td height="22" colspan="4">Transferencias bancarias</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="3"><div align="left">
          <input name="txtconcepto" type="text" id="txtconcepto" value="<?php print $ls_desmov;?>" size="108">
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
	 ...
	 <a href="javascript:uf_cat_deducciones();"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo de deducciones" width="15" height="15" border="0"></a>	  <?php
		}
	  ?>	
      </div></td>
      <td><div align="right">Via Web</div></td>
      <td><div align="left">
        <input name="chkestinternet" type="checkbox" id="chkestinternet" value="1" onClick="javascript:uf_checkinternet();"  <?php print $lb_chkinternet; ?> style="width:15px; height:15px">
      </div></td>
    </tr>
    <tr>
      <td height="22">&nbsp;</td>
    ...
    <tr>
      ...
      <td width="189"><div align="left">
          <input name="txtdocorigen" type="text" id="txtdocorigen" style="text-align:center" onBlur="rellenar( this,15)" value="<?php print $ls_docorigen;?>" size="24">
      </div></td>
    ...
    <tr>
      ...
      <td><div align="left"><select name="cmboperacionorigen" id="cmboperacionorigen" style="width:110px;text-align:center" onChange="javascript:uf_verificar_operacion();">
    ...
    <tr>
      ...
      <td><div align="left">
          <input name="txtdocdestino" type="text" id="txtdocdestino" style="text-align:center" onBlur="rellenar(this,15)" value="<?php print $ls_docdestino;?>" size="24">
      </div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td colspan="3"><div align="left">
          ...
          <a href="javascript:cat_bancosdestino();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Bancos"></a>
    ...
    <tr>
      ...
      <td colspan="3"><div align="left">
          ...
          <a href="javascript:catalogo_cuentabancodestino();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Cuentas Bancarias"></a>
    ...
    <tr>
      ...
      <td><div align="left">
          ...
          <input name="operaciondestino" type="text" id="operaciondestino" value="<?php print $ls_destino?>" readonly>
</div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
...
f.action="tepuy_scb_p_transferencias.php";
f.submit();
}
