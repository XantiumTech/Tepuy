...
<script>
	...
	var loadDataURL = "../../php/tepuy_srh_a_requisitos_concurso.php?valor=createXML";
	var actionURL = "../../php/tepuy_srh_a_requisitos_concurso.php";
...
//initialise (from xml) and populate (from xml) grid
	...
	function Buscar()
	{
	   ...
	   divResultado = document.getElementById('mostrar');
	   divResultado.innerHTML= img;
	   mygrid.loadXML("../../php/tepuy_srh_a_requisitos_concurso.php?valor=buscar"+"&txtcodcon="+codcon+"&txtdescon="+descon);
	   setTimeout (terminar_buscar,500);
	...
	function aceptar(ls_codcon,ls_descon,ls_coddestino,ls_dendestino,ls_reqindcon,ls_reqindcondestino)
	{
		   ...
		   else
		   {
			...
			opener.document.form1.action="../pantallas/tepuy_srh_d_requisitos_concurso.php";
