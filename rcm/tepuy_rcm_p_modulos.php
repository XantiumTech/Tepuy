<?php
	...
	$io_fun_rcm->uf_load_seguridad("RCM","tepuy_rcm_p_modulos.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
   //--------------------------------------------------------------
	...
	switch ($ls_operacion)
	{
		case"PROCESAR":
			...
			if(!empty($ls_codsis))
			{
				...
				require_once("class_folder/tepuy_rcm_c_".$ls_codsisaux.".php");
				switch ($ls_codsis)
				{
					case"SCV":
						$io_rcm= new tepuy_rcm_c_scv();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"CXP":
						$io_rcm= new tepuy_rcm_c_cxp();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"SOC":
						$io_rcm= new tepuy_rcm_c_soc();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"SNO":
						$io_rcm= new tepuy_rcm_c_sno();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"HIST":
						$io_rcm= new tepuy_rcm_c_hist();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"SCG":
						$io_rcm= new tepuy_rcm_c_scg();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"RPC":
						$io_rcm= new tepuy_rcm_c_rpc();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"SIV":
						$io_rcm= new tepuy_rcm_c_siv();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"SAF":
						$io_rcm= new tepuy_rcm_c_saf();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"CFG":
						$io_rcm= new tepuy_rcm_c_cfg();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"SEP":
						$io_rcm= new tepuy_rcm_c_sep();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"SCB":
						$io_rcm= new tepuy_rcm_c_scb();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"SPG":
						$io_rcm= new tepuy_rcm_c_spg();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
					case"SPI":
						$io_rcm= new tepuy_rcm_c_spi();
						$lb_valido=$io_rcm->uf_convertir_data($la_seguridad);
					break;
				}
			}		
...
<table width="800" border="0" align="center" cellpadding="1" cellspacing="0" class="contorno">
  ...
  <tr>
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_nuevo();"></a><a href="javascript:ue_cerrar();"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/ayuda.png" alt="Ayuda" width="20" height="20"></td>
  </tr>
</table>
<p>&nbsp;</p>
...
<?php
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	$io_fun_rcm->uf_print_permisos($ls_permisos,$la_permisos,$ls_logusr,"location.href='../tepuy_menu.php'");
	unset($io_fun_rcm);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
        ...
        <tr>
          <td><table width="539" height="310" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
            ...
            <tr>
              ...
              <td width="86" height="22"><a href="javascript:ue_procesar('CFG');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir CFG"></a><?php if($lb_procfg){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('SCG');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir SCG"></a><?php if($lb_proscg){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('SPI');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir SPI"></a><?php if($lb_prospi){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('SPG');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir SPG"></a><?php if($lb_prospg){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('RPC');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir RPC"></a><?php if($lb_prorcp){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('SEP');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir SEP"></a><?php if($lb_prosep){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('SOC');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir SOC"></a><?php if($lb_prosoc){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('SIV');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir SIV"></a><?php if($lb_prosiv){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('CXP');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir CXP"></a><?php if($lb_procxp){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('SCB');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir SCB"></a><?php if($lb_proscb){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('SAF');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir SAF"></a><?php if($lb_prosaf){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('SCV');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir SCV"></a><?php if($lb_proscv){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('SNO');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir SNO"><?php if($lb_prosno){?></a><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
            <tr>
              ...
              <td height="22"><a href="javascript:ue_procesar('HIST');"><img src="tools20/calcular.png" width="30" height="30" border="0" title="Reconvertir HISTORICOS"></a><?php if($lb_prohist){?><img src="tools20/aprobado.png" width="20" height="20" title="Exitoso"><?php }?></td>
            </tr>
...
function ue_procesar(ls_codsis)
{
	...
	f.action="tepuy_rcm_p_modulos.php";
    f.submit();     
}
function ue_cerrar()
{
	location.href = "../tepuy_menu.php";
}
</script>
</html>
