<?php
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_scg->uf_load_seguridad_reporte("SCG","tepuy_scg_r_comparados_oaf.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	{
		case "0":
			require_once("tepuy_scg_class_oaf.php");
			$io_report  = new tepuy_scg_class_oaf();
			$ls_bolivares ="Bolivares";
			break;

		case "1":
			require_once("tepuy_scg_class_oafbsf.php");
			$io_report  = new tepuy_scg_class_oafbsf();
