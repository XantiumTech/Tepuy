<?php
	...
	switch($ls_proceso)
	{
		...
		case "CAUSA":
			...
			// aqui se esta ajustando //
			//print "general: ".$li_totgeneral;
	...
	{	
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp, $io_ds_scgcuentas, $io_ds_spgcuentas;
		// Recorrido del Grid de Cuentas Presupuestarias
		//print "total partidas: ".$ai_totrowspg;
	...
	{	
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		global $io_funciones_cxp, $io_ds_scgcuentas;
	...
	{	
		...
		for($li_fila=1;($li_fila<=$li_totrow)&&($lb_valido);$li_fila++)
		{
			...
			$ls_cargo=trim($io_recepcion->io_ds_compromisos->data["cargo"][$li_fila]);
			...
			$ls_programatica="";
			$li_monto_anterior=0;
			$lb_valido=$io_recepcion->uf_load_monto_causado_anterior($ls_nrocomp,$ls_procede,$ls_cuenta,$ls_codpro,&$li_monto_anterior);
			if($lb_valido)
			{
	...
	{	
		...
		$io_ds_cargos->group_by(array('0'=>'nrocomp','1'=>'codpro','2'=>'cuenta','3'=>'codfuefin'),array('0'=>'monimp'),'monimp');
	...
	{	
		...
		$io_ds_cargos->reset_ds();
		$io_ds_aux->reset_ds();
		//print "total cargos: ".$ai_totrowcargos;
		...
		$io_ds_aux->group_by(array('0'=>'nrocomp','1'=>'codpro','2'=>'cuenta','3'=>'codfuefin'),array('0'=>'monimp'),'monimp');
	...
	{	
		...
		$lo_title[2]=utf8_encode("Código Programático");
		$lo_title[3]=utf8_encode("Código Estadístico");
		$lo_title[4]="Monto"; 
		$lo_title[5]=" "; 
		$io_ds_spgcuentas->group_by(array('0'=>'spgnrocomp','1'=>'codpro','2'=>'spgcuenta','3'=>'codfuefin'),array('0'=>'spgmonto'),array('0'=>'spgnrocomp','1'=>'codpro','2'=>'spgcuenta','3'=>'codfuefin'));
		$li_totrow=$io_ds_spgcuentas->getRowCount('spgcuenta');
		//$li_totrow=2;
		//print "total x".$li_totrow;
		//print "presp.:".$as_estpresupuestario;
		for($li_fila=1;$li_fila<=$li_totrow;$li_fila++)
		{
			...
			if($ls_cargo=="0")
			{
				...
				{
					case 1: // Causa
						$ls_eliminar="<a href=javascript:ue_delete_compromiso('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";			
						$ls_readonly="";
					break;
					
					case 2: // compromete y Causa
						$ls_eliminar="<a href=javascript:ue_delete_spg_cuenta('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";			
					break;
				}
			}
			...
			$lo_object[$li_fila][3]="<input name=txtspgcuenta".$li_fila."     type=text id=txtspgcuenta".$li_fila."    class=sin-borde  style=text-align:center size=25 value='".$ls_cuenta."' readonly>";
			$lo_object[$li_fila][4]="<input name=txtspgmonto".$li_fila."      type=text id=txtspgmonto".$li_fila."     class=sin-borde  style=text-align:right  size=25 onKeyPress=return(ue_formatonumero(this,'.',',',event)); onBlur=ue_procesar_comprobante('".$li_fila."'); value='".$li_moncue."' ".$ls_readonly.">";
		...
		$lo_object[$ai_totrowspg][3]="<input name=txtspgcuenta".$ai_totrowspg."     type=text id=txtspgcuenta".$ai_totrowspg."    class=sin-borde  style=text-align:center size=25 value='' readonly>";
		$lo_object[$ai_totrowspg][4]="<input name=txtspgmonto".$ai_totrowspg."      type=text id=txtspgmonto".$ai_totrowspg."     class=sin-borde  style=text-align:right  size=25 value='' readonly>";
		$lo_object[$ai_totrowspg][5]="".
		...
		print "  <table width='785' border='0' align='center' cellpadding='0' cellspacing='0' class='celdas-blancas'>";
		print "    <tr>";
		switch ($as_estpresupuestario)
		{
			case 1: // Causa  Busca de un compromiso
				print "<td  align='left'><a href='javascript:ue_catalogo_compromisos();'><img src='../shared/imagebank/tools/nuevo.png' width='20' height='20' border='0' title='Agregar Compromisos'>Agregar Compromisos</a>&nbsp;&nbsp;</td>";
			break;
			
			case 2: // compromete y Causa  // permite ingresar directamente las cuentas presupuestarias
				print "<td  align='left'><a href='javascript:ue_catalogo_cuentas_spg();'><img src='../shared/imagebank/tools/nuevo.png' width='20' height='20' border='0' title='Agregar Cuenta'>Agregar Cuenta Presupuestaria</a>&nbsp;&nbsp;</td>";
			break;
		}
		print "    </tr>";
		print "  </table>";
		//$ai_totrowspg=$ai_totrowspg+1;
		$io_grid->makegrid($ai_totrowspg,$lo_title,$lo_object,785,"Cuentas Presupuestarias ","gridcuentas");
	...
	{	
		...
		// Titulos el Grid
		$lo_title[1]="Nro. Compromiso";
		$lo_title[2]=utf8_encode("Código Contable");
		$lo_title[3]="Debe";
		$lo_title[4]="Haber"; 
		$lo_title[5]=" "; 
		$li_total=0;
			...
			if(array_key_exists("cargos",$_SESSION))
			{
				...
				if($li_cerrarasiento)
				{
					...
					for($li_i=1;$li_i<=$li_totrow;$li_i++)
					{
						...
						$ls_sccuenta=$io_ds_cargos->getValue("cuenta",$li_i);			
		...
		for($li_fila=1;$li_fila<=$li_totrow;$li_fila++)
		{
			$ls_nrocomp=$io_ds_scgcuentas->getValue("scgnrocomp",$li_fila);
			$ls_cuenta=$io_ds_scgcuentas->getValue("scgcuenta",$li_fila);
			...
			if((($ls_estatus=="M")&&($ai_generarcontable=="0"))||($li_cerrarasiento=="1"))
			{
				if($ls_estatus=="M")
				{
					$ls_eliminar="<a href=javascript:ue_delete_scg_cuenta('".$li_fila."');><img src=../shared/imagebank/tools15/eliminar.png title=Eliminar width=15 height=10 border=0></a>";			
				}
			}
			$lo_object[$li_fila][1]="<input name=txtscgnrocomp".$li_fila."    type=text id=txtscgnrocomp".$li_fila." class=".$ls_formato." style=text-align:center size=20 value='".$ls_nrocomp."' readonly>";
			$lo_object[$li_fila][2]="<input name=txtscgcuenta".$li_fila."     type=text id=txtscgcuenta".$li_fila."  class=".$ls_formato." style=text-align:center size=40 value='".$ls_cuenta."'  readonly>";
		...
		if(($ai_generarcontable=="1")&&($li_totrow>0))
		{
			...
			$lo_object[$li_fila][1]="<input name=txtscgnrocomp".$li_fila."    type=text id=txtscgnrocomp".$li_fila." class=celdas-azules style=text-align:center size=20 value='".$ls_numrecdoc."' readonly>";
			$lo_object[$li_fila][2]="<input name=txtscgcuenta".$li_fila."     type=text id=txtscgcuenta".$li_fila."  class=celdas-azules style=text-align:center size=40 value='".$ls_sccuentaprov."'  readonly>";
			$lo_object[$li_fila][3]="<input name=txtmondeb".$li_fila."        type=text id=txtmondeb".$li_fila."     class=celdas-azules style=text-align:right size=25 value=''   readonly>";
			$lo_object[$li_fila][4]="<input name=txtmonhab".$li_fila."        type=text id=txtmonhab".$li_fila."     class=celdas-azules style=text-align:right size=25 value='".$li_total."'   readonly>";
			$lo_object[$li_fila][5]="".
		...
		$lo_object[$ai_totrowscg][1]="<input name=txtscgnrocomp".$ai_totrowscg."    type=text id=txtscgnrocomp".$ai_totrowscg." class=sin-borde style=text-align:center size=20 value='' readonly>";
		$lo_object[$ai_totrowscg][2]="<input name=txtscgcuenta".$ai_totrowscg."     type=text id=txtscgcuenta".$ai_totrowscg."  class=sin-borde style=text-align:center size=40 value=''  readonly>";
		$lo_object[$ai_totrowscg][3]="<input name=txtmondeb".$ai_totrowscg."        type=text id=txtmondeb".$ai_totrowscg."     class=sin-borde style=text-align:right size=25 value=''   readonly>";
		$lo_object[$ai_totrowscg][4]="<input name=txtmonhab".$ai_totrowscg."        type=text id=txtmonhab".$ai_totrowscg."     class=sin-borde style=text-align:right size=25 value=''   readonly>";
		...
		{// si los asientos contables se generan automáticamente y la recepcion tiene afectación contable
			print "  <table width='785' border='0' align='center' cellpadding='0' cellspacing='0' class='celdas-blancas'>";
			print "    <tr>";
			print "		<td  align='left'><a href='javascript:ue_catalogo_cuentas_scg();'><img src='../shared/imagebank/tools/nuevo.png' width='20' height='20' border='0' title='Agregar Cuenta'>Agregar Cuenta Contable</a>&nbsp;&nbsp;</td>";
			print "    </tr>";
			print "  </table>";
		...
		$io_grid->makegrid($ai_totrowscg,$lo_title,$lo_object,785,"Cuentas Contable","gridcuentas");		
...
//		print "          	<input name='btnotroscreditos' type='button' class='boton' id='btnotroscreditos' value='Otros Cr&eacute;ditos' onClick='ue_catalogocreditos();'> ";
		print "          	<input name='btnotroscreditos' type='button' class='boton' id='btnotroscreditos' value='I.V.A.' onClick='ue_catalogocreditos();'> ";
		print "          </td>";
		...
		print "          <td height='22'>&nbsp;</td>";
		print "          <td height='22' align='right'>";
		print "          	<input name='btndeducciones' type='button' class='boton' id='btndeducciones' value='Retenciones' onClick='ue_catalogodeducciones();'> ";
		print "			 </td>";
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_load_cuentas_presupuesto($as_numrecdoc,$as_codtipdoc,$as_cedbene,$a_codpro,$as_estcontable,$as_estpresupuestario)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		require_once("tepuy_cxp_c_recepcion.php");
		$io_recepcion=new tepuy_cxp_c_recepcion("../../");
		$rs_data = $io_recepcion->uf_load_spgcuentas($as_numrecdoc,$as_codtipdoc,$as_cedbene,$a_codpro);
		$li_fila=0;
	//print "aqui";
		while($row=$io_recepcion->io_sql->fetch_row($rs_data))	  
		{
			$li_fila=$li_fila+1;
			$ls_nrocomp=$row["numdoccom"];
			$ls_codpro=$row["codestpro"];
			...
			if($ls_cuenta!="")
			{
				...
				$lo_object[$li_fila][2]="<input name=txtprogramatica".$li_fila."  type=text id=txtprogramatica".$li_fila." class=sin-borde  style=text-align:center size=45 value='".$ls_programatica."' readonly>";
				$lo_object[$li_fila][3]="<input name=txtspgcuenta".$li_fila."     type=text id=txtspgcuenta".$li_fila."    class=sin-borde  style=text-align:center size=25 value='".$ls_cuenta."' readonly>";
				$lo_object[$li_fila][4]="<input name=txtspgmonto".$li_fila."      type=text id=txtspgmonto".$li_fila."     class=sin-borde  style=text-align:right  size=25 onKeyPress=return(ue_formatonumero(this,'.',',',event)); value='".$li_moncue."' >";
				$lo_object[$li_fila][5]=$ls_eliminar.
										"<input name=txtcodpro".$li_fila."        type=hidden id=txtcodpro".$li_fila."      value='".$ls_codpro."'>".
										"<input name=txtcargo".$li_fila."         type=hidden id=txtcargo".$li_fila."       value='".$ls_cargo."'>".
										"<input name=txtoriginal".$li_fila."      type=hidden id=txtoriginal".$li_fila."    value='".$li_original."'>".
		...
		$lo_object[$li_fila][3]="<input name=txtspgcuenta".$li_fila."     type=text id=txtspgcuenta".$li_fila."    class=sin-borde  style=text-align:center size=25 value='' readonly>";
		$lo_object[$li_fila][4]="<input name=txtspgmonto".$li_fila."      type=text id=txtspgmonto".$li_fila."     class=sin-borde  style=text-align:right  size=25 value='' readonly>";
		$lo_object[$li_fila][5]="".
		...
		print "    </tr>";
		print "  </table>";
		$io_grid->makegrid($li_fila,$lo_title,$lo_object,785,"Cuentas Presupuestarias","gridcuentas");
		unset($rs_data);
		unset($io_recepcion);
	...
	{	
		...
		$li_fila=$li_fila+1;
		$lo_object[$li_fila][1]="<input name=txtscgnrocomp".$li_fila."    type=text id=txtscgnrocomp".$li_fila." class=sin-borde style=text-align:center size=20 value='' readonly>";
		$lo_object[$li_fila][2]="<input name=txtscgcuenta".$li_fila."     type=text id=txtscgcuenta".$li_fila."  class=sin-borde style=text-align:center size=40 value=''  readonly>";
		$lo_object[$li_fila][3]="<input name=txtmondeb".$li_fila."        type=text id=txtmondeb".$li_fila."     class=sin-borde style=text-align:right size=25 value=''   readonly>";
		$lo_object[$li_fila][4]="<input name=txtmonhab".$li_fila."        type=text id=txtmonhab".$li_fila."     class=sin-borde style=text-align:right size=25 value=''   readonly>";
		$lo_object[$li_fila][5]=" ".
		...
		$io_grid->makegrid($li_fila,$lo_title,$lo_object,785,"Cuentas Contable","gridcuentas");
		print "<table width='700' border='0' align='center' cellpadding='0' cellspacing='0' class='celdas-blancas'>";
		print "        <tr>";
		print $ls_boton;
		print "          <td width='175' height='22' align='right'><div align='right'><strong>Total Debe</strong></div></td>";
