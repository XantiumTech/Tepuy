<?php
class tepuy_c_check_relaciones
{
var $ls_sql;
var $is_msg_error;
var $ls_database;
...
function tepuy_c_check_relaciones($conn)
{
        ...
        while ($row=$this->io_sql->fetch_row($rs_data))	 
	          {
				...
				$rs_codemp      = $this->uf_select_table_names("AND table_name='$ls_table_name' AND column_name='codemp' ",$as_tabla_maestro,$lb_valido);//Verificamos que la tabla posea el código de la empresa.
