<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","tepuy_scg_r_comparados_est_resultado.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	{	
		...
		if(txtetiqueta=="Mensual")
		{
			...
			else
			{
				...
				{
				   pagina="reportes/tepuy_scg_rpp_comparado_est_resultado.php?combo="+combo
		...
		else
		{
			...
			{
			   pagina="reportes/tepuy_scg_rpp_comparado_est_resultado.php?combo="+combo+"&txtetiqueta="+txtetiqueta+"&tiporeporte="+tiporeporte;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
   	}
