...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_instructivo_estado_resultado_programatica.php";
...
function ue_showouput()
{
	...
	else
	{
		...
		pagina="reportes/tepuy_spg_rpp_instructivo_estado_resultado.php?trimestre="+trimestre;
