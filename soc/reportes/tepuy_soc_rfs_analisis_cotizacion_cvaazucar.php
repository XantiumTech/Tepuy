<?PHP
	...
	function uf_print_encabezado_pagina($as_numanacot,$observacion,$ad_fecha,&$io_pdf)
	{
		...
		// Fecha Creación: 17/06/2007                   Fecha Creación: 11/03/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],25,535,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
		$io_pdf->addJpegFromFile('../../shared/imagebank/LOGO CVA1.jpg',25,530,90,50); // Agregar Logo cvazucar
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_cva.jpg',670,530,100,60); // Agregar Logo  
		$io_pdf->Rectangle(25,500,740,90);
		$io_pdf->add_texto(120,17,14,"<b>Análisis de Precios</b>");	
	    $io_pdf->line(25,515,765,515);
		$io_pdf->addText(28,505,9,"<b>NUMERO DE REQUISICIÓN:</b> ");
		$io_pdf->addText(150,505,9,"$as_numanacot");
		$io_pdf->addText(250,505,9,"<b>UNIDAD SOLICITANTE:</b> ");
		$io_pdf->addText(520,505,9,"<b>FECHA:</b>");
		$io_pdf->addText(560,505,9,"$ad_fecha");
		$io_pdf->addText(650,505,9,"<b>FECHA AP:</b> ");
		$io_pdf->ezSetDy(-20);	
	...
	//------------------------------------------------------------------------------------------------------------------------------------
	//------------------------------------------------------------------------------------------------------------------------------------
	function uf_print_pie_pagina($io_pdf,$ls_observacion)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$io_pdf->Rectangle(20,110,740,20);   // primer rectángulo inferior
		$io_pdf->addText(22,145,9,"<b>OBSERVACIONES: </b>"); 
		$io_pdf->addText(110,145,10,$ls_observacion); 
		$io_pdf->Rectangle(20,50,740,105); // cuadro de las firmas y observación
        $io_pdf->addText(115,120,9,"<b>REALIZADO POR:</b>"); 
		$io_pdf->addText(110,65,8,"<b>LIC. ANTONIO FLORES</b>");
		$io_pdf->addText(130,55,8,"<b>LICENCIADO I</b>");
		$io_pdf->line(280,49,280,130);  // LINEA VERTICAL
        $io_pdf->addText(355,120,9,"<b>REALIZADO POR:</b>"); 
		$io_pdf->addText(345,65,8,"<b>LIC. DALIANNY HERNANDEZ</b>");
		$io_pdf->addText(340,55,8,"<b>COORDINADORA DE COMPRAS</b>");
        $io_pdf->line(530,49,530,130);  // LINEA VERTICAL
		$io_pdf->addText(605,120,9,"<b>REALIZADO POR:</b>");
		$io_pdf->addText(595,65,8,"<b>LIC. VIVIANA CASTELLANOS</b>");
		$io_pdf->addText(560,55,8,"<b>GERENTE DE ADMINISTRACIÓN Y FINANZAS</b>");
	...
	if($lb_valido)
	{
		...
		if($lb_valido)
		{
			...
			if($lb_valido)
			{
				...
				uf_print_pie_pagina($io_pdf,$ls_observacion);
				$io_pdf->ezStream();
				unset($io_pdf);
			}
		}
