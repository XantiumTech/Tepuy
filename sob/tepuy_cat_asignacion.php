...
if((!array_key_exists("ls_database",$_SESSION))||(!array_key_exists("ls_hostname",$_SESSION))||(!array_key_exists("ls_gestor",$_SESSION))||(!array_key_exists("ls_login",$_SESSION)))
{
	...
	print "opener.location.href='../tepuy_menu.php';";
	print "close();";
	print "</script>";		
} 
...
<html>
<head>
<title>Cat&aacute;logo de Obras Asignaciones</title>
  ...
  <p align="center">
    ...
    <input name="hidorigen" type="hidden" id="hidorigen" value="<?php print $ls_origen ?>">
  	 ...
  	 <table width="800" border="0" align="center" cellpadding="1" cellspacing="1">
    	<tr>
     	 	<td width="800" colspan="2" class="titulo-celda">Cat&aacute;logo Obras Asignaciones</td>
    	</tr>
	 </table>
	 <br>
...
if($ls_operacion=="BUSCAR")
{
	...
	$ls_straux="AND a.estspgscg ='1'";
		...
		$ls_sql="SELECT a.codasi,a.codobr,a.cod_pro,a.cod_pro_ins,a.puncueasi,a.fecasi,a.obsasi,a.monparasi,
	     		a.basimpasi,a.montotasi,a.estasi,o.desobr,p.nompro,o.feciniobr,o.fecfinobr
	...
	}else
	{
		if($row=$io_sql->fetch_row($rs_data))
		{
			...
			for($li_z=1;$li_z<=$li_totrow;$li_z++)
			{
				...
				$ls_feciniobr=$data["feciniobr"][$li_z];
				$ls_fecfinobr=$data["fecfinobr"][$li_z];
				...
				switch($ls_origen)
				{
					case"DC":
						...
						'$ls_monparasi','$ls_basimpasi','$ls_montotasi','$ls_estasi','$ls_desobr','$ls_nompro','$ls_fecasi','$ls_feciniobr','$ls_fecfinobr');\">".$ls_codasi."</a></td>";
...
function aceptar(ls_codasi,ls_codobr,ls_codpro,ls_codproins,ld_puncue,ls_obsasi,ls_monparasi,ls_basimpasi,ls_montotasi,ls_estasi,ls_desobr,ls_nompro,ls_fecasi)
  {
...
function aceptar_dc(ls_codasi,ls_codobr,ls_codpro,ls_codproins,ld_puncue,ls_obsasi,ls_monparasi,ls_basimpasi,ls_montotasi,ls_estasi,ls_desobr,ls_nompro,ls_fecasi,ls_feciniobr,ls_fecfinobr)
  //import java.text.DecimalFormat;
{
	//alert("aqui");
	opener.document.form1.hidfecasi.value=ls_fecasi;
	opener.document.form1.txtfecinicon.value=ls_feciniobr.substring(8, 2)+ls_feciniobr.substring(5, 5)+ls_feciniobr.substring(0, 4);
	opener.document.form1.txtfecfincon.value=ls_fecfinobr.substring(8, 2)+ls_fecfinobr.substring(5, 5)+ls_fecfinobr.substring(0, 4);
	
	//DecimalFormat formato = new DecimalFormat("#,###.00");
	opener.document.form1.txtmonto.value=formatoNumero(ls_montotasi, 2, ",", ".");//ls_montotasi;
	

	//opener.document.form1.operacion.value="ue_nuevo";
    opener.ue_cargarasignacion(ls_codasi,ls_codobr,ls_codpro,ls_codproins,ld_puncue,ls_obsasi,ls_monparasi,ls_basimpasi,ls_montotasi,ls_estasi,ls_desobr,ls_nompro,ls_fecasi);
	close();
  }
 ...
 function formatoNumero(numero, decimales, separadorDecimal, separadorMiles)
  ...
  f.action="tepuy_cat_asignacion.php";
  f.submit();
  }
</script>
