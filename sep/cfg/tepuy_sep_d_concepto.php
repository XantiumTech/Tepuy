...
require_once("tepuy_sep_c_concepto.php");
...
$io_con       = new tepuy_sep_c_concepto($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SEP";
	$ls_ventanas = "tepuy_sep_d_concepto.php";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
     ...
     if ($ls_operacion=="CARGAR")
        ...
        $ls_sql=" SELECT C.codconsep as codigo,C.codcar as codcar,S.dencar as dencar, S.porcar as porcar ".
                " FROM sep_conceptocargos C, tepuy_cargos S ".
        ...
        if ($row=$io_sql->fetch_row($rs))
	       {
			 ...
			 for ($i=1;$i<=$totrow;$i++)	   	   
                 {							                  
				   ...
				   $object[$li_row][4] = "<a href=javascript:uf_delete(".$li_row.");><img src=../../shared/imagebank/tools20/eliminar.png alt=Aceptar width=15 height=15 border=0></a>";
                 }           
           }
         else
         {
...
?>
      <p>&nbsp;</p>
      <table width="602" height="448" border="0" align="center"  cellpadding="0" cellspacing="0" class="formato-blanco">
	  <tr>
          <td width="572" height="446"><div align="center">
            <table width="544" height="22"  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              <tr>
                <td height="22" colspan="2" class="titulo-ventana">Conceptos&nbsp;</td>
              </tr>
              <tr>
                <td height="22" >&nbsp;</td>
                <td width="370" height="22" ><input name="hidestatus" type="hidden" id="hidestatus" value="<?php print $ls_estatus ?>"></td>
              </tr>
              <tr>
...
function catalogo_cuentas()
{
	f=document.form1;
	f.operacion.value="";			
	pagina="tepuy_sep_cat_ctasspg.php";
...
function ue_nuevo()
{
	...
	if (li_incluir==1)
	   {	
		 ...
		 f.action="tepuy_sep_d_concepto.php";
		 f.submit();
	   }
	else
	   {
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
	     pagina="tepuy_sep_cat_concepto.php";
