<?Php
	...
	$oi_fun_integrador->uf_load_seguridad("SCB","tepuy_mis_p_reverso_scb.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
   ...
   function uf_limpiarvariables()
   {
		...
		// Fecha Creación: 21/08/2012 								Fecha Última Modificación : 
		//////////////////////////////////////////////////////////////////////////////
   		global $ldt_fecha,$ls_mes,$ls_operacion,$lo_title,$li_totrows,$oi_fun_integrador,$li_widthtable,$ls_titletable,$ls_nametable;
		...
		$la_text=array("Nota Débito","Nota Crédito","Cheque","Depósito","Retiro","Pago por Transferencias");
		$ls_numdoc="";
		$ls_fecdoc="";
		$ls_tipo_operacion="";
        $lo_title[1]="";
   ...
   function uf_load_variables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		global $ls_numdoc,$ls_mes,$ls_fecdoc,$ls_tipo_operacion;
...
<?php
	...
	switch ($ls_operacion) 
	{
		...
		case "BUSCAR":
			uf_load_variables();
	    	$in_class_contabiliza->uf_select_banco_contabilizar($ls_numdoc,$ls_fecdoc,$ls_tipo_operacion,$lo_object,$li_totrows,"C",0,$ls_mes);
			if($li_totrows==0)
			{
				$li_totrows=1;
				uf_agregarlineablanca($lo_object,$li_totrows);
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td width="432" height="20" colspan="11" bgcolor="#E7E7E7"><table width="762" border="0" align="center" cellpadding="0" cellspacing="0">
      <td width="432" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Caja y Banco -><i>Reverso de Movimientos Bancarios</i></td>
...
function ue_procesar()
{
	...
	if(li_ejecutar==1)
	{
		...
		if(lb_valido)
		{
			...
			f.action="tepuy_mis_p_reverso_scb.php";
			f.submit();
		}
		else
		{
