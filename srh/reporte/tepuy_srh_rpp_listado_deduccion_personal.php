...
//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_srh->uf_load_seguridad_reporte("SRH","tepuy_srh_r_listado_deducciones_personal.php",$ls_descripcion);
		return $lb_valido;
	}
...
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	require_once("class_folder/tepuy_srh_class_report.php");
	$io_report=new tepuy_srh_class_report();
						   ...
						   if (($ls_sueldoper >= $ls_sueldo)&&($ls_edadper >= $ls_edadmin)&&($ls_edadper <= $ls_edadmax)&&($ls_sexper==$ls_sexo)&& ($ls_hcm==$ls_hcmper))
							 ...
							 {					  
								   ...
								   $la_data[$li_i]=array('coddeduc'=>$ls_codtipded,'dendeduc'=>$ls_dentipded,
						 						'valor'=>number_format($li_prima,2,",","."), 'aporemple'=>number_format($ls_valor_emple,2,",","."), 
			 ...
			 $lb_valido=$io_report->uf_select_deduccion_personal_familiar($ls_codper, $rs_data3);
					 ...
					 if ($lb_valido)
					 {
						...
						{ 
						  ...
						  if ($ls_hcm!="")
						  {	
							if (($ls_sueldoper>=$ls_sueldobene)&&($edad_familiar>=$ls_edadmin)&&($edad_familiar<=$ls_edadmax)&&($ls_sexoben==$sexo_familiar)&&($ls_nexo==$nexo_familiar)&&($ls_sexoben==$sexo_familiar)&&($ls_hcm==$hcm_familiar))
							{
								   ...
								   $la_data[$li_i]=array('coddeduc'=>$ls_codtipded2,'dendeduc'=>$ls_dentipded2,
						 						'valor'=>number_format($ls_valorprima,2,",","."), 'aporemple'=>number_format($ls_valor_emple,2,",","."), 
				                                 'aporempre'=>number_format($ls_valor_empre,2,",","."));
									$li_i++;
									$suma_total_emple= $suma_total_emple + $ls_valor_emple;
									$suma_total_empre= $suma_total_empre + $ls_valor_empre;
						   ...
						   {
							 if (($ls_sueldoper>=$ls_sueldobene)&&($edad_familiar>=$ls_edadmin)&&($edad_familiar<=$ls_edadmax)&&($ls_sexoben==$sexo_familiar)&&($ls_nexo==$nexo_familiar)&&($ls_sexoben==$sexo_familiar))
							  {
