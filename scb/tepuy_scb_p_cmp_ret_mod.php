...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_p_cmp_ret_mod.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<?php
	...
	require_once("tepuy_scb_c_cmp_ret.php");
	$io_cmpret=new tepuy_scb_c_cmp_ret($la_seguridad);	
	...
	else//Caso de apertura de la pagina o carga inicial
	{
		...
		$object[$li_i][10]= "";			
		$object[$li_i][11]= "<img src=../shared/imagebank/tools15/eliminar.png alt='Eliminar Retención' width=15 height=15 border=0>";
  ...
  <table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td><?php $io_grid->makegrid($li_total,$titleProg,$object,770,'Documentos ',$gridProg);?>
		...
		<input name="estcmpret" id="estcmpret" value="<?php print $ls_estcmpret;?>" type="hidden"></td>
    </tr>
  </table>
  <p>&nbsp;</p>
  <p>
...
function ue_nuevo()
{
	...
	f.action="tepuy_scb_p_cmp_ret_mod.php";
	f.submit();
}
...
function ue_cerrar()
{
  ...
  {
  	  ls_pagina="tepuy_scb_edit_cmp_ret.php?numcom="+ls_numcom+"&codret="+ls_codret+"&numope="+ls_numope+"&numfac="+ls_numfac+"&opener=tepuy_scb_edit_cmp_ret.php";
