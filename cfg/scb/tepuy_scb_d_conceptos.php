...
require_once("tepuy_scb_c_conceptos.php");
...
function ue_nuevo()
{
	...
	if (li_incluir==1)
	   {	
         ...
         f.action="tepuy_scb_d_conceptos.php";
		 f.submit();
	   }
	else
	   {
...
function ue_buscar()
{
	...
	if (li_leer==1)
       {
	     window.open("tepuy_scb_cat_conceptos.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
       }
	else
	   {
