...
require_once("class_folder/tepuy_rpc_c_tipoorg.php");
...
$io_tipoorg= new tepuy_rpc_c_tipoorg($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="RPC";
	$ls_ventanas="tepuy_rpc_d_tipoempresa.php";
        ...
        <td width="542" height="170"><div align="center">
          <table  border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
            ...
            <tr>
              ...
              <td height="22"><input name="txtdenominacion" id="txtdenominacion3" value="<?php print $ls_dentipoorg ?>" type="text" size="60" maxlength="40"  onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+'.,-'); "></td>
            </tr>
            <tr>
              <td height="22">&nbsp;</td>
              <td height="22">&nbsp;</td>
...
function ue_nuevo()
{
	...
	{		  
	   ...
	   f.action="tepuy_rpc_d_tipoempresa.php";
	   f.submit();
	}
	else
	{
...
function ue_buscar()
{
	...
	{
		f.operacion.value="";			
		pagina="tepuy_rpc_cat_tipoempresa.php";
