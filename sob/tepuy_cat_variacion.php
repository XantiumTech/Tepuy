	...
	else
	{
		if($row=$io_sql->fetch_row($rs_data))
		{
			...
			for($li_z=1;$li_z<=$li_totrow;$li_z++)
			{
				...
				print "<td><a href=\"javascript: aceptar('$ls_codvar','$ls_codcon','$ls_tipvar','$ls_motvar','$ls_fecha','$ls_monto','$ls_monco','$ls_nomestval','$ls_codasi');\">".$ls_codcon."</a></td>";
...
function aceptar(ls_codvar,ls_codcon,ls_tipvar,ls_motvar,ls_fecha,ls_monto,ls_monco,ls_nomestval,ls_codasi)
  {
    opener.ue_cargarvariacion(ls_codvar,ls_codcon,ls_tipvar,ls_motvar,ls_fecha,ls_monto,ls_monco,ls_nomestval,ls_codasi);
	close();
  }
  ...
  f.action="tepuy_cat_variacion.php";
  f.submit();
  }
</script>
