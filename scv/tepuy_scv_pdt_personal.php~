...
<form name="form1" method="post" action="">
  <table width="555" border="0" align="center" class="formato-blanco">
    ...
    <tr>
      <td height="22" align="right">Sueldo</td>
      <td height="22" colspan="3" align="left">
        <input name="txtcodclavia" type="text" id="txtcodclavia" size="15" readonly>
      </td>
    </tr>
    <tr>
...
function ue_beneficiarios()
{
	...
	window.open("tepuy_scv_cat_beneficiarios.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
}
...
function ue_personal()
{
	...
	f.txtcarper.value="";
	f.txtcodclavia.value="";
	window.open("tepuy_scv_cat_personal.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
}
