...
require_once("class_folder/tepuy_cxp_c_doc.php");
...
$io_doc       = new tepuy_cxp_c_doc($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "CXP";
	$ls_ventanas = "tepuy_cxp_d_documentos.php";
  ...
  <tr>
    <td width="542" height="196"><div align="center">
      <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
        ...
        <tr>
          <td width="109" height="22" align="right">C&oacute;digo</td>
        ...
        <tr>
          ...
          <td width="226" height="22"><p align="left">
		...
		<tr>
          ...
          <td width="25" height="22"><input name="chktipodoc" type="checkbox" id="chktipodoc" value="1" <?php print $ls_anticipo ?>></td>
          <td width="160">Anticipo</td>
          <td height="22">&nbsp;</td>
        </tr>
        <tr>
          <td height="22">&nbsp;</td>
...
function ue_nuevo()
{
  ...
  if (li_incluir==1)
	 {	
	   ...
	   f.action="tepuy_cxp_d_documentos.php";
	   f.submit();
	}
  else
	{
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
	     f.operacion.value="";			
	     pagina="tepuy_cxp_cat_documentos.php";
