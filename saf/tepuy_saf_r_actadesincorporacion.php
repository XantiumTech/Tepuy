...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_actadesincorporacion.php",$ls_permisos,$la_seguridad,$la_permisos);
$ls_reporte=$io_fun_activo->uf_select_config("SAF","REPORTE","FORMATO_ACTADESINCORPORACION","tepuy_saf_rpp_acta_desincorporacion.php","C");
