<?php
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('programatica'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la 
						 			...
						 			//   'precomprometido'=>array('justification'=>'right','width'=>100), // Justificación 
									   ...
									   'porpagado'=>array('justification'=>'right','width'=>80),
									   'saldo'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la 
	...
	function uf_print_pie_cabecera($ad_total_asignado,$ad_total_precompromiso,$ad_total_compromiso,$ad_total_causado,
	                               $ad_total_pagado,$ad_total_saldo,&$io_pdf,$as_titulo)
	{
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$la_data[]=array('programatica'=>'','descripcion'=>'<b>'.$as_titulo.'</b>','asignado'=>$ad_total_asignado,
		       //          'precomprometido'=>$ad_total_precompromiso,'comprometido'=>$ad_total_compromiso,
		                 'comprometido'=>$ad_total_compromiso,'porcomprometido'=>'',
				 'causado'=>$ad_total_causado,'porcausado'=>'','pagado'=>$ad_total_pagado,'porpagado'=>'','saldo'=>$ad_total_saldo);
		...
		$la_columnas=array('programatica'=>' ','descripcion'=>'','asignado'=>'','comprometido'=>'',                           'porcomprometido'=>'','causado'=>'','porcausado'=>'','pagado'=>'','porpagado'=>'','saldo'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 8, // Tamaño de Letras
						 'titleFontSize' => 8,  // Tamaño de Letras de los títulos
						 'showLines'=>0, // Mostrar Líneas
						 ...
						 'cols'=>array('programatica'=>array('justification'=>'left','width'=>120), // Justificación y ancho de la 
						 			...
						 			//   'precomprometido'=>array('justification'=>'right','width'=>100), // Justificación 
						 			   ...
						 			   'porcausado'=>array('justification'=>'right','width'=>80), // Justificación y ancho  
						 			   'pagado'=>array('justification'=>'right','width'=>100), // Justificación y ancho  
									   'porpagado'=>array('justification'=>'right','width'=>80),// Justificación y ancho de l
									   'saldo'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de la 
		$io_pdf->ezTable($la_data,$la_columnas,'',$la_config);
	...
	//-----------------------------------------------------------------------------------------------------------------------------
		...
		if($ls_tipoformato==1)
		{
			require_once("tepuy_spg_reportes_class_bsf.php");
			$io_report = new tepuy_spg_reportes_class_bsf();
		}
		else
		{
			require_once("tepuy_spg_reportes_class.php");
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  --------------------------------------
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","tepuy_spg_r_ejecutado_por_partida.php",$ls_desc_event);
	////////////////////////////////         SEGURIDAD               ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Cargar el dts_cab con los datos de la cabecera del reporte( Selecciono todos comprobantes )	
	 ...
	 else // Imprimimos el reporte
	 {
		...
		$ld_total_pagado_general=0;		$ld_total_saldo_general=0;
		$ld_total_saldo=0;
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			if ($li_estmodest=='2')
		    	{
			   $ls_programatica=substr($ls_programatica,18,2).'-'.substr($ls_programatica,24,2).'-'.substr($ls_programatica,27,2).'-'.substr($ls_programatica,29,2).'-'.substr($ls_programatica,31,2);
		    	}
			...
			if($ld_asignado>0)
			{
				$ld_saldoanterior=$ld_asignado;
		    		$ld_saldo=$ld_asignado;
				//print "saldo anterior".$ld_saldoanterior; die();
			}
			else
			{
				//print "saldo anterior".$ld_saldoanterior; die();
				$ld_saldo=($ld_saldoanterior-$ld_compromiso);
				$ld_saldoanterior=($ld_saldoanterior-$ld_compromiso);
			}
		    ...
		    $ld_total_saldo=$ld_total_saldo+$ld_saldo;
			...
			$ls_programatica=substr($ls_programatica,18,2)."-".substr($ls_programatica,24,2)."-".substr($ls_programatica,27,2);
			if (!empty($ls_spg_cuenta))
		    {
				  ...
				  $la_data[$z]=array('programatica'=>$ls_programatica,'descripcion'=>$ls_descripcion,'asignado'=>$ld_asignado,
						//			 'precomprometido'=>$ld_precompromiso,'comprometido'=>$ld_compromiso,
									 'comprometido'=>$ld_compromiso,'porcomprometido'=>$ld_porc_comprometido,'causado'=>$ld_causado,'porcausado'=>$ld_porc_causado,
									 'pagado'=>$ld_pagado,'porpagado'=>$ld_porc_pagado,'saldo'=>$ld_saldo);
			...
			if (!empty($ls_spg_cuenta_next))
			{
				 ...
				 $ld_total_saldo=$ld_total_asignado-$ld_total_compromiso;
				 $ld_totalsaldo=$ld_total_asignado-$ld_total_compromiso;
				 ...
				 $ld_totalsaldo=number_format($ld_totalsaldo,2,",",".");
				 ...
				 {
					 uf_print_pie_cabecera($ld_total_asignado,$ld_total_precompromiso,$ld_total_compromiso,$ld_total_causado,
										   $ld_total_pagado,$ld_total_saldo,$io_pdf,'Total Bs.');	
				 }						   
				 $ld_total_asignado=0;
				 ...
				 {// Hacemos un rollback de los registros, agregamos una nueva página y volvemos a imprimir
					...
					{
					  uf_print_pie_cabecera($ld_totalasignado,$ld_totalprecompromiso,$ld_totalcompromiso,$ld_totalcausado,
					       				    $ld_totalpagado,$ld_totalsaldo,$io_pdf,'Total Bs.');	
					}						
				    $ld_totalasignado=0;
				 ...
				 if($z==$li_tot)
				 {
					...
					if($ls_tipoformato==1)
					{
						 ...
						 $ld_total_saldo_general=number_format($ld_total_saldo_general,2,",",".");
					...
					else
					{
						 ...
						 $ld_total_saldo_general =$ld_total_asignado_general-$ld_total_compromiso_general;
						 ...
						 $ld_total_saldo_general_bsf=number_format($ld_total_saldo_general_bsf,2,",",".");
						 ...
						 $ld_total_saldo_general=number_format($ld_total_saldo_general,2,",",".");
						  ...
						  //Bolivares 
						  uf_print_pie_cabecera($ld_total_asignado_general,$ld_total_precompromiso_general,$ld_total_compromiso_general,
												$ld_total_causado_general,$ld_total_pagado_general,$ld_total_saldo_general,$io_pdf,'Total Bs.');
						  //Bolivar Fuerte
