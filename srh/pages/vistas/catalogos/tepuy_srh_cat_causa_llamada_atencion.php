...
<html>
<head>
<title>Cat&aacute;logo de Causas de Llamada de Atenci&oacute;n</title>
<script type="text/javascript" language="JavaScript1.2" src="../shcaullam_atend/js/valida_tecla.js"></script>
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_causa_llamada_atencion.js"></script>
...
<form name="form1" method="post" action="">
  ...
  <table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="496" colspan="2" class="titulo-celda">Cat&aacute;logo de Causas de Llamada de Atenci&oacute;n </td>
    </tr>
  </table>
<br>
...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_causa_llamada_atencion.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_causa_llamada_atencion.php";
		var mygrid;
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_causa_llamada_atencion.php?valor=buscar"+"&txtcodcaullam_aten="+codcaullam_aten+"&txtdencaullam_aten="+dencaullam_aten);
          setTimeout (terminar_buscar,500);
