<?php
	...
	$io_fun_nomina->uf_load_seguridad("SNR","tepuy_snorh_d_sueldominimo.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<body>
<?php 
	require_once("tepuy_snorh_c_sueldominimo.php");
	$io_sueldo = new tepuy_snorh_c_sueldominimo();
	uf_limpiarvariables();
	switch ($ls_operacion) 
	{
		case "GUARDAR":
        ...
        <td>
		  ...
		  <table width="550" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
            ...
            <tr>
              ...
              <td> <div align="left">
                <input name="txtfecvigsuemin" type="text" id="txtfecvigsuemin" value="<?php print $ld_fecvigsuemin;?>" size="15" maxlength="10" onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" datepicker="true">
              </div></td>
            </tr>
            <tr>
...
function ue_nuevo()
{
	...
	{	
		...
		f.action="tepuy_snorh_d_sueldominimo.php";
		f.submit();
   	}
	else
   	{
...
function ue_buscar()
{
	...
	if (li_leer==1)
   	{
		window.open("tepuy_snorh_cat_sueldominimo.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
   	}
	else
   	{
 		alert("No tiene permiso para realizar esta operacion");
