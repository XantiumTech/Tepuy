...
function tepuy_spi_c_comprobante()
{
...
function uf_guardar_automatico($as_comprobante,$ad_fecha,$as_proccomp,$as_desccomp,$as_prov,$as_bene,$as_tipo,$ai_tipo_comp,$as_codban,$as_ctaban)
{
	...
	{	
	   $lb_valido=$this->io_int_spi->uf_tepuy_comprobante($dat["codemp"],$as_proccomp,$as_comprobante,$ad_fecha,$ai_tipo_comp,$as_desccomp,$as_tipo,$as_prov,$as_bene,0,$as_codban,$as_ctaban);
	   if (!$lb_valido)
	   {
...
function uf_cargar_dt_comprobante($as_codemp,$as_procede,$as_comprobante,$adt_fecha)
{
	...
	$ld_fecha=$this->io_function->uf_convertirdatetobd($adt_fecha);
 	$ls_sql="SELECT DISTINCT DT.spi_cuenta as spi_cuenta,C.denominacion as denominacion,
  		     ...
  		     FROM spi_dt_cmp DT,spi_cuentas C, tepuy_procedencias P,spi_operaciones OP
