...
<form name="form1" method="post" action="">
  <table width="254" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr>
      ...
      <a href="javascript: uf_aceptar(document.form1.total.value);"><img src="../../shared/imagebank/tools20/aprobado.png" alt="Aceptar" width="20" height="20" border="0"></a>      </tr>
  </table>
  <p align="center">
    <?php
...
if($ls_operacion=="")
{
    ...
    $ls_sql=" SELECT codcar,dencar,formula,codestpro,spg_cuenta,porcar ".
            " FROM tepuy_cargos ORDER BY codcar ASC";  
...
<script language="JavaScript">
  ...
  function uf_calcular_monobjret()
  {
	...
	f.action="tepuy_catdinamic_deducciones.php";
	f.submit();
  }
  ...
  function uf_select_all()
  {
   ...
   function cat_scg()
   {
	   pagina="tepuy_catdinamic_biecar.php";
