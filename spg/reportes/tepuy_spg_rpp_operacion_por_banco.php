<?php
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  --------------------------------------
	 ...
	 $io_function_report->uf_load_seguridad_reporte("SPG","tepuy_spg_r_operacion_por_banco.php",$ls_desc_event);
	////////////////////////////////         SEGURIDAD               ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if ($li_numrows>0)
		{
			 ...
			 while ($row=$io_sql->fetch_row($rs_data))
			 {
			         ...
			         else
					 {
						  ...
						  $ls_programatica = substr($ls_codestpro,18,2).'-'.substr($ls_codestpro,24,2).'-'.substr($ls_codestpro,27,2).'-'.$ls_codestpro4.'-'.$ls_codestpro5;
					 }
                     if ($z==1)
					 {
