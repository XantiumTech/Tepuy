...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_relacion_sel_docs.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<script language="JavaScript">
	  ...
	  if (li_imprimir=='1')
	     {
			  ...
			  if(ls_documentos.length>0)
			  {
					pagina="reportes/tepuy_scb_rpp_relacion_docs.php?codban="+ls_codban+"&ctaban="+ls_ctaban+"&denban="+ls_denban+"&dencta="+ls_dencta+"&documentos="+ls_documentos+"&fechas="+ls_fechas+"&operaciones="+ls_operaciones+"&tiporeporte="+ls_tiporeporte;  	
	...
	function uf_cargar_dt()
	{
		...
		if((ls_codban!="")&&(ls_ctaban!="")&&(ld_fecdesde!="")&&(ld_fechasta!=""))
		{
			...
			f.action='tepuy_scb_r_relacion_sel_docs.php';	
			f.submit();
		}
		else
		{
