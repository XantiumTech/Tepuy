		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch($as_tipo)
				{
					...
					case "credenciales": // Se hace el llamado desde tepuy_snorh_r_credencialespersonal.php
						print "<tr class=celdas-blancas>";
					...
					case "replisperdes": // Se hace el llamado desde tepuy_snorh_r_unidadadministrativa.php
						print "<tr class=celdas-blancas>";
					...
					case "replisperhas": // Se hace el llamado desde tepuy_snorh_r_unidadadministrativa.php
						print "<tr class=celdas-blancas>";
					...
					case "replisfir": // Se hace el llamado desde tepuy_sno_r_listadofirmas.php
						print "<tr class=celdas-blancas>";
						print "<td align=center><a href=\"javascript: aceptarreplisfir('$ls_minorguniadm','$ls_ofiuniadm',";
						print "'$ls_uniuniadm','$ls_depuniadm','$ls_prouniadm','$denominacion');\">".$codigo."</a></td>";
						print "<td>".$denominacion."</td>";
