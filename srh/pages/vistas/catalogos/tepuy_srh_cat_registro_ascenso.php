...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_cat_registro_ascenso.js"></script>
...
<br>
    <table width="513" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
     ...
     <tr>
        ...
        <a href="javascript:catalogo_concurso();"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Cat&aacute;logo Tipos de Documentos" name="buscartip" width="15" height="15" border="0" id="buscartip"></a>
       </div></td>
	  ...
	  <td><input name="txttipo" type="hidden" id="txttipo" size="2" maxlength="2" value="M" readonly>
       ...
       <td width="240"  align="center"><a href="javascript: Buscar()"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Haga Click aqu&iacute; para Buscar</a></td>
      </tr>
  </table>
