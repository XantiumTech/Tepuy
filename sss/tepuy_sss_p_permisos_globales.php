...
$io_fun_seguridad->uf_load_seguridad("SSS","tepuy_c_permisos_globales.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<?php
	require_once("tepuy_sss_c_permisos_globales.php");
	$io_sss= new tepuy_sss_c_permisos_globales();
      ...
      <tr>
        <td height="13"><table width="458" height="197" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="71">&nbsp;</td>
            <td width="171">&nbsp;</td>
            <td><a href="javascript: ue_procesar();"><img src="../shared/imagebank/tools15/ejecutar.png" width="15" height="15" border="0">Procesar</a></td>
          </tr>
        </table></td>
      </tr>
    </table>
		...
		if(li_ejecutar==1)
		{
			...
			if((ls_usuario!="---")&&(ls_sistemas!="---"))
			{
				if(lb_valido)
				{
					...
					f.action="tepuy_sss_p_permisos_globales.php";
					f.submit();
				}
				else
				{
...
function ue_buscarcodigo()
{
	...
	if(ls_codsis=="SNO")
	{
		window.open("tepuy_sss_cat_nominas.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	if(ls_codsis=="SPG")
	{
		window.open("tepuy_sss_cat_est_prog.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
}
