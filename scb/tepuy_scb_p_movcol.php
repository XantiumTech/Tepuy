...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_p_movcol.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<script language="javascript">
	function uf_valida_cuadre()
	{
		...
		if((ldec_diferencia!=0)&&((ls_operacion=="")||(ls_operacion=="GUARDAR")||(ls_operacion=='NUEVO')))
		{
			...
			f.action="tepuy_scb_p_movcol.php";			
			f.submit();
		}
	}
</script>
...
<?php
	...
	require_once("tepuy_scb_c_movcol.php");
	$in_classmovcol=new tepuy_scb_c_movcol($la_seguridad);
	...
	if($ls_operacion=="DELETESPG")
	{
		...
		$in_classmovcol->SQL->begin_transaction();
		$lb_valido=$in_classmovcol->uf_delete_dt_spg($ls_docmov,$ls_codban,$ls_cuenta_banco,$ls_mov_operacion,$ls_numcol,$ls_cuenta_spg,$ls_operacion,$ls_programatica);
		$msg->message($in_classmovcol->is_msg_error);
		if($lb_valido)
		{
			$in_classmovcol->SQL->commit();
...
?>
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    <tr class="titulo-ventana">
      <td height="22" colspan="4">Movimientos de Colocaci&oacute;n </td>
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="3"><input name="txtcolocacion" type="text" id="txtcolocacion" value="<?php print $ls_numcol;?> ">
      <a href="javascript:cat_colocaciones();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Bancos"></a>
      <input name="txtdencol" type="text" id="txtdencol" value="<?php print $ls_dencol;?>" class="sin-borde"></td>
    </tr>
    <tr>
      ...
      <td colspan="3"><div align="left">
          ...
          &nbsp;&nbsp;&nbsp;<input name="txtcuenta_scg" type="text" class="sin-borde" id="txtcuenta_scg" value="<?php print $ls_cuenta_scg;?>">
      </div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" colspan="4">&nbsp;&nbsp;<a href="javascript: alert('Este movimiento no puede registrar detalle de presupuesto');"><img src="../shared/imagebank/tools/nuevo.png" width="15" height="15" border="0">Agregar detalle Presupuesto</a> </td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" colspan="4">&nbsp;&nbsp;<a href="javascript: alert('Este movimiento no puede registrar Retenciones');"><img src="../shared/imagebank/tools/nuevo.png" width="15" height="15" border="0">Agregar detalle Retenciones </a> </td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="22" colspan="4">&nbsp;&nbsp;<img src="../shared/imagebank/tools/nuevo.png" width="15" height="15" border="0">Agregar detalle Ingreso  </td>
    </tr>
    <tr>
      <td height="22" colspan="4"><div align="center">
        <a name="03"></a>
...
function ue_buscar()
{
	window.open("tepuy_cat_mov_colocacion.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=650,height=400,left=50,top=50,location=no,resizable=yes");
}
...
function ue_cerrar()
{
	...
	function catalogo_cuentabanco()
	 ...
	 function cat_colocaciones()
	 {
		   ...
		   if((ls_codban!=""))
		   {
			   pagina="tepuy_cat_colocaciones.php?codigo="+ls_codban+"&denban="+ls_denban;
...
function uf_verificar_provbene(lb_checked,obj)
{
   ...
   function  uf_agregar_dtcon()
   {
		...
		if(ls_estcol=="N")
		{
			...
			{
				ls_pagina = "tepuy_w_regdt_col_contable.php?txtprocedencia=SCBCOL&txtdoccol="+ls_documento+"&fecha="+ld_fecha+"&procede="+ls_procede+"&descripcion="+ls_descripcion+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&cuenta_scg="+ls_cuenta_scg+"&mov_operacion="+ls_operacion+"&monto="+ldec_monto+"&chevau="+ls_chevau+"&estint="+li_estint+"&cobrapaga="+li_cobrapaga+"&estbpd=M&estmov="+ls_estmov+"&codconmov="+ls_codconmov+"&tasa="+ldec_tasa+"&opener=tepuy_scb_p_movcol.php&numcol="+ls_numcol;
    ...
    function  uf_agregar_dtpre()
   {
		...
		if((lb_valido)&&(ls_descripcion!="")&&(ls_codban!="")&(ls_ctaban!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto>0))
		{
			...
			{
				ls_pagina = "tepuy_w_regdt_col_presupuesto.php?txtprocedencia=SCBCOL&numdoc="+ls_documento+"&fecha="+ld_fecha+"&procede="+ls_procede+"&descripcion="+ls_descripcion+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&cuenta_scg="+ls_cuenta_scg+"&mov_operacion="+ls_operacion+"&monto="+ldec_monto+"&chevau="+ls_chevau+"&estint="+li_estint+"&cobrapaga="+li_cobrapaga+"&estbpd=M&estmov="+ls_estmov+"&codconmov="+ls_codconmov+"&tasa="+ldec_tasa+"&opener=tepuy_scb_p_movcol.php&txtdoccol="+ls_numcol;
    ...
    function  uf_agregar_dtret(operacion)
   {
		...
		if((ls_descripcion!="")&&(ls_codban!="")&(ls_ctaban!="")&&(ls_documento!="")&&(ls_operacion!="")&&(ldec_monto>0))
		{
			if(ls_operacion=="CH")
			{
				ls_pagina = "tepuy_w_regdt_deducciones.php?txtdocumento="+ls_documento+"&fecha="+ld_fecha+"&procede="+ls_procede+"&descripcion="+ls_descripcion+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&cuenta_scg="+ls_cuenta_scg+"&mov_operacion="+ls_operacion+"&monto="+ldec_monto+"&chevau="+ls_chevau+"&estint="+li_estint+"&cobrapaga="+li_cobrapaga+"&estbpd=M&txtnomproben="+ls_nomproben+"&estmov="+ls_estmov+"&codconmov="+ls_codconmov+"&tip_mov= &opener=tepuy_scb_p_movcol.php";
