<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsolcot,$as_fecsolcot,$as_dentipsolcot,$as_obssolcot,&$io_pdf)
	{
		...
		//$io_pdf->Rectangle(460,690,125,44);
		$ls_rifemp= $_SESSION["la_empresa"]["rifemp"];
		$ls_email= 'www.cvaleander.com.ve';//$_SESSION["la_empresa"]["email"];
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/logo_cvaleander2.jpg',525,719,50,50); // Agregar Logo
...
//----------------------------------------------------------------------------------------------------------------------------------
		...
		$io_pdf->rectangle(140,635,450,40);
		$io_pdf->line(450,635,450,675);
		$io_pdf->line(450,655,590,655);
		...
		$io_pdf->addText(460,660,10,"<b>   No.:</b>");      // Agregar texto
		$io_pdf->addText(495,660,10,$as_numsolcot); // Agregar Numero de la solicitud
		$io_pdf->addText(450,640,10,"<b>  Fecha:</b>"); // Agregar texto
		$io_pdf->addText(495,640,10,$as_fecsolcot); // Agregar la Fecha
...
//--------------------------------------------------------------------------------------------------------------------------------------
		...
		// cuadro inferior
		$io_pdf->Rectangle(20,100,560,60); // 
	   // $io_pdf->line(15,200,585,200);   //
		$io_pdf->addText(150,150,9,"COMPRA"); 
	//	$io_pdf->line(200,175,200,255);  // LINEA VERTICAL
		$io_pdf->addText(350,150,9,"DIRECCION DE ADMINISTRACION Y FINANZA"); 
		$io_pdf->line(300,100,300,160);  // LINEA VERTICAL
		//$io_pdf->addText(45,245,9,"FIANZA DE FIEL CUMPLIMIENTO"); 
		
		$io_pdf->line(20,145,580,145);	//HORIZONTAL	
