<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_titulo1,&$io_pdf)
	{
		...
		$io_pdf->addText(510,762,6,"Dirección de Administración"); // Direccion		
		...
		$tm=306-($li_tm/2);
		$io_pdf->addText($tm,643,8,$as_titulo1); // Agregar el título
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('partida'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la
									...
									'sub-especifica'=>array('justification'=>'center','width'=>45), // Justificación y ancho de la
						 			'denominacion'=>array('justification'=>'left','width'=>320), // Justificación y ancho de la
						 			'pres_anual'=>array('justification'=>'right','width'=>90))); // Justificación y ancho 
		$la_columnas=array('partida'=>'<b>Partida</b>','generica'=>'<b>Generica</b>','especifica'=>'<b>Especifica</b>','sub-especifica'=>'<b>Sub-Especifica</b>','denominacion'=>'<b>Denominación</b>','pres_anual'=>'<b>Estimado</b>');
	...
	function uf_print_pie_cabecera($la_data_tot,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'center','width'=>480), // Justificación y ancho de la columna
		...
		$la_config1=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'xPos'=>305,
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('forma'=>array('justification'=>'left','width'=>570))); // Justificación y ancho de la columna
	     ...
	     if ($lb_valido==false) // Existe algún error ó no hay registros
		 ...
		 else // Imprimimos el reporte
		    {
			  ...
			  $io_pdf->selectFont('../../shared/ezpdf/fonts/Helvetica.afm'); // Seleccionamos el tipo de letra
	 		  $io_pdf->ezSetCmMargins(7.4,3,3,3); // Configuración de los margenes en centímetros
			  uf_print_encabezado_pagina($ls_titulo,$ls_titulo1,$io_pdf); // Imprimimos el encabezado de la página
			  $io_pdf->ezStartPageNumbers(580,40,10,'','',1); // Insertar el número de página
