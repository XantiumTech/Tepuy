...
<p>&nbsp;</p>
  	...
  	<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_grupomovimiento.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_grupomovimiento.php";
		var mygrid;
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img;
		   mygrid.loadXML("../../php/tepuy_srh_a_grupomovimiento.php?valor=buscar"+"&txtcodgrumov="+codgrumov+"&txtdengrumov="+dengrumov);
		   setTimeout (terminar_buscar,500);
