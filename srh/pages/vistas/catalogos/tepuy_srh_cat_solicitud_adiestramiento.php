...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_cat_solicitud_adiestramiento.js"></script>
 ...
 <td height="28"><div align="right">Fecha Solicitud Hasta</div></td>
  ...
  <input name="reset" type="reset" onclick="return showCalendar('txtfecsolhas', '%d/%m/%Y');" value=" ... " /> </td>
   ...
   <tr>
        ...
        <a href="javascript:catalogo_proveedor();"><img src="../../../../shared/imagebank/tools15/buscar.png"  name="buscartip" width="15" height="15" border="0" id="buscartip"></a>
      ...
      <tr>
	 <strong> <td>&nbsp;</td></strong>
	<td width="219"><div align="right"><a href="javascript: Limpiar_busqueda(); ">  <img src="../../../public/imagenes/nuevo.png" alt="Limpiar" width="15" height="15" border="0">Limpiar</a></div></td>
       <td width="195" align="left"><div  align="right"><a href="javascript: Buscar()"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Haga click aqu&iacute; para Buscar</a></div></td>
