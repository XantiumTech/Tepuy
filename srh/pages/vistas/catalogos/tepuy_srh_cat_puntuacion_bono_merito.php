...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_puntuacion_bono_merito.js"></script>
<style type="text/css">
<!--
a:link {
	color: #006699;
...
<br>
    ...
    <td height="28" colspan="2"><input name="txtcodtipper" type="text" id="txtcodtipper"    size="5" maxlength="3" readonly> <a href="javascript:catalogo_tipo_personal();"><img src="../../../../shared/imagebank/tools15/buscar.png"  name="buscartip" width="15" height="15" border="0" id="buscartip"></a>
      <input name="txtdentipper" type="text" class="sin-borde" id="txtdentipper"  size="45" maxlength="80" readonly></td>      
		</tr>
	 <tr>
	  <td>&nbsp;</td>
	  <td width="53">&nbsp;</td>
       <td width="299"><div align="right"><a href="javascript: Limpiar_busqueda(); Buscar();">  <img src="../../../public/imagenes/nuevo.png" alt="Limpiar" width="15" height="15" border="0">Limpiar</a></div></td>
       <td width="62"><div align="right"><a href="javascript: Buscar()"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Buscar</a></div></td>
      </tr>
    </table>
...
{	
f=document.form1;		
	  pagina="../catalogos/tepuy_srh_cat_tipopersonal.php?valor_cat=0";
	  window.open(pagina,"catalogo2","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
		...
		var loadDataURL = "../../php/tepuy_srh_a_puntuacion_bono_merito.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_puntuacion_bono_merito.php";
		var mygrid;
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_puntuacion_bono_merito.php?valor=buscar"+"&txtcodpunt="+codpunt+"&txtnombpunt="+nombpunt+"&txtcodtipper="+codtipper);
		   setTimeout (terminar_buscar,500);
