<?php
class tepuy_srh_class_report
{
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_srh_class_report($as_path="../../")
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_srh_class_report
		//		   Access: public 
...
function uf_select_resultadosxaspirante($as_tipo_eval,$as_codper,$as_codcon,$as_fecha)
{
   ...
   switch ($_SESSION["ls_gestor"])
	...
	$ls_sql="  SELECT srh_requisitos_minimos.tipo_eval,srh_requisitos_minimos.codper, ".
			...
			" WHERE srh_requisitos_minimos.codemp='".$this->ls_codemp."' ".
			"   and srh_requisitos_minimos.codper= '".$as_codper."'  ".
 ...
 function uf_select_lote_revision_odi($ad_fechades,$ad_fechahas,$as_codperdes,$as_codperhas)
	 ...
	 function uf_select_lote_dt_revision_odi($as_nroreg)
	{
	    ...
	    $ls_sql="SELECT srh_dt_revisiones_odi.nroreg,srh_dt_revisiones_odi.fecrev,srh_dt_revisiones_odi.odi, 
				 ...
				 AND srh_dt_revisiones_odi.odi=srh_dt_odi.odi";	   
 ...
 function uf_select_dt_evaluacion_odi($as_nroeval)
	{
		...
		$ls_criterio="";
		$ls_gestor = $_SESSION["ls_gestor"];
	    $ls_sql="SELECT codemp, nroeval, odi, peso_rango, rango
		           FROM srh_evaluacion_odi where nroeval='".$as_nroeval."' "; ////print $ls_sql."<br>";  
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
			$this->io_mensajes->message("CLASE->Report MÉTODO->uf_evaluacion_desemp ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
	 ...
	 function uf_select_lote_dt_odi($as_nroreg,$ad_fecini, $ad_fecfin)
	{
	   ...
	   $ad_fecini=$this->io_funciones->uf_convertirdatetobd($ad_fecini);	   
	    ...
	    $ls_sql="SELECT srh_dt_revisiones_odi.nroreg,srh_dt_revisiones_odi.fecrev,srh_dt_revisiones_odi.odi, 
				 ...
				 AND srh_dt_revisiones_odi.nroreg=srh_dt_odi.nroreg
				 AND srh_dt_revisiones_odi.odi=srh_dt_odi.odi
				 ORDER BY srh_dt_revisiones_odi.odi ";	   
...
function uf_select_deduccion_personal($as_codper, &$rs_data)
	{
	    ...
	    $ls_sql=" SELECT  sno_personaldeduccion.codtipded, srh_dt_tipodeduccion.*, sno_personal.hcmper, sno_personal.sexper, 
		          sno_personal.fecnacper, sno_personalnomina.sueper, srh_tipodeduccion.dentipded ". 
				" FROM  sno_personaldeduccion, srh_dt_tipodeduccion, sno_personal, sno_personalnomina, srh_tipodeduccion, sno_nomina ".
				...
				" AND srh_dt_tipodeduccion.codtipded=srh_tipodeduccion.codtipded  ".
...
function uf_select_deduccion_personal_familiar($as_codper, &$rs_data)
	{
	    ...
	    $ls_sql=" SELECT sno_familiardeduccion.codtipded, srh_dt_tipodeduccion.*, sno_personalnomina.sueper, 
		           srh_tipodeduccion.dentipded, sno_nomina,  sno_familiar.nexfam as nexofam, ".
					" sno_familiar.fecnacfam  as fecha_nac, ".
					" sno_familiar.hcfam  as hcfam, ".
					" sno_familiar.hcmfam  as hcmfam, ".
					" sno_familiar.sexfam as sexofam ".
				    "        FROM sno_familiardeduccion,srh_dt_tipodeduccion, sno_personalnomina,srh_tipodeduccion, ".
					"         sno_familiar, sno_personaldeduccion,sno_nomina ".
                    ...
                    "        AND sno_familiardeduccion.codtipded= sno_personaldeduccion.codtipded  ".
                    "        AND srh_dt_tipodeduccion.codtipded=sno_personaldeduccion.codtipded   ".
                    "        AND sno_familiardeduccion.codper= sno_personaldeduccion.codper     ".
                    "        AND srh_dt_tipodeduccion.codtipded=srh_tipodeduccion.codtipded  ".
					"        AND sno_personalnomina.codemp= '".$this->ls_codemp."'  ".
					"		 AND sno_personalnomina.codper='$as_codper'   ".
					"        AND sno_familiar.codemp= '".$this->ls_codemp."' ".
...
} // fin de la clase tepuy_srh_class_report
