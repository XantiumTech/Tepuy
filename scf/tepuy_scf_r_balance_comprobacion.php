<?php
	...
	$io_fun_scf->uf_load_seguridad("SCF","tepuy_scf_r_balance_comprobacion.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
      ...
      <td height="136"><p>&nbsp;</p>
          <table width="600" height="22" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
            ...
            <tr>
              ...
              <a href="javascript:ue_buscarcuenta('REPDES')"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Cuentas" width="15" height="15" border="0"></a></div></td>
              <td align="center"><div align="right">Hasta</div></td>
              <td align="center"><div align="left">
                  <input name="txtcuentahasta" type="text" id="txtcuentahasta" size="22">
              <a href="javascript:ue_buscarcuenta('REPHAS')"><img src="../shared/imagebank/tools15/buscar.png" alt="Catalogo Cuentas" width="15" height="15" border="0"></a></div></td>
            </tr>
            <tr class="titulo-celdanew">
...
function ue_search()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/tepuy_scf_rpp_balance_comprobacion.php?fecdes="+fecdes+"&fechas="+fechas;
...
function ue_openexcel()
{
	...
	{	
		...
		if(valido)
		{
			pagina="reportes/tepuy_scf_rpp_balance_comprobacion_excel.php?fecdes="+fecdes+"&fechas="+fechas;
			pagina=pagina+"&cuentadesde="+cuentadesde+"&cuentahasta="+cuentahasta+"&nivel="+nivel+"&tiporeporte="+tiporeporte;
			window.open(pagina,"Reporte","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
   	}
