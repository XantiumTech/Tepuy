...
$io_fun_viaticos->uf_load_seguridad("SCV","tepuy_scv_r_solicitudes.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
$ls_formato=$io_fun_viaticos->uf_select_config("SCV","REPORTE","SOLICITUDES","tepuy_scv_rpp_solicitudes.php","C");
?>
...
<!--  <tr>
  ...
  <tr> 
    <td width="20" height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:uf_mostrar_reporte();"><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" width="20" height="20" border="0"></a></td>
    <td width="20" bgcolor="#FFFFFF" class="toolbar"><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a></td>
      ...
      <td height="33" colspan="3" align="center">      <div align="left">
        <table width="457" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="110" height="22"><input name="txtdesde" type="text" id="txtdesde" size="15"  onKeyPress="ue_separadores(this,'/',patron,true);" style="text-align:center" datepicker="true"></td>
            <td height="22"><div align="right">Hasta</div></td>
            <td height="22"><div align="left">
                <input name="txthasta" type="text" id="txthasta" size="15"  onKeyPress="ue_separadores(this,'/',patron,true);" style="text-align:center" datepicker="true">
            </div></td>
            <td height="22">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td height="22" colspan="3"><a href="javascript: ue_buscarunidad();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
          ...
          <tr>
            ...
            <td height="22" colspan="3"><a href="javascript: ue_buscarbeneficiario();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
function ue_buscarunidad()
{
	...
	if (li_leer==1)
   	{
		window.open("tepuy_scv_cat_unidadadm.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=50,top=50,location=no,resizable=yes");
   	}
	else
   	{
...
function ue_buscarbeneficiario()
{
	...
	if (li_leer==1)
   	{
		window.open("tepuy_scv_cat_beneficiarios.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,left=50,top=50,location=no,resizable=yes");
   	}
	else
   	{
 		alert("No tiene permiso para realizar esta operacion");
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				if ((ld_desde!="")&&(ld_hasta!=""))
				{
					...
					window.open("reportes/"+formato+"?ordenfec="+li_ordenfec+"&desde="+ld_desde+"&hasta="+ld_hasta+"&codben="+ls_codben+"&coduniadm="+ls_coduniadm+"&tiporeporte="+ls_tiporeporte+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				}
				else
				{
