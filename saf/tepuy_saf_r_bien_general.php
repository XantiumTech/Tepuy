...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_bien_general.php",$ls_permisos,$la_seguridad,$la_permisos);
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				pantalla="reportes/tepuy_saf_rpp_bien_general.php?ordenact="+li_ordenact+"&desde="+ld_desde+
				...
				f.action="tepuy_siv_r_bien_general.php";
