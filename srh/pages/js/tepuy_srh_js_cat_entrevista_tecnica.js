...
var loadDataURL = "../../php/tepuy_srh_a_entrevista_tecnica.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_entrevista_tecnica.php";
var mygrid;
...
function Buscar()
{
	 ...
	 else
	 {
		 ...
		 mygrid.loadXML("../../php/tepuy_srh_a_entrevista_tecnica.php?valor=buscar"+"&txtfechades="+fechades+"&txtfechahas="+fechahas+"&txtcodper="+codper);
...
function aceptar ( ls_codper ,  ls_fecha ,  ls_apeper ,  ls_nomper,  ls_codcon ,  ls_descon , ls_codperdestino ,  ls_fechadestino ,  ls_nomdestino ,  ls_codcondestino ,  ls_descondestino, ls_codeval, ls_deneval, ls_codevaldestino, ls_denevaldestino, li_total, ls_totaldestino, ls_ejecucion)
	{
		...
		if(ls_ejecucion=="1")
		{
		 ...
		 opener.document.form1.hidstatus.value="";
			...
			opener.document.form1.action="../pantallas/tepuy_srh_p_entrevista_tecnica.php";
