...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_comparados_ejecucion_financiera_formato3.php";
...
function ue_showouput()
{
    ...
    if(estmodest==1)
	{
		if(txtetiqueta=="Mensual")
		{
			...
			{
			 pagina="reportes/tepuy_spg_rpp_comp_ejec_finan_formato2.php?codestpro1="+codestpro1+"&codestpro2="+codestpro2
   ...
   +"&combo="+combo+"&combomes="+combomes+"&ckbformil="+ckbformil+"&txtetiqueta="+txtetiqueta+"&tipoformato="+tipoformato
   +"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas;
   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,        location=no");
			}
		  }	
