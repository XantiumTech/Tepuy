...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_comparados_forma0407.php";
...
<title>EJECUCION FINANCIERA TRIMESTRAL DEL PRESUPUESTO DE GASTOS</title>
...
?>
  <table width="608" height="18" border="0" align="center" cellpadding="1" cellspacing="1">
    <tr>
      <td width="604" colspan="2" class="titulo-ventana">EJECUCION FINANCIERA TRIMESTRAL DEL PRESUPUESTO DE GASTOS</td>
    </tr>
  </table>
  <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
    ...
    <tr>
      <td height="22" colspan="3" align="left"><table width="550" height="40" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr class="titulo-celdanew">
          <td height="13" colspan="4"><strong class="titulo-celdanew">Seleccione Trimestre y Nivel </strong></td>
        </tr>
        <tr>
          <td width="85" height="21"><div align="right">Trimestre</div></td>
...
function ue_showouput()
{
    ...
    if(estmodest==1)
	{
		...
		{
		   pagina="reportes/tepuy_spg_rpp_comp_ejec_finan_forma0407.php?cmbmes="+cmbmes+"&codestpro1="+codestpro1
				  ...
				  +"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas +"&tipoformato="+tipoformato;
	...
	else
	{
		...
		else
		{
		   ...
		   +"&codestpro5h="+codestpro5h+"&cmbnivel="+cmbnivel+"&txtcodfuefindes="+txtcodfuefindes
		   +"&txtcodfuefinhas="+txtcodfuefinhas+"&tipoformato="+tipoformato;
		   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
		}
	}	
}
