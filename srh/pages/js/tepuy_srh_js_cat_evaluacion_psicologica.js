...
var loadDataURL = "../../php/tepuy_srh_a_evaluacion_psicologica.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_evaluacion_psicologica.php";
var mygrid;
...
function Buscar()
{
	 ...
	 else
	 {
		 ...
		 mygrid.loadXML("../../php/tepuy_srh_a_evaluacion_psicologica.php?valor=buscar"+"&txtfechades="+fechades+"&txtfechahas="+fechahas+"&txtcodper="+codper);
	...
	ls_ejecucion=document.form1.hidstatus.value
		if(ls_ejecucion=="1")
		{
		 ...
		 opener.document.form1.hidstatus.value="";
			...
			opener.document.form1.action="../pantallas/tepuy_srh_p_evaluacion_psicologica.php";
