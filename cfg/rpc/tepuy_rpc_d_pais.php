...
require_once("class_folder/tepuy_rpc_c_pais.php");
...
$io_pais      = new tepuy_rpc_c_pais($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "CFG";
	$ls_ventanas = "tepuy_rpc_d_pais.php";
...
if ($ls_operacion=="NUEVO")
   {     
     $ls_codpais=$io_funciondb->uf_generar_codigo($lb_empresa,$ls_empresa,'tepuy_pais','codpai');
	 if (empty($ls_codpais))
	    {
     ...
     if ($lb_existe)
	    {
	      ...
	      $lb_tiene     = $io_chkrel->uf_check_relaciones($ls_empresa,$ls_condicion,'tepuy_pais',$ls_codpais,$ls_mensaje);//Verifica los movimientos asociados a la cuenta
          if (!$lb_tiene)
		     {
        ...
        <td width="516" height="174"><div align="center">
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr>
              ...
              <td height="22"><input name="txtdenominacion" id="txtdenominacion" value="<?php print $ls_denpais?>" type="text" size="60" maxlength="60" onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnñopqrstuvwxyz '+',.-');"></td>
            </tr>
            <tr>
              <td height="22">&nbsp;</td>
              <td height="22">&nbsp; </td>
...
function ue_buscar()
{
	...
	if (li_leer==1)
	   {
		 f.operacion.value="";			
		 pagina="tepuy_cfg_cat_paises.php";
