...
var url= "../../php/tepuy_srh_a_resultados_evaluacion_aspirante.php";
var metodo='get';
...
function Consultar()
{
     if  ( ($('txtcodper').value=="") || ($('txtcodcon').value=="")) 		
	 {
	  ...
	  f.operacion.value="CONSULTAR";
  	  f.action="../pantallas/tepuy_srh_p_resultados_evaluacion_aspirante.php";
	  f.existe.value="TRUE";			
	  f.submit();	
	 }
}
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_resultados_evaluacion_aspirante.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
