<?php
	...
	function uf_print_cabezera_detalle(&$io_pdf)
	{
		...
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$la_datatitulos= array(array('cuenta'=>"<b>Partida Presupuestaria</b>",'fecha'=>"<b>Fecha</b>",
					     'denominacion'=>"<b>DENOMINACION</b>",
		                             'disminucion'=>"<b>CEDENTE</b>",'aumento'=>"<b>RECEPTORA</b>"));
				
		$la_columna=array('cuenta'=>'<b>CODIGO</b>','fecha'=>"<b>Fecha</b>",
						  'denominacion'=>'<b>DENOMINACION</b>',
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>550, // Ancho Máximo de la tabla
						 'xPos'=>320, // Orientación de la tabla
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>140), // Justificación y ancho de la columna
									   'fecha'=>array('justification'=>'center','width'=>60), // Justificación y ancho de la columna
		...
		$la_columnas=array('cuenta'=>'<b>CODIGO</b>','fecha'=>"<b>Fecha</b>",
						   'denominacion'=>'<b>DENOMINACION</b>',
						   'disminucion'=>'<b>CEDENTE</b>',
						   'aumento'=>'<b>RECEPTORA</b>');
	...
	//----------------------------------------------------  Parámetros del encabezado  -----------------------------------------------
		$ls_titulo=" <b>RESUMEN DE MODIFICACIONES PRESUPUESTARIAS</b> ";       
	//--------------------------------------------------------------------------------------------------------------------------------
	 ...
	 else // Imprimimos el reporte
	 {
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			if (!empty($ls_procomp))
		    {
				...
				if($ld_aumento=="0,00"){$ld_aumento="";}
				$ld_disminucion=number_format($ld_disminucion,2,",",".");
			   	if($ld_disminucion=="0,00"){$ld_disminucion="";}
				$la_data[$z]=array('cuenta'=>$ls_spg_cuenta,'fecha'=>$ldt_fecha,'denominacion'=>$ls_denominacion,
			...
			/*	if($z<$li_tot)
				...
				$ld_totalaum=$ld_totalaumento;
				$ld_totaldis=$ld_totaldismi;		uf_print_detalle($la_data,$io_pdf); // Imprimimos el detalle 
