	 ...
	 if ($lb_encontrado)
	    {
		  ...
		  if (!$lb_existe)
			 { 
			   $lb_valido = $io_estpro3->uf_spg_insert_estprog3($ls_codemp,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_denestpro3,$ls_codfuefin,$ls_responsable,$li_estmodest,$la_seguridad);		
			   if ($lb_valido)
				  {
				    $io_sql->commit();
			 ...
			 { 
			   $lb_valido = $io_estpro3->uf_spg_update_estprog3($ls_codemp,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,$ls_denestpro3,$ls_codfuefin,$ls_responsable,$la_seguridad);		
			   if ($lb_valido)
				  {
				    $io_sql->commit();
