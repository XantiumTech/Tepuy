...
$io_fun_viaticos->uf_load_seguridad("SCV","tepuy_scv_d_tarifasxdistancias.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
   function uf_limpiarvariables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
		global $ls_codtar,$ls_dentar,$li_kmsdes,$li_kmshas,$li_montar,$ls_estatus;
...
require_once("class_folder/tepuy_scv_c_tarifasxdistancias.php");
$io_scv= new tepuy_scv_c_tarifasxdistancias($conn);
...
function ue_nuevo()
{
   ...
   {			 
	  ...
	  f.action="tepuy_scv_d_tarifasxdistancias.php";
	  f.submit();
   }
   else
   {
	...
	if (li_leer==1)
	   {
		 ...
		 pagina="tepuy_scv_cat_tarifasxdistancias.php?destino="+ls_destino+"";
