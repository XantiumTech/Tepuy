<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_r_relacionsolicitudes.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
function uf_imprimir()
{
		...
		if(li_imprimir==1)
		{
			...
			pantalla="reportes/tepuy_cxp_rpp_relacionsolicitudes.php?numsoldes="+numsoldes+"&numsolhas="+numsolhas+"&tiporeporte="+tiporeporte+"";
