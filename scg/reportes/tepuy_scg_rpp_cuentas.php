<?php
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_scg->uf_load_seguridad_reporte("SCG","tepuy_scg_r_cuentas.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'maxWidth'=>550,
						 'cols'=>array('cuenta'=>array('justification'=>'center','width'=>130),
						               'denominacion'=>array('justification'=>'left','width'=>420))); // Ancho Máximo de la tabla
	...
	if($lb_valido)
	{
		$lb_valido=$io_report->uf_cargar_listado_cuentas_contables($ls_cuenta_desde,$ls_cuenta_hasta,&$rs_data);
	}	
