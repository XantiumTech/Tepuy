...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_r_reporteseguimientoobra.php";
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	require_once ("class_folder/tepuy_sob_c_reportes.php");
	$io_reporte=new tepuy_sob_c_reportes();
...
//-------------------------------------Campos a ser mostrados en el reporte---------------------------------------//
		...
		if($lb_valido)
		{
			...
			for($li_i=0;$li_i<$li_filas;$li_i++)		
			{
				...
				{
					case "anticipo":
						include_once("class_folder/tepuy_sob_c_anticipo.php");
					...
					case "amortizacionanticipo":
						include_once("class_folder/tepuy_sob_c_anticipo.php");
						include_once("class_folder/tepuy_sob_c_valuacion.php");
						$io_anticipo=new tepuy_sob_c_anticipo();					
					...
					break;
					case "ejecucionfinanciera":
						include_once("class_folder/tepuy_sob_c_contrato.php");
						include_once("class_folder/tepuy_sob_c_valuacion.php");
					...
					case "fuentesfinanciamiento":
						include_once("class_folder/tepuy_sob_class_obra.php");
			...
			{
				include_once("class_folder/tepuy_sob_c_supervisores.php");
				$io_proveedores=new tepuy_sob_c_supervisores();
			}
...
//----------------------------------------------------------------------------------------------------------------------------------//		
			...
			?>
				<script language="javascript">
					var pagina='tepuy_sob_r_plantillapdf.php';
              ...
              <td height="56" colspan="3" align="left"><table width="638" height="54" border="0" align="center" cellpadding="0" cellspacing="2" class="formato-blanco">
                <tr>
                  ...
                  <td width="458" ><input name="txtcodcontratista" type="text" id="txtcodcontratista" value="<? print $ls_codcontratista?>" size="10" maxlength="10">
                      <span class="toolbar"><a href="javascript:ue_catcontratista();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a></span>
                ...
                <tr>
                  ...
                  <td ><input name="txtcodins" type="text" id="txtcodins" value="<? print $ls_codins?>" size="10" maxlength="10">
                      <span class="toolbar"><a href="javascript:ue_catinspectora();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a></span>
              ...
              <td height="62" colspan="3" align="left"><table width="638" height="45" border="0" align="center" cellpadding="0" cellspacing="2" class="formato-blanco">
                <tr>
                  ...
                  <td colspan="3" ><input name="txtcodfuefin" type="text" id="txtcodfuefin"  style="text-align:left" value="<? print $ls_codfuefin ?>" size="4" maxlength="4" >
                      <a href="javascript:ue_catfuentesfin();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0"></a>
...
/***********************************************************************************************************************************/
        ...
        {
	        f=document.form1;
	        f.action="tepuy_sob_r_reporteobra.php";
	        f.operacion.value="";
	        f.submit();
        }
