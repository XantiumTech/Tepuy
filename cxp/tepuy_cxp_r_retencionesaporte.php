<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_r_retencionesaporte.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_reporte=$io_fun_cxp->uf_select_config("CXP","REPORTE","FORMATO_RETAPORTE","tepuy_cxp_rpp_retencionesaporte.php","C");
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
