...
<input name="txtfechas" type="text" id="txtfechas" onBlur="valFecha(document.form1.txtfechas)" value="<? print $ls_fechas ?>" size="12" maxlength="10" datepicker="true">
  ...
  <tr>
    <td height="22" colspan="5" align="center" ><div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0" onClick="ue_search()">Buscar Recepcion de Documentos </a></div></td>
  </tr>
</table>
<p align="center">
  <?Php
...
function ue_search()
  {
	  ...
	  f.action="tepuy_saf_cat_recepciones.php";
	  f.submit();
  }
