...
<html>
<head>
<title>Registro de Proveedores de Servicios Medicos</title>
...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Servicios Medicos-->Registro de Proveedores</td>
...
<?php
require_once("class_folder/tepuy_sme_c_proveedor.php");
...
$io_proveedor = new tepuy_sme_c_proveedor();
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema  = "SME";
	$ls_ventanas = "tepuy_sme_d_proveedor.php";
...
<br>
  <table width="770" border="0" cellpadding="0" cellspacing="0" align="center" class="contorno">
    ...
    <tr>
      <td height="22">&nbsp;</td>
      <td height="22"><input name="botsocios" type="button" class="boton" id="botsocios" onClick="javascript: uf_socio(document.form1.txtcodigo.value)" value="Socios" <?php print $ls_disabled ?>> 
...
function uf_socio(prov)
{
  ...
  if (prov=="")
   ...
   else
      {
		...
		pagina="tepuy_sme_d_socio.php?txtprov="+prov +"&txtnombre="+ls_nomprov;
...
function uf_documento(prov)
{
   ...
   if (prov=="")
      ...
      {
        ls_nomprov=f.txtnombre.value;
		pagina="tepuy_sme_w_proxdoc.php?txtprov="+prov +"&txtnombre="+ls_nomprov;
		window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=600,height=500,resizable=yes,location=no");
	  }	
}
...
function uf_clasificacion(prov)
{
 ...
 if (prov=="")
    ...
    {
      ls_nomprov=f.txtnombre.value;
	  pagina="tepuy_sme_w_proxcla.php?txtprov="+prov +"&txtnombre="+ls_nomprov;
...
function uf_especialidad(prov)
{
 ...
 if (prov=="")
      ...
      {
 	    ls_nomprov=f.txtnombre.value;
		pagina="tepuy_sme_w_proxesp.php?codprov="+prov +"&nomprov="+ls_nomprov;
									                                         ...
									                                         {//29
																				if((f.chkestpro.checked==false)&&(f.chkestcon.checked==false))
																				{
																				 ...
																				 {//29
																				   ...
																				   f.action="tepuy_sme_d_proveedor.php";
																				   f.submit();
																				  }		  
										                                     }//29
									                                    }//27
...
/*Function:  ue_buscar()
    ...
    function ue_buscar()
    {
		...
		{
			f.operacion.value="";			
			pagina="tepuy_sme_cat_proveedores.php";
...
function catalogo_BCOSIGECOF()
{
	f=document.form1;
	f.operacion.value="";			
	pagina="tepuy_sme_cat_bancos_sigecof.php";
