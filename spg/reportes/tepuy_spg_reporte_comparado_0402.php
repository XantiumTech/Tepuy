...
/****************************************************************************************************************************************/	
class tepuy_spg_reporte_comparado_0402
{
    //conexion	
	var $sqlca;   
...
/****************************************************************************************************************************************/	
    function  tepuy_spg_reporte_comparado_0402()
    {
        ...
        $this->tepuy_int_spi=new class_tepuy_int_spi();
		...
		{   
		  ...
		  {		  
			  ...
			  if($ls_etiqueta=="Mensual")
			  {
				  ...
				  $ls_diahas=$this->io_fecha->uf_last_day($li_mesantdes,$li_ano);
...
/****************************************************************************************************************************************/
    ...
    { ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  if($lb_valido)
	  {
		...
		if($rs_data===false)
		{   // error interno sql
		   $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0717  MÉTODO->uf_spg_reportes_comparados_presupuesto_de_caja_0717  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		   $lb_valido = false;
		}
		else
		{
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación : 24/08/2006               Fecha última Modificacion :      Hora :
  	 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  $lb_valido = true;	 
	  $ls_sql=" SELECT salinipro, salinieje  FROM tepuy_empresa WHERE codemp='".$this->ls_codemp."' ";
	  $rs_data=$this->io_sql->select($ls_sql);
	  if($rs_data===false)
	  {   // error interno sql
		  $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0717  MÉTODO->uf_spg_reporte_select_saldo_empresa  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		  $lb_valido = false;
	  }
	  else
	  {
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    24/08/2006               Fecha última Modificacion :      Hora :
	  ...
	  if($rs_data===false)
	  {   // error interno sql
		  $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0717  
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    25/08/2006         Fecha última Modificacion :      Hora :
	  ...
	  $as_spi_cuenta=$this->tepuy_int_spi->uf_spi_cuenta_sin_cero($as_spi_cuenta)."%";
	  $ls_sql=" SELECT * ".
			  " FROM   spi_dt_cmp ".
	  ...
	  else
	  {
		while($row=$this->io_sql->fetch_row($rs_data))
		{
		  ...
		  $ls_opera=$this->tepuy_int_spi->uf_operacion_codigo_mensaje($ls_operacion);
...
/****************************************************************************************************************************************/
    ...
    { /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  if($lb_valido)
	  {
		...
		$la_cuenta[42]='407010200'.$ls_ceros;
		$la_cuenta[43]='407010300'.$ls_ceros;
		// ---> Otras Transferencias Corrientes Diversas
		$la_cuenta[44]='407030000'.$ls_ceros;
		$la_cuenta[45]='407030100'.$ls_ceros;
		$la_cuenta[46]='407030300'.$ls_ceros;
		$la_cuenta[47]='407020000'.$ls_ceros;
		$la_cuenta[48]='408080000'.$ls_ceros;
		$la_cuenta[49]='404000000'.$ls_ceros;
		$la_cuenta[50]='405000000'.$ls_ceros;
		// ---> Saldo Final
		...
		{  //=========================> Incluir encabezado en el datastore
		   ...
		   {				
			 case 14:
				 ...
				 /*print $ld_monto_programado_act."<br>";
				 print $ld_monto_programado_act_acumulado."<br>";
				 print $ld_monto_ejecutado_act."<br>";
				 print $ld_monto_ejecutado_act_acumulado."<br>";*/
				 ...
				 $adts_datastore->insertRow("tipo","B");
			 break;
			 case 16:
	   ...
	   // print_r($adts_datastore)."<br><br>";
		//actualiza total ingresos
		$ld_suma=0;
		$ld_suma=$adts_datastore->getValue("monto_ejecutado","3");
		$ld_suma=$ld_suma+$adts_datastore->getValue("monto_ejecutado","2");
		...
		$ld_suma_acumulado=0;
		$ld_suma_acumulado=$ld_suma_acumulado+$adts_datastore->getValue("monto_ejecutado_acumulado","3");
		$ld_suma_acumulado=$ld_suma_acumulado+$adts_datastore->getValue("monto_ejecutado_acumulado","2");
		$ld_suma_acumulado=$ld_suma_acumulado+$adts_datastore->getValue("monto_ejecutado_acumulado","17");
		$ld_suma_acumulado=$ld_suma_acumulado+$adts_datastore->getValue("monto_ejecutado_acumulado","25");
		$ld_suma_acumulado=$ld_suma_acumulado+$adts_datastore->getValue("monto_ejecutado_acumulado","41");
		
		$ld_suma_programado=0;
		$ld_suma_programado=$adts_datastore->getValue("monto_ejecutado","3");
		$ld_suma_programado=$ld_suma_programado+$adts_datastore->getValue("monto_programado","2");
		$ld_suma_programado=$ld_suma_programado+$adts_datastore->getValue("monto_programado","17");
		$ld_suma_programado=$ld_suma_programado+$adts_datastore->getValue("monto_programado","25");
		$ld_suma_programado=$ld_suma_programado+$adts_datastore->getValue("monto_programado","41");

		$ld_suma_programado_acumulado=0;
		$ld_suma_programado_acumulado=$ld_suma_programado_acumulado+$adts_datastore->getValue("monto_programado_acumulado","3");
		$ld_suma_programado_acumulado=$ld_suma_programado_acumulado+$adts_datastore->getValue("monto_programado_acumulado","2");
		$ld_suma_programado_acumulado=$ld_suma_programado_acumulado+$adts_datastore->getValue("monto_programado_acumulado","17");
		$ld_suma_programado_acumulado=$ld_suma_programado_acumulado+$adts_datastore->getValue("monto_programado_acumulado","25");
		$ld_suma_programado_acumulado=$ld_suma_programado_acumulado+$adts_datastore->getValue("monto_programado_acumulado","41");
		...
		if($li_pos>0)
		{
			...
			$adts_datastore->updateRow("monto_programado",$ld_suma_programado,$li_pos);	
			$adts_datastore->updateRow("monto_programado_acumulado",$ld_suma_programado_acumulado,$li_pos);	
		...
		if($li_pos>0)
		{
		 /* $ld_monto_programado_saling=$ld_monto_programado_ingreso+$ad_salinipro;
		  ...
		  $ld_monto_programado_saling=$ld_suma_programado+$ad_salinipro;
		  $ld_monto_programado_saling_acumulado=$ld_suma_programado_acumulado+$ad_salinipro;
		...
		$adts_datastore->insertRow("denominacion","<b>SALDO FINAL</b>");
		$adts_datastore->insertRow("tipo_cuenta",$ls_tipo_cuenta);
		$adts_datastore->insertRow("spg_cuenta",$ls_spg_cuenta);
		$adts_datastore->insertRow("status",$ls_status);
		$adts_datastore->insertRow("nivel",$li_nivel);
...
/****************************************************************************************************************************************/
    ...
    { /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  //    Fecha Creación :    28/08/2006                       Fecha última Modificacion :      Hora :
		...
		/*if($li_lent!=9)
		{
		  $as_spi_cuenta=substr($as_spi_cuenta,0,9);
		}*/
		$lb_valido=true;
		$ls_sql = "SELECT denominacion FROM tepuy_plan_unico_re WHERE sig_cuenta='".$as_spi_cuenta."' ";
		$rs_data=$this->io_sql->select($ls_sql);
		if($rs_data===false)
		{
			$lb_valido=false;
    ...
    { //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  $this->dts_ctas_ingreso->reset_ds();
	   ...
	   $ls_sql=" SELECT curCta.* ".
		...
		if($rs_data===false)
		{   // error interno sql
		   $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0717  MÉTODO->uf_spg_reportes_otros_ingresos  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		   $lb_valido = false;
		}
		else
		{
...
/****************************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    25/08/2006         Fecha última Modificacion :      Hora :
	  ...
	  if($rs_data===false)
	  { // error interno sql
		$this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0717  MÉTODO->uf_spg_reporte_calcular_ejecutado_otros_ingreso  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		$lb_valido = false;
 	  }
	  else
	  {
    ...
    { //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  //    Fecha Creación :    29/11/2006                       Fecha última Modificacion :      Hora :
	   ...
	   $ls_sql=" SELECT curCta.* ".
		...
		if($rs_data===false)
		{   // error interno sql
		   $this->io_msg->message("CLASE->tepuy_spg_reporte_comparado_0717  MÉTODO->uf_spg_reportes_otros_ingresos_propiedad  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		   $lb_valido = false;
		}
		else
		{
...
/****************************************************************************************************************************************/
    ...
    { //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  //    Fecha Creación :    30/11/2006                       Fecha última Modificacion :      Hora :
	   ...
	   //$ld_monto_programado_acumulado_total=0;
	   $lb_valido = true;	 
			   ...
			   if($lb_valido)
			   {
				  ...
				  if($lb_valido)
				  {
					...
					{	
						 ...
						 $this->dts_ctas_ingreso_actividad->insertRow("monto_programado_acumulado",$ld_monto_programado_acumulado);
						 $this->dts_ctas_ingreso_actividad->insertRow("monto_ejecutado",$ld_cobrado);
						 $this->dts_ctas_ingreso_actividad->insertRow("monto_ejecutado_acumulado",$ld_cobrado_acumulado);
