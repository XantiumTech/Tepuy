...
$io_classben = new tepuy_scv_c_beneficiario();
...
if ($ls_operacion=="BUSCAR")
   {
     ...
     $ls_sql = "SELECT rpc_beneficiario.codemp, rpc_beneficiario.ced_bene, rpc_beneficiario.codpai, rpc_beneficiario.codest,
	                   ...
	                   rpc_beneficiario.celbene, rpc_beneficiario.email, rpc_beneficiario.sc_cuenta, rpc_beneficiario.sc_cuenta_comp, rpc_beneficiario.codbansig,
...
function aceptar(cedula,nombre,apellido,direccion,telefono,celular,email,contable,denocontable,dencontablecomp,contablecomp,banco,cuenta,tipocuenta,pais,estado,municipio,parroquia,codbansig,denbansig,rifben,ls_fecregben,ls_nacben,ls_numpasben,ls_tipconben,ls_tipcuebanben)
{
