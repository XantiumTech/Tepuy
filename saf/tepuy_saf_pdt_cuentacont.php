...
<form name="form1" method="post" action="">
  <table width="525" border="0" align="center" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="97"><a href="javascript: ue_cancelar();"><img src="../shared/imagebank/tools15/eliminar.png" width="15" height="15" class="sin-borde">Cancelar</a></td>
    </tr>
  </table>
</form>
</body>
...
{
	window.open("tepuy_saf_cat_codactivo.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=630,height=400,left=50,top=50,location=no,resizable=yes");
}
