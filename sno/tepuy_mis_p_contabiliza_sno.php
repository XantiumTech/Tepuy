<?Php
	...
	$oi_fun_integrador->uf_load_seguridad("MIS","tepuy_mis_p_contabiliza_sno.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<?php
	...
	require_once("class_folder/class_tepuy_sno_integracion.php");  	
	$in_class = new class_tepuy_sno_integracion();  
	uf_limpiarvariables();
	switch ($ls_operacion) 
	{
		case "NUEVO":
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
    <td width="432" height="20" colspan="11" bgcolor="#E7E7E7"><table width="762" border="0" align="center" cellpadding="0" cellspacing="0">
        <td width="432" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de N&oacute;mina -><i>M&oacute;dulo Integrador</i></td>
...
<!--<tr>    <td height="20" colspan="11" bgcolor="#E7E7E7" class="cd-menu"><script type="text/javascript" language="JavaScript1.2" src="js/menu.js"></script></td>
  </tr> -->
  <tr>
  ...
  <table width="750" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td ><input name="txtcodperi" type="text" id="txtcodperi" size="6" maxlength="3" readonly>
        <a href="javascript: ue_buscarperiodo();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" name="periodo" width="15" height="15" border="0" id="periodo"></a>
...
function ue_procesar()
{
	...
	{	
		...
		if(lb_valido)
		{
			...
			f.action="tepuy_mis_p_contabiliza_sno.php";
			f.submit();
		}
		else
		{
...
{
	window.open("tepuy_mis_cat_nomina.php?tipo=contabilizar","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
}
...
function ue_buscarperiodo()
{
	...
	window.open("tepuy_mis_cat_periodo.php?tipo=contabilizar&codnom="+codnom+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
}
...
function uf_verdetalle(codcom)
{
	...
	window.open("tepuy_mis_pdt_sno.php?codcom="+codcom+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=500,height=400,left="+Xpos+",top="+Ypos+",location=no,resizable=no");
}
