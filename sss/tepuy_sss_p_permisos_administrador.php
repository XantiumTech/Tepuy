...
$io_fun_activo->uf_load_seguridad("SSS","tepuy_c_permisos_globales.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<?php
	...
	require_once("tepuy_sss_c_permisos_administrador.php");
	$io_sss= new tepuy_sss_c_permisos_administrador();
      ...
      <tr>
        <td height="13"><table width="383" height="86" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="87">&nbsp;</td>
            <td width="126">&nbsp;</td>
            <td width="68"><a href="javascript: ue_procesar();"><img src="../shared/imagebank/tools15/ejecutar.png" width="15" height="15" border="0">Procesar</a></td>
          </tr>
        </table></td>
      </tr>
    </table>
...
function ue_procesar()
{
	...
	if(li_ejecutar==1)
	{
		...
		if(ls_usuario!="---")
		{
			...
			f.action="tepuy_sss_p_permisos_administrador.php";
			f.submit();
		}
		else
		{
