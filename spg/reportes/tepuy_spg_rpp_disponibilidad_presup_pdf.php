	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('cuenta'=>array('justification'=>'left','width'=>100), // Justificación y ancho de la columna
									   ...
									   'disponibilidad'=>array('justification'=>'right','width'=>100))); // Justificación y ancho de
	 ...
	 else // Imprimimos el reporte
	 {
		...
		for($z=1;$z<=$li_tot;$z++)
		{
			...
			{ //print "entrooooo if"."<br>";
				...
				{
				// AQUI SE ENVIA LOS DATOS DE LA PROGRAMATICA //
...
// ESTA MODIFICACION ME PERMITE VISUALIZAR MEJOR EL CODIGO PRESUPUESTARIO //
		...
		// AGREGA . A LA CTA. PRESUPUESTARIA//
			...
			if (!empty($ls_programatica_next))
			{
				...
				uf_print_pie_cabecera($ld_totalasignado,$ld_totaldisponible,$io_pdf);				
