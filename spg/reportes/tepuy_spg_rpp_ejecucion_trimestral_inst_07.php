<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_moneda,$as_trimestre,&$io_pdf)
	{
		...
		$io_pdf->addText(22,384,7,"PARTIDA",270); // Columna, Altura,Tamaño, Texto, Giro
...
//-----------------------------------------------------------------------------------------------------------------------------
		global $la_data_tot;
		require_once("tepuy_spg_class_reportes_instructivos.php");
		$io_report = new tepuy_spg_class_reportes_instructivos();
			...
			$ls_status="";
				...
				//print "PAGADO: ".$ld_pagado_acum;
				  ...
				  if($ls_status == "C")
				  {
					...
					//print "ACUMULADO: ".$ld_total_pagado_acum;
				  } 
				  ...
				  $la_data[$z]=array('partida'=>$ls_partida,
