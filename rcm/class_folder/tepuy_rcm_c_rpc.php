<?php
class tepuy_rcm_c_rpc
{
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_rcm_c_rpc()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_rcm_c_rpc
		//		   Access: public 
...
/*		$ld_fecha=date("Y_m_d_H_i");
	...
	function uf_convertir_rpcproveedor()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_rpc MÉTODO->SELECT->uf_convertir_rpcproveedor ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
