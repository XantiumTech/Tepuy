	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('fecha'=>array('justification'=>'center','width'=>40), // Justificación y ancho de la columna
									   ...
									   'disminución'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
									   'montoactualizado'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
									   'precomprometido'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
									   'comprometido'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
	...
	function uf_print_pie_cabecera($la_data_tot,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
						 ...
						 'cols'=>array('total'=>array('justification'=>'right','width'=>150), // Justificación y ancho de la columna
									   'saldoporcomprometer'=>array('justification'=>'right','width'=>90), // Justificación y ancho de la columna
									   'asignado'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
						 			   'aumento'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
									   'disminución'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
									   'montoactualizado'=>array('justification'=>'right','width'=>80), // Justificación y ancho de la columna
