<?php
class tepuy_sep_class_reportbsf
{
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_sep_class_reportbsf()
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
								   ...
								   $ai_contabilizada,$ai_procesada,$ai_anulada,$ai_despachada,$as_orden)
	{
		...
		$ls_sql="SELECT numsol, sep_solicitud.codtipsol, sep_solicitud.coduniadm, codfuefin, fecregsol, estsol, ".
				"       consol, montoaux AS monto, monbasinmaux AS monbasinm, montotcaraux AS montotcar, tipo_destino, ".
				...
				"          codfuefin, fecregsol, estsol, consol, sep_solicitud.montoaux, sep_solicitud.monbasinmaux, ".
				"          sep_solicitud.montotcaraux, tipo_destino, sep_solicitud.cod_pro, sep_solicitud.ced_bene, ".
