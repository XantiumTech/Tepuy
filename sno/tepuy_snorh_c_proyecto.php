...
class tepuy_snorh_c_proyecto
{
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_snorh_c_proyecto()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_snorh_c_proyecto
		//		   Access: public (tepuy_snorh_d_proyecto)
	...
	}// end function tepuy_snorh_c_proyecto
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_insert_proyecto($as_codproy,$as_nomproy,$as_codpro,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$lb_valido=true;
		$ls_sql= "INSERT INTO sno_proyecto (codemp,codproy,nomproy,estproproy)VALUES('".$this->ls_codemp."','".$as_codproy."','".$as_nomproy."','".$as_codpro."')";
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_update_proyecto($as_codproy,$as_nomproy,$as_codpro,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_guardar($as_existe,$as_codproy,$as_nomproy,$as_codpro,$aa_seguridad)
	{		
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_guardar
		//		   Access: public (tepuy_snorh_d_proyecto)
		...
		switch ($as_existe)
		{
			case "FALSE":
				...
				{
					$lb_valido=$this->uf_insert_proyecto($as_codproy,$as_nomproy,$as_codpro,$aa_seguridad);
				}
				else
				{
			...
			case "TRUE":
				...
				{
					$lb_valido=$this->uf_update_proyecto($as_codproy,$as_nomproy,$as_codpro,$aa_seguridad);
				}
				else
				{
	...
	function uf_load_personalproyecto($as_codper,&$ai_totdiaper,&$ai_porcentaje,&$ai_totrows,&$aa_object)
	{
		...
		//		   Access: public (tepuy_sno_d_personaproyecto.php)
		...
		else
		{
			...
			while($row=$this->io_sql->fetch_row($rs_data))
			{
				...
				$aa_object[$ai_totrows][1]="<div align='center'><a href=javascript:ue_eliminarproyecto('$ls_codproy');><img src='../shared/imagebank/tools20/eliminar.png' alt='Eliminar' width='15' height='15' border='0'></a></div>";
	...
	{		
		...
		//		   Access: public (tepuy_sno_d_personaproyecto)
		//	    Arguments: as_codper  // código del Personal
		//				   as_codproy  // Código del proyecto
		//				   ai_totdiaper  // total de días Habiles del periodo
		//				   ai_totdiames  // total de días hábiles de las personas en el proyecto
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_update_proyecto_historico($as_codproy,$as_nomproy,$as_codpro,$aa_seguridad)
	{
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
