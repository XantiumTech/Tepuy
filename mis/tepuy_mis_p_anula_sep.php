<?php
	...
	$oi_fun_integrador->uf_load_seguridad("MIS","tepuy_mis_p_anula_sep.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
		...
		case "PROCESAR":
			...
			for($li_i=1;$li_i<=$li_totrows;$li_i++)
			{
				if(array_key_exists("chksel".$li_i,$_POST))
				{
					...
					$lb_valido=$in_class->uf_procesar_anulacion_solicitud_sep($ls_numsol,$ls_fechaconta,$ls_fecha,$la_seguridad);
					if($lb_valido)
					{
...
function ue_procesar()
{
	...
	if(li_ejecutar==1)
	{
		...
		if(lb_valido)
		{
			...
			f.action="tepuy_mis_p_anula_sep.php";
			f.submit();
		}
		else
		{
