...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_disponibilidad_formato2.php";
    ...
    <tr>
      <td colspan="3" align="center"><div align="left"></div>        <div align="left"></div>        <div align="left" class="style14"></div>        <div align="left">
        <table width="559" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="4"><strong>Intervalos de Fechas </strong></td>
          </tr>
          <tr>
            <td width="112" height="22"><div align="right">Hasta</div></td>
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			else
			{
				...
				{
				  pagina="reportes/tepuy_spg_rpp_disponibilidad_formato2.php?codestpro1="+codestpro1
							...
							+"&txtcuentahas="+txtcuentahas+"&txtfechas="+txtfechas+"&tipoformato="+tipoformato
