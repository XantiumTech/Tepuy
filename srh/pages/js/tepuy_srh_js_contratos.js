...
var url= "../../php/tepuy_srh_a_contratos.php";
var metodo='get';
...
function ue_guardar()
{
  lb_valido=true;
  lb_valido2=true;
  var la_objetos=new Array ("txtnroreg","txtcodper", "txtcodtipcon", "txtfecini", "txtfecfin", "txtdes",  "txtmontocon", "comboestcon");
  
 
 var la_mensajes=new Array ("el numero de registro", "el código personal",   "el código del tipo de contrato", "la fecha de inicio del contrato", "la fecha de culminación del contrato", "la descripción del contrato", "el monto","el estado del contrato");
...
function catalogo_tipocontrato()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_tipocontrato.php?valor_cat=0";
...
function catalogo_personal()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_personal.php?valor_cat=0"+"&tipo=12";
...
function catalogo_solicitud_empleo()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_solicitud_empleo.php?valor_cat=0"+"&tipo=8";
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_contratos.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=580,height=420,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
...
{
      f= document.form1;
	  pagina="../catalogos/tepuy_srh_cat_cargo.php?valor_cat=0";
      window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
{
   pagina="../catalogos/tepuy_srh_cat_cargo_rac.php?valor_cat=0&tipo=2";
