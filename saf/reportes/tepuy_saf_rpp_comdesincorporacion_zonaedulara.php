<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_cmpmov,$ad_fecha,&$io_pdf)
	{
		...
		//$io_pdf->addJpegFromFile('../../shared/imagebank/LOGO ZONA EDUCATIVA LARA.jpg',12,540,240,50); // Agregar Logo
		...
		$io_pdf->addText(670,530,8,"Fecha:  ".date("d/m/Y")); // Agregar la Fecha
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_columna=array('cantidad'=>'<b>Cantidad</b>',
						  ...
						  'codcau'=>'<b>                                Desincorporación                                           Código                     Descripción</b>',
