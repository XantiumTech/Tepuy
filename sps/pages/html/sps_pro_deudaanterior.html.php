          ...
          <table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
            ...
            <tr>
              ...
              <td width="351" ><input name="txtcodper" type="text" id="txtcodper" style="text-align:center" value="" size="15" maxlength="10">
                <label><a href="javascript: ue_buscarpersonal();"><img src="../../../shared/imagebank/tools20/buscar.png" alt="Buscar" name="personal" width="20" height="20" border="0" id="personal"></a></label></td>
            </tr>
            <tr>
              <td></td>
              <td>&nbsp;</td>
