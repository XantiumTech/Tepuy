<?php
	...
	function uf_insert_seguridad($as_titulo)
	{
		...
		$lb_valido=$io_fun_scg->uf_load_seguridad_reporte("SCG","tepuy_scg_r_comparados_forma0714.php",$ls_descripcion);
		return $lb_valido;
	}
	//-----------------------------------------------------------------------------------------------------------------------------------
	...
	//--------------------------------------------------------------------------------------------------------------------------------
		...
		require_once("tepuy_scg_reporte_comparado_0714.php");
		$io_report = new tepuy_scg_reporte_comparado_0714();
		...
		switch($ls_tiporeporte)
		{
			...
			case "1":
				require_once("tepuy_scg_reporte_comparado_0714bsf.php");
				$io_report  = new tepuy_scg_reporte_comparado_0714bsf();
				$ls_bolivares ="Bs.F.";
				break;
		}
