<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_fecha,$as_numorddes,&$io_pdf)
	{
		...
		$io_pdf->line(280,40,280,110);	
		$io_pdf->line(520,40,520,110);		
		$io_pdf->addText(130,102,7,"ELABORADO POR"); // Agregar el título
		$io_pdf->addText(110,43,7,"ÁREA DE ALMACÉN Y SERVICIOS"); // Agregar el título
		//$io_pdf->addText(245,102,7,"VERIFICADO POR"); // Agregar el título
		//$io_pdf->addText(250,43,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(370,102,7,"AUTORIZADO POR"); // Agregar el título
		$io_pdf->addText(320,43,7,"DIRECCIÓN DE ADMINISTRACIÓN Y PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(585,102,7,"MATERIALES RECIBIDOS"); // Agregar el título
		$io_pdf->addText(565,43,7,"FIRMA AUTOGRAFA, SELLO, FECHA"); // Agregar el título
		$io_pdf->restoreState();
		$io_pdf->closeObject();
