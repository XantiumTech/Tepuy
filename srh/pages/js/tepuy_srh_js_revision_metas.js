...
var url= "../../php/tepuy_srh_a_revision_metas.php";
var metodo='get';
...
function ue_nuevo()
{
  ...
  f.action="tepuy_srh_p_revision_metas.php";
  f.submit();
}
...
function Consultar()
{
     if  ($('txtnroreg').value=="")  		
	 {
	  ...
	  f.operacion.value="CONSULTAR";
  	  f.action="../pantallas/tepuy_srh_p_revision_metas.php";
	  f.existe.value="TRUE";			
	  f.submit();	
	 }
}
...
{
  pagina="../catalogos/tepuy_srh_cat_registro_metas.php?valor_cat=0";
  window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,resizable=yes,location=no,dependent=yes");
...
function ue_buscar()
{
	...
	if(li_leer==1)
	{
		window.open("../catalogos/tepuy_srh_cat_revision_metas.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
