...
var url= "../../php/tepuy_srh_a_revisiones_odi.php";
var metodo='get';
var img="<img src=\"../../../public/imagenes/progress.gif\"> ";


var loadDataURL = "../../php/tepuy_srh_a_revisiones_odi.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_revisiones_odi.php";
var mygrid;
...
function Buscar()
{
	...
	if (!valfecha)
	 ...
	 else
	 {
		...
		mygrid.loadXML("../../php/tepuy_srh_a_revisiones_odi.php?valor=buscar"+"&txtfechades="+fechades+"&txtfechahas="+fechahas+"&txtnroreg="+nroreg);
...
function aceptar ( ls_nroreg, ls_fecha, ls_apeper, ls_nomper, ls_codper,ls_apeeva, ls_nomeva, ls_codeva, ls_careva,ls_fecini,ls_fecfin, ls_rev, ls_nrodestino,ls_codperdestino, ls_fechadestino,  ls_nomdestino, ls_fecinidestino,  ls_fecfindestino, ls_codevadestino,ls_nomevadestino,ls_carevadestino,ls_revdestino, ls_carper,ls_carperdestino)
	{
		...
		obj10.value=ls_rev;
	     ...
	     ls_ejecucion=document.form1.hidstatus.value;
			...
			opener.document.form1.action="../pantallas/tepuy_srh_p_revisiones_odi.php";
...
function catalogo_registro_odi ()
{
   ...
   pagina="../catalogos/tepuy_srh_cat_odi.php?valor_cat=0";
