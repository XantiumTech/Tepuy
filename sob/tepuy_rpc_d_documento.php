...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
  ...
  <tr>
	...
	<table width="778" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <td width="423" height="20" bgcolor="#E7E7E7" class="descripcion_sistema">Sistema de Control Obras</td>
...
$io_documento = new tepuy_rpc_c_documento($conn);//Instanciando la Clase tepuy Definiciones.
...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="RPC";
	$ls_ventanas="tepuy_rpc_d_documento.php";
	 ...
	 if ($lb_existe)
        { 
		  ...
		  elseif($ls_estatus=="GRABADO")
		     {
		       $lb_valido=$io_documento->uf_update_documento($ls_codemp,$ls_codigo,$ls_dendoc,$la_seguridad);
	           if ($lb_valido)
				  {
					$io_sql->commit();
	   ...
	   {  
		  $lb_valido=$io_documento->uf_insert_documento($ls_codemp,$ls_codigo,$ls_dendoc,$la_seguridad);
          if ($lb_valido)
		      {
			    $io_sql->commit();
...
function ue_nuevo()
{
   ...
   if(li_incluir==1)
   {
	  ...
	  f.action="tepuy_rpc_d_documento.php";
	  f.submit();
   }
   else
   {
...
function ue_buscar()
{
	...
	{
		f.operacion.value="";			
		pagina="tepuy_rpc_cat_documento.php";
