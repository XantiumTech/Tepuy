...
class tepuy_srh_c_evaluacion_ascenso
{
	var $obj="";
	var $io_sql;
	var $siginc;
...
function tepuy_srh_c_evaluacion_ascenso($path)
	{   
  ...
  {  
		...
		//         access: public (tepuy_srh_evaluacion_ascenso)														         
...
function uf_srh_guardar_dt_evaluacion_ascenso($ao_evaluacion, $aa_seguridad)
  { 
		...
		//         access: public (tepuy_dt_srh_evaluacion_ascenso)														
...
function uf_srh_eliminar_dt_evaluacion_ascenso($as_nroreg,$as_fecha, $aa_seguridad)
  {
		...
		//        access:  public (tepuy_srh_dt_evaluacion_ascenso)														
		//      Argumento: $as_nroreg        // numero de la evaluacion de ascenso
		//                 $as_fecha		// fecha de la evaluación de ascenso
		//                 $aa_seguridad    //  arreglo de registro de seguridad                                                
		//	      Returns: Retorna un Booleano																				    
...
}// end   class tepuy_srh_c_evaluacion_ascenso
?>