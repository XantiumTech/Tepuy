<?PHP
	...
	function uf_insert_seguridad($as_titulo,$as_titulo2,$as_desnom,$as_periodo,$ai_tipo)
	{
		...
		if($ai_tipo==1)
		{
			$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte_nomina("SNO","tepuy_sno_r_contableingresos.php",$ls_descripcion,$ls_codnom);
		}
		else
		{
			$lb_valido=$io_fun_nomina->uf_load_seguridad_reporte_nomina("SNO","tepuy_sno_r_contableingresos.php",$ls_descripcion,$ls_codnom);
	...
	$ls_reporte=$io_report->uf_select_config("SNO","REPORTE","CONTABLE_CONCEPTOSINGRESOS","tepuy_sno_rpp_contableingresos.php","C");
	if($ls_reporte!="tepuy_sno_rpp_contableingresos.php")
	{
