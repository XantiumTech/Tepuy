...
/********************************************************************************************************************************/	
class tepuy_spg_reportes_class
{
    //conexion	
	var $sqlca;   
	...
	var $li_estmodest;
/********************************************************************************************************************************/	
    function  tepuy_spg_reportes_class()
    {
...
/********************************************************************************************************************************/	
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    07/09/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_seguridad="";
	  $this->io_spg_report_funciones->uf_filtro_seguridad_programatica('CT',$ls_seguridad);
	   ...
	   if($this->li_estmodest==2)
		{
			...
			{	
				$as_codestpro1_ori=$this->io_function->uf_cerosizquierda($as_codestpro1_ori,20);
			...
			{
				$as_codestpro2_ori=$this->io_function->uf_cerosizquierda($as_codestpro2_ori,6);
			...
			{	
				$as_codestpro3_ori=$this->io_function->uf_cerosizquierda($as_codestpro3_ori,3);
			...
			{	
				$as_codestpro1_des=	$this->io_function->uf_cerosizquierda($as_codestpro1_des,20);
			...
			{	
				$as_codestpro2_des=$this->io_function->uf_cerosizquierda($as_codestpro2_des,6);
			...
			{	
				$as_codestpro3_des=$this->io_function->uf_cerosizquierda($as_codestpro3_des,3);
		...
		{
			$ls_estructura_desde=$this->io_function->uf_cerosizquierda($as_codestpro1_ori,20).$this->io_function->uf_cerosizquierda($as_codestpro2_ori,6).$this->io_function->uf_cerosizquierda($as_codestpro3_ori,3).$as_codestpro4_ori.$as_codestpro5_ori;
			$ls_estructura_hasta=$this->io_function->uf_cerosizquierda($as_codestpro1_des,20).$this->io_function->uf_cerosizquierda($as_codestpro2_des,6).$this->io_function->uf_cerosizquierda($as_codestpro3_des,3).$as_codestpro4_des.$as_codestpro5_des;
		}	  
	 /* if (strtoupper($ls_gestor)=="MYSQL")
	  {
		   $ls_cadena_ct="CONCAT(CT.codestpro1,CT.codestpro2,CT.codestpro3,CT.codestpro4,CT.codestpro5)";
		   $ls_cadena_e="CONCAT(E.codestpro1,E.codestpro2,E.codestpro3,E.codestpro4,E.codestpro5)";
	  }
	  else
	  {
		   $ls_cadena_ct="CT.codestpro1||CT.codestpro2||CT.codestpro3||CT.codestpro4||CT.codestpro5";
		   $ls_cadena_e="E.codestpro1||E.codestpro2||E.codestpro3||E.codestpro4||E.codestpro5";
	  }*/
	  ...
	  if (strtoupper($ls_gestor)=="MYSQL")
	  {
		   ...
		   {
			   $ls_tabla="spg_ep3"; 
			   $ls_cadena="CONCAT(CT.codestpro1,CT.codestpro2,CT.codestpro3,CT.codestpro4,CT.codestpro5)";
			   $ls_cadena_ct="CONCAT(CT.codestpro1,CT.codestpro2,CT.codestpro3)";
			   $ls_cadena_e="CONCAT(E.codestpro1,E.codestpro2,E.codestpro3)";
		   }
	  ...
	  else
	  {
		   ...
		   {
			   $ls_tabla="spg_ep3"; 
			   $ls_cadena="CT.codestpro1||CT.codestpro2||CT.codestpro3||CT.codestpro4||CT.codestpro5";
			   $ls_cadena_ct="CT.codestpro1||CT.codestpro2||CT.codestpro3";
			   $ls_cadena_e="E.codestpro1||E.codestpro2||E.codestpro3";
		   }
		   elseif($this->li_estmodest==2)
		   {
			   $ls_tabla="spg_ep5";
	  ...
	  $ls_sql=" SELECT CT.* ".
			  ...
			  " WHERE CT.codemp='".$this->ls_codemp."' AND   ".
			  ...
			  "	     ".$ls_cadena_ct."= ".$ls_cadena_e."  AND CT.status='C'  ".$ls_seguridad." ".
			  " ORDER BY CT.codestpro1,CT.codestpro2,CT.codestpro3,CT.codestpro4,CT.codestpro5,spg_cuenta ";
			 
	/* $ls_sql=" SELECT CT.*, E.denestpro5 ".
             " FROM   spg_cuentas CT, spg_ep5 E ".
	...
	if($rs_data===false)
	{   // error interno sql
		   $this->io_msg->message("CLASE->tepuy_spg_reporte_class  
...
/********************************************************************************************************************************/	
	/////////////////////////////////////////////////////////////////////////
	//   CLASE REPORTES SPG  LISTADO  " UNIDADES actividadS "             //
	///////////////////////////////////////////////////////////////////////
    function uf_spg_reportes_unidades_actividads($as_codestpro1_ori,$as_codestpro2_ori,$as_codestpro3_ori,
	                                             $as_codestpro4_ori,$as_codestpro5_ori,$as_coduniadm_des,$as_coduniadm_has,
												 $ai_estemireq,$as_ckq_unidad,$as_codfuefindes,$as_codfuefinhas)
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_spg_reportes_unidades_actividads
	 //     Argumentos :    as_codestpro1_ori ... $as_codestpro5_ori //rango nivel estructura presupuestaria origen
	 //                     as_codestpro1_des ... $as_codestpro5_des //rango nivel estructura presupuestaria destino
     //	       Returns :	Retorna true o false si se realizo la consulta para el reporte
	 //	   Description :	Reporte que genera salida  del Ejecucion Financiera Formato 3
	 ...
	 // Fecha Creación :    07/09/2006          Fecha última Modificacion :      Hora :
	  ...
	  if($this->li_estmodest==2)
		...
		if(strtoupper($ls_gestor)=="MYSQL")
			{
			   $ls_concat=" AND CONCAT(codestpro1,codestpro2,codestpro3,codestpro4,codestpro5)";
			}
			else
			{
			   $ls_concat=" AND (codestpro1||codestpro2||codestpro3||codestpro4||codestpro5)";
			}
	  if($ai_estemireq==1)
	  {
...
//	print $ls_sql;
	  ...
	  {   // error interno sql
		   $this->io_msg->message("CLASE->tepuy_spg_reporte_class  
		                           MÉTODO->uf_spg_reportes_unidades_actividads  
								   ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
			$lb_valido = false;
	  }
      else
      {
			while($row=$this->io_sql->fetch_row($rs_data))
			{
			   if($this->li_estmodest==2)
			   {
			   		$ls_programatica=substr($row["codestpro1"],-2)."-".substr($row["codestpro2"],-2)."-".substr($row["codestpro3"],-2)."-".$row["codestpro4"]."-".$row["codestpro5"];
			   }
			   else
			   {
			   		$ls_programatica=$row["codestpro1"].$row["codestpro2"].$row["codestpro3"];
			   }
      ...
      else
      {
		  ...
		  for($li_i=1;$li_i<=$li_total;$li_i++)
		  {
			  ...
			  if($lb_valido)
			  {
				...
				$ls_sql=" SELECT PMV.*, POP.asignar, POP.aumento, POP.disminucion, POP.comprometer, POP.causar, POP.pagar ".
						" FROM   tepuy_cmp PCM, spg_dt_cmp PMV, spg_operaciones POP ".
    ...
    {//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    19/09/2006               Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT CM.*, PR.nompro as nompro,".$ls_cadena."  as nombene ".
              " FROM   tepuy_cmp CM, rpc_proveedor PR, rpc_beneficiario XBF ".
...
/********************************************************************************************************************************/	
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    22/09/2006          Fecha última Modificacion :      Hora :
	  ...
	  if ($rs_data===false)
	     {
		   $this->io_msg->message("CLASE->tepuy_spg_reporte_class.MÉTODO->uf_spg_reportes_compromiso_no_causados.ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		   $lb_valido = false;
	     }
      else
         {
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    22/09/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT distinct PCM.procede, PCM.comprobante, PCM.fecha, PCM.descripcion, PCM.total, PCM.tipo_destino,    	".
			  "					PCM.cod_pro, PRV.nompro,PCM.ced_bene, BEN.nombene, PMV.operacion 							".
			  "         FROM tepuy_cmp PCM, spg_dt_cmp PMV, rpc_proveedor PRV, rpc_beneficiario BEN, spg_operaciones POP   ".
			  "					WHERE PMV.codemp  = PCM.codemp 																".
			  "					AND   PMV.comprobante  = PCM.comprobante 													".
			  "					AND   PMV.fecha = PCM.fecha 																".
			  "					AND   PMV.codban = PCM.codban 																".
			  "					AND   PMV.ctaban  = PCM.ctaban 																".
			  "					AND   PMV.procede = PCM.procede 															".
			  "					AND   PRV.codemp = PCM.codemp 																".
			  "					AND   PRV.cod_pro = PCM.cod_pro 															".
			  "					AND   BEN.codemp = PCM.codemp 																".
			  "					AND   BEN.ced_bene = PCM.ced_bene 															".
			  "					AND   PMV.operacion=POP.operacion 															".
      ...
      {    
	        $total=$this->io_sql->num_rows($rs_data);
			$i=0; 
			while($i<$total)
			{
			   $i++;
			   ...
			   if($lb_valido)
			   {
				  ...
				  {    
					  ...
					  {
						   //print  "Comprobante Causado Parcialmente: ".$ls_comprobante." - ".$ls_procede." - ".$ldt_fecha."<br><br>";
						   $ls_programatica=$ls_codestpro1.$ls_codestpro2.$ls_codestpro3.$ls_codestpro4.$ls_codestpro5;
						   $this->dts_reporte_final->insertRow("programatica",$ls_programatica);
						   $this->dts_reporte_final->insertRow("codestpro1",$ls_codestpro1);
						   $this->dts_reporte_final->insertRow("codestpro2",$ls_codestpro2);
						   ...
						   $this->dts_reporte_final->insertRow("comprobante",$ls_comprobante);
						   $this->dts_reporte_final->insertRow("fecha",$ldt_fecha);
						   $this->dts_reporte_final->insertRow("compromiso",$ld_total_comprometer);
						   $this->dts_reporte_final->insertRow("causado",$ld_causado);					 					 
						   $this->dts_reporte_final->insertRow("pagado",$ld_pagado);
						   $this->dts_reporte_final->insertRow("nompro",$ls_nompro);
						   $this->dts_reporte_final->insertRow("nombene",$ls_nombene);
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    22/09/2006          Fecha última Modificacion :      Hora :
	  ...
	  $ls_sql=" SELECT distinct PCM.procede, PCM.comprobante, PCM.fecha, PCM.descripcion, PCM.total, PCM.tipo_destino, ".
              ...
              " FROM   tepuy_cmp PCM, rpc_proveedor PRV, rpc_beneficiario XBF, spg_dt_cmp PMV, spg_operaciones POP    ".
...
/********************************************************************************************************************************/	
    ...
    {///////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 // Fecha Creación :    25/09/2006          Fecha última Modificacion :      Hora :
	  ...
	  $adt_fecdes=$this->io_function->uf_convertirdatetobd($adt_fecdes);
	  $adt_fechas=$this->io_function->uf_convertirdatetobd($adt_fechas);
	  $ls_sql=" SELECT  spg_dt_cmp.spg_cuenta,tepuy_cmp.tipo_destino,spg_dt_cmp.*,rpc_beneficiario.apebene,tepuy_cmp.cod_pro, ".
              ...
              "         case when (substr(tepuy_cmp.cod_pro,1,1)='-' and substr(tepuy_cmp.ced_bene,1,1)='-')          ".
			  "                    then spg_dt_cmp.descripcion                                                          ".
	  	      "              when (substr(tepuy_cmp.ced_bene,1,1)='-' and substr(tepuy_cmp.cod_pro,1,1)!='-')         ".
			  "                    then rpc_proveedor.nompro                                                            ".
	  	      "              when (substr(tepuy_cmp.cod_pro,1,1)='-' and substr(tepuy_cmp.ced_bene,1,1)!='-')         ".
			  "                    then ".$ls_cadena."  end  AS nom_benef                                               ".
              " FROM   spg_dt_cmp,spg_operaciones,tepuy_cmp,rpc_beneficiario ,rpc_proveedor ,spg_cuentas               ".
			  ...
			  "   AND  spg_dt_cmp.codemp=tepuy_cmp.codemp                          									".
			  "   AND  tepuy_cmp.codemp=rpc_beneficiario.codemp       													".
			  ...
			  "   AND  tepuy_cmp.cod_pro=rpc_proveedor.cod_pro        													".
			  "   AND  tepuy_cmp.ced_bene=rpc_beneficiario.ced_bene                                              		".
		...
		$ls_sql=" SELECT spg_cuenta, descripcion, codestpro1, codestpro2, codestpro3, codestpro4, codestpro5, operacion, ".
		  ...
		  else
		  {
			while($row=$this->io_sql->fetch_row($rs_data))
			{
			  $ls_operacion=$row["operacion"];
			  $ld_monto=$row["monto"];
			  $ls_mensaje = $this->tepuy_int_spg->uf_operacion_codigo_mensaje($ls_operacion);
      ...
      else
      {
		...
		if($lb_valido)
		{
		  ...
		  {	  
			...
			{
  			   $lb_valido=$this->uf_tepuy_reportes_calcular_monto_operacion($ls_operacion,$ld_monto,$ld_asignado,$ld_aumento,
...
/********************************************************************************************************************************/	
    function uf_tepuy_reportes_calcular_monto_operacion($as_operacion,$ad_monto,&$ad_asignado,&$ad_aumento,&$ad_disminucion,
	                                                     &$ad_pre_comprometido,&$ad_comprometido,&$ad_causado,&$ad_pagado)
    {///////////////////////////////////////////////////////////////////////////////////////////////////////////
	 //	      Function :	uf_tepuy_reportes_calcular_monto_operacion
	 //     Argumentos :    
     //	       Returns :	Retorna true o false si se realizo la consulta para el reporte
	 //	   Description :	Reporte que genera salida las operaciones por especificas 
	 //     Creado por :    Ing. Miguel Palencia.
	 // Fecha Creación :    25/09/2006          Fecha última Modificacion :      Hora :
  	 //////////////////////////////////////////////////////////////////////////////////////////////////////////
	  $lb_valido = true;
	  $ls_mensaje = $this->tepuy_int_spg->uf_operacion_codigo_mensaje($as_operacion);
	  $ls_mensaje=strtoupper($ls_mensaje); // devuelve cadena en MAYUSCULAS
	  //I-Asignacion
	  $li_pos_i=strpos($ls_mensaje,"I"); 
	  if (!($li_pos_i===false)) 
	...
	return $lb_valido;
   }//fin  uf_tepuy_reportes_calcular_monto_operacion
/********************************************************************************************************************************/	
	///////////////////////////////////////////////////////////////////////////////////////
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////
	  ...
	  $ls_sql=" SELECT scb_movbco_spg.spg_cuenta,scb_movbco.comprobante,scb_movbco.codban, 			".
			  ...
			  "        scb_movbco_spg.monto,spg_cuentas.denominacion as dencuenta                   ".
	  ...
	  if ($rs_data===false)
		 {
		   $this->io_msg->message("CLASE->tepuy_spg_reporte_class.MÉTODO->uf_spg_reportes_operacion_por_banco.ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
			$lb_valido = false;
		 }
	  return  $rs_data;
...
/********************************************************************************************************************************/
	...
	function uf_select_nombreusuario($as_codemp,$as_procede,$as_comprobante)
	{
		 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		 //	      Function :	uf_select_nombreusuario
		 //         Access :	private
		 //     Argumentos :    codemp, pocede y el comprobante
		 //	       Returns :	Retorna nombre y apellido del usuario que aporbo
		 //     Creado por :    Ing. Miguel Palencia.
		 // Fecha Creación :    04/02/2016
		 ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		
		 $ls_sql = "SELECT tepuy_cmp_md.codusu,
				   CONCAT(sss_usuarios.nomusu,' ',sss_usuarios.apeusu) as nombre
					  FROM tepuy_cmp_md, sss_usuarios
					 WHERE tepuy_cmp_md.codemp='".$as_codemp."'
					   AND tepuy_cmp_md.procede='".$as_procede."'
					   AND tepuy_cmp_md.comprobante='".$as_comprobante."'
					   AND tepuy_cmp_md.codemp=sss_usuarios.codemp
					   AND tepuy_cmp_md.codusu=sss_usuarios.codusu
				  ORDER BY tepuy_cmp_md.codusu";//print $ls_sql.'<br><br><br>';
		 $rs_data = $this->io_sql->select($ls_sql);
		 if ($rs_data===false)
			{
			  $this->io_msg->message("Error en consulta metodo->uf_select_nombreusuario ".$this->io_function->uf_convertirmsg($this->io_sql->message));
			  $lb_valido = false;  
			}
		 else
		{
...
/********************************************************************************************************************************/
	...
	function uf_select_dt_comprobante($as_codemp,$as_procede,$as_comprobante,$ad_fecha,&$ai_numrows,&$rs_data)
	{
		 ...
		 $ls_sql = "SELECT spg_dtmp_cmp.codestpro1,
						...
						//   tepuy_cmp_md.codusu,
					"	   MAX(spg_dtmp_cmp.spg_cuenta) AS spg_cuenta,
						   spg_dtmp_cmp.operacion,
						   MAX(spg_dtmp_cmp.descripcion) AS descripcion,
						   SUM(spg_dtmp_cmp.monto) AS monto,
						   MAX(tepuy_fuentefinanciamiento.denfuefin) AS denfuefin,
						   MAX(spg_ministerio_ua.denuac) AS denuac
					  FROM tepuy_cmp_md, spg_dtmp_cmp, tepuy_fuentefinanciamiento, spg_ministerio_ua
					 WHERE tepuy_cmp_md.codemp='".$as_codemp."'
					   AND tepuy_cmp_md.procede='".$as_procede."'
					   AND tepuy_cmp_md.comprobante='".$as_comprobante."'
					   AND tepuy_cmp_md.fecha='".$ld_fecha."'
					   AND tepuy_cmp_md.codemp=spg_dtmp_cmp.codemp
					   AND tepuy_cmp_md.procede=spg_dtmp_cmp.procede
					   AND tepuy_cmp_md.comprobante=spg_dtmp_cmp.comprobante
					   AND tepuy_cmp_md.fecha=spg_dtmp_cmp.fecha
					   AND tepuy_cmp_md.codemp=tepuy_fuentefinanciamiento.codemp
					   AND tepuy_cmp_md.codfuefin=tepuy_fuentefinanciamiento.codfuefin
					   AND tepuy_cmp_md.codemp=spg_ministerio_ua.codemp
					   AND tepuy_cmp_md.coduac=spg_ministerio_ua.coduac
				  GROUP BY 	spg_dtmp_cmp.codestpro1,spg_dtmp_cmp.codestpro2,spg_dtmp_cmp.codestpro3,
				            spg_dtmp_cmp.codestpro4,spg_dtmp_cmp.codestpro5,spg_dtmp_cmp.operacion,spg_dtmp_cmp.spg_cuenta 
				  ORDER BY spg_dtmp_cmp.operacion DESC,spg_dtmp_cmp.codestpro1,spg_dtmp_cmp.codestpro2,spg_dtmp_cmp.codestpro3,spg_dtmp_cmp.codestpro4,
						   spg_dtmp_cmp.codestpro5,spg_dtmp_cmp.spg_cuenta";//print $ls_sql.'<br><br><br>';
		//print $ls_sql;die();
		 $rs_data = $this->io_sql->select($ls_sql);
		 if ($rs_data===false)
			{
...
/********************************************************************************************************************************/
 function uf_select_denctaspg($as_codemp,$as_codestpro1,$as_codestpro2,$as_codestpro3,$as_codestpro4,$as_codestpro5,$as_spgcta)
 {
	global $io_sql;
	$ls_denctaspg="";
...
/********************************************************************************************************************************/
	function uf_select_data($ls_sql,$ls_campo1,$ls_campo2,&$ls_variable1,&$ls_variable2)
	{
		  global $io_sql;
		  $lb_valido = true;
		  $rs_data   = $io_sql->select($ls_sql);//print "Sentencia =>".$ls_sql.'<br><br><br><br>';
		  if ($rs_data===false)
			 {
			   $lb_valido = false;
			   print $io_sql->message;
		 ...
		 if($lb_valido)
		 {
			if ($ai_numrows)
			{
				 ...
				 { // while
						...
						if ($li_pos=='1'){
						 $this->io_dsreport->insertRow("sector","");
						 $this->io_dsreport->insertRow("programa","");
						 $this->io_dsreport->insertRow("actividad","");
						 ...
						 $this->io_dsreport->insertRow("auxiliar","");
					///////////////     NUEVO      ////////////////////////
 						 $this->io_dsreport->insertRow("sector1","");
						 $this->io_dsreport->insertRow("programa1","");
						 $this->io_dsreport->insertRow("actividad1","");
						 $this->io_dsreport->insertRow("partida1","");
						 $this->io_dsreport->insertRow("generica1","");
						 $this->io_dsreport->insertRow("especifica1","");
						 $this->io_dsreport->insertRow("subespecifica1","");
						 $this->io_dsreport->insertRow("auxiliar1","");
					///////////////////////////////////////////////////////////
						 $this->io_dsreport->insertRow("sector2","");
						 $this->io_dsreport->insertRow("programa2","");
						 $this->io_dsreport->insertRow("actividad2","");
						 ...
						 $this->io_dsreport->insertRow("auxiliar2","");
					...
					///////////////////////////////////////////////////////////
						 ...
						 $li_encontrado = $this->io_dsreport->findValues(array('sector2'=>$ls_estpro1_aux,'operacion'=>$ls_operacion),'sector');
						 if ($li_encontrado<=0) // INSERTA LA LINEA A NIVEL DE SECTOR .$li_pos
							{
							 $this->io_dsreport->insertRow("sector",$ls_estpro1_aux);
							 $this->io_dsreport->insertRow("programa","");
							 $this->io_dsreport->insertRow("actividad","");
							 $this->io_dsreport->insertRow("partida","");
							 $this->io_dsreport->insertRow("generica","");
						 	...
						 	$this->io_dsreport->insertRow("auxiliar1","");
						///////////////////////////////////////////////////////////
							 $this->io_dsreport->insertRow("sector2",$ls_estpro1_aux);
							 $this->io_dsreport->insertRow("programa2","");
							 $this->io_dsreport->insertRow("actividad2","");
							 $this->io_dsreport->insertRow("partida2","");
							 $this->io_dsreport->insertRow("generica2","");
						 ...
						 $li_encontrado = $this->io_dsreport->findValues(array('sector2'=>$ls_estpro1_aux,'programa2'=>$ls_estpro2_aux,'operacion'=>$ls_operacion),'sector');//print "Encontrado => ".$li_encontrado.'<br>';
						 if ($li_encontrado<=0) // INSERTA LA LINEA A NIVEL DEL PROGRAMA
							{
							 $this->io_dsreport->insertRow("sector","");
							 $this->io_dsreport->insertRow("programa",$ls_estpro2_aux);
							 $this->io_dsreport->insertRow("actividad","");
							 $this->io_dsreport->insertRow("partida","");
							 $this->io_dsreport->insertRow("generica","");
							 $this->io_dsreport->insertRow("especifica","");
							...
							///////////////////////////////////////////////////////////
							 $this->io_dsreport->insertRow("sector2",$ls_estpro1_aux);
							 $this->io_dsreport->insertRow("programa2",$ls_estpro2_aux);
							 $this->io_dsreport->insertRow("actividad2","");
							 $this->io_dsreport->insertRow("partida2","");
							 $this->io_dsreport->insertRow("generica2","");
							 $this->io_dsreport->insertRow("especifica2","");
						 ...
						 $li_encontrado = $this->io_dsreport->findValues(array('sector2'=>$ls_estpro1_aux,'programa2'=>$ls_estpro2_aux,'actividad'=>$ls_estpro3_aux,'operacion'=>$ls_operacion),'sector');//print "Encontrado => ".$li_encontrado.'<br>';
						 if ($li_encontrado<=0) // INSERTA LA LINEA A NIVEL DE LA ACTIVIDAD
							{
							 $this->io_dsreport->insertRow("sector","");
							 $this->io_dsreport->insertRow("programa","");
							 $this->io_dsreport->insertRow("actividad",$ls_estpro3_aux);
							 $this->io_dsreport->insertRow("partida","");
							 $this->io_dsreport->insertRow("generica","");
							 $this->io_dsreport->insertRow("especifica","");
							 $this->io_dsreport->insertRow("subespecifica","");
							...
							///////////////////////////////////////////////////////////
							 $this->io_dsreport->insertRow("sector2",$ls_estpro1_aux);
							 $this->io_dsreport->insertRow("programa2",$ls_estpro2_aux);
							 $this->io_dsreport->insertRow("actividad2",$ls_estpro3_aux);
							 $this->io_dsreport->insertRow("partida2","");
							 $this->io_dsreport->insertRow("generica2","");
							 $this->io_dsreport->insertRow("especifica2","");
							 $this->io_dsreport->insertRow("subespecifica2","");
						...
						$ls_denctaspg = $this->uf_select_denctaspg($ls_codemp,$ls_codestpro1,$ls_codestpro2,$ls_codestpro3,
						                                           $ls_codestpro4,$ls_codestpro5,$ls_spgcta);
						$ls_campo1="";
						$ls_variable1="";
						$this->uf_select_data("SELECT sum(spg_dtmp_cmp.monto) as monto
										 ...
										 WHERE spg_dtmp_cmp.codemp='".$ls_codemp."'
										   ...
										   AND spg_dtmp_cmp.fecha = '".$ld_fecha."'
										   AND spg_dtmp_cmp.operacion='".$ls_operacion."'
										   AND spg_dtmp_cmp.spg_cuenta like '".trim($la_cuenta[0])."%'
						 ...
						 $li_encontrado = $this->io_dsreport->findValues(array('sector2'=>$ls_estpro1_aux,'programa2'=>$ls_estpro2_aux,'partida2'=>$la_cuenta[0],'operacion'=>$ls_operacion),'sector');
						 if ($li_encontrado<=0) // INSERTA LA LINEA A NIVEL DE PARTIDA
							{
							 $this->io_dsreport->insertRow("sector","");
							 $this->io_dsreport->insertRow("programa","");
							 $this->io_dsreport->insertRow("actividad","");
						...
						///////////////////////////////////////////////////////////
						 ...
						 $li_encontrado = $this->io_dsreport->findValues(array('sector2'=>$ls_estpro1_aux,'programa2'=>$ls_estpro2_aux,'partida2'=>$la_cuenta[0],'generica2'=>$la_cuenta[1],'operacion'=>$ls_operacion),'sector');
						 if ($li_encontrado<=0) // INSERTA LA LINEA A NIVEL A GENERICA
							{
							 $this->io_dsreport->insertRow("sector","");
							 $this->io_dsreport->insertRow("programa","");
							 $this->io_dsreport->insertRow("actividad","");
						 ...
						 $this->uf_select_data("SELECT spg_cuentas.denominacion as denctaspg, sum(spg_dtmp_cmp.monto) as monto
										  ...
										  WHERE spg_dtmp_cmp.codemp='".$ls_codemp."'
											...
											GROUP BY spg_dtmp_cmp.codestpro1,spg_dtmp_cmp.codestpro2,spg_dtmp_cmp.codestpro3,
													 spg_dtmp_cmp.codestpro4,spg_dtmp_cmp.codestpro5,denctaspg",$ls_campo1,'monto',$ls_variable1,$ld_monspg);					 
						 $li_encontrado = $this->io_dsreport->findValues(array('sector2'=>$ls_estpro1_aux,'programa2'=>$ls_estpro2_aux,'partida2'=>$la_cuenta[0],'generica2'=>$la_cuenta[1],'especifica2'=>$la_cuenta[2],'operacion'=>$ls_operacion),'sector');
						 if ($li_encontrado<=0) // INSERTA LA LINEA A NIVEL DE ESPECIFICA
							{
							 $this->io_dsreport->insertRow("sector","");
							 $this->io_dsreport->insertRow("programa","");
							 $this->io_dsreport->insertRow("actividad","");
						 ...
						 if ($ls_subespaux!='00')
							{
							   ...
							   GROUP BY spg_dtmp_cmp.codestpro1,spg_dtmp_cmp.codestpro2,spg_dtmp_cmp.codestpro3,
										 spg_dtmp_cmp.codestpro4,spg_dtmp_cmp.codestpro5,denctaspg",$ls_campo1,'monto',$ls_variable1,$ld_monspg);					 
							   $li_encontrado = $this->io_dsreport->findValues(array('sector2'=>$ls_estpro1_aux,'programa2'=>$ls_estpro2_aux,'partida2'=>$la_cuenta[0],'generica2'=>$la_cuenta[1],'especifica2'=>$la_cuenta[2],'subespecifica2'=>$la_cuenta[3],'operacion'=>$ls_operacion),'sector');
							   if ($li_encontrado<=0) // INSERTA LA LINEA A NIVEL DE SUB-ESPECIIFCA
								  {
									 $this->io_dsreport->insertRow("sector","");
									 $this->io_dsreport->insertRow("programa","");
									 $this->io_dsreport->insertRow("actividad","");
					...
					/////// auxiliar ////////////
						...
						$this->uf_select_data("SELECT spg_cuentas.denominacion as denctaspg, sum(spg_dtmp_cmp.monto) as monto
							   ...
							   GROUP BY spg_dtmp_cmp.codestpro1,spg_dtmp_cmp.codestpro2,spg_dtmp_cmp.codestpro3,
										 spg_dtmp_cmp.codestpro4,spg_dtmp_cmp.codestpro5,denctaspg",$ls_campo1,'monto',$ls_variable1,$ld_monspg);					 
							   $li_encontrado = $this->io_dsreport->findValues(array('sector2'=>$ls_estpro1_aux,'programa2'=>$ls_estpro2_aux,'partida2'=>$la_cuenta[0],'generica2'=>$la_cuenta[1],'especifica2'=>$la_cuenta[2],'subespecifica2'=>$la_cuenta[3],'auxiliar2'=>$la_cuenta[4],'operacion'=>$ls_operacion),'sector');
							   if ($li_encontrado<=0) // INSERTA LA LINEA A NIVEL DE AUXILIAR
								  {
									 $this->io_dsreport->insertRow("sector","");
									 $this->io_dsreport->insertRow("programa","");
									 $this->io_dsreport->insertRow("actividad","");
									 ...
									 $this->io_dsreport->insertRow("especifica","");
									 $this->io_dsreport->insertRow("subespecifica","");
									 $this->io_dsreport->insertRow("auxiliar",$la_cuenta[4]);
									 ///////////////     NUEVO      ////////////////////////
 						 			$this->io_dsreport->insertRow("sector1","");
						 			$this->io_dsreport->insertRow("programa1","");
						 			$this->io_dsreport->insertRow("actividad1","");
					...
					///////////////////////////////////////////////////////////
									 ...
									 $this->io_dsreport->insertRow("especifica2",$la_cuenta[2]);
									 $this->io_dsreport->insertRow("subespecifica2",$la_cuenta[3]);
									 $this->io_dsreport->insertRow("auxiliar2",$la_cuenta[4]);
									 $this->io_dsreport->insertRow("denominacion",$ls_denctaspg);
									 $this->io_dsreport->insertRow("monto",$ld_monspg);
									 $this->io_dsreport->insertRow("operacion",$ls_operacion);
								  }	
						...
						///////////////////////////////////////////////////////////
						 ...
						 $li_totrow = $this->io_dsreport->getRowCount("sector");
						 for ($i=1;$i<=$li_totrow;$i++) 
							 {
							   $ls_sector     = $this->io_dsreport->getValue("sector",$i);
							   $ls_programa       = $this->io_dsreport->getValue("programa",$i);
							   $ls_actividad    = $this->io_dsreport->getValue("actividad",$i);
							   ...
							   $ls_auxiliar	    = $this->io_dsreport->getValue("auxiliar",$i);
...
/********************************************************************************************************************************/
   ...
   { //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 if($rs_data===false)
	 {   // error interno sql
		   $this->io_msg->message("CLASE->tepuy_spg_reporte_class  MÉTODO->uf_spg_reporte_select_resumen_fideicomiso SEP ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
			$lb_valido = false;
	 }
     else
     {
	 ...
	 {   // error interno sql
		   $this->io_msg->message("CLASE->tepuy_spg_reporte_class  MÉTODO->uf_spg_reporte_select_resumen_fideicomiso SOC ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
			$lb_valido = false;
	 }
     else
     {
	 ...
	 {   // error interno sql
		   $this->io_msg->message("CLASE->tepuy_spg_reporte_class  MÉTODO->uf_spg_reporte_select_resumen_fideicomiso CXP ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
			$lb_valido = false;
	 }
     else
     {
	 ...
	 $ls_sql=" SELECT MAX(scb_movbco.numdoc) AS numdoc, MAX(scb_movbco.codfuefin) AS codfuefin, ".
             "       scb_movbco_spg.codestpro, scb_movbco_spg.spg_cuenta, SUM(scb_movbco.monto) AS monto ".
             ...
             " GROUP BY scb_movbco_spg.codestpro, scb_movbco_spg.spg_cuenta";
	 //print $ls_sql."<br>";
...
/********************************************************************************************************************************/
	function uf_select_denominacion_fuentefideicomiso($as_codfuefin,&$as_denfuefin)
	{
		...
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////				
		 ...
		 {
			$lb_valido=false;
		   $this->io_msg->message("CLASE->tepuy_spg_reporte_class  MÉTODO->uf_select_denominacion_fuentefideicomiso  ERROR->".$this->io_function->uf_convertirmsg($this->io_sql->message));
		 }		
		 else
		 {
			 if($row=$this->io_sql->fetch_row($rs_data))
