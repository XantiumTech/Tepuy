...
$io_fun_compra->uf_load_seguridad("SOC","tepuy_soc_r_sumario_orden_compra.php",$ls_permisos,&$la_seguridad,$la_permisos);
$ls_reporte = $io_fun_compra->uf_select_config("SOC","REPORTE","LISTADO_ORDCOM","tepuy_soc_rpp_sumario_orden_compra.php","C");
...
<title>Sumario de Ordenes de Compras</title>
...
<input name="rdtipo" type="radio" class="sin-borde" value="A" checked="checked" />
        ...
        <td height="13" colspan="6"><table width="490" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="171" style="text-align:left"><input name="txtnumordcomdes" type="text" id="txtnumordcomdes" value="<?php print $ls_numordcomdes ?>" size="20" maxlength="15"  style="text-align:center "  onblur="javascript:rellenar_cad(this.value,15,this)" onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript: ue_catalogo('tepuy_soc_cat_orden_compra.php?tipo=REPORTE-DESDE');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar hasta..." name="buscar1" width="15" height="15" border="0"  id="buscar1" /></a></td>
            ...
            <td width="154" style="text-align:left"><input name="txtnumordcomhas" type="text" id="txtnumordcomhas" value="<?php print $ls_numordcomhas ?>" size="20" maxlength="15"  style="text-align:center"  onblur="javascript:rellenar_cad(this.value,15,this)"  onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript: ue_catalogo('tepuy_soc_cat_orden_compra.php?tipo=REPORTE-HASTA');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar desde..." name="buscar2" width="15" height="15" border="0" id="buscar2" /></a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
        ...
        <td height="13" colspan="6"><table width="490" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="171" style="text-align:left"><input name="txtcodprodes" type="text" id="txtcodprodes" value="<?php print $ls_codprodes ?>" size="20" maxlength="15"  style="text-align:center "  onblur="javascript:rellenar_cad(this.value,15,this)" onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript: ue_catalogo('tepuy_soc_cat_proveedor.php?tipo=REPDES');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar hasta..." name="buscar1" width="15" height="15" border="0"  id="buscar1" /></a></td>
            <td width="44" style="text-align:right">Hasta</td>
            <td width="154" style="text-align:left"><input name="txtcodprohas" type="text" id="txtcodprohas" value="<?php print $ls_codprohas ?>" size="20" maxlength="15"  style="text-align:center"  onblur="javascript:rellenar_cad(this.value,15,this)"  onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript: ue_catalogo('tepuy_soc_cat_proveedor.php?tipo=REPHAS');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar desde..." name="buscar2" width="15" height="15" border="0" id="buscar2" /></a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="22" colspan="6" style="text-align:center"><table width="490" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            <td width="63" style="text-align:right">Desde</td>
            <td width="171" style="text-align:left"><input name="txtfecordcomdes" type="text" id="txtfecordcomdes" value="<?php print $ls_fecordcomdes ?>" size="12" maxlength="10"  style="text-align:left"  datepicker="true" onkeypress="currencyDate(this);" />
              <a href="javascript: ue_catalogo('tepuy_soc_cat_analisis_cotizacion.php?catalogo=txtnumanacotdes');"></a></td>
            <td width="44" style="text-align:right">Hasta</td>
            <td width="154" style="text-align:left"><input name="txtfecordcomhas" type="text" id="txtfecordcomhas" value="<?php print $ls_fecordcomhas ?>" size="12" maxlength="10"  style="text-align:left"  datepicker="true" onkeypress="currencyDate(this);" />
      ...
      <tr>
        <td height="22" colspan="6" style="text-align:center"><table width="490" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="4" style="text-align:left"><strong>Unidad Solicitante </strong></td>
          </tr>
          <tr>
            <td width="64" style="text-align:right">Desde</td>
            <td width="157" style="text-align:left"><input name="txtcoduniadmdes" type="text" id="txtcoduniadmdes" value="<?php print $ls_coduniadmdes ?>" size="15" maxlength="10"  style="text-align:center "  onblur="javascript:rellenar_cad(this.value,10,this)" onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript:ue_catalogo('tepuy_soc_cat_unidad_ejecutora.php?tipo=REPDES');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar hasta..." name="buscar1" width="15" height="15" border="0"  id="buscar1" /></a></td>
            <td width="54" style="text-align:right">Hasta</td>
            <td width="158" style="text-align:left"><input name="txtcoduniadmhas" type="text" id="txtcoduniadmhas" value="<?php print $ls_coduniadmhas ?>" size="15" maxlength="10"  style="text-align:center"  onblur="javascript:rellenar_cad(this.value,10,this)"  onkeypress="return keyRestrict(event,'1234567890');" />
              <a href="javascript:ue_catalogo('tepuy_soc_cat_unidad_ejecutora.php?tipo=REPHAS');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar desde..." name="buscar2" width="15" height="15" border="0" id="buscar2" /></a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
  ...
  <input name="esttip" type="radio" class="sin-borde" value="S" onClick="uf_deshabilitar()"/>
          ...
          <tr class="formato-blanco">
            ...
            <td style="text-align:left"><span class="Estilo2">
              ...
              <a href="javascript:ue_catalogo_bienes('REPDES');"><img src="../shared/imagebank/tools15/buscar.png" alt="Cat&aacute;logo de Articulos" name="busartdes" width="15" height="15" border="0" class="weekend" id="busartdes" /></a></span></td>
            ...
            </span><a href="javascript:ue_catalogo_bienes('REPHAS');"><img src="../shared/imagebank/tools15/buscar.png" alt="Cat&aacute;logo de Articulos" name="busarthas" width="15" height="15" border="0" id="busarthas" />
...
function ue_catalogo_bienes(ls_tipo)
{
	...
	window.open("tepuy_soc_cat_bienes.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=550,height=400,resizable=yes,location=no,left=50,top=50");          
}

function ue_catalogo_servicios(ls_tipo)
{
    f.tipo.value=ls_tipo
	window.open("tepuy_soc_cat_servicios.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=550,height=400,resizable=yes,location=no,left=50,top=50");          
}
...
function ue_imprimir()
{
	...
	ls_coduniadmdes = f.txtcoduniadmdes.value;
	ls_coduniadmhas = f.txtcoduniadmhas.value;
	...
	{ 
		...
		ls_reporte  = "tepuy_soc_rpp_sumario_orden_compra.php";
		//alert(ls_reporte);
		...
		pagina="reportes/"+ls_reporte+"?txtnumordcomdes="+ls_numordcomdes+"&rdtipo="+ls_tipord
						 ...
						 +"&txtcoduniadmdes="+ls_coduniadmdes+"&txtcoduniadmhas="+ls_coduniadmhas
						 +"&rdanucom="+rdanucom
