...
if($ls_operacion=="BUSCAR")
{
	if(($ld_fecdes!="")&&($ld_fechas!=""))
	{
		$ls_sqlint=" AND saf_movimiento.feccmp >= '". $ld_fecdes ." 00:00:00'".
				   " AND saf_movimiento.feccmp <= '". $ld_fechas ." 23:59:59' ";
	}
	else
	{
		$ls_sqlint="";
	...
	if($li_num>0)
	{
		while($row=$io_sql->fetch_row($rs_cta))
		{
			...
			print "<td><a href=\"javascript: aceptar('$ls_cmpmov','$ls_codact','$ls_ideact','$ls_denact','$ls_descmp','$ld_feccmp','$ls_codcau','$ls_dencau','$ls_estpromov');\">".$ls_cmpmov."</a></td>";
...
function aceptar(ls_cmpmov,ls_codact,ls_ideact,ls_denact,ls_descmp,ls_feccmp,ls_codcau,ls_dencau,ls_estpromov)
{
...
function ue_search()
{
	...
	f.action="tepuy_saf_cat_modificaciones.php";
	f.submit();
}
////////////////////////    Validar la Fecha     ///////////////////////////
