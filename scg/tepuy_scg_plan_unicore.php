...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" background="../shared/imagebank/header.jpg" class="contorno">
  <tr>
    <td height="30" background="../shared/imagebank/header.jpg"><a href="../shared/imagebank/header.jpg"><img src="../shared/imagebank/header.jpg" width="778" height="40" border="0"></a></td>
  </tr>
   <tr>
...
<!--  <tr>
   ...
   <tr>
    <td height="36" class="toolbar"><img src="../shared/imagebank/tools20/espacio.gif" width="4" height="20"><a href="javascript: ue_nuevor();"><img src="../shared/imagebank/tools20/nuevo.png" alt="Nuevo" width="20" height="20" border="0"></a><a href="javascript: ue_guardar();"><img src="../shared/imagebank/tools20/grabar.png" alt="Grabar" width="20" height="20" border="0"></a><a href="javascript: ue_buscar();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/imprimir.png" alt="Imprimir" width="20" height="20"><img src="../shared/imagebank/tools20/ejecutar.png" alt="Ejecutar" width="20" height="20"><a href="javascript: ue_eliminar();"><img src="../shared/imagebank/tools20/eliminar.png" alt="Eliminar" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/deshacer.png" alt="Deshacer" width="20" height="20"><img src="imagebank/tools20/filtrar.png" alt="Filtrar" width="20" height="20">
	<img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20"><img src="../shared/imagebank/tools20/ayuda.png" alt="Ayuda" width="20" height="20"></td>
  </tr>
</table>
...
{
      $li_return = $int_scg->uf_insert_plan_unico_cuentare($ls_cuenta,$ls_denominacion);
	  if($li_return==2)
	  {
	    $ls_cuenta=" ";
        $ls_denominacion=" ";
      ...
      <tr>
		...
		<table width="452" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-ventana">
            <td colspan="2"><div align="center">Plan Unico Cuentas de Recursos y Egresos </div></td>
          </tr>
          <tr>
            <td width="101" height="20"><span class="Estilo1"></span></td>
            <td width="349"><span class="Estilo1"></span></td>
          </tr>
          <tr>
  ...
  with (form1)
  {
    ...
    else
    {
	  ...
	  else
	  {
		...
		f.action="tepuy_scg_plan_unicore.php";
		f.submit();
	  }
	} 
  }
...
{
   f=document.form1;
   pagina="tepuy_catdinamic_ctaspure.php?";
