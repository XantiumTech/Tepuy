...
<form name="form1" method="post" action="">
  ...
  <table width="535" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      ...
      <td width="80" style="text-align:right">Hasta</td>
      <td width="245" style="text-align:left"><input name="txtfechasta" type="text" id="txtfechasta" style="text-align:center" onKeyPress="currencyDate(this);"  datepicker="true"></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="13" colspan="4" align="center">
        <p>&nbsp;</p>        </td>
    </tr>
  </table>
...
function ue_search()
{
  ...
  pagina="reportes/tepuy_scb_rpp_descuadrados_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codope="+ls_codope+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&orden="+ls_orden;
