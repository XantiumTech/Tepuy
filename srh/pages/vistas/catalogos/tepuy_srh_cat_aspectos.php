...
<script language="JavaScript">
        ...
        var loadDataURL = "../../php/tepuy_srh_a_aspectos.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_aspectos.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_aspectos.php?valor=buscar"+"&txtcodeval="+codeval+"&txtdeneval="+deneval);
 		  setTimeout (terminar_buscar,500);
	...
	function aceptar(ls_codeval,ls_deneval,ls_codevaldestino,ls_denevaldestino)
	{
		...
		opener.document.form1.action="../pantallas/tepuy_srh_d_aspectos.php";
