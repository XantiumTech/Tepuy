...
class tepuy_srh_c_requerimiento
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_srh_c_requerimiento($path)
...
function uf_srh_getProximoCodigo()
  {
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_srh_getProximoCodigo
		//         Access: public (tepuy_srh_d_requerimiento)
		//      Argumento: 
	...
	function uf_srh_select_requerimiento($as_codreq)
	{
		...
		//         reqess: public (tepuy_srh_requerimientos)
...
}// end   class tepuy_srh_c_requerimiento
?>
