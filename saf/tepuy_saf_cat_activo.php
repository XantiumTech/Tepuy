...
<br>
    <table width="550" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        <td>&nbsp;</td>
        <td colspan="4"><div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Buscar</a></div></td>
      </tr>
    </table>
  <br>
<?php
...
if($ls_operacion=="BUSCAR")
{
		...
		if (array_key_exists("txthasta",$_POST))
		{
			...
			if($lb_fechavalida)
			{
				...
				$ls_sql="SELECT saf_activo.*, ".
						" 		(SELECT denfuefin FROM tepuy_fuentefinanciamiento ".
						"         WHERE tepuy_fuentefinanciamiento.codfuefin = saf_activo.codfuefin) as denfuefin, ".
						...
						"         WHERE tepuy_pais.codpai = saf_activo.codpai) as despai, ".	
						" 		(SELECT desest FROM tepuy_estados ".
						"         WHERE tepuy_estados.codest = saf_activo.codest ".
						"           AND tepuy_estados.codpai = saf_activo.codpai) as desest, ".	
						" 		(SELECT denmun FROM tepuy_municipio ".
						"         WHERE tepuy_municipio.codmun = saf_activo.codmun ".
						"           AND tepuy_municipio.codest = saf_activo.codest ".
						"           AND tepuy_municipio.codpai = saf_activo.codpai) as desmun, ".	
	...
	if($li_numrows>0)
	{
		while($row=$io_sql->fetch_row($rs_cta))
		{
			...
			print " <td><a href=\"javascript: aceptar('$ls_codact','$ls_denact','$ls_maract','$ls_modact','$ld_fecregact','$ld_feccmpact',".
			       ...
			       "'$ls_obsact','$ls_codcat','$ls_dencat','$ls_ctaspg','$ls_esttipinm','$ls_numord','$ls_codpro','$ld_fecordcom',".
...
<script language="JavaScript">   
  function aceptar(ls_codact,$ls_denact,ls_maract,ls_modact,ld_fecregact,ld_feccmpact,li_cosact,ls_codconbie,ls_denconbie,ls_codfuefin,
  			       ls_denfuefin,ls_codsitcon,ls_densitcon,ls_codconcom,ls_denconcom,ls_codpai,ls_denpai,ls_codest,ls_denest,ls_codmun,
				   ls_denmun,ls_obsact,ls_codcat,ls_dencat,ls_ctaspg,ls_esttipinm,ls_numord,ls_codpro,ld_fecordcom,ls_nompro,li_monord,
  ...
  f.action="tepuy_saf_cat_activo.php";
  f.submit();
  }
