<?php
class tepuy_rcm_c_hist
{
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_rcm_c_hist()
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_rcm_c_soc
		//		   Access: public 
	...
	function uf_convertir_snohconcepto()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohconcepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snothconcepto()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothconcepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snohconceptopersonal()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohconceptopersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snothconceptopersonal()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothconceptopersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
	...
	function uf_convertir_snohconceptovacacion()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohconceptovacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snothconceptovacacion()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothconceptovacacion ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snohconstante()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohconstante ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snothconstante()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothconstante ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snohconstantepersonal()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohconstantepersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snothconstantepersonal()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothconstantepersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snohgrado()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohgrado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snothgrado()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothgrado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snohperiodo()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{  
	...
	function uf_convertir_snothperiodo()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{  
	...
	function uf_convertir_snohpersonalnomina()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohpersonalnomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{  
	...
	function uf_convertir_snothpersonalnomina()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothpersonalnomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{  
	...
	function uf_convertir_snohprenomina()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohprenomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{  
	...
	function uf_convertir_snothprenomina()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothprenomina ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{  
	...
	function uf_convertir_snohprestamos()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohprestamos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snothprestamos()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothprestamos ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snohprestamosamortizado()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohprestamosamortizado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snothprestamosamortizado()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothprestamosamortizado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snohprestamosperiodo()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohprestamosperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snothprestamosperiodo()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothprestamosperiodo ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snohprimaconcepto()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohprimaconcepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snothprimaconcepto()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothprimaconcepto ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{ 
	...
	function uf_convertir_snohprimagrado()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohprimagrado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snothprimagrado()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothprimagrado ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snohresumen()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohresumen ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snothresumen()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothresumen ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snohsalida()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohsalida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snothsalida()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothsalida ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snohvacacpersonal()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snohvacacpersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
	...
	function uf_convertir_snothvacacpersonal()
	{
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->tepuy_rcm_c_hist MÉTODO->SELECT->uf_convertir_snothvacacpersonal ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
