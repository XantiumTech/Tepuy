<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_p_recepcioncontable.php",$ls_permisos,$la_seguridad,$la_permisos);
	$ls_reporte=$io_fun_cxp->uf_select_config("CXP","REPORTE","FORMATO_RECEPCION","tepuy_cxp_rfs_recepciones.php","C");
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
   ...
   function uf_limpiarvariables()
   {
		...
		global $ls_operacion,$ls_existe,$ls_codcla,$ls_dencondoc,$ld_fecvendoc,$ld_fecemidoc,$ls_numref,$ls_numrecdoc,$ls_numfactura;
   ...
   function uf_load_variables()
   {
		...
		global $ls_codigocuenta,$ls_estatuscontable,$ls_estatuspresupuesto,$ls_codtipdoc,$li_totrowspg,$ls_procede,$ls_numfactura;
   ...
   function uf_load_data(&$as_parametros)
   {
		...
		// Fecha Creación: 29/04/2007								Fecha Última Modificación : 
		//////////////////////////////////////////////////////////////////////////////
		global $li_subtotal,$li_cargos,$li_total,$li_deducciones,$li_totalgeneral,$li_totrowspg,$ls_numrecdoc,$ls_numfactura,$ls_codigocuenta;
		global $ls_estatuscontable,$ls_estatuspresupuesto, $li_totrowscg,$ls_numref;
		...
		$as_parametros=$as_parametros."&numrecdoc=".$ls_numrecdoc."&numfactura=".$ls_numfactura."&totrowspg=".$li_totrowspg."&estcontable=".$ls_estatuscontable."&estpresupuestario=".$ls_estatuspresupuesto;
...
<body>
<?php
	require_once("class_folder/tepuy_cxp_c_recepcion.php");
	$io_cxp=new tepuy_cxp_c_recepcion("../");
	uf_limpiarvariables();
	switch ($ls_operacion) 
	{
		case "NUEVO":
		...
		case "GUARDAR":
			...
			$lb_valido=$io_cxp->uf_guardar($ls_existe,$ls_numrecdoc,$ls_tipodestino,$ls_codprovben,$ls_codtipdoc,$ld_fecregdoc,
										   ...
										   $ls_codfuefin,$ls_numfactura,$la_seguridad);
            ...
            <table width="785" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              ...
              <tr style="visibility:hidden">
                <td height="22">Reporte en
                  <select name="cmbbsf" id="cmbbsf" style="visibility:hidden">
              ...
              <tr>
                ...
                <td width="119" height="22"><input name="txtfecregdoc" type="text" id="txtfecregdoc" onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" value="<?php print $ld_fecregdoc;?>" size="17"  style="text-align:center" datepicker="true"></td>
              </tr>
              <tr>
              ...
              <tr>
				...
				<table width="785" border="0" cellpadding="0" cellspacing="1" class="celdas-blancas">
                  <tr>
                    <td width="155" height="22"><div align="right">N&uacute;mero de Ficha </div></td>
                    <td width="200" height="22"><div align="left">
                      <input name="txtnumrecdoc" type="text" id="txtnumrecdoc"  onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz')" onBlur="javascript: ue_verificar_rd();" value="<?php print $ls_numrecdoc;?>" size="20" maxlength="15" >
                    </div></td>
		</tr>
                    <td width="155" height="22"><div align="right">N&uacute;mero de Factura </div></td>
                    <td width="200" height="22"><div align="left">
                      <input name="txtnumfactura" type="text" id="txtnumfactura"  onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz')" onBlur="javascript: ue_verificar_rd();" value="<?php print $ls_numfactura;?>" size="20" maxlength="15" >
                    </div></td>
                    <td width="195" height="22"><div align="right">N&uacute;mero de Control (Factura)</div></td>
                    <td width="200" height="22"><div align="left">
                      <input name="txtnumref" type="text" id="txtnumref"  onKeyPress="return keyRestrict(event,'1234567890'+'abcdefghijklmnopqrstuvwxyz-_')" value="<?php print $ls_numref;?>" size="20" maxlength="15"  >
                    </div></td>
                  </tr>
                  <tr>
                    <td height="22"><div align="right">Fecha de Emisi&oacute;n </div></td>
                    <td width="200" height="22"><div align="left">
                      <input name="txtfecemidoc" type="text" id="txtfecemidoc" style="text-align:center" value="<?php print $ld_fecemidoc;?>" size="17"  onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" datepicker="true">
                    </div></td>
                    <td height="22"><div align="right">Fecha de Vencimiento </div></td>
                    <td height="22"><div align="left">
                      <input name="txtfecvendoc" type="text" id="txtfecvendoc" style="text-align:center" value="<?php print $ld_fecvendoc;?>" size="17"  onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" datepicker="true">
                    </div></td>
                  </tr>
                  <tr>
                    ...
                    <td height="22" colspan="3"><div align="left">
                      ...
                      <a href="javascript: ue_fuentefinanciamiento();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0"></a>
				 ...
				 <tr>
                    ...
                    <td width="200" height="22"><div align="left">
                      <div align="right">Asociado al Libro de Compras
                        <input name="chkestlibcom" type="checkbox" class="sin-borde" id="chkestlibcom" value="1" <?php if($ls_estlibcom!=""){print "unchecked";}?>>
                      </div>
                    </div>
                    <div align="right"></div></td>
                    <td width="193" height="22"><div align="right">Impuesto Municipal
                        <input name="chkestimpmun" type="checkbox" class="sin-borde" id="chkestimpmun" value="1" <?php if($ls_estimpmun!=""){print "unchecked";}?>>
                    </div></td>
                    <td height="22">&nbsp;</td>
                  </tr>
				  <tr>
...
function ue_nuevo()
{
	...
	{	
		...
		f.action="tepuy_cxp_p_recepcioncontable.php";
		f.submit();
   	}
	else
   	{
...
function ue_verificar_rd()
{
	...
	if(f.existe.value=="FALSE")
	{
		...
		numfactura=ue_validarvacio(f.txtnumfactura.value);
		...
		if(parametros!="")
		{
			...
			ajax.open("POST","class_folder/tepuy_cxp_c_recepcion_ajax.php",true);
...
function ue_guardar()
{
	...
	if(((lb_existe=="TRUE")&&(li_cambiar==1))||(lb_existe=="FALSE")&&(li_incluir==1))
	{
		...
		else
		{
			...
			if(valido)
			{
				valido=ue_validarcampo(numrecdoc,"El Número de Ficha no puede estar vacio.",f.txtnumrecdoc);
			}
			if(valido)
			{
...
function ue_buscar()
{
	window.open("tepuy_cxp_cat_recepcion.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=650,height=400,left=50,top=50,location=no,resizable=no");
}
function ue_fuentefinanciamiento()
{
	...
	{
		window.open("tepuy_cxp_cat_fuente.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=550,height=400,left=50,top=50,location=no,resizable=no");
	}
}
...
function ue_imprimir()
{
	...
	if(li_imprimir==1)
	{
		if(lb_existe=="TRUE")
		{
			...
			formato="tepuy_cxp_rfs_recepciones_barinas.php";
...
function ue_cambiardestino()
{
	...
	if(tipdes!="-")
	{
		if(tipdes=="P")
		{
			window.open("tepuy_cxp_cat_proveedor.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
		}
		else
		{
			...
			if(f.recepcionexiste.value=="true")
			{
				...
				else
				{
					...
					else
					{
						...
						{
							pagina="tepuy_cxp_pdt_spgcuentas.php?documento="+numdoc+"&sccuenta="+codigocuenta;
			...
			if(f.recepcionexiste.value=="true")
			{
				...
				{			
					...
					else
					{
						if((codtipdoc!='-')&&(codproben!='')&&(numdoc!=''))
						{
							pagina="tepuy_cxp_pdt_scgcuentas.php?documento="+numdoc+"&sccuenta="+codigocuenta;
							window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=no,width=705,height=270,resizable=no,location=no,dependent=yes");
							f.fecregdoc.value=f.txtfecregdoc.value;
							f.fecvendoc.value=f.txtfecvendoc.value;
							f.fecemidoc.value=f.txtfecemidoc.value;
			...
			if(f.recepcionexiste.value=="true")
			{
				...
				{			
					...
					else
					{
						if((codtipdoc!='-')&&(codproben!='')&&(numdoc!=''))
						{
							pagina="tepuy_cxp_pdt_compromisos.php";
				   ...
				   // ha reprocesado algun documento Tipo Causa para darle acceso al catalogo de otros Creditos.
					...
					{	
						...
						else
						{
							if(	presupuesto=="2")
							{
								pagina="tepuy_cxp_pdt_otroscreditos.php?numrecdoc="+numrecdoc+"&subtotal="+subtotal+"&procede="+procede+"";
							}
							else
							{
								if((estmodiva=='1')||(causadoparcial='1'))
								{
									pagina="tepuy_cxp_pdt_otroscreditosparcial.php?numrecdoc="+numrecdoc+"&subtotal="+subtotal;
		...
		{	
			...
			else
			{
				if (procede!='SNOCNO')
				{
					...
					pagina="tepuy_cxp_pdt_deducciones.php?numrecdoc="+numrecdoc+"&subtotal="+subtotal+"&procede="+procede+"&cargos="+cargos;
...
function ue_procesar_comprobante(fila)
{
	...
	else
	{
		...
		if((parseFloat(li_cargos)>0)||(parseFloat(li_deducciones)>0))
		{
			alert("Ya agrego Cargos y/o Retenciones debe proceder a eliminar los movimientos para poder modificar los montos.");
		}
		else
		{
			procede=f.procede.value;
