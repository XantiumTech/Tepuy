...
var url= "../../php/tepuy_srh_a_defcontrato.php";
var metodo='get';
...
function ue_buscar()
{
	...
	if (li_leer==1)
   	{
		window.open("../catalogos/tepuy_srh_cat_defcontrato.php?valor_cat=1","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
   	}
	else
   	{
