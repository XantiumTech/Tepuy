...
// ESTAS LINEAS SON NECESARIAS PARA QUE SE PUEDA MOSTRAR EL PDF //
	...
	function uf_insert_seguridad()
	{
	    ...
	    $ls_evento      = "IMPRIMIR";
	    $ls_descripcion = "Imprimio Separador a nivel de Sectores";
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  -----------------------------------------
          	...
          	else
		{
			...
			$hasta=1;
         	...
         	$lb_valido=$io_report->uf_spg_reportes_separador_sector($li_cmbnivel,$desde,$hasta);
			 ...
			 // $io_pdf->ezStartPageNumbers(550,50,10,'','',1); // Insertar el número de página
			  ...
			  for ($z=$desde;$z<=$hasta;$z++)
				...
				for ($l=1;$l<=24;$l++)
				{
					...
					$ubica=$ubica+1;
					$la_data[$ubica]=array('titulo'=>$ls_denestpro1);
					$ubica=$ubica+1;
					}
					else
					{
