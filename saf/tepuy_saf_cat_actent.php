...
<br>
      ...
      <tr>
        <td height="22">&nbsp;</td>
        <td height="22"></td>
        <td height="22" colspan="4"><div align="right"><a href="javascript:ue_search();"><img src="../shared/imagebank/tools/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a> <a href="javascript:aceptar();"></a> </div></td>
      </tr>
    </table>
<br>	
	<?php
		...
		if($row=$SQL->fetch_row($rs_cta))
		{
			...
			if($totrow>0)
			{
				for($z=1;$z<=$totrow;$z++)
				{
					...
					$object[$z][1]="<div align=center><img src=../shared/imagebank/tools15/aprobado.png width=15 height=15  onClick='javascript: ue_agregar(".$z.");'></div>"; 
			...
			{
					$object[1][1]="<div align=center><img src=../shared/imagebank/tools15/aprobado.png width=15 height=15  onClick='javascript: ue_agregar();'></div>"; 
...
function ue_search()
{
	  ...
	  f.action="tepuy_saf_cat_actent.php";
	  f.submit();
}
</script>
</html>