<?PHP
	...
	function uf_print_encabezado_pagina($as_titulo,$as_desnom,$as_anocurper,$as_desmesper,&$io_pdf)
	{
		...
		$ls_periodo="Año: ".$as_anocurper." Mes: ".$as_desmesper;
	...
	function uf_print_cabecera(&$io_pdf)
	{
        ...
        $io_pdf->filledRectangle(25,676,550,$io_pdf->getFontHeight(19));
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>30), // Justificación y ancho de la columna
						 			   ...
						 			   'sueldointegral'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'bonovacacional'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
						 			   'bonofin'=>array('justification'=>'center','width'=>70), // Justificación y ancho de la columna
	...
	else // Imprimimos el reporte
	{
		...
		uf_print_encabezado_pagina($ls_titulo,$ls_desnom,$ls_anocurper,$ls_desmesper,$io_pdf); // Imprimimos el encabezado de la página
