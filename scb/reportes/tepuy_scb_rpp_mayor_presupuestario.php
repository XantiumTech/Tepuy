...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_encabezado_pagina($as_codemp,$as_titulo,$ad_totpagefe,$as_codestpro,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		$ls_codestpro1 = substr($as_codestpro,0,20); //0,20
		$ls_codestpro2 = substr($as_codestpro,20,6); //20,6
		$ls_codestpro3 = substr($as_codestpro,26,3); // 26,3
		$ls_codestpro1aux = substr($as_codestpro,18,2); //0,20
		$ls_codestpro2aux = substr($as_codestpro,24,2); //20,6
		$ls_codestpro3aux = substr($as_codestpro,27,2); // 26,3
		...
		$la_data    = array(array('row1'=>'<b>'.$as_titulo.'</b>','row2'=>'<b>'.$_SESSION["la_empresa"]["estemp"].'</b>','row3'=>'<b>NÚMERO</b>','row4'=>'17','row5'=>'<b>AÑO</b>','row6'=>'2008'));
		...
		$la_data[2] = array('column1'=>'<b>'.strtoupper($_SESSION["la_empresa"]["nomestpro1"]).':</b>','column2'=>'<b>'.$ls_codestpro1aux.' - </b>','column3'=>'<b>'.$ls_denestpro1.'</b>');
		$la_data[3] = array('column1'=>'<b>'.strtoupper($_SESSION["la_empresa"]["nomestpro2"]).':</b>','column2'=>'<b>'.$ls_codestpro2aux.' - </b>','column3'=>'<b>'.$ls_denestpro2.'</b>');
		$la_data[4] = array('column1'=>'<b>'.strtoupper($_SESSION["la_empresa"]["nomestpro3"]).':</b>','column2'=>'<b>'.$ls_codestpro3aux.' - </b>','column3'=>'<b>'.$ls_denestpro3.'</b>');
	...
	function uf_print_firmas(&$io_pdf)
	{
		...
		$la_data[5] = array('column1'=>'','column2'=>'','column3'=>'');
		$la_data[6] = array('column1'=>'','column2'=>'','column3'=>'');
		  ...
		  while($row=$io_sql->fetch_row($rs_data))
			   {
				 ...
				 if ($li_totrows==1)
				    ...
				    { 
					  if ($ls_codestpro!=$ls_codestproant)
					     {
						   uf_print_encabezado_pagina($ls_codemp,$ls_titulo,$ld_totmonche,$ls_codestproant,$io_pdf);
				 ...
				 if ($li_totrows==$li_numrows)
				    { 
					  uf_print_encabezado_pagina($ls_codemp,$ls_titulo,$ld_totmonche,$ls_codestpro,$io_pdf);
					  uf_print_detalles($la_detrep,$io_pdf);
		              uf_print_totales($ld_montotsub,$ld_totmoniva,$ld_totretiva,$ld_totretisl,$ld_totmonche,$io_pdf);
					  uf_print_firmas($io_pdf);				 
					}
