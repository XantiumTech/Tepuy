...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_unidadadmin.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_unidadadmin.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_unidadadmin.php?valor=buscar"+"&txtdenuniadm="+denuniadm+"&txttipo="+tipo);
           setTimeout (terminar_buscar,500);
