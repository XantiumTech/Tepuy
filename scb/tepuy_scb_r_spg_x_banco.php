...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_spg_x_banco.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
...
<!--  <tr>
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_imprimir();"><img src="../shared/imagebank/tools20/imprimir.png" width="20" height="20" border="0" alt="Imprimir" title="Imprimir"></a></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" title="Salir" width="20" height="20" border="0"></a>
													 <img src="../shared/imagebank/tools20/ayuda.png" alt="Ayuda" title="Ayuda" width="20" height="20"></td>
  </tr>
</table>
<?php
      ...
      <td colspan="3" align="center"><table width="556" height="57" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        ...
        <tr>
          ...
          <td><input name="txtcodban" type="text" id="txtcodban" style="text-align:center" value="<?php print $ls_codban; ?>" size="5" maxlength="3">
              <a href="javascript:catalogo_banco();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a>
        ...
        <tr>
          ...
          <td><input name="txtcuenta" type="text" id="txtcuenta" style="text-align:center" value="<?php print $ls_cuenta; ?>" size="27" maxlength="25">
              <a href="javascript:catalogo_cuenta_banco();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a>
      ...
      <td colspan="3" align="center">      <div align="left">
        <table width="556" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="67"><a href="javascript:catalogo_cuentahas();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Estructura Programatica 1"></a></td>
          </tr>
        </table>
      </div></td>
    </tr>
...
function ue_imprimir()
{
	...
	else
	{
		...
		else                                                          
		{
			...
			if (li_imprimir=='1')
			   {
				 pagina="reportes/tepuy_scb_rpp_spg_x_banco.php?txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas
...
function catalogo_cuenta_banco()
{
	    ...
	    pagina="tepuy_cat_ctabanco.php?codigo="+txtcodban+"&hidnomban="+denban;
