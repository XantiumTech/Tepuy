...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_profesion.js"></script>
...
<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_profesion.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_profesion.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
   		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_profesion.php?valor=buscar"+"&txtcodpro="+codpro+"&txtdespro="+despro);
		  setTimeout (terminar_buscar,500);
