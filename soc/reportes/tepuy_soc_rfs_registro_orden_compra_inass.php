...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{                              
		...
		$io_pdf->addJpegFromFile('../../shared/imagebank/'.$_SESSION["ls_logo"],20,719,$_SESSION["ls_width"],$_SESSION["ls_height"]); // Agregar Logo
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'center','width'=>67),
						               'columna2'=>array('justification'=>'center','width'=>250),
									   'columna3'=>array('justification'=>'center','width'=>66),
									   'columna4'=>array('justification'=>'center','width'=>57),
									   'columna5'=>array('justification'=>'center','width'=>67),
									   'columna6'=>array('justification'=>'center','width'=>63))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_datatit,$la_columnas,'',$la_config);
		unset($la_datatit);
		unset($la_columnas);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('numero'=>array('justification'=>'center','width'=>67),
						               'codigo'=>array('justification'=>'left','width'=>250), // Justificación y ancho de la columna	 			   
									   'presentacion'=>array('justification'=>'center','width'=>66),
						 			   'cantidad'=>array('justification'=>'center','width'=>57), // Justificación y ancho de la columna
