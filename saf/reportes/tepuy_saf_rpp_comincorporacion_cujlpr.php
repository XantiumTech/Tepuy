<?php
	...
	function uf_print_encabezado_pagina($as_titulo,$as_cmpmov,$ad_fecha,&$io_pdf)
	{
		...
		// Fecha Creación: 26/04/2006                               Fecha de Modificación: 10/04/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);
		$io_pdf->rectangle(261,530,250,25);
		$io_pdf->rectangle(290,535,10,10);  // rectángulo pequeño
	    $io_pdf->line(290,535,300,545);		
		$io_pdf->line(290,545,300,535);		
		$io_pdf->addText(305,535,10,"Bienes Muebles"); // Agregar texto
		$io_pdf->rectangle(420,535,10,10);   // rectángulo pequeño
		...
		$io_pdf->addText(660,520,8,"No.:  ".$as_cmpmov); // Agregar la Fecha
		$io_pdf->addText(660,505,8,"Fecha:  ".date("d/m/Y")); // Agregar la Fecha
		$io_pdf->restoreState();
		$io_pdf->closeObject();
	...
	function uf_print_cabecera($as_codemp,$as_nomemp,$ls_coduniadm,$ls_denuniadm,&$io_pdf)
	{
		...
		// Fecha Creación: 21/04/2006                      Fecha de Modificación: 10/04/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);
	...
	else // Imprimimos el reporte
	{
		...
		$io_fun_activos->uf_load_seguridad_reporte("SAF","tepuy_saf_r_compincorporacion.php",$ls_desc_event);
		////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////////////////
