  ...
  <p align="center">
    <input name="operacion" type="hidden" id="operacion">
	 ...
	 <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        <td height="21">&nbsp;</td>
        <td height="21"><div align="right"><a href="javascript: ue_search();"><img src="../../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a></div></td>
      </tr>
    </table>
	 <div align="center"><br>
	<?php
			...
			else
			{
				if($row=$SQL->fetch_row($rs_cta))
				{
					...
					for($z=1;$z<=$totrow;$z++)
					{
						...
						$monint=number_format($monint,2,",",".");
						$tascol=number_format($tascol,2,",",".");
						print "<td align=center><a href=\"javascript: aceptar('$numcol','$dencol','$codban','$nomban','$ctaban','$dencta','$status','$codtipcol','$nomtipcol','$feccol','$monto','$fecvencol','$monint','$sc_cuenta','$denscg','$ls_cuenta','$diacol','$tascol');\">".$numcol."</a></td>";
						...
						print "<td align=center>".$monint."</td>";
...
<script language="JavaScript">
  function aceptar(numcol,dencol,codban,nomban,ctaban,dencta,status,codtipcol,nomtipcol,feccol,monto,fecvencol,
                   monint,sc_cuenta,denscg,ls_cuenta,diacol,tascol)
  {
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_scb_cat_colocacion.php";
	  f.submit();
  }
</script>
</html>
