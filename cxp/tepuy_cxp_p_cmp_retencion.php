<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_p_cmp_retencion.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
   ...
   function uf_limpiarvariables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		global $ls_mes,$arr_fecha,$ld_fecemicom,$ls_agno,$ls_operacion,$ls_existe,$ls_tipo,$ls_mes,$ls_mes1,$io_funciones;
		global $ls_disenb,$ls_disislr,$ls_provbenedesde,$io_fun_cxp,$ls_provbenehasta,$ls_flag,$ls_hidopctipret,$ls_descmb,$ls_disaposol;
		
		$arr_fecha        = getdate();
		$ld_fecemicom=date("d/m/Y");
		$ls_agno          = $arr_fecha["year"];
		$ls_mes           = $arr_fecha["mon"];
		$ls_mes1          = $arr_fecha["mon"];
		$ls_tipo          = "-";
		$ls_mes           = $io_funciones->uf_cerosizquierda($ls_mes,2);
		$ls_mes1          = $io_funciones->uf_cerosizquierda($ls_mes1,2);
		$ls_provbenedesde = "";
		$ls_provbenehasta = "";
		$ls_flag          = ""; 
		$ls_hidopctipret  = "";
   ...
   function uf_load_variables()
   {
		...
		//////////////////////////////////////////////////////////////////////////////
   		global $ls_disenb,$ld_fecemicom,$ls_disislr,$ls_tipo,$ls_mes,$ls_mes1,$ls_agno,$ls_provbenedesde,$ls_provbenehasta,$ls_flag,$ls_descmb,$ls_hidopctipret;
				
	$ls_tipo          = $_POST["estprov"];
	$ld_fecemicom	  = $_POST["txtfecemicom"];
	$ls_mes           = $_POST["mes"];
	$ls_mes1          = $_POST["mes1"];
	$ls_agno          = $_POST["agno"];
...
<html>
<head>
<title>Generaci&oacute;n de Comprobantes de Retenci&oacute;n</title>
...
<!--  <tr>
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_nuevo();"><img src="../shared/imagebank/tools20/nuevo.png" alt="Nuevo" width="20" height="20" border="0"></a><a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/ayuda.png" alt="Ayuda" width="20" height="20"></td>
  </tr>
</table>
<?php
...
$io_retencion=new tepuy_cxp_c_cmp_retencion("../");
...
$ls_conivaret=$_SESSION["la_empresa"]["estretiva"];
	switch($ls_operacion)
	{
		case "NEW":
			...
			$ls_disaposol="";
			if(($ls_modageret=="B")&&($ls_conivaret=="B")&&($ls_disaposol!=""))
			{
				$io_msg->message("Todos los comprobantes se generan por el Módulo de Caja y Banco");	
			}
			else
			{
			//	uf_load_variables(); 
		...
		case "PROCESAR":
			uf_load_variables();
			//print "tipo de comprobante: ".$ls_hidopctipret;
			//print "Fecha del Comprobante: ".$ld_fecemicom;  
			//print "Mes de Busqueda: ".$ls_mes1;  
	        $li_numcmp=$io_retencion->uf_procesar_cmp_retencion($ld_fecemicom,$ls_mes,$ls_agno,$ls_provbenedesde,$ls_provbenehasta,$ls_tipo,$ls_hidopctipret,$la_numcmp,$la_seguridad,$ls_mes1);
	        if($li_numcmp>0)
	         {
...
?>
  ...
  <table width="474" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
    <tr class="titulo-celdanew">
      <td width="462" height="22" colspan="4" style="text-align:center" class="titulo-celdanew">Comprobante de Retenci&oacute;n</td>
    </tr>
    <tr>
      <td height="13" colspan="4" align="center">&nbsp;</td>
    </tr>
    <tr>
      <td height="13" colspan="5" align="center"><table width="435" border="0" cellspacing="0" class="formato-blanco">
	 ...
	 <td width="90">&nbsp;</td>
        ...
        <tr>
          ...
          <td height="22"><div align="center">
			    <div align="right">Imp. Municipal
			      <input type="radio" name="opctipret" value="M" <?php print $ls_disenb;?>>
			       </div>
          </div></td>
          <td><div align="right">ISLR
            <input type="radio" name="opctipret" value="S"   <?php print $ls_disenb;?>>
          </div></td>
	  <td><div align="right">Tim. Fiscal
            <input type="radio" name="opctipret" value="T"   <?php print $ls_disenb;?>>
          </div></td>
          <td><div align="right">Ap. Social
            <input name="opctipret" type="radio" value="O" <?php print $ls_disenb;?>>
          </div></td>
          <td>&nbsp;</td>
        </tr>
      </table></td>
        ...
        <tr>
          ...
          <td width="121"><div align="left">
            <input name="agno" type="text" id="agno" style="text-align:center " value="<?php print $ls_agno;?>" size="10" maxlength="4">
                ...
                <td width="119" height="22"><input name="txtfecemicom" type="text" id="txtfecemicom" onKeyPress="javascript: ue_formatofecha(this,'/',patron,true);" value="<?php print $ld_fecemicom;?>" size="17"  style="text-align:center" datepicker="true"></td>
              </tr>
</div></td>
        </tr>
      </table></td>
    ...
    <tr>
      <td height="13" colspan="4" align="center"><table width="398" border="0" cellspacing="0" class="formato-blanco">
		<tr class="titulo-celda">
          <td colspan="4"><div align="center"><strong>Mes de Busqueda de la Orden de Pago</strong></div></td>
      <tr class="titulo-celda">
          <td width="70">&nbsp;</td>
          <td width="143">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td width="113"><div align="left">
            	<?php $io_retencion->uf_cmb_mes1($ls_mes1); //Combo que contiene los meses del año y retorna selecciona el que el ususario tenga acutalmente ?>
          </div></td>
              </tr>
    <tr>
      <td height="73" colspan="4" align="center">
        <table width="398" border="0" cellspacing="0" class="formato-blanco">
          ...
          <tr>
            ...
            <td width="159" align="left"><input name="txtcodigo1" type="text" id="txtcodigo1">              <a href="javascript:uf_catalogo_proben('D');"><img src="../shared/imagebank/tools15/buscar.png" name="buscar1" width="15" height="15" border="0"  id="buscar1" onClick="document.form1.hidrangocodigos.value=1"></a></td>
            <td width="43" align="right">Hasta</td>
            <td width="147" align="left"><input name="txtcodigo2" type="text" id="txtcodigo2">              <a href="javascript:uf_catalogo_proben('H');"><img src="../shared/imagebank/tools15/buscar.png" name="buscar2" width="15" height="15" border="0" id="buscar2"  onClick="document.form1.hidrangocodigos.value=2"></a></td>
          </tr>
			<?php }?>
      </table>      </td>
    </tr>
    <tr>
      ...
      </strong><img src="../shared/imagebank/tools20/ejecutar.png" width="20" height="20" border="0">Ejecutar</a></p>        </td>
    </tr>
  </table> 
</table>
 ...
 <input name="hiddisenb" type="hidden" id="hiddisenb" value="<?php print $ls_disislr?>">
...
<script language="JavaScript">
	...
	function ue_nuevo()
	{
		  ...
		  {	
			  ...
			  f.hiddisenb.value="";
			  f.hiddescmb.value="";
			  f.action="tepuy_cxp_p_cmp_retencion.php";
			  f.submit();	  
		  }
		  else
		  {
	...
	function ue_procesar()
	{
	    ...
	    {	
			...
			if (valrad=="")
			 ...
			 {
				if ((f.txtcodigo1.value=="")||(f.txtcodigo2.value==""))
				{
				alert("Debe seleccionar el proveedor o beneficiario");
				}
			 	else
			 	{
