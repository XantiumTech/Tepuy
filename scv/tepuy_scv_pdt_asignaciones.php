  ...
  <table width="555" border="0" align="center" class="formato-blanco">
    <tr>
      <td height="22" colspan="4"><div align="center">
          <input name="rdprocedencia" type="radio" class="sin-borde" value="radiobutton" onClick="javascript: ue_tablaviaticos();">
      Tabla de Viaticos 
    ...
    <tr>
      ...
      <td width="97"><a href="javascript: ue_agregar();"><img src="../shared/imagebank/tools15/aprobado.png" width="15" height="15" class="sin-borde">Agregar Detalle</a> </td>
      <td width="69"><a href="javascript: ue_cancelar();"><img src="../shared/imagebank/tools15/eliminar.png" width="15" height="15" class="sin-borde">Cancelar</a></td>
    </tr>
  </table>
</form>
</body>
<script language="javascript">
function ue_tablaviaticos()
{
	f=document.form1;
	ls_destino="SOLICITUD";
	window.open("tepuy_scv_cat_tablaviaticos.php?destino="+ls_destino+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
...
function ue_tarifaviaticos()
{
	f=document.form1;
	ls_destino="SOLICITUD";
	window.open("tepuy_scv_cat_tarifas.php?destino="+ls_destino+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
	li_numdia=f.hidnumdia.value;
	f.txtcanasi.value=li_numdia;
}
...
function ue_transporte()
{
	f=document.form1;
	ls_destino="SOLICITUD";
	window.open("tepuy_scv_cat_transporte.php?destino="+ls_destino+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
...
function ue_tarifadistancia()
{
	f=document.form1;
	ls_destino="SOLICITUD";
	window.open("tepuy_scv_cat_tarifasxdistancias.php?destino="+ls_destino+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
	f.txtcanasi.value="0,00";
}
...
function ue_otrastarifas()
{
	f=document.form1;
	ls_destino="SOLICITUD";
	window.open("tepuy_scv_cat_otrasasignaciones.php?destino="+ls_destino+"","_blank","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=no");
	f.txtcanasi.value="0,00";
}
