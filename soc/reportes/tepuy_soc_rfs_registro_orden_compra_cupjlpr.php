...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_estcondat,$as_numordcom,$ad_fecordcom,$as_coduniadm,$as_denuniadm, $as_codfuefin,
									   ...
									   $ls_forpagcom,$ls_condicion,$ls_lugentdir,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// Fecha Creación: 21/06/2007                   Fecha de Modificación: 08/04/2008
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$io_encabezado=$io_pdf->openObject();
		$io_pdf->saveState();
		$io_pdf->setStrokeColor(0,0,0);
		$io_pdf->line(15,40,585,40);   // linea del pie
		$io_pdf->line(480,685,480,760);  // linea vertical
		$io_pdf->line(480,725,585,725);  // linea horizontal
        $io_pdf->Rectangle(15,685,570,75);
		...
		$io_pdf->addText(183,750,9,"<b>REPUBLICA BOLIVARIANA DE VENEZUELA</b>"); // Agregar el título
		$io_pdf->addText(189,738,9,"<b>MINISTERIO DE EDUCAIÓN SUPERIOR</b>"); // Agregar el título
		$io_pdf->addText(215,727,9,"<b>COLEGIO UNIVERSITARIO</b>"); // Agregar el título
		$io_pdf->addText(175,715,9,"<b>PROFESOR JOSÉ LORENZO PEREZ RODRIGUEZ</b>"); // Agregar el título
		$io_pdf->addText(225,690,12,$ls_titulo); // Agregar el título
		...
		$io_pdf->addText(167,122,7,"PRESUPUESTO"); // Agregar el título
		//$io_pdf->addText(160,63,7,""); // Agregar el título
		$io_pdf->line(260,60,260,130);	//VERTICAL		
		$io_pdf->addText(295,122,7,"CONTROL INTERNO"); // Agregar el título
		$io_pdf->addText(300,63,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->line(410,60,410,130);	//VERTICAL		
		$io_pdf->addText(445,122,7,"ADMINSITRACION-DIRECCIÓN"); // Agregar el título
		...
		$la_data[1]=array('columna1'=>'<b>Nº OCEI:</b>  ');
		...
		$la_data[1]=array('columna1'=>'<b>Fuente Financiamiento</b>   '.$ls_fuefin,'columna2'=>'<b> Condición de Pago</b>    '.$ls_condicion);
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		$la_data[1]=array('columna1'=>'<b>Concepto</b>         '.$as_conordcom,'columna2'=>'<b>Lugar de Entrega</b>    '.$ls_lugentdir);
		$la_columnas=array('columna1'=>'','columna2'=>'');
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 'fontSize' => 9, // Tamaño de Letras
						 'titleFontSize' => 12,  // Tamaño de Letras de los títulos
		...
		if($lb_valido)	
		{
			...
			if ($row=$io_sql->fetch_row($rs_data))
			{
				...
				uf_print_encabezado_pagina($ls_estcondat,$ls_numordcom,$ld_fecordcom,$ls_coduniadm,$ls_denuniadm,
										   ...
										   $ls_diaplacom,$ls_dirpro,$ls_forpagcom,$ls_condicion,$ls_lugentdir,&$io_pdf);
				/////DETALLE  DE  LA ORDEN DE COMPRA
			   //$rs_datos = $io_report->uf_select_detalle_orden_imprimir($ls_numordcom,$ls_estcondat,&$lb_valido);
			   $rs_datos= $io_report->uf_select_detalleorden_imprimir($ls_numordcom,$ls_estcondat,&$lb_valido); // Cargar los datos del reporte
			   if ($lb_valido)
			   {
			    ...
			    /*	for ($i=$li_i+1;$i<=25;$i++)
						...
						$la_data[$i]=array('codigo'=>$ls_codartser,'denominacion'=>$ls_denartser,'cantidad'=>$li_cantartser,
										   'unidad'=>$ls_unidad,'cosuni'=>$ld_preartser,'baseimp'=>$ld_subtotartser,
										   'cargo'=>$ld_carartser,'montot'=>$ld_totartser);  //print_r($la_data);
						} */
