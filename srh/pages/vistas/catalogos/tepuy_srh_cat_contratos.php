...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_cat_contratos.js"></script>
...
<br>
  ...
  <tr>
        ...
        <a href="javascript:catalogo_tipocontrato();"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Cat&aacute;logo Tipos de Documentos" name="buscartip" width="15" height="15" border="0" id="buscartip"></a>
      </div></td>
	  ...
	  <td>&nbsp;</td>
       ...
       <td width="146"><div align="right"><a href="javascript: Limpiar_busqueda(); ">  <img src="../../../public/imagenes/nuevo.png" alt="Limpiar" width="15" height="15" border="0">Limpiar</a></div></td>
       <td width="221"><div align="right"><a href="javascript: Buscar()">  <img src="../../../../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Haga click aqu&iacute; para Buscar</a></div></td>
      </tr>
