...
<p>&nbsp;</p>
	...
	<script>
		...
		var loadDataURL = "../../php/tepuy_srh_a_nivelseleccion.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_nivelseleccion.php";
		var mygrid;
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_nivelseleccion.php?valor=buscar"+"&txtcodniv="+codniv+"&txtdenniv="+denniv);
           setTimeout (terminar_buscar,500);
