...
if (array_key_exists("txtsaldoreal",$_GET))
{
   $ld_saldoreal=$_GET["txtsaldoreal"];
}

if (array_key_exists("txtsaldoapro",$_GET))
{
   $ld_saldoapro=$_GET["txtsaldoapro"];
}

if (array_key_exists("txtsaldomod",$_GET))
{
   $ld_saldomod=$_GET["txtsaldomod"];
}
...
<?php 
  ...
  ?>
      <td width="71" class="fd-blanco"><div align="right">Enero</div></td>
      <td width="153">
        <div align="left">
        ...
        </div></td><td width="82" class="fd-blanco"><div align="right">Julio</div></td>
      <td width="140"><input name="txtJulio" type="text" class="fd-blanco" id="txtJulio3"  onKeyPress="return(currencyFormat(this,'.',',',event))" value="<?php print $ld_julio?>" onBlur="uf_actualizar(this)"></td>
  ...
  if($ls_operacion=="ACEPTAR")
  {
	...
	$ld_saldoapro=$_POST["txtsaldoapro"];
	...
	$ld_asignado=str_replace(',','.',$ld_asignado);	
	$ld_saldoreal=str_replace('.','',$ld_saldoreal);
	$ld_saldoreal=str_replace(',','.',$ld_saldoreal);		
	$ld_saldoapro=str_replace('.','',$ld_saldoapro);
	$ld_saldoapro=str_replace(',','.',$ld_saldoapro);
	$ld_saldomod=str_replace('.','',$ld_saldomod);
	$ld_saldomod=str_replace(',','.',$ld_saldomod);		
    ...
    else
    {
	  ...
	  $ds_prorep->updateRow("saldo_real_ant",$ld_saldoreal,$i);
	  $ds_prorep->updateRow("saldo_apro",$ld_saldoapro,$i);
	  $ds_prorep->updateRow("saldo_mod",$ld_saldomod,$i);
...
?>
      ...
      <td colspan="3" rowspan="10"><input name="botAceptar" type="button" class="boton" id="botAceptar2" onClick="ue_aceptar()" value="Aceptar">        
    ...
    <tr>
      ...
      <td><input name="txtsaldoreal" type="text" class="fd-blanco" id="txtsaldoreal"  onKeyPress="return(currencyFormat(this,'.',',',event))" value="<?php print $ld_saldoreal ?>" readonly></td>
    </tr>
    <tr>
      <td class="fd-blanco">&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><input name="txtsaldoapro" type="text" class="fd-blanco" id="txtsaldoapro"  onKeyPress="return(currencyFormat(this,'.',',',event))" value="<?php print $ld_saldoapro ?>" readonly></td>
    </tr>
    <tr>
      <td class="fd-blanco">&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      ...
      <td><input name="txtsaldomod" type="text" class="fd-blanco" id="txtsaldomod"  onKeyPress="return(currencyFormat(this,'.',',',event))" value="<?php print $ld_saldomod ?>" readonly></td>
    </tr>
    <tr>
      <td class="fd-blanco">&nbsp;</td>
      <td>&nbsp;</td>
...
function ue_aceptar()
{
	...
	{	
		...
		f.action="tepuy_scg_wdist_manual.php";
		f.submit();
	}
}
