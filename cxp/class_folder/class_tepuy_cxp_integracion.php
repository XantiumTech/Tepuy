...
class class_tepuy_cxp_integracion
{
	...
	//print "pase";
		...
		//	$lb_valido=$this->io_fun_mis->uf_convertir_tepuycmp($this->as_procede,$this->as_comprobante,$this->ad_fecha,
			$lb_valido=$this->io_fun_mis->uf_convertir_tepuycmp($this->as_procede,$this->as_comprobante,$ldt_fecha,
		...
		if($lb_valido)
		{
			...
			$lb_valido=$this->io_fun_mis->uf_convertir_spgdtcmp($this->as_procede,$this->as_comprobante,$ldt_fecha,
																$this->as_codban,$this->as_ctaban,$aa_seguridad);
		}
		if($lb_valido)
		{
			//$lb_valido=$this->io_fun_mis->uf_convertir_scgdtcmp($this->as_procede,$this->as_comprobante,$this->ad_fecha,
			$lb_valido=$this->io_fun_mis->uf_convertir_scgdtcmp($this->as_procede,$this->as_comprobante,$ldt_fecha,
																$this->as_codban,$this->as_ctaban,$aa_seguridad);
		}
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function uf_procesar_anular_solicitud($as_numsol,$adt_fecha,$ad_fechaconta,$aa_seguridad)
	{
		...
		if ($lb_valido)
		{
			$lb_valido=$this->io_tepuy_int->uf_init_end_transaccion_integracion($aa_seguridad,$ldt_fecha_anula); 
			if($lb_valido===false)
			{
				$this->io_msg->message("".$this->io_tepuy_int->is_msg_error);
			}
