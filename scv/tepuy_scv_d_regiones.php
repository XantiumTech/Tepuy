...
$io_fun_viaticos->uf_load_seguridad("SCV","tepuy_scv_d_regiones.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
require_once("class_folder/tepuy_scv_c_regiones.php");
$io_region= new tepuy_scv_c_regiones($conn);
$lb_existe= "";
global $object;
...
switch ($ls_operacion) 
{
	case "NUEVO":
		...
		$object[1][3]="<a href=javascript:uf_delete(1);><img src=../shared/imagebank/tools20/eliminar.png alt=Aceptar width=15 height=15 border=0></a>";
		$li_totrows = 1;	
	break;
	case "PINTAR":
		...
		for ($li_i=1;$li_i<=$li_totrows;$li_i++)
		{
			if (array_key_exists("txtcodest".$li_i,$_POST))
			{
				...
				$object[$li_i][3]="<a href=javascript:uf_delete(".$li_i.");><img src=../shared/imagebank/tools20/eliminar.png alt=Aceptar width=15 height=15 border=0></a>";
			}
			else
			{
		...
		{           
			...
			{ 
				...
				if ($lb_valido)
				{
					...
					$lb_empresa=true;
					$ls_codreg=$io_funciondb->uf_generar_codigo($lb_empresa,$ls_codemp,'scv_regiones','codreg');
					$ls_denreg="";
					$ls_estatus="NUEVO";
				}
				else
	...
	case "DELETEROW":
		...
		{ 
			...
			{  		
				...
				$object[$li_temp][3]="<a href=javascript:uf_delete(".$li_temp.");><img src=../shared/imagebank/tools20/eliminar.png alt=Aceptar width=15 height=15 border=0></a>";
			}
			else
			{	
				$li_rowdelete=0;
...
<table  border="0" cellspacing="0" cellpadding="0" class="formato-blanco" align="center">
      ...
      <tr> 
        ...
        <td height="22" ><input name="txtcodreg" type="text" id="txtcodreg" value="<?php print $ls_codreg ?>" size="10" maxlength="5" style="text-align:center" onBlur="javascript:rellenar_cad(this.value,5)" onKeyPress="return keyRestrict(event,'1234567890');" readonly> 
      ...
      <tr>
        <td height="22" colspan="2"><a href="javascript:uf_cat_estados();"><img src="../shared/imagebank/tools20/nuevo.png" width="20" height="20" border="0" alt="Agregar Estado">Agregar Estado</a>
...
function uf_cat_estados()
{
	...
	ls_destino="REGIONES";
	pagina= "tepuy_scv_cat_estados.php?codpai="+ls_codpais+"&destino="+ls_destino+"";
...
function ue_nuevo()
{
	...
	{	
		...
		if (ls_codpais!="---")
		{
			...
			f.action="tepuy_scv_d_regiones.php";
			f.submit();
		}
		else
		{
    ...
    if (ls_codpais!="---")
	   {
		 if (li_leer==1)
		    {
			  f.operacion.value="";			
			  pagina="tepuy_scv_cat_regiones.php?hidpais="+ls_codpais;
