...
if ($ls_operacion=="BUSCAR")
   {
	 ...
	 $ls_sql="SELECT codestpro1,codestpro2,codestpro3,denestpro3,responsable,tepuy_fuentefinanciamiento.codfuefin,tepuy_fuentefinanciamiento.denfuefin
		 ...
		 for ($z=1;$z<=$totrow;$z++)
		     {
			   ...
			   print "<td width=150 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3','$ls_responsable','$ls_codfuefin','$ls_denfuefin');\">".trim($ls_codestpro1)."</td>";
			   print "<td width=100 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3','$ls_responsable','$ls_codfuefin','$ls_denfuefin');\">".trim($ls_codestpro2)."</td>";
			   print "<td width=50 align=\"center\"><a href=\"javascript: aceptar('$ls_codestpro3','$ls_denestpro3','$ls_responsable','$ls_codfuefin','$ls_denfuefin');\">".trim($ls_codestpro3)."</a></td>";
...
function aceptar(ls_codestpro3,ls_denestpro3,ls_responsable,ls_codfuefin,ls_denfuefin,ls_pantalla)
{
