<?php
	...
	$io_fun_nomina->uf_load_seguridad("SNR","tepuy_snorh_d_establecer_periodo.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
function ue_guardar()
{
	...
	if(marcados>0)
	{
		...
		else
		{
			...
			f.action="tepuy_snorh_d_establecer_periodo.php";
			f.submit();		
		}
	}
	else
