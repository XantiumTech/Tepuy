...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_sigecof.php",$ls_permisos,$la_seguridad,$la_permisos);
...
function uf_mostrar_reporte()
{
	...
	if(li_imprimir==1)
	{
		...
		window.open("reportes/tepuy_saf_rpp_sigecof.php?orden="+li_orden+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
	}
	else
