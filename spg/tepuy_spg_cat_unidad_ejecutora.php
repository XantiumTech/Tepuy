...
<?php
	...
	if($ls_operacion=="BUSCAR")
	{
		$ls_sql=" SELECT coduniadm,denuniadm ".
				...
				" WHERE  codemp='".$ls_codemp."' AND coduniadm like '".$ls_codigo."' AND denuniadm like '".$ls_denominacion."' "; 
		if($ls_estpro1!="")
		{
			 ...
			 if($li_estmodest==2)
			 {
				 if($ls_estpro4!="")
				 {
					$ls_sql=$ls_sql." AND codestpro4='".$ls_estpro4."' ";
				 }
				 if($ls_estpro5!="")
				 {
					$ls_sql=$ls_sql." AND codestpro5='".$ls_estpro5."' ";
				 }
			 }
		}
...
function ue_search()
{
	...
	f.action="tepuy_spg_cat_unidad_ejecutora.php?tipo=<?php print $ls_tipo; ?>";
	f.submit();
}
