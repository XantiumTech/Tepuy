...
<?
	...
	{
		$ls_sql="SELECT siv_toma.numtom,siv_toma.codalm,siv_toma.fectom,siv_toma.estpro,".
		...
		if($row=$io_sql->fetch_row($rs_cta))
		{
			...
			for($z=1;$z<=$totrow;$z++)
			{
				...
				print "<td><a href=\"javascript: aceptar('$ls_numtom','$ls_codalm','$ls_nomfisalm','$ld_fectom','$ls_estpro');\">".$ls_numtom."</a></td>";
...
<script language="JavaScript">
	function aceptar(ls_numtom,ls_codalm,ls_nomfisalm,ld_fectom,ls_estpro)
	{
	...
	function ue_search()
  	{
		...
		f.action="tepuy_siv_cat_tomaalmacen.php";
		f.submit();
	}
</script>
</html>
