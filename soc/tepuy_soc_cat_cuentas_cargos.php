...
<html>
<head>
<title>Cat&aacute;logo de Cuentas Presupuestarias para los Cargos</title>
...
<br>
    <table width="500" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
	  <tr>
	    <td height="22" colspan="2" class="titulo-celda">Cat&aacute;logo de Cuentas Presupuestarias para los Cargos </td>
      </tr>
	  <tr>
	    <td height="15">&nbsp;</td>
	    <td height="15">&nbsp;</td>
	  ...
	  <tr>
	    <td width="55" height="22" style="text-align:right">Cargo</td>
        <td width="439" height="22"><input name="txtcodcar" type="text" id="txtcodcar" size="10" maxlength="5" onBlur="javascript: ue_rellenarcampo(this,5);" style="text-align:center" readonly>
        <a href="javascript: ue_catalogo_cargos();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0" /></a>
        <label><input name="txtdencar" type="text" class="sin-borde" id="txtdencar" size="60" style="text-align:left" readonly>
        </label>        </td>
	  </tr>
	  <tr>
...
{
	window.open("tepuy_soc_cat_cargos.php","_blank","menubar=no,toolbar=no,scrollbars=yes,width=600,height=400,resizable=yes,location=no,left=50,top=50");
}
...
function ue_aceptar(as_programatica,as_cuenta,as_denominacion,as_codespro)
{
	...
	for(j=1;(j<=rowcuentas)&&(valido);j++)
	{
		...
		if((cuentagrid==as_cuenta)&&(codcargo==cargo)&&(as_codespro==programatica))
		{
	...
	if(tipo=="B")
	{
		...
		for(j=1;(j<rowbienes)&&(valido);j++)
		{
			...
			parametros=parametros+"&txtcodart"+j+"="+codart+"&txtdenart"+j+"="+denart+""+
					   ...
					   "&txtdenunimed"+j+"="+ls_denunimed+"&txtnumsolord"+j+"="+ls_numsolord+""+
					   "&txtcoduniadmsep"+j+"="+ls_coduniadm+"&txtdenuniadmsep"+j+"="+ls_denuniadm+""+
	...
	parametros=parametros+"&txtcodcargo"+rowcuentas+"="+codcargo+"&txtcodprocar"+rowcuentas+"="+as_codespro+"&txtcuentacar"+rowcuentas+"="+as_cuenta+
			   "&totalcuentascargo="+totalcuentas;
	//---------------------------------------------------------------------------------
...
function ue_search()
{
	...
	ajax.send("catalogo=CUENTAS-CARGOS&codestpro1="+codestpro1+"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+
			  "&codestpro4="+codestpro4+"&codestpro5="+codestpro5+"&orden="+orden+"&campoorden="+campoorden+"&tipo="+tipo);
}
