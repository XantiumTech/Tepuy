<?php
	...
	$io_fun_nomina->uf_load_seguridad_nomina("SNO","tepuy_sno_p_hajustarcontabilizacion.php",$ls_codnom,$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	if (li_ejecutar==1)
   	{
		if(f.contabilizado.value=="0")
		{
			...
			f.action="tepuy_sno_p_hajustarcontabilizacion.php";
			f.submit();
		}
		else
		{
