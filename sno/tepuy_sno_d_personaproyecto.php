<?php
   session_start();
	...
	$io_fun_nomina->uf_load_seguridad_nomina("SNO","tepuy_sno_d_personaproyecto.php",$ls_codnom,$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
   ...
   function uf_agregarlineablanca(&$aa_object,$ai_totrows)
   {
		...
		// Fecha Creación: 04/07/2006 								Fecha Última Modificación : 
		//////////////////////////////////////////////////////////////////////////////
		$aa_object[$ai_totrows][1]="<div align='center'><a href='javascript:ue_buscarproyecto();'><img src='../shared/imagebank/tools20/buscar.png' alt='Buscar' width='15' height='15' border='0'></a></div>";
	...
	switch ($ls_operacion) 
	{
		...
		case "CARGARPROYECTO":
			...
			for($li_i=1;$li_i<=$li_totrows;$li_i++)
			{
				...
				$li_pordiames=$_POST["txtpordiames".$li_i]; 
				$lo_object[$li_i][1]="<div align='center'><a href=javascript:ue_eliminarproyecto('$ls_codproy');><img src='../shared/imagebank/tools20/eliminar.png' alt='Eliminar' width='15' height='15' border='0'></a></div>";
			...
			for($li_i=1;$li_i<$li_totrows;$li_i++)
			{
				...
				if($ls_proyecto==$ls_codproy)
				{
					...
					else
					{
						...
						$li_totdiames=$_POST["txttotdiames".$li_i]; 
						$li_pordiames=$_POST["txtpordiames".$li_i]; 
						$lo_object[$li_j][1]="<div align='center'><a href=javascript:ue_eliminarproyecto('$ls_codproy');><img src='../shared/imagebank/tools20/eliminar.png' alt='Eliminar' width='15' height='15' border='0'></a></div>";
      ...
      <tr>
		...
		<table width="600" border="0" align="center" cellpadding="1" cellspacing="0" class="formato-blanco">
              ...
              <tr >
                ...
                <td align="left">
                  <input name="txtuniadm" type="text" class="sin-borde3" id="txtuniadm" value="<?php print $ls_uniadm; ?>" size="33" maxlength="30" readonly>
</td>
              </tr>
              <tr >
	...
	{		
		...
		if(li_cambiar==1)
		{
			...
			if(lb_valido)
			{
				...
				f.action="tepuy_sno_d_personaproyecto.php";
				f.submit();
			}
		}
		else
...
function ue_eliminarproyecto(codproy)
{
	...
	f.action="tepuy_sno_d_personaproyecto.php?codproy="+codproy+"";
	f.submit();
}
...
function ue_buscar()
{
	...
	if (li_leer==1)
   	{
		window.open("tepuy_sno_cat_personalnomina.php?tipo=personaproyecto","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
   	}
	else
   	{
 		alert("No tiene permiso para realizar esta operacion");
...
{
	window.open("tepuy_snorh_cat_proyecto.php?tipo=personaproyecto","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=530,height=400,left=50,top=50,location=no,resizable=no");
}
