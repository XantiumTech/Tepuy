<?php
	...
	$io_fun_cxp->uf_load_seguridad("CXP","tepuy_cxp_r_librocompra_res.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
?>
...
<table width="762" border="0" align="center" cellpadding="0" cellspacing="0" class="contorno">
             <tr>
               <td width="780" height="30" colspan="11" class="cd-logo"><img src="../shared/imagebank/header.jpg" alt="a" width="778" height="40"></td>
             </tr>
             <tr>
...
function uf_imprimir()
{
	...
	if(li_imprimir==1)
	{
		...
		pagina= "reportes/tepuy_cxp_rpp_librocompra_res.php?mes="+ls_mes+"&agno="+ls_ano+"&tiporeporte="+tiporeporte;
