...
class tepuy_srh_c_inscripcion_concurso 
{
	var $io_sql;
	var $io_msg;
	var $io_funcion;
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	public function tepuy_srh_c_inscripcion_concurso($path)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	}// end function tepuy_srh_c_inscripcion_concurso
...
function uf_srh_buscar_concursante($as_codcon,$as_codper,$as_apeper,$as_nomper)
	{
		...
		$ls_sql= " SELECT srh_concursante.*, tepuy_pais.despai, tepuy_estados.desest, ".
		         ...
		         " sno_asignacioncargo.codasicar ".
		 		 " FROM tepuy_pais, tepuy_estados,sno_profesion, srh_concursante,srh_concurso ".
				 ...
				 " AND tepuy_pais.codpai = srh_concursante.codpai ".
				 " AND srh_concurso.codcon = srh_concursante.codcon ".
				 " AND tepuy_estados.codpai = srh_concursante.codpai ".
				 " AND tepuy_estados.codest = srh_concursante.codest ".				
...
function uf_srh_guardar_cursos ($ao_cursos,$as_operacion="insertar", $aa_seguridad)
  { 
		...
		//         access: public (tepuy_srh_cursosconcursante)
...
function uf_srh_buscar_reqindcon($as_codcon,&$as_reqindcon)
{
		...
		//         access: public (tepuy_srh_requisitos_concurso)
	  	//      Argumento: $as_codcon    // código del concurso						
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{		
			...
			{
				 $this->io_msg->message("No se encontraron Requisitos de Concurso asiados al concursante ".$as_codper);
				  $lb_existe=false;
			}
			$this->io_sql->free_result($rs_data);
		}
