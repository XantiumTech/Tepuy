...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPI";
	$ls_ventanas="tepuy_spi_p_apertura.php";
...
<table width="798" height="241" border="0" align="center">
  <tr>
    ...
    Manual </td>
              <td><a href="javascript:ue_distribuir();"><img src="../shared/imagebank/tools15/aprobado.png" alt="Aceptar" width="15" height="15" border="0"></a></td>
            </tr>
          </table>
        </div></td>
        </tr>
		   ...
		   if($lb_valido)
		   {
			  if($row=$SQL->fetch_row($rs_data))
			  {
			   ...
			   {    
					...
					$object[$i][3]="<input type=text name=txtPrevisto".$i." onBlur=uf_format(this) class=sin-borde onKeyPress=return(ue_formatonumero(this,'.',',',event)) onFocus= uf_fila(".$i.") value=$ld_previsto style=text-align:right><input name=enero".$i." type=hidden id=enero".$i." value='$ld_enero'>
   ...
   if(li!="")
   {
	   ...
	   else
	   {
			...
			if (document.opcion=="M" ) 
			{
				 ...
				 pagina="tepuy_spi_p_apertura_distribucion.php?fila="+li+"&txtPrevisto="+ld_previsto+"&enero="+ld_enero
...
function ue_guardar()
{
	...
	else
	{
		...
		f.action="tepuy_spi_p_apertura.php";
		f.submit();
	}	
}
