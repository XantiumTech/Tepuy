...
$io_fun_activo->uf_load_seguridad("SAF","tepuy_saf_r_relmovbm2.php",$ls_permisos,$la_seguridad,$la_permisos);
            ...
            <table width="497" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
                ...
                <tr>
                  ...
                  <td height="22"><input name="txtcodrespri" type="text" id="txtcodrespri" size="15" style="text-align:center" readonly>
                    <a href="javascript: uf_resprimario('repasignadospri');"><img src="../shared/imagebank/tools15/buscar.png" alt="BUSCAR" width="15" height="15" border="0"></a>
                ...
                <tr>
                  ...
                  <td height="22"><input name="txtcodresuso" type="text" id="txtcodresuso" size="15" style="text-align:center" readonly>
                    <a href="javascript: uf_resprimario('repasignadosuso');"><img src="../shared/imagebank/tools15/buscar.png" alt="BUSCAR" width="15" height="15" border="0"></a>
                ...
                <tr>
                  ...
                  <td height="22"><input name="txtcodresact" type="text" id="txtcodresact" size="15"  style="text-align:center" readonly>
                    <a href="javascript: uf_resprimario('responsableactual');"><img src="../shared/imagebank/tools15/buscar.png" alt="BUSCAR" width="15" height="15" border="0"></a>
...
//	codigo=f.txtcodgru.value;
	...
	if(codgru!="---")
	{
		...
		window.open("tepuy_saf_cat_subgrupo.php?txtcodgru="+codgru+"&txtdengru="+dengru+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
		f.txtcodsec.value="";
		f.txtdensec.value="";
	}
	else
...
function ue_seccion()
{
	...
	if((codgru!="---")||(codsubgru!="---"))
	{
		window.open("tepuy_saf_cat_seccion.php?txtcodgru="+codgru+"&txtcodsubgru="+codsubgru+"&txtdengru="+dengru+"&txtdensubgru="+densubgru+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
	}
	else
	{
	...
	function uf_mostrar_reporte()
	{
			...
			if(li_imprimir==1)
			{
				...
				window.open("reportes/tepuy_saf_rpp_relmovbm2.php?ordenact="+li_ordenact+"&coddesde="+ls_coddesde+"&codhasta="+ls_codhasta+"&desde="+ls_desde+"&hasta="+ls_hasta+"&codgru="+ls_grupo+"&codsubgru="+ls_subgrupo+"&codsec="+ls_seccion+"&coduniadm="+ls_coduniadm+"&denuniadm="+ls_denuniadm+"&tipoformato="+tipoformato+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				f.operacion.value="REPORT";
				f.action="tepuy_siv_r_relmovbm2.php";
				//f.submit();
			}
			else
