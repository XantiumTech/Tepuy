...
class tepuy_scf_c_comprobante
 {
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function tepuy_scf_c_comprobante($as_path)
	{	
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: tepuy_scf_c_comprobante
		//		   Access: public 
		...
		require_once($as_path."shared/class_folder/class_tepuy_int.php");
		require_once($as_path."shared/class_folder/class_tepuy_int_int.php");
		require_once($as_path."shared/class_folder/class_tepuy_int_spg.php");
		require_once($as_path."shared/class_folder/class_tepuy_int_scg.php");
		require_once($as_path."shared/class_folder/class_tepuy_int_spi.php");
		$this->io_intint=new class_tepuy_int_int();
		$this->io_intscg=new class_tepuy_int_scg();
        $this->ls_codemp=$_SESSION["la_empresa"]["codemp"];
	}// end function tepuy_scf_c_comprobante
	//-----------------------------------------------------------------------------------------------------------------------------------
								   ...
								   $as_codban,$as_ctaban,$ai_tipcom,$ai_totrowscg,$aa_seguridad)
	{
	    ...
	    $lb_valido=$this->io_intscg->uf_tepuy_insert_comprobante($this->ls_codemp,$as_procede,$as_comprobante,$ad_fecha,
								   ...
								   $as_codban,$as_ctaban,$ai_tipcom,$ai_totaldebe,$ai_totrowscg,$aa_seguridad)
	{
		...
		$this->io_sql->begin_transaction();				
		$ad_fecha=$this->io_funciones->uf_convertirdatetobd($ad_fecha);
		$lb_valido=$this->io_intscg->uf_tepuy_update_comprobante($this->ls_codemp,$as_procede,$as_comprobante,$ad_fecha,
																  $ai_tipcom,$as_descripcion,$as_tipodestino,$as_codpro,
																  $as_cedbene,$as_codban,$as_ctaban);
		if($lb_valido)
		{
	...
	{		
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		//	     Function: uf_guardar
		//		   Access: public (tepuy_scf_p_comprobante.php)
		...
		{
			$ld_fecha=$this->io_funciones->uf_convertirdatetobd($ad_fecha);
			$lb_valido=$this->uf_convertir_tepuycmp($as_procede,$as_comprobante,$ld_fecha,$as_codban,$as_ctaban,$aa_seguridad);
		}
	   ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		return $lb_valido;
	...
	{		
		...
		if($lb_valido)
		{		
			$lb_valido=$this->io_intscg->uf_tepuy_delete_comprobante();
		}
		if($lb_valido)
		{
			/////////////////////////////////         SEGURIDAD               /////////////////////////////		
	...
	//-----------------------------------------------------------------------------------------------------------------------------------
	function uf_convertir_tepuycmp($as_procede,$as_comprobante,$ad_fecha,$as_codban,$as_ctaban,$aa_seguridad)
	{
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if($rs_data===false)
		{ 
			$this->io_mensajes->message("CLASE->class_funciones MÉTODO->uf_convertir_tepuycmp ERROR->".$this->io_funciones->uf_convertirmsg($this->io_sql->message));
			$lb_valido=false;
		}
		else
		{
