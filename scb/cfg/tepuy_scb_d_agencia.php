  ...
  <tr>
	...
	<table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		...
		<td bgcolor="#E7E7E7" class="letras-pequeñas"><div align="right"><b><?PHP print $_SESSION["la_nomusu"]." ".$_SESSION["la_apeusu"];?></b></div></td>
	</table></td>
  </tr>
...
require_once("tepuy_scb_c_agencia.php");
...
function ue_nuevo()
{
	...
	if (li_incluir==1)
	   {	
         ...
         f.action="tepuy_scb_d_agencia.php";
		 f.submit();
	   }
	else
	   {
...
function ue_buscar()
{
	...
	if (li_leer==1)
       {
	     window.open("tepuy_scb_cat_agencias.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=518,height=400,left=50,top=50,location=no,resizable=yes");
       }
	else
	   {
		 alert("No tiene permiso para realizar esta operación");
...
function ue_cerrar()
{
	...
	function catalogo_cuentasSCG()
	 {
	   f=document.form1;
	   pagina="tepuy_cat_filt_scg.php?filtro=1110102";
