...
{
	$ls_sql="SELECT codestpro1,codestpro2,codestpro3,denestpro3 FROM spg_ep3 WHERE codemp='".$ls_codemp."' AND codestpro1 ='".$io_fun->uf_cerosizquierda($ls_codestprog1,20)."' AND codestpro2 ='".$io_fun->uf_cerosizquierda($ls_codestprog2,6)."' AND codestpro3 like '".$ls_codigo."' AND denestpro3 like '".$ls_denominacion."' ";
	...
	if($row=$SQL->fetch_row($rs_cta))
	{
		...
		for($z=1;$z<=$totrow;$z++)
		{
			...
			if($ls_estmodest==2){$codestprog1=substr($codestprog1,-2);$codestprog2=substr($codestprog2,-2);$codigo=substr($codigo,-2);}
...
//	opener.document.form1.submit();
  ...
  f.action="tepuy_cat_public_estpro3.php";
  f.submit();
  }
</script>
</html>
