...
<!--  <tr>
  ...
  <tr>
    <td height="20" width="25" class="toolbar"><div align="center"><a href="javascript: ue_ejecutar();"><img src="../shared/imagebank/tools20/ejecutar.png" alt="Ejecutar" width="20" height="20" border="0"></a><a href="javascript: ue_nuevo();"></a></div></td>
    <td class="toolbar" width="25"><div align="center"><a href="javascript: ue_guardar();"></a><a href="javascript: ue_cerrar();"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a></div></td>
...
<?php
	...
	$ls_sistema="SCB";
	$ls_ventanas="tepuy_scb_p_desprogpago.php";
	...
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	include("tepuy_spg_c_aprob_modpre.php");
	$io_cmp=new tepuy_spg_c_aprob_modpre($la_security);
  ...
  <table width="780" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td height="22">&nbsp;</td>
      <td height="22">&nbsp;&nbsp;<a href="javascript: uf_cargar_dt();"><img src="../shared/imagebank/tools15/buscar.png" alt="Cargar Comprobantes" width="15" height="15" border="0">Cargar Comprobantes</a></td>
      <td height="22">&nbsp;</td>
      <td height="22">&nbsp;</td>
    </tr>
    <tr>
...
<script language="javascript">
	...
	function ue_ejecutar()
	{
		...
		f.action="tepuy_spg_p_aprob_modpre.php";
		f.submit();
	}
