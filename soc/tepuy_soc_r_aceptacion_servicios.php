...
$io_fun_compra->uf_load_seguridad("SOC","tepuy_soc_r_aceptacion_servicios.php",$ls_permisos,&$la_seguridad,$la_permisos);
$ls_reporte= $io_fun_compra->uf_select_config("SOC","REPORTE","FORMATO_ACTA","tepuy_soc_rpp_aceptacion_servicios.php","C");
        ...
        <td height="214"><div align="center">
          <table width="509" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
             <tr class="titulo-celdanew">
               <td height="22" colspan="2" align="center" class="titulo-celdanew">Aceptaci&oacute;n de Servicios </td>
              </tr>
             <tr>
             ...
             <tr>
              ...
              <a href="javascript: uf_catalogo('tepuy_soc_cat_orden_compra.php?origen=AS&tipo=REPORTE-DESDE');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0" /></a></div></td>
            </tr>
            <tr>
              <td height="22" align="center"><div align="right">Personal</div></td>
              <td height="22" align="center"><div align="left">
                  <input name="txtcedper" type="text" id="txtcedper" style="text-align:center" value="<?php print $ls_codper ?>"/>
                  <a href="javascript: uf_catalogo('tepuy_soc_cat_personal.php?origen=AS');"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0" /></a>
                  <input name="txtnompersol" type="text" class="sin-borde" id="txtnompersol" value="<?php print $ls_nomper ?>" size="40"  />
              </div></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td height="22" align="center"><div align="left">
                  <input name="txtfecordcom" type="text" id="txtfecordcom" value="<?php print $ls_fecordcom ?>" size="17"  datepicker="true" />
              </div></td>
            </tr>
            <tr>
