...
$io_fun_compra->uf_load_seguridad("SOC","tepuy_soc_p_aprobacion_analisis_cotizacion.php",$ls_permisos,&$la_seguridad,$la_permisos);
...
<?php
require_once("class_folder/tepuy_soc_c_aprobacion_analisis_cotizacion.php");
$io_soc = new tepuy_soc_c_aprobacion_analisis_cotizacion("../");
uf_limpiarvariables();
switch($ls_operacion){
  case 'GUARDAR':
			uf_load_variables();
...
?>
    <table width="595" border="0" cellpadding="0" cellspacing="0" class="formato-blanco">
      <tr>
        <td height="22" colspan="6" class="titulo-celdanew">Aprobaci&oacute;n de An&aacute;lisis de Cotizaciones
      ...
      <tr>
        ...
        <td height="22" colspan="2" style="text-align:left"><label>
          <select name="cmbtipope" id="cmbtipope">
      ...
      <tr>
        ...
        <td height="22" style="text-align:left"><label>
          <input name="txtnumanacot" type="text" id="txtnumanacot" value="<?php print $ls_numanacot ?>" size="20" maxlength="15" style="text-align:center" onKeyPress="return keyRestrict(event,'1234567890'); " onBlur="javascript:rellenar_cad(this.value,15)" />
        </label></td>
      ...
      <!--tr>
        ...
        <td height="22" colspan="5" style="text-align:left"><label>
          <input name="txtsolcot" type="text" id="txtsolcot" value="<?php print $ls_solcot ?>" size="15" maxlength="10" style="text-align:center" readonly />
          <a href="javascript:ue_catalogo_solicitudes();"><img src="../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" /></a></label></td>
      </tr-->
      <tr>
	   ...
	   if (ls_tipope!='-')
		  {
		    ...
		    ajax.open("POST","class_folder/tepuy_soc_c_aprobacion_analisis_cotizacion_ajax.php",true);
