<?php
   ...
   function uf_print($as_codproy, $as_nomproy, $as_tipo)
   {
		...
		$ls_sql="SELECT codemp, codproy, nomproy, estproproy, ".
				"		(SELECT denestpro1 ".
				"		   FROM spg_ep1 ".
				"		  WHERE codemp=sno_hproyecto.codemp".
				"		    AND spg_ep1.codestpro1=substr(sno_hproyecto.estproproy,1,20)) as denestpro1, ".
				"		(SELECT denestpro2 ".
				"		   FROM spg_ep2 ".
				"		  WHERE codemp=sno_hproyecto.codemp".
				"		    AND spg_ep2.codestpro1=substr(sno_hproyecto.estproproy,1,20) ".
				"		    AND spg_ep2.codestpro2=substr(sno_hproyecto.estproproy,21,6)) as denestpro2, ".
				"		(SELECT denestpro3 ".
				"		   FROM spg_ep3 ".
				"		  WHERE codemp=sno_hproyecto.codemp".
				"		    AND spg_ep3.codestpro1=substr(sno_hproyecto.estproproy,1,20) ".
				"		    AND spg_ep3.codestpro2=substr(sno_hproyecto.estproproy,21,6) ".
				"		    AND spg_ep3.codestpro3=substr(sno_hproyecto.estproproy,27,3)) as denestpro3, ".
				"		(SELECT denestpro4 ".
				"		   FROM spg_ep4 ".
				"		  WHERE codemp=sno_hproyecto.codemp".
				"		    AND spg_ep4.codestpro1=substr(sno_hproyecto.estproproy,1,20) ".
				"		    AND spg_ep4.codestpro2=substr(sno_hproyecto.estproproy,21,6) ".
				"		    AND spg_ep4.codestpro3=substr(sno_hproyecto.estproproy,27,3) ".
				"		    AND spg_ep4.codestpro4=substr(sno_hproyecto.estproproy,30,2)) as denestpro4, ".
				"		(SELECT denestpro5 ".
				"		   FROM spg_ep5 ".
				"		  WHERE codemp=sno_hproyecto.codemp".
				"		    AND spg_ep5.codestpro1=substr(sno_hproyecto.estproproy,1,20) ".
				"		    AND spg_ep5.codestpro2=substr(sno_hproyecto.estproproy,21,6) ".
				"		    AND spg_ep5.codestpro3=substr(sno_hproyecto.estproproy,27,3) ".
				"		    AND spg_ep5.codestpro4=substr(sno_hproyecto.estproproy,30,2) ".
				"		    AND spg_ep5.codestpro5=substr(sno_hproyecto.estproproy,32,2)) as denestpro5 ".
				"  FROM sno_hproyecto ".
			...
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch($as_tipo)
				{
					case "": // Se hace el llamado desde tepuy_snorh_d_uni_adm.php
						...
						print "<td align=center><a href=\"javascript: aceptar('$ls_codproy','$ls_nomproy','$ls_codest1',";
...
function aceptar(codproy,nomproy,codest1,codest2,codest3,codest4,codest5,denestpro1,denestpro2,denestpro3,denestpro4,denestpro5)
{
