...
<br>
      ...
      <tr>
        ...
        <td width="341" height="22"><div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0"> Buscar </a></div></td>
      </tr>
    </table>
	<br>
    <?php
...
<script language="JavaScript">
  ...
  function ue_search()
  {
	  ...
	  f.action="tepuy_cat_ctasrephas.php";
	  f.submit();
  }
</script>
</html>
