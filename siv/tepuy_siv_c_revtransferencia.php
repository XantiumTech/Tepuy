...
class tepuy_siv_c_revtransferencia
{
	var $obj="";
	var $io_sql;
	var $siginc;
	...
	function tepuy_siv_c_revtransferencia()
	{
	...
	function uf_siv_select_dt_transferencia($as_codemp,$as_numtra,&$rs_data)
	{
		...
		//         Access: public (tepuy_siv_p_revtransferencia)
		//      Argumento: $as_codemp    // codigo de empresa
	...
	function uf_siv_delete_transferencia($as_codemp,$as_numtra)
	{
		...
		//         Access: public (tepuy_siv_p_revtranferencia)
		//      Argumento: $as_codemp // codigo de empresa
		//  			   $as_numtra // numero de transferencia
		//	      Returns: Retorna un Booleano
...
}//end  class tepuy_siv_c_revtransferencia
?>
