...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPG";
	$ls_ventanas="tepuy_spg_r_acum_x_cuentas.php";
...
<!--  <tr>
  ...
  <tr> 
    <td height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript: ue_showouput();"><img src="../shared/imagebank/tools20/imprimir.png" width="20" height="20" border="0"></a>
	                                                  <a href="javascript:ue_openexcel();"><img src="../shared/imagebank/tools20/excel.png" alt="Excel" width="20" height="20" border="0"></a>
													  <a href="tepuywindow_blank.php"><img src="../shared/imagebank/tools20/salir.png" alt="Salir" width="20" height="20" border="0"></a><img src="../shared/imagebank/tools20/ayuda.png" alt="Ayuda" width="20" height="20"></td>
  </tr>
</table>
  <p>
    <?php
...
$ls_rep_acum_x_cta_pdf      = $io_fun_gasto->uf_select_config("SPG","REPORTE","ACUM_X_CUENTAS","tepuy_spg_rpp_acum_x_cuenta_pdf.php","C");
$ls_rep_acum_x_cta_formato2 = $io_fun_gasto->uf_select_config("SPG","REPORTE","ACUM_X_CUENTAS_FORMATO2","tepuy_spg_rpp_acum_x_cuenta_formato2.php","C");
...
?>
    ...
    <table width="605" border="0" align="center" cellpadding="0" cellspacing="1" class="formato-blanco">
      ...
      <tr  style="display:none">
        <td colspan="3" align="center"><div align="left">Reporte en<strong></strong>
      ...
      <tr>
        <td height="17" colspan="3" align="center"><table width="550" height="39" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
      ...
      <tr>
        <td height="13" colspan="3" align="left"><table width="550" height="40" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr class="titulo-celdanew">
            <td height="13" colspan="6"><strong class="titulo-celdanew">Nivel de Cuentas </strong></td>
          </tr>
          <tr>
            <td width="58"><div align="right"><span class="style1 style14">Nivel</span></div></td>
            <td width="172" height="22"><select name="cmbnivel" id="cmbnivel">
            ...
            <td width="81"><div align="left">Sub - Niveles</div></td>
            <td><div align="right">
      ...
      <tr>
        <td colspan="3" align="center"><div align="right"><span class="Estilo1"> </span><span class="Estilo1">
			...
			<input name="txtrepacumpdf"   type="hidden"   id="txtrepacumpdf"   value="<?php print $ls_rep_acum_x_cta_pdf;      ?>">
			<input name="txtrepacumfor2"  type="hidden"   id="txtrepacumfor2"  value="<?php print $ls_rep_acum_x_cta_formato2; ?>">
...
function ue_showouput()
{
	...
	ls_repacupdf  = f.txtrepacumpdf.value;
	ls_repacufor2 = f.txtrepacumfor2.value;
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			else
			{
			   ...
			   {
				   pagina="reportes/"+ls_repacufor2+"?codestpro1="+codestpro1
			   ...
			   {
				   pagina="reportes/"+ls_repacupdf+"?codestpro1="+codestpro1
				   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
				   +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
				   +"&cmbmesdes="+cmbmesdes+"&cmbmeshas="+cmbmeshas+"&checksubniv="+checksubniv
				   +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas+"&tipoformato="+tipoformato
			   ...
			   /*pagina="reportes/tepuy_spg_rpp_acum_x_cuenta_pdf.php?codestpro1="+codestpro1
			   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
			   +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
			   +"&cmbmesdes="+cmbmesdes+"&cmbmeshas="+cmbmeshas+"&checksubniv="+checksubniv
			   +"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas+"&tipoformato="+tipoformato;
		...
		else
		{
			...
			else
			{
			  ...
			  /* pagina="reportes/tepuy_spg_rpp_acum_x_cuenta_pdf.php?codestpro1="+codestpro1
			   ...
			   +"&codestpro1h="+codestpro1h+"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&codestpro4h="+codestpro4h
			   +"&codestpro5h="+codestpro5h+"&cmbnivel="+cmbnivel+"&cmbmesdes="+cmbmesdes+"&cmbmeshas="+cmbmeshas
			   +"&checksubniv="+checksubniv+"&tipoformato="+tipoformato;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");*/
			}
		}	 
	}
...
function ue_openexcel()
{
	...
	if(li_imprimir==1)
	{
		...
		if(estmodest==1)
		{
			...
			{
			   pagina="reportes/tepuy_spg_rpp_acum_x_cuenta_excel.php?codestpro1="+codestpro1
			   +"&codestpro2="+codestpro2+"&codestpro3="+codestpro3+"&codestpro1h="+codestpro1h
			   +"&codestpro2h="+codestpro2h+"&codestpro3h="+codestpro3h+"&cmbnivel="+cmbnivel
			   +"&cmbmesdes="+cmbmesdes+"&cmbmeshas="+cmbmeshas+"&checksubniv="+checksubniv+"&tipoformato="+tipoformato
			   +"&txtcodfuefindes="+txtcodfuefindes+"&txtcodfuefinhas="+txtcodfuefinhas+"&txtcuentades="+txtcuentades+"&txtcuentahas="+txtcuentahas;
			   window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		}
		else
