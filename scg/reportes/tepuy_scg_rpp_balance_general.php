<?php
	...
	//--------------------------------------------------------------------------------------------------------------------------------
	function uf_print_detalle($la_data,$as_imprimir_titulo,&$io_pdf)
	{
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// Fecha Creación: 28/04/2006 
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_config=array('showHeadings'=>$as_imprimir_titulo, // Mostrar encabezados
	...
	{
		case "0":
			require_once("tepuy_scg_class_bal_general.php");
			$io_report  = new tepuy_scg_class_bal_general();
			$ls_bolivares ="Bs.";
			break;
	
		case "1":
			require_once("tepuy_scg_class_bal_generalbsf.php");
			$io_report  = new tepuy_scg_class_bal_generalbsf();
			$ls_bolivares ="Bs.F.";
			break;
	}	 
	 require_once("../../shared/class_folder/class_fecha.php");
	...
	//--------------------------------------------------  Parámetros para Filtar el Reporte  -----------------------------------------
	   ...
	   $ldt_fechas=$io_funciones->uf_convertirdatetobd($ld_fechas)." 00:00:00";
    ...
    // Cargar datastore con los datos del reporte
		...
		else// Imprimimos el reporte
		{
			...
			for($li_i=1;$li_i<=$li_tot;$li_i++)
			{
				...
				$as_cuenta_gasto=substr($as_cuenta,0,1);
				if($as_cuenta_gasto==4)
				{
				  $la_data_gasto[$i]=array('cuenta'=>$as_cuenta,'denominacion'=>$ls_denominacion,'saldo4'=>$ld_saldo4,'saldo3'=>$ld_saldo3,'saldo2'=>$ld_saldo2,'saldo'=>$ld_saldo);
				  $i++;
				}
				else
				{
			...
			uf_print_detalle($la_data,1,$io_pdf); // Imprimimos el detalle 
			$ld_total=$ld_total;
			if($ld_total<0)
			{
			...
			uf_print_detalle($la_data_gasto,0,$io_pdf); // Imprimimos el detalle 
			unset($la_data);	
			unset($la_data_gasto);		
