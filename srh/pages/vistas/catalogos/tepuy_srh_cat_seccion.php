...
<script type="text/javascript" language="JavaScript1.2" src="../../js/tepuy_srh_js_seccion.js"></script>
    ...
    <table width="497" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
       ...
       <tr>
        ...
        <a href="javascript:catalogo_departamento();"><img src="../../../public/imagenes/buscar.png" alt="Cat&aacute;logo Tipos de Documentos" name="buscartip" width="15" height="15" border="0" id="buscartip"></a>
        </div></td>
	  ...
	  <td width="4">&nbsp;</td>
       ...
       <td width="160"><div align="right"><a href="javascript: Limpiar_busqueda(); Buscar();"><img src="../../../public/imagenes/nuevo.png" alt="Limpiar" width="15" height="15" border="0">Limpiar</a></div></td>
       
       <td width="80"><div align="right"><a href="javascript: Buscar()"><img src="../../../../shared/imagebank/tools15/buscar.png" alt="Buscar" width="15" height="15" border="0">Buscar</a></div></td>
	  </tr>
  </table>
...
<script language="JavaScript">
		...
		var loadDataURL = "../../php/tepuy_srh_a_seccion.php?valor=createXML";
		var actionURL = "../../php/tepuy_srh_a_seccion.php";
	...
	//initialise (from xml) and populate (from xml) grid
		...
		function Buscar()
		{
		   ...
		   divResultado = document.getElementById('mostrar');
		   divResultado.innerHTML= img; 
		   mygrid.loadXML("../../php/tepuy_srh_a_seccion.php?valor=buscar"+"&txtcodsec="+codsec+"&txtdensec="+densec+"&txtcoddep="+coddep);
           setTimeout (terminar_buscar,500);
		...
		function catalogo_departamento()
		{
		   ...
		   ls_depto = f.txtcoddep.value;			
			...
			pagina="tepuy_srh_cat_departamento.php";
