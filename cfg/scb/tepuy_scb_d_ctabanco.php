...
require_once("tepuy_scb_c_ctabanco.php");
require_once("../../shared/class_folder/tepuy_c_check_relaciones.php");

$io_conexion = new tepuy_include();//Instanciando la tepuy_Include.
$conn        = $io_conexion->uf_conectar();//Asignacion de valor a la variable $conn a traves del metodo uf_conectar de la clase tepuy_include.
          ...
          <table width="566" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
              ...
              <tr class="formato-blanco">
                ...
                <td height="22" colspan="2" align="left"><div align="left">
                  ...
                  <a href="javascript:cat_tipo_cuenta();"><img src="../../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Cuentas de Gastos"></a>                  
              ...
              <tr class="formato-blanco">
                ...
                <td height="22" colspan="2" align="left"><div align="left">
                  ...
                  <a href="javascript:cat_bancos();"><img src="../../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Cuentas de Gastos"></a>                  
            ...
            <tr class="formato-blanco">
                ...
                <td height="22" colspan="2"><div align="left" >
                  ...
                  <a href="javascript:catalogo_cuentasSCG();"><img src="../../shared/imagebank/tools15/buscar.png" width="15" height="15" border="0" alt="Cat&aacute;logo de Cuentas de Gastos"></a>                  
...
function ue_nuevo()
{
	...
	if (li_incluir==1)
	   {	
         ...
         f.action="tepuy_scb_d_ctabanco.php";
		 f.submit();
	   }
	else
	   {
...
function ue_buscar()
{
	...
	if (li_leer==1)
       {
	     window.open("tepuy_scb_cat_ctabanco.php","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=750,height=400,left=50,top=50,location=no,resizable=yes");
       }
	else
	   {
		 alert("No tiene permiso para realizar esta operación");
	...
	function catalogo_cuentasSCG()
	 {
	   ...
	   ls_filtro_1 = '1110102';
	   ls_filtro_2 = '211';
	   pagina="tepuy_cat_filt_scg.php?filtro_1="+ls_filtro_1+"&filtro_2="+ls_filtro_2;
