...
//////////////////////////////////AGREGA TITULO  ///////////////////////////
		...
		$io_pdf->addText($tmy+30,$tmx-60,10,"HOJA DE IMPUTACIÓN PRESUPUESTARIA EJERCICIO FISCAL 2012"); // Agregar el título
...
//////////////////////////////////////////////
	...
	function uf_print_detalle_cuentas($la_data,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>1, // Mostrar encabezados
				         ...
				         'outerLineThickness'=>0.5,
						 'innerLineThickness' =>0.5,
						 'cols'=>array('codestpro1'=>array('justification'=>'center','width'=>44), // Justificación y ancho de la columna
						 			   'codestpro2'=>array('justification'=>'center','width'=>53), // Justificación y ancho de la columna
						 			   'codestpro3'=>array('justification'=>'center','width'=>53), // Justificación y ancho de la columna
