...
<table width="700" border="0" align="center" cellpadding="1" cellspacing="1" >
  <tr>
   <td width="700" colspan="2" class="titulo-celda"><div align="center">Cat&aacute;logo de Obras </div></td>
  </tr>
</table>
	 <br>
	 <table width="700" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      <tr>
        <td width="109"  height="30"><div align="right">C&oacute;digo Obras</div></td>
        ...
        <a href="javascript: ue_catcategoriaspartidas();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"></a></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="2">&nbsp;</td>
        <td colspan="2"><div align="right"><a href="javascript: ue_search();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"> Buscar</a></div></td>
      </tr>
    </table>
...
if($ls_operacion=="ue_buscar")
{
	...
	$ls_sql=" SELECT s.codpar,s.nompar,s.despar,u.nomuni,u.coduni,s.prepar,s.codcovpar,s.codcatpar
			  FROM sob_partida s,sob_unidad u
			  WHERE s.codemp='".$ls_codemp."'
			  AND s.nompar like '".$ls_nompar."' AND s.codpar like '".$ls_codpar."' 
			  GROUP BY ".$ls_campo." ".$ls_orden."";
	...
	if($row=$io_sql->fetch_row($rs_data))
	{
		...
		print "<td><a href=javascript:ue_ordenar('s.prepar','ue_buscar');><font color=#FFFFFF>Monto de la Obra</font></a></td>";
...
//			print "<td style=\"text-align:center \"><a href=\"javascript: aceptar('$ls_codigo','$ls_nombre','$ls_descripcion','$ls_codunidad','$ls_unidad','$ls_prepar','$ls_codcovpar','$ls_codcatpar','$ls_descatpar');\">".$ls_codigo."</a></td>";
			print "<td style=\"text-align:center \"><a href=\"javascript: aceptar('$ls_codigo','$ls_nombre','$ls_descripcion','$ls_prepar');\">".$ls_codigo."</a></td>";
...
<script language="JavaScript">
  ...
  function aceptar(codigo,nombre,descripcion,prepar)
  {
 	f=document.form1;
	opener.ue_cargarobra(codigo,nombre,descripcion,prepar);
