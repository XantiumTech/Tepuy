...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SOB";
	$ls_ventanas="tepuy_sob_r_reporteasignacionesobra.php";
              ...
              <td height="8" colspan="3" align="left"><table width="572" height="73" border="0" align="center" cellpadding="0" cellspacing="2" class="formato-blanco">
                ...
                <tr>
                  ...
                  <td colspan="3" ><input name="txtcodpro" type="text" id="txtcodpro" value="<? print $ls_codpro?>" size="10" maxlength="10">
                    <span class="toolbar"><a href="javascript:ue_catcontratista();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"></a></span>
                ...
                <!--tr>
                  ...
                  <td colspan="3" ><input name="txtcodproins" type="text" id="txtcodproins" value="<? print $ls_codproins?>" size="10" maxlength="10">
                    <span class="toolbar"><a href="javascript:ue_catinspector();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="20" height="20" border="0"></a>
