...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function uf_print_encabezado_pagina($as_titulo,$as_numsol,$ad_fecregsol,&$io_pdf)
	{
		...
		$io_pdf->addText($tm,730,11,"ORDEN DE PAGO"); // Agregar el título
...
//////////////////////////         GRID DETALLE CONTABLE	    //////////////////////////////////////
					$lb_valido=$io_report->uf_select_detalle_scg($ls_numsol); // Cargar el DS con los
...
//// aqui se modifico para que no aparezcan las cuentas contables ////
///////////////////////////////////////////////////////////////////////
