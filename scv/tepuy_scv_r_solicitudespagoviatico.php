...
$io_fun_viaticos->uf_load_seguridad("SCV","tepuy_scv_r_solicitudespagoviatico.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
$ls_formato=$io_fun_viaticos->uf_select_config("SCV","REPORTE","SOLICITUD_PAGO","tepuy_scv_rpp_solicitudespago.php","C");
?>
...
?>	
  ...
  <table width="437" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
    ...
    <tr>
      <td colspan="3" align="center"><table width="415" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
        <tr>
        ...
        <tr>
          ...
          <td width="153"><input name="txtcodsoldes" type="text" id="txtcodsoldes" size="13" maxlength="10" value="" readonly>
            <a href="javascript: ue_buscarsolicituddesde();"><img src="../shared/imagebank/tools20/buscar.png" alt="Buscar" name="personal" width="15" height="15" border="0" id="personal"></a></td>
          ...
          <td width="166"><input name="txtcodsolhas" type="text" id="txtcodsolhas" size="13" maxlength="10" value="" readonly>
            <a href="javascript: ue_buscarsolicitudhasta();"><img id="personal" src="../shared/imagebank/tools20/buscar.png" alt="Buscar" width="15" height="15" border="0"></a></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="3" align="center"><div align="left">
        <table width="415" border="0" align="center" cellpadding="0" cellspacing="0" class="formato-blanco">
          <tr>
            <td colspan="2"><strong>Tipo de Nomina </strong></td>
            <td width="65">&nbsp;</td>
            <td width="57">&nbsp;</td>
            <td width="145">&nbsp;</td>
          </tr>
          <tr>
            <td width="81"><div align="right"><span class="style1">
              <input name="rdnomina" type="radio" class="sin-borde" value="1">
            </span></div></td>
            <td width="65">Especial</td>
            <td>&nbsp;</td>
            <td><div align="right"><span class="style1">
              <input name="rdnomina" type="radio" class="sin-borde" value="0" checked>
            </span></div></td>
            <td>Normal</td>
          </tr>
        </table>
	...
	function uf_mostrar_reporte()
	{
		...
		if(valido)
		{
			...
			if(li_imprimir==1)
			{
				...
				for (i=0;i<f.rdnomina.length;i++)
				{ 
				   if (f.rdnomina[i].checked) 
					  break; 
				} 
				document.opcion = f.rdnomina[i].value; 
				li_rdnomina=document.opcion;
				if ((ld_desde!="")&&(ld_hasta!=""))
				{
					li_ordenfec=0;
					window.open("reportes/"+formato+"?codsoldes="+ls_solicituddesde+"&codsolhas="+ls_solicitudhasta
					             +"&ordenfec="+li_ordenfec+"&desde="+ld_desde+"&hasta="+ld_hasta+"&tiporeporte="+ls_tiporeporte
								 +"&rdnomina="+li_rdnomina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,left=0,top=0,location=no,resizable=yes");
				}
				else
				{
