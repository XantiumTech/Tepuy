...
$io_fun_banco->uf_load_seguridad("SCB","tepuy_scb_r_estado_ctares.php",$ls_permisos,$la_seguridad,$la_permisos);
$li_diasem = date('w');
switch ($li_diasem){
  ...
  if (li_imprimir=='1')
     {
       if ((ld_fecdesde!="")&&(ld_fechasta!="")&&(ls_codban!="")&&(ls_ctaban!=""))
          {
			pagina="reportes/tepuy_scb_rpp_estcta_res_pdf.php?fecdes="+ld_fecdesde+"&fechas="+ld_fechasta+"&codban="+ls_codban+"&ctaban="+ls_ctaban+"&tiporeporte="+ls_tiporeporte;
