...
var loadDataURL = "../../php/tepuy_srh_a_contratos.php?valor=createXML";
var actionURL = "../../php/tepuy_srh_a_contratos.php";
var mygrid;
...
function Buscar()
		{
		 ...
		 tipcon=document.form1.txtcodtipcon.value;
		  ...
		  mygrid.loadXML("../../php/tepuy_srh_a_contratos.php?valor=buscar"+"&txtnroreg="+nroreg+"&txtcodper="+codper+"&txtnomper="+nomper+"&txtapeper="+apeper+"&txtcodtipcon="+tipcon);
