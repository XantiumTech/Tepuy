<?php
class tepuy_cfg_c_procedencias
 {
    var $ls_sql="";
	var $io_msg_error;
	
	function tepuy_cfg_c_procedencias()//Constructor de la Clase.
	{
		...
		if ($rs_data==false)
		   {
	         ...
	         $this->io_msg->message("CLASE->tepuy_CFG_C_PROCEDENCIAS; METODO->uf_delete_procedencia;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));   
		 	 $lb_valido=false;
		   }
		else
		   {   
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	if ($rs_data===false)
	   {
	     $lb_valido=false;
	     $this->io_msg->message("CLASE->tepuy_CFG_C_PROCEDENCIAS; METODO->uf_select_procedencia;ERROR->".$this->io_funcion->uf_convertirmsg($this->io_sql->message));   
	   }
	else
	   {
