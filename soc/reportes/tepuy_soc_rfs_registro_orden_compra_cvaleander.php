...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
									   ...
									   $as_denuniadm,$as_lugentnomdep, $as_concom,$ls_monant,$as_obscom,&$io_pdf)
	{
		...
		$io_pdf->addText(40,710,7,'<b>RIF. <b>'.$ls_rifemp); // Agregar el título
		$io_pdf->addText(180,750,9,'<b>REPUBLICA BOLIVARIANA DE VENEZUELA<b>'); // Agregar el título
		$io_pdf->addText(120,735,9,'<b>MINISTERIO DEL PODER POPULAR PARA LA AGRICULTURA Y TIERRAS<b>'); // Agregar el título
		$io_pdf->addText(180,720,9,'<b>CVA LEANDER CARNES Y PESCADOS S.A<b>'); // Agregar el título
		$io_pdf->addText(120,705,9,'<b>Edif. CVA. Av. libertador entre calle 38 y 38, Zona Ind. I Barquisimeto, Edo. Lara<b>'); // Agregar el título
		$io_pdf->addText(150,690,9,'<b>Telefonos:0251-2371078 - 6110063 <b>'.'<b>'.$ls_email.'</b>'); // Agregar el título
		...
		$tm=250-($li_tm/2);
		$io_pdf->addText($tm,670,16,$ls_titulo); // Agregar el título
		$io_pdf->addText(470,700,9," <b>No. </b>".$as_numordcom); // Agregar el título
		$io_pdf->addText(470,680,9,"<b> Fecha </b>".$ad_fecordcom); // Agregar el título		
		// cuadro inferior
        $io_pdf->Rectangle(20,60,570,70); 
		$io_pdf->line(20,112,590,112);	//HORIZONTAL
		$io_pdf->addText(50,122,7,"COMPRAS"); // Agregar el título	
		$io_pdf->addText(21,115,5,"ELABORADO POR"); // Agregar el título		
		$io_pdf->line(135,60,135,130);	//VERTICAL	
		$io_pdf->addText(150,122,7,"PRESUPUESTO"); // Agregar el título
		$io_pdf->addText(136,115,5,"PROCESADO POR"); // Agregar el título
		$io_pdf->line(230,60,230,130);	//VERTICAL		
		$io_pdf->addText(240,122,7,"ADMINISTRAC. Y FINANZAS"); // Agregar el título
		$io_pdf->addText(230,115,5,"REVISADO POR:"); // Agregar el título
		$io_pdf->line(350,60,350,130);	//VERTICAL		
		$io_pdf->addText(370,122,7,"PRESIDENCIA"); // Agregar el título
		$io_pdf->addText(360,115,5,"AUTORIZADO POR:"); // Agregar el título
		$io_pdf->line(450,60,450,130);	//VERTICAL		
		$io_pdf->addText(500,122,7,"PROVEEDOR"); // Agregar el título
		$io_pdf->addText(452,115,5,"FIRMA, CEDULA, SELLO Y FECHA:"); // Agregar el título
		$io_pdf->ezSetY(670);
////////////////////////////////////////////////////////////tabla1///////////////////////////////////////////////////////////////
		$la_data[1]=array('columna1'=>'<b>Proveedor: </b>'.$as_codpro.' - '.$as_nombre. '<b> Rif del Proveedor :</b> '.$as_rifpro);
		$la_data[2]=array('columna1'=>'<b>Direccion: </b>'.$as_dirpro.'<b>  Teléfono: </b> '.$as_telfpro);	
		...
		$la_data[5]=array('columna1'=>'<b>Observación: </b>'.$as_obscom);		
...
///////////////////////////////////////////////tabla4///////////////////////////////////////////////////////////////////////////////
		...
		$la_data[1]=array('columna1'=>'<b>Dependencia:</b>',                  
		                  'columna2'=>'<b>Dirección de Entrega:</b>',
		...
		unset($la_config);
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        $la_data_enc[1]=array('columna1'=>'<b>Condición de Entrega:</b>',                  
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
 ...
 function uf_print_requision ($as_numsol,$as_denuniadm_req, &$io_pdf)
 {
	...
	function uf_print_detalle($la_data,&$io_pdf)
	{
		...
		$la_datatit[1]=array(  'columna2'=>'<b>Código</b>',
							   'columna3'=>'<b>Denominacón</b>',
							   'columna4'=>'<b>Presentación</b>',
						   	   'columna5'=>'<b>Cant.</b>',						   
						  	   'columna6'=>'<b>Precio </b>',
							   'columna7'=>'<b>Cargos </b>',
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna2'=>array('justification'=>'center','width'=>115),
									   ...
									   'columna8'=>array('justification'=>'center','width'=>78))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_datatit,$la_columnas,'',$la_config);
		unset($la_datatit);
		unset($la_columnas);
		unset($la_config);
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('codigo'=>array('justification'=>'center','width'=>115), // Justificación y ancho de la columna
						 			   'denominacion'=>array('justification'=>'left','width'=>127), // Justificación y ancho de la columna
									   'presentacion'=>array('justification'=>'center','width'=>60),
						 			   'cantidad'=>array('justification'=>'right','width'=>35), // Justificación y ancho de la columna
	...
	function uf_print_piecabecera($li_subtot,$li_totcar,$li_montot,&$io_pdf)
	{
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'maxWidth'=>570, // Ancho Máximo de la tabla
						 'xOrientation'=>'center', // Orientación de la tabla
						 'cols'=>array('columna1'=>array('justification'=>'left','width'=>155), // Justificación y ancho de la columna
						 			   'columna2'=>array('justification'=>'left','width'=>220),
									   'columna3'=>array('justification'=>'left','width'=>195))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_data_enc,$la_columna,'',$la_config);
		unset($la_data_enc);
		unset($la_columna);
		unset($la_config);	
	   ...
	   if ($as_estlugcom==0)
		...
		$la_config=array('showHeadings'=>0, // Mostrar encabezados
						 ...
						 'cols'=>array('columna1'=>array('justification'=>'center','width'=>170), // Justificación y ancho de la columna
						 			   ...
						 			   'columna3'=>array('justification'=>'center','width'=>150), // Justificación y ancho de la columna
									   'columna4'=>array('justification'=>'right','width'=>150))); // Justificación y ancho de la columna
		$io_pdf->ezTable($la_datatit,$la_columnas,'',$la_config);
		unset($la_datatit);
		unset($la_columnas);
		unset($la_config);
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		$la_datatit[1]=array( 'columna1'=>'<b>País: </b>'.$den_pais,
