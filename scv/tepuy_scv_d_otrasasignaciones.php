...
$io_fun_viaticos->uf_load_seguridad("SCV","tepuy_scv_d_otrasasignaciones.php",$ls_permisos,$la_seguridad,$la_permisos);
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
<!--  <tr>
  ...
  <tr> 
    <td width="21" height="20" bgcolor="#FFFFFF" class="toolbar"><a href="javascript:ue_nuevo();"><img src="../shared/imagebank/tools20/nuevo.png" alt="Nuevo" width="20" height="20" border="0"></a><a href="javascript:ue_guardar();"></a><a href="javascript:ue_buscar();"></a><a href="javascript:ue_eliminar();"></a><a href="javascript: ue_cerrar();"></a></td>
...
require_once("class_folder/tepuy_scv_c_otrasasignaciones.php");
$io_scv= new tepuy_scv_c_otrasasignaciones($conn);
...
function ue_nuevo()
{
   ...
   {			 
	  ...
	  f.action="tepuy_scv_d_otrasasignaciones.php";
	  f.submit();
   }
   else
   {
	...
	if (li_leer==1)
	   {
		 ...
		 window.open("tepuy_scv_cat_otrasasignaciones.php?destino="+ls_destino+"","catalogo","menubar=no,toolbar=no,scrollbars=yes,width=520,height=400,left=50,top=50,resizable=yes,location=no");
	   }
	else
	   {
		 alert("No tiene permiso para realizar esta operacion");
