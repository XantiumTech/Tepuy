<?php
   ...
   function uf_print($as_codper, $as_cedper, $as_nomper, $as_apeper, $as_tipo, $ai_subnomina)
   {
		...
		$ls_sql="SELECT sno_thpersonalnomina.codper, sno_thpersonalnomina.codsubnom, sno_thpersonalnomina.codasicar, sno_thpersonalnomina.codtab, ".
				...
				"		sno_thpersonalnomina.codclavia, sno_personal.cedper, sno_personal.nomper, sno_personal.apeper, sno_thpersonalnomina.grado,".
				...
				"		sno_thpersonalnomina.codunirac, sno_thpersonalnomina.pagtaqper, sno_thpersonalnomina.fecascper,".
				...
				"  FROM sno_thpersonalnomina, sno_personal, sno_thsubnomina, sno_thunidadadmin, sno_dedicacion, sno_tipopersonal, ".
		...
		else
		{
			while($row=$io_sql->fetch_row($rs_data))
			{
				...
				switch ($as_tipo)
				{
					case "": // el llamado se hace desde tepuy_sno_d_hpersonalnomina.php
						...
						print "'$ls_conjub','$ls_catjub','$ls_codclavia','$ls_dencat','$ls_codunirac','$li_pagtaqper','$li_compensacion','$ld_fecascper','$ls_grado');\">".$ls_codper."</a></td>";
					...
					case "repprenomdes": // el llamado se hace desde tepuy_sno_r_hprenomina.php
						print "<tr class=celdas-blancas>";
					...
					case "repprenomhas": // el llamado se hace desde tepuy_sno_r_hprenomina.php
						print "<tr class=celdas-blancas>";
					...
					case "reppagnomdes": // el llamado se hace desde tepuy_sno_r_hpagonomina.php
						print "<tr class=celdas-blancas>";
					...
					case "reppagnomhas": // el llamado se hace desde tepuy_sno_r_hpagonomina.php
						print "<tr class=celdas-blancas>";
					...
					case "reprecpagdes": // el llamado se hace desde tepuy_sno_r_hrecibopago.php
						print "<tr class=celdas-blancas>";
					...
					case "reprecpaghas": // el llamado se hace desde tepuy_sno_r_hrecibopago.php
						print "<tr class=celdas-blancas>";
					...
					case "modpersonalhistorico": // el llamado se hace desde tepuy_sno_p_hmodificarpersonalnomina.php
						print "<tr class=celdas-blancas>";
...
function aceptar(codper,nomper,estper,codasicar,denasicar,codcar,descar,codtab,destab,codgra,codpas,
				 ...
				 subnomina,conjub,catjub,codclavia,dencat,codunirac,pagtaqper,compensacion,fecascper,grado)
{
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="tepuy_sno_cat_hpersonalnomina.php?tipo=<?PHP print $ls_tipo;?>&subnom=<?PHP print $li_subnomina;?>";
  	f.submit();
}
</script>
</html>
