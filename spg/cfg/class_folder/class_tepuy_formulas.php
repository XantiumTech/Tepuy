...
function iff($ad_condicional,$ad_true,$ad_false)
{
	print $ad_condicional;
...
<table width="500" border="0" align="center" cellpadding="1" cellspacing="1">
	 ...
	 <table width="500" border="0" cellpadding="0" cellspacing="0" class="formato-blanco" align="center">
      ...
      <tr>
        ...
        <td width="160"><a href="javascript: uf_agregar(document.form1.txtvar.value)"><img src="imagebank/tools15/aprobado.png" alt="Agregar" width="15" height="15" border="0"></a></td>
      ...
      <tr>
        ...
        <td><a href="javascript: uf_agregar(document.form1.select3.value)"><img src="imagebank/tools15/aprobado.png" alt="Agregar" width="15" height="15" border="0"></a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td><div align="right">Valor</div></td>
        <td><input name="txtvalor" type="text" id="txtvalor" style="text-align:right"></td>
        <td><a href="javascript: uf_agregar(document.form1.txtvalor.value)"><img src="imagebank/tools15/aprobado.png" alt="Agregar" width="15" height="15" border="0"></a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td valign="top"><div align="right">F&oacute;rmula</div></td>
        <td colspan="3"><input name="txtformula" type="text" value="<?php print $ls_formula;?>" size="70" maxlength="70">
      ...
      <tr>
        ...
        <a href="javascript: uf_verificar();"><img src="imagebank/tools15/aprobado-off.png" alt="Verificar" width="15" height="15" border="0"></a><a href="javascript: uf_volver();"><img src="imagebank/tools15/deshacer.png" alt="Volver" width="15" height="15" border="0"></a></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
