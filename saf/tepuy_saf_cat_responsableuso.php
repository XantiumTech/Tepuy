	...
	function uf_imprimirresultados($as_codper, $as_cedper, $as_nomper, $as_apeper)
   	{
		...
		print "</tr>";
		$ls_sql="SELECT sno_personal.*, sno_profesion.despro, tepuy_pais.despai, tepuy_estados.desest, tepuy_municipio.denmun, tepuy_parroquia.denpar "; 
		$ls_sql=$ls_sql."FROM sno_personal, sno_profesion, tepuy_pais, tepuy_estados, tepuy_municipio, tepuy_parroquia ";
		...
		$ls_sql=$ls_sql."  AND tepuy_pais.codpai = sno_personal.codpai ";
		$ls_sql=$ls_sql."  AND tepuy_estados.codpai = sno_personal.codpai ";
		$ls_sql=$ls_sql."  AND tepuy_estados.codest = sno_personal.codest ";
		$ls_sql=$ls_sql."  AND tepuy_municipio.codpai = sno_personal.codpai ";
		$ls_sql=$ls_sql."  AND tepuy_municipio.codest = sno_personal.codest ";
		$ls_sql=$ls_sql."  AND tepuy_municipio.codmun = sno_personal.codmun ";
		$ls_sql=$ls_sql."  AND tepuy_parroquia.codpai = sno_personal.codpai ";
		$ls_sql=$ls_sql."  AND tepuy_parroquia.codest = sno_personal.codest ";
		$ls_sql=$ls_sql."  AND tepuy_parroquia.codmun = sno_personal.codmun ";
		$ls_sql=$ls_sql."  AND tepuy_parroquia.codpar = sno_personal.codpar ";
...
function ue_search()
{
	f=document.form1;
  	...
  	f.action="tepuy_saf_cat_responsableuso.php";
  	f.submit();
}
</script>
</html>
