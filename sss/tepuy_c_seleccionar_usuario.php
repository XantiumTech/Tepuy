...
<?php
	...
	switch ($ls_operacion)
	{
		case "USUARIOS":
			...
			print("<script language=JavaScript>");
			print("opener.parent.location.href='tepuy_sss_p_derechousuario.php'");
			print("</script>");
			?>
				<script language="JavaScript">
					close();
		...
		case "GRUPOS":
			...
			$_SESSION["la_sistema"]["sistema"]=$ls_sistema;
			print("<script language=JavaScript>");
			print("opener.parent.location.href='tepuy_sss_p_derechogrupo.php'");
			print("</script>");
			?>
				<script language="JavaScript">
					close();
...
<form name="form1" method="post" action="">
  ...
  <div align="center">
    <table width="41%" height="123" border="0" cellpadding="0" cellspacing="0"  background="imagenes/tepuy.jpg" class="formato-blanco">
      <tr >
...
function ue_aceptar()
{
	...
	f.action="tepuy_c_seleccionar_usuario.php";
	f.submit();
}
