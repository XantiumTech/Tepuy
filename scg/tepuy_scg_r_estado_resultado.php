<?php
	...
	$io_fun_scg->uf_load_seguridad("SCG","tepuy_scg_r_estado_resultado.php",$ls_permisos,$la_seguridad,$la_permisos);
	//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
...
function ue_search(codemp)
{
	...
	{	
		...
		if(hidbot==true)
		{
			...
			{
				pagina="reportes/tepuy_scg_rpp_estado_resultado_barvialsa.php?hidcodemp="+codemp+"&cmbmesdes="+cmbmesdes
		...
		if(hidbot==false)
		{
			...
			{
				pagina="reportes/tepuy_scg_rpp_estado_resultado.php?hidcodemp="+codemp+"&txtfecdes="+txtfecdes
...
function ue_openexcel(codemp)
{
	...
	{	
		...
		if(hidbot==true)
		{
			...
			{
				pagina="reportes/tepuy_scg_rpp_estado_resultado_excel.php?hidcodemp="+codemp+"&cmbmesdes="+cmbmesdes
						+"&cmbmeshas="+cmbmeshas+"&cmbagnodes="+cmbagnodes+"&cmbagnohas="+cmbagnohas+"&cmbnivel="+cmbnivel
						+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte;
				window.open(pagina,"catalogo","menubar=no,toolbar=no,scrollbars=yes,width=800,height=600,resizable=yes,location=no");
			}
		...
		if(hidbot==false)
		{
			...
			{
				pagina="reportes/tepuy_scg_rpp_estado_resultado_excel.php?hidcodemp="+codemp+"&txtfecdes="+txtfecdes
						+"&txtfechas="+txtfechas+"&cmbnivel="+cmbnivel+"&hidbot="+hidbot+"&tiporeporte="+tiporeporte;
				window.open(pagina,"catalogo","menubar=yes,toolbar=yes,scrollbars=yes,width=800,height=600,resizable=yes,location=yes");
			}
		}	
...
function uf_cambio_meses()
{
	 ...
	 f.action="tepuy_scg_r_estado_resultado.php";
	 f.submit();
