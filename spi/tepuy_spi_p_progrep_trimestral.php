...
//////////////////////////////////////////////         SEGURIDAD               /////////////////////////////////////////////
	...
	$ls_sistema="SPI";
	$ls_ventanas="tepuy_spi_p_progrep_trimestral.php";
...
function uf_cargargrid()
{
	...
	f.action="tepuy_spi_p_progrep_trimestral.php";
	f.submit();
}
...
function ue_distribuir()
{
	...
	if(document.opcion=="M" ) 
	{
		 ...
		 pagina="tepuy_spi_p_progrep_trimestral_distribucion.php?fila="+li+"&txtPrevisto="+ld_previsto
